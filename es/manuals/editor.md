...
- anchor: the-editor-views
  title: Paneles del editor
- 1. Panel Assets
- anchor: the-scene-editor
  title: 2. Panel Scene Editor
- 3. Panel Outline
- 4. Panel Properties
- 5. Panel Tools
...
- anchor: creating-new-project-files
  title: Crear nuevos archivos de proyecto
- Plantillas
- Importar archivos a tu proyecto
- Actualizar el editor
- Preferencias
- anchor: editor-logs
  title: Logs del editor
- Servidor del editor
- anchor: editor-installation-metadata
  title: Metadatos de instalación del editor
- Estilo del editor
- FAQ
---
...
: Aquí están tus proyectos abiertos recientemente para que puedas acceder a ellos con rapidez. Esta es la vista predeterminada de la pantalla de inicio.
  ...
  ![my projects](/manuals/images/editor/start_no_projects.png)
...
: Contiene proyectos preparados para mostrar ciertos casos de uso.
  ...
  ![New project](/manuals/images/editor/start_templates.png)

Cuando creas un nuevo proyecto, se almacena en tu unidad local y cualquier edición que hagas se guarda localmente.

Puedes aprender más sobre las distintas opciones en el [manual de configuración de proyecto](https://www.defold.com/es/manuals/project-setup/).
...
- [Navegación de escenas 2D y 3D](/es/manuals/scene-editing/#2d-and-3d-scene-orientation) con modos de cámara ortográfica y de perspectiva
- [Herramientas de transformación](/es/manuals/scene-editing/#manipulating-objects) para mover, rotar y escalar objetos
- [Free Camera Mode](/es/manuals/scene-editing/#free-camera-mode) para navegación 3D en primera persona
- [Configuración de Grid](/es/manuals/scene-editing/#grid-settings) con tamaño, plano y apariencia configurables
- [Filtros de visibilidad](/es/manuals/scene-editing/#visibility-filters) para alternar tipos de componentes y guías

Lee más en el [manual del Scene Editor](/es/manuals/scene-editing/).
...
*Curve Editor* : se usa al editar curvas en el [Particle Editor](/es/manuals/particlefx/).

El panel Tools también se usa para interactuar con el depurador integrado. Lee más sobre esto en el [manual de depuración](/es/manuals/debugging/).

### 6. Panel Changed Files

Si tu proyecto usa Git, esta vista enumera los archivos que se han cambiado, añadido, renombrado o eliminado localmente en comparación con el commit actual (`HEAD`). Usa un cliente Git externo o la línea de comando para sincronizar con un repositorio remoto. Puedes obtener más información en el [manual de control de versiones](/es/manuals/version-control/). Algunas operaciones orientadas a archivos pueden realizarse en esta vista:
...
- seleccionar `➝| Open As` para usar un editor distinto al predeterminado o la herramienta externa asociada configurada en `File ▸ Preferences ▸ Code ▸ Custom Editor`. Consulta más en el [manual de preferencias](/es/manuals/editor-preferences).

![Tabs](/manuals/images/editor/tabs_custom.png)
...
![Update from project selection](/manuals/images/editor/update_start.png)
![Update from Editor](/manuals/images/editor/update_available.png)
...
![Update Editor popup](/manuals/images/editor/update.png)

Verás el progreso de la descarga en la barra de estado inferior:

![Download progress](/manuals/images/editor/download_status.png)
...
![Restart to update](/manuals/images/editor/restart_to_update.png)
...
Lee más detalles en el [manual de preferencias](/es/manuals/editor-preferences)
...
Lee más en el [manual para obtener ayuda](/es/manuals/getting-help/#getting-help).
...
## Metadatos de instalación del editor {#editor-installation-metadata}
...
La apariencia del editor puede cambiarse con estilos personalizados. Lee más en el [manual de estilo del editor](/es/manuals/editor-styling).

...
* [Collection factory](/es/manuals/collection-factory) - Genera colecciones
* [Collection proxy](/es/manuals/collection-proxy) - Carga y descarga colecciones
* [Collision object](/es/manuals/physics) - Físicas 2D y 3D
* [Camera](/es/manuals/camera) - Cambia la ventana de visualización y la proyección del mundo del juego
...
* [Script](/es/manuals/script) - Añade lógica del juego
* [Sound](/es/manuals/sound) - Reproduce sonido o música
* [Sprite](/es/manuals/sprite) - Muestra una imagen 2D (con animación flipbook opcional)
* [Tilemap](/es/manuals/tilemap) - Muestra una cuadrícula de tiles
...
Todos los tipos de componentes de Defold tienen propiedades diferentes. El [panel Properties](/es/manuals/editor/#the-editor-views) del editor mostrará las propiedades del componente seleccionado actualmente en el [panel Outline](/es/manuals/editor/#the-editor-views). Consulta los manuales de los distintos tipos de componentes para aprender más sobre las propiedades disponibles.

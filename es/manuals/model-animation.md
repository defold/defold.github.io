...
Para obtener detalles sobre cómo importar datos 3D en un Model para animación, consulta la [documentación de Model](/es/manuals/model).

  ![Animación de Blender](/manuals/images/animation/blender_animation.png)
  ![Bucle wiggle](/manuals/images/animation/suzanne.gif)
...
Además de usar `model.play_anim()` para avanzar una animación de modelo, los componentes *Model* exponen una propiedad "cursor" que se puede manipular con `go.animate()` (más sobre [animaciones de propiedades](/es/manuals/property-animation)):

...
- anchor: creating-display-profiles
  title: Crear perfiles de pantalla
...
![Nuevos perfiles de pantalla](/manuals/images/gui-layouts/new_profiles.png)
...
![Configuración](/manuals/images/gui-layouts/settings.png)
...
![Añadir layout a la escena](/manuals/images/gui-layouts/add_layout.png)
...
![Barra de herramientas de layouts](/manuals/images/gui-layouts/toolbar.png)

![edición en vertical](/manuals/images/gui-layouts/portrait.png)
...
![edición en horizontal](/manuals/images/gui-layouts/landscape.png)

...
1. Crea un bucket para los recursos de Live update
    ...
    ![Crear un bucket](/manuals/images/live-update/01-create-bucket.png)
...
2. Agrega una política del bucket a tu bucket
    ...
    ![Política del bucket](/manuals/images/live-update/02-bucket-policy.png)
...
3. Agrega una configuración CORS a tu bucket (opcional)
    ...
    ![Configuración CORS](/manuals/images/live-update/03-cors-configuration.png)
...
4. Crea una política IAM
    ...
    ![Política IAM](/manuals/images/live-update/04-create-policy.png)
...
6. Crea un archivo de perfil de credenciales
    ...
    ![Configuración de Live update](/manuals/images/live-update/05-liveupdate-settings.png)
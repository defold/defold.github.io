...
![Recarga de recursos](/manuals/images/hot-reload/menu.png)

## Recarga en caliente en dispositivo

La recarga en caliente funciona tanto en dispositivos como en computadoras de escritorio. Para usarla en un dispositivo, ejecuta una build de depuración de tu juego, o la [app de desarrollo](/es/manuals/dev-app) en tu dispositivo móvil, y luego selecciona el dispositivo como objetivo de build desde el editor:

![dispositivo objetivo](/manuals/images/hot-reload/target.png)
...
![recargar gui](/manuals/images/hot-reload/gui.png)
...
![gui recargada](/manuals/images/hot-reload/gui-reloaded.png)
...
Cambiar y recargar "my_module.lua" _no_ cambiará el comportamiento de "user.script". Consulta [el manual de Módulos](/es/manuals/modules) para obtener más información sobre por qué sucede esto y cómo evitar este problema.

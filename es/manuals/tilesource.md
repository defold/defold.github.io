...
Un *Tile Source* puede ser usado por un [componente Tilemap](/es/manuals/tilemap) para pintar tiles sobre un área de cuadrícula, o puede usarse como fuente gráfica para un [Sprite](/es/manuals/sprite) o un [componente Particle Effect](/es/manuals/particlefx). También puedes usar las *Collision Shapes* del tile source en un Tilemap para [detección de colisiones y simulación física](/es/manuals/physics) ([ejemplo](/examples/tilemap/collisions/)).
...
![imagen de tiles](/manuals/images/tilemap/small_map.png)
...
![Crear un Tile Source](/manuals/images/tilemap/tilesource.png)
...
![Animación de Tile Source](/manuals/images/tilemap/animation.png)
...
![Formas de colisión](/manuals/images/tilemap/collision.png)

...
- anchor: multi-textured-sprites
  title: Sprites con múltiples texturas
- Animaciones
- UVs
---
...
El componente Sprite puede usar un [Atlas](/es/manuals/atlas) o un [Tile Source](/es/manuals/tilesource) para sus gráficos.
...
{% include shared/es/slice-9-texturing.md %}
...
{% include shared/es/material-constants.md component='sprite' variable='tint' %}
...
Un sprite puede sobrescribir atributos de vértice del material asignado actualmente; estos se pasarán al vertex shader desde el componente (consulta el [manual de Material para más detalles](/es/manuals/material/#attributes)).
...
Por eso usamos `Rename patterns` en el [atlas](/es/manuals/material/) para renombrarlos.

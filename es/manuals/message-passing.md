...
El paso de mensajes es un mecanismo para que los objetos de juego de Defold se comuniquen entre sí. Este manual asume que tienes una comprensión básica del [mecanismo de direccionamiento](/es/manuals/addressing) de Defold y de los [bloques de construcción básicos](/es/manuals/building-blocks).
...
![Estructura de paso de mensajes](/manuals/images/message_passing/message_passing_structure.png)
...
![Paso de mensajes](/manuals/images/message_passing/message_passing.png)
...
![Nombre de colección](/manuals/images/message_passing/collection_name.png)
...
```
Puedes encontrar una descripción más detallada de cómo funcionan los proxies en la documentación de [proxies de colección](/es/manuals/collection-proxy).

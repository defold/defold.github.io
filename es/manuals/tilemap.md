...
Antes de poder crear un tile map, necesitas crear un Tile Source. Consulta el [manual de Tile Source](/es/manuals/tilesource) para aprender cómo crear un Tile Source.
...
- El tile map nuevo se abre automáticamente en el editor de tile maps.
  ...
  ![tilemap nuevo](/manuals/images/tilemap/tilemap.png)
...
2. Selecciona un tile para usarlo como pincel (presiona <kbd>Space</kbd> para mostrar la paleta de tiles) o selecciona algunos tiles haciendo click y arrastrando en la paleta para crear un pincel rectangular con varios tiles.
   ...
   ![Paleta](/manuals/images/tilemap/palette.png)
...
3. Pinta con el pincel seleccionado. Para borrar un tile, elige un tile vacío y úsalo como pincel, o selecciona el borrador (<kbd>Edit ▸ Select Eraser</kbd>).
   ...
   ![Pintar tiles](/manuals/images/tilemap/paint_tiles.png)
...
![Tomar tiles](/manuals/images/tilemap/pick_tiles.png)
...
![Usar tile map](/manuals/images/tilemap/use_tilemap.png)
...
{% include shared/es/material-constants.md component='tilemap' variable='tint' %}
...
El archivo *game.project* tiene algunas [configuraciones del proyecto](/es/manuals/project-settings#tilemap) relacionadas con tilemaps.

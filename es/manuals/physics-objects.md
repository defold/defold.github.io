...
Collision Shape
: Un recurso tilemap o `.convexshape`. Para usar una malla glTF o GLB, agrega una forma Hull o Mesh al componente y define las propiedades *Scene* y *Mesh* de esa forma. Consulta [formas de colisión para obtener más información](/es/manuals/physics-shapes).

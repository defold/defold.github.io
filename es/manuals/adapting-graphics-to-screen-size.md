...
Se puede lograr el mismo resultado adjuntando un [componente Camera](/es/manuals/camera/) a un objeto de juego, marcando *Orthographic Projection* y definiendo *Orthographic Zoom* en 4.0:

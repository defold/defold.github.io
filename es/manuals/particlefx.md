...
![Editor ParticleFX](/manuals/images/particlefx/editor.png)
...
Selecciona <kbd>New... ▸ Particle FX</kbd> desde el menú contextual en el navegador *Assets*. Nombra el nuevo archivo de efecto de partículas. El editor abrirá el archivo usando el [Scene Editor](/es/manuals/editor/#the-scene-editor).
...
![Partículas predeterminadas](/manuals/images/particlefx/default.png)
...
![Añadir modificador](/manuals/images/particlefx/add_modifier.png)

![Seleccionar modificador añadido](/manuals/images/particlefx/add_modifier_select.png)
...
![Editar partículas](/manuals/images/particlefx/rotate.gif)
...
: La forma del emisor
  ...
  ![tipos de emisor](/manuals/images/particlefx/emitter_types.png)
...
### Modos de mezcla
{% include shared/es/blend-modes.md %}
...
![Propiedad](/manuals/images/particlefx/property.png)
...
![Propiedad con clave](/manuals/images/particlefx/key.png)
...
![Curve Editor de ParticleFX](/manuals/images/particlefx/curve_editor.png)
...
: Afecta a las partículas en una dirección circular o espiral alrededor de su posición.
  ...
  ![modificadores](/manuals/images/particlefx/modifiers.png)
...
Para iniciar y detener un efecto de partículas desde un script de GUI, consulta el [manual de Particle FX de GUI](/es/manuals/gui-particlefx#controlling-the-effect) para obtener más información.
...
El material predeterminado de efecto de partículas tiene las siguientes constantes, que pueden cambiarse con `particlefx.set_constant()` y restablecerse con `particlefx.reset_constant()` (consulta el [manual de Material para más detalles](/es/manuals/material/#vertex-and-fragment-constants)):
...
El archivo *game.project* tiene algunas [opciones de configuración del proyecto](/es/manuals/project-settings#particle-fx) relacionadas con las partículas.
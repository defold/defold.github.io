...
: Arrastra y suelta imágenes desde el panel *Assets* a la vista del editor.
  ...
  ![Crear un atlas, agregar imágenes](/manuals/images/atlas/add.png)
  ...
  ![Imágenes agregadas](/manuals/images/atlas/single_images.png)
...
: Haz <kbd>click derecho</kbd> en la entrada raíz Atlas del panel *Outline*.
  ...
  ![Crear un atlas, agregar imágenes](/manuals/images/atlas/add_animation.png)
  ...
  ![Grupo de animación](/manuals/images/atlas/animation_group.png)
...
Size
: Muestra el tamaño total calculado del recurso de textura resultante. El ancho y el alto se ajustan a la potencia de dos más cercana. Ten en cuenta que, si activas la compresión de texturas, algunos formatos requieren texturas cuadradas. Las texturas no cuadradas se redimensionarán y se rellenarán con espacio vacío para hacer que la textura sea cuadrada. Consulta el [manual de perfiles de textura](/es/manuals/texture-profiles/) para más detalles.
...
![Atlas de varias páginas](/manuals/images/atlas/multipage_atlas.png)
...
![Propiedades del atlas](/manuals/images/atlas/atlas_properties.png)
...
![Propiedades de imagen](/manuals/images/atlas/image_properties.png)
...
Usa [`resource.create_texture(path, params)`](https://defold.com/ref/resource/#resource.create_texture:path-table) para crear un nuevo recurso de textura:
...
Una vez creada la textura, puedes usar [`resource.set_texture(path, params, buffer)`](https://defold.com/ref/resource/#resource.set_texture:path-table-buffer) para definir los pixeles de la textura:
...
La textura puede usarse directamente en un [componente de modelo](/es/manuals/model/) con `go.set()`:
...
Si la textura debe usarse en un [componente sprite](/es/manuals/sprite/), primero debe usarse en un atlas. Usa [`resource.create_atlas(path, params)`](https://defold.com/ref/resource/#resource.create_atlas:path-table) para crear un Atlas:

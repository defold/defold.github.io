...
![Componente factory](/manuals/images/factory/factory_collection.png)

![Componente factory](/manuals/images/factory/factory_component.png)
...
![Objeto de juego generado](/manuals/images/factory/factory_spawned.png)
...
`[properties]`
: (opcional) Una tabla Lua con cualquier valor de propiedad de script con el que iniciar el objeto de juego. Consulta el [manual de propiedades de script](/es/manuals/script-properties) para obtener información sobre las propiedades de script.
...
![Objeto de juego generado con propiedad y escalado](/manuals/images/factory/factory_spawned2.png)
...
![Cargar dinámicamente](/manuals/images/factory/load_dynamically.png)
...
![Prototipo dinámico](/manuals/images/factory/dynamic_prototype.png)
...
![Máximo de instancias](/manuals/images/factory/factory_max_instances.png)
...
Planifica *Max Instances* en función del mayor número de objetos de juego que puedan estar vivos simultáneamente en un mundo dinámico. Consulta [Optimizaciones del recuento máximo de componentes](/es/manuals/project-settings/#component-max-count-optimizations) para saber cómo se calculan los demás límites de componentes.

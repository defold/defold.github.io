...
![proyecciones](/manuals/images/camera/projections.png)
...
![crear componente Camera](/manuals/images/camera/create.png)

El componente Camera tiene las siguientes propiedades que definen el *frustum* de la cámara:

![configuración de cámara](/manuals/images/camera/settings.png)
...
![seguir objeto de juego](/manuals/images/camera/follow.png)
...
function M.screen_to_world(camera, screen_x, screen_y, z)
    ...
    -- https://defold.com/es/manuals/camera/#converting-mouse-to-world-coordinates
...
<div class='sidenote' markdown='1'>
Las [soluciones de cámara de terceros mencionadas en este manual](/es/manuals/camera/#third-party-camera-solutions) proporcionan funciones para convertir hacia y desde coordenadas de pantalla.
</div>

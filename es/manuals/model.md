...
![Model en objeto de juego](/manuals/images/model/model_gltf.png)
...
![Wiggler en el juego](/manuals/images/model/runtime.png)

### Animación en runtime

Defold proporciona soporte potente para controlar la animación en runtime. Más información en el [manual de animación de modelos](/es/manuals/model-animation):
...
Consulta la [documentación de Render](/es/manuals/render) para más detalles sobre cómo funcionan los scripts de render.
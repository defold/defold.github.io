...
Para obtener más información sobre los reportes de build, consulta el [manual de profiling](/es/manuals/profiling/#build-reports).

### Android

La creación de un bundle de aplicación Android (archivo .apk) está documentada en el [manual de Android](/es/manuals/android/#creating-an-android-application-bundle).

### iOS

La creación de un bundle de aplicación iOS (archivo .ipa) está documentada en el [manual de iOS](/es/manuals/ios/#creating-an-ios-application-bundle).

### macOS

La creación de un bundle de aplicación macOS (archivo .app) está documentada en el [manual de macOS](/es/manuals/macos).
...
La creación de un bundle de aplicación Windows (archivo .exe) está documentada en el [manual de Windows](/es/manuals/windows).

### HTML5

La creación de un bundle de aplicación HTML5, así como la configuración opcional, está documentada en el [manual de HTML5](/es/manuals/html5/#creating-html5-bundle).

#### Facebook Instant Games

Es posible crear una versión especial de un bundle de aplicación HTML5 específicamente para Facebook Instant Games. Este proceso está documentado en el [manual de Facebook Instant Games](/es/manuals/instant-games/).

## Crear bundles desde la línea de comando

El editor usa nuestra [herramienta de línea de comando Bob](/es/manuals/bob/) para crear el bundle de la aplicación.
...
Usando la configuración [bundle_resources](https://defold.com/es/manuals/project-settings/#bundle-resources), puedes configurar assets que deben colocarse dentro del bundle tal cual.
...
Usando la configuración [custom_resources](https://defold.com/es/manuals/project-settings/#custom-resources), puedes configurar assets que deben colocarse (con compresión) dentro de `game.arcd`.
...
* Las builds release no incluyen el [grabador de pantalla](/ref/sys/#start_record)
...
* Las builds release no admiten el targeting desde el editor para [hot-reload](/es/manuals/hot-reload) y funcionalidades similares
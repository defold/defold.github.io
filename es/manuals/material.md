...
- anchor: vertex-and-fragment-constants
  title: Constantes de vertex y fragment shader
...
* Para obtener más información sobre el pipeline de render, consulta la [documentación de Render](/es/manuals/render).
* Para una explicación detallada de los programas de shader, consulta la [documentación de Shader](/es/manuals/shader).
...
![Archivo de material](/manuals/images/materials/material_file.png)

El nuevo material se abrirá en el *Material Editor*.

![Editor de material](/manuals/images/materials/material.png)
...
![Atributo de material personalizado](/manuals/images/materials/set_custom_attribute.png)
...
![Configuración de instancing](/manuals/images/materials/instancing-setup.png)
...
![Material de instancing](/manuals/images/materials/instancing-material.png)
...
![Draw calls de instancing](/manuals/images/materials/instancing-draw-calls.png)
...
`CONSTANT_TYPE_USER`
: Una constante vector4 que puedes usar para cualquier dato personalizado que quieras pasar a tus programas de shader. Puedes definir el valor inicial de la constante en la definición de la constante, pero es mutable mediante las funciones [go.set()](/ref/go/#go.set) / [go.animate()](/ref/go/#go.animate). También puedes recuperar el valor con [go.get()](/ref/go/#go.get). Cambiar una constante de material de una sola instancia de componente [rompe el batching de render y producirá draw calls adicionales](/es/manuals/render/#draw-calls-and-batching).
...
: Una constante matrix4 que puedes usar para cualquier dato personalizado que quieras pasar a tus programas de shader. Puedes definir el valor inicial de la constante en la definición de la constante, pero es mutable mediante las funciones [go.set()](/ref/go/#go.set) / [go.animate()](/ref/go/#go.animate). También puedes recuperar el valor con [go.get()](/ref/go/#go.get). Cambiar una constante de material de una sola instancia de componente [rompe el batching de render y producirá draw calls adicionales](/es/manuals/render/#draw-calls-and-batching).
...
![Sampler de sprite](/manuals/images/materials/sprite_sampler.png)
...
![Ajustes de sampler](/manuals/images/materials/my_sampler.png)
...
![Samplers de modelo](/manuals/images/materials/model_samplers.png)
...
![Modelo](/manuals/images/materials/model.png)

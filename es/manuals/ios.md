...
- anchor: creating-an-ios-application-bundle
  title: Crear un bundle de aplicación iOS
...
iOS requiere que _cualquier_ app que crees y quieras ejecutar en tu teléfono o tablet _deba_ estar firmada con un certificado emitido por Apple y un perfil provisional. Este manual explica los pasos necesarios para crear un bundle de tu juego para iOS. Durante el desarrollo, suele ser preferible ejecutar tu juego mediante la [app de desarrollo](/es/manuals/dev-app), ya que te permite recargar contenido y código en caliente directamente en tu dispositivo.
...
: El UDID de un dispositivo iOS puede encontrarse conectando el dispositivo a una computadora por wifi o cable. Abre Xcode y selecciona <kbd>Window ▸ Devices and Simulators</kbd>. El número de serie y el identificador se muestran cuando seleccionas tu dispositivo.
  ...
  ![dispositivos xcode](/manuals/images/ios/xcode_devices.png)
  ...
  ![dispositivos itunes](/manuals/images/ios/itunes_devices.png)
...
![Instalar y ejecutar bundle iOS](/manuals/images/ios/install_and_launch.png)
...
Si el editor no puede detectar la ubicación de instalación de la herramienta ios-deploy, tendrás que especificarla en [Preferences](/es/manuals/editor-preferences/#tools).
...
![Crear proyecto](/manuals/images/ios/xcode_create_project.png)

Haz click en Next y continúa para configurar tu proyecto. Ingresa un Product Name:

![Configuración del proyecto](/manuals/images/ios/xcode_storyboard_create_project_settings.png)

Haz click en Create para finalizar el proceso. Tu proyecto ya está creado y podemos continuar para crear el storyboard:

![La vista del proyecto](/manuals/images/ios/xcode_storyboard_project_view.png)
...
![Agregar imagen](/manuals/images/ios/xcode_storyboard_add_image.png)
...
![Agregar vista de imagen](/manuals/images/ios/xcode_storyboard_add_imageview.png)

Arrastra el componente Image View al storyboard:

![Agregar al storyboard](/manuals/images/ios/xcode_storyboard_add_imageview_to_storyboard.png)
...
![Crear build del proyecto](/manuals/images/ios/xcode_icons_build.png)
...
![Agregar icono y asset catalog a game.project](/manuals/images/ios/defold_icons_game_project.png)
...
{% include shared/es/apple-privacy-manifest.md %}
...
Si crees que tu proyecto está exento, define la clave [`ITSAppUsesNonExemptEncryption`](https://developer.apple.com/documentation/bundleresources/information-property-list/itsappusesnonexemptencryption) como `False` en el `Info.plist` del proyecto. Consulta [Manifiestos de aplicación](/es/manuals/extensions-manifest-merge-tool) para obtener más detalles.

...
Defold contiene un depurador Lua integrado con una herramienta de inspección. Junto con las [herramientas de profiling](/es/manuals/profiling) integradas, es una herramienta potente que puede ayudar a encontrar la causa de errores en la lógica de tu juego o a analizar problemas de rendimiento.
...
: Los breakpoints pueden desactivarse temporalmente sin eliminarlos. Cuando están desactivados, se ignoran durante la ejecución, pero pueden volver a activarse en cualquier momento. Haz click derecho sobre él en el margen del editor de código y luego activa o desactiva la casilla Enabled. Los breakpoints desactivados aparecen huecos para indicar que están inactivos.
  ...
  ![disable breakpoint](/manuals/images/debugging/disable_breakpoint.png)
...
## Pestaña Breakpoints
  ...
  ![breakpoints tab](/manuals/images/debugging/breakpoints_tab.png)
...
![physics debug visualization](/manuals/images/debugging/physics_debug_visualisation.png)
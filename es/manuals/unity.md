...
| [Label](/es/manuals/label/) | Text / TextMeshPro | Defold tiene una [extensión RichText](https://defold.com/assets/richtext/) para formato enriquecido (similar a TextMeshPro). |

...
![Bindings de input](/manuals/images/input/overview.png)
...
: Los dispositivos de input que forman parte de tu computadora o dispositivo móvil, o que están conectados a ellos, proporcionan input raw de nivel de sistema al runtime de Defold. Se admiten los siguientes tipos de dispositivos:
  ...
  4. Gamepads (según el soporte del sistema operativo y el mapeo en el archivo [gamepads](/es/manuals/input-gamepads/#gamepads-settings-file))
...
Triggers de teclas
: Input de teclado de una sola tecla. Cada tecla se mapea por separado a una acción correspondiente. Aprende más en el [manual de input de teclas y texto](/es/manuals/input-key-and-text).

Triggers de texto
: Los triggers de texto se usan para leer input de texto arbitrario. Aprende más en el [manual de input de teclas y texto](/es/manuals/input-key-and-text)

Triggers de mouse
: Input de botones del mouse y ruedas de desplazamiento. Aprende más en el [manual de input de mouse y touch](/es/manuals/input-mouse-and-touch).

Triggers de touch
: Los triggers de tipo Single-touch y Multi-touch están disponibles en dispositivos iOS y Android en aplicaciones nativas y en bundles HTML5. Aprende más en el [manual de mouse y touch](/es/manuals/input-mouse-and-touch).

Triggers de gamepad
: Los triggers de gamepad te permiten vincular input de gamepad estándar a funciones del juego. Aprende más en el [manual de gamepads](/es/manuals/input-gamepads).
...
![Pila de input](/manuals/images/input/input_stack.png)
...
![Despacho de acciones](/manuals/images/input/actions.png)
...
![Despacho de acciones a proxies](/manuals/images/input/proxy.png)
...
![consumir input](/manuals/images/input/consuming.png)
...
![menú de pausa](/manuals/images/input/game_paused.png)

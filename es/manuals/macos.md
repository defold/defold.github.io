...
La configuración de aplicaciones específica de macOS se hace desde la [sección macOS](/es/manuals/project-settings/#macos) del archivo de configuración *game.project*.

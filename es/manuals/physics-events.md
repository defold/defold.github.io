...
Si se define un listener, los [mensajes de físicas](/es/manuals/physics-messages) ya no se enviarán para el mundo de físicas donde está definido este listener.
</div>

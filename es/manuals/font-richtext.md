...
- anchor: rich-text-markup
  title: Marcado de texto enriquecido
...
- anchor: interaction-messages
  title: Mensajes de interacción
- anchor: named-styles
  title: Estilos con nombre
- anchor: layout-object-api
  title: API de objetos de layout
- label.get_layout_objects()
- gui.get_layout_objects()
- anchor: returned-object-fields
  title: Campos del objeto devuelto
- anchor: lua-example
  title: Ejemplo Lua
- anchor: useful-combinations
  title: Combinaciones útiles
- anchor: colored-outline-with-a-horizontal-gradient
  title: Contorno de color con un degradado horizontal
- anchor: shake-a-sentence-gradient-one-word
  title: Hacer vibrar una frase y aplicar un degradado a una palabra
- anchor: override-one-property-without-losing-the-others
  title: Sobrescribir una propiedad sin perder las demás
---
...
![Texto de ejemplo renderizado en verde opaco](/manuals/images/richtext/color_green.webp)
...
![Texto de ejemplo renderizado en verde con alfa a la mitad](/manuals/images/richtext/color_green_alpha.webp)
...
![Texto de ejemplo renderizado a 24 pixeles](/manuals/images/richtext/size_24.webp)
...
![Texto de ejemplo renderizado al 120 por ciento de 32 pixeles](/manuals/images/richtext/size_120.webp)
...
![Texto de ejemplo renderizado al doble del tamaño base de 32 pixeles](/manuals/images/richtext/size_2em.webp)
...
![Texto de ejemplo con un degradado horizontal de magenta a blanco](/manuals/images/richtext/gradient_horizontal.webp)
...
![Texto de ejemplo con un degradado azul vertical](/manuals/images/richtext/gradient_vertical.webp)
...
![Texto de ejemplo con un degradado de cuatro esquinas ajustado a cada glifo](/manuals/images/richtext/gradient_four_glyph.webp)
...
![Texto de ejemplo con un degradado de cuatro esquinas ajustado al fragmento](/manuals/images/richtext/gradient_four_text.webp)
...
![Degradado animado que fluye ajustado a cada glifo](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![Degradado animado que fluye ajustado al fragmento](/manuals/images/richtext/gradient_flow_span.webp)
...
![Texto de ejemplo con un subrayado continuo](/manuals/images/richtext/underline_solid.webp)
...
![Texto de ejemplo con un subrayado discontinuo](/manuals/images/richtext/underline_dashed.webp)
...
![Texto de ejemplo con un subrayado degradado](/manuals/images/richtext/underline_gradient.webp)
...
![Texto de ejemplo con un tachado continuo](/manuals/images/richtext/strike_solid.webp)
...
![Texto de ejemplo con un tachado discontinuo](/manuals/images/richtext/strike_dashed.webp)
...
![Texto de ejemplo con un contorno negro exterior](/manuals/images/richtext/outline.webp)
...
![Texto de ejemplo con una sombra desplazada](/manuals/images/richtext/shadow.webp)
...
![Texto de ejemplo con una vibración animada por glifo](/manuals/images/richtext/shake_glyph.webp)
...
![Texto de ejemplo con una vibración animada de todo el fragmento](/manuals/images/richtext/shake_span.webp)
...
![Texto de ejemplo con una onda animada por glifo](/manuals/images/richtext/wave_glyph.webp)
...
![Texto de ejemplo que se mueve como un solo fragmento animado](/manuals/images/richtext/wave_span.webp)
...
![Un logo de Defold renderizado integrado en el texto](/manuals/images/richtext/sprite.webp)
...
![www.defold.com renderizado con el estilo de enlace predeterminado y un subrayado](/manuals/images/richtext/link.webp)
...
Consulta [foco de input](/es/manuals/input/#input-focus) e [input de mouse y táctil](/es/manuals/input-mouse-and-touch) para conocer los detalles de configuración.

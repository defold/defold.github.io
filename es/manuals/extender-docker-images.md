...
3. Ejecuta Extender local como se describe en [Cómo ejecutar Extender local con artefactos preconfigurados](/es/manuals/extender-local-setup#how-to-run-local-extender-with-preconfigured-artifacts).
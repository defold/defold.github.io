...
* Para ver una explicación detallada de los programas de shader, consulta la [documentación de shaders](/es/manuals/shader).
...
![Archivo compute](/manuals/images/compute/compute_file.png)
...
![Archivo de render compute](/manuals/images/compute/compute_render_file.png)

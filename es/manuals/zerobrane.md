...
![Mostrar en Finder](/manuals/images/zerobrane/show_in_desktop.png)

## Configurar ZeroBrane

Para configurar ZeroBrane, selecciona <kbd>Project ▸ Project Directory ▸ Choose...</kbd>:

![Configurar](/manuals/images/zerobrane/setup.png)
...
![Iniciar depurador](/manuals/images/zerobrane/startdebug.png)

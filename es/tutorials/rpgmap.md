...
En este proyecto de ejemplo, que puedes [abrir desde el editor](/es/manuals/project-setup/) o [descargar desde GitHub](https://github.com/defold/sample-rpgmap), mostramos un método para crear mapas RPG muy grandes en Defold. El diseño se basa en las siguientes suposiciones:

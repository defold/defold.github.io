...
* Crea un [proyecto nuevo](/es/manuals/project-setup/#creating-a-new-project) desde la plantilla "Empty Project"
...
![Game rules schematic](/tutorials/images/magic-link/linker_rules.png)
...
![Folder structure](/tutorials/images/magic-link/linker_folders.png)
...
![Project settings](/tutorials/images/magic-link/linker_project_settings.png)
...
![Game scale layout](/tutorials/images/magic-link/linker_layout.png)
...
![Max sprite count](/tutorials/images/magic-link/linker_sprite_max_count.png)
...
![Add images](/tutorials/images/magic-link/linker_add_images.png)
...
![Add images to Atlas](/tutorials/images/magic-link/linker_add_to_atlas.png)
...
![Board collection](/tutorials/images/magic-link/linker_board_collection.png)

![Board collection bootstrap](/tutorials/images/magic-link/linker_bootstrap_board.png)
...
![Block game object](/tutorials/images/magic-link/linker_block.png)
...
![Block factory](/tutorials/images/magic-link/linker_blockfactory.png)

Ahora deberías poder ejecutar el juego y ver el tablero lleno de bloques de colores aleatorios:

![First screenshot](/tutorials/images/magic-link/linker_first_screenshot.png)
...
![Input bindings](/tutorials/images/magic-link/linker_input_bindings.png)
...
![Connector game object](/tutorials/images/magic-link/linker_connector.png)

![Connector factory](/tutorials/images/magic-link/linker_connector_factory.png)
...
![Connectors in game](/tutorials/images/magic-link/linker_connector_screen.png)
...
![Slide blocks down](/tutorials/images/magic-link/linker_blocks_slide.png)
...
![Cover sprite](/tutorials/images/magic-link/linker_cover.png)
...
![Magic block without and with light](/tutorials/images/magic-link/linker_magic_blocks.png)
...
![Mark regions](/tutorials/images/magic-link/linker_regions.png)
...
![First win](/tutorials/images/magic-link/linker_first_win.png)
...
![Drop](/tutorials/images/magic-link/linker_drop.png)
...
![Main menu GUI](/tutorials/images/magic-link/linker_main_menu.png)
...
El proxy de colección nos permite cargar y descargar dinámicamente colecciones en el juego en ejecución. Actúa en nombre de un archivo de colección especificado y cargamos, inicializamos, habilitamos, deshabilitamos y descargamos la colección dinámica enviando mensajes al proxy. Para una descripción completa de cómo usarlos, consulta la [documentación de Collection Proxy](/es/manuals/collection-proxy).
...
![main collection](/tutorials/images/magic-link/linker_main_collection.png)

Ahora debemos abrir *game.project* y cambiar el bootstrap *main_collection* a `/main/main.collectionc`.

![bootstrap main collection](/tutorials/images/magic-link/linker_bootstrap_main.png)
...
![board gui](/tutorials/images/magic-link/linker_board_gui.png)
...
![restart GUI](/tutorials/images/magic-link/linker_restart_gui.png)
...
![level complete dialog](/tutorials/images/magic-link/linker_level_complete_gui.png)
...
![present level GUI](/tutorials/images/magic-link/linker_present_level_gui.png)
...
![no drop room GUI](/tutorials/images/magic-link/linker_no_drop_room_gui.png)
...
![Final board collection](/tutorials/images/magic-link/linker_board_collection_final.png)
...
![Game finished](/tutorials/images/magic-link/linker_game_finished.png)

...
En este proyecto de ejemplo, que puedes [abrir desde el editor](/es/manuals/project-setup/) o [descargar desde GitHub](https://github.com/defold/sample-parallax), demostramos cómo usar un efecto de parallax para simular profundidad en el mundo del juego.

...
En este proyecto de ejemplo, que puedes [abrir desde el editor](/es/manuals/project-setup/) o [descargar desde GitHub](https://github.com/defold/sample-main-menu-animation), demostramos efectos para presentar un menú principal. El menú contiene un fondo y dos elementos de menú.

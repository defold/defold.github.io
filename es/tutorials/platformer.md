...
Si no estás seguro de cómo manejar input en Defold, hay una guía sobre eso [aquí](/es/manuals/input).
...
Consulta nuestras guías sobre [físicas](/es/manuals/physics) y [tiles](/es/manuals/2dgraphics) para más información.

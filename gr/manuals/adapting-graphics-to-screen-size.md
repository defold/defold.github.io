...
toc: ["Εισαγωγή","Πώς να αλλάξετε τον τρόπο απόδοσης του περιεχομένου σας","Ρετρό / γραφικά 8-bit","Υψηλή ρύθμιση DPI και οθόνες αμφιβληστροειδούς","Δημιουργία προσαρμοσμένου GUI","Ιδιότητες node","Διατάξεις Layouts","Δοκιμή διαφορετικών μεγεθών οθόνης"]

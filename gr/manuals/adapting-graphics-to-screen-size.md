---
brief: Αυτό το εγχειρίδιο εξηγεί πώς να προσαρμόσετε το παιχνίδι και τα γραφικά σας
  σε διαφορετικά μεγέθη οθόνης.
github: https://github.com/defold/doc
language: gr
layout: manual
title: Προσαρμογή γραφικών σε διαφορετικά μεγέθη οθόνης
toc: '["Εισαγωγή","Πώς να αλλάξετε τον τρόπο απόδοσης του περιεχομένου σας","Ρετρό
  / γραφικά 8-bit","Γραφικά υψηλής ανάλυσης","Υψηλή ρύθμιση DPI και οθόνες αμφιβληστροειδούς","Δημιουργία
  προσαρμοσμένου GUI","Ιδιότητες node","Διατάξεις Layouts","Δοκιμή διαφορετικών μεγεθών
  οθόνης"]'
---

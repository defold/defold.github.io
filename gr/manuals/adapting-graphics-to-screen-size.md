---
τίτλος: Προσαρμογή γραφικών σε διαφορετικά μεγέθη οθόνης
ενσυντομία: Αυτό το εγχειρίδιο εξηγεί πώς να προσαρμόσετε το παιχνίδι και τα γραφικά σας σε διαφορετικά μεγέθη οθόνης.
---
...
Μπορείτε να μάθετε περισσότερα σχετικά με αυτές τις ιδιότητες [in the GUI manual](/gr/manuals/gui/#node-properties).

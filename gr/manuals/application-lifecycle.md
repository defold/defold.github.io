...
toc: '["Κύκλος ζωής εφαρμογής","Αρχικοποίηση","Ο βρόχος ενημέρωσης","Είσοδος","Ενημέρωση
  - Update","Ενημέρωση απόδοσης - Render update","Δημοσίευση ενημέρωσης - Post update","Βήμα
  ρυθμού καρέ και χρόνου συλλογής","Οριστικοποίηση - Finalization"]'
---

...
Περιμένετε ώσπου η διεύθυνση URL να είναι διαθέσιμη πριν ξεκινήσετε δοκιμές προγράμματος περιήγησης. Δείτε τις [Δοκιμές προγράμματος περιήγησης για HTML5](/gr/manuals/automated-testing/#browser-tests-for-html5) για περισσότερες λεπτομέρειες.

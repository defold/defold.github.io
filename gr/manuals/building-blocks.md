---
brief: Αυτό το εγχειρίδιο σκάβει τις λεπτομέρειες του τρόπου λειτουργίας των αντικειμένων,
  των συστατικών και των συλλογών του παιχνιδιού.
github: https://github.com/defold/doc
language: gr
layout: manual
title: Τα δομικά στοιχεία του Defold
toc: '["Δομικά στοιχεία","Collections Συλλογές","Game objects Αντικείμενα Παιχνιδιού","Components
  Συστατικό","Αντικείμενα προστέθηκαν επιτόπου ή με αναφορά","Childing game objects"]'
---

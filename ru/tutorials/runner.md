...
Чтобы сделать это и корректно обрабатывать столкновения, потребуется немного векторной математики. Подробное объяснение того, как решать kinematic collisions, есть в [документации Physics](/ru/manuals/physics#resolving-kinematic-collisions).
</div>
...
5. Добавьте *Collision Object* (щёлкните правой кнопкой в *Outline* и выберите <kbd>Add Component</kbd>) и добавьте *Sphere* shape, покрывающую изображение (щёлкните правой кнопкой по компоненту и выберите <kbd>Add Shape</kbd>).

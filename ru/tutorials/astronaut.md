...
![new project](/tutorials/images/new-astronaut.png)

Редактор автоматически откроет файл "README" из корня проекта, в котором находится полный текст учебника.

![icon](/tutorials/images/icon-tutorial.svg) [Полный текст учебника также можно прочитать на Github](https://github.com/defold/tutorial-astronaut)

...
![thumbnail](/tutorials/images/snake/thumbnail.png)
...
Этот учебник рассчитан на начинающих, но если вы совсем не знакомы с Defold и разработкой игр, мы рекомендуем сначала прочитать несколько вводных руководств, особенно о [структурных элементах Defold](/ru/manuals/building-blocks/) и [глоссарий](/ru/manuals/glossary/). Если Defold еще не установлен, загляните в [руководство по установке](/ru/manuals/install/). Также стоит посмотреть [обзор редактора](/ru/manuals/editor/), чтобы быстрее освоиться в самом редакторе; в этом учебнике мы также приводим скриншоты для каждого шага.
...
![start](/tutorials/images/snake/1.png)
...
![display](/tutorials/images/snake/2.png)

Это нужно потому, что игра будет рисоваться по сетке, где каждый сегмент имеет размер 16x16 пикселей, и тогда экран не будет обрезать частичные сегменты. Файл `game.project` содержит все важные настройки проекта — подробнее о них можно прочитать в [руководстве по настройкам проекта](/ru/manuals/project-settings/).
...
![new_folder](/tutorials/images/snake/3.png)
...
![snake_sprites](/tutorials/images/snake/snake.png)
...
![new_folder](/tutorials/images/snake/4.png)

Подробнее об этом можно прочитать в руководстве по [импорту графики](/ru/manuals/importing-graphics/).

<input type="checkbox"/> Готово!

## Добавление Tile Source

В Defold есть встроенный компонент [Tilemap](/ru/manuals/tilemap/), который вы будете использовать для создания игрового поля из *тайлов*, выровненных по сетке. Tilemap позволяет задавать и читать отдельные тайлы, что идеально подходит для этой игры. Поскольку tilemap берет графику из [Tilesource](/ru/manuals/tilesource/), сначала нужно создать его:
...
![new_tilesource](/tutorials/images/snake/5.png)
...
![tilesource](/tutorials/images/snake/6.png)
...
![tilesource_properties](/tutorials/images/snake/7.png)
...
![add_tilemap](/tutorials/images/snake/8.png)
...
![set_tilesource](/tutorials/images/snake/9.png)
...
![tilemap](/tutorials/images/snake/10.png)

3. Нарисуйте рамку по краю экрана и несколько препятствий.
![tilemap_final](/tutorials/images/snake/11.png)
...
![add_game_object](/tutorials/images/snake/12.png)
...
![add_component](/tutorials/images/snake/13.png)
...
![run_game](/tutorials/images/snake/14.png)
...
![add_script](/tutorials/images/snake/15.png)
...
![main _ollection](/tutorials/images/snake/16.png)
...
![algorithm](/tutorials/images/snake/17.png)
...
![run the game](/tutorials/images/snake/snake_run_1.png)
...
![input](/tutorials/images/snake/18.png)

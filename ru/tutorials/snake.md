...
![tilesource](/tutorials/images/snake/tilesource.png)
...
![Set tilesource](/tutorials/images/snake/set_tilesource.png)
...
![tilemap](/tutorials/images/snake/tilemap.png)
...
![add game object](/tutorials/images/snake/add_game_object.png)
...
![add component](/tutorials/images/snake/add_component_file.png)
...
![main collection](/tutorials/images/snake/main_collection_no_gui.png)
...
![run the game](/tutorials/images/snake/run_1.png)
...
![input](/tutorials/images/snake/input.png)
...
Однако если змейка движется влево, а игрок *быстро* нажимает сначала <kbd>up</kbd>, а затем <kbd>right</kbd> до следующего шага змейки, сработает только нажатие <kbd>right</kbd>, и змейка всё равно повернёт в себя. А с добавленными выше условиями ввод просто будет проигнорирован. *Плохо!*

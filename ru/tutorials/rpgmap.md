...
В этом примере проекта, который можно [открыть из редактора](/ru/manuals/project-setup/) или [скачать с GitHub](https://github.com/defold/sample-rpgmap), мы показываем один из способов создания очень больших RPG-карт в Defold. Дизайн основан на следующих предположениях:

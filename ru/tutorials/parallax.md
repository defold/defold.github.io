...
В этом примере проекта, который можно [открыть из редактора](/ru/manuals/project-setup/) или [скачать с GitHub](https://github.com/defold/sample-parallax), мы показываем, как использовать эффект параллакса для имитации глубины в игровом мире.

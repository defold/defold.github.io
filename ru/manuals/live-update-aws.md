...
1. Создайте bucket для ресурсов Live update
    ...
    ![Создание bucket](/manuals/images/live-update/01-create-bucket.png)
...
2. Добавьте политику bucket'а
    ...
    ![Политика bucket'а](/manuals/images/live-update/02-bucket-policy.png)
...
3. Добавьте CORS-конфигурацию в bucket (необязательно)
    ...
    ![CORS-конфигурация](/manuals/images/live-update/03-cors-configuration.png)
...
4. Создайте IAM-политику
    ...
    ![IAM-политика](/manuals/images/live-update/04-create-policy.png)
...
6. Создайте файл профиля учетных данных
    ...
    ![Настройки Live update](/manuals/images/live-update/05-liveupdate-settings.png)
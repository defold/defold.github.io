...
toc: ["Компонент Sound","Создание звукового компонента","Воспроизведение звука","Остановка звука","Усиление","Звуковые группы","Фильтрация звуков","Манипулирование при выполнении","Конфигурация проекта"]

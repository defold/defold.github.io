...
Если вы создаете статический UI, достаточно определить callbacks, которые просто изменяют локальные переменные. Для динамических UI и более сложных взаимодействий см. раздел [реактивность](#реактивность).

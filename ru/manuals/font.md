---
brief: В этом руководстве описаны особенности работы со шрифтами и способ их вывода
  на экран в играх.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Ресурс Font
toc: '["Ресурс Font","Создание шрифта","Свойства","Шрифты Distance Field","Растровые
  шрифты BMFont","Артефакты и рекомендации","Кэш шрифта"]'
---

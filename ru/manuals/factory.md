---
brief: Это руководство объясняет, как использовать компоненты Factory для динамического
  порождения игровых объектов во время выполнения.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Компонент Factory
toc: '["Компонент Factory","Адресация объектов, созданных фабрикой","Отслеживание
  порожденных и родительских объектов","Динамическая загрузка ресурсов фабрики","Ограничения
  инстанцирования","Объединение игровых объектов в пул"]'
---

...
- anchor: symbolicate-a-callstack
  title: Генерация отладочных символов к стеку вызовов
...
## Генерация отладочных символов к стеку вызовов {#symbolicate-a-callstack}
...
* HTML5 — каталог `<project_name>_symbols` рядом с HTML5-бандлом содержит `<project_name>_wasm.js.symbols`, а если выбрана архитектура `wasm_pthread-web`, также `<project_name>_pthread_wasm.js.symbols`.

---
brief: В этом руководстве подробно описан принцип работы игровых объектов, компонентов
  и коллекций.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Структурные элементы
toc: '["Структурные элементы","Коллекции (Collections)","Игровые объекты (Game objects)","Компоненты","Объекты,
  добавленные на месте или по ссылке","Подчинение игровых объектов"]'
---

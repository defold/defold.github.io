---
brief: В этом руководстве подробно описывается жизненный цикл игр и приложений, созданных
  в Defold.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Жизненный цикл приложения
toc: '["Жизненный цикл приложения","Инициализация","Цикл обновления","Ввод","Обновление","Рендер
  обновление","Постобновление","Частота кадров и временной шаг коллекции","Финальная
  стадия"]'
---

...
toc: ["Жизненный цикл приложения","Инициализация","Цикл обновления","Ввод","Обновление","Рендер обновление","Постобновление","Частота кадров и временной шаг коллекции","Финальная стадия"]

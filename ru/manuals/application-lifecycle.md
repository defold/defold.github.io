...
![Обзор жизненного цикла](/manuals/images/application_lifecycle/application_lifecycle.png)
...
Шаги, входящие в проход ["диспетчеризации сообщений"](#диспетчеризация-сообщений), для наглядности показаны отдельной диаграммой в конце этого руководства и отмечены на схемах маленькой иконкой "конверт со стрелкой" 📩.

## Инициализация

Именно здесь запускается ваша игра. Это первый этап работающего приложения, и его можно разделить на 3 фазы:

![Инициализация](/manuals/images/application_lifecycle/initialization.png)
...
![Предварительная инициализация](/manuals/images/application_lifecycle/pre_init.png)
...
![Инициализация коллекции](/manuals/images/application_lifecycle/collection_init.png)
...
![Цикл обновления](/manuals/images/application_lifecycle/update_loop.png)
...
![Фаза Update](/manuals/images/application_lifecycle/update_phase.png)
...
Если для физической симуляции используется [fixed timestep](/ru/manuals/physics/#physics-updates), у всех script-компонентов также может вызываться функция `fixed_update()`. Она полезна в играх с физикой, когда требуется изменять физические объекты через равные интервалы времени, чтобы добиться стабильной симуляции.
...
![Фаза Render Update](/manuals/images/application_lifecycle/render_update_phase.png)
...
![Фаза Post Update](/manuals/images/application_lifecycle/post_update_phase.png)
...
![Фаза Render](/manuals/images/application_lifecycle/render_phase.png)

После этого отрисовывается графика, а также визуальный профайлер (см. [руководство по отладке](/ru/manuals/debugging)). По завершении рендеринга графики выполняется захват видео.
...
(Подробности см. в [руководстве по Collection Proxy](/ru/manuals/collection-proxy) и в описании [`set_time_step`](/ref/collectionproxy#set-time-step))
...
![Финализация](/manuals/images/application_lifecycle/finalization.png)
...
![Диспетчеризация сообщений](/manuals/images/application_lifecycle/dispatch_messages.png)

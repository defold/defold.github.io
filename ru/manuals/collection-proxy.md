---
brief: Это руководство объясняет, как динамически создавать новые игровые пространства
  и переключаться между ними.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Компонент Collection Proxy
toc: '["Компонент Collection Proxy","Создание компонента Collection Proxy","Загрузочная
  коллекция","Загрузка коллекции","Отправка сообщений в новый игровой мир","Выгрузка
  мира","Временной шаг","Предостережения и общие проблемы"]'
---

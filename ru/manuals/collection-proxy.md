...
toc: ["Компонент Collection Proxy","Создание компонента Collection Proxy","Загрузочная коллекция","Загрузка коллекции","Отправка сообщений в новый игровой мир","Выгрузка мира","Временной шаг","Предостережения и общие проблемы"]

...
Он отделён от [сервера редактора](/ru/manuals/editor-http-api), который принадлежит редактору Defold и управляет открытым проектом.
...
![Информация о порте сервиса движка в отладочной сборке Defold](/manuals/images/automation/engine-service.png)
...
![Доступ к серверу движка](/manuals/images/automation/engine-server.png)
...
Скрипты среды выполнения, физика, ввод, динамически создаваемые объекты и платформенный рендеринг требуют запущенного движка и должны проверяться с помощью [автоматизированного тестирования среды выполнения](/ru/manuals/automated-testing).

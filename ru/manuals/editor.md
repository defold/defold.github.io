...
- [2D- и 3D-навигация по сцене](/ru/manuals/scene-editing/) с ортографической и перспективной камерами.
- [Инструменты трансформации](/ru/manuals/scene-editing/) для перемещения, вращения и масштабирования объектов.
- [Режим свободной камеры](/ru/manuals/scene-editing/) для навигации в 3D от первого лица.
- [Настройки сетки](/ru/manuals/scene-editing/) с настраиваемым размером, плоскостью и внешним видом.
- [Фильтры видимости](/ru/manuals/scene-editing/) для включения и выключения типов компонентов и направляющих.

Подробнее см. в [руководстве по редактору сцены](/ru/manuals/scene-editing/).
...
: Используется при редактировании кривых в [редакторе частиц (Particle Editor)](/ru/manuals/particlefx/).

Панель Инструменты (Tools) также используется для работы с интегрированным отладчиком (debugger). Подробнее об этом можно прочитать в [Pуководстве по отладке](/ru/manuals/debugging/).

### 6. Панель изменённые файлы (Changed Files)

Если проект использует систему контроля версий Git, здесь отображаются изменённые, добавленные или удалённые файлы. Регулярная синхронизация позволяет держать проект в актуальном состоянии. Это позволяет удобно работать в команде и не потерять свою работу в случае сбоя. Подробнее читайте в [руководстве по контролю версий](/ru/manuals/version-control/). Доступны действия:
...
- выбрать `➝| Открыть как` (Open As) — открыть файл в другом, отличном от стандартного, редакторе или во внешнем инструменте, указанном в настройках `Файл ▸ Настройки ▸ Код ▸ Пользовательский редактор` (`File ▸ Preferences ▸ Code ▸ Custom Editor`). Подробнее см. [руководство по настройкам редактора](/ru/manuals/editor-preferences).
...
Подробнее читайте в [руководстве по получению помощи](/ru/manuals/getting-help/#getting-help).
...
Внешний вид редактора можно изменять с помощью пользовательских тем и стилей. Подробнее см. [руководство по оформлению редактора](/ru/manuals/editor-styling.md).

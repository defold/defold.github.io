...
toc: ["Обзор редактора Defold","Запуск редактора","Панели редактора","Двухпанельное редактирование","Редактор сцен","Создание новых файлов проекта","Импортирование файлов в проект","Обновление редактора","Клавиатурные сокращения","Сокращения по умолчанию","Кастомизация сокращений","Журнал событий редактора","FAQ"]

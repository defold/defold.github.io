---
brief: В этом руководстве описаны некоторые подробности о системе сборки, используемой
  для нативных расширений.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Нативные расширения - Подробнее
toc: '["Настройка сборки для Defold","C++ версия","Toolchain","Версии SDK","C++ версия
  + ABI совместимость","Win32 + Clang","Статическая связка","Никаких исключений из
  C++"]'
---

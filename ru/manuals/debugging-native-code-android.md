...
Здесь мы перечислим ряд способов отладки вашей сборки, используя [Android Studio](https://developer.android.com/studio/), официальную IDE для операционной системы Android от Google.
...
Сопоставления путей хранятся в проекте `.iml` в проекте Android Studio.

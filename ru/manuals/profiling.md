...
Обратитесь к [справочнику по API профилировщика](/ref/profiler/) для получения дополнительной информации о функциях профилировщика. 
...
[Параметр Max Sample Count](/ru/manuals/project-settings/#max-sample-count) ограничивает число выборок профайлера, записываемых в каждом потоке за кадр. Если профайлер сообщает о превышении предела, сначала проверьте код профилирования нативных расширений на незакрытую пару начала/конца области. Увеличивайте предел только в том случае, если допустимый кадр действительно содержит больше областей, чем разрешено текущим значением.
</div>

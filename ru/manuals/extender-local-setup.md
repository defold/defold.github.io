...
toc: '["Установка локального сервера сборки","Как запустить локальный сервер сборки
  с готовыми артефактами","Предустановки","Как использовать готовые образы Docker"]'
---

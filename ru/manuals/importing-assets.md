---
brief: В этом руководстве рассказывается о том, как импортировать и редактировать
  ассеты.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Импортирование ассетов
toc: '["Импортирование ассетов","Импортирование ассетов","Использование ассетов","Редактирование
  внешних ассетов","Редактирование ассетов Defold"]'
---

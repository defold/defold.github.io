...
: Укажите в этом свойстве материал, который подходит для текстурированного 3D-объекта. В качестве отправной точки можно использовать несколько встроенных материалов:
  ...
  * Используйте *model_instances.material* для статических инстансируемых моделей
  * Используйте *model_skinned.material* для скинненных (анимированных) неинстансируемых моделей
  * Используйте *model_skinned_instances.material* для скинненных (анимированных) инстансируемых моделей

...
![Показать в Finder](/manuals/images/zerobrane/show_in_desktop.png)

## Настройка ZeroBrane

Чтобы настроить ZeroBrane, выберите <kbd>Project ▸ Project Directory ▸ Choose...</kbd>:

![Настройка](/manuals/images/zerobrane/setup.png)
...
![Запуск отладчика](/manuals/images/zerobrane/startdebug.png)
...
![Пошаговое выполнение](/manuals/images/zerobrane/code.png)
...
![Другие рекомендуемые настройки](/manuals/images/zerobrane/otherrecommended.png)
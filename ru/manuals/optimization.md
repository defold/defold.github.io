---
brief: В этом руководстве описывается, как оптимизировать Defold приложение по размеру
  и производительности.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Оптимизация игры на Defold
toc: '["Оптимизация игры на Defold","Оптимизация размера приложения","Уменьшение размера
  движка","Оптимизация звуков","Оптимизация графики","Исключение контента для загрузки
  по запросу","Оптимизации размера специфичные для Android","Оптимизация скорости
  приложения","Уменьшение времени выполнения скрипта","Сократите время, необходимое
  для рендеринга кадра","Снижение сложности графа сцены","Оптимизация использования
  памяти","Оптимизация использования батареи"]'
---

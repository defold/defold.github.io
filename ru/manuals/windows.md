...
Специфичная для Windows конфигурация приложения выполняется в разделе [Windows](/ru/manuals/project-settings/#windows) файла настроек *game.project*.
...
## FAQ
{% include shared/ru/windows-faq.md %}
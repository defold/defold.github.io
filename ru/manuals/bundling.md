...
Создание бандла для Linux не требует специальной настройки и дополнительной конфигурации для конкретной платформы в [файле настроек проекта][project settings file](/ru/manuals/project-settings/) *game.project*.
...
* По умолчанию релизные сборки не содержат [профайлер](/ru/manuals/profiling). Чтобы включить поддержку профайлера как в отладочных, так и в релизных сборках, установите для параметра **Profiler** значение **Always** в [манифесте приложения](/ru/manuals/app-manifest/#profiler).
* Релизные сборки не содержат [запись экрана](/ref/sys/#start_record)

...
Редактор — графическое настольное приложение. Запускайте его в интерактивном пользовательском сеансе с доступом к дисплею. Если графический сеанс недоступен, например в headless-CI, либо для автоматизации только компиляции и создания автономных бандлов, используйте [Bob](/ru/manuals/bob).
...
Перед запуском браузерных тестов дождитесь доступности URL. Подробнее см. в разделе [Браузерные тесты для HTML5](/ru/manuals/automated-testing/#browser-tests-for-html5).

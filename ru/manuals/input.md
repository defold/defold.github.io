...
toc: ["Устройтво ввода","Настройка привязок ввода","Типы триггеров","Ввод с акселерометра","Фокус ввода","Отправка ввода и on_input()","Фокус ввода и компоненты прокси-коллекций","Освобождение ввода","Обработка ввода"]

...
toc: ["Перезагрузка ресурсов на лету","Как сделать горячую перезагрузку","Горячая перезагрузка на устройстве","Перезагрузка скриптов","Перезагрузка Lua модулей","Функция on_reload()"]

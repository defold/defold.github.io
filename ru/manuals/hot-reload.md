---
brief: В этом руководстве объясняется функция горячей перезагрузки (перезагрузки на
  лету) в Defold.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Горячая перезагрузка
toc: '["Перезагрузка ресурсов на лету","Как сделать горячую перезагрузку","Горячая
  перезагрузка на устройстве","Перезагрузка скриптов","Перезагрузка Lua модулей","Функция
  on_reload()","Перезагрузка кода шейдера"]'
---

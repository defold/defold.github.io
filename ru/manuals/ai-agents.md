...
* [Скрипты редактора](/ru/manuals/editor-scripts) могут предоставлять операции с ресурсами и инструменты, специфичные для проекта.
* [HTTP API редактора](/ru/manuals/editor-http-api) предоставляет команды редактора, результаты сборки, вывод консоли, поиск по справочнику, предпросмотры, настройки и маршруты скриптов редактора.
* [Сервис движка и API автоматизации среды выполнения](/ru/manuals/engine-service) предоставляют состояние работающего отладочного движка, ввод, снимки экрана и операции, определяемые расширениями.
* [Bob](/ru/manuals/bob) выполняет сборки из командной строки, создаёт отчёты, архивы и бандлы.
...
Агенты должны следовать тому же [циклу инспекции, изменения, проверки и оценки](/ru/manuals/automation/#the-automation-loop), что и любая другая автоматизация.
...
Хорошие практики автоматизированного тестирования и проверки описаны в [этом руководстве](/ru/manuals/automated-testing).

## Мультимодальная оценка {#multimodal-evaluation}

Агент с возможностью обработки изображений может исследовать [предпросмотры редактора](/ru/manuals/editor-http-api/#rendering-scene-previews), снимки экрана среды выполнения, визуальные различия и снимки браузера.
...
Подробнее о предпросмотрах редактора, снимках экрана среды выполнения и визуальной инспекции читайте в [этом руководстве](/ru/manuals/automated-testing).

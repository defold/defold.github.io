...
toc: ["Логи игры и системный лог","Чтение лога игры из редактора","Чтение лога игры с терминала","Чтение логов игры и системных логов с помощью инструментов, специфичных для платформы","HTML5","Android","iOS"]

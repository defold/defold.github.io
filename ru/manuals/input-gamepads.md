...
toc: '["Геймпады","Цифровые кнопки","Аналоговые стики","Несколько геймпадов","Соеденение
  и разоедининение","Нефильтрованые данные с геймпада","Файл настроек геймпадов","Неопознанные
  геймпады","Геймпады в HTML5","Геймпады на Android"]'
---

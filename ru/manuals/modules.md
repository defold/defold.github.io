---
brief: Lua-модули позволяют структурировать проект и создавать многократно используемый
  библиотечный код. Данное руководство объясняет, как это делается в Defold.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Lua-модули
toc: '["Lua-модули","Запрос Lua-файла","Модули","Горячая перезагрузка модулей","Модули
  и состояние"]'
---

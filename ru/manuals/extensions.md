...
toc: ["Нативные расширения","Платформа для сборки","Планировка проекта","Файлы манифеста","Совместное использование расширения","Простой пример расширения","C++ symbol in your extension","Жизненный цикл расширения","Определенные идентификаторы платформы","Построение журналов сервера","Файл ext.manifest","Разрешенные ключи","Примеры расширений"]

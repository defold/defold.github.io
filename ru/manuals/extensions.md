...
toc: ["Нативные расширения","Платформа для сборки","Планировка проекта","Файлы манифеста","Совместное использование расширения","Простой пример расширения","C++ symbol in your extension","Разрешенные ключи","Примеры расширений"]

...
![Model](/manuals/images/icons/model.png) С помощью компонента 3D-модели можно импортировать в игру glTF-сетку, скелет и анимационные ассеты. За подробностями обращайтесь к [руководству по моделям](/ru/manuals/model/).
...
![Sound](/manuals/images/icons/sound.png) Звук --- это компонент, отвечающий за воспроизведение определённого звука. Defold поддерживает файлы WAV, Ogg Vorbis и Ogg Opus. Поддержку Opus необходимо включить в манифесте приложения. За подробностями обращайтесь к [руководству по звукам](/ru/manuals/sound).

---
brief: В этом руководстве описано, как создавать GUI-ноды, которые маскируют другие
  ноды с помощью трафаретного клипирования.
github: https://github.com/defold/doc
language: ru
layout: manual
title: GUI-клипирование
toc: '["GUI-клипирование","Создание ноды клипирования","Трафаретная маска","Ограничения
  по использованию трафарета","Слои"]'
---

---
brief: Это руководство вкратце знакомит с основами программирования на Lua в целом
  и с тем, что необходимо учитывать при работе с Lua в Defold.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Lua в Defold
toc: '["Lua в Defold","Версии Lua","Стандартные библиотеки и расширения","Книги по
  Lua и ресурсы","Онлайн ресурсы","Книги","Синтаксис","Переменные и типы данных","Операторы","Управление
  потоком","Локальные, глобальные и лексические области видимости","Затенение переменной","Корутины","Lua-контексты
  в Defold","Советы производительности","Память и сборка мусора","Лучшие методы работы"]'
---

...
При отправке запроса можно задавать дополнительные заголовки. Например, это можно использовать для установки заголовка `Authorization` или `Content-Type`, чтобы сообщить серверу, в каком формате отправлены данные.

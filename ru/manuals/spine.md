...
*Spine модель*
: Комнонент _SpineModel_ вставляется в игровой объект чтобы вывести графику и аниммацию на экран. Компонент состоит из скелета-иерархии игровых объектов, указания, которую из анимаций проигрывать, указания, какой применять скин, а также он задает материал, который будет задействован для рендеринга модели. Смотрите [документацию по SpineModel](/ru/manuals/spinemodel) для подробностей.

*Spine Нода*
: В случае GUI сцены для Spine-анимации, используйте Spine GUI ноды вместо компонентов типа Spine модель. Смотрите [документацию по GUI spine](/ru/manuals/gui-spine) для подробностей.
...
- Создайте _Atlas_ файл и добавьте туда все изображения. (Смотрите [документацию по 2D графике](/ru/manuals/2dgraphics) чтобы детальнее понять, как создаются атласы, а также смотрите ниже ряд предостережений)
...
Когда у вас есть все нужные импортированные данные и ваш ресурс-файл _Spine scene_ готов, вы можете создать компонент SpineModel. Смотрите [документацию по SpineModel](/ru/manuals/spinemodel) для подробностей.

## Создание Spine GUI-нод

Вы также можете использовать Spine анимации в GUI сценах. Смотрите [документацию по GUI spine](/ru/manuals/gui-spine) для подробностей.
...
В дополнении к использованию метода `spine.play_anim()` для более продвинутой анимации модели компоненты типа *Spine Model* предоставляют свойство "cursor" которым можно управлять с помощью вызова `go.animate()` (более подробно в разделе [анимация свойств](/ru/manuals/property-animation)):
...
Далее для анимирования вашей Spine модели, пожалуйста прочтите [документацию по анимации](/ru/manuals/animation).

...
Когда исключенный контент скачивается и подготавливается к использованию в игре, движок проверяет этот контент перед использованием. Проверка состоит из нескольких этапов:
...
Подробнее об этом процессе можно прочитать в [руководстве по Live Update](https://defold.com/ru/manuals/live-update/#content-verification).
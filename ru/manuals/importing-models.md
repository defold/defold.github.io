...
toc: ["Импортирование 3D-моделей","Экспортирование в формат Collada","Требования","Объединение нескольких полигональных сеток","Удаление материалов","Экспортирование текстуры","Экспортирование с помощью Blender","Импортирование в Defold","Использование модели"]

...
layout: manual
title: Адресация
toc: '["Адресация","Идентификаторы","Коллекции","Относительная адресация","Сокращения","Пути
  игровых объектов","Абсолютная адресация","Хэшированные идентификаторы","URL","Получение
  URL-объектов"]'
---

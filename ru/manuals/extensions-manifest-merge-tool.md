...
toc: ["Манифесты приложений","Именования и Структуры","Android","Пример","iOS / macOS","Пример","HTML5","Пример"]
...
Мы рекомендуем использовать: `<uses-sdk android:targetSdkVersion=“{% raw %}{{android.target_sdk_version}}{% endraw %}” />`
</div>
### Пример

...
- anchor: rich-text-markup
  title: Форматированная текстовая разметка
...
- anchor: interaction-messages
  title: Сообщения взаимодействия
- anchor: named-styles
  title: Именованные стили
- anchor: layout-object-api
  title: API объектов раскладки
...
- anchor: returned-object-fields
  title: Поля возвращаемых объектов
- anchor: lua-example
  title: Пример Lua
- anchor: useful-combinations
  title: Полезные сочетания
- anchor: colored-outline-with-a-horizontal-gradient
  title: Цветная обводка с горизонтальным градиентом
- anchor: shake-a-sentence-gradient-one-word
  title: Тряска предложения и градиент для одного слова
- anchor: override-one-property-without-losing-the-others
  title: Переопределение одного свойства с сохранением остальных
---
...
![Пример текста непрозрачного зелёного цвета](/manuals/images/richtext/color_green.webp)
...
![Пример зелёного текста с половинной непрозрачностью](/manuals/images/richtext/color_green_alpha.webp)
...
![Пример текста размером 24 пикселя](/manuals/images/richtext/size_24.webp)
...
![Пример текста размером 120 процентов от 32 пикселей](/manuals/images/richtext/size_120.webp)
...
![Пример текста вдвое больше базового размера 32 пикселя](/manuals/images/richtext/size_2em.webp)
...
![Пример текста с горизонтальным градиентом от пурпурного к белому](/manuals/images/richtext/gradient_horizontal.webp)
...
![Пример текста с вертикальным синим градиентом](/manuals/images/richtext/gradient_vertical.webp)
...
![Пример текста с градиентом по четырём углам каждого глифа](/manuals/images/richtext/gradient_four_glyph.webp)
...
![Пример текста с градиентом по четырём углам всего фрагмента](/manuals/images/richtext/gradient_four_text.webp)
...
![Анимированный перетекающий градиент для каждого глифа](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![Анимированный перетекающий градиент для всего фрагмента](/manuals/images/richtext/gradient_flow_span.webp)
...
![Пример текста со сплошным подчёркиванием](/manuals/images/richtext/underline_solid.webp)
...
![Пример текста со штриховым подчёркиванием](/manuals/images/richtext/underline_dashed.webp)
...
![Пример текста с градиентным подчёркиванием](/manuals/images/richtext/underline_gradient.webp)
...
![Пример текста, перечёркнутого сплошной линией](/manuals/images/richtext/strike_solid.webp)
...
![Пример текста, перечёркнутого штриховой линией](/manuals/images/richtext/strike_dashed.webp)
...
![Пример текста с внешней чёрной обводкой](/manuals/images/richtext/outline.webp)
...
![Пример текста со смещённой тенью](/manuals/images/richtext/shadow.webp)
...
![Пример текста с анимированной тряской каждого глифа](/manuals/images/richtext/shake_glyph.webp)
...
![Пример текста с анимированной тряской всего фрагмента](/manuals/images/richtext/shake_span.webp)
...
![Пример текста с анимированной волной для каждого глифа](/manuals/images/richtext/wave_glyph.webp)
...
![Пример текста, движущегося как один анимированный фрагмент](/manuals/images/richtext/wave_span.webp)
...
![Логотип Defold, отрисованный в строке с текстом](/manuals/images/richtext/sprite.webp)
...
![www.defold.com со стандартным стилем ссылки и подчёркиванием](/manuals/images/richtext/link.webp)
...
Подробнее о настройке см. в разделах [Фокус ввода](/ru/manuals/input/#input-focus) и [Ввод с помощью мыши и касаний](/ru/manuals/input-mouse-and-touch).

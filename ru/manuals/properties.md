...
| *scale.xy* | Локальный неравномерный масштаб игрового объекта, выраженный в виде вектора, где каждая компонента содержит множитель вдоль оси X и Y. | `vector3` | `get+set` |

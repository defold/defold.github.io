...
toc: ["Компонент Particle FX","Создание эффекта","Предпросмотр эффекта","Свойства эмиттера","Режимы наложения","Программируемые свойства эмиттера","Модификаторы","Свойства модификатора","Управление эффектом частиц"]

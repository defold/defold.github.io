---
brief: Это руководство объясняет, как работает компонент Particle FX и как его редактировать
  для создания визуальных эффектов частиц.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Компонент Particle FX
toc: '["Компонент Particle FX","Создание эффекта","Предпросмотр эффекта","Свойства
  эмиттера","Режимы наложения","Программируемые свойства эмиттера","Модификаторы","Свойства
  модификатора","Управление эффектом частиц","Константы материала","Конфигурация проекта"]'
---

...
toc: ["Введение","Как изменить способ отображения вашего контента","Ретро/8-битная графика","Графика высокого разрешения","Настройка высокого разрешения и Retina экраны","Создание адаптивного графического интерфейса","Свойства нод","Компоновки","Тестирование экранов разных размеров"]

---
brief: В этом руководстве объясняется, как адаптировать игру и графику к разным размерам
  экрана.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Адаптация графики к разным размерам экрана
toc: '["Введение","Как изменить способ отображения вашего контента","Ретро/8-битная
  графика","Графика высокого разрешения","Настройка высокого разрешения и Retina экраны","Создание
  адаптивного графического интерфейса","Свойства нод","Компоновки","Тестирование экранов
  разных размеров"]'
---

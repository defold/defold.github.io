...
Редактор поддерживает подмножество [Language Server Protocol](https://microsoft.github.io/language-server-protocol/): диагностику (предупреждения линтера), автодополнение, информацию при наведении, символы документа в панели Structure, переход к определению, поиск ссылок и переименование символов. Наведите курсор на символ, чтобы увидеть информацию от языкового сервера. Установив курсор на символ, нажмите <kbd>F2</kbd>, чтобы переименовать его, <kbd>F12</kbd>, чтобы перейти к определению, или <kbd>Shift+F12</kbd>, чтобы найти ссылки. Эти действия также доступны в меню <kbd>Edit</kbd>.

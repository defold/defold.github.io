...
toc: ["Скрипты редактора","Время выполнения скрипта редактора","Анатомия .editor_script","Действия","Отменяемые действия","Действие при смешивании и побочные эффекты","Хуки жизненного цикла"]

...
toc: ["Скрипты редактора","Время выполнения скрипта редактора","Анатомия `.editor_script`","API редактора","Команды","Действия","Отменяемые действия","Неотменяемые действия","Действие при смешивании и побочные эффекты","Хуки жизненного цикла","Скрипты редактора в библиотеках"]

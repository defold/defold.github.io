...
toc: ["Компоненты игрового объекта","Типы компонентов","Включение и отключение компонентов","Свойства компонента","Позиция, вращение и масштаб компонента","Порядок отрисовки компонентов","Предикаты рендер-скрипта","Значение по оси Z"]

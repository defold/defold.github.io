---
brief: Данное руководство объясняет как работать с материалами, шейдерными константами
  и сэмплерами.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Материалы
toc: '["Материалы","Создание материала","Вершинные и фрагментные константы","Сэмплеры","Настройки
  сэмплера","Буферы констант"]'
---

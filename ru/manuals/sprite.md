---
brief: Данное руководство описывает, как отображать 2D изображения и анимацию с помощью
  компонента Sprite.
github: https://github.com/defold/doc
language: ru
layout: manual
title: Компонент Sprite
toc: '["Компонент Sprite","Свойства спрайта","Режим наложения","Манипулирование при
  выполнении","Константы материала","Конфигурация проекта"]'
---

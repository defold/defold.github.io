...
W tym przykładowym projekcie, który możesz [otworzyć w edytorze](/pl/manuals/project-setup/) lub [pobrać z GitHub](https://github.com/defold/sample-hud), pokazujemy efekty związane ze zliczaniem punktów. Punkty pojawiają się losowo na ekranie, co symuluje grę, w której gracz zdobywa punkty w różnych miejscach.

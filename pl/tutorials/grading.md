...
Zakładamy, że swobodnie poruszasz się po edytorze Defold oraz masz podstawową wiedzę o shaderach GL i pipeline renderowania Defold. Jeśli chcesz uzupełnić wiedzę na te tematy, zajrzyj do [instrukcji Shader](/pl/manuals/shader/) oraz [instrukcji Render](/pl/manuals/render/).
...
Możesz zastąpić program shaderów komponentu innym, który modyfikuje dane pikseli albo programowo tworzy zupełnie nowe kolory pikseli. [Samouczek Shadertoy](/pl/tutorials/shadertoy) pokazuje, jak to zrobić.
...
![Cel renderowania](/tutorials/images/grading/render_target.png)
...
3. Otwórz *grade.render* i ustaw jego właściwość *Script* na "/main/grade.render_script".
   ...
   ![Plik grade.render](/tutorials/images/grading/grade_render.png)

4. Otwórz *game.project* i ustaw *Render* na "/main/grade.render".

   ![Plik game.project](/tutorials/images/grading/game_project.png)
...
6. Dodaj *Tag* o nazwie "`grade`". W skrypcie do renderowania utworzymy nowy *render predicate* pasujący do tego tagu, aby narysować quada.
    ...
    ![Plik grade.material](/tutorials/images/grading/grade_material.png)
...
7. Otwórz *`main.collection`*, zaznacz komponent modelu w obiekcie gry "`grade`" i ustaw jego właściwość *Material* na "`/main/grade.material`".
   ...
   ![Właściwości modelu](/tutorials/images/grading/model_properties.png)
...
![Gra po desaturacji](/tutorials/images/grading/desaturated_game.png)
...
![Sześcian kolorów](/tutorials/images/grading/color_cube.png)
...
![Korekcja kolorów na render target](/tutorials/images/grading/render_target_grading.png)
...
![Tekstura LUT](/tutorials/images/grading/lut.png)
...
![Tabela LUT](/tutorials/images/grading/lut_lookup.png)
...
![Filtrowanie tabeli LUT](/tutorials/images/grading/lut_filtering.png)
...
3. Ustaw właściwość *`Filter min`* na `FILTER_MODE_MIN_LINEAR`, a właściwość *`Filter mag`* na `FILTER_MODE_MAG_LINEAR`.
    ...
    ![Sampler tabeli LUT](/tutorials/images/grading/material_lut_sampler.png)

4. Pobierz poniższą teksturę lookup table (*`lut16.png`*) i dodaj ją do projektu.

    ![16-kolorowa tabela LUT](/tutorials/images/grading/lut16.png)

5. Otwórz *`main.collection`* i ustaw właściwość tekstury *`lut`* na pobraną teksturę lookup.

    ![Tabela LUT dla modelu quada](/tutorials/images/grading/quad_lut.png)
...
![Świat w oryginalnej kolorystyce](/tutorials/images/grading/world_original.png)
...
![Pasmowanie kanału niebieskiego](/tutorials/images/grading/blue_banding.png)
...
![Kanał niebieski bez pasmowania](/tutorials/images/grading/blue_no_banding.png)
...
![Świat w Affinity](/tutorials/images/grading/world_graded_affinity.png)
...
![Świat po gradingu](/tutorials/images/grading/world_graded.png)

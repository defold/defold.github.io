...
Jeśli potrzebujesz wprowadzenia do programowania w Lua, zajrzyj do naszego [podręcznika Lua w Defold](/pl/manuals/lua).
...
Gdy edytor jest już zainstalowany i uruchomiony, pora utworzyć nowy projekt i przygotować go do pracy. Utwórz [nowy projekt](/pl/manuals/project-setup/#creating-a-new-project) z szablonu "Empty Project".
...
![Widok edytora](/tutorials/images/runner/1/editor2_overview.png)
...
![Budowanie](/tutorials/images/runner/1/build_and_launch.png)
...
![Plik z niezapisanymi zmianami](/tutorials/images/runner/1/file_changed.png)
</div>
...
![Kliknij prawym przyciskiem i skopiuj link do wydania](/tutorials/images/runner/extension-spine-releases.png)

Dodaj link do wydania do listy [zależności game.project](/pl/manuals/libraries/#setting-up-library-dependencies). Gdy rozszerzenie Spine zostanie dodane, musisz też zrestartować edytor, aby aktywować integrację edytora dołączoną do Spine Extension.
...
2. Utwórz nowy plik *Atlas*, który będzie przechowywał tekstury podłoża (kliknij prawym przyciskiem odpowiedni folder, na przykład folder *main*, w *Assets pane* i wybierz <kbd>New ▸ Atlas File</kbd>). Nazwij plik atlasu *level.atlas*.
  ...
  <div class='sidenote' markdown='1'>
  *Atlas* to plik, który łączy zestaw oddzielnych obrazów w jeden większy plik graficzny. Robi się tak, aby oszczędzić miejsce i poprawić wydajność. Więcej o atlasach i innych funkcjach grafiki 2D przeczytasz w [dokumentacji grafiki 2D](/pl/manuals/2dgraphics).
  </div>
...
3. Dodaj obrazy podłoża do nowego atlasu, klikając prawym przyciskiem korzeń atlasu w *Outline* i wybierając <kbd>Add Images</kbd>. Wybierz zaimportowane obrazy i kliknij *OK*. Każdy obraz w atlasie jest teraz dostępny jako jednoramkowa animacja (obraz statyczny), której można używać w sprite'ach, efektach cząsteczkowych i innych elementach wizualnych. Zapisz plik.
  ...
  ![Utwórz nowy atlas](/tutorials/images/runner/1/new_atlas.png)

  ![Dodaj obrazy do atlasu](/tutorials/images/runner/1/add_images_to_atlas.png)
...
5. Do każdego obiektu dodaj komponent sprite (kliknij prawym przyciskiem obiekt gry w widoku *Outline* i wybierz <kbd>Add Component</kbd>, następnie wybierz *Sprite* i kliknij *OK*), ustaw właściwość *Image* komponentu sprite na właśnie utworzony atlas i ustaw domyślną animację sprite'a na jeden z dwóch obrazów podłoża. Ustaw pozycję X _komponentu sprite_ (nie obiektu gry) na 190, a pozycję Y na 40. Ponieważ szerokość obrazu wynosi 380 pikseli i przesuwamy go w bok o połowę tej wartości, punkt zakotwiczenia obiektu gry znajdzie się na lewej krawędzi obrazu sprite'a.
  ...
  ![Utwórz kolekcję podłoża](/tutorials/images/runner/1/ground_collection.png)
...
6. Grafika, której używamy, jest trochę za duża, więc przeskaluj każdy obiekt gry do 60% (skalowanie 0.6 w X i Y, co daje fragmenty podłoża o szerokości 228 pikseli).
  ...
  ![Skalowanie podłoża](/tutorials/images/runner/1/scale_ground.png)
...
9. Uruchom grę (<kbd>Project ▸ Build</kbd>), aby sprawdzić, że wszystko jest na miejscu.
  ...
  ![Nieruchome podłoże](/tutorials/images/runner/1/still_ground.png)
...
Na razie te opisy prawdopodobnie wystarczą. Znacznie pełniejsze omówienie tych kwestii znajdziesz jednak w [podręczniku o blokach budujących](/pl/manuals/building-blocks). Warto zajrzeć do niego później, aby lepiej zrozumieć, jak rzeczy działają w Defold.
...
Defold dodaje do Lua zestaw API, a także system _przekazywania wiadomości_, który pozwala programować komunikację między obiektami gry. Szczegóły działania znajdziesz w [podręczniku o przekazywaniu wiadomości](/pl/manuals/message-passing).
</div>
...
![Kontroler podłoża](/tutorials/images/runner/1/ground_controller.png)
...
![Atlas bohatera](/tutorials/images/runner/2/hero_atlas.png)
...
![Scena Spine bohatera](/tutorials/images/runner/2/hero_spinescene.png)
...
![Właściwości Spine Model](/tutorials/images/runner/2/spinemodel_properties.png)
...
<div class='sidenote' markdown='1'>
Kolizja "Kinematic" oznacza, że chcemy rejestrować zderzenia, ale silnik fizyki nie będzie automatycznie rozwiązywał kolizji ani symulował obiektów. Silnik fizyki obsługuje kilka różnych typów obiektów kolizji. Więcej o nich przeczytasz w [dokumentacji fizyki](/pl/manuals/physics).
</div>
...
![Obiekt gry bohatera](/tutorials/images/runner/2/hero_game_object.png)
...
![Wiązania wejść](/tutorials/images/runner/2/input_bindings.png)
...
![Właściwość skryptu](/tutorials/images/runner/2/script_property.png)
...
![Dodaj kod podłoża](/tutorials/images/runner/insert_ground_code.png)
...
![Kolizja podłoża](/tutorials/images/runner/2/ground_collision.png)
...
![Platforma](/tutorials/images/runner/2/platform_long.png)
...
![Uruchomiona gra](/tutorials/images/runner/2/run_game.png)
...
![Wstaw kod bohatera](/tutorials/images/runner/insert_hero_code.png)
...
8. Zapisz plik.
    ...
    ![Kolce platformy](/tutorials/images/runner/3/danger_edges.png)

9. Otwórz *hero.go*, zaznacz *Collision Object* i dodaj nazwę "danger" do właściwości *Mask*. Następnie zapisz plik.

    ![Kolizja bohatera](/tutorials/images/runner/3/hero_collision.png)
...
3. Otwórz *platform.script* i zmodyfikuj go tak, aby zamiast po prostu usuwać platformę, która dotarła do lewego skraju, wysyłał do kontrolera poziomu wiadomość z prośbą o usunięcie platformy:
    ...
    ![Wstaw kod platformy](/tutorials/images/runner/insert_platform_code.png)
...
![Wstaw kod bohatera 2](/tutorials/images/runner/insert_hero_code_2.png)
...
10. Dodaj plik skryptu jako komponent *Script* do obiektu monety (kliknij prawym przyciskiem korzeń w *Outline* i wybierz <kbd>Add Component from File</kbd>).
    ...
    ![Obiekt gry monety](/tutorials/images/runner/3/coin.png)
...
![Fabryka monet](/tutorials/images/runner/3/coin_factory.png)
...
![Wstaw kod kontrolera](/tutorials/images/runner/insert_controller_code.png)
...
> Pobierz ukończoną wersję projektu [tutaj](/tutorials/images/runner/sample-runner.zip)

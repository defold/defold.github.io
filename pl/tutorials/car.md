...
![Nowy projekt](/tutorials/images/new_empty.png)
...
Zacznij od utworzenia [nowego projektu](/pl/manuals/project-setup/) i otwarcia go w edytorze. Jeśli dwukrotnie klikniesz plik *main/main.collection*, zostanie on otwarty w edytorze:
...
Changed Files
: Zawiera pliki dodane, zmodyfikowane, przemianowane lub usunięte lokalnie w porównaniu z bieżącym commitem Git. Możesz tutaj wyświetlać tekstowe diffy i cofać lokalne zmiany. Do synchronizacji ze zdalnym repozytorium użyj zewnętrznego klienta Git lub wiersza poleceń.
...
![Budowanie](/tutorials/images/car/start_build_and_launch.png)
...
![Plik z niezapisanymi zmianami](/tutorials/images/car/file_changed.png)
</div>
...
![Nowy plik kolekcji](/tutorials/images/car/start_new_collection.png)
...
![Dodawanie obiektu gry samochodu](/tutorials/images/car/start_add_car_gameobject.png)
...
![Dodawanie komponentu samochodu](/tutorials/images/car/start_add_car_component.png)
...
![Obraz samochodu](/tutorials/images/car/start_car.png)
![Obraz opony](/tutorials/images/car/start_tire.png)

Dodaj te obrazy do atlasu:

![Atlas sprite'ów](/tutorials/images/car/start_sprites_atlas.png)

![Właściwości sprite'a](/tutorials/images/car/start_sprite_properties.png)
...
![Gotowa kolekcja samochodu](/tutorials/images/car/start_car_collection_complete.png)
...
<div class='sidenote' markdown='1'>
Defold udostępnia kilka funkcji cyklu życia do kodowania logiki gry. Przeczytaj o nich więcej w [Script Manual](/pl/manuals/script).
</div>
...
![Wiązania wejść](/tutorials/images/car/start_input_bindings.png)
...
![Dodawanie kolekcji samochodu](/tutorials/images/car/start_adding_car_collection.png)
...
3. Dodaj do samochodu dźwięki i spraw, żeby robił vroom! ([Wskazówka](/pl/manuals/sound/))

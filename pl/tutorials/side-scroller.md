...
![nowy projekt](/tutorials/images/new-side-scroller.webp)

Edytor automatycznie otworzy plik "README" z katalogu głównego projektu, który zawiera pełny tekst samouczka.

![ikona](/tutorials/images/icon-tutorial.svg) [Pełny tekst samouczka możesz też przeczytać na GitHub](https://github.com/defold/tutorial-side-scroller)

...
W tym przykładowym projekcie, który możesz [otworzyć w edytorze](/pl/manuals/project-setup/) albo [pobrać z GitHuba](https://github.com/defold/sample-rpgmap), pokazujemy jeden ze sposobów tworzenia bardzo dużych map RPG w Defold. Projekt opiera się na następujących założeniach:

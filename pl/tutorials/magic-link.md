...
* Utwórz [nowy projekt](/pl/manuals/project-setup/#creating-a-new-project) z szablonu <kbd>Empty Project</kbd>
...
![Schemat zasad gry](/tutorials/images/magic-link/linker_rules.png)
...
![Struktura folderów](/tutorials/images/magic-link/linker_folders.png)
...
![Ustawienia projektu](/tutorials/images/magic-link/linker_project_settings.png)
...
![Układ skalowania gry](/tutorials/images/magic-link/linker_layout.png)
...
![Maksymalna liczba sprite'ów](/tutorials/images/magic-link/linker_sprite_max_count.png)
...
![Dodawanie obrazów](/tutorials/images/magic-link/linker_add_images.png)
...
![Dodawanie obrazów do atlasu](/tutorials/images/magic-link/linker_add_to_atlas.png)
...
![Kolekcja planszy](/tutorials/images/magic-link/linker_board_collection.png)

![Bootstrap kolekcji planszy](/tutorials/images/magic-link/linker_bootstrap_board.png)
...
![Obiekt gry block](/tutorials/images/magic-link/linker_block.png)
...
![Fabryka block](/tutorials/images/magic-link/linker_blockfactory.png)

Teraz powinieneś być w stanie uruchomić grę i zobaczyć planszę wypełnioną losowo kolorowymi blokami:

![Pierwszy zrzut ekranu](/tutorials/images/magic-link/linker_first_screenshot.png)
...
![Wiązania wejść](/tutorials/images/magic-link/linker_input_bindings.png)
...
![Obiekt gry connector](/tutorials/images/magic-link/linker_connector.png)

![Fabryka connector](/tutorials/images/magic-link/linker_connector_factory.png)
...
![Łączniki w grze](/tutorials/images/magic-link/linker_connector_screen.png)
...
![Przesuwanie bloków w dół](/tutorials/images/magic-link/linker_blocks_slide.png)
...
![Obiekt magic_fx.go](/tutorials/images/magic-link/linker_magic_fx.png)
...
![Sprite pokrywy](/tutorials/images/magic-link/linker_cover.png)
...
![Magiczny blok bez światła i ze światłem](/tutorials/images/magic-link/linker_magic_blocks.png)
...
![Oznaczanie regionów](/tutorials/images/magic-link/linker_regions.png)
...
![Pierwsze zwycięstwo](/tutorials/images/magic-link/linker_first_win.png)
...
![Mechanika zrzutu](/tutorials/images/magic-link/linker_drop.png)
...
![GUI głównego menu](/tutorials/images/magic-link/linker_main_menu.png)
...
![GUI planszy](/tutorials/images/magic-link/linker_board_gui.png)
...
![GUI restartu](/tutorials/images/magic-link/linker_restart_gui.png)
...
![Dialog ukończenia poziomu](/tutorials/images/magic-link/linker_level_complete_gui.png)
...
![GUI prezentacji poziomu](/tutorials/images/magic-link/linker_present_level_gui.png)
...
![GUI braku miejsca na zrzut](/tutorials/images/magic-link/linker_no_drop_room_gui.png)
...
![Finalna kolekcja planszy](/tutorials/images/magic-link/linker_board_collection_final.png)
...
![Ukończona gra](/tutorials/images/magic-link/linker_game_finished.png)

...
![Przybliżone całkowanie prędkości](/tutorials/images/platformer/integration.png)
...
![Równanie prędkości](/tutorials/images/platformer/equationofvelocity.png)
...
![Równanie przemieszczenia](/tutorials/images/platformer/equationoftranslation.png)
...
Jeśli nie wiesz, jak obsługiwać wejście w Defold, znajdziesz o tym poradnik [tutaj](/pl/manuals/input).
...
![Normalne kontaktów działające na postać gracza](/tutorials/images/platformer/collision.png)
...
![Edytor Defold z geometrią poziomu i umieszczoną w świecie postacią gracza](/tutorials/images/platformer/editor.png)
...
![Wiele wielokątów opartych na kafelkach połączonych w jeden](/tutorials/images/platformer/stitching.png)
...
Więcej informacji znajdziesz w naszych poradnikach o [fizyce](/pl/manuals/physics) i [kafelkach](/pl/manuals/2dgraphics).

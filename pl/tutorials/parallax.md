...
W tym przykładowym projekcie, który możesz [otworzyć w edytorze](/pl/manuals/project-setup/) albo [pobrać z GitHub](https://github.com/defold/sample-parallax), pokazujemy, jak używać efektu paralaksy do symulowania głębi w świecie gry.

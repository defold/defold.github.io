...
![Kolekcja Mona Lisa](/manuals/images/live-update/mona-lisa.png)
...
![Wykluczony Collection proxy](/manuals/images/live-update/proxy-excluded.png)
...
![Ustawienia Live update](/manuals/images/live-update/05-liveupdate-settings-zip.png)
...
`Amazon`
: Ta opcja każe Defold automatycznie wysłać wykluczone zasoby do bucketa S3 w Amazon Web Services (AWS). Wpisz nazwę profilu AWS w polu *Credential profile*, wybierz odpowiedni *Bucket* i podaj *Prefix*. Więcej informacji o konfiguracji konta AWS znajdziesz w [instrukcji AWS](/pl/manuals/live-update-aws).
...
![Pakowanie aplikacji Live](/manuals/images/live-update/bundle-app.png)
...
Więcej informacji znajdziesz [w instrukcji skryptowania z Live update](/pl/manuals/live-update-scripting).
...
: Gdy uruchamiasz zbundlowaną wersję gry, nie masz bezpośredniego dostępu do konsoli. To utrudnia debugowanie. Możesz jednak uruchomić aplikację z wiersza poleceń albo przez bezpośrednie dwukrotne kliknięcie pliku wykonywalnego w bundle:
  ...
  ![Uruchamianie aplikacji z bundle](/manuals/images/live-update/run-bundle.png)

  Gra uruchomi się wtedy z oknem powłoki, w którym będą wyświetlane wszystkie wywołania `print()`:

  ![Wyjście konsoli](/manuals/images/live-update/run-bundle-console.png)

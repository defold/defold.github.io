...
Każda aplikacja na iOS lub Androidzie zbudowana w wariancie Debug może działać jako development app. To zalecane rozwiązanie, ponieważ taka development app ma poprawne ustawienia projektu i korzysta z tych samych [rozszerzeń natywnych](/pl/manuals/extensions/) co projekt, nad którym pracujesz.
...
![paczka bez zawartości](/manuals/images/dev-app/contentless-bundle.png)

### Instalowanie na iOS

Postępuj zgodnie z [instrukcjami w podręczniku iOS](/pl/manuals/ios/#creating-an-ios-application-bundle), aby utworzyć paczkę dla iOS. Upewnij się, że wybierasz wariant Debug!

### Instalowanie na Androidzie

Postępuj zgodnie z [instrukcjami w podręczniku Android](https://defold.com/pl/manuals/android/#creating-an-android-application-bundle), aby utworzyć paczkę dla Androida.
...
5. Gdy gra działa, możesz jak zwykle korzystać z [szybkiego przeładowania](/pl/manuals/hot-reload/).

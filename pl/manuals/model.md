...
![Model w obiekcie gry](/manuals/images/model/model_gltf.png)
...
![Wiggler w grze](/manuals/images/model/runtime.png)

### Animacja w czasie działania

Defold zapewnia rozbudowane wsparcie dla sterowania animacją w czasie działania gry. Więcej informacji znajdziesz w [instrukcji animacji modelu](/pl/manuals/model-animation):
...
Szczegóły działania skryptów do renderowania znajdziesz w [dokumentacji renderowania](/pl/manuals/render).
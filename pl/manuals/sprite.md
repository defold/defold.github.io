...
Komponent Sprite może jako źródło grafiki używać [Atlas](/pl/manuals/atlas) albo [Tile Source](/pl/manuals/tilesource).
...
Sprite może nadpisywać atrybuty wierzchołków z aktualnie przypisanego materiału. Zostaną one przekazane z komponentu do vertex shadera. Więcej informacji znajdziesz w [instrukcji do materiałów](/pl/manuals/material/#attributes).
...
Dlatego używamy `Rename patterns` w [atlasie](/pl/manuals/material/), aby zmienić te nazwy.

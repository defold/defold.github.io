...
* Szczegółowe wyjaśnienie programów shaderowych znajdziesz w [dokumentacji shaderów](/pl/manuals/shader).
...
![Plik compute](/manuals/images/compute/compute_file.png)

Nowy plik compute otworzy się w *Compute Editor*.

![Edytor compute](/manuals/images/compute/compute.png)
...
![Plik render z compute](/manuals/images/compute/compute_render_file.png)

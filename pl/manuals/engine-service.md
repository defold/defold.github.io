...
Jest oddzielona od [serwera edytora](/pl/manuals/editor-http-api), który należy do edytora Defold i steruje otwartym projektem.
...
![Informacja o porcie usługi silnika w buildzie debugowania Defold](/manuals/images/automation/engine-service.png)
...
![Dostęp do serwera silnika](/manuals/images/automation/engine-server.png)
...
Skrypty czasu działania, fizyka, wejście, dynamicznie tworzone obiekty i renderowanie charakterystyczne dla platformy wymagają uruchomionego silnika i powinny być weryfikowane przez [automatyczne testy czasu działania](/pl/manuals/automated-testing).

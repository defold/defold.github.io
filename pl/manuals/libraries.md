...
Załóżmy, że chcesz zbudować bibliotekę zawierającą współdzielone sprite'y oraz źródła kafelków. Zacznij od [utworzenia nowego projektu](/pl/manuals/project-setup/). Zdecyduj, które foldery chcesz udostępnić z projektu, i dodaj ich nazwy do właściwości *`include_dirs`* w ustawieniach projektu. Jeśli chcesz wymienić więcej niż jeden folder, oddziel nazwy spacjami:
...
<div class='important' markdown='1'>
Zaleca się zawsze przejrzeć biblioteki stron trzecich przed ich użyciem. Dowiedz się więcej o [zabezpieczaniu korzystania z oprogramowania stron trzecich](https://defold.com/pl/manuals/application-security/#securing-your-use-of-third-party-software).
</div>
...
Jeśli skopiujesz materiał i chcesz używać go we wszystkich komponentach danego typu, pomocne mogą być [szablony dla poszczególnych projektów](/pl/manuals/editor/#creating-new-project-files).

...
- anchor: hull-and-mesh-shapes-in-3d
  title: Kształty Hull i Mesh w 3D
...
![Dodawanie kształtu podstawowego](/manuals/images/physics/add_shape.png)

## Kształt prostopadłościanu

Kształt prostopadłościanu ma pozycję, obrót i wymiary: szerokość, wysokość oraz głębokość:

![Kształt prostopadłościanu](/manuals/images/physics/box.png)
...
Defold zawiera funkcję, która pozwala łatwo generować kształty fizyki dla źródła kafelków używanego przez mapę kafelków. W [instrukcji Tile source](/pl/manuals/tilesource/#tile-source-collision-shapes) wyjaśniono, jak dodawać grupy kolizji do źródła kafelków i przypisywać kafelki do grup kolizji ([przykład](/examples/tilemap/collisions/)).
...
![Kolizja mapy kafelków](/manuals/images/physics/collision_tilemap.png)

...
![Przeładowywanie zasobów](/manuals/images/hot-reload/menu.png)

## Szybkie przeładowanie na urządzeniu

Funkcja szybkiego przeładowania działa zarówno na urządzeniu, jak i na komputerze. Aby używać jej na urządzeniu, uruchom debugową wersję gry albo [development app](/pl/manuals/dev-app) na urządzeniu mobilnym, a następnie wybierz je jako cel w edytorze:

![Urządzenie docelowe](/manuals/images/hot-reload/target.png)
...
![Przeładowywanie GUI](/manuals/images/hot-reload/gui.png)

Dodaj nowe przyciski, zapisz plik GUI i przeładuj go. Nowe przyciski będą teraz widoczne na ekranie telefonu:

![Przeładowane GUI](/manuals/images/hot-reload/gui-reloaded.png)
...
Zmiana i przeładowanie pliku "my_module.lua" _nie_ zmienią zachowania "user.script". Zobacz [instrukcję o modułach](/pl/manuals/modules), aby dowiedzieć się więcej o tym, dlaczego tak się dzieje i jak uniknąć tej pułapki.

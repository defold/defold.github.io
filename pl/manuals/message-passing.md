...
Przekazywanie wiadomości to mechanizm, dzięki któremu obiekty gry w Defold mogą komunikować się ze sobą. Ten podręcznik zakłada, że znasz podstawy [mechanizmu adresowania](/pl/manuals/addressing) i [podstawowych elementów budujących grę](/pl/manuals/building-blocks).
...
```
Bardziej szczegółowy opis działania pełnomocników kolekcji znajdziesz w dokumentacji [Collection Proxies](/pl/manuals/collection-proxy).

...
Przekazywanie wiadomości to mechanizm pozwalający obiektom gry w silniku Defold komunikować się między sobą. Ten materiał zakłada, że znasz podstawy [mechanizmu adresowania](/pl/manuals/addressing) w silniku Defold oraz [podstawowych elementów budujących grę](/pl/manuals/building-blocks).
...
Szczegółowy opis działania pełnomocników kolekcji znajdziesz w instrukcji [Collection Proxies](/pl/manuals/collection-proxy).

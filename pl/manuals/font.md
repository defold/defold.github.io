...
Informacje o stylizowaniu poszczególnych fragmentów tekstu oraz pracy z odnośnikami i obrazami osadzonymi w tekście znajdziesz w [instrukcji znaczników tekstu formatowanego](/pl/manuals/font-richtext).
...
Zobacz [Włączanie runtime fonts](/pl/manuals/font#enabling-runtime-fonts)
...
* Dodaj [App Manifest](/pl/manuals/app-manifest) i włącz opcję `Use full text layout system`.

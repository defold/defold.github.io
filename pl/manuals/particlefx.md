...
toc: ["Efekty cząsteczkowe (Particle FX)","Tworzenie efektu cząsteczkowego","Podgląd efektu","Właściwości emitera","Tryby Mieszania","Kluczowe właściwości emitera","Modyfikatory","Właściwości Modyfikatora","Kontrola efektu cząsteczkowego"]
...
Aby uruchomić i zatrzymać efekt cząsteczkowy z poziomu skryptu GUI zobacz: [instrukcję dla GUI Particle FX](/pl/manuals/gui-particlefx#controlling-the-effect).

...
1. Utwórz bucket dla zasobów Live update
    ...
    ![Utwórz bucket](/manuals/images/live-update/01-create-bucket.png)
...
2. Dodaj politykę bucketa
    ...
    ![Polityka bucketa](/manuals/images/live-update/02-bucket-policy.png)
...
3. Dodaj do bucketa konfigurację CORS (Opcjonalnie)
    ...
    ![Konfiguracja CORS](/manuals/images/live-update/03-cors-configuration.png)
...
4. Utwórz politykę IAM
    ...
    ![Polityka IAM](/manuals/images/live-update/04-create-policy.png)
...
6. Utwórz plik profilu poświadczeń
    ...
    ![Ustawienia Live update](/manuals/images/live-update/05-liveupdate-settings.png)
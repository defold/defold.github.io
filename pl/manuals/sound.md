...
![Mikser grup dźwięku](/manuals/images/sound/sound_mixer.png)
...
![Przesunięcie fazowe](/manuals/images/sound/sound_phase_shift.png)
...
Plik *game.project* ma kilka [ustawień projektu](/pl/manuals/project-settings#sound) związanych z komponentami dźwięku.

## Streaming dźwięku

Można też obsługiwać [streaming sounds](/pl/manuals/sound-streaming)
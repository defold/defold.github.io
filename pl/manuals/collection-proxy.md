...
Pełnomocniki kolekcji różnią się od [fabryk kolekcji](/pl/manuals/collection-factory/). Fabryka kolekcji tworzy instancje zawartości kolekcji w bieżącym świecie gry. Pełnomocniki kolekcji tworzą natomiast nowy świat gry w trakcie działania programu, więc mają inne zastosowania.
...
(Możesz wyłączyć tę zawartość z kompilacji i pobrać ją później kodem, zaznaczając *Exclude* i używając funkcji [Live update](/pl/manuals/live-update/).)
...
A jeśli chcesz komunikować się z obiektem gry w wczytanej kolekcji z poziomu loadera, możesz wysłać wiadomość, używając [pełnego URL-a obiektu](/pl/manuals/addressing/#urls):
...
* [animacje właściwości obiektu gry i GUI](https://defold.com/pl/manuals/animation/#property-animation-1)
* [animacje flipbook](https://defold.com/pl/manuals/animation/#flip-book-animation)
* [symulacje Particle FX](https://defold.com/pl/manuals/particlefx/)
* prędkość timerów

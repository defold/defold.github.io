...
![Okno dialogowe przykładu „Witaj świecie”](/manuals/images/editor_scripts/perform_action_dialog.png)
...
![Wyrównanie](/manuals/images/editor_scripts/alignment.png)
...
![Padding i Spacing](/manuals/images/editor_scripts/padding_and_spacing.png)
...
editor.ui.grid({
    ...
    columns = {% raw %}{{}, {grow = true}}{% endraw %}, -- spraw, by druga kolumna się rozciągała
    children = {
        {
            editor.ui.label({ 
                text = "Level Name",
...
![Formularz nowego poziomu](/manuals/images/editor_scripts/new_level_dialog.png)
...
![Pola wejściowe](/manuals/images/editor_scripts/inputs_demo.png)
...
![Okno dialogowe tworzenia nowego pliku](/manuals/images/editor_scripts/reactive_new_file_dialog.png)

...
W centrum projektu Defold stoi kilka kluczowych pojęć, które warto dobrze poznać. Ta instrukcja wyjaśnia, z czego składają się podstawowe elementy Defold. Po jej przeczytaniu przejdź do [instrukcji adresowania](/pl/manuals/addressing) i [instrukcji przesyłania wiadomości](/pl/manuals/message-passing). W edytorze dostępny jest też zestaw [tutoriali](/tutorials/getting-started), które pomogą szybko zacząć pracę.

![Podstawowe elementy](/manuals/images/building_blocks/building_blocks.png)
...
Nie można adresować samych kolekcji, ponieważ nie ma w czasie działania obiektów odpowiadających kolekcjom "main" i "bean". Czasami jednak identyfikator kolekcji jest potrzebny jako część _ścieżki_ do obiektu gry. Szczegóły znajdziesz w [instrukcji adresowania](/pl/manuals/addressing):
...
Zobacz [przegląd komponentów](/pl/manuals/components/), aby uzyskać listę wszystkich dostępnych typów komponentów.

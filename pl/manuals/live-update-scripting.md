...
Mount jest aktywny tylko w bieżącej sesji. Zapisz ścieżkę pakietu i ustawienia mounta we własnych trwałych danych, a po każdym restarcie ponownie wywołaj `liveupdate.add_mount()`.

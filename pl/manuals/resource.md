...
Defold ma też pojęcie [zasobów pakietu](/pl/manuals/project-settings/#bundle-resources). Są one dołączane do pakietu aplikacji, ale nie należą do drzewa zasobów. Mogą to być zarówno pliki pomocnicze zależne od platformy, jak i zewnętrzne pliki [wczytywane z systemu plików](/pl/manuals/file-access/#how-to-access-files-bundled-with-the-application) używane przez grę, na przykład banki dźwięków FMOD.
</div>
...
- kolekcji świata gry wskazywanych przez Collection proxy; takie światy są stosunkowo duże, więc ich ładowanie i zwalnianie trzeba wyzwalać ręcznie w kodzie. Szczegóły znajdziesz w [instrukcji Collection proxy](/pl/manuals/collection-proxy)
...
Szczegóły działania znajdziesz w [instrukcji Factory](/pl/manuals/factory) i [instrukcji Collection factory](/pl/manuals/collection-factory).
...
Po oznaczeniu Collection proxy jako <kbd>Exclude</kbd> wskazany zasób zostanie pominięty w pakiecie gry. Zamiast tego możesz przechowywać *wykluczone kolekcje* w wybranym magazynie w chmurze. [Instrukcja Live update](/pl/manuals/live-update/) wyjaśnia, jak działa ta funkcja.
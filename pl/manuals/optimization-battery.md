...
Zapoznaj się z instrukcjami dotyczącymi [optymalizacji wydajności w czasie działania](/pl/manuals/optimization-speed) gry, aby dowiedzieć się, jak zmniejszyć użycie CPU i GPU.

## Wyłącz akcelerometr
Jeśli tworzysz grę mobilną, która nie korzysta z akcelerometru urządzenia, zaleca się [wyłączenie go w *game.project*](/pl/manuals/project-settings/#use-accelerometer), aby zmniejszyć liczbę generowanych zdarzeń wejściowych.

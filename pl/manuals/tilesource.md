...
Źródło kafelków, *Tile Source*, może być używane przez [Tilemap component](/pl/manuals/tilemap) do rysowania kafelków na obszarze siatki albo jako źródło grafiki dla [Sprite](/pl/manuals/sprite) lub [Particle Effect component](/pl/manuals/particlefx). Możesz też użyć *Collision Shapes* ze źródła kafelków w Tilemap do [wykrywania kolizji i symulacji fizycznej](/pl/manuals/physics) ([przykład](/examples/tilemap/collisions/)).
...
![Obraz kafelków](/manuals/images/tilemap/small_map.png)
...
![Animacja źródła kafelków](/manuals/images/tilemap/animation.png)

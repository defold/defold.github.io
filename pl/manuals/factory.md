...
`[properties]`
: (opcjonalnie) Tabela Lua z wartościami właściwości skryptu, którymi ma zostać zainicjowany obiekt gry. Więcej informacji o właściwościach skryptu znajdziesz w [instrukcji Script property](/pl/manuals/script-properties).
...
![Maksymalna liczba instancji](/manuals/images/factory/factory_max_instances.png)
...
Dobierz *Max Instances* do największej liczby obiektów gry, które mogą jednocześnie istnieć w dynamicznym świecie. Sposób obliczania pozostałych limitów komponentów opisano w sekcji [Optymalizacje maksymalnej liczby komponentów](/pl/manuals/project-settings/#component-max-count-optimizations).

...
* [Skrypty edytora](/pl/manuals/editor-scripts) mogą udostępniać operacje na zasobach i narzędzia charakterystyczne dla projektu.
* [Editor HTTP API](/pl/manuals/editor-http-api) udostępnia polecenia edytora, wyniki budowania, dane wyjściowe konsoli, wyszukiwanie w dokumentacji, podglądy, preferencje i trasy skryptów edytora.
* [Usługa silnika i interfejsy API automatyzacji w czasie działania](/pl/manuals/engine-service) udostępniają bieżący stan silnika debugowania, wejście, zrzuty ekranu i operacje zdefiniowane przez rozszerzenia.
* [Bob](/pl/manuals/bob) umożliwia budowanie z wiersza poleceń oraz tworzenie raportów, archiwów i pakietów.
...
Agenci powinni stosować tę samą [pętlę sprawdzania, zmiany, weryfikacji i oceny](/pl/manuals/automation/#the-automation-loop), co każda inna automatyzacja.
...
Dobre praktyki dotyczące zautomatyzowanego testowania i weryfikacji opisano w [tej instrukcji](/pl/manuals/automated-testing).

## Ocena multimodalna {#multimodal-evaluation}

Agent obsługujący obrazy może sprawdzać [podglądy edytora](/pl/manuals/editor-http-api/#rendering-scene-previews), zrzuty ekranu z uruchomionej aplikacji, różnice wizualne i zrzuty z przeglądarki.
...
Więcej informacji o podglądach edytora, zrzutach ekranu z uruchomionej aplikacji i kontroli wizualnej znajduje się w [tej instrukcji](/pl/manuals/automated-testing).

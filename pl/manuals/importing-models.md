...
![Model w Blenderze](/manuals/images/model/blender_gltf.png)
...
![Zaimportowane zasoby modelu](/manuals/images/model/assets_gltf.png)
...
## Używanie modelu
Po zaimportowaniu modelu użyj go w [komponencie Model](/pl/manuals/model):
...
![Zaznacz wszystkie](/manuals/images/model/blender_select_all_vertices.png)
...
![Eksport układu UV](/manuals/images/model/blender_export_uv_layout.png)

![Wynik eksportu układu UV](/manuals/images/model/blender_export_uv_layout_result.png)

### Eksportowanie w Blenderze
Eksportuj model z Blendera za pomocą <kbd>File ▸ Export ▸ glTF 2.0 (.glb/.gltf)</kbd>.

![Eksportowanie w Blenderze](/manuals/images/model/export_gltf.png)
...
![Eksportowanie w Blenderze](/manuals/images/model/export_settings.png)
...
## Używanie modelu
Gdy model jest już zaimportowany do Defold, możesz użyć go w [komponencie Model](/pl/manuals/model).
...
![Ustawienia eksportu układu UV](/manuals/images/model/blender_export_uv_layout_settings.png)
...
![Eksportowanie w Blenderze](/manuals/images/model/blender_export.png)
...
![Dodawanie Label](/manuals/images/label/add_label.png)
...
![Nowy Label](/manuals/images/label/label.png)
...
![Font i material](/manuals/images/label/font_material.png)
...
Plik *game.project* ma kilka [ustawień projektu](/pl/manuals/project-settings#label) związanych z Label.
...
Innym przypadkiem użycia dużych ilości danych pobieranych przez sieć jest strumieniowanie dźwięku, gdy „fragmenty” danych dźwiękowych są wczytywane z adresu URL i przekazywane do zasobu dźwięku. Pełny przykład znajdziesz w [podręczniku strumieniowania dźwięku](/pl/manuals/sound-streaming/#sound-streaming).
...
* `Range: bytes=<from>-<to>` zostanie ustawiony przy żądaniu częściowej odpowiedzi, na przykład podczas [strumieniowania dźwięków](/pl/manuals/sound-streaming/#sound-streaming).

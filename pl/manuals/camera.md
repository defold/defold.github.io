...
function M.screen_to_world(camera, screen_x, screen_y, z)
    ...
    -- https://defold.com/pl/manuals/camera/#converting-mouse-to-world-coordinates
...
<div class='sidenote' markdown='1'>
[Rozwiązania kamer od społeczności wymienione w tym podręczniku](/pl/manuals/camera/#third-party-camera-solutions) zawierają funkcje konwersji do współrzędnych ekranu i z powrotem.
</div>

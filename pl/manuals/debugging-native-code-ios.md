...
* Zbuduj pakiet aplikacji za pomocą bob, używając opcji `--with-symbols` ([więcej informacji](/pl/manuals/debugging-native-code/#symbolicate-a-callstack)):
...
* Pobierz folder `.dSYM` (czyli symbole debugowania)
	...
	* Jeśli używasz rozszerzenia natywnego, folder `.dSYM` jest generowany podczas budowania za pomocą [bob.jar](https://www.defold.com/pl/manuals/bob/). Wystarczy samo zbudowanie projektu, bez archiwizacji ani bundlowania:

...
- anchor: rich-text-markup
  title: Znaczniki tekstu formatowanego
- anchor: tag-reference
  title: Przegląd znaczników
- anchor: syntax
  title: Składnia
- anchor: attributes
  title: Atrybuty
...
![Przykładowy tekst w nieprzezroczystym zielonym kolorze](/manuals/images/richtext/color_green.webp)
...
![Przykładowy tekst w zielonym kolorze z połową krycia](/manuals/images/richtext/color_green_alpha.webp)
...
![Przykładowy tekst o rozmiarze 24 pikseli](/manuals/images/richtext/size_24.webp)
...
![Przykładowy tekst o rozmiarze 120 procent z 32 pikseli](/manuals/images/richtext/size_120.webp)
...
![Przykładowy tekst o rozmiarze dwukrotnie większym niż bazowe 32 piksele](/manuals/images/richtext/size_2em.webp)
...
![Przykładowy tekst z poziomym gradientem od magenty do bieli](/manuals/images/richtext/gradient_horizontal.webp)
...
![Przykładowy tekst z pionowym niebieskim gradientem](/manuals/images/richtext/gradient_vertical.webp)
...
![Przykładowy tekst z gradientem czterech narożników dopasowanym do każdego glifu](/manuals/images/richtext/gradient_four_glyph.webp)
...
![Przykładowy tekst z gradientem czterech narożników dopasowanym do fragmentu tekstu](/manuals/images/richtext/gradient_four_text.webp)
...
![Animowany przepływający gradient dopasowany do każdego glifu](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![Animowany przepływający gradient dopasowany do fragmentu tekstu](/manuals/images/richtext/gradient_flow_span.webp)
...
![Przykładowy tekst z ciągłym podkreśleniem](/manuals/images/richtext/underline_solid.webp)
...
![Przykładowy tekst z przerywanym podkreśleniem](/manuals/images/richtext/underline_dashed.webp)
...
![Przykładowy tekst z podkreśleniem gradientowym](/manuals/images/richtext/underline_gradient.webp)
...
![Przykładowy tekst z ciągłym przekreśleniem](/manuals/images/richtext/strike_solid.webp)
...
![Przykładowy tekst z przerywanym przekreśleniem](/manuals/images/richtext/strike_dashed.webp)
...
![Przykładowy tekst z zewnętrznym czarnym obrysem](/manuals/images/richtext/outline.webp)
...
![Przykładowy tekst z przesuniętym cieniem](/manuals/images/richtext/shadow.webp)
...
![Przykładowy tekst z animowanym drżeniem poszczególnych glifów](/manuals/images/richtext/shake_glyph.webp)
...
![Przykładowy tekst z animowanym drżeniem całego fragmentu](/manuals/images/richtext/shake_span.webp)
...
![Przykładowy tekst z animowaną falą poszczególnych glifów](/manuals/images/richtext/wave_glyph.webp)
...
![Przykładowy tekst poruszający się jako jeden animowany fragment](/manuals/images/richtext/wave_span.webp)
...
![Logo Defold wyrenderowane w wierszu tekstu](/manuals/images/richtext/sprite.webp)
...
![www.defold.com wyrenderowane z domyślnym stylem odnośnika i podkreśleniem](/manuals/images/richtext/link.webp)
...
Szczegóły konfiguracji znajdziesz w sekcjach [fokus wejścia](/pl/manuals/input/#input-focus) oraz [wejście myszy i dotyku](/pl/manuals/input-mouse-and-touch).

...
- anchor: multisampled-render-targets
  title: Cele renderowania z wielokrotnym próbkowaniem
- Uchwyt tekstur
...
W samym sercu potoku renderowania znajduje się _skrypt do renderowania_. To skrypt Lua z funkcjami `init()`, `update()` i `on_message()`, używany przede wszystkim do współpracy z niskopoziomowym API graficznym. Skrypt do renderowania zajmuje szczególne miejsce w cyklu życia gry. Szczegóły znajdziesz w [dokumentacji cyklu życia aplikacji](/pl/manuals/application-lifecycle).
...
![Wbudowany render](/manuals/images/render/builtin.png)
...
Szczegółowy opis działania materiałów znajdziesz w [dokumentacji materiału](/pl/manuals/material).
...
![Projekcja Stretch](/manuals/images/render/stretch_projection.png)

*Projekcja Stretch przy oryginalnym rozmiarze okna*

![Projekcja Stretch po zmianie rozmiaru](/manuals/images/render/stretch_projection_resized.png)
...
![Projekcja Fixed Fit](/manuals/images/render/fixed_fit_projection.png)

*Projekcja Fixed Fit przy oryginalnym rozmiarze okna*

![Projekcja Fixed Fit po zmianie rozmiaru](/manuals/images/render/fixed_fit_projection_resized.png)

*Projekcja Fixed Fit z poziomo rozciągniętym oknem*

![Projekcja Fixed Fit po zmniejszeniu](/manuals/images/render/fixed_fit_projection_resized_smaller.png)
...
![Projekcja Fixed](/manuals/images/render/fixed_projection_zoom_2_0.png)

*Projekcja Fixed z zoomem ustawionym na 2*

![Projekcja Fixed](/manuals/images/render/fixed_projection_zoom_0_5.png)

*Projekcja Fixed z zoomem ustawionym na 0.5*

![Projekcja Fixed](/manuals/images/render/fixed_projection_zoom_2_0_resized.png)
...
Gdy używasz domyślnego skryptu do renderowania i w projekcie są dostępne włączone [komponenty Camera](/pl/manuals/camera), mają one pierwszeństwo przed każdym innym widokiem / projekcją ustawionymi w skrypcie do renderowania. Aby dowiedzieć się więcej o pracy z komponentami kamery w skryptach do renderowania, zapoznaj się z [dokumentacją kamery](/pl/manuals/camera).
...
1 = Pudełko ograniczające siatki musi zostać ustawione przez dewelopera. [Dowiedz się więcej](/pl/manuals/mesh/#frustum-culling).
...
![Zasoby renderowania](/manuals/images/render/render_resources.png)
...
Cele renderowania obsługują antyaliasing z wielokrotnym próbkowaniem (MSAA). Wygładza on krawędzie geometrii w pozaekranowym przebiegu renderowania. Liczba próbek celu jest niezależna od [Display ▸ Samples](/pl/manuals/project-settings/#samples), które steruje antyaliasingiem okna.

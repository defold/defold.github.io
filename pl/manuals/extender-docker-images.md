...
3. Uruchom lokalny Extender zgodnie z opisem w sekcji [Jak uruchomić lokalny Extender z prekonfigurowanymi artefaktami](/pl/manuals/extender-local-setup#how-to-run-local-extender-with-preconfigured-artifacts).
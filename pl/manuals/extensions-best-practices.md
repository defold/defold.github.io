...
```
    /root
        ...
        /bundleres                       -- Zasoby, które powinny zostać dołączone do bundla (zob. game.project oraz [bundle_resources setting]([physics scale setting](/pl/manuals/project-settings/#project))
            /<platform>
        game.project

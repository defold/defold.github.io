...
Jeśli słuchacz zostanie ustawiony, [wiadomości fizyki](/pl/manuals/physics-messages) nie będą już wysyłane dla świata fizycznego, w którym ten słuchacz jest aktywny.
</div>

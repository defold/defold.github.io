...
* Więcej informacji o potoku renderowania znajdziesz w [dokumentacji renderowania](/pl/manuals/render).
* Szczegółowe wyjaśnienie programów shaderów znajdziesz w [dokumentacji shaderów](/pl/manuals/shader).
...
![Plik materiału](/manuals/images/materials/material_file.png)

Nowy materiał otworzy się w *Material Editor*.

![Edytor materiałów](/manuals/images/materials/material.png)
...
Tags
: Tagi powiązane z materiałem. W silniku tagi są reprezentowane jako _maska bitowa_, z której [`render.predicate()`](/ref/render#render.predicate) korzysta do zbierania komponentów, które powinny zostać narysowane razem. Więcej informacji o tym, jak to zrobić, znajdziesz w [dokumentacji renderowania](/pl/manuals/render). Maksymalna liczba tagów, których możesz użyć w projekcie, to 32.
...
![Własny atrybut materiału](/manuals/images/materials/set_custom_attribute.png)
...
![Konfiguracja instancing](/manuals/images/materials/instancing-setup.png)
...
![Materiał instancing](/manuals/images/materials/instancing-material.png)
...
![Wywołania rysowania instancing](/manuals/images/materials/instancing-draw-calls.png)
...
![Sampler sprite'a](/manuals/images/materials/sprite_sampler.png)
...
![Ustawienia samplera](/manuals/images/materials/my_sampler.png)
...
![Samplery modelu](/manuals/images/materials/model_samplers.png)

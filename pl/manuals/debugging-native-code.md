...
Najprostszym sposobem debugowania kodu natywnego jest [debugowanie przez wypisywanie](http://en.wikipedia.org/wiki/Debugging#Techniques). Użyj funkcji z przestrzeni nazw [`dmLog`](/ref/dmLog/), aby obserwować zmienne albo zaznaczać przebieg wykonania. Każda z funkcji logujących wypisze dane do widoku *Console* w edytorze oraz do [logu gry](/pl/manuals/debugging-game-and-system-logs).

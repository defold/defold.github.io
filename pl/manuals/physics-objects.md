...
Collision Shape
: Zasób mapy kafelków lub `.convexshape`. Aby użyć siatki glTF lub GLB, dodaj do komponentu kształt Hull lub Mesh i ustaw jego właściwości *Scene* oraz *Mesh*. Więcej informacji znajdziesz w [instrukcji kształtów kolizji](/pl/manuals/physics-shapes).

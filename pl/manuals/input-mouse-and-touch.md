...
Zaleca się najpierw zapoznać z ogólnym sposobem działania wejścia w Defold, z tym, jak odbiera się wejście i w jakiej kolejności skrypty je otrzymują. Więcej informacji znajdziesz w [instrukcji ogólnej o wejściu](/pl/manuals/input).
</div>
...
W obu przypadkach trzeba przeliczyć współrzędne ekranu dla zdarzenia myszy lub dotyku na współrzędne świata obiektów gry. Można to zrobić na kilka sposobów:
  ...
  * Ręcznie śledzić, jaki widok i jaka projekcja są używane przez skrypt renderowania, a następnie wykorzystać je do przeliczania między współrzędnymi świata i ekranu. Zobacz [instrukcję o kamerze](/pl/manuals/camera/#converting-mouse-to-world-coordinates) jako przykład.
  * Użyć [rozwiązania kamery innej firmy](/pl/manuals/camera/#third-party-camera-solutions) i skorzystać z dostarczonych funkcji konwersji z ekranu do świata.
...
<div class="section dark page-dark-section gradient-background-top-dark" id="foundation-photos" markdown="0">
	<div class="container">
		...
		<div class="page-feature-grid page-grid-auto-fill page-grid-three page-grid-flush">
			{% include page_feature_card.html title="Björn, Sara, Elin and Mathias" body="High-resolution Foundation group photo." link="/images/foundation/highres/GT1A2780.jpg" thumbnail="/images/foundation/thumbs/GT1A2780.jpg" hide_badge=true cta_text="Open high-resolution image" %}
			{% include page_feature_card.html title="Elin, Sara, Mathias and Björn" body="High-resolution Foundation group photo." link="/images/foundation/highres/GT1A2904.jpg" thumbnail="/images/foundation/thumbs/GT1A2904.jpg" hide_badge=true cta_text="Open high-resolution image" %}
			{% include page_feature_card.html title="Mathias, Björn, Elin and Sara" body="High-resolution Foundation group photo." link="/images/foundation/highres/GT1A2974.jpg" thumbnail="/images/foundation/thumbs/GT1A2974.jpg" hide_badge=true cta_text="Open high-resolution image" %}
			{% include page_feature_card.html title="Mathias, Björn, Elin and Sara" body="High-resolution Foundation group photo." link="/images/foundation/highres/GT1A2985.jpg" thumbnail="/images/foundation/thumbs/GT1A2985.jpg" hide_badge=true cta_text="Open high-resolution image" %}
			{% include page_feature_card.html title="Mathias, Björn, Elin and Sara" body="High-resolution Foundation group photo." link="/images/foundation/highres/GT1A2989.jpg" thumbnail="/images/foundation/thumbs/GT1A2989.jpg" hide_badge=true cta_text="Open high-resolution image" %}
			...
			{% include page_feature_card.html title="Elin Eriksson" body="High-resolution Foundation board member photo." link="/images/foundation/highres/Elin Eriksson_2020_RW.jpg" thumbnail="/images/foundation/thumbs/Elin Eriksson_2020_RW.jpg" hide_badge=true cta_text="Open high-resolution image" %}

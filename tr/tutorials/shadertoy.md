...
![başlangıç](/tutorials/images/shadertoy/empty_project.png)
...
![Blender'da dörtgen](/tutorials/images/shadertoy/quad_blender.png)
...
![Defold'da dörtgen](/tutorials/images/shadertoy/quad_default_material.png)
...
1. `Assets` bölmesindeki `main` klasörüne <kbd>Right Mouse Button</kbd> ile tıklayıp <kbd>New</kbd>-><kbd>Material</kbd> seçeneğini seçin ve `star-nest` adını vererek yeni bir *`star-nest.material`* materyal dosyası oluşturun.
 ...
 ![materyal](/tutorials/images/shadertoy/new_material.png)
...
8. *Tags* bölümüne "tile" etiketini ekleyin. Böylece dörtgen, sprite bileşenleri ve karolar çizilirken yapılan işleme geçişine dahil edilir.
 ...
 ![materyal](/tutorials/images/shadertoy/material.png)
...
![Defold'da dörtgen](/tutorials/images/shadertoy/quad_material.png)
...
![kamera](/tutorials/images/shadertoy/camera.png)
...
![Star Nest gölgelendiricisinin kodu](/tutorials/images/shadertoy/starnest_code.png)
...
![Star Nest ile kaplanmış dörtgen](/tutorials/images/shadertoy/quad_starnest.png)
...
![zaman sabiti](/tutorials/images/shadertoy/time_constant.png)

...
[Düzenleyiciden açabileceğiniz](/tr/manuals/project-setup/) veya [GitHub'dan indirebileceğiniz](https://github.com/defold/sample-parallax) bu örnek projede, oyun dünyasında derinlik hissi yaratmak için paralaks (parallax) efektinin nasıl kullanılacağını gösteriyoruz.

...
* "Empty Project" şablonundan [yeni bir proje](/tr/manuals/project-setup/#creating-a-new-project) oluşturun
...
![Oyun kuralları şeması](/tutorials/images/magic-link/linker_rules.png)
...
![Klasör yapısı](/tutorials/images/magic-link/linker_folders.png)
...
![Proje ayarları](/tutorials/images/magic-link/linker_project_settings.png)
...
![Oyun boyutlarının yerleşimi](/tutorials/images/magic-link/linker_layout.png)
...
![En fazla sprite sayısı](/tutorials/images/magic-link/linker_sprite_max_count.png)
...
![Görüntü ekleme](/tutorials/images/magic-link/linker_add_images.png)
...
![Atlasa görüntü ekleme](/tutorials/images/magic-link/linker_add_to_atlas.png)
...
![Tahta koleksiyonu](/tutorials/images/magic-link/linker_board_collection.png)

![Başlangıçta tahta koleksiyonunun yüklenmesi](/tutorials/images/magic-link/linker_bootstrap_board.png)
...
![Blok oyun nesnesi](/tutorials/images/magic-link/linker_block.png)
...
![Blok fabrikası](/tutorials/images/magic-link/linker_blockfactory.png)

Artık oyunu çalıştırıp tahtanın rastgele renkli bloklarla dolduğunu görebilmelisiniz:

![İlk ekran görüntüsü](/tutorials/images/magic-link/linker_first_screenshot.png)
...
![Girdi eşlemeleri](/tutorials/images/magic-link/linker_input_bindings.png)
...
![Bağlayıcı oyun nesnesi](/tutorials/images/magic-link/linker_connector.png)

![Bağlayıcı fabrikası](/tutorials/images/magic-link/linker_connector_factory.png)
...
![Oyun içindeki bağlayıcılar](/tutorials/images/magic-link/linker_connector_screen.png)
...
![Blokları aşağı kaydırma](/tutorials/images/magic-link/linker_blocks_slide.png)
...
![Kapak sprite bileşeni](/tutorials/images/magic-link/linker_cover.png)
...
![Işığı kapalı ve açık sihirli blok](/tutorials/images/magic-link/linker_magic_blocks.png)
...
![Bölgeleri işaretleme](/tutorials/images/magic-link/linker_regions.png)
...
![İlk kazanma](/tutorials/images/magic-link/linker_first_win.png)
...
![Blok bırakma](/tutorials/images/magic-link/linker_drop.png)
...
![Ana menü GUI'si](/tutorials/images/magic-link/linker_main_menu.png)
...
![Ana koleksiyon](/tutorials/images/magic-link/linker_main_collection.png)
...
![Başlangıçtaki ana koleksiyon](/tutorials/images/magic-link/linker_bootstrap_main.png)
...
![Tahta GUI'si](/tutorials/images/magic-link/linker_board_gui.png)
...
![Yeniden başlatma GUI'si](/tutorials/images/magic-link/linker_restart_gui.png)
...
![Bölüm tamamlandı iletişim kutusu](/tutorials/images/magic-link/linker_level_complete_gui.png)
...
![Bölümü tanıtan GUI](/tutorials/images/magic-link/linker_present_level_gui.png)
...
![Blok bırakacak yer olmadığını gösteren GUI](/tutorials/images/magic-link/linker_no_drop_room_gui.png)
...
![Son tahta koleksiyonu](/tutorials/images/magic-link/linker_board_collection_final.png)
...
![Tamamlanan oyun](/tutorials/images/magic-link/linker_game_finished.png)

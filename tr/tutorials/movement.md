...
![yeni proje](/tutorials/images/new-movement.png)

Düzenleyici, proje kök dizinindeki öğretici metninin tamamını içeren "README" dosyasını otomatik olarak açar.

![simge](/tutorials/images/icon-tutorial.svg) [Öğretici metninin tamamını GitHub'da da okuyabilirsiniz](https://github.com/defold/tutorial-movement)

...
Defold düzenleyicisini kullanmayı bildiğiniz ve GL gölgelendiricileri (shader) ile Defold işleme hattı (rendering pipeline) hakkında temel bilginiz olduğu varsayılır. Bu konuları öğrenmeniz gerekiyorsa [Gölgelendirici kılavuzumuza](/tr/manuals/shader/) ve [İşleme kılavuzuna](/tr/manuals/render/) göz atın.
...
Bir bileşenin gölgelendirici programını, piksel verilerini değiştiren veya program yoluyla tamamen yeni piksel renkleri oluşturan bir programla değiştirebilirsiniz. [Shadertoy öğreticisi](/tr/tutorials/shadertoy) bunu nasıl yapacağınızı öğretir.
...
![İşleme hedefi](/tutorials/images/grading/render_target.png)
...
7. *`main.collection`* dosyasını açın, "`grade`" oyun nesnesindeki model bileşenini seçin ve *Material* özelliğini "`/main/grade.material`" olarak ayarlayın.
   ...
   ![Model özellikleri](/tutorials/images/grading/model_properties.png)
...
![Renk doygunluğu kaldırılmış oyun](/tutorials/images/grading/desaturated_game.png)
...
![Renk küpü](/tutorials/images/grading/color_cube.png)
...
![İşleme hedefinde renk düzenleme](/tutorials/images/grading/render_target_grading.png)
...
![Arama dokusu](/tutorials/images/grading/lut.png)
...
![Arama tablosu](/tutorials/images/grading/lut_lookup.png)
...
![Arama tablosunda filtreleme](/tutorials/images/grading/lut_filtering.png)
...
3. *`Filter min`* özelliğini `FILTER_MODE_MIN_LINEAR`, *`Filter mag`* özelliğini ise `FILTER_MODE_MAG_LINEAR` olarak ayarlayın.
    ...
    ![Arama tablosu örnekleyicisi](/tutorials/images/grading/material_lut_sampler.png)

4. Aşağıdaki arama tablosu dokusunu (*`lut16.png`*) indirip projenize ekleyin.

    ![16 renkli arama tablosu](/tutorials/images/grading/lut16.png)

5. *`main.collection`* dosyasını açın ve *`lut`* doku özelliğini indirdiğiniz arama dokusuna ayarlayın.

    ![Kare modelin arama tablosu](/tutorials/images/grading/quad_lut.png)
...
![Dünyanın özgün görünümü](/tutorials/images/grading/world_original.png)
...
![Mavide bantlaşma](/tutorials/images/grading/blue_banding.png)
...
![Mavide bantlaşma yok](/tutorials/images/grading/blue_no_banding.png)
...
![Affinity'de dünya](/tutorials/images/grading/world_graded_affinity.png)
...
![Renkleri düzenlenmiş dünya](/tutorials/images/grading/world_graded.png)

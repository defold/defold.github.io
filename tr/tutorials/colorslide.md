...
![yeni proje](/tutorials/images/new-colorslide.png)

Düzenleyici, öğreticinin tam metnini içeren "README" dosyasını projenin kök dizininden otomatik olarak açar.

![simge](/tutorials/images/icon-tutorial.svg) [Öğreticinin tam metnini GitHub'da da okuyabilirsiniz](https://github.com/defold/tutorial-colorslide)

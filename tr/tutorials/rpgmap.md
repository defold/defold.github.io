...
[Düzenleyiciden açabileceğiniz](/tr/manuals/project-setup/) veya [GitHub'dan indirebileceğiniz](https://github.com/defold/sample-rpgmap) bu örnek projede, Defold'da çok büyük RPG haritaları oluşturmanın bir yöntemini gösteriyoruz. Tasarım şu varsayımlara dayanır:

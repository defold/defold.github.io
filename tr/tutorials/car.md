...
![Yeni proje](/tutorials/images/new_empty.png)
...
[Yeni bir proje](/tr/manuals/project-setup/) oluşturup düzenleyicide açarak başlayın. *main/main.collection* dosyasına çift tıklarsanız dosya açılır:
...
![Proje derleme](/tutorials/images/car/start_build_and_launch.png)
...
![Kaydedilmemiş değişiklikler içeren dosya](/tutorials/images/car/file_changed.png)
</div>
...
![Yeni koleksiyon dosyası](/tutorials/images/car/start_new_collection.png)
...
![Araba oyun nesnesi ekleme](/tutorials/images/car/start_add_car_gameobject.png)
...
![Araba bileşeni ekleme](/tutorials/images/car/start_add_car_component.png)
...
![Araba görüntüsü](/tutorials/images/car/start_car.png)
![Lastik görüntüsü](/tutorials/images/car/start_tire.png)

Bu görüntüleri atlasa ekleyin:

![Sprite atlası](/tutorials/images/car/start_sprites_atlas.png)

![Sprite özellikleri](/tutorials/images/car/start_sprite_properties.png)
...
![Tamamlanmış araba koleksiyonu](/tutorials/images/car/start_car_collection_complete.png)
...
<div class='sidenote' markdown='1'>
Defold, oyun mantığını kodlamak için çeşitli yaşam döngüsü işlevleri sağlar. Bunlar hakkında daha fazla bilgiyi [Betik kılavuzunda](/tr/manuals/script) bulabilirsiniz.
</div>
...
![Girdi eşlemeleri](/tutorials/images/car/start_input_bindings.png)
...
![Araba koleksiyonunu ekleme](/tutorials/images/car/start_adding_car_collection.png)
...
3. Arabanıza sesler ekleyin ve vınlasın! ([İpucu](/tr/manuals/sound/))

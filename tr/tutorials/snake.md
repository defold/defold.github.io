...
![Küçük resim](/tutorials/images/snake/thumbnail.png)
...
Bu öğretici yeni başlayanlar için tasarlanmıştır; ancak Defold ve oyun geliştirme konusunda tamamen yeniyseniz önce giriş niteliğindeki bazı kılavuzları, özellikle [Defold'un yapı taşları](/tr/manuals/building-blocks/) ve [Terim sözlüğü](/tr/manuals/glossary/) kılavuzlarını okumanızı öneririz. Henüz Defold'u indirmediyseniz [Kurulum kılavuzuna](/tr/manuals/install/) bakın. Düzenleyiciyi hızla tanımak için [Düzenleyiciye genel bakış](/tr/manuals/editor/) kılavuzuna da göz atmanız önerilir; ayrıca burada her adım için ekran görüntüleri sunuyoruz.
...
![Başlangıç](/tutorials/images/snake/1.png)
...
![Ekran ayarları](/tutorials/images/snake/2.png)

Bunu yapmanızın nedeni, oyunun her parçası 16x16 piksel olan bir ızgara üzerine çizilecek olmasıdır; böylece oyun ekranı hiçbir parçayı kısmen kesmez. `game.project` dosyası projenin tüm önemli ayarlarını içerir; bunların tamamını [Proje ayarları kılavuzunda](/tr/manuals/project-settings/) okuyabilirsiniz.
...
![Yeni klasör](/tutorials/images/snake/3.png)
...
![Yılan sprite görüntüleri](/tutorials/images/snake/snake.png)
...
![Yeni klasör](/tutorials/images/snake/4.png)

[Varlıkları içe aktarma hakkında daha fazla ayrıntıyı burada](/tr/manuals/importing-graphics/) da okuyabilirsiniz.

<input type="checkbox"/> Tamam!

## Karo kaynağı ekleme

Defold, ızgara üzerinde hizalanmış *karolardan* (tiles) oluşan oyun alanını oluşturmak için kullanacağınız yerleşik bir [karo haritası (Tile Map)](/tr/manuals/tilemap/) bileşeni (component) sunar. Karo haritası, karoları tek tek ayarlamanıza ve okumanıza olanak tanır; bu da bu oyun için çok uygundur. Karo haritaları grafiklerini bir [karo kaynağından (Tile Source)](/tr/manuals/tilesource/) aldığı için bir karo kaynağı oluşturmanız gerekir:
...
![Yeni karo kaynağı](/tutorials/images/snake/5.png)
...
![Karo kaynağı](/tutorials/images/snake/6.png)
...
![Karo kaynağı özellikleri](/tutorials/images/snake/7.png)
...
![Karo haritası ekleme](/tutorials/images/snake/8.png)
...
![Karo kaynağını ayarlama](/tutorials/images/snake/9.png)
...
![Karo haritası](/tutorials/images/snake/10.png)

3. Ekranın kenarlarını çevreleyen bir sınır ve birkaç engel boyayın.
![Tamamlanmış karo haritası](/tutorials/images/snake/11.png)
...
![Oyun nesnesi ekleme](/tutorials/images/snake/12.png)
...
![Bileşen ekleme](/tutorials/images/snake/13.png)
...
![Oyunu çalıştırma](/tutorials/images/snake/14.png)
...
![Betik ekleme](/tutorials/images/snake/15.png)
...
![Ana koleksiyon](/tutorials/images/snake/16.png)
...
![Algoritma](/tutorials/images/snake/17.png)
...
![Oyunu çalıştırma](/tutorials/images/snake/snake_run_1.png)
...
![Girdi](/tutorials/images/snake/18.png)

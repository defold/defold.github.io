...
- anchor: dynamic-loading-of-factory-resources
  title: Fabrika kaynaklarını dinamik olarak yükleme
- Dinamik prototip
- Örnek sınırları
...
![Fabrika bileşeni](/manuals/images/factory/factory_collection.png)

![Fabrika bileşeni](/manuals/images/factory/factory_component.png)
...
![Çalışma sırasında oluşturulan oyun nesnesi](/manuals/images/factory/factory_spawned.png)
...
`[properties]`
: (isteğe bağlı) Oyun nesnesini başlatırken kullanılacak betik özelliği değerlerini içeren bir Lua tablosu. Betik özellikleri hakkında bilgi için [Betik özellikleri kılavuzuna](/tr/manuals/script-properties) bakın.
...
![Özellik ve ölçeklendirme ile oluşturulan oyun nesnesi](/manuals/images/factory/factory_spawned2.png)
...
![Dinamik yükleme](/manuals/images/factory/load_dynamically.png)
...
![Dinamik prototip](/manuals/images/factory/dynamic_prototype.png)
...
![En fazla örnek sayısı](/manuals/images/factory/factory_max_instances.png)
...
*Max Instances* değerini, dinamik bir dünyada aynı anda var olabilecek en fazla oyun nesnesi sayısına göre planlayın. Diğer bileşen sınırlarının nasıl hesaplandığını öğrenmek için [Bileşen sayısı üst sınırı optimizasyonları](/tr/manuals/project-settings/#component-max-count-optimizations) bölümüne bakın.

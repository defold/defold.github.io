...
* İşleme hattı hakkında daha fazla bilgi için [İşleme belgelerine](/tr/manuals/render) bakın.
* Gölgelendirici programlarının ayrıntılı açıklaması için [Gölgelendirici belgelerine](/tr/manuals/shader) bakın.
...
![Materyal dosyası](/manuals/images/materials/material_file.png)

Yeni materyal *Material Editor* içinde açılır.

![Materyal düzenleyicisi](/manuals/images/materials/material.png)
...
Tags
: Materyalle ilişkili etiketler. Etiketler motorda, birlikte çizilmesi gereken bileşenleri toplamak üzere [`render.predicate()`](/ref/render#render.predicate) tarafından kullanılan bir _bit maskesi_ olarak temsil edilir. Bunun nasıl yapıldığını öğrenmek için [İşleme belgelerine](/tr/manuals/render) bakın. Bir projede kullanabileceğiniz en fazla etiket sayısı 32'dir.
...
![Özel materyal özniteliği](/manuals/images/materials/set_custom_attribute.png)
...
![Örneklerle çizim kurulumu](/manuals/images/materials/instancing-setup.png)

Materyal, örnek başına tekrarlanan tek bir özel köşe özniteliğiyle şu şekilde yapılandırılmıştır:

![Örneklerle çizim materyali](/manuals/images/materials/instancing-material.png)
...
![Örneklerle çizimde çizim çağrıları](/manuals/images/materials/instancing-draw-calls.png)
...
![Sprite örnekleyicisi](/manuals/images/materials/sprite_sampler.png)
...
![Örnekleyici ayarları](/manuals/images/materials/my_sampler.png)
...
![Model örnekleyicileri](/manuals/images/materials/model_samplers.png)

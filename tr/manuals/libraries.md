...
- anchor: setting-up-library-sharing
  title: Kütüphane paylaşımını ayarlama
...
- anchor: setting-up-library-dependencies
  title: Kütüphane bağımlılıklarını ayarlama
...
Paylaşılan sprite bileşenleri ve karo kaynakları (tile source) içeren bir kütüphane oluşturmak istediğinizi varsayalım. Önce [yeni bir proje oluşturun](/tr/manuals/project-setup/). Projeden hangi klasörleri paylaşmak istediğinize karar verin ve bu klasörlerin adlarını proje ayarlarındaki *`include_dirs`* özelliğine ekleyin. Birden fazla klasör listelemek istiyorsanız adları boşluklarla ayırın:

![Dahil edilecek dizinler](/manuals/images/libraries/libraries_include_dirs.png)
...
![GitHub kütüphane URL adresi](/manuals/images/libraries/libraries_library_url_github.png)
...
<div class='important' markdown='1'>
Üçüncü taraf kütüphaneleri kullanmadan önce her zaman incelemeniz önerilir. [Üçüncü taraf yazılımları güvenli kullanma](https://defold.com/tr/manuals/application-security/#securing-your-use-of-third-party-software) hakkında daha fazla bilgi edinin.
</div>
...
![Bağımlılıklar](/manuals/images/libraries/libraries_dependencies.png)
...
![Kütüphaneleri alma](/manuals/images/libraries/libraries_fetch_libraries.png)
...
![Kütüphane kurulumu tamamlandı](/manuals/images/libraries/libraries_done.png)
...
Bir materyali kopyalayıp yapıştırdıysanız ve belirli bir türün tüm bileşenlerinde (component) kullanmak istiyorsanız [projeye özel şablonları](/tr/manuals/editor/#creating-new-project-files) kullanmak yararlı olabilir.

...
toc:
- Motor hizmeti ve çalışma zamanı HTTP APIleri
...
- anchor: automation-bridge-extension
  title: Automation Bridge eklentisi
...
Defold düzenleyicisine ait olan ve açık projeyi kontrol eden [düzenleyici sunucusundan](/tr/manuals/editor-http-api) ayrıdır.
...
![Defold hata ayıklama derlemesinde motor hizmetinin bağlantı noktası bilgisi](/manuals/images/automation/engine-service.png)
...
![Motor sunucusuna erişim](/manuals/images/automation/engine-server.png)
...
Çalışma zamanı betikleri, fizik, girdi, dinamik olarak oluşturulan nesneler ve platforma özgü işleme, çalışan bir motor gerektirir ve [otomatik çalışma zamanı testleri](/tr/manuals/automated-testing) aracılığıyla doğrulanmaları önerilir.

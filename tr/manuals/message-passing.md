...
İleti aktarımı (message passing), Defold oyun nesnelerinin (game object) birbirleriyle iletişim kurmasını sağlayan bir mekanizmadır. Bu kılavuz, Defold'un [adresleme mekanizması](/tr/manuals/addressing) ve [temel yapı taşları](/tr/manuals/building-blocks) hakkında temel bilgiye sahip olduğunuzu varsayar.
...
![İleti aktarımı yapısı](/manuals/images/message_passing/message_passing_structure.png)
...
![İleti aktarımı](/manuals/images/message_passing/message_passing.png)
...
{% include shared/tr/url-shorthands.md %}
...
![Koleksiyon adı](/manuals/images/message_passing/collection_name.png)
...
```
Vekillerin nasıl çalıştığına ilişkin daha ayrıntılı bir açıklamayı [Koleksiyon vekilleri](/tr/manuals/collection-proxy) belgesinde bulabilirsiniz.

...
- anchor: creating-a-new-project
  title: Yeni bir yerel proje oluşturma
...
![proje açma](/manuals/images/workflow/open_project.png)

Veya adım adım yönergeler içeren bir öğreticiden (Tutorial):

![öğreticiden proje oluşturma](/manuals/images/workflow/create_from_tutorial.png)

Veya tamamlanmış bir örnek oyundan (Sample):

![örnekten proje oluşturma](/manuals/images/workflow/create_from_sample.png)
...
![projeyi içe aktarma](/manuals/images/workflow/open_from_disk.png)

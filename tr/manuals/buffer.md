...
Bir arabellek kaynağı, bir [örgü bileşeninin (Mesh component)](/tr/manuals/mesh) girdisi olarak kullanılabilir. Arabellek kaynakları `buffer.create()` ve [ilgili API işlevleri](/ref/buffer/#buffer.create:element_count-declaration) kullanılarak çalışma sırasında da oluşturulabilir.
...
Düzenleyici önizlemesi, motorun yazı tipi işleyicisini kullanarak metin şekillendirmeyi ve sağdan sola yerleşimi destekler. Gerekli yazı tipi ve App Manifest ayarları için [metin yerleşimi desteğine](/tr/manuals/font/#text-layout-support-eg-right-to-left) bakın.
...
![Yazı tipleri](/manuals/images/gui-text/fonts.png)
...
![Metin hizalaması](/manuals/images/gui-text/align.png)

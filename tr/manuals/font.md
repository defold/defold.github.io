...
- anchor: text-layout-support-eg-right-to-left
  title: Metin yerleşimi desteği (ör. sağdan sola)
...
- anchor: bitmap-bmfonts
  title: Bit eşlem BMFont yazı tipleri
- Görüntü kusurları ve önerilen uygulamalar
- Yazı tipi önbelleği
- anchor: enabling-runtime-fonts
  title: Çalışma zamanı yazı tiplerini etkinleştirme
...
Metnin ayrı bölümlerini biçimlendirme, bağlantılar ve satır içi sprite bileşenleriyle çalışma hakkında bilgi için [Zengin metin işaretleme kılavuzuna](/tr/manuals/font-richtext) bakın.
...
[Çalışma zamanı yazı tiplerini etkinleştirme](/tr/manuals/font#enabling-runtime-fonts) bölümüne bakın.
...
![Uzaklık alanı yazı tipi](/manuals/images/font/df_font.png)
...
![Büyütülmüş yazı tipleri](/manuals/images/font/scale_up.png)
...
![Küçültülmüş yazı tipleri](/manuals/images/font/scale_down.png)
...
![Uzaklık alanı görüntü kusurları](/manuals/images/font/df_artifacts.png)
...
Gölgelendirici uniform parametreleri hakkında daha fazla bilgi için [Gölgelendirici kılavuzuna](/tr/manuals/shader) bakın.
...
* Bir [App Manifest](/tr/manuals/app-manifest) ekleyin ve `Use full text layout system` seçeneğini etkinleştirin.

...
- anchor: input-dispatch-and-on_input
  title: Girdi dağıtımı ve on_input()
...
![Girdi eşlemeleri](/manuals/images/input/overview.png)
...
: Bilgisayarınızın veya mobil cihazınızın parçası olan ya da bunlara bağlanan girdi cihazları, Defold çalışma zamanı ortamına sistem düzeyinde ham girdi sağlar. Aşağıdaki cihaz türleri desteklenir:
  ...
  4. Oyun kumandaları (işletim sistemi tarafından desteklendiği ve [gamepads](/tr/manuals/input-gamepads/#gamepads-settings-file) dosyasında eşlendiği şekilde)
...
![Girdi eşlemesi ayarı](/manuals/images/input/setting.png)
...
![Girdi eşlemelerini ayarlama](/manuals/images/input/input_binding.png)
...
Key Triggers
: Tek tuşluk klavye girdisi. Her tuş, karşılık gelen bir eyleme ayrı ayrı eşlenir. Daha fazla bilgi için [tuş ve metin girdisi kılavuzuna](/tr/manuals/input-key-and-text) bakın.

Text Triggers
: Metin tetikleyicileri, serbest metin girdisini okumak için kullanılır. Daha fazla bilgi için [tuş ve metin girdisi kılavuzuna](/tr/manuals/input-key-and-text) bakın

Mouse Triggers
: Fare düğmelerinden ve kaydırma tekerleklerinden gelen girdi. Daha fazla bilgi için [fare ve dokunma girdisi kılavuzuna](/tr/manuals/input-mouse-and-touch) bakın.

Touch Triggers
: Tekli dokunma ve çoklu dokunma türündeki tetikleyiciler, iOS ve Android cihazlarda yerel uygulamalarda ve HTML5 dağıtım paketlerinde kullanılabilir. Daha fazla bilgi için [fare ve dokunma kılavuzuna](/tr/manuals/input-mouse-and-touch) bakın.

Gamepad Triggers
: Oyun kumandası tetikleyicileri, standart oyun kumandası girdisini oyun işlevlerine bağlamanızı sağlar. Daha fazla bilgi için [oyun kumandaları kılavuzuna](/tr/manuals/input-gamepads) bakın.
...
![Girdi yığını](/manuals/images/input/input_stack.png)
...
![Eylem dağıtımı](/manuals/images/input/actions.png)
...
![Eylemlerin vekillere dağıtımı](/manuals/images/input/proxy.png)
...
![Girdiyi tüketme](/manuals/images/input/consuming.png)
...
![Girdiyi tüketme](/manuals/images/input/game.png)
...
![Duraklatma menüsü](/manuals/images/input/game_paused.png)

...
Aynı sonuç, bir oyun nesnesine (game object) [kamera bileşeni](/tr/manuals/camera/) ekleyip *Orthographic Projection* seçeneğini işaretleyerek ve *Orthographic Zoom* değerini 4.0 olarak ayarlayarak da elde edilebilir:

...
- anchor: creating-html5-bundle
  title: HTML5 dağıtım paketi oluşturma
- WebGL bağlam sürümü
- anchor: download-verification
  title: İndirme doğrulaması
...
![Proje ayarları](/manuals/images/html5/html5_project_settings.png)
...
![HTML5 derleme](/manuals/images/html5/html5_build_launch.png)
...
![HTML5 dağıtım paketi oluşturma](/manuals/images/html5/html5_bundle.png)
...
Mimarilerden birini veya her ikisini de pakete ekleyebilirsiniz. Her ikisi de eklendiğinde yükleyici, tarayıcı ve barındırma ortamı destekliyorsa `wasm_pthread-web` mimarisini seçer; aksi durumda `wasm-web` mimarisine geçer. Standart hedef adları için [Bob kılavuzuna](/tr/manuals/bob/#usage) bakın.
...
İstenen grafik bağlamını [`graphics.webgl_version_hint`](/tr/manuals/project-settings/#webgl-version-hint) aracılığıyla seçin. Varsayılan değer WebGL 2'dir; her iki sürümü de destekleyen tarayıcılarda WebGL 1 bağlamını test etmek veya hedeflemek için WebGL 1'i isteyin.
...
**Verify Downloaded File Size** seçeneğinin devre dışı bırakılması, dağıtım paketine dahil edilen tüm SHA-1 doğrulamalarını etkin bırakır. [HTML5 proje ayarlarına](/tr/manuals/project-settings/#verify-downloaded-file-size) bakın.
...
* Oyun kumandası (gamepad) desteği - HTML5'te dikkate almanız gereken özel durumlar ve uygulamanız gerekebilecek adımlar için [oyun kumandası belgelerine bakın](/tr/manuals/input-gamepads/#gamepads-in-html5).
...
![HTML5 bölümü](/manuals/images/html5/html5_section.png)

Her seçenek hakkında daha fazla bilgi [proje ayarları kılavuzunda](/tr/manuals/project-settings/#html5) bulunur.
...
![Display bölümü](/manuals/images/html5/html5_display.png)

*game.project* dosyasını metin olarak açın ve `[section_name]` değerini ve kullanmak istediğiniz alanın adını kontrol edin. Ardından bunu bir belirteç olarak kullanabilirsiniz: `{% raw %}{{section_name.field}}{% endraw %}` veya `{% raw %}{{{section_name.field}}}{% endraw %}`.

![Display bölümü](/manuals/images/html5/html5_game_project.png)
...
<div class='important' markdown='1'>
Bu satır içi bloğun, ana uygulama betiği yüklenmeden önce yer alması önemlidir. HTML etiketleri içerdiği için bu makro, karakter dizilerine kaçış uygulanmasını önlemek üzere üçlü süslü parantez `{% raw %}{{{TOKEN}}}{% endraw %}` içinde yer almalıdır.
</div>
...
* [Bellek kullanımı](/tr/manuals/optimization-memory)
* [Motor boyutu](/tr/manuals/optimization-size)
* [Oyun boyutu](/tr/manuals/optimization-size)

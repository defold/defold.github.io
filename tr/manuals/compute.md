...
- Hesaplama programını Defoldda kullanma
...
* Görüntü oluşturmak için kullanılan işleme (rendering) hattı hakkında daha fazla bilgi için [İşleme belgelerine](/tr/manuals/render) bakın.
...
![Hesaplama dosyası](/manuals/images/compute/compute_file.png)

Yeni hesaplama dosyası *Compute Editor* içinde açılır.

![Hesaplama düzenleyicisi](/manuals/images/compute/compute.png)
...
![Hesaplama programı içeren işleme dosyası](/manuals/images/compute/compute_render_file.png)
...
Diziye yalnızca desteklenen özellikler dahil edilir; bu yapı, anahtar olarak özellik sabitlerini kullanan bir tablo değildir. Oyun farklı grafik bağdaştırıcılarıyla veya sürücü desteği farklı cihazlarda çalışabiliyorsa, hesaplama gölgelendiricilerini kullanmadan önce her zaman bu kontrolü yapın. OpenGL ve OpenGL ES desteği API sürümüne ve sürücüye bağlıdır. Vulkan ve MoltenVK aracılığıyla Metal, 1.0 sürümünden itibaren hesaplama gölgelendiricilerini destekler. Vulkan'ın varsayılan grafik arka ucu olmadığı platformlarda Vulkan'ı seçmek için bir [uygulama bildirimi](/tr/manuals/app-manifest) kullanın.
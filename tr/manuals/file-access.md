...
- anchor: how-to-access-files-bundled-with-the-application
  title: Uygulamanın dağıtım paketine eklenen dosyalara erişme
...
Eklentiler de `ext.properties` aracılığıyla bu dosyaları ekleyebilir. Bu dosyaların yolları, hem düzenleyici derlemelerinde hem de Bob arşivlerinde projenin özel kaynaklarıyla birleştirilir. [Eklentilerde özel kaynaklar](/tr/manuals/extensions/#custom-resources) bölümüne bakın.

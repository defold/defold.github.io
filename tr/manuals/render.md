...
- anchor: render-predicates
  title: İşleme yüklemleri
- anchor: default-view-projection
  title: Varsayılan görünüm izdüşümü
- Esnetme izdüşümü
...
- anchor: frustum-culling
  title: Görüş hacmi dışında kalanları eleme
- Koordinat sistemleri
- anchor: the-render-script
  title: İşleme betiği
- İşleme kaynakları
- anchor: multisampled-render-targets
  title: Çok örnekli işleme hedefleri
- Doku tanıtıcıları
- Desteklenen grafik APIleri
- Sistem iletileri
- anchor: draw-calls-and-batching
  title: Çizim çağrıları ve toplu çizim
...
![Yerleşik işleme](/manuals/images/render/builtin.png)
...
Materyallerin nasıl çalıştığına ilişkin ayrıntılı açıklamayı [Materyal belgesinde](/tr/manuals/material) bulabilirsiniz.
...
![Esnetme izdüşümü](/manuals/images/render/stretch_projection.png)

*Özgün pencere boyutuyla esnetme izdüşümü*

![Yeniden boyutlandırıldığında esnetme izdüşümü](/manuals/images/render/stretch_projection_resized.png)
...
![Sabit sığdırma izdüşümü](/manuals/images/render/fixed_fit_projection.png)

*Özgün pencere boyutuyla sabit sığdırma izdüşümü*

![Yeniden boyutlandırıldığında sabit sığdırma izdüşümü](/manuals/images/render/fixed_fit_projection_resized.png)

*Pencere yatay olarak esnetildiğinde sabit sığdırma izdüşümü*

![Küçültüldüğünde sabit sığdırma izdüşümü](/manuals/images/render/fixed_fit_projection_resized_smaller.png)
...
![Sabit izdüşüm](/manuals/images/render/fixed_projection_zoom_2_0.png)

*Yakınlaştırma 2 olarak ayarlandığında sabit izdüşüm*

![Sabit izdüşüm](/manuals/images/render/fixed_projection_zoom_0_5.png)

*Yakınlaştırma 0,5 olarak ayarlandığında sabit izdüşüm*

![Sabit izdüşüm](/manuals/images/render/fixed_projection_zoom_2_0_resized.png)
...
Varsayılan işleme betiği kullanılırken projede etkin [kamera bileşenleri](/tr/manuals/camera) varsa, bunlar işleme betiğinde ayarlanan diğer tüm görünüm / izdüşümlere göre önceliklidir. İşleme betiklerinde kamera bileşenleriyle nasıl çalışılacağı hakkında daha fazla bilgi için [Kamera belgesine](/tr/manuals/camera) bakın.
...
1 = Örgünün sınırlayıcı kutusunun geliştirici tarafından ayarlanması gerekir. [Daha fazla bilgi](/tr/manuals/mesh/#frustum-culling).
...
![İşleme kaynakları](/manuals/images/render/render_resources.png)
...
Düğümleri hiyerarşiler halinde düzenleyebilmek, düğümleri yönetilebilir birimler halinde gruplamayı kolaylaştırır. Ancak farklı düğüm türlerini karıştırırsanız hiyerarşiler toplu çizimi bozabilir. GUI katmanlarını kullanarak düğüm hiyerarşilerini korurken GUI düğümlerini daha etkili biçimde toplu çizim için gruplamak mümkündür. GUI katmanları ve bunların çizim çağrılarını nasıl etkilediği hakkında daha fazla bilgiyi [GUI kılavuzunda](/tr/manuals/gui#layers-and-draw-calls) bulabilirsiniz.
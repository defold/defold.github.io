...
: Görüntüleri *Asset* bölmesinden düzenleyici görünümüne sürükleyip bırakın.
  ...
  ![Atlas oluşturma, görüntü ekleme](/manuals/images/atlas/add.png)
  ...
  ![Eklenen görüntüler](/manuals/images/atlas/single_images.png)
...
: *Outline* bölmesindeki kök Atlas öğesine <kbd>sağ tıklayın</kbd>.
  ...
  ![Atlas oluşturma, görüntü ekleme](/manuals/images/atlas/add_animation.png)
  ...
  ![Animasyon grubu](/manuals/images/atlas/animation_group.png)
...
![Çok sayfalı atlas](/manuals/images/atlas/multipage_atlas.png)
...
![Atlas özellikleri](/manuals/images/atlas/atlas_properties.png)
...
![Görüntü özellikleri](/manuals/images/atlas/image_properties.png)
...
Doku, `go.set()` kullanılarak doğrudan bir [model bileşeninde](/tr/manuals/model/) kullanılabilir:
...
Dokunun bir [sprite bileşeninde](/tr/manuals/sprite/) kullanılması için önce bir atlas tarafından kullanılması gerekir. Bir atlas oluşturmak için [`resource.create_atlas(path, params)`](https://defold.com/ref/stable/resource/#resource.create_atlas:path-table) işlevini kullanın:

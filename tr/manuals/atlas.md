...
Dokunun bir [sprite bileşeninde](/tr/manuals/sprite/) kullanılması için önce bir atlas tarafından kullanılması gerekir. Bir atlas oluşturmak için [`resource.create_atlas(path, params)`](https://defold.com/ref/resource/#resource.create_atlas:path-table) işlevini kullanın:

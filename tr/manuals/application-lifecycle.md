...
![Yaşam döngüsüne genel bakış](/manuals/images/application_lifecycle/application_lifecycle.png)
...
![Başlangıç işlemleri](/manuals/images/application_lifecycle/initialization.png)
...
![Ön başlatma](/manuals/images/application_lifecycle/pre_init.png)
...
![Koleksiyonun başlangıç işlemleri](/manuals/images/application_lifecycle/collection_init.png)
...
![Güncelleme sonrası aşama](/manuals/images/application_lifecycle/post_init.png)
...
![Güncelleme döngüsü](/manuals/images/application_lifecycle/update_loop.png)
...
![Güncelleme aşaması](/manuals/images/application_lifecycle/update_phase.png)
...
Fizik benzetimi için [sabit zaman adımı](/tr/manuals/physics/#physics-updates) kullanılıyorsa tüm betik bileşenlerinin `fixed_update()` işlevi de çağrılabilir. Bu işlev, fizik tabanlı oyunlarda kararlı bir fizik benzetimi elde etmek için fizik nesnelerini düzenli aralıklarla değiştirmek istediğinizde yararlıdır.
...
![İşleme güncellemesi aşaması](/manuals/images/application_lifecycle/render_update_phase.png)
...
![Güncelleme sonrası aşama](/manuals/images/application_lifecycle/post_update_phase.png)
...
![İşleme aşaması](/manuals/images/application_lifecycle/render_phase.png)

Ardından grafikler ve görsel profil çıkarıcının görüntüsü işlenir ([Hata ayıklama belgelerine](/tr/manuals/debugging) bakın). Grafikler işlendikten sonra video kaydı yapılır.
...
(Ayrıntılar için [Koleksiyon vekili kılavuzuna](/tr/manuals/collection-proxy) ve [`set_time_step`](/ref/collectionproxy#set-time-step) başvurusuna bakın)
...
![Sonlandırma işlemleri](/manuals/images/application_lifecycle/finalization.png)
...
![İletileri dağıtma](/manuals/images/application_lifecycle/dispatch_messages.png)
...
Alıcı bileşenlerin `on_message()` kodu ek iletiler gönderebildiğinden, ileti dağıtıcısı ileti kuyruğu boşalana kadar gönderilen iletileri özyinelemeli olarak dağıtmaya devam eder. Ancak ileti dağıtıcısının ileti kuyruğunu kaç kez dolaşacağına ilişkin bir sınır vardır. Ayrıntılar için [İleti zincirlerine](/tr/manuals/message-passing) bakın.
...
- Oyununuzu başlatma
- Windowsta USB kullanarak bir iOS cihazına bağlanma
- Linuxta USB kullanarak bir iOS cihazına bağlanma
- macOSta USB kullanarak bir iOS cihazına bağlanma
- macOSta USB kullanarak bir Android cihazına bağlanma
- Windows veya Linuxta USB kullanarak bir Android cihazına bağlanma
- Sorun giderme
---
...
Debug modunda paketlenen herhangi bir iOS veya Android uygulaması, geliştirme uygulaması olarak kullanılabilir. Aslında önerilen çözüm budur; çünkü geliştirme uygulaması doğru proje ayarlarına sahip olur ve üzerinde çalıştığınız projeyle aynı [yerel kod eklentilerini (native extensions)](/tr/manuals/extensions/) kullanır. 
...
![İçeriksiz dağıtım paketi](/manuals/images/dev-app/contentless-bundle.png)

### iOS üzerinde kurma

iOS için dağıtım paketi oluşturmak üzere [iOS kılavuzundaki yönergeleri](/tr/manuals/ios/#creating-an-ios-application-bundle) izleyin. Derleme çeşidi olarak Debug seçtiğinizden emin olun!

### Android üzerinde kurma

Android için dağıtım paketi oluşturmak üzere [Android kılavuzundaki yönergeleri](https://defold.com/tr/manuals/android/#creating-an-android-application-bundle) izleyin.
...
5. Oyun çalışırken her zamanki gibi [çalışma sırasında yeniden yükleme (hot reload)](/tr/manuals/hot-reload/) özelliğini kullanabilirsiniz.

...
![Düzenleyicide bean](/manuals/images/addressing/bean_editor.png)
...
![Göreli tanımlayıcı](/manuals/images/addressing/relative_same.png)
...
![Yönetici nesnesi](/manuals/images/addressing/manager_editor.png)
...
![Takımlar ve yönetici](/manuals/images/addressing/teams_manager.png)

![Mutlak adresleme](/manuals/images/addressing/absolute.png)
...
socket
: Hedefin oyun dünyasını tanımlar. [Koleksiyon vekilleriyle (collection proxy)](/tr/manuals/collection-proxy) çalışırken bu önemlidir ve bu durumda _dinamik olarak yüklenen koleksiyonu_ tanımlamak için kullanılır.

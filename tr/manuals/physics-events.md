...
toc:
- Defoldda fizik olaylarını işleme
...
Bir dinleyici ayarlandığında, bu dinleyicinin ayarlandığı fizik dünyası için artık [fizik iletileri](/tr/manuals/physics-messages) gönderilmez.
</div>

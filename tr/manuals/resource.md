...
- *game.project* dosyasında tanımlanan [özel kaynaklar](/tr/manuals/project-settings/#custom-resources).

![Kaynak ağacı](/manuals/images/resource/resource_tree.png)

<div class='sidenote' markdown='1'>
Defold'da [dağıtım paketine eklenen kaynaklar](/tr/manuals/project-settings/#bundle-resources) kavramı da vardır. Bu kaynaklar uygulamanın dağıtım paketine dahil edilir, ancak kaynak ağacının bir parçası değildir. Dağıtım paketine eklenen kaynaklar, platforma özgü destek dosyalarından [dosya sisteminden yüklenen](/tr/manuals/file-access/#how-to-access-files-bundled-with-the-application) ve oyununuzun kullandığı harici dosyalara (örneğin FMOD ses bankaları) kadar her tür dosya olabilir.
</div>
...
- Koleksiyon vekilleri aracılığıyla başvurulan oyun dünyası koleksiyonları. Oyun dünyaları nispeten büyüktür; bu nedenle bunların yüklenmesini ve bellekten kaldırılmasını kodda elle tetiklemeniz gerekir. Ayrıntılar için [Koleksiyon vekili kılavuzuna](/tr/manuals/collection-proxy) bakın.
...
![Kaynak yükleme](/manuals/images/resource/loading.png)
...
![Dinamik yükleme](/manuals/images/resource/load_dynamically.png)
...
Bunun nasıl çalıştığıyla ilgili ayrıntılar için [Fabrika kılavuzunu](/tr/manuals/factory) ve [Koleksiyon fabrikası (collection factory) kılavuzunu](/tr/manuals/collection-factory) okuyun.

...
* bob kullanarak, `--with-symbols` seçeneğiyle uygulamanın dağıtım paketini oluşturun ([daha fazla bilgi](/tr/manuals/debugging-native-code/#symbolicate-a-callstack)):
...
* `.dSYM` klasörünü, yani hata ayıklama sembollerini (debug symbols) edinin
	...
	* Yerel kod eklentisi kullanıyorsanız `.dSYM` klasörü, [bob.jar](https://www.defold.com/tr/manuals/bob/) ile projeyi derlediğinizde oluşturulur. Yalnızca projeyi derlemek gerekir (arşivleme veya paketleme gerekmez):
...
* Yeni bir Xcode projesi oluşturun, `Game` şablonunu seçin
	...
	![Proje şablonu](/manuals/images/extensions/debugging/ios/project_template.png)
...
* Kodunuzu uygulamaya ekleyin
	...
	![Dosya ekleme](/manuals/images/extensions/debugging/ios/add_files.png)

* "Copy items if needed" seçeneğinin işaretli olmadığından emin olun.

	![Kaynak kod ekleme](/manuals/images/extensions/debugging/ios/add_source.png)

* Sonuç şöyle görünür

	![Eklenen kaynak kod](/manuals/images/extensions/debugging/ios/added_source.png)


* `Build` adımını devre dışı bırakın

	![Şema düzenleme](/manuals/images/extensions/debugging/ios/edit_scheme.png)

	![Derleme adımını devre dışı bırakma](/manuals/images/extensions/debugging/ios/disable_build.png)

* `Deployment target` sürümünü, artık cihazınızın iOS sürümünden daha yüksek olacak şekilde ayarlayın

	![Dağıtıma alma sürümü](/manuals/images/extensions/debugging/ios/deployment_version.png)

* Hedef cihazı seçin

	![Cihaz seçme](/manuals/images/extensions/debugging/ios/select_device.png)
...
2. Ya da `Attach to process by PID or Process name` seçeneğini seçebilirsiniz
	...
	![Cihaz seçme](/manuals/images/extensions/debugging/ios/attach_to_process_name.png)
...
```
	...
	![dSYM ekleme](/manuals/images/extensions/debugging/ios/add_dsym.png)
...
* Proje görünümünde bir dosya açın ve bir kesme noktası (breakpoint) belirleyin
	...
	![Kesme noktası](/manuals/images/extensions/debugging/ios/breakpoint.png)

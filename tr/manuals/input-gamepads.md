...
- anchor: gamepads-settings-file
  title: Oyun kumandası ayar dosyası
- Tanımlanamayan oyun kumandaları
- anchor: gamepads-in-html5
  title: HTML5te oyun kumandaları
- Standart oyun kumandası
- Windowsta oyun kumandaları
- Androidde oyun kumandaları
---

<div class='sidenote' markdown='1'>
Defold'da girdinin genel olarak nasıl çalıştığını, girdinin nasıl alındığını ve betik dosyalarınızda hangi sırayla alındığını öğrenmeniz önerilir. Girdi sistemi hakkında daha fazla bilgi için [Girdiye genel bakış kılavuzuna](/tr/manuals/input) bakın.
</div>
...
![Oyun kumandası ayarları](/manuals/images/input/gamepads.png)
...
![Oyun kumandası ayarları](/manuals/images/input/gamepad_setting.png)

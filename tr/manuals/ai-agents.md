...
* [Düzenleyici betikleri](/tr/manuals/editor-scripts), projeye özgü kaynak işlemleri ve araçlar sağlayabilir.
* [Düzenleyici HTTP API'si](/tr/manuals/editor-http-api), düzenleyici komutları, derleme sonuçları, konsol çıktısı, başvuru araması, önizlemeler, tercihler ve düzenleyici betiği rotaları sağlar.
* [Motor hizmeti ve çalışma zamanı otomasyon API'leri](/tr/manuals/engine-service), hata ayıklama motorunun canlı durumunu, girdileri, ekran görüntülerini ve eklentilerin tanımladığı işlemleri sağlar.
* [Bob](/tr/manuals/bob), komut satırından proje derleme olanağı, raporlar, arşivler ve dağıtım paketleri sağlar.
...
Ajanların diğer tüm otomasyonlarla aynı [incele, değiştir, doğrula, değerlendir döngüsünü](/tr/manuals/automation/#the-automation-loop) izlemesi önerilir.
...
Otomatik test ve doğrulamaya ilişkin iyi uygulamalar [bu kılavuzda](/tr/manuals/automated-testing) açıklanır.

## Çok modlu değerlendirme

Görüntü girdisi alabilen bir ajan, [düzenleyici önizlemelerini](/tr/manuals/editor-http-api/#rendering-scene-previews), çalışma sırasında alınan ekran görüntülerini, görsel farkları ve tarayıcı görüntülerini inceleyebilir.
...
Düzenleyici önizlemeleri, çalışma sırasında alınan ekran görüntüleri ve görsel inceleme hakkında daha fazla bilgi için [bu kılavuzu](/tr/manuals/automated-testing) okuyun.

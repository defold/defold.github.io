...
![Blender'da model](/manuals/images/model/blender_gltf.png)
...
![İçe aktarılan model varlıkları](/manuals/images/model/assets_gltf.png)
...
## Model kullanma
Modeli içe aktardıktan sonra bir [model bileşeninde](/tr/manuals/model) kullanın:
...
![Tümünü seçme](/manuals/images/model/blender_select_all_vertices.png)

Tüm köşeler seçildiğinde UV yerleşimini elde etmek için örgünün UV açılımını yapın:

![Örgünün UV açılımını yapma](/manuals/images/model/blender_unwrap_mesh.png)

Ardından UV yerleşimini doku olarak kullanılabilecek bir görüntüye dışa aktarabilirsiniz:

![UV yerleşimini dışa aktarma](/manuals/images/model/blender_export_uv_layout.png)

![UV yerleşimini dışa aktarmanın sonucu](/manuals/images/model/blender_export_uv_layout_result.png)

### Blender ile dışa aktarma
Modelinizi Blender'dan <kbd>File ▸ Export ▸ glTF 2.0 (.glb/.gltf)</kbd> ile dışa aktarın.

![Blender ile dışa aktarma](/manuals/images/model/export_gltf.png)
...
![Blender ile dışa aktarma](/manuals/images/model/export_settings.png)
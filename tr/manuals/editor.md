...
- anchor: the-editor-views
  title: Düzenleyici bölmeleri
- 1. Assets bölmesi
- anchor: the-scene-editor
  title: 2. Scene Editor bölmesi
- 3. Outline bölmesi
...
: Yakın zamanda açtığınız projeler, onlara hızlıca erişebilmeniz için burada bulunur. Bu, başlangıç ekranının varsayılan görünümüdür.
  ...
  ![Projelerim](/manuals/images/editor/start_no_projects.png)


  Daha önce proje açtıysanız aşağıdaki resimdeki gibi projelerinizin listesi gösterilir:

  ![Projelerim](/manuals/images/editor/start_my_projects.png)
...
: Belirli kullanım senaryolarını göstermek için hazırlanmış projeler içerir.
  ...
  ![Yeni proje](/manuals/images/editor/start_templates.png)

Yeni bir proje oluşturduğunuzda proje yerel sürücünüzde saklanır ve yaptığınız tüm değişiklikler yerel olarak kaydedilir.

Farklı seçenekler hakkında daha fazla bilgiyi [Proje kurulumu kılavuzunda](https://www.defold.com/tr/manuals/project-setup/) bulabilirsiniz.
...
![Diller](/manuals/images/editor/languages.png)
...
![Scene Editor görünümü](/manuals/images/editor/2d_scene.png)

Scene Editor tarafından sunulan temel özelliklerden bazıları:

- Ortografik ve perspektif kamera modlarıyla [2B ve 3B sahnelerde gezinme](/tr/manuals/scene-editing/#2d-and-3d-scene-orientation)
- Nesneleri taşımak, döndürmek ve ölçeklemek için [dönüşüm araçları](/tr/manuals/scene-editing/#manipulating-objects)
- Birinci şahıs bakış açısıyla 3B gezinme için [serbest kamera modu](/tr/manuals/scene-editing/#free-camera-mode)
- Boyutu, düzlemi ve görünümü yapılandırılabilen [ızgara ayarları](/tr/manuals/scene-editing/#grid-settings)
- Bileşen türlerinin ve kılavuzların görünürlüğünü değiştirmek için [görünürlük filtreleri](/tr/manuals/scene-editing/#visibility-filters)

Daha fazla bilgiyi [Sahne düzenleyicisi kılavuzunda](/tr/manuals/scene-editing/) bulabilirsiniz.
...
![Outline bölmesi](/manuals/images/editor/outline.png)
...
![Properties bölmesi](/manuals/images/editor/properties.png)
...
*Curve Editor*: [Parçacık düzenleyicisinde](/tr/manuals/particlefx/) eğrileri düzenlerken kullanılır.

Tools bölmesi, tümleşik hata ayıklayıcıyla etkileşim kurmak için de kullanılır. Daha fazla bilgiyi [Hata ayıklama kılavuzunda](/tr/manuals/debugging/) bulabilirsiniz.

### 6. Changed Files bölmesi

Projenizde Git kullanılıyorsa bu görünüm, geçerli Git kaydına (commit) (`HEAD`) kıyasla yerel olarak değiştirilen, eklenen, yeniden adlandırılan veya silinen dosyaları listeler. Uzak bir depoyla eşitlemek için harici bir Git istemcisi veya komut satırını kullanın. Daha fazla bilgiyi [Sürüm kontrolü kılavuzunda](/tr/manuals/version-control/) bulabilirsiniz. Dosyalarla ilgili bazı işlemleri bu görünümde yapabilirsiniz:
...
![Bölme görünürlüğü](/manuals/images/editor/editor_panes.png)
...
- Varsayılan düzenleyici dışında bir düzenleyici veya `File ▸ Preferences ▸ Code ▸ Custom Editor` altında ayarlanmış ilişkili harici aracı kullanmak için `➝| Open As` seçeneğini seçin. Daha fazla bilgiyi [Tercihler kılavuzunda](/tr/manuals/editor-preferences) bulabilirsiniz.

![Sekmeler](/manuals/images/editor/tabs_custom.png)
...
![2 bölme](/manuals/images/editor/2-panes.png)
...
![Dosya oluşturma](/manuals/images/editor/create_file.png)
...
![Proje seçim ekranından güncelleme](/manuals/images/editor/update_start.png)
![Düzenleyiciden güncelleme](/manuals/images/editor/update_available.png)
...
![Düzenleyiciyi güncelleme penceresi](/manuals/images/editor/update.png)

İndirme ilerlemesini alttaki durum çubuğunda görebilirsiniz:

![İndirme ilerlemesi](/manuals/images/editor/download_status.png)
...
![Güncellemek için yeniden başlatma](/manuals/images/editor/restart_to_update.png)
...
Daha fazla ayrıntıyı [Tercihler kılavuzunda](/tr/manuals/editor-preferences) bulabilirsiniz

![Preferences penceresi](/manuals/images/editor/preferences.png)
...
Daha fazla bilgiyi [Yardım alma kılavuzunda](/tr/manuals/getting-help/#getting-help) bulabilirsiniz.

![Show Logs seçeneği](/manuals/images/editor/show_logs.png)
...
Düzenleyicinin görünümü özel biçimlendirmeyle değiştirilebilir. Daha fazla bilgiyi [Düzenleyici biçimlendirme kılavuzunda](/tr/manuals/editor-styling) bulabilirsiniz.

## Sık sorulan sorular
{% include shared/tr/editor-faq.md %}
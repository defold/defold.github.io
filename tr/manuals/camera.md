...
- anchor: converting-mouse-to-world-coordinates
  title: Ekran ve dünya koordinatları arasında dönüştürme
- Çalışma sırasında değiştirme
- anchor: third-party-camera-solutions
  title: Üçüncü taraf kamera çözümleri
---
...
![izdüşümler](/manuals/images/camera/projections.png)
...
![kamera bileşeni oluşturma](/manuals/images/camera/create.png)

Kamera bileşeni, kameranın *görüş hacmini* tanımlayan şu özelliklere sahiptir:

![kamera ayarları](/manuals/images/camera/settings.png)
...
![oyun nesnesini takip etme](/manuals/images/camera/follow.png)
...
<div class='sidenote' markdown='1'>
[Bu kılavuzda sözü edilen üçüncü taraf kamera çözümleri](/tr/manuals/camera/#third-party-camera-solutions), ekran koordinatlarına ve ekran koordinatlarından dönüştürme işlevleri sağlar.
</div>

...
* Görüntüler, 2B oyunlarda sık kullanılan birçok görsel bileşen türünü oluşturmak için kullanılabilir. [2B grafiklerin nasıl içe aktarılacağı ve kullanılacağı hakkında daha fazla bilgiyi burada bulabilirsiniz](/tr/manuals/importing-graphics).
* Sesler, ses çalmak için [ses bileşeni (Sound)](/tr/manuals/sound) tarafından kullanılabilir.
* Yazı tipleri, [etiket bileşeni (Label)](/tr/manuals/label) ve GUI içindeki [metin düğümleri](/tr/manuals/gui-text) tarafından kullanılır.
* glTF modelleri (*.gltf* ve *.glb*), animasyonlu 3B modelleri göstermek için [model bileşeni (Model)](/tr/manuals/model) tarafından kullanılabilir. Modelin kullandığı tüm doku görüntülerini ayrı varlıklar olarak içe aktarın ve bunları model bileşeninin materyal doku özelliklerine atayın. [3B modellerin nasıl içe aktarılacağı ve kullanılacağı hakkında daha fazla bilgiyi burada bulabilirsiniz](/tr/manuals/importing-models).

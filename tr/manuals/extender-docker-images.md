...
3. Yerel Extender'ı [Önceden yapılandırılmış çıktı dosyalarıyla yerel Extender'ı çalıştırma](/tr/manuals/extender-local-setup#how-to-run-local-extender-with-preconfigured-artifacts) bölümünde açıklandığı gibi çalıştırın.
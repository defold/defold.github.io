...
* Uygulamayı hata ayıklama modunda, seçtiğiniz bir klasöre paketleyin.
	...
	![Android için paketleme](/manuals/images/extensions/debugging/android/bundle_android.png)

* [Android Studio](https://developer.android.com/studio/) uygulamasını başlatın

* `Profile or debug APK` seçeneğini seçin

	![APK hata ayıklama](/manuals/images/extensions/debugging/android/android_profile_or_debug.png)

* Az önce oluşturduğunuz APK dağıtım paketini seçin

	![APK seçimi](/manuals/images/extensions/debugging/android/android_select_apk.png)

* Ana `.so` dosyasını seçin ve hata ayıklama sembolleri içerdiğinden emin olun

	![.so dosyası seçimi](/manuals/images/extensions/debugging/android/android_missing_symbols.png)
...
* .so dosyasını seçin, ardından yerel diskinize bir eşleme ekleyin
	...
	![Yol eşlemesi 1](/manuals/images/extensions/debugging/android/path_mappings_android.png)

	![Yol eşlemesi 2](/manuals/images/extensions/debugging/android/path_mappings_android2.png)
...
* Artık projenizde eşlenen kaynak kodu görmeniz gerekir
	...
	![Kaynak kod eşlemeleri](/manuals/images/extensions/debugging/android/source_mappings_android.png)

* Bir kesme noktası (breakpoint) ekleyin

	![Kesme noktası](/manuals/images/extensions/debugging/android/breakpoint_android.png)

* `Run` -> `Debug "Appname"` seçeneğine basın ve yürütmeyi durdurmak istediğiniz kodu çağırın

	![Kesme noktası](/manuals/images/extensions/debugging/android/callstack_variables_android.png)

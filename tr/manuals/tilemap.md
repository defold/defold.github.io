...
Bir karo haritası oluşturmadan önce bir karo kaynağı oluşturmanız gerekir. Karo kaynağının nasıl oluşturulduğunu öğrenmek için [Karo kaynağı kılavuzuna](/tr/manuals/tilesource) bakın.
...
- Yeni karo haritası otomatik olarak karo haritası düzenleyicisinde açılır.
  ...
  ![Yeni karo haritası](/manuals/images/tilemap/tilemap.png)
...
2. Fırça olarak kullanılacak bir karo seçin (karo paletini göstermek için <kbd>Space</kbd> tuşuna basın) veya birden fazla karodan oluşan dikdörtgen bir fırça oluşturmak için palette tıklayıp sürükleyerek birkaç karo seçin.
   ...
   ![Palet](/manuals/images/tilemap/palette.png)
...
3. Seçili fırçayla boyayın. Bir karoyu silmek için boş bir karo seçip fırça olarak kullanın veya silgiyi seçin (<kbd>Edit ▸ Select Eraser</kbd>).
   ...
   ![Karoları boyama](/manuals/images/tilemap/paint_tiles.png)
...
![Karoları seçme](/manuals/images/tilemap/pick_tiles.png)
...
![Karo haritasını kullanma](/manuals/images/tilemap/use_tilemap.png)
...
{% include shared/tr/material-constants.md component='tilemap' variable='tint' %}
...
*game.project* dosyasında karo haritalarıyla ilgili birkaç [proje ayarı](/tr/manuals/project-settings#tilemap) bulunur.

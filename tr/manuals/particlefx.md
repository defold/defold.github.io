...
![ParticleFX düzenleyicisi](/manuals/images/particlefx/editor.png)
...
*Assets* tarayıcısındaki bağlam menüsünden <kbd>New... ▸ Particle FX</kbd> seçeneğini seçin. Yeni parçacık efekti dosyasına bir ad verin. Düzenleyici, dosyayı [Scene Editor](/tr/manuals/editor/#the-scene-editor) görünümünde açar.

*Outline* bölmesinde varsayılan yayıcı gösterilir. Özelliklerini aşağıdaki *Properties* bölmesinde görmek için yayıcıyı seçin.

![Varsayılan parçacıklar](/manuals/images/particlefx/default.png)
...
![Değiştirici ekleme](/manuals/images/particlefx/add_modifier.png)

![Eklenecek değiştiriciyi seçme](/manuals/images/particlefx/add_modifier_select.png)
...
![Parçacıkları düzenleme](/manuals/images/particlefx/rotate.gif)
...
: Yayıcının şekli
  ...
  ![Yayıcı türleri](/manuals/images/particlefx/emitter_types.png)
...
### Harmanlama modları
{% include shared/tr/blend-modes.md %}
...
![Özellik](/manuals/images/particlefx/property.png)
...
![Anahtar kare atanmış özellik](/manuals/images/particlefx/key.png)
...
![ParticleFX için Curve Editor](/manuals/images/particlefx/curve_editor.png)
...
: Parçacıkları kendi konumunun etrafında dairesel veya sarmal bir yönde etkiler.
  ...
  ![Değiştiriciler](/manuals/images/particlefx/modifiers.png)
...
Bir GUI betiğinden parçacık efektini başlatma ve durdurma hakkında daha fazla bilgi için [GUI parçacık efektleri kılavuzuna](/tr/manuals/gui-particlefx#controlling-the-effect) bakın.
...
Varsayılan parçacık efekti materyalinin, `particlefx.set_constant()` ile değiştirilebilen ve `particlefx.reset_constant()` ile sıfırlanabilen aşağıdaki sabitleri vardır (ayrıntılar için [Materyal kılavuzuna](/tr/manuals/material/#vertex-and-fragment-constants) bakın):
...
*game.project* dosyasında parçacıklarla ilgili birkaç [proje ayarı](/tr/manuals/project-settings#particle-fx) bulunur.
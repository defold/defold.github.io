...
Defold, hedef platforma bağlı olarak Lua 5.1 ve LuaJIT kullanır. Oyun mantığını yazarken Lua'nın bu belirli sürümlerinin dil belirtimine uymanız gerekir. Defold'da Lua ile çalışma hakkında daha fazla bilgi için [Defold'da Lua kılavuzumuza](/tr/manuals/lua) bakın.
...
Değiştirilmiş açık dosyaları kaydederken biçimlendirmek için <kbd>Preferences ▸ Code</kbd> bölümündeki **Format on save** seçeneğini etkinleştirin. Bu tercih varsayılan olarak devre dışıdır ve belge biçimlendirmeyi destekleyen bir dil sunucusu gerektirir. [Kod tercihlerine](/tr/manuals/editor-preferences/#code) bakın.

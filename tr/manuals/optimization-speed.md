...
## Görüş hacmi dışında kalanları eleme
İşleme betiği (render script), tanımlı bir sınırlayıcı kutunun (frustum) dışında kalan oyun nesnesi bileşenlerini otomatik olarak işleme dışında bırakabilir. Görüş hacmi dışında kalanları eleme (frustum culling) hakkında daha fazla bilgi için [İşleme hattı kılavuzuna](/tr/manuals/render/#frustum-culling) bakın.

...
Proje önbelleğini, `build/default` içindeki dosyaları silerek veya [komut satırı derleme aracı Bob](/tr/manuals/bob) ile `clean` komutunu çalıştırarak elle silebilirsiniz.

...
- anchor: changing-an-excluded-proxys-collection
  title: Hariç tutulan bir vekilin koleksiyonunu değiştirme
...
Koleksiyon vekilleri, [koleksiyon fabrikası (collection factory) bileşenlerinden](/tr/manuals/collection-factory/) farklıdır. Bir koleksiyon fabrikası, koleksiyon içeriğinin örneklerini geçerli oyun dünyasında oluşturur. Koleksiyon vekilleri ise çalışma sırasında yeni bir oyun dünyası oluşturur ve bu nedenle farklı kullanım alanlarına sahiptir.
...
![Vekil bileşeni ekleme](/manuals/images/collection-proxy/create_proxy.png)

(İçeriği derleme çıktısından hariç tutup bunun yerine kodla indirmek için *Exclude* kutusunu işaretleyebilir ve [Live Update özelliğini](/tr/manuals/live-update/) kullanabilirsiniz.)

## Başlangıç

Defold motoru başlatıldığında, bir *başlangıç koleksiyonundan (bootstrap collection)* tüm oyun nesnelerini çalışma zamanı ortamına yükler ve örneklerini oluşturur. Ardından oyun nesnelerinin ve bileşenlerinin başlangıç işlemlerini gerçekleştirip onları etkinleştirir. Motorun hangi başlangıç koleksiyonunu kullanacağı [proje ayarlarında](/tr/manuals/project-settings/#main-collection) belirlenir. Bu koleksiyon dosyasına genellikle `main.collection` adı verilir.

![Başlangıç](/manuals/images/collection-proxy/bootstrap.png)
...
![Başlangıç](/manuals/images/collection-proxy/collection_id.png)
...
![Yükleme](/manuals/images/collection-proxy/proxy_load.png)
...
![Yükleme](/manuals/images/collection-proxy/message_passing.png)

Yükleyiciden, yüklenen koleksiyondaki bir oyun nesnesiyle iletişim kurmanız gerekirse [nesnenin tam URL adresini](/tr/manuals/addressing/#urls) kullanarak bir ileti gönderebilirsiniz:
...
* [Oyun nesnesi ve GUI özellik animasyonları](https://defold.com/tr/manuals/animation/#property-animation-1)
* [Kare dizisi animasyonları](https://defold.com/tr/manuals/animation/#flip-book-animation)
* [Parçacık efekti simülasyonları](https://defold.com/tr/manuals/particlefx/)
* Zamanlayıcı hızı
...
Bellek
: Yüklenen her koleksiyon, görece büyük miktarda bellek kullanan yeni bir oyun dünyası oluşturur. Vekiller aracılığıyla aynı anda onlarca koleksiyon yüklüyorsanız tasarımınızı yeniden değerlendirmek isteyebilirsiniz. Oyun nesnesi hiyerarşilerinin çok sayıda örneğini çalışma sırasında oluşturmak için [koleksiyon fabrikaları](/tr/manuals/collection-factory) daha uygundur.

...
![Yeni GUI dosyası](/manuals/images/gui/new_gui_file.png)

Defold şimdi dosyayı otomatik olarak GUI sahne düzenleyicisinde açar.

![Yeni GUI](/manuals/images/gui/new_gui.png)

*Outline* görünümü GUI'nin tüm içeriğini listeler: düğüm (node) listesini ve tüm bağımlılıklarını (aşağıya bakın).

Ortadaki düzenleme alanı GUI'yi gösterir. Düzenleme alanının sağ üst köşesindeki araç çubuğunda *Move*, *Rotate* ve *Scale* araçlarının yanı sıra bir [yerleşim](/tr/manuals/gui-layouts) seçicisi bulunur.

![Araç çubuğu](/manuals/images/gui/toolbar.png)
...
![Yazı tipini alma ve ayarlama](/manuals/images/gui/get_set_font.png)
...
![Materyali alma ve ayarlama](/manuals/images/gui/get_set_material.png)
...
![Dokuyu alma ve ayarlama](/manuals/images/gui/get_set_texture.png)
...
![Bağımlılıklar](/manuals/images/gui/dependencies.png)
...
Kutu düğümü
: ![Kutu düğümü](/manuals/images/icons/gui-box-node.png)
  Kutu düğümü (box node), tek bir renk, doku veya kare dizisi animasyonu (flip-book animation) içeren dikdörtgen düğümdür. Ayrıntılar için [kutu düğümü belgelerine](/tr/manuals/gui-box) bakın.

<div style="clear: both;"></div>

Metin düğümü
: ![Metin düğümü](/manuals/images/icons/gui-text-node.png)
  Metin düğümü (text node), metin gösterir. Ayrıntılar için [metin düğümü belgelerine](/tr/manuals/gui-text) bakın.

<div style="clear: both;"></div>

Daire dilimi düğümü
: ![Daire dilimi düğümü](/manuals/images/icons/gui-pie-node.png)
  Daire dilimi düğümü (pie node), kısmen doldurulabilen veya ters çevrilebilen, daire ya da elipsoit biçiminde bir düğümdür. Ayrıntılar için [daire dilimi düğümü belgelerine](/tr/manuals/gui-pie) bakın.

<div style="clear: both;"></div>

Şablon düğümü
: ![Şablon düğümü](/manuals/images/icons/gui.png)
  Şablon düğümleri (template node), başka GUI sahne dosyalarına dayalı örnekler (instance) oluşturmak için kullanılır. Ayrıntılar için [şablon düğümü belgelerine](/tr/manuals/gui-template) bakın.

<div style="clear: both;"></div>

ParticleFX düğümü
: ![ParticleFX düğümü](/manuals/images/icons/particlefx.png)
  Bir parçacık efekti oynatır. Ayrıntılar için [ParticleFX düğümü belgelerine](/tr/manuals/gui-particlefx) bakın.
...
![Düğüm ekleme](/manuals/images/gui/add_node.png)
...
: Düğümün konumunu, yönelimini ve esnemesini belirler. Bu değerleri değiştirmek için *Move*, *Rotate* ve *Scale* araçlarını kullanabilirsiniz. Değerlere betikle animasyon uygulanabilir ([daha fazla bilgi](/tr/manuals/property-animation)).

Size (kutu, metin ve daire dilimi düğümleri)
: Düğümün boyutu varsayılan olarak otomatiktir, ancak *Size Mode* değerini `Manual` olarak ayarlayarak boyutu değiştirebilirsiniz. Boyut, düğümün sınırlarını tanımlar ve girdiyle düğüm seçerken kullanılır. Bu değere betikle animasyon uygulanabilir ([daha fazla bilgi](/tr/manuals/property-animation)).
...
: Düğüm yeniden boyutlandırıldığında, düğümün dokusunun kenarlarındaki piksel boyutunu korumak için ayarlayın. Ayrıntılar için [kutu düğümü belgelerine](/tr/manuals/gui-box) bakın.

Inner Radius (daire dilimi düğümleri)
: Düğümün X ekseni boyunca ifade edilen iç yarıçapı. Ayrıntılar için [daire dilimi düğümü belgelerine](/tr/manuals/gui-pie) bakın.

Outer Bounds (daire dilimi düğümleri)
: Dış sınırların davranışını belirler. Ayrıntılar için [daire dilimi düğümü belgelerine](/tr/manuals/gui-pie) bakın.

Perimeter Vertices (daire dilimi düğümleri)
: Şekli oluşturmak için kullanılacak parça sayısı. Ayrıntılar için [daire dilimi düğümü belgelerine](/tr/manuals/gui-pie) bakın.

Pie Fill Angle (daire dilimi düğümleri)
: Daire diliminin ne kadarının doldurulacağı. Ayrıntılar için [daire dilimi düğümü belgelerine](/tr/manuals/gui-pie) bakın.

Template (şablon düğümleri)
: Düğüm için şablon olarak kullanılacak GUI sahne dosyası. Ayrıntılar için [şablon düğümü belgelerine](/tr/manuals/gui-template) bakın.

ParticleFX (particlefx düğümleri)
: Bu düğümde kullanılacak parçacık efekti. Ayrıntılar için [ParticleFX düğümü belgelerine](/tr/manuals/gui-particlefx) bakın.

Color
: Düğümün rengi. Düğüm dokuluysa renk, dokuya renk çarpanı olarak uygulanır. Renge betikle animasyon uygulanabilir ([daha fazla bilgi](/tr/manuals/property-animation)).

Alpha
: Düğümün saydamlığı. Alfa değerine betikle animasyon uygulanabilir ([daha fazla bilgi](/tr/manuals/property-animation)).
...
: Düğümün dayanak noktasını (pivot) belirler. Bu nokta, düğümün "merkez noktası" olarak düşünülebilir. Her türlü döndürme, ölçekleme veya boyut değişikliği bu noktanın çevresinde gerçekleşir.
  ...
  ![Dayanak noktası](/manuals/images/gui/pivot.png)
...
: Sabitleme (anchoring), sahne sınırları veya üst düğümün sınırları fiziksel ekran boyutuna sığacak şekilde esnetildiğinde düğümün dikey ve yatay konumunun nasıl değişeceğini belirler.
  ...
  ![Sabitleme uygulanmadan önce](/manuals/images/gui/anchoring_unadjusted.png)
  ...
  ![Sabitleme](/manuals/images/gui/anchoring.png)
...
: Düğümün uyarlama modunu (adjust mode) belirler. Uyarlama modu ayarı, sahne sınırları veya üst düğümün sınırları fiziksel ekran boyutuna sığacak şekilde uyarlandığında düğüme ne olacağını belirler.
  ...
  ![Uyarlanmamış](/manuals/images/gui/unadjusted.png)
  ...
  ![Uyarlama modları](/manuals/images/gui/adjusted.png)
...
: Düğümün kırpma modunu belirler:
  ...
  Ayrıntılar için [GUI kırpma kılavuzuna](/tr/manuals/gui-clipping) bakın.

Clipping Visible (kutu ve daire dilimi düğümleri)
: Düğümün içeriğini şablon alanında işlemek için işaretleyin. Ayrıntılar için [GUI kırpma kılavuzuna](/tr/manuals/gui-clipping) bakın.

Clipping Inverted (kutu ve daire dilimi düğümleri)
: Şablon maskesini ters çevirir. Ayrıntılar için [GUI kırpma kılavuzuna](/tr/manuals/gui-clipping) bakın.
...
![Çizim sırası](/manuals/images/gui/draw_order.png)
...
![Üst ve alt düğüm](/manuals/images/gui/parent_child.png)
...
![Toplu çizimi bölen hiyerarşi](/manuals/images/gui/break_batch.png)
...
![Katmanlar](/manuals/images/gui/layers.png)

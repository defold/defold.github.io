...
- anchor: spawning-a-collection
  title: Çalışma sırasında koleksiyon oluşturma
- Özellikler
- anchor: dynamic-loading-of-factory-resources
  title: Fabrika kaynaklarının dinamik olarak yüklenmesi
- Dinamik prototip
---
...
Koleksiyonlar, Defold'da yeniden kullanılabilir şablonlar, diğer adıyla "prefab"lar oluşturmak için güçlü bir mekanizma sağlar. Koleksiyonlara genel bir bakış için [Yapı taşları belgelerine](/tr/manuals/building-blocks#collections) bakın. Koleksiyonlar düzenleyicide yerleştirilebilir veya oyuna dinamik olarak eklenebilir.
...
![Çalışma sırasında oluşturulacak koleksiyon](/manuals/images/collection_factory/collection.png)
...
![Koleksiyon fabrikası](/manuals/images/collection_factory/factory.png)
...
`bean` oyun nesnesinin `bean.collection` içinde `shield` özelliğini tanımladığını varsayalım. [Betik özelliği kılavuzu](/tr/manuals/script-properties), betik özellikleri hakkında bilgi içerir.
...
![Dinamik olarak yükleme](/manuals/images/collection_factory/load_dynamically.png)
...
![Dinamik prototip](/manuals/images/collection_factory/dynamic_prototype.png)

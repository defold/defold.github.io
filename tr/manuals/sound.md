...
![Bileşen seçme](/manuals/images/sound/sound_add_component.jpg)

Oluşturulan bileşenin ayarlanması gereken bir dizi özelliği vardır:

![Bileşen seçme](/manuals/images/sound/sound_properties.png)

*Sound*
: Projenizdeki bir ses dosyasına ayarlamanız önerilir. Dosyanın _Wave_, _Ogg Vorbis_ veya _Ogg Opus_ biçiminde olması önerilir. Defold, 8 bit ve 16 bit PCM Wave dosyalarını destekler. Ogg Opus oynatma isteğe bağlıdır ve [App Manifest](/tr/manuals/app-manifest/#sound) içinde **Include Sound Decoder: Opus** seçeneğini gerektirir; Opus kod çözücüsü varsayılan olarak dahil edilmez.
...
![Kazanç](/manuals/images/sound/sound_gain.png)
...
![Ses grubu mikseri](/manuals/images/sound/sound_mixer.png)
...
![Faz kayması](/manuals/images/sound/sound_phase_shift.png)
...
*game.project* dosyasında ses bileşenleriyle ilgili birkaç [proje ayarı](/tr/manuals/project-settings#sound) bulunur.

## Akış yoluyla ses oynatma

[Akış yoluyla ses oynatma](/tr/manuals/sound-streaming) desteği sağlamak da mümkündür
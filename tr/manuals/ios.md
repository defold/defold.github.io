...
iOS, derlediğiniz ve telefonunuzda veya tabletinizde çalıştırmak istediğiniz _her_ uygulamanın Apple tarafından verilmiş bir sertifika ve sağlama profiliyle (provisioning profile) imzalanmasını _zorunlu kılar_. Bu kılavuz, oyununuzu iOS için paketlerken izlemeniz gereken adımları açıklar. Geliştirme sırasında oyununuzu [geliştirme uygulaması](/tr/manuals/dev-app) üzerinden çalıştırmak genellikle tercih edilir; çünkü bu yöntem, içeriği ve kodu doğrudan cihazınızda çalışma sırasında yeniden yüklemenize (hot reload) olanak tanır.
...
![iOS dağıtım paketini imzalama](/manuals/images/ios/sign_bundle.png)
...
![ipa iOS uygulama dağıtım paketi](/manuals/images/ios/ipa_file.png)

Uygulamada kullanılacak simgeyi, açılış ekranının arayüz taslağını (storyboard) ve benzeri ayarları *game.project* proje ayarları dosyasının [iOS bölümünde](/tr/manuals/project-settings/#ios) belirtirsiniz.
...
{% include shared/tr/build-variants.md %}
...
![iOS dağıtım paketini kurma ve başlatma](/manuals/images/ios/install_and_launch.png)
...
Düzenleyici ios-deploy aracının kurulum konumunu algılayamazsa bu konumu [Preferences](/tr/manuals/editor-preferences/#tools) bölümünde belirtmeniz gerekir. 
...
![Görüntü ekleme](/manuals/images/ios/xcode_storyboard_add_image.png)
...
![Görüntü görünümü ekleme](/manuals/images/ios/xcode_storyboard_add_imageview.png)

Image View bileşenini arayüz taslağına sürükleyin:

![Arayüz taslağına ekleme](/manuals/images/ios/xcode_storyboard_add_imageview_to_storyboard.png)
...
![Projeyi derleme](/manuals/images/ios/xcode_icons_build.png)
...
![game.project dosyasına simge ve varlık kataloğu ekleme](/manuals/images/ios/defold_icons_game_project.png)
...
{% include shared/tr/apple-privacy-manifest.md %}
...
Projenizin muaf olduğunu düşünüyorsanız projenin `Info.plist` dosyasında [`ITSAppUsesNonExemptEncryption`](https://developer.apple.com/documentation/bundleresources/information-property-list/itsappusesnonexemptencryption) anahtarını `False` olarak ayarlayın. Daha fazla ayrıntı için [Uygulama bildirimleri](/tr/manuals/extensions-manifest-merge-tool) kılavuzuna bakın.

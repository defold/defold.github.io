...
Defold'un tasarımının temelinde, iyi kavranması çok önemli olan birkaç kavram bulunur. Bu kılavuz, Defold'un yapı taşlarının neler olduğunu açıklar. Bu kılavuzu okuduktan sonra [adresleme kılavuzuna](/tr/manuals/addressing) ve [ileti aktarımı kılavuzuna](/tr/manuals/message-passing) geçin. Hızla başlamanıza yardımcı olmak için düzenleyicinin içinden de erişebileceğiniz bir dizi [öğretici](/tutorials/getting-started) bulunur.

![Yapı taşları](/manuals/images/building_blocks/building_blocks.png)
...
![Koleksiyon](/manuals/images/building_blocks/collection.png)
...
![Bean koleksiyonu](/manuals/images/building_blocks/bean_collection.png)

"main" ve "bean" koleksiyonlarına karşılık gelen çalışma zamanı nesneleri olmadığından koleksiyonların kendilerini adresleyemezsiniz. Ancak bazen bir oyun nesnesine giden _yolun_ parçası olarak koleksiyonun kimliğini kullanmanız gerekir (ayrıntılar için [adresleme kılavuzuna](/tr/manuals/addressing) bakın):
...
Kullanılabilir tüm bileşen türlerinin listesi için [bileşenlere genel bakış](/tr/manuals/components/) sayfasına bakın.
...
![Örnek](/manuals/images/building_blocks/instance.png)
...
![Oyun nesnesi örnekleri](/manuals/images/building_blocks/go_instance.png)

Prototip dosyasını değiştirdiğinizde, o dosyayı kullanan tüm örnekler hemen güncellenir.

![Oyun nesnesi prototipini değiştirme](/manuals/images/building_blocks/go_change_blueprint.png)

Burada prototip dosyasının sprite görüntüsü değiştirilir ve dosyayı kullanan tüm örnekler hemen güncellenir:

![Güncellenen oyun nesnesi örnekleri](/manuals/images/building_blocks/go_instance2.png)
...
![Oyun nesnelerini alt nesne olarak bağlama](/manuals/images/building_blocks/childing.png)
...
![Alt nesnenin dönüşümü](/manuals/images/building_blocks/child_transform.png)

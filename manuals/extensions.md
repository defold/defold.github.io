...
toc: ["Native extensions","The build server","Project layout","Manifest files","Sharing an extension","A simple example extension","C++ symbol in your extension","Extension Lifecycle","Defined platform identifiers","Build server logs","Example extensions"]

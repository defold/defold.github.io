---
brief: This manual explains how Defold's render pipeline works and how you can program
  it.
github: https://github.com/defold/doc
language: en
layout: manual
title: The render pipeline in Defold
toc: '["Render","Render pipeline - What, when and where?","The default render","Render
  predicates","Default view projection","Stretch projection","Fixed fit projection","Fixed
  projection","Camera projection","Frustum culling","Coordinate systems","The render
  script","Render Resources","Texture handles","Supported graphics APIs","System messages","Draw
  calls and batching","Batch rules for non-GUI components","Batch rules for GUI components"]'
---

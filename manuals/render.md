...
toc: ["Render","Render pipeline - What, when and where?","The default render","Render predicates","Fixed fit projection","Camera projection","Frustum culling","Coordinate systems","The render script","Render Resources","Draw calls and batching","Batch rules for non-GUI components","Batch rules for GUI components"]

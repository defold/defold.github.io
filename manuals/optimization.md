...
To get a better understanding of what makes up the size of your application you can [generate a build report](/manuals/bundling/#build_reports) when bundling. It is quite common that sounds and graphics is what takes up the bulk of the size of any game.
...
* [Dynamic loading of factories](https://www.defold.com/manuals/collection-factory/#dynamic_loading_of_factory_resources)

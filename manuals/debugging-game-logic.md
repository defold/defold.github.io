...
Break
: <img src='../images/debugging/pause.svg' width='60px' alt='Pause button'/>
...
Continue
: <img src='../images/debugging/play.svg' width='60px' alt='Play button'/>
...
Stop
: <img src='../images/debugging/stop.svg' width='60px' alt='Stop button'/>
...
Step Over
: <img src='../images/debugging/step_over.svg' width='60px' alt='Step over button'/>
...
Step Into
: <img src='../images/debugging/step_in.svg' width='60px' alt='Step in button'/>
...
Step Out
: <img src='../images/debugging/step_out.svg' width='60px' alt='Step out button'/>

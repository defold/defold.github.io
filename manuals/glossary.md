...
![Animation set](../images/icons/animationset.png) An animation set resource contains a list of glTF files or other .animationset files from where to read animations. Adding one .animationset files to another is handy if you share partial sets of animations between several models. See the [model animation manual](/manuals/model-animation/) for details.
...
![Sound](../images/icons/sound.png) The sound component is responsible for playing a specific sound. Defold supports WAV, Ogg Vorbis, and Ogg Opus files. Opus support must be enabled in the App Manifest. See the [Sound manual](/manuals/sound) for more information.

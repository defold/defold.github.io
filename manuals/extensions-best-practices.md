...
toc: ["Best Practices","Project structure","Lua API","Folder structure","Platform folders","Writing native code","C++ version","No C++ Exceptions","Standard Template Libraries - STL","Strings","Make functions hidden","3rd party libraries","Open source dependencies"]

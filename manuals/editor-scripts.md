...
toc: ["Editor scripts","Editor script runtime","Anatomy of .editor_script","Use commands to change the in-memory editor state","Lifecycle hooks","Editor scripts in libraries","Prefs","Execution modes","Actions","Undoable actions","Mixing actions and side effects"]

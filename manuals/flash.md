...
toc: ["Defold for Flash users","Introduction","Movie clips and game objects","Flash—manually creating movie clips","Defold—manually creating game objects","Flash—referencing manually created movie clips","Defold—Game object id","Flash—dynamically creating movie clips","Flash—stage","Defold—collections","Flash—timeline","Defold—property animation","Flash—depth index","Defold—z position"]

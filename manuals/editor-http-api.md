...
<div class='important' markdown='1'>
An editor preview is not a screenshot of the running game. It does not verify dynamically created objects, runtime post-processing, or platform-specific rendering. Use a [runtime screenshot](/manuals/automated-testing/#editor-previews-and-runtime-screenshots) when those elements are needed.
</div>

---
layout: post
title:  Defold release 1.12.4
excerpt: Defold 1.12.4 has been released - Free Fly camera mode in editor, smaller HTML5 builds, and more!
author: The Defold Foundation
tags: ["news", "release notes", "html5", "editor", "shaders"]
---

# Defold 1.12.4

![defold_1_12_4](/images/posts/releases/defold_1_12_4_thumb.webp)
<div align="center">
<a href="https://www.fatesofort.com/">Featured: Fates of Ort by 8BitSkull</a>
</div>

We continue our focus on making the engine faster, smoother and more reliable, while still maintaining the small size - and even decreasing it further - for HTML5 builds the empty project is now 1.06 MB. We also keep adding some nice features, i.a. a new Free Fly mode in the Editor for easier scene nagivation in 3D projects.
...
* __NEW__: ([#11185,#8840](https://github.com/defold/defold/pull/11309)) Free camera mode in scene view + enhanced camera controls (by JosephFerano)
...
__NEW__: ([#11185,#8840](https://github.com/defold/defold/pull/11309)) __'Free camera mode in scene view + enhanced camera controls'__ by JosephFerano

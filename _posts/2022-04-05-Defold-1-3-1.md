...
Frustum culling is enabled by default in the default.render_script 2. If you have a custom render script, you need to create a frustum matrix, and pass it into your render.draw() calls.

...
Before updating an existing project, we recommend reviewing the [full release notes](https://forum.defold.com/t/defold-1-13-1-has-been-released/83156), particularly the Xcode and custom `Info.plist` migration note.
...
One major new feature in Defold 1.13.1 is the introduction of first-class [Light components](/manuals/light/). Defold now supports four light resource types:

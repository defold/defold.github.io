...
```
    /root
        ...
        /bundleres                       -- Recursos que devem ser incluídos no pacote (veja game.project e a [configuração bundle_resources]([physics scale setting](/pt/manuals/project-settings/#project))
            /<platform>
        game.project

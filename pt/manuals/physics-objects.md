...
Um componente de colisão pode usar várias formas primitivas ou uma única forma complexa. Saiba mais sobre as várias formas e como adicioná-las a um componente de colisão no [manual de Formas de Colisão](/pt/manuals/physics-shapes).
...
Collision Shape
: Esta propriedade é usada para geometria de tile map ou formas convexas que não usam formas primitivas. Veja [Formas de Colisão para mais informações](/pt/manuals/physics-shapes).

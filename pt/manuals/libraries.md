...
<div class='important' markdown='1'>
É recomendável sempre revisar bibliotecas de terceiros antes de usá-las. Saiba mais sobre [como proteger o uso de software de terceiros](https://defold.com/pt/manuals/application-security/#securing-your-use-of-third-party-software).
</div>
...
Se você copiar e colar um material e quiser usá-lo em todos os componentes de um certo tipo, pode ser útil usar [modelos por projeto](/pt/manuals/editor/#creating-new-project-files).

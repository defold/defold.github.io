...
Para saber como aplicar estilos a trechos individuais de texto e trabalhar com links e sprites inseridos no texto, consulte o [manual de marcação de texto formatado](/pt/manuals/font-richtext).
...
Veja [Habilitando fontes em runtime](/pt/manuals/font#enabling-runtime-fonts)
...
![Fonte de campo de distância](/manuals/images/font/df_font.png)
...
![Fontes ampliadas](/manuals/images/font/scale_up.png)
...
![Fontes reduzidas](/manuals/images/font/scale_down.png)
...
![Artefatos de campo de distância](/manuals/images/font/df_artifacts.png)
...
* Adicione um [App Manifest](/pt/manuals/app-manifest) e habilite a opção `Use full text layout system`.

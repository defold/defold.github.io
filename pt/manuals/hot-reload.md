...
O hot reload funciona tanto em dispositivos quanto no desktop. Para usá-lo em um dispositivo, execute uma build de depuração do seu jogo, ou o [aplicativo de desenvolvimento](/pt/manuals/dev-app) no seu dispositivo móvel, e então escolha-o como alvo no editor:
...
Alterar e recarregar "my_module.lua" _não_ mudará o comportamento de "user.script". Consulte o [manual de Módulos](/pt/manuals/modules) para mais informações sobre o motivo e sobre como evitar essa armadilha.

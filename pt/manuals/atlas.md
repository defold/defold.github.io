...
: Arraste e solte imagens do painel *Assets* para a visualização do editor.
  ...
  ![Criando um atlas, adicionando imagens](/manuals/images/atlas/add.png)
  ...
  ![Imagens adicionadas](/manuals/images/atlas/single_images.png)
...
: Use <kbd>Right click</kbd> na entrada raiz Atlas no painel *Outline*.
  ...
  ![Criando um atlas, adicionando imagens](/manuals/images/atlas/add_animation.png)
  ...
  ![Grupo de animação](/manuals/images/atlas/animation_group.png)
...
![Atlas de múltiplas páginas](/manuals/images/atlas/multipage_atlas.png)
...
![Propriedades do atlas](/manuals/images/atlas/atlas_properties.png)
...
![Propriedades da imagem](/manuals/images/atlas/image_properties.png)
...
Use [`resource.create_texture(path, params)`](https://defold.com/ref/resource/#resource.create_texture:path-table) para criar um novo recurso de textura:
...
Depois que a textura for criada, você pode usar [`resource.set_texture(path, params, buffer)`](https://defold.com/ref/resource/#resource.set_texture:path-table-buffer) para definir os pixels da textura:
...
A textura pode ser usada diretamente em um [componente de modelo](/pt/manuals/model/) usando `go.set()`:
...
Se a textura deve ser usada em um [componente de sprite](/pt/manuals/sprite/), ela precisa primeiro ser usada por um atlas. Use [`resource.create_atlas(path, params)`](https://defold.com/ref/resource/#resource.create_atlas:path-table) para criar um atlas:

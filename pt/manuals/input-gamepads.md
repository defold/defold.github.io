...
- anchor: gamepads-settings-file
  title: Arquivo de configurações de gamepads
- Gamepads não identificados
- anchor: gamepads-in-html5
  title: Gamepads em HTML5
- Gamepad padrão
- Gamepads no Windows
- Gamepads no Android
---
...
| Evento de tecla para índice de botão | Índice |
|-----------------------------|-------|
| `AKEYCODE_BUTTON_A`           | 0     |
| `AKEYCODE_BUTTON_B`           | 1     |
| `AKEYCODE_BUTTON_C`           | 2     |

...
Um projeto local não terá integração com nenhum sistema de controle de versão, o que significa que os arquivos residem apenas no seu disco rígido. Quaisquer alterações feitas nos arquivos são permanentes e não há como reverter alterações ou recuperar arquivos excluídos. É recomendado usar um sistema de controle de versão como Git para acompanhar alterações nos seus arquivos. Isso também torna muito fácil colaborar em um projeto com outras pessoas. Enviar um projeto local para o GitHub pode ser feito em poucos passos:

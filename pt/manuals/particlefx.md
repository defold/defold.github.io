...
Selecione <kbd>New... ▸ Particle FX</kbd> no menu de contexto do navegador *Assets*. Nomeie o novo arquivo de efeito de partículas. O editor abrirá o arquivo usando o [Scene Editor](/pt/manuals/editor/#the-scene-editor).
...
### Modos de blend
{% include shared/pt/blend-modes.md %}
...
Para iniciar e parar um efeito de partículas a partir de um script de GUI, consulte o [manual de GUI Particle FX](/pt/manuals/gui-particlefx#controlling-the-effect) para mais informações.
...
O material padrão de efeitos de partículas tem as seguintes constantes, que podem ser alteradas usando `particlefx.set_constant()` e redefinidas usando `particlefx.reset_constant()` (consulte o [manual de Material para mais detalhes](/pt/manuals/material/#vertex-and-fragment-constants)):
...
O arquivo *game.project* tem algumas [configurações do projeto](/pt/manuals/project-settings#particle-fx) relacionadas a partículas.
---
brief: Este manual descreve como funciona a mesclagem de manifestos da aplicação
github: https://github.com/defold/doc
layout: manual
locale: pt
title: Extensões nativas - ferramentas de mesclagem de manifestos
toc:
...
Para um conjunto completo de instruções sobre como modificar seus manifestos Android, consulte [a documentação deles](https://developer.android.com/studio/build/manifest-merge).

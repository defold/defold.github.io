...
Um recurso Buffer pode ser usado como entrada para um [componente Mesh](/pt/manuals/mesh). Recursos Buffer também podem ser criados em runtime usando `buffer.create()` e as [funções relacionadas da API](/ref/stable/buffer/#buffer.create:element_count-declaration).
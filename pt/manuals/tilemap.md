...
Antes de criar um tile map, você precisa criar um Tile Source. Consulte o [manual de Tile Source](/pt/manuals/tilesource) para aprender como criar um Tile Source.
...
{% include shared/pt/material-constants.md component='tilemap' variable='tint' %}
...
O arquivo *game.project* tem algumas [configurações do projeto](/pt/manuals/project-settings#tilemap) relacionadas a tilemaps.

...
O mesmo resultado pode ser obtido anexando um [componente de câmera](/pt/manuals/camera/) a um objeto de jogo, marcando *Orthographic Projection* e ajustando *Orthographic Zoom* para 4.0:

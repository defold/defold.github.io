...
- Relatar um problema pelo editor
...
* [Logs da engine](/pt/manuals/debugging-game-and-system-logs)
* [Logs do editor](/pt/manuals/editor#editor-logs)
* [Logs do servidor de build](/pt/manuals/extensions#build-server-logs)
...
Ele é separado do [servidor do editor](/pt/manuals/editor-http-api), que pertence ao editor Defold e controla o projeto aberto.
...
![Informações da porta do serviço do engine em um build de depuração do Defold](/manuals/images/automation/engine-service.png)
...
![Acesso ao servidor do engine](/manuals/images/automation/engine-server.png)
...
Scripts de tempo de execução, física, entrada, objetos criados dinamicamente e renderização de plataforma exigem um engine em execução e devem ser verificados por meio de [testes automatizados em tempo de execução](/pt/manuals/automated-testing).

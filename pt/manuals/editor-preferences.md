...
: Habilita a [compressão de textura](/pt/manuals/texture-profiles) para todos os builds feitos pelo editor.
...
Lint Code on Build
: Habilita [linting de código](/pt/manuals/writing-code/#linting-configuration) quando o projeto é compilado. Esta opção é habilitada por padrão, mas pode ser desabilitada se o linting em um projeto grande levar tempo demais.

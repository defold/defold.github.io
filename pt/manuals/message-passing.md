...
Passagem de mensagens é um mecanismo para objetos de jogo do Defold se comunicarem entre si. Este manual pressupõe que você tenha um entendimento básico do [mecanismo de endereçamento](/pt/manuals/addressing) do Defold e dos [blocos básicos de construção](/pt/manuals/building-blocks).
...
```
Uma descrição mais aprofundada sobre como proxies funcionam pode ser encontrada na documentação de [Proxies de Coleção](/pt/manuals/collection-proxy).

...
Coleções oferecem um mecanismo poderoso para criar modelos reutilizáveis, ou "prefabs", no Defold. Para uma visão geral de coleções, consulte a [documentação de blocos de construção](/pt/manuals/building-blocks#collections). Coleções podem ser posicionadas no editor ou inseridas dinamicamente no seu jogo.
...
![Fábrica de coleção](/manuals/images/collection_factory/factory.png)
...
Supondo que o objeto de jogo `bean` em `bean.collection` defina a propriedade `shield`. [O manual de propriedades de script](/pt/manuals/script-properties) contém informações sobre propriedades de script.
...
![Carregar dinamicamente](/manuals/images/collection_factory/load_dynamically.png)
...
![Protótipo dinâmico](/manuals/images/collection_factory/dynamic_prototype.png)

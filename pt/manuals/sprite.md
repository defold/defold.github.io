...
O componente Sprite pode usar um [Atlas](/pt/manuals/atlas) ou um [Tile Source](/pt/manuals/tilesource) para seus gráficos.
...
{% include shared/pt/material-constants.md component='sprite' variable='tint' %}
...
Um sprite pode sobrescrever atributos de vértice do material atualmente atribuído, e eles serão passados para o vertex shader a partir do componente (consulte o [manual de Material para mais detalhes](/pt/manuals/material/#attributes)).
...
O arquivo *game.project* tem algumas [configurações do projeto](/pt/manuals/project-settings#sprite) relacionadas a sprites.
...
Então usamos os `Rename patterns` no [atlas](/pt/manuals/material/) para renomeá-los.

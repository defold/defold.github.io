...
- [Recursos personalizados](/pt/manuals/project-settings/#custom-resources) declarados em *game.project*.

![Resource tree](/manuals/images/resource/resource_tree.png)

<div class='sidenote' markdown='1'>
O Defold também tem o conceito de [recursos de bundle](/pt/manuals/project-settings/#bundle-resources). Recursos de bundle são incluídos com o bundle da aplicação, mas não fazem parte da árvore de recursos. Esses recursos podem ser qualquer coisa, desde arquivos de suporte específicos de plataforma até arquivos externos [carregados do sistema de arquivos](/pt/manuals/file-access/#how-to-access-files-bundled-with-the-application) e usados pelo seu jogo (por exemplo, bancos de som do FMOD).
</div>
...
- Coleções de mundo de jogo referenciadas por proxies de coleção. Mundos de jogo são relativamente grandes, então você precisa acionar manualmente o carregamento e descarregamento deles no código. Consulte o [manual de proxy de coleção](/pt/manuals/collection-proxy) para detalhes.
...
Leia o [manual de fábrica](/pt/manuals/factory) e o [manual de fábrica de coleção](/pt/manuals/collection-factory) para detalhes sobre como isso funciona.
...
Ao marcar um proxy de coleção como *Exclude*, o recurso referenciado ficará fora do bundle do jogo. Em vez disso, você pode armazenar coleções excluídas em um serviço de armazenamento em nuvem escolhido. O [manual de Live update](/pt/manuals/live-update/) explica como esse recurso funciona.
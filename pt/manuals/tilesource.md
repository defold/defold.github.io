...
Um *Tile Source* pode ser usado por um [componente Tilemap](/pt/manuals/tilemap) para pintar tiles em uma área de grade, ou pode ser usado como fonte gráfica para um [Sprite](/pt/manuals/sprite) ou [componente Particle Effect](/pt/manuals/particlefx). Você também pode usar os *Collision Shapes* do tile source em um Tilemap para [detecção de colisão e simulação física](/pt/manuals/physics) ([exemplo](/examples/tilemap/collisions/)).

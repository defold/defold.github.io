...
Consulte os manuais sobre como [otimizar o desempenho em tempo de execução](/pt/manuals/optimization-speed) de um jogo para aprender como reduzir o uso de CPU e GPU.

## Desabilitar o acelerômetro
Se você está criando um jogo mobile que não usa o acelerômetro do dispositivo, é recomendado [desabilitá-lo em *game.project*](/pt/manuals/project-settings/#use-accelerometer) para reduzir o número de eventos de entrada gerados.

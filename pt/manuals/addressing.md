...
socket
: Identifica o mundo de jogo do alvo. Isso é importante ao trabalhar com [proxies de coleção](/pt/manuals/collection-proxy), quando é usado para identificar a _coleção carregada dinamicamente_.

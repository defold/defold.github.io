...
| [Label](/pt/manuals/label/) | Text / TextMeshPro | O Defold tem uma [extensão RichText](https://defold.com/assets/richtext/) para formatação rica (semelhante ao TextMeshPro). |

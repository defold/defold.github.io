...
O Defold é muito menor que o Unity. O tamanho da engine com um projeto vazio fica entre 1-3 MB em todas as plataformas. Você pode remover partes adicionais da engine e mover parte do conteúdo do jogo para [Live Update](/pt/manuals/live-update), baixando-o separadamente depois. Uma comparação de tamanho e outros motivos para escolher o Defold são descritos na [página Why Defold](https://defold.com/why/).
...
Se precisar de mais detalhes, leia este curto [manual de instalação](/pt/manuals/install/).
...
![Welcome screen comparison](/manuals/images/unity/unity_defold_start.png)
...
![Welcome Templates comparison](/manuals/images/unity/unity_defold_templates.png)
...
Apresentaremos o Defold Editor aqui pela perspectiva do que um usuário de Unity talvez queira saber primeiro, mas recomendamos também conferir o [manual completo de visão geral do editor](/pt/manuals/editor) depois.
...
![Editor Comparison](/manuals/images/unity/defold_unity_editor.png)
...
![Defold Toolbar](/manuals/images/unity/defold_2d.png)

Você também pode ajustar as `Grid Settings` na barra de ferramentas para usar o plano `Y`, como no Unity:

![Defold 3D settings](/manuals/images/unity/defold_3d.png)
...
| [Debugger](/pt/manuals/debugging/) | Visual Studio Debugger | O depurador vem totalmente integrado ao Defold por padrão. Há uma aba adicional para rastrear, ativar e desativar breakpoints. |
...
![Building blocks](/manuals/images/unity/blocks.png)

Para mais detalhes, consulte o manual completo sobre [blocos de construção do Defold](/pt/manuals/building-blocks/).
...
Leia mais sobre [Componentes do Defold aqui](/pt/manuals/components/).
...
| Defold | Unity | Diferenças |
|---|---|---|
| [Sprite](/pt/manuals/sprite/) | Sprite Renderer | No Defold, você só pode alterar o tint (propriedade de cor) via código. |
| [Tilemap](/pt/manuals/tilemap/) | Tilemap / Grid | O Defold tem um Tilemap Editor integrado que suporta grades quadradas (mas há uma extensão para, por exemplo, [Hexagon](https://github.com/selimanac/defold-hexagon/)) e não tem regras integradas de autotiling. Ferramentas como [Tiled](https://defold.com/assets/tiled/), [TileSetter](https://defold.com/assets/tilesetter/) ou [Sprite Fusion](https://defold.com/assets/spritefusion/) têm opções de exportação para Defold. |
| [Label](/pt/manuals/label/) | Text / TextMeshPro | Desde o Defold 1.13.2, componentes Label e nós de texto de GUI oferecem suporte integrado a [marcação de texto formatado](/pt/manuals/font-richtext/) para cores, gradientes, contornos e efeitos animados. Uma [extensão RichText](https://defold.com/assets/richtext/) separada também está disponível. |
| [Sound](/pt/manuals/sound/) | AudioSource | O Defold tem apenas uma fonte de som global (não espacial). Há uma [extensão FMOD](https://github.com/defold/extension-fmod) oficial para Defold. |
| [Factory](/pt/manuals/factory/) | Prefab Instantiate() | No Defold, uma Factory é um componente com um protótipo específico (prefab). |
| [Collection Factory](/pt/manuals/collection-factory/) | - (Sem equivalente direto de componente) | Um componente Collection Factory no Defold pode instanciar vários Game Objects com relações pai-filho de uma vez. |
| [Collision Object](/pt/manuals/physics-objects) | Rigidbody + Collider | No Defold, objetos físicos e formas de colisão são combinados em um único componente. |
| [Collision Shapes](/pt/manuals/physics-shapes/)  | BoxCollider / SphereCollider / CapsuleCollider | No Defold, formas (box, sphere, capsule) são configuradas dentro do componente Collision Object. Ambos suportam formas de colisão vindas de tilemaps e dados de casco convexo. |
| [Camera](/pt/manuals/camera/) | Camera | No Unity, a câmera tem mais configurações integradas de renderização e pós-processamento, enquanto o Defold delega esse controle personalizado ao usuário via script de renderização. |
| [GUI](/pt/manuals/gui/) | UI Toolkit / Unity UI / uGUI Canvas | A GUI do Defold é um componente poderoso para criar UIs completas e templates. O Unity não tem um componente único equivalente, mas sim vários frameworks de UI. O Defold também tem uma extensão para [Extension](https://github.com/britzl/extension-imgui). |
| [GUI Script](/pt/manuals/gui-script/) | Unity UI / uGUI scripts | A GUI do Defold pode ser controlada por scripts de GUI usando a API dedicada `gui`. |
| [Model](/pt/manuals/model/) | MeshRenderer + Material | No Defold, um componente Model reúne um arquivo de modelo 3D, texturas e um material com shaders. |
| [Mesh](/pt/manuals/mesh/) | MeshRenderer / MeshFilter / Procedural Mesh | No Defold, Mesh é um componente para gerenciar um conjunto de vértices via código. É semelhante a um Model do Defold, mas ainda mais baixo nível. |
| [ParticleFX](/pt/manuals/particlefx/) | Particle System | O editor de partículas do Defold suporta efeitos de partículas 2D/3D com muitas propriedades, e permite animá-las ao longo do tempo usando curvas no Curve Editor. Ele não tem Trails ou Collisions. |
| [Script](/pt/manuals/script/) | Script | Mais detalhes sobre diferenças de programação são explicados abaixo. |
...
| Defold | Unity | Diferenças |
|---|---|---|
| [Atlas](/pt/manuals/atlas/) | Sprite Atlas / Texture2D | O Defold também tem uma [extensão para Texture Packer](https://defold.com/extension-texturepacker/). |
| [Tile source](/pt/manuals/tilesource/) | Tile Palette + Asset | No Defold, um tile source pode ser usado como textura para tilemaps, mas também para sprites ou partículas. |
| [Font](/pt/manuals/font/) | Font | Usada pelo componente Label do Defold ou por nós de texto em GUI, semelhante a Text/TextMeshPro no Unity. |
| [Material](/pt/manuals/material/) | Material | No Defold, shaders são chamados de vertex program e fragment program. |
...
Leia mais sobre Collections no [manual Building Blocks](/pt/manuals/building-blocks/#collections).
...
Leia mais sobre extensões no [manual Defold Native Extensions](/pt/manuals/extensions/).
...
- [Manual de Script](/pt/manuals/script/)
- [Escrevendo código](/pt/manuals/writing-code/)
- [Depuração](/pt/manuals/debugging/)
...
Você também pode configurar as preferências do Defold Editor para abrir arquivos de texto por padrão no VS Code (ou qualquer outro editor externo). Veja [Editor Preferences](/pt/manuals/editor-preferences/) para detalhes.
...
Leia mais sobre shaders no [manual de Shaders](/pt/manuals/shader).
...
Leia mais sobre materiais no [manual de Materials](/pt/manuals/material).
...
Você pode ler mais detalhes no [Manual de Passagem de Mensagens](/pt/manuals/message-passing/).
...
Mais detalhes podem ser encontrados no [manual de Endereçamento](/pt/manuals/addressing/).
...
Confira mais detalhes no [manual de Factory](/pt/manuals/factory/).
...
Confira mais detalhes no [manual de Collection Factory](/pt/manuals/collection-factory/).
...
Confira mais detalhes no [manual de Gerenciamento de Recursos](/pt/manuals/resource/).
...
Confira mais detalhes no [manual de Collection Proxy](/pt/manuals/collection-proxy/).
...
| `on_input` | Input Methods | O Defold recebe entradas quando o [foco de entrada é definido para o script](/pt/manuals/input/#input-focus). Processado primeiro no loop de atualização. |
| `fixed_update()` | `FixedUpdate()` | Chamado em passo de tempo fixo. Para ativá-lo no Defold, você precisa definir `Use Fixed Timestep` - [detalhes](https://defold.com/pt/manuals/project-settings/#use-fixed-timestep). Desde 1.12.0, ele roda antes de `update()`. |
...
Para mais detalhes, leia o [Manual do Ciclo de Vida da Aplicação](/pt/manuals/application-lifecycle/).
...
Para mais detalhes, leia o [Manual de GUI](/pt/manuals/gui/).

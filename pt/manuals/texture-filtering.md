...
A configuração de qual filtragem usar é armazenada no arquivo [Project Settings](/pt/manuals/project-settings/#graphics). Há duas configurações:
...
Observe que a configuração em *game.project* é usada pelos samplers padrão. Se você especificar samplers em um material personalizado, poderá definir o método de filtro em cada sampler especificamente. Veja o [manual de Materials](/pt/manuals/material/) para detalhes.
...
Se um listener for definido, [mensagens de física](/pt/manuals/physics-messages) não serão mais enviadas para o mundo de física onde esse listener está definido.
</div>

...
O cache do projeto pode ser excluído manualmente apagando os arquivos em `build/default` ou executando o comando `clean` da [ferramenta de build de linha de comando Bob](/pt/manuals/bob).

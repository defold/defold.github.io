...
- anchor: rich-text-markup
  title: Marcação de texto formatado
- anchor: tag-reference
  title: Referência de tags
- anchor: syntax
  title: Sintaxe
- anchor: attributes
  title: Atributos
...
- anchor: interaction-messages
  title: Mensagens de interação
- anchor: named-styles
  title: Estilos nomeados
...
- anchor: returned-object-fields
  title: Campos do objeto retornado
- anchor: lua-example
  title: Exemplo em Lua
- anchor: useful-combinations
  title: Combinações úteis
- anchor: colored-outline-with-a-horizontal-gradient
  title: Contorno colorido com gradiente horizontal
- anchor: shake-a-sentence-gradient-one-word
  title: Tremer uma frase e aplicar gradiente a uma palavra
- anchor: override-one-property-without-losing-the-others
  title: Sobrescrever uma propriedade sem perder as outras
---
...
![Texto de exemplo renderizado em verde opaco](/manuals/images/richtext/color_green.webp)
...
![Texto de exemplo renderizado em verde com metade do alfa](/manuals/images/richtext/color_green_alpha.webp)
...
![Texto de exemplo renderizado a 24 pixels](/manuals/images/richtext/size_24.webp)
...
![Texto de exemplo renderizado a 120 por cento de 32 pixels](/manuals/images/richtext/size_120.webp)
...
![Texto de exemplo renderizado ao dobro do tamanho base de 32 pixels](/manuals/images/richtext/size_2em.webp)
...
![Texto de exemplo com um gradiente horizontal de magenta a branco](/manuals/images/richtext/gradient_horizontal.webp)
...
![Texto de exemplo com um gradiente azul vertical](/manuals/images/richtext/gradient_vertical.webp)
...
![Texto de exemplo com um gradiente de quatro cantos ajustado a cada glifo](/manuals/images/richtext/gradient_four_glyph.webp)
...
![Texto de exemplo com um gradiente de quatro cantos ajustado ao trecho](/manuals/images/richtext/gradient_four_text.webp)
...
![Gradiente de fluxo animado ajustado a cada glifo](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![Gradiente de fluxo animado ajustado ao trecho](/manuals/images/richtext/gradient_flow_span.webp)
...
![Texto de exemplo com sublinhado contínuo](/manuals/images/richtext/underline_solid.webp)
...
![Texto de exemplo com sublinhado tracejado](/manuals/images/richtext/underline_dashed.webp)
...
![Texto de exemplo com sublinhado em gradiente](/manuals/images/richtext/underline_gradient.webp)
...
![Texto de exemplo com tachado contínuo](/manuals/images/richtext/strike_solid.webp)
...
![Texto de exemplo com tachado tracejado](/manuals/images/richtext/strike_dashed.webp)
...
![Texto de exemplo com contorno preto externo](/manuals/images/richtext/outline.webp)
...
![Texto de exemplo com uma sombra deslocada](/manuals/images/richtext/shadow.webp)
...
![Texto de exemplo com tremor animado por glifo](/manuals/images/richtext/shake_glyph.webp)
...
![Texto de exemplo com tremor animado do trecho inteiro](/manuals/images/richtext/shake_span.webp)
...
![Texto de exemplo com onda animada por glifo](/manuals/images/richtext/wave_glyph.webp)
...
![Texto de exemplo movendo-se como um único trecho animado](/manuals/images/richtext/wave_span.webp)
...
![Um logotipo do Defold renderizado junto ao texto](/manuals/images/richtext/sprite.webp)
...
![www.defold.com renderizado com o estilo padrão de link e um sublinhado](/manuals/images/richtext/link.webp)
...
Consulte [foco de entrada](/pt/manuals/input/#input-focus) e [entrada de mouse e toque](/pt/manuals/input-mouse-and-touch) para saber como configurar.

...
3. Execute o Extender local conforme descrito em [Como executar o Extender local com artefatos pré-configurados](/pt/manuals/extender-local-setup#how-to-run-local-extender-with-preconfigured-artifacts).
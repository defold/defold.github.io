...
* Modelos glTF podem ser usados pelo [componente de Modelo](/pt/manuals/model) para mostrar modelos 3D com animações. Leia mais sobre [como importar e usar modelos 3D aqui](/pt/manuals/importing-models).

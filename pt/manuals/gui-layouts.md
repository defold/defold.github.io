...
![Novos perfis de exibição](/manuals/images/gui-layouts/new_profiles.png)
...
![Configurações](/manuals/images/gui-layouts/settings.png)
...
![Adicionar layout à cena](/manuals/images/gui-layouts/add_layout.png)
...
![Barra de ferramentas de layouts](/manuals/images/gui-layouts/toolbar.png)

![edição em retrato](/manuals/images/gui-layouts/portrait.png)
...
![edição em paisagem](/manuals/images/gui-layouts/landscape.png)

...
A criação de um pacote de aplicação Linux não exige configuração específica nem configuração opcional específica da plataforma no [arquivo de configurações do projeto](/pt/manuals/project-settings/#linux) *game.project*.

...
![Modelo no Blender](/manuals/images/model/blender_gltf.png)
...
## Usando um modelo
Depois de importar o modelo, use-o em um [componente de Modelo](/pt/manuals/model):
...
5. Defina a propriedade *Material* para um material adequado ao modelo. Os arquivos integrados *model.material*, *model_instanced.material*, *model_skinned.material* e *model_skinned_instanced.material* são bons pontos de partida. Os materiais com skinning usam o espaço local dos vértices para que o skinning possa ser executado na GPU; materiais personalizados para modelos com skinning na GPU ou instanciados também devem usar o espaço local dos vértices. Consulte o [manual de Modelo](/pt/manuals/model/#material) para saber o requisito do adaptador gráfico.
...
![Selecionar tudo](/manuals/images/model/blender_select_all_vertices.png)

Quando todos os vértices estiverem selecionados, você faz o unwrap da malha para obter o layout UV:

![Fazer unwrap da malha](/manuals/images/model/blender_unwrap_mesh.png)
...
![Resultado da exportação do layout UV](/manuals/images/model/blender_export_uv_layout_result.png)

### Exportando usando o Blender
Exporte seu modelo do Blender usando <kbd>File ▸ Export ▸ glTF 2.0 (.glb/.gltf)</kbd>.

![Exportando usando o Blender](/manuals/images/model/export_gltf.png)
...
![Exportando usando o Blender](/manuals/images/model/export_settings.png)
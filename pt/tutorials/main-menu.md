...
Neste projeto de exemplo, que você pode [abrir pelo editor](/pt/manuals/project-setup/) ou [baixar do GitHub](https://github.com/defold/sample-main-menu-animation), demonstramos efeitos para apresentar um menu principal. O menu contém um plano de fundo e dois itens de menu.

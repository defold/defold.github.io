...
Neste projeto de exemplo, que você pode [abrir pelo editor](/pt/manuals/project-setup/) ou [baixar do GitHub](https://github.com/defold/sample-hud), demonstramos efeitos para contagem de pontuação. As pontuações aparecem aleatoriamente pela tela, simulando um jogo em que o jogador obtém pontos em posições diferentes.

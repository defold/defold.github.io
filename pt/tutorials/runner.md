...
Para fazer isso e tratar colisão corretamente, é necessário um pouco de matemática vetorial. Uma explicação completa sobre como resolver colisões cinemáticas é dada na [documentação de Física](/pt/manuals/physics-resolving-collisions/).
</div>

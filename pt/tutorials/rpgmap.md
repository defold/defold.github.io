...
Neste projeto de exemplo, que você pode [abrir pelo editor](/pt/manuals/project-setup/) ou [baixar do GitHub](https://github.com/defold/sample-rpgmap), mostramos um método para criar mapas de RPG muito grandes no Defold. O design se baseia nas seguintes premissas:

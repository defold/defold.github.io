...
Neste projeto de exemplo, que você pode [abrir pelo editor](/pt/manuals/project-setup/) ou [baixar do GitHub](https://github.com/defold/sample-parallax), demonstramos como usar um efeito de parallax para simular profundidade no mundo do jogo.

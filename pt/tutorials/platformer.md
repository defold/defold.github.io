...
![Approximative velocity integration](/tutorials/images/platformer/integration.png)
...
![Equation of velocity](/tutorials/images/platformer/equationofvelocity.png)
...
![Equation of translation](/tutorials/images/platformer/equationoftranslation.png)
...
Se você não tiver certeza de como lidar com entrada no Defold, há um guia sobre isso [aqui](/pt/manuals/input).
...
![Contact normals acting on the player character](/tutorials/images/platformer/collision.png)
...
![The Defold Editor with the level geometry and player placed into the world](/tutorials/images/platformer/editor.png)
...
![Multiple tile-based polygons stitched into one](/tutorials/images/platformer/stitching.png)
...
Confira nossos guias sobre [física](/pt/manuals/physics) e [tiles](/pt/manuals/2dgraphics) para mais informações.

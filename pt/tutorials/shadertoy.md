...
[Shadertoy.com](https://www.shadertoy.com/) é um site que reúne shaders GL contribuídos por usuários. É um ótimo recurso para encontrar código de shader e inspiração. Neste tutorial, vamos pegar um shader do Shadertoy e fazê-lo rodar no Defold. Presume-se algum entendimento básico de shaders. Se você precisar estudar o assunto, [o manual de Shader](/pt/manuals/shader/) é um bom ponto de partida.
...
![start](/tutorials/images/shadertoy/empty_project.png)
...
![quad in Blender](/tutorials/images/shadertoy/quad_blender.png)
...
![quad in Defold](/tutorials/images/shadertoy/quad_default_material.png)
...
1. Crie um novo arquivo de material *`star-nest.material`* clicando com <kbd>Right Mouse Button</kbd> na pasta `main` no painel `Assets`, selecionando <kbd>New</kbd>-><kbd>Material</kbd> e nomeando-o `star-nest`.
 ...
 ![material](/tutorials/images/shadertoy/new_material.png)
...
8. Adicione uma tag "tile" em *Tags*. Isso faz com que o quad seja incluído no render pass quando sprites e tiles forem desenhados.
 ...
 ![material](/tutorials/images/shadertoy/material.png)
...
![quad in Defold](/tutorials/images/shadertoy/quad_material.png)
...
![camera](/tutorials/images/shadertoy/camera.png)
...
![Star Nest shader code](/tutorials/images/shadertoy/starnest_code.png)
...
![quad with starnest](/tutorials/images/shadertoy/quad_starnest.png)
...
![time constant](/tutorials/images/shadertoy/time_constant.png)

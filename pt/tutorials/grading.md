...
Assumimos que você sabe se orientar no editor Defold e que tem entendimento básico de shaders GL e do pipeline de renderização do Defold. Se precisar estudar esses assuntos, confira [nosso manual de Shader](/pt/manuals/shader/) e o [manual de Render](/pt/manuals/render/).
...
Você pode substituir o shader program de um componente por outro que modifica os dados de pixel ou cria cores de pixel totalmente novas de forma programática. O [tutorial Shadertoy](/pt/tutorials/shadertoy) ensina como fazer isso.

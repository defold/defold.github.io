...
* Crie um [novo projeto](/pt/manuals/project-setup/#creating-a-new-project) a partir do modelo "Empty Project"
...
![Esquema das regras do jogo](/tutorials/images/magic-link/linker_rules.png)
...
![Estrutura de pastas](/tutorials/images/magic-link/linker_folders.png)
...
![Configurações do projeto](/tutorials/images/magic-link/linker_project_settings.png)
...
![Layout de escala do jogo](/tutorials/images/magic-link/linker_layout.png)
...
![Contagem máxima de sprites](/tutorials/images/magic-link/linker_sprite_max_count.png)
...
![Adicionar imagens](/tutorials/images/magic-link/linker_add_images.png)
...
![Adicionar imagens ao Atlas](/tutorials/images/magic-link/linker_add_to_atlas.png)
...
![Coleção do tabuleiro](/tutorials/images/magic-link/linker_board_collection.png)

![Bootstrap da coleção do tabuleiro](/tutorials/images/magic-link/linker_bootstrap_board.png)
...
![Objeto de jogo de bloco](/tutorials/images/magic-link/linker_block.png)
...
![Fábrica de blocos](/tutorials/images/magic-link/linker_blockfactory.png)

Agora você deve conseguir executar o jogo e ver o tabuleiro preenchido com blocos de cores aleatórias:

![Primeira captura de tela](/tutorials/images/magic-link/linker_first_screenshot.png)
...
![Mapeamentos de entrada](/tutorials/images/magic-link/linker_input_bindings.png)
...
![Objeto de jogo connector](/tutorials/images/magic-link/linker_connector.png)

![Fábrica de conectores](/tutorials/images/magic-link/linker_connector_factory.png)
...
![Conectores no jogo](/tutorials/images/magic-link/linker_connector_screen.png)
...
![Deslizar blocos para baixo](/tutorials/images/magic-link/linker_blocks_slide.png)
...
![Sprite de cover](/tutorials/images/magic-link/linker_cover.png)
...
![Bloco mágico sem e com luz](/tutorials/images/magic-link/linker_magic_blocks.png)
...
![Marcar regiões](/tutorials/images/magic-link/linker_regions.png)
...
![Primeira vitória](/tutorials/images/magic-link/linker_first_win.png)
...
![GUI do menu principal](/tutorials/images/magic-link/linker_main_menu.png)
...
![coleção main](/tutorials/images/magic-link/linker_main_collection.png)

Agora devemos abrir *game.project* e alterar o *main_collection* de bootstrap para `/main/main.collectionc`.

![coleção main de bootstrap](/tutorials/images/magic-link/linker_bootstrap_main.png)
...
![gui do tabuleiro](/tutorials/images/magic-link/linker_board_gui.png)
...
![GUI de reinício](/tutorials/images/magic-link/linker_restart_gui.png)
...
![diálogo de conclusão de nível](/tutorials/images/magic-link/linker_level_complete_gui.png)
...
![GUI de apresentação do nível](/tutorials/images/magic-link/linker_present_level_gui.png)
...
![GUI sem espaço para drop](/tutorials/images/magic-link/linker_no_drop_room_gui.png)
...
![Coleção final do tabuleiro](/tutorials/images/magic-link/linker_board_collection_final.png)
...
![Jogo concluído](/tutorials/images/magic-link/linker_game_finished.png)

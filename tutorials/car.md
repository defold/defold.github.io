...
Changed Files
: Contains files added, modified, renamed, or deleted locally compared with the current Git commit. You can view textual diffs and revert local changes here. Use an external Git client or the command line to synchronize with a remote repository.

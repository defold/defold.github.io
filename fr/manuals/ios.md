...
- anchor: ios-development
  title: Développement pour iOS
- anchor: apples-code-signing-process
  title: Processus de signature de code dApple
- anchor: developing-using-a-free-apple-developer-account
  title: Développement avec un compte développeur Apple gratuit
- anchor: creating-an-ios-application-bundle
  title: Création dun bundle dapplication iOS
- anchor: custom-infoplist-and-local-target-discovery
  title: Info.plist personnalisé et découverte de cibles locales
- anchor: installing-and-launching-bundle-on-a-connected-iphone
  title: Installation et lancement du bundle sur un iPhone connecté
- anchor: creating-a-storyboard
  title: Création dun storyboard
- anchor: creating-an-icon-asset-catalog
  title: Création dun catalogue de ressources dicônes
- anchor: installing-an-ios-application-bundle
  title: Installation dun bundle dapplication iOS
- anchor: export-compliance-information
  title: Informations de conformité à lexportation
- anchor: faq
...
Sous iOS, _toute_ application que vous créez et souhaitez exécuter sur votre téléphone ou votre tablette _doit_ être signée avec un certificat délivré par Apple et un profil d'approvisionnement. Ce manuel explique les étapes de la création d'un bundle de votre jeu pour iOS. Pendant le développement, il est souvent préférable d'exécuter votre jeu au moyen de l'[application de développement](/fr/manuals/dev-app), car elle vous permet de recharger à chaud le contenu et le code directement sur votre appareil.
...
![Espace membre Apple](/manuals/images/ios/apple_member_center.png)
...
: Vous pouvez trouver l'UDID d'un appareil iOS en le connectant à un ordinateur par Wi-Fi ou par câble. Ouvrez Xcode et sélectionnez <kbd>Window ▸ Devices and Simulators</kbd>. Le numéro de série et l'identifiant s'affichent lorsque vous sélectionnez votre appareil.
  ...
  ![Appareils dans Xcode](/manuals/images/ios/xcode_devices.png)
  ...
  ![Appareils dans iTunes](/manuals/images/ios/itunes_devices.png)
...
![Signature d'un bundle iOS](/manuals/images/ios/sign_bundle.png)
...
![Bundle d'application iOS au format ipa](/manuals/images/ios/ipa_file.png)

Vous définissez l'icône de l'application, le storyboard de l'écran de lancement, etc. dans la [section iOS](/fr/manuals/project-settings/#ios) du fichier de paramètres du projet *game.project*.
...
{% include shared/fr/build-variants.md %}
...
![Installation et lancement d'un bundle iOS](/manuals/images/ios/install_and_launch.png)
...
Si l'éditeur ne parvient pas à détecter l'emplacement d'installation de l'outil ios-deploy, vous devrez le préciser dans les [préférences](/fr/manuals/editor-preferences/#tools). 
...
![Création d'un projet](/manuals/images/ios/xcode_create_project.png)

Cliquez sur Next et configurez votre projet. Renseignez le champ Product Name :

![Paramètres du projet](/manuals/images/ios/xcode_storyboard_create_project_settings.png)

Cliquez sur Create pour terminer. Votre projet est maintenant créé et nous pouvons passer à la création du storyboard :

![Vue du projet](/manuals/images/ios/xcode_storyboard_project_view.png)
...
![Ajout d'une image](/manuals/images/ios/xcode_storyboard_add_image.png)
...
![Ajout d'une vue d'image](/manuals/images/ios/xcode_storyboard_add_imageview.png)

Faites glisser le composant Image View sur le storyboard :

![Ajout au storyboard](/manuals/images/ios/xcode_storyboard_add_imageview_to_storyboard.png)
...
![Paramètres du projet](/manuals/images/ios/xcode_icons_create_project_settings.png)
...
![Vue du projet](/manuals/images/ios/xcode_icons_project_view.png)

Glissez-déposez des images dans les cases vides correspondant aux différentes tailles d'icônes prises en charge :

![Ajout d'icônes](/manuals/images/ios/xcode_icons_add_icons.png)
...
![Compilation du projet](/manuals/images/ios/xcode_icons_build.png)
...
![Ajout de l'icône et du catalogue de ressources dans game.project](/manuals/images/ios/defold_icons_game_project.png)
...
{% include shared/fr/apple-privacy-manifest.md %}

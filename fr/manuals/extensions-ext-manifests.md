...
toc:
- anchor: extension-application-and-engine-manifest-files
  title: Fichiers manifestes dextension, dapplication et du moteur
- anchor: app-manifest
  title: Manifeste dapplication
- anchor: engine-manifest
  title: Manifeste du moteur
- anchor: extension-manifest
  title: Manifeste dextension
- anchor: the-extmanifest-file
  title: Le fichier ext.manifest
---

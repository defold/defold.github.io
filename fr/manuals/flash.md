...
toc:
- anchor: defold-for-flash-users
  title: Defold pour les utilisateurs de Flash
- anchor: introduction
  title: Introduction
- anchor: movie-clips-and-game-objects
  title: Clips danimation et objets de jeu
- anchor: flashmanually-creating-movie-clips
  title: Flash — création manuelle de clips danimation
- anchor: defoldmanually-creating-game-objects
  title: Defold — création manuelle dobjets de jeu
- anchor: flashreferencing-manually-created-movie-clips
  title: Flash — référencement des clips danimation créés manuellement
- anchor: defoldgame-object-id
  title: Defold — identifiant dobjet de jeu
- anchor: flashdynamically-creating-movie-clips
  title: Flash — création dynamique de clips danimation
- anchor: defoldcreating-game-objects-using-factories
  title: Defold — création dobjets de jeu à laide de factories
- anchor: flashstage
  title: Flash — scène
- anchor: defoldcollections
  title: Defold — collections
- anchor: flashtimeline
  title: Flash — scénario
- anchor: defoldproperty-animation
  title: Defold — animation de propriétés
- anchor: flashdepth-index
  title: Flash — indice de profondeur
- anchor: defoldz-position
  title: Defold — position z
- anchor: flash-hittestobject-and-hittestpoint-collision-detection
  title: Détection des collisions dans Flash avec hitTestObject et hitTestPoint
- anchor: defoldcollision-objects
  title: Defold — objets de collision
- anchor: flashevent-handling
  title: Flash — gestion des événements
- anchor: defoldcall-back-functions-and-messaging
  title: Defold — fonctions de rappel et échange de messages
- anchor: flashbutton-symbols
  title: Flash — symboles de bouton
- anchor: defoldgui-scenes-and-scripts
  title: Defold — scènes et scripts dinterface graphique
- anchor: debugging
  title: Débogage
...
![objet de jeu et clip d'animation](/manuals/images/flash/go_movieclip.png)

Contrairement aux clips d'animation Flash, les objets de jeu Defold n'ont pas de scénario. Un objet de jeu est composé de plusieurs composants (components). Les composants comprennent notamment les sprites, les sons et les scripts---parmi bien d'autres (pour en savoir plus sur les composants disponibles, consultez la [documentation sur les éléments de base](/fr/manuals/building-blocks) et les articles associés). L'objet de jeu de la capture d'écran ci-dessous est constitué d'un sprite et d'un script. Le composant script sert à contrôler le comportement et l'apparence des objets de jeu tout au long de leur cycle de vie :

![composant script](/manuals/images/flash/script_component.png)
...
![objets de jeu créés manuellement](/manuals/images/flash/manual_game_objects.png)
...
![nom d'instance Flash](/manuals/images/flash/flash_instance_name.png)
...
![identifiant d'objet de jeu](/manuals/images/flash/game_object_id.png)
...
Le modèle d'adressage et l'échange de messages sont des concepts clés du développement de jeux Defold. Le [manuel sur l'adressage](/fr/manuals/addressing) et le [manuel sur l'échange de messages](/fr/manuals/message-passing) les expliquent en détail.
...
![liaison ActionScript](/manuals/images/flash/actionscript_linkage.png)
...
![factory de logo](/manuals/images/flash/logo_factory.png)
...
![composant factory](/manuals/images/flash/factory_component.png)
...
L'URL est un paramètre obligatoire de `factory.create()`. Vous pouvez également ajouter des paramètres facultatifs pour définir la position, la rotation, les propriétés et l'échelle. Pour plus d'informations sur le composant factory, consultez le [manuel sur les factories](/fr/manuals/factory). Notez que l'appel à `factory.create()` renvoie l'identifiant de l'objet de jeu créé. Vous pouvez stocker cet identifiant dans une table (l'équivalent Lua d'un tableau) pour y faire référence ultérieurement.
...
![scénario et scène](/manuals/images/flash/stage.png)
...
Les collections sont des conteneurs utilisés dans l'éditeur pour organiser les objets de jeu et les autres collections. Le contenu d'une collection peut également être créé par script en cours d'exécution à l'aide d'une [factory de collection](/fr/manuals/collection-factory/#spawning-a-collection), qui fonctionne de la même manière qu'une factory d'objets de jeu classique. Cela sert, par exemple, à créer des groupes d'ennemis ou un ensemble de pièces à collecter disposées selon un motif. Dans la capture d'écran ci-dessous, nous avons placé manuellement deux instances de la collection `logos` dans la collection `main`.

![collection](/manuals/images/flash/collection.png)

Dans certains cas, vous souhaitez charger un monde de jeu entièrement nouveau. Le composant [proxy de collection](/fr/manuals/collection-proxy/) vous permet de créer un nouveau monde de jeu à partir du contenu d'un fichier de collection. Cela peut servir à charger de nouveaux niveaux de jeu, des mini-jeux ou des cinématiques.
...
![scénario](/manuals/images/flash/timeline.png)
...
![animation image par image](/manuals/images/flash/flipbook.png)
...
![indice de profondeur](/manuals/images/flash/depth_index.png)
...
![indice de profondeur](/manuals/images/flash/depth_index_2.png)

## Defold — position z {#defoldz-position}

Les positions des objets de jeu dans Defold sont représentées par des vecteurs composés de trois variables : x, y et z. La position z détermine la profondeur d'un objet de jeu. Dans le [script de rendu](/fr/manuals/render) par défaut, les positions z disponibles vont de -1 à 1.
...
![ordre selon l'axe z](/manuals/images/flash/z_order.png)
...
![ordre selon l'axe z](/manuals/images/flash/z_order_outline.png)
...
![test de collision](/manuals/images/flash/hittest.png)
...
![test de collision avec le rectangle englobant](/manuals/images/flash/hitboundingbox.png)
...
![sans débogage](/manuals/images/flash/no_debug.png)

L'activation du débogage physique affiche les objets de collision ajoutés à nos objets de jeu :

![avec débogage](/manuals/images/flash/with_debug.png)
...
Enfin, consultez la [documentation du profileur](/ref/profiler/) pour savoir comment surveiller l'utilisation du processeur et de la mémoire. Pour plus d'informations sur les techniques de débogage avancées, consultez la [section sur le débogage](/fr/manuals/debugging) du manuel Defold.

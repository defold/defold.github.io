...
toc:
- anchor: working-offline
  title: Travailler hors ligne
- anchor: automatic-updates
  title: Mises à jour automatiques
- anchor: reporting-issues
  title: Signalement de problèmes
- anchor: fetching-dependencies
  title: Récupération des dépendances
- anchor: building-native-extensions
  title: Compilation dextensions natives
---
...
Si vous rencontrez un problème hors ligne, vous pouvez le signaler manuellement plus tard à l'aide de [l'option Report Issue du menu Help](/fr/manuals/getting-help/#report-a-problem-from-the-editor) de l'éditeur.


## Récupération des dépendances {#fetching-dependencies}

Defold propose un système permettant aux développeurs de partager du code et des ressources à l'aide de ce que l'on appelle des [projets de bibliothèque](/fr/manuals/libraries/). Les bibliothèques sont des fichiers zip qui peuvent être hébergés n'importe où en ligne. Vous trouverez généralement les projets de bibliothèque Defold sur GitHub et dans d'autres dépôts de code source en ligne.

Un projet peut ajouter une bibliothèque en tant que [dépendance dans les paramètres du projet](/fr/manuals/project-settings/#dependencies). Les dépendances sont téléchargées ou mises à jour à l'ouverture du projet, ou à tout moment lorsque l'option *Fetch Libraries* est sélectionnée dans le menu *Project*.
...
Defold propose un système permettant aux développeurs d'ajouter du code natif pour étendre les fonctionnalités du moteur, appelé [extensions natives](/fr/manuals/extensions/). Defold permet de commencer à utiliser les extensions natives sans aucune configuration grâce à une solution de build dans le cloud.

...
toc:
- anchor: app-manifest
  title: Manifeste dapplication
- anchor: applying-the-manifest
  title: Appliquer le manifeste
- anchor: physics-2d
  title: Physique 2D
- anchor: physics-3d
  title: Physique 3D
- anchor: rig-model
  title: Squelette + modèle
- anchor: exclude-record
  title: Exclure lenregistrement
- anchor: profiler
  title: Profileur
- anchor: sound
  title: Son
- anchor: exclude-sound
  title: Exclure le son
- anchor: exclude-sound-decoder-wav
  title: 'Exclure le décodeur audio : WAV'
- anchor: exclude-sound-decoder-ogg
  title: 'Exclure le décodeur audio : OGG'
...
- anchor: exclude-basis-transcoder
  title: Exclure le transcodeur Basis
- anchor: use-android-support-lib
  title: Utiliser la bibliothèque Android Support
- anchor: graphics
  title: Graphismes
...
- anchor: initial-memory-html5
  title: Mémoire initiale (HTML5)
- anchor: stack-size-html5
  title: Taille de la pile (HTML5)
---
...
Les paramètres du solveur Box2D dépendent de la version. Consultez les [paramètres de projet Box2D](/fr/manuals/project-settings/#box2d) pour en savoir plus.
...
Contrôlez les fonctionnalités des squelettes et des modèles, ou sélectionnez None pour exclure complètement les modèles et les squelettes. (Consultez la documentation de [`Model`](https://defold.com/fr/manuals/model/#model-component)).
...
Le paramètre du manifeste d'application contrôle si le code du profileur est lié à un build. Les paramètres de la section `profiler` de *game.project* contrôlent le comportement du profileur à l'exécution. Découvrez comment utiliser les outils disponibles dans le [manuel de profilage](/fr/manuals/profiling/).
...
Inclut la prise en charge des ressources audio Ogg Opus. Le décodeur Opus est exclu par défaut ; cette option doit donc être activée avant de pouvoir lire les ressources `.opus`. Consultez le [manuel du son](/fr/manuals/sound/) pour connaître les formats pris en charge.
...
Exclut la [bibliothèque de compression de textures](/fr/manuals/texture-profiles) Basis Universal du moteur.


## Utiliser la bibliothèque Android Support {#use-android-support-lib}

Utilise la bibliothèque obsolète Android Support Library à la place d'Android X. [En savoir plus](https://defold.com/fr/manuals/android/#using-androidx).
...
Cette option fournit la valeur par défaut à la compilation. La valeur [`html5.heap_size`](/fr/manuals/html5/#heap-size) de *game.project* la remplace à l'exécution.

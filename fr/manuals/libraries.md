...
- anchor: libraries
  title: Bibliothèques
- anchor: setting-up-library-sharing
  title: Configurer le partage de bibliothèques
- anchor: library-url
  title: URL de la bibliothèque
- anchor: basic-access-authentication
  title: Authentification daccès de base
- anchor: advanced-access-authentication
  title: Authentification daccès avancée
- anchor: setting-up-library-dependencies
  title: Configurer les dépendances de bibliothèques
- anchor: editing-files-in-library-dependencies
  title: Modifier les fichiers des bibliothèques utilisées comme dépendances
- anchor: broken-references
  title: Références rompues
- anchor: name-collisions
  title: Collisions de noms
---
...
Supposons que vous souhaitiez créer une bibliothèque contenant des sprites et des sources de tuiles partagés. Commencez par [configurer un nouveau projet](/fr/manuals/project-setup/). Choisissez les dossiers du projet que vous souhaitez partager et ajoutez leurs noms à la propriété *`include_dirs`* dans les paramètres du projet. Si vous souhaitez indiquer plusieurs dossiers, séparez leurs noms par des espaces :

![Dossiers à inclure](/manuals/images/libraries/libraries_include_dirs.png)
...
![URL d'une bibliothèque sur GitHub](/manuals/images/libraries/libraries_library_url_github.png)
...
<div class='important' markdown='1'>
Il est recommandé de toujours examiner les bibliothèques tierces avant de les utiliser. Pour en savoir plus, consultez la section [sécuriser votre utilisation de logiciels tiers](https://defold.com/fr/manuals/application-security/#securing-your-use-of-third-party-software).
</div>
...
![Dépendances](/manuals/images/libraries/libraries_dependencies.png)
...
![Récupération des bibliothèques](/manuals/images/libraries/libraries_fetch_libraries.png)
...
![Configuration de la bibliothèque terminée](/manuals/images/libraries/libraries_done.png)
...
Si vous copiez-collez un matériau et souhaitez l'utiliser pour tous les composants (components) d'un certain type, il peut être utile d'utiliser des [modèles propres au projet](/fr/manuals/editor/#creating-new-project-files).

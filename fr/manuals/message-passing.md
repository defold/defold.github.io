...
- anchor: message-passing
  title: Échange de messages
- anchor: usage-examples
  title: Exemples dutilisation
- anchor: sending-messages
  title: Envoi de messages
- anchor: shorthands
  title: Raccourcis
- anchor: receiving-messages
  title: Réception de messages
- anchor: messaging-between-game-worlds
  title: Échange de messages entre mondes de jeu
- anchor: message-chains
  title: Chaînes de messages
---

# Échange de messages {#message-passing}

L'échange de messages est un mécanisme qui permet aux objets de jeu (game objects) de Defold de communiquer entre eux. Ce manuel suppose que vous avez une connaissance élémentaire du [mécanisme d'adressage](/fr/manuals/addressing) et des [éléments fondamentaux](/fr/manuals/building-blocks) de Defold.
...
![Structure de l'échange de messages](/manuals/images/message_passing/message_passing_structure.png)
...
![Échange de messages](/manuals/images/message_passing/message_passing.png)
...
![Nom de la collection](/manuals/images/message_passing/collection_name.png)
...
```
Vous trouverez une description plus détaillée du fonctionnement des proxys dans la documentation sur les [proxys de collection](/fr/manuals/collection-proxy).

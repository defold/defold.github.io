...
- anchor: optimize-battery-usage
  title: Optimiser la consommation de la batterie
- anchor: disable-accelerometer
  title: Désactiver laccéléromètre
- anchor: platform-specific-optimizations
  title: Optimisations propres à chaque plateforme
...
Consultez les manuels expliquant comment [optimiser les performances à l'exécution](/fr/manuals/optimization-speed) d'un jeu pour savoir comment réduire l'utilisation du CPU et du GPU.

## Désactiver l'accéléromètre {#disable-accelerometer}
Si vous créez un jeu mobile qui n'utilise pas l'accéléromètre de l'appareil, il est recommandé de [le désactiver dans *game.project*](/fr/manuals/project-settings/#use-accelerometer) pour réduire le nombre d'événements d'entrée générés.

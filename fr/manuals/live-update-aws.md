...
toc:
- anchor: setting-up-amazon-web-service
  title: Configurer Amazon Web Service
---
...
1. Créer un compartiment pour les ressources Live Update
    ...
    ![Créer un compartiment](/manuals/images/live-update/01-create-bucket.png)
...
2. Ajouter une stratégie de compartiment à votre compartiment
    ...
    ![Stratégie de compartiment](/manuals/images/live-update/02-bucket-policy.png)
...
3. Ajouter une configuration CORS à votre compartiment (facultatif)
    ...
    ![Configuration CORS](/manuals/images/live-update/03-cors-configuration.png)
...
4. Créer une stratégie IAM
    ...
    ![Stratégie IAM](/manuals/images/live-update/04-create-policy.png)
...
6. Créer un fichier de profils d'identifiants
    ...
    ![Paramètres de Live Update](/manuals/images/live-update/05-liveupdate-settings.png)
...
toc:
- anchor: font-files
  title: Fichiers de police
- anchor: offline-or-runtime-fonts
  title: Polices prégénérées ou générées à lexécution
- anchor: text-layout-support-eg-right-to-left
  title: Prise en charge de la disposition du texte (par exemple, de droite à gauche)
- anchor: font-collection
  title: Collection de polices
- anchor: creating-a-font
  title: Création dune police
- anchor: properties
  title: Propriétés
- anchor: distance-field-fonts
  title: Polices à champ de distance
- anchor: bitmap-bmfonts
  title: Polices matricielles BMFont
- anchor: artifacts-and-best-practices
  title: Artefacts et bonnes pratiques
- anchor: font-cache
  title: Cache de police
- anchor: enabling-runtime-fonts
  title: Activation des polices générées à lexécution
- anchor: font-scripting
  title: Scripts de polices
- anchor: addingremoving-fonts-to-a-font-collection
  title: Ajout et suppression de polices dans une collection de polices
- anchor: prewarming-glyphs
  title: Préparation des glyphes
---
...
Pour savoir comment appliquer des styles à des portions de texte et utiliser des liens et des sprites intégrés au texte, consultez le [manuel du balisage de texte enrichi](/fr/manuals/font-richtext).
...
Consultez [Activation des polices générées à l'exécution](/fr/manuals/font#enabling-runtime-fonts)
...
![Nom de la nouvelle police](/manuals/images/font/new_font_name.png)
...
![Nouvelle police](/manuals/images/font/new_font.png)
...
![Police à champ de distance](/manuals/images/font/df_font.png)
...
![Polices agrandies](/manuals/images/font/scale_up.png)
...
![Polices réduites](/manuals/images/font/scale_down.png)
...
![Artefacts de champ de distance](/manuals/images/font/df_artifacts.png)
...
Pour en savoir plus sur les variables uniformes des shaders, consultez le [manuel des shaders](/fr/manuals/shader).
...
* Ajoutez un [manifeste d'application](/fr/manuals/app-manifest) et activez l'option `Use full text layout system`.

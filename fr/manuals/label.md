...
- anchor: creating-a-label
  title: Création dun libellé
- anchor: label-properties
  title: Propriétés du libellé
- anchor: blend-modes
  title: Modes de fusion
- anchor: pivot-and-alignment
  title: Pivot et alignement
...
![Ajouter un libellé](/manuals/images/label/add_label.png)
...
![Nouveau libellé](/manuals/images/label/label.png)
...
![Police et matériau](/manuals/images/label/font_material.png)
...
![Alignement du texte](/manuals/images/label/align.png)
...
Le fichier *game.project* comporte quelques [paramètres du projet](/fr/manuals/project-settings#label) liés aux libellés.
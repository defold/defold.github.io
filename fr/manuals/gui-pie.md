...
- anchor: gui-pie-nodes
  title: Nœuds Pie dinterface graphique
- anchor: creating-a-pie-node
  title: Créer un nœud Pie
- anchor: modify-pie-nodes-at-runtime
  title: Modifier les nœuds Pie à lexécution
---
...
![Créer un nœud Pie](/manuals/images/gui-pie/create.png)
...
![Propriétés](/manuals/images/gui-pie/properties.png)

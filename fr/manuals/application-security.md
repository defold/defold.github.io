...
- anchor: securing-your-intellectual-property-from-theft
  title: Protéger votre propriété intellectuelle contre le vol
- anchor: source-code-obfuscation
  title: Obfuscation du code source
- anchor: resource-encryption
  title: Chiffrement des ressources
- anchor: encoding-project-configuration-values
  title: Encodage des valeurs de configuration du projet
- anchor: securing-your-game-against-cheaters
  title: Protéger votre jeu contre les tricheurs
- anchor: securing-your-network-communication
  title: Sécuriser vos communications réseau
- anchor: ssl-certificate-validation
  title: Validation des certificats SSL
- anchor: securing-your-use-of-third-party-software
  title: Sécuriser votre utilisation de logiciels tiers
- anchor: securing-your-use-of-cloud-build-servers
  title: Sécuriser votre utilisation des serveurs de build dans le cloud
- anchor: securing-your-downloadable-content
  title: Sécuriser votre contenu téléchargeable
---
...
Vous pouvez en savoir plus sur ce processus dans le [manuel Live Update](https://defold.com/fr/manuals/live-update/#content-verification).
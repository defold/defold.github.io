...
- anchor: creating-a-new-project
  title: Créer un nouveau projet local
- anchor: adding-the-project-to-github
  title: Ajouter le projet à GitHub
...
![Ouvrir un projet](/manuals/images/workflow/open_project.png)

Ou à partir d'un tutoriel contenant des instructions pas à pas :

![Créer un projet à partir d'un tutoriel](/manuals/images/workflow/create_from_tutorial.png)

Ou à partir d'un jeu d'exemple complet :

![Créer un projet à partir d'un exemple](/manuals/images/workflow/create_from_sample.png)
...
![Importer un projet](/manuals/images/workflow/open_from_disk.png)

...
- anchor: input
  title: Entrées
- anchor: setting-up-input-bindings
  title: Configuration des liaisons dentrée
- anchor: trigger-types
  title: Types de déclencheurs
- anchor: accelerometer-input
  title: Entrées de laccéléromètre
- anchor: input-focus
  title: Focus dentrée
- anchor: input-dispatch-and-on_input
  title: Distribution des entrées et on_input()
- anchor: input-focus-and-collection-proxy-components
  title: Focus dentrée et composants proxy de collection
- anchor: releasing-input
  title: Libération du focus dentrée
- anchor: consuming-input
  title: Consommation des entrées
---
...
![Liaisons d'entrée](/manuals/images/input/overview.png)
...
: Les périphériques d'entrée intégrés à votre ordinateur ou appareil mobile, ou qui y sont connectés, fournissent des entrées brutes au niveau du système à l'environnement d'exécution Defold. Les types de périphériques suivants sont pris en charge :
  ...
  4. Manettes (selon la prise en charge par le système d'exploitation et les correspondances définies dans le fichier [gamepads](/fr/manuals/input-gamepads/#gamepads-settings-file))
...
![Paramètre des liaisons d'entrée](/manuals/images/input/setting.png)
...
![Configuration des liaisons d'entrée](/manuals/images/input/input_binding.png)
...
Key Triggers
: Entrées provenant de touches individuelles du clavier. Chaque touche est associée séparément à une action correspondante. Pour en savoir plus, consultez le [manuel sur les entrées clavier et la saisie de texte](/fr/manuals/input-key-and-text).

Text Triggers
: Les déclencheurs de texte servent à lire du texte saisi librement. Pour en savoir plus, consultez le [manuel sur les entrées clavier et la saisie de texte](/fr/manuals/input-key-and-text)

Mouse Triggers
: Entrées provenant des boutons et des molettes de la souris. Pour en savoir plus, consultez le [manuel sur les entrées souris et tactiles](/fr/manuals/input-mouse-and-touch).

Touch Triggers
: Les déclencheurs tactiles simples et multitactiles sont disponibles sur les appareils iOS et Android dans les applications natives et les bundles HTML5. Pour en savoir plus, consultez le [manuel sur les entrées souris et tactiles](/fr/manuals/input-mouse-and-touch).

Gamepad Triggers
: Les déclencheurs de manette vous permettent de lier les entrées standard des manettes aux fonctions du jeu. Pour en savoir plus, consultez le [manuel sur les manettes](/fr/manuals/input-gamepads).
...
![Pile d'entrée](/manuals/images/input/input_stack.png)
...
![Distribution des actions](/manuals/images/input/actions.png)
...
![Distribution des actions aux proxys](/manuals/images/input/proxy.png)
...
![Consommation des entrées](/manuals/images/input/consuming.png)
...
![Consommation des entrées](/manuals/images/input/game.png)
...
![Menu de pause](/manuals/images/input/game_paused.png)

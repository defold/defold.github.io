...
- anchor: gui-particlefx-nodes
  title: Nœuds ParticleFX dinterface graphique
- anchor: adding-particle-fx-nodes
  title: Ajout de nœuds Particle FX
- anchor: controlling-the-effect
  title: Contrôle de leffet
---
...
![Effet de particules](/manuals/images/gui-particlefx/create.png)
...
Consultez le [manuel sur les effets de particules](/fr/manuals/particlefx) pour plus de détails sur le fonctionnement des effets de particules.
...
- anchor: rich-text-markup
  title: Balisage de texte enrichi
- anchor: tag-reference
  title: Référence des balises
- anchor: syntax
  title: Syntaxe
- anchor: attributes
  title: Attributs
...
- anchor: interaction-messages
  title: Messages dinteraction
- anchor: named-styles
  title: Styles nommés
- anchor: layout-object-api
  title: API des objets de mise en page
...
- anchor: returned-object-fields
  title: Champs des objets renvoyés
- anchor: lua-example
  title: Exemple Lua
- anchor: useful-combinations
  title: Combinaisons utiles
- anchor: colored-outline-with-a-horizontal-gradient
  title: Contour coloré avec un dégradé horizontal
- anchor: shake-a-sentence-gradient-one-word
  title: Faire trembler une phrase et appliquer un dégradé à un mot
- anchor: override-one-property-without-losing-the-others
  title: Remplacer une propriété sans perdre les autres
---
...
![Texte d'exemple affiché en vert opaque](/manuals/images/richtext/color_green.webp)
...
![Texte d'exemple affiché en vert à demi-opacité](/manuals/images/richtext/color_green_alpha.webp)
...
![Texte d'exemple affiché en 24 pixels](/manuals/images/richtext/size_24.webp)
...
![Texte d'exemple affiché à 120 pour cent de 32 pixels](/manuals/images/richtext/size_120.webp)
...
![Texte d'exemple affiché au double de la taille de base de 32 pixels](/manuals/images/richtext/size_2em.webp)
...
![Texte d'exemple avec un dégradé horizontal du magenta au blanc](/manuals/images/richtext/gradient_horizontal.webp)
...
![Texte d'exemple avec un dégradé bleu vertical](/manuals/images/richtext/gradient_vertical.webp)
...
![Texte d'exemple avec un dégradé à quatre coins ajusté à chaque glyphe](/manuals/images/richtext/gradient_four_glyph.webp)
...
![Texte d'exemple avec un dégradé à quatre coins ajusté à la portion de texte](/manuals/images/richtext/gradient_four_text.webp)
...
![Dégradé à défilement animé ajusté à chaque glyphe](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![Dégradé à défilement animé ajusté à la portion de texte](/manuals/images/richtext/gradient_flow_span.webp)
...
![Texte d'exemple avec un soulignement continu](/manuals/images/richtext/underline_solid.webp)
...
![Texte d'exemple avec un soulignement en tirets](/manuals/images/richtext/underline_dashed.webp)
...
![Texte d'exemple avec un soulignement en dégradé](/manuals/images/richtext/underline_gradient.webp)
...
![Texte d'exemple barré d'un trait continu](/manuals/images/richtext/strike_solid.webp)
...
![Texte d'exemple barré d'un trait en tirets](/manuals/images/richtext/strike_dashed.webp)
...
![Texte d'exemple avec un contour noir extérieur](/manuals/images/richtext/outline.webp)
...
![Texte d'exemple avec une ombre décalée](/manuals/images/richtext/shadow.webp)
...
![Texte d'exemple avec un tremblement animé par glyphe](/manuals/images/richtext/shake_glyph.webp)
...
![Texte d'exemple avec un tremblement animé de toute la portion de texte](/manuals/images/richtext/shake_span.webp)
...
![Texte d'exemple avec une onde animée par glyphe](/manuals/images/richtext/wave_glyph.webp)
...
![Texte d'exemple animé comme une seule portion de texte](/manuals/images/richtext/wave_span.webp)
...
![Logo Defold affiché dans le texte](/manuals/images/richtext/sprite.webp)
...
![www.defold.com affiché avec le style de lien par défaut et un soulignement](/manuals/images/richtext/link.webp)
...
Consultez [Focus d'entrée](/fr/manuals/input/#input-focus) et [Entrées de la souris et tactiles](/fr/manuals/input-mouse-and-touch) pour les détails de configuration.

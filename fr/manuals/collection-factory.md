...
toc:
- anchor: collection-factories
  title: Factories de collection
- anchor: spawning-a-collection
  title: Apparition dune collection
- anchor: properties
  title: Propriétés
- anchor: dynamic-loading-of-factory-resources
  title: Chargement dynamique des ressources de factory
...
Les collections constituent un mécanisme puissant pour créer des modèles réutilisables, ou « prefabs », dans Defold. Pour une présentation des collections, consultez la [documentation sur les éléments constitutifs](/fr/manuals/building-blocks#collections). Vous pouvez placer les collections dans l'éditeur ou les insérer dynamiquement dans votre jeu.
...
![Factory de collection](/manuals/images/collection_factory/factory.png)
...
Supposons que l'objet de jeu `bean` de `bean.collection` définisse la propriété `shield`. Le [manuel des propriétés de script](/fr/manuals/script-properties) contient des informations sur les propriétés de script.
...
![Chargement dynamique](/manuals/images/collection_factory/load_dynamically.png)
...
![Prototype dynamique](/manuals/images/collection_factory/dynamic_prototype.png)

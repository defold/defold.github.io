...
- anchor: http-requests
  title: Requêtes HTTP
- anchor: http-get
  title: Requêtes HTTP GET
- anchor: http-post
  title: Requêtes HTTP POST
- anchor: other-http-methods
  title: Autres méthodes HTTP
- anchor: how-to-work-with-the-http-response
  title: Traitement de la réponse HTTP
- anchor: request-headers
  title: En-têtes de requête
- anchor: response-headers
  title: En-têtes de réponse
- anchor: http-proxy
  title: Proxy HTTP
- anchor: api-reference
  title: Référence de lAPI
- anchor: extensions
  title: Extensions
---

...
![Modèle dans un objet de jeu](/manuals/images/model/model_gltf.png)
...
![Wiggler dans le jeu](/manuals/images/model/runtime.png)

### Animation à l'exécution {#runtime-animation}

Defold offre des fonctions puissantes pour contrôler l'animation à l'exécution. Vous trouverez plus d'informations dans le [manuel sur l'animation des modèles](/fr/manuals/model-animation) :
...
Consultez la [documentation sur le rendu](/fr/manuals/render) pour plus de détails sur le fonctionnement des scripts de rendu.
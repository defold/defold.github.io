...
- anchor: material-attributes
  title: Attributs de matériau
- anchor: project-configuration
  title: Configuration du projet
- anchor: multi-textured-sprites
  title: Sprites à plusieurs textures
- anchor: animations
  title: Animations
- anchor: uvs
  title: Coordonnées UV
---
...
Le composant sprite peut utiliser un [atlas](/fr/manuals/atlas) ou une [source de tuiles](/fr/manuals/tilesource) pour ses graphismes.
...
{% include shared/fr/slice-9-texturing.md %}
...
{% include shared/fr/material-constants.md component='sprite' variable='tint' %}
...
Un sprite peut redéfinir les attributs de sommets du matériau actuellement assigné, qui seront transmis au shader de sommets par le composant (consultez le [manuel des matériaux pour plus de détails](/fr/manuals/material/#attributes)).
...
![attributs du sprite](/manuals/images/graphics/sprite-attributes.png)

## Configuration du projet {#project-configuration}

Le fichier *game.project* comporte quelques [paramètres du projet](/fr/manuals/project-settings#sprite) liés aux sprites.
...
Nous utilisons donc `Rename patterns` dans l'[atlas](/fr/manuals/material/) pour les renommer.

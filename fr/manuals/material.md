...
- anchor: creating-a-material
  title: Création dun matériau
- anchor: attributes
  title: Attributs
- anchor: default-attribute-semantics
  title: Sémantique par défaut des attributs
- anchor: setting-custom-vertex-attribute-data
  title: Définition des données dattributs de sommet personnalisés
- anchor: examples-of-using-custom-vertex-attributes
  title: Exemples dutilisation dattributs de sommet personnalisés
- anchor: instancing
  title: Instanciation
- anchor: vertex-and-fragment-constants
  title: Constantes de sommets et de fragments
- anchor: gui-node-material-constants
  title: Constantes de matériau des nœuds dinterface graphique
- anchor: samplers
  title: Échantillonneurs
- anchor: sampler-settings
  title: Paramètres des échantillonneurs
- anchor: constants-buffers
  title: Tampons de constantes
---
...
* Pour plus d'informations sur le pipeline de rendu, consultez la [documentation sur le rendu](/fr/manuals/render).
* Pour une explication approfondie des programmes de shader, consultez la [documentation sur les shaders](/fr/manuals/shader).
...
![Fichier de matériau](/manuals/images/materials/material_file.png)

Le nouveau matériau s'ouvre dans le *Material Editor*.

![Éditeur de matériaux](/manuals/images/materials/material.png)
...
Tags
: Les étiquettes associées au matériau. Dans le moteur, les étiquettes sont représentées par un _masque de bits_ utilisé par [`render.predicate()`](/ref/render#render.predicate) pour regrouper les composants qui doivent être dessinés ensemble. Consultez la [documentation sur le rendu](/fr/manuals/render) pour savoir comment procéder. Vous pouvez utiliser au maximum 32 étiquettes dans un projet.
...
![Attribut de matériau personnalisé](/manuals/images/materials/set_custom_attribute.png)
...
![Configuration de l'instanciation](/manuals/images/materials/instancing-setup.png)

Le matériau est configuré ainsi, avec un seul attribut de sommet personnalisé répété pour chaque instance :

![Matériau pour l'instanciation](/manuals/images/materials/instancing-material.png)
...
![Appels de rendu avec instanciation](/manuals/images/materials/instancing-draw-calls.png)
...
![Échantillonneur de sprite](/manuals/images/materials/sprite_sampler.png)
...
![Paramètres d'échantillonneur](/manuals/images/materials/my_sampler.png)
...
![Échantillonneurs de modèle](/manuals/images/materials/model_samplers.png)
...
![Modèle](/manuals/images/materials/model.png)

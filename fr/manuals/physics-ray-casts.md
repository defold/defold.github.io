...
toc:
- anchor: ray-casts
  title: Lancers de rayons
---

## Lancers de rayons {#ray-casts}

Les lancers de rayons (ray casts) permettent d'interroger le monde physique le long d'un rayon rectiligne. Pour lancer un rayon dans le monde physique, vous fournissez une position de départ et une position d'arrivée, ainsi qu'[un ensemble de groupes de collision](/fr/manuals/physics-groups) à tester.

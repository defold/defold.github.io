...
- anchor: application-manifests
  title: Manifestes dapplication
- anchor: naming-and-structure
  title: Nommage et structure
- anchor: android
  title: Android
- anchor: example
  title: Exemple
...
Nous vous recommandons d'utiliser : `<uses-sdk android:targetSdkVersion="{% raw %}{{android.target_sdk_version}}{% endraw %}" />`
</div>
### Exemple {#example}

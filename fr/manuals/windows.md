...
toc:
- anchor: windows-development
  title: Développement pour Windows
- anchor: project-settings
  title: Paramètres du projet
- anchor: application-icon
  title: Icône de lapplication
- anchor: creating-ico-file-locally-using-imagemagick-software-suite
  title: Création locale dun fichier .ico à laide de la suite logicielle ImageMagick.
- anchor: faq
...
La configuration de l'application propre à Windows s'effectue dans la [section Windows](/fr/manuals/project-settings/#windows) du fichier de paramètres *game.project*.

...
- anchor: debugging-lua-scripts-with-zerobrane-studio
  title: Débogage des scripts Lua avec ZeroBrane Studio
- anchor: zerobrane-configuration
  title: Configuration de ZeroBrane
- anchor: to-set-up-zerobrane
  title: Configurer ZeroBrane
- anchor: starting-the-debugging-server
  title: Démarrer le serveur de débogage
- anchor: connecting-your-application-to-the-debugger
  title: Connecter votre application au débogueur
- anchor: remote-debugging
  title: Débogage à distance
- anchor: other-recommended-zerobrane-setting
  title: Autre paramètre ZeroBrane recommandé
---
...
![Démarrer le débogueur](/manuals/images/zerobrane/startdebug.png)
...
![Exécution pas à pas](/manuals/images/zerobrane/code.png)
...
![Autres paramètres recommandés](/manuals/images/zerobrane/otherrecommended.png)
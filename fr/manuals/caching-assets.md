...
toc:
- anchor: caching-assets
  title: Mise en cache des ressources
- anchor: project-cache
  title: Cache du projet
- anchor: local-cache
  title: Cache local
- anchor: remote-cache
  title: Cache distant
...
Vous pouvez supprimer le cache du projet manuellement en effaçant les fichiers dans `build/default` ou en exécutant la commande `clean` de l'[outil de build en ligne de commande Bob](/fr/manuals/bob).

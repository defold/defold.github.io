...
- anchor: creating-a-tile-source
  title: Créer une source de tuiles
- anchor: tile-source-flip-book-animations
  title: Animations image par image dune source de tuiles
- anchor: tile-source-collision-shapes
  title: Formes de collision dune source de tuiles
---

# Source de tuiles {#tile-source}

Une *source de tuiles* peut être utilisée par un [composant (component) tilemap](/fr/manuals/tilemap) pour peindre des tuiles sur une grille, ou servir de source graphique pour un [sprite](/fr/manuals/sprite) ou un [composant d'effet de particules](/fr/manuals/particlefx). Vous pouvez également utiliser les *formes de collision* de la source de tuiles dans une tilemap pour la [détection des collisions et la simulation physique](/fr/manuals/physics) ([exemple](/examples/tilemap/collisions/)).
...
![Image de tuiles](/manuals/images/tilemap/small_map.png)
...
![Création d'une source de tuiles](/manuals/images/tilemap/tilesource.png)
...
![Animation d'une source de tuiles](/manuals/images/tilemap/animation.png)
...
![Formes de collision](/manuals/images/tilemap/collision.png)

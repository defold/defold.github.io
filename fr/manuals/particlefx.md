...
- anchor: creating-an-effect
  title: Création dun effet
- anchor: previewing-an-effect
  title: Aperçu dun effet
- anchor: emitter-properties
  title: Propriétés des émetteurs
- anchor: blend-modes
  title: Modes de fusion
- anchor: keyable-emitter-properties
  title: Propriétés démetteur animables par images clés
- anchor: modifiers
  title: Modificateurs
- anchor: modifier-properties
  title: Propriétés des modificateurs
- anchor: controlling-a-particle-effect
  title: Contrôle dun effet de particules
...
![Éditeur d'effets de particules](/manuals/images/particlefx/editor.png)
...
Sélectionnez <kbd>New... ▸ Particle FX</kbd> dans le menu contextuel du navigateur *Assets*. Nommez le nouveau fichier d'effet de particules. L'éditeur ouvre alors le fichier dans l'[éditeur de scène](/fr/manuals/editor/#the-scene-editor).
...
![Particules par défaut](/manuals/images/particlefx/default.png)
...
![Ajout d'un modificateur](/manuals/images/particlefx/add_modifier.png)

![Sélection du modificateur à ajouter](/manuals/images/particlefx/add_modifier_select.png)
...
![Modification des particules](/manuals/images/particlefx/rotate.gif)
...
: Forme de l'émetteur
  ...
  ![Types d'émetteurs](/manuals/images/particlefx/emitter_types.png)
...
![Propriété](/manuals/images/particlefx/property.png)
...
![Propriété animée par images clés](/manuals/images/particlefx/key.png)
...
![Éditeur de courbes d'effets de particules](/manuals/images/particlefx/curve_editor.png)
...
: Agit sur les particules dans une direction circulaire ou en spirale autour de sa position.
  ...
  ![Modificateurs](/manuals/images/particlefx/modifiers.png)
...
Pour démarrer et arrêter un effet de particules depuis un script GUI, consultez le [manuel des effets de particules GUI](/fr/manuals/gui-particlefx#controlling-the-effect) pour plus d'informations.
...
Le matériau par défaut des effets de particules possède les constantes suivantes, qui peuvent être modifiées avec `particlefx.set_constant()` et réinitialisées avec `particlefx.reset_constant()` (consultez le [manuel des matériaux pour plus de détails](/fr/manuals/material/#vertex-and-fragment-constants)) :
...
Le fichier *game.project* contient quelques [paramètres du projet](/fr/manuals/project-settings#particle-fx) liés aux particules.
...
- anchor: creating-a-collection-proxy-component
  title: Création dun composant proxy de collection
- anchor: bootstrap
  title: Démarrage
- anchor: loading-a-collection
  title: Chargement dune collection
- anchor: changing-an-excluded-proxys-collection
  title: Modification de la collection dun proxy exclu
- anchor: addressing-into-the-new-world
  title: Adressage dans le nouveau monde
- anchor: unloading-a-world
  title: Déchargement dun monde
- anchor: time-step
  title: Pas de temps
...
Les proxys de collection diffèrent des [composants collection factory](/fr/manuals/collection-factory/). Une collection factory instancie le contenu d'une collection dans le monde de jeu actuel. Les proxys de collection créent un nouveau monde de jeu à l'exécution et répondent donc à d'autres besoins.
...
![Ajout d'un composant proxy](/manuals/images/collection-proxy/create_proxy.png)

(Vous pouvez exclure le contenu du build et le télécharger à l'aide de code en cochant la case *Exclude* et en utilisant la [fonctionnalité Live Update](/fr/manuals/live-update/).)

## Démarrage {#bootstrap}

Au démarrage, le moteur Defold charge et instancie tous les objets de jeu d'une *collection bootstrap* dans l'environnement d'exécution. Il initialise et active ensuite les objets de jeu et leurs composants. La collection bootstrap que le moteur doit utiliser est définie dans les [paramètres du projet](/fr/manuals/project-settings/#main-collection). Par convention, ce fichier de collection est généralement nommé `main.collection`.

![Démarrage](/manuals/images/collection-proxy/bootstrap.png)
...
![Démarrage](/manuals/images/collection-proxy/collection_id.png)
...
![Chargement](/manuals/images/collection-proxy/proxy_load.png)
...
![Chargement](/manuals/images/collection-proxy/message_passing.png)

Si vous devez communiquer avec un objet de jeu de la collection chargée depuis l'objet de chargement, vous pouvez envoyer un message en utilisant l'[URL complète de l'objet](/fr/manuals/addressing/#urls) :
...
* Les [animations de propriétés des objets de jeu et de l'interface graphique](https://defold.com/fr/manuals/animation/#property-animation-1)
* Les [animations image par image](https://defold.com/fr/manuals/animation/#flip-book-animation)
* Les [simulations d'effets de particules](https://defold.com/fr/manuals/particlefx/)

...
- anchor: enabling-and-disabling-components
  title: Activation et désactivation des composants
- anchor: component-properties
  title: Propriétés des composants
- anchor: component-position-rotation-and-scale
  title: Position, rotation et échelle des composants
- anchor: component-draw-order
  title: Ordre de rendu des composants
- anchor: render-script-predicates
  title: Prédicats du script de rendu
- anchor: component-z-value
  title: Valeur Z du composant
---

#  Composants {#components}

{% include shared/fr/components.md %}

## Types de composants {#component-types}

Defold prend en charge les types de composant (component) suivants :

* [Factory de collection](/fr/manuals/collection-factory) - Créer des collections
* [Proxy de collection (collection proxy)](/fr/manuals/collection-proxy) - Charger et décharger des collections
* [Objet de collision](/fr/manuals/physics) - Physique 2D et 3D
* [Caméra](/fr/manuals/camera) - Modifier la fenêtre d'affichage et la projection du monde de jeu (game world)
* [Factory](/fr/manuals/factory) - Créer des objets de jeu (game object)
* [GUI](/fr/manuals/gui) - Effectuer le rendu d'une interface graphique
* [Étiquette](/fr/manuals/label) - Afficher un texte
* [Lumière](/fr/manuals/light) - Ajouter des données d'éclairage pour les shaders
* [Maillage](/fr/manuals/mesh) Afficher un maillage 3D (avec création et manipulation à l'exécution)
* [Modèle](/fr/manuals/model) Afficher un modèle 3D (avec des animations facultatives)
* [Effets de particules](/fr/manuals/particlefx) -  Créer des particules
* [Script](/fr/manuals/script) - Ajouter la logique du jeu
* [Son](/fr/manuals/sound) - Jouer du son ou de la musique
* [Sprite](/fr/manuals/sprite) - Afficher une image 2D (avec une animation image par image facultative)
* [Tilemap](/fr/manuals/tilemap) - Afficher une grille de tuiles
...
Chaque type de composant Defold possède des propriétés différentes. Le [panneau Properties](/fr/manuals/editor/#the-editor-views) de l'éditeur affiche les propriétés du composant actuellement sélectionné dans le [panneau Outline](/fr/manuals/editor/#the-editor-views). Consultez les manuels des différents types de composants pour en savoir plus sur les propriétés disponibles.

...
- anchor: defold-editor-overview
  title: Présentation de l’éditeur Defold
- anchor: editors-comparison
  title: Comparaison des éditeurs
- anchor: defold-panes-overview
  title: Présentation des panneaux de Defold
- anchor: key-concepts
  title: Concepts clés
...
- anchor: resources
  title: Ressources
- anchor: collection-vs-scene
  title: Collection et scène
- anchor: project-resources-and-assets
  title: Ressources et contenu du projet
- anchor: assets
  title: Ressources du projet
- anchor: resource-formats
  title: Formats des ressources
- anchor: library-cache
  title: Cache de bibliothèque
- anchor: code-writing
  title: Écriture du code
- anchor: lua
  title: Lua
- anchor: teal
  title: Teal
- anchor: cc-native-extensions
  title: Extensions natives C++/C
- anchor: from-monobehaviours-to-lua-modules
  title: Des MonoBehaviours aux modules Lua
- anchor: built-in-code-editor
  title: Éditeur de code intégré
- anchor: vs-code-and-other-editors
  title: VS Code et les autres éditeurs
- anchor: shaders-glsl
  title: Shaders - GLSL
- anchor: messaging-system
  title: Système de messagerie
- anchor: sending-a-message
  title: Envoi d’un message
- anchor: addressing
  title: Adressage
- anchor: messaging-to-gui-and-render
  title: Messages aux interfaces graphiques et au rendu
- anchor: prefabs-and-instances
  title: Prefabs et instances
- anchor: factory
  title: Factory
...
- anchor: application-lifecycle
  title: Cycle de vie de l’application
- anchor: initialization
  title: Initialisation
- anchor: when-messages-are-handled
  title: Quand les messages sont-ils traités ?
- anchor: update-loop
  title: Boucle de mise à jour
- anchor: finalization
  title: Finalisation
- anchor: rendering
  title: Rendu
...
- anchor: gui-nodes
  title: Nœuds d’interface graphique
- anchor: gui-script
  title: Script d’interface graphique
- anchor: gui-rendering
  title: Rendu de l’interface graphique
- anchor: where-are-sorting-layers
  title: Où sont les Sorting Layers ?
...
Defold est beaucoup plus léger que Unity. Le moteur avec un projet vide occupe entre 1 et 3 Mo sur toutes les plateformes. Vous pouvez retirer d’autres parties du moteur et déplacer une partie du contenu du jeu vers [Live Update](/fr/manuals/live-update) pour le télécharger séparément plus tard. Une comparaison des tailles et d’autres raisons de choisir Defold sont présentées sur la [page Pourquoi Defold](https://defold.com/why/).
...
Pour en savoir plus, consultez ce court [manuel d’installation](/fr/manuals/install/).
...
![Comparaison des écrans d’accueil](/manuals/images/unity/unity_defold_start.png)
...
![Comparaison des modèles de l’écran d’accueil](/manuals/images/unity/unity_defold_templates.png)
...
![Bonjour le monde, étape 1](/manuals/images/unity/helloworld_1.png)
...
![Bonjour le monde, étape 2](/manuals/images/unity/helloworld_2.png)
4. Faites un clic droit sur l’objet de jeu (game object) `go` créé et sélectionnez `Add Component`, puis `Label`.
![Bonjour le monde, étape 3](/manuals/images/unity/helloworld_3.png)
...
![Bonjour le monde, étape 4](/manuals/images/unity/helloworld_4.png)
...
![Bonjour le monde, étape 5](/manuals/images/unity/helloworld_5.png)
...
Nous présentons ici l’éditeur Defold en nous plaçant du point de vue de ce qu’un utilisateur de Unity souhaite savoir en premier, mais nous vous encourageons à consulter ensuite le [manuel complet de présentation de l’éditeur](/fr/manuals/editor).
...
![Comparaison des éditeurs](/manuals/images/unity/defold_unity_editor.png)
...
| [Debugger](/fr/manuals/debugging/) | Visual Studio Debugger | Le débogueur est entièrement intégré à Defold dès l’installation. Un onglet supplémentaire permet de suivre, d’activer et de désactiver les points d’arrêt. |
...
![Éléments de base](/manuals/images/unity/blocks.png)

Pour en savoir plus, consultez le manuel complet sur les [éléments de base de Defold](/fr/manuals/building-blocks/).
...
Pour en savoir plus sur les [composants de Defold, consultez cette page](/fr/manuals/components/).
...
| Defold | Unity | Différences |
|---|---|---|
| [Sprite](/fr/manuals/sprite/) | Sprite Renderer | Dans Defold, vous ne pouvez changer la teinte (propriété de couleur) que par le code. |
| [Tilemap](/fr/manuals/tilemap/) | Tilemap / Grid | Defold possède un éditeur de tilemaps intégré qui prend en charge les grilles carrées (mais il existe des extensions, comme [Hexagon](https://github.com/selimanac/defold-hexagon/)) et ne propose pas de règles intégrées de placement automatique des tuiles. Des outils comme [Tiled](https://defold.com/assets/tiled/), [TileSetter](https://defold.com/assets/tilesetter/) ou [Sprite Fusion](https://defold.com/assets/spritefusion/) proposent des options d’exportation vers Defold. |
| [Label](/fr/manuals/label/) | Text / TextMeshPro | Depuis Defold 1.13.2, les composants Label et les nœuds de texte GUI prennent en charge un [balisage de texte enrichi](/fr/manuals/font-richtext/) intégré pour les couleurs, les dégradés, les contours et les effets animés. Une [extension RichText](https://defold.com/assets/richtext/) distincte est également disponible. |
| [Sound](/fr/manuals/sound/) | AudioSource | Defold ne possède qu’une source sonore globale (non spatiale). Il existe une [extension FMOD](https://github.com/defold/extension-fmod) officielle pour Defold. |
| [Factory](/fr/manuals/factory/) | Prefab Instantiate() | Dans Defold, une factory est un composant associé à un prototype (prefab) précis. |
| [Collection Factory](/fr/manuals/collection-factory/) | - (Aucun composant directement équivalent) | Un composant factory de collection dans Defold peut créer plusieurs objets de jeu avec des relations parent-enfant en une seule fois. |
| [Collision Object](/fr/manuals/physics-objects) | Rigidbody + Collider | Dans Defold, les objets physiques et les formes de collision sont réunis dans un même composant. |
| [Formes de collision](/fr/manuals/physics-shapes/)  | BoxCollider / SphereCollider / CapsuleCollider | Dans Defold, les formes (boîte, sphère, capsule) sont configurées dans le composant Collision Object. Les deux moteurs prennent en charge les formes de collision issues de tilemaps et de données d’enveloppes convexes. |
| [Camera](/fr/manuals/camera/) | Camera | Dans Unity, la caméra possède davantage de paramètres intégrés de rendu et de post-traitement, tandis que Defold laisse à l’utilisateur le soin de les contrôler par le script de rendu. |
| [GUI](/fr/manuals/gui/) | UI Toolkit / Unity UI / uGUI Canvas | Le composant GUI de Defold est puissant et permet de créer des interfaces utilisateur complètes et des modèles. Unity ne possède pas de composant d’interface unique équivalent, mais plusieurs frameworks d’interface. Defold dispose également d’une extension pour [Extension](https://github.com/britzl/extension-imgui). |
| [GUI Script](/fr/manuals/gui-script/) | Scripts Unity UI / uGUI | L’interface graphique de Defold peut être contrôlée par des scripts d’interface graphique à l’aide de l’API dédiée `gui`. |
| [Model](/fr/manuals/model/) | MeshRenderer + Material | Dans Defold, un composant Model regroupe un fichier de modèle 3D, des textures et un matériau avec des shaders. |
| [Mesh](/fr/manuals/mesh/) | MeshRenderer / MeshFilter / Maillage procédural | Dans Defold, Mesh est un composant permettant de gérer un ensemble de sommets par le code. Il ressemble au composant Model de Defold, mais opère à un niveau encore plus bas. |
| [ParticleFX](/fr/manuals/particlefx/) | Particle System | L’éditeur de particules de Defold prend en charge les effets de particules 2D/3D avec de nombreuses propriétés et permet de les animer dans le temps à l’aide de courbes dans Curve Editor. Il ne propose ni Trails ni Collisions. |
| [Script](/fr/manuals/script/) | Script | Les différences de programmation sont expliquées plus en détail ci-dessous. |
...
| Defold | Unity | Différences |
|---|---|---|
| [Atlas](/fr/manuals/atlas/) | Sprite Atlas / Texture2D | Defold possède également une [extension pour Texture Packer](https://defold.com/extension-texturepacker/). |
| [Source de tuiles](/fr/manuals/tilesource/) | Tile Palette + Asset | Dans Defold, une source de tuiles peut servir de texture pour les tilemaps, mais aussi pour les sprites ou les particules. |
| [Font](/fr/manuals/font/) | Font | Utilisée par le composant Label de Defold ou par les nœuds de texte des interfaces graphiques, comme Text/TextMeshPro dans Unity. |
| [Material](/fr/manuals/material/) | Material | Dans Defold, les shaders portent les noms de programme de sommets et de programme de fragments. |
...
Pour en savoir plus sur les collections, consultez le [manuel des éléments de base](/fr/manuals/building-blocks/#collections).
...
Pour en savoir plus sur les extensions, consultez le [manuel des extensions natives de Defold](/fr/manuals/extensions/).
...
- [Manuel des scripts](/fr/manuals/script/)
- [Écriture du code](/fr/manuals/writing-code/)
- [Débogage](/fr/manuals/debugging/)
...
Vous pouvez également configurer les préférences de l’éditeur Defold pour ouvrir par défaut les fichiers texte dans VS Code (ou tout autre éditeur externe). Consultez les [préférences de l’éditeur](/fr/manuals/editor-preferences/) pour en savoir plus.
...
Pour en savoir plus sur les shaders, consultez le [manuel des shaders](/fr/manuals/shader).
...
Pour en savoir plus sur les matériaux, consultez le [manuel des matériaux](/fr/manuals/material).
...
Vous trouverez plus de précisions dans le [manuel de l’échange de messages](/fr/manuals/message-passing/).
...
Vous trouverez plus de précisions dans le [manuel de l’adressage](/fr/manuals/addressing/).
...
Vous trouverez plus de précisions dans le [manuel des factories](/fr/manuals/factory/). 
...
Vous trouverez plus de précisions dans le [manuel des factories de collection](/fr/manuals/collection-factory/).
...
Vous trouverez plus de précisions dans le [manuel de gestion des ressources](/fr/manuals/resource/). 
...
Vous trouverez plus de précisions dans le [manuel des proxies de collection](/fr/manuals/collection-proxy/).
...
| `on_input` | Méthodes d’entrée | Defold reçoit les entrées lorsque [le focus d’entrée est attribué au script](/fr/manuals/input/#input-focus). Elles sont traitées en premier dans la boucle de mise à jour. |
| `fixed_update()` | `FixedUpdate()` | Appelé à pas de temps fixe. Pour l’activer dans Defold, vous devez définir `Use Fixed Timestep` - [précisions](https://defold.com/fr/manuals/project-settings/#use-fixed-timestep). Depuis la version 1.12.0, il s’exécute avant `update()`. |
...
Pour en savoir plus, consultez le [manuel du cycle de vie de l’application](/fr/manuals/application-lifecycle/).
...
Pour en savoir plus, consultez le [manuel de l’interface graphique](/fr/manuals/gui/).

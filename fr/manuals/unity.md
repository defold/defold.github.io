...
| [Label](/fr/manuals/label/) | Text / TextMeshPro | Defold possède une [extension RichText](https://defold.com/assets/richtext/) pour la mise en forme enrichie (comme TextMeshPro). |

...
- anchor: creating-display-profiles
  title: Création de profils daffichage
- anchor: auto-layout-selection-display-profiles
  title: Sélection automatique de la mise en page (profils daffichage)
- anchor: gui-layouts
  title: Mises en page dinterface graphique
- anchor: dynamic-profile-selection
  title: Sélection dynamique des profils
- anchor: layout-change-messages
  title: Messages de changement de mise en page
- anchor: manual-layout-selection-lua
  title: Sélection manuelle de la mise en page (Lua)
- anchor: guiset_layoutlayout
  title: gui.set_layout(layout)
- anchor: guiget_layouts
  title: gui.get_layouts()
---
...
![Nouveaux profils d'affichage](/manuals/images/gui-layouts/new_profiles.png)
...
![Paramètres](/manuals/images/gui-layouts/settings.png)
...
![Ajout d'une mise en page à la scène](/manuals/images/gui-layouts/add_layout.png)
...
![Barre d'outils des mises en page](/manuals/images/gui-layouts/toolbar.png)

![Modification en mode portrait](/manuals/images/gui-layouts/portrait.png)
...
![Modification en mode paysage](/manuals/images/gui-layouts/landscape.png)

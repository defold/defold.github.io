...
- anchor: introduction
  title: Introduction
- anchor: how-to-change-how-your-content-is-rendered
  title: Comment modifier le rendu de votre contenu
- anchor: retro8-bit-graphics
  title: Graphismes rétro/8 bits
- anchor: high-resolution-graphics
  title: Graphismes haute résolution
- anchor: high-dpi-setting-and-retina-screens
  title: Paramètre de haute densité de pixels et écrans retina
- anchor: creating-an-adaptive-gui
  title: Créer une interface graphique adaptative
- anchor: node-properties
  title: Propriétés des *nœuds*
- anchor: layouts
  title: Dispositions
- anchor: testing-different-screen-sizes
  title: Tester différentes tailles décran
---
...
Vous pouvez obtenir le même résultat en attachant un [composant caméra](/fr/manuals/camera/) à un objet de jeu (game object), en cochant *Orthographic Projection* et en réglant *Orthographic Zoom* sur 4.0 :

...
toc:
- anchor: lua-modules
  title: Les modules Lua
- anchor: requiring-lua-files
  title: Chargement de fichiers Lua avec require
- anchor: modules
  title: Modules
- anchor: hot-reloading-modules
  title: Rechargement à chaud des modules
- anchor: modules-and-state
  title: Modules et état
---
...
![nouveau fichier](/manuals/images/modules/new_name.png)

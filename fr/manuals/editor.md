...
- anchor: editor-overview
  title: Présentation de léditeur
- anchor: starting-the-editor
  title: Démarrage de léditeur
- anchor: editor-language
  title: Langue de léditeur
- anchor: the-editor-views
  title: Les volets de léditeur
- anchor: 1-assets-pane
  title: 1. Volet Assets
- anchor: the-scene-editor
  title: 2. Volet Scene Editor
- anchor: 3-outline-pane
  title: 3. Volet Outline
- anchor: 4-properties-pane
  title: 4. Volet Properties
- anchor: 5-tools-pane
  title: 5. Volet Tools
- anchor: 6-changed-files-pane
  title: 6. Volet Changed Files
- anchor: menu-bar
  title: Barre de menus
- anchor: status-bar
  title: Barre détat
- anchor: panes-size-and-visibility
  title: Taille et visibilité des volets
- anchor: tabs
  title: Onglets
- anchor: side-by-side-editing
  title: Édition côte à côte
- anchor: creating-new-project-files
  title: Création de fichiers dans le projet
- anchor: templates
  title: Modèles
- anchor: importing-files-to-your-project
  title: Importation de fichiers dans votre projet
- anchor: updating-the-editor
  title: Mise à jour de léditeur
- anchor: preferences
  title: Préférences
- anchor: editor-logs
  title: Journaux de léditeur
- anchor: editor-server
  title: Serveur de léditeur
- anchor: editor-installation-metadata
  title: Métadonnées dinstallation de léditeur
- anchor: editor-styling
  title: Personnalisation de lapparence de léditeur
- anchor: faq
  title: FAQ
---
...
: Vous trouverez ici vos projets récemment ouverts pour y accéder rapidement. Il s'agit de la vue par défaut de l'écran de démarrage.
  ...
  ![Mes projets](/manuals/images/editor/start_no_projects.png)


  Si vous avez déjà ouvert des projets, la liste de vos projets s'affiche, comme sur l'image ci-dessous :

  ![Mes projets](/manuals/images/editor/start_my_projects.png)
...
: Contient des projets préparés pour illustrer des cas d'utilisation particuliers.
  ...
  ![Nouveau projet](/manuals/images/editor/start_templates.png)
...
Pour en savoir plus sur les différentes options, consultez le [manuel de configuration d'un projet](https://www.defold.com/fr/manuals/project-setup/).
...
![Langues](/manuals/images/editor/languages.png)
...
![Éditeur de scène](/manuals/images/editor/2d_scene.png)

Voici quelques-unes des principales fonctionnalités de l'éditeur de scène :

- [Navigation dans les scènes 2D et 3D](/fr/manuals/scene-editing/#2d-and-3d-scene-orientation) avec des modes de caméra orthographique et en perspective
- [Outils de transformation](/fr/manuals/scene-editing/#manipulating-objects) pour déplacer, faire pivoter et redimensionner les objets
- [Mode caméra libre](/fr/manuals/scene-editing/#free-camera-mode) pour une navigation 3D à la première personne
- [Réglages de la grille](/fr/manuals/scene-editing/#grid-settings) avec une taille, un plan et une apparence configurables
- [Filtres de visibilité](/fr/manuals/scene-editing/#visibility-filters) pour afficher ou masquer les types de composants et les repères

Pour en savoir plus, consultez le [manuel de l'éditeur de scène](/fr/manuals/scene-editing/).
...
![Arborescence](/manuals/images/editor/outline.png)
...
![Propriétés](/manuals/images/editor/properties.png)
...
*Curve Editor* : sert à modifier les courbes dans l'[éditeur de particules](/fr/manuals/particlefx/).

Le volet Tools sert également à interagir avec le débogueur intégré. Pour en savoir plus, consultez le [manuel de débogage](/fr/manuals/debugging/).

### 6. Volet Changed Files {#6-changed-files-pane}

Si votre projet utilise Git, cette vue répertorie les fichiers qui ont été modifiés, ajoutés, renommés ou supprimés localement par rapport au commit actuel (`HEAD`). Utilisez un client Git externe ou la ligne de commande pour synchroniser le projet avec un dépôt distant. Pour en savoir plus, consultez le [manuel de gestion de versions](/fr/manuals/version-control/). Certaines opérations sur les fichiers peuvent être effectuées dans cette vue :
...
![Visibilité des volets](/manuals/images/editor/editor_panes.png)
...
- Sélectionner `➝| Open As` pour utiliser un autre éditeur que celui par défaut, ou l'outil externe associé défini dans `File ▸ Preferences ▸ Code ▸ Custom Editor`. Pour en savoir plus, consultez le [manuel des préférences](/fr/manuals/editor-preferences).

![Onglets](/manuals/images/editor/tabs_custom.png)
...
![Deux volets](/manuals/images/editor/2-panes.png)
...
![Création d'un fichier](/manuals/images/editor/create_file.png)
...
![Modèles](/manuals/images/editor/templates.png)

## Importation de fichiers dans votre projet {#importing-files-to-your-project}

Pour ajouter des fichiers de ressources (images, sons, modèles, etc.) à votre projet, faites-les simplement glisser à l'emplacement voulu dans le navigateur *Assets*. Cela crée des _copies_ des fichiers à l'emplacement sélectionné dans l'arborescence du projet. Pour en savoir plus, consultez notre [manuel sur l'importation de ressources](/fr/manuals/importing-assets/).

![Importation de fichiers](/manuals/images/editor/import.png)
...
![Mise à jour depuis la sélection de projets](/manuals/images/editor/update_start.png)
![Mise à jour depuis l'éditeur](/manuals/images/editor/update_available.png)
...
![Fenêtre de mise à jour de l'éditeur](/manuals/images/editor/update.png)

La progression du téléchargement s'affiche dans la barre d'état inférieure :

![Progression du téléchargement](/manuals/images/editor/download_status.png)
...
![Redémarrage pour la mise à jour](/manuals/images/editor/restart_to_update.png)
...
Pour en savoir plus, consultez le [manuel des préférences](/fr/manuals/editor-preferences)

![Préférences](/manuals/images/editor/preferences.png)
...
Pour en savoir plus, consultez le [manuel pour obtenir de l'aide](/fr/manuals/getting-help/#getting-help).

![Affichage des journaux](/manuals/images/editor/show_logs.png)
...
L'apparence de l'éditeur peut être modifiée à l'aide de styles personnalisés. Pour en savoir plus, consultez le [manuel de personnalisation de l'apparence de l'éditeur](/fr/manuals/editor-styling).

## FAQ {#faq}
{% include shared/fr/editor-faq.md %}
...
- anchor: digital-buttons
  title: Boutons numériques
- anchor: analog-sticks
  title: Sticks analogiques
- anchor: multiple-gamepads
  title: Plusieurs manettes
- anchor: connect-and-disconnect
  title: Connexion et déconnexion
- anchor: raw-gamepads
  title: Entrées brutes des manettes
- anchor: gamepads-settings-file
  title: Fichier de paramètres des manettes
- anchor: unidentified-gamepads
  title: Manettes non identifiées
- anchor: gamepads-in-html5
  title: Manettes en HTML5
- anchor: standard-gamepad
  title: Manette standard
- anchor: gamepads-on-windows
  title: Manettes sous Windows
- anchor: gamepads-on-android
  title: Manettes sous Android
---

<div class='sidenote' markdown='1'>
Il est recommandé de vous familiariser avec le fonctionnement général des entrées dans Defold, la manière de les recevoir et l'ordre dans lequel elles sont reçues dans vos fichiers de script. Pour en savoir plus sur le système d'entrée, consultez le [manuel de présentation des entrées](/fr/manuals/input).
</div>
...
![Paramètres des manettes](/manuals/images/input/gamepads.png)
...
![Paramètres des manettes](/manuals/images/input/gamepad_setting.png)

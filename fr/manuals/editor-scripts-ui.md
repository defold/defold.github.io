...
- anchor: editor-scripts-and-ui
  title: Scripts de léditeur et interface utilisateur
- anchor: hello-world
  title: Bonjour tout le monde
- anchor: opening-resources
  title: Ouverture de ressources
- anchor: basic-concepts
  title: Concepts de base
- anchor: components
  title: Composants
- anchor: props
  title: Propriétés (props)
- anchor: alignment
  title: Alignement
...
![Boîte de dialogue du premier exemple](/manuals/images/editor_scripts/perform_action_dialog.png)
...
![Alignement](/manuals/images/editor_scripts/alignment.png)
...
![Marge intérieure et espacement](/manuals/images/editor_scripts/padding_and_spacing.png)
...
![Boîte de dialogue de création d'un niveau](/manuals/images/editor_scripts/new_level_dialog.png)
...
![Champs de saisie](/manuals/images/editor_scripts/inputs_demo.png)
...
![Boîte de dialogue de création d'un fichier](/manuals/images/editor_scripts/reactive_new_file_dialog.png)

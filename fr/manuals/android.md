...
- anchor: android-development
  title: Développement pour Android
- anchor: android-and-google-play-signing-process
  title: Processus de signature pour Android et Google Play
- anchor: creating-a-keystore
  title: Création dun magasin de clés
- anchor: creating-an-android-application-bundle
  title: Création dun bundle dapplication Android
- anchor: installing-an-android-application-bundle
  title: Installation dun bundle dapplication Android
- anchor: shrinking-java-code-with-r8
  title: Réduction du code Java avec R8
- anchor: enabling-r8
  title: Activation de R8
- anchor: adding-rules-to-an-extension
  title: Ajout de règles à une extension
- anchor: keeping-the-obfuscation-mapping
  title: Conservation de la table de correspondance dobfuscation
- anchor: permissions
  title: Autorisations
- anchor: androidpermissioninternet-and-androidpermissionaccess_network_state-protection-level-normal
  title: 'android.permission.INTERNET et android.permission.ACCESS_NETWORK_STATE (niveau de protection : normal)'
- anchor: androidpermissionwake_lock-protection-level-normal
  title: 'android.permission.WAKE_LOCK (niveau de protection : normal)'
- anchor: using-androidx
  title: Utilisation dAndroidX
- anchor: faq
...
Les appareils Android vous permettent d'y exécuter librement vos propres applications. Il est très facile de créer un build de votre jeu et de le copier sur un appareil Android. Ce manuel explique les étapes nécessaires à la création d'un bundle de votre jeu pour Android. Pendant le développement, il est souvent préférable d'exécuter votre jeu avec l'[application de développement](/fr/manuals/dev-app), car elle vous permet de recharger à chaud le contenu et le code directement sur votre appareil.
...
L'éditeur vous permet de créer facilement un bundle d'application autonome pour votre jeu. Avant de créer le bundle, vous pouvez préciser les icônes à utiliser pour l'application, définir le code de version, etc. dans le [fichier de paramètres du projet](/fr/manuals/project-settings/#android) *game.project*.
...
![Signature d'un bundle Android](/manuals/images/android/sign_bundle.png)
...
![Signature d'un bundle Android](/manuals/images/android/sign_bundle2.png)
...
![Fichier de paquet d'application Android](/manuals/images/android/apk_file.png)
...
{% include shared/fr/android-adb.md %}
...
![Installation et lancement d'un APK](/manuals/images/android/install_and_launch.png)

Pour que cette fonctionnalité fonctionne, *ADB* doit être installé et *USB debugging* doit être activé sur l'appareil connecté. Si l'éditeur ne parvient pas à détecter l'emplacement d'installation de l'outil en ligne de commande ADB, vous devez le préciser dans les [Preferences](/fr/manuals/editor-preferences/#tools).

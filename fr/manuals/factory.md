...
- anchor: factory-components
  title: Composants factory
- anchor: addressing-of-factory-created-objects
  title: Adressage des objets créés par une factory
- anchor: tracking-spawned-and-parent-objects
  title: Suivi des objets créés et des objets parents
- anchor: dynamic-loading-of-factory-resources
  title: Chargement dynamique des ressources dune factory
- anchor: dynamic-prototype
  title: Prototype dynamique
- anchor: instance-limits
  title: Limites dinstances
- anchor: pooling-of-game-objects
  title: Mise en réserve des objets de jeu
---
...
![Composant factory](/manuals/images/factory/factory_collection.png)

![Composant factory](/manuals/images/factory/factory_component.png)
...
![Objet de jeu créé](/manuals/images/factory/factory_spawned.png)
...
`[properties]`
: (facultatif) Une table Lua contenant les valeurs des propriétés de script avec lesquelles initialiser l'objet de jeu. Consultez le [manuel des propriétés de script](/fr/manuals/script-properties) pour en savoir plus sur ces propriétés.
...
![Objet de jeu créé avec une propriété et une mise à l'échelle](/manuals/images/factory/factory_spawned2.png)
...
![Chargement dynamique](/manuals/images/factory/load_dynamically.png)
...
![Prototype dynamique](/manuals/images/factory/dynamic_prototype.png)
...
![Nombre maximal d'instances](/manuals/images/factory/factory_max_instances.png)
...
Définissez *Max Instances* en fonction du plus grand nombre d'objets de jeu susceptibles d'être présents simultanément dans un monde dynamique. Consultez la section [Optimisations des nombres maximaux de composants](/fr/manuals/project-settings/#component-max-count-optimizations) pour savoir comment les autres limites de composants sont calculées.

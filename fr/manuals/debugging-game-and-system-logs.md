...
- anchor: game-and-system-log
  title: Journal du jeu et du système
- anchor: reading-the-game-log-from-the-editor
  title: Lire le journal du jeu depuis léditeur
- anchor: reading-the-game-log-from-the-terminal
  title: Lire le journal du jeu depuis le terminal
- anchor: reading-game-and-system-logs-using-platform-specific-tools
  title: Lire les journaux du jeu et du système à laide doutils propres à chaque plateforme
- anchor: html5
  title: HTML5
- anchor: android
  title: Android
...
- anchor: reading-the-game-log-from-the-log-file
  title: Lire le journal du jeu depuis le fichier journal
---
...
Lorsque vous exécutez votre jeu localement depuis l'éditeur ou en étant connecté à l'[application de développement mobile](/fr/manuals/dev-app), toutes les sorties s'affichent dans le panneau de console de l'éditeur :

![Éditeur 2](/manuals/images/editor/editor2_overview.png)
...
: Connectez votre appareil à un ordinateur sur lequel macOS et Xcode sont installés.
  ...
  ![Télécharger le conteneur](/manuals/images/debugging/download_container.png)

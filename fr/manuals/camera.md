...
![création d'un composant caméra](/manuals/images/camera/create.png)

Le composant caméra possède les propriétés suivantes, qui définissent le *volume de visualisation* de la caméra :

![paramètres de la caméra](/manuals/images/camera/settings.png)
...
![suivi d'un objet de jeu](/manuals/images/camera/follow.png)
...
<div class='sidenote' markdown='1'>
Les [solutions de caméra tierces mentionnées dans ce manuel](/fr/manuals/camera/#third-party-camera-solutions) proposent des fonctions de conversion depuis et vers les coordonnées écran.
</div>

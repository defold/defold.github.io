...
toc:
- anchor: debugging-on-android
  title: Débogage sur Android
- anchor: android-studio
  title: Android Studio
- anchor: notes
  title: Remarques
- anchor: native-extension-job-folder
  title: Dossier de tâche de lextension native
---
...
* Créez le bundle de l'application en mode débogage dans le dossier de votre choix.
	...
	![Création du bundle Android](/manuals/images/extensions/debugging/android/bundle_android.png)

* Lancez [Android Studio](https://developer.android.com/studio/)

* Choisissez `Profile or debug APK`

	![Débogage de l'APK](/manuals/images/extensions/debugging/android/android_profile_or_debug.png)

* Choisissez le bundle APK que vous venez de créer

	![Sélection de l'APK](/manuals/images/extensions/debugging/android/android_select_apk.png)

* Sélectionnez le fichier `.so` principal et assurez-vous qu'il contient les symboles de débogage

	![Sélection du fichier .so](/manuals/images/extensions/debugging/android/android_missing_symbols.png)
...
* Sélectionnez le fichier .so, puis ajoutez une correspondance vers votre disque local
	...
	![Correspondance de chemins 1](/manuals/images/extensions/debugging/android/path_mappings_android.png)

	![Correspondance de chemins 2](/manuals/images/extensions/debugging/android/path_mappings_android2.png)
...
* Vous devriez maintenant voir le code source associé dans votre projet
	...
	![Correspondances du code source](/manuals/images/extensions/debugging/android/source_mappings_android.png)

* Ajoutez un point d'arrêt

	![Point d'arrêt](/manuals/images/extensions/debugging/android/breakpoint_android.png)

* Appuyez sur `Run` -> `Debug "Appname"` et appelez le code dans lequel vous souhaitez interrompre l'exécution

	![Point d'arrêt](/manuals/images/extensions/debugging/android/callstack_variables_android.png)

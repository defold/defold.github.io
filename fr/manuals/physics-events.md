...
toc:
- anchor: defold-physics-event-handling
  title: Gestion des événements physiques dans Defold
- anchor: setting-the-physics-world-listener
  title: Définition de lécouteur du monde physique
- anchor: event-data-structure
  title: Structure des données dévénement
- anchor: example-usage
  title: Exemple dutilisation
- anchor: limitations
  title: Limitations
---
...
Si un écouteur est défini, les [messages physiques](/fr/manuals/physics-messages) ne seront plus envoyés pour le monde physique dans lequel cet écouteur est défini.
</div>

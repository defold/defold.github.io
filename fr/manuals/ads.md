...
- anchor: interstitial-ads
  title: Publicités interstitielles
- anchor: rewarded-ads
  title: Publicités avec récompense
- anchor: ad-networks
  title: Réseaux publicitaires
- anchor: how-to-integrate-ads-in-your-game
  title: Comment intégrer des publicités dans votre jeu
- anchor: combining-ads-and-in-app-purchases
  title: Combiner publicités et achats intégrés
- anchor: learn-more

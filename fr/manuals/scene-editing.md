...
- anchor: the-defold-scene-editor
  title: Léditeur de scène Defold
- anchor: opening-the-scene-editor
  title: Ouvrir léditeur de scène
- anchor: remembered-scene-views
  title: Mémorisation des vues de scène
- anchor: scene-view-navigation-camera-controls
  title: Navigation dans la vue de scène (commandes de caméra)
- anchor: standard-navigation-all-visual-editors
  title: Navigation standard (tous les éditeurs visuels)
- anchor: 2d-and-3d-scene-orientation
  title: Orientation de la scène en 2D et en 3D
- anchor: toolbar-overview
  title: Présentation de la barre doutils
- anchor: manipulating-objects
  title: Sélectionner et manipuler des objets
...
- anchor: camera-type-perspective-vs-orthographic
  title: 'Type de caméra : perspective ou orthographique'
- anchor: free-camera-mode
  title: Mode caméra libre
- anchor: activating-free-camera-mode
  title: Activer le mode caméra libre
- anchor: exiting-free-camera-mode
  title: Quitter le mode caméra libre
- anchor: looking-around-mouse-look
  title: Regarder autour de soi (orientation à la souris)
- anchor: moving
  title: Se déplacer
- anchor: walking-mode-optional
  title: Mode marche (facultatif)
- anchor: camera-settings-popup
  title: Fenêtre contextuelle des paramètres de la caméra
---
...
![Éditeur de scène en 3D](/manuals/images/editor/3d_scene.png)
...
![Barre d'outils](/manuals/images/editor/toolbar.png)
...
![Outil de déplacement](/manuals/images/editor/icon_move.png)
...
![Déplacer un objet](/manuals/images/editor/move.png)![Déplacer un objet en 3D](/manuals/images/editor/move_3d.png)
...
![Outil de rotation](/manuals/images/editor/icon_rotate.png)
...
![Faire pivoter un objet](/manuals/images/editor/rotate.png)![Faire pivoter un objet en 3D](/manuals/images/editor/rotate_3d.png)
...
![Outil de mise à l'échelle](/manuals/images/editor/icon_scale.png)
...
![Mettre un objet à l'échelle](/manuals/images/editor/scale.png)![Mettre un objet à l'échelle en 3D](/manuals/images/editor/scale_3d.png)
...
![Filtres de visibilité](/manuals/images/editor/visibilityfilters.png)
...
![Paramètres de la grille](/manuals/images/editor/grid_popup.png)
...
![Paramètres de la caméra en perspective](/manuals/images/editor/camera_popup.png)

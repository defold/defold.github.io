...
toc:
- anchor: the-mobile-development-app
  title: Lapplication de développement mobile
- anchor: installing-a-development-app
  title: Installer une application de développement
- anchor: installing-on-ios
  title: Installer sur iOS
- anchor: installing-on-android
  title: Installer sur Android
- anchor: launching-your-game
  title: Lancer votre jeu
- anchor: connecting-to-an-ios-device-using-usb-on-windows
  title: Se connecter à un appareil iOS par USB sous Windows
- anchor: connecting-to-an-ios-device-using-usb-on-linux
  title: Se connecter à un appareil iOS par USB sous Linux
- anchor: connecting-to-an-ios-device-using-usb-on-macos
  title: Se connecter à un appareil iOS par USB sous macOS
- anchor: connecting-to-an-android-device-using-usb-on-macos
  title: Se connecter à un appareil Android par USB sous macOS
- anchor: connecting-to-an-android-device-using-usb-on-windows-or-linux
  title: Se connecter à un appareil Android par USB sous Windows ou Linux
...
Toute application iOS ou Android dont le bundle est créé en mode Debug peut servir d'application de développement. C'est d'ailleurs la solution recommandée, car l'application de développement disposera des paramètres de projet appropriés et utilisera les mêmes [extensions natives](/fr/manuals/extensions/) que le projet sur lequel vous travaillez.
...
![bundle sans contenu](/manuals/images/dev-app/contentless-bundle.png)

### Installer sur iOS {#installing-on-ios}

Suivez les [instructions du manuel iOS](/fr/manuals/ios/#creating-an-ios-application-bundle) pour créer un bundle pour iOS. Veillez à sélectionner la variante Debug !

### Installer sur Android {#installing-on-android}

Suivez les [instructions du manuel Android](https://defold.com/fr/manuals/android/#creating-an-android-application-bundle) pour créer un bundle pour Android.
...
5. Pendant que le jeu s'exécute, vous pouvez utiliser le [rechargement à chaud](/fr/manuals/hot-reload/) comme d'habitude.

...
- anchor: collision-objects
  title: Objets de collision
- anchor: adding-a-collision-object-component
  title: Ajouter un composant objet de collision
- anchor: adding-a-collision-shape
  title: Ajouter une forme de collision
- anchor: collision-object-properties
  title: Propriétés des objets de collision
- anchor: runtime-properties
  title: Propriétés à lexécution
---
...
Collision Shape
: Une ressource tilemap ou `.convexshape`. Pour utiliser un maillage glTF ou GLB, ajoutez plutôt une forme Hull ou Mesh au composant et définissez les propriétés *Scene* et *Mesh* de cette forme. Consultez [Formes de collision pour plus d'informations](/fr/manuals/physics-shapes).

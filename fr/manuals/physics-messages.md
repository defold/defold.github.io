...
- anchor: collision-messages
  title: Messages de collision
- anchor: event-filtering
  title: Filtrage des événements
- anchor: collision-response
  title: Réponse à une collision
- anchor: contact-point-response
  title: Réponse à un point de contact
- anchor: trigger-response
  title: Réponse de déclencheur
---

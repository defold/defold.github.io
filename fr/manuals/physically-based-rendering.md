...
- anchor: physically-based-rendering-pbr
  title: Rendu basé sur la physique (PBR)
- anchor: material-properties-overview
  title: Aperçu des propriétés des matériaux
- anchor: shader-integration
  title: Intégration aux shaders
- anchor: example-shader
  title: Exemple de shader
- anchor: constants
  title: Constantes
- anchor: next-steps
...
![Constantes du matériau](/manuals/images/physically-based-rendering/material-constants.png)

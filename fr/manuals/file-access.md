...
- anchor: working-with-files
  title: Manipulation des fichiers
- anchor: functions-for-file-and-folder-access
  title: Fonctions daccès aux fichiers et aux dossiers
- anchor: file-and-folder-locations
  title: Emplacements des fichiers et des dossiers
- anchor: how-to-save-and-load-application-specific-files
  title: Comment enregistrer et charger des fichiers propres à lapplication
- anchor: how-to-access-files-bundled-with-the-application
  title: Comment accéder aux fichiers inclus dans le bundle de lapplication
- anchor: system-file-access
  title: Accès aux fichiers système
- anchor: extensions
  title: Extensions
---
...
Les extensions peuvent également fournir ces fichiers via `ext.properties`. Leurs chemins sont combinés aux ressources personnalisées du projet dans les builds de l'éditeur comme dans les archives de Bob. Consultez [Ressources personnalisées des extensions](/fr/manuals/extensions/#custom-resources).

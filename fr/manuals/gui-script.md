...
toc:
- anchor: gui-scripts
  title: Scripts dinterface graphique
- anchor: adding-a-script-to-a-gui
  title: Ajouter un script à une interface graphique
- anchor: the-gui-namespace
  title: Lespace de noms « gui »
- anchor: message-passing
  title: Échange de messages
- anchor: addressing-nodes
  title: Adressage des nœuds
- anchor: dynamically-created-nodes
  title: Nœuds créés dynamiquement
- anchor: dynamic-node-ids
  title: Identifiants des nœuds dynamiques
---
...
![échange de messages](/manuals/images/gui-script/message_passing.png)
...
![échange de messages](/manuals/images/gui-script/node_id.png)
...
![nœud dynamique](/manuals/images/gui-script/dynamic_nodes.png)

...
```
    /root
        ...
        /bundleres                       -- Resources that should be bundles for (see game.project and the [bundle_resources setting]([physics scale setting](/fr/manuals/project-settings/#project))
            /<platform>
        game.project

...
- anchor: creating-a-clipping-node
  title: Création dun nœud de découpage
- anchor: stencil-mask
  title: Masque de stencil
- anchor: stencil-limitations
  title: Limites du stencil
- anchor: layers
  title: Couches
---
...
![Création d'un découpage](/manuals/images/gui-clipping/create.png)
...
![Hiérarchie de découpage](/manuals/images/gui-clipping/setup.png)
...
![Masques de stencil](/manuals/images/gui-clipping/modes.png)
...
![Couches et découpage](/manuals/images/gui-clipping/layers.png)

...
La fin du build ne signifie pas que le jeu a terminé son chargement dans le navigateur. Attendez que le canevas et l'application soient prêts avant d'envoyer des entrées ou de vérifier le déroulement du jeu. Consultez [Tests dans un navigateur pour HTML5](/fr/manuals/automated-testing/#browser-tests-for-html5) pour plus de détails.

...
- anchor: how-to-use-old-docker-images
  title: Utiliser danciennes images Docker
---
...
3. Exécutez Extender en local comme décrit dans [Exécuter Extender en local avec des artefacts préconfigurés](/fr/manuals/extender-local-setup#how-to-run-local-extender-with-preconfigured-artifacts).
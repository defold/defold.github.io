...
- anchor: the-static-resource-tree
  title: Larborescence statique des ressources
- anchor: dynamically-loading-factory-resources
  title: Chargement dynamique des ressources des factories
- anchor: unloading-dynamically-loaded-resources
  title: Déchargement des ressources chargées dynamiquement
- anchor: excluding-resources-from-bundle
  title: Exclusion de ressources du bundle
---
...
- [Ressources personnalisées](/fr/manuals/project-settings/#custom-resources) déclarées dans *game.project*.

![Arborescence des ressources](/manuals/images/resource/resource_tree.png)

<div class='sidenote' markdown='1'>
Defold propose également le concept de [ressources du bundle](/fr/manuals/project-settings/#bundle-resources). Ces ressources sont incluses dans le bundle de l'application, mais ne font pas partie de l'arborescence des ressources. Elles peuvent aller de fichiers auxiliaires propres à une plateforme à des fichiers externes [chargés depuis le système de fichiers](/fr/manuals/file-access/#how-to-access-files-bundled-with-the-application) et utilisés par votre jeu (par exemple, des banques de sons FMOD).
</div>
...
![Chargement des ressources](/manuals/images/resource/loading.png)
...
![Chargement dynamique](/manuals/images/resource/load_dynamically.png)
...
Consultez le [manuel des factories](/fr/manuals/factory) et le [manuel des factories de collection](/fr/manuals/collection-factory) pour en savoir plus sur ce fonctionnement.

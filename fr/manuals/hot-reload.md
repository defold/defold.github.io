...
toc:
- anchor: hot-reloading-resources
  title: Rechargement à chaud des ressources
- anchor: how-to-hot-reload
  title: Comment recharger à chaud
- anchor: hot-reloading-on-device
  title: Rechargement à chaud sur un appareil
- anchor: reloading-scripts
  title: Rechargement des scripts
- anchor: reloading-lua-modules
  title: Rechargement des modules Lua
- anchor: the-on_reload-function
  title: La fonction on_reload()
- anchor: reloading-shader-code
  title: Rechargement du code des shaders
---
...
![Rechargement des ressources](/manuals/images/hot-reload/menu.png)

## Rechargement à chaud sur un appareil {#hot-reloading-on-device}

Le rechargement à chaud fonctionne aussi bien sur un appareil que sur un ordinateur. Pour l'utiliser sur un appareil, exécutez un build de débogage de votre jeu ou l'[application de développement](/fr/manuals/dev-app) sur votre appareil mobile, puis sélectionnez-le comme cible dans l'éditeur :

![Appareil cible](/manuals/images/hot-reload/target.png)
...
![Rechargement de l'interface graphique](/manuals/images/hot-reload/gui.png)
...
![Interface graphique rechargée](/manuals/images/hot-reload/gui-reloaded.png)
...
Modifier et recharger `my_module.lua` ne changera _pas_ le comportement de `user.script`. Consultez [le manuel sur les modules](/fr/manuals/modules) pour en savoir plus sur les raisons de ce comportement et sur la façon d'éviter ce piège.

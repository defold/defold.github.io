...
toc:
- anchor: importing-3d-models
  title: Importation de modèles 3D
- anchor: importing-to-defold
  title: Importation dans Defold
- anchor: using-a-model
  title: Utilisation dun modèle
- anchor: exporting-to-gltf
  title: Exportation au format glTF
- anchor: requirements
  title: Exigences
- anchor: exporting-a-texture
  title: Exportation dune texture
- anchor: exporting-using-blender
  title: Exportation avec Blender
---
...
![Modèle dans Blender](/manuals/images/model/blender_gltf.png)
...
![Ressources du modèle importées](/manuals/images/model/assets_gltf.png)
...
Une fois le modèle importé, utilisez-le dans un [composant Model](/fr/manuals/model) :
...
5. Définissez la propriété *Material* sur un matériau adapté au modèle. Les fichiers intégrés *model.material*, *model_instanced.material*, *model_skinned.material* et *model_skinned_instanced.material* constituent des points de départ utiles. Les matériaux de déformation par squelette utilisent l'espace local des sommets pour que la déformation puisse s'exécuter sur le GPU ; les matériaux personnalisés pour les modèles déformés par squelette sur le GPU ou rendus par instanciation doivent également utiliser l'espace local des sommets. Consultez le [manuel des modèles](/fr/manuals/model/#material) pour connaître les exigences concernant l'adaptateur graphique.
...
![Tout sélectionner](/manuals/images/model/blender_select_all_vertices.png)

Une fois tous les sommets sélectionnés, dépliez le maillage pour obtenir le dépliage UV :

![Déplier le maillage](/manuals/images/model/blender_unwrap_mesh.png)

Vous pouvez ensuite exporter le dépliage UV vers une image utilisable comme texture :

![Exporter le dépliage UV](/manuals/images/model/blender_export_uv_layout.png)

![Résultat de l'exportation du dépliage UV](/manuals/images/model/blender_export_uv_layout_result.png)
...
![Exportation avec Blender](/manuals/images/model/export_gltf.png)
...
![Exportation avec Blender](/manuals/images/model/export_settings.png)
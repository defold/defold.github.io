...
- anchor: creating-a-gui-component
  title: Création dun composant GUI
- anchor: gui-properties
  title: Propriétés de linterface graphique
...
- anchor: node-properties
  title: Propriétés des nœuds
- anchor: pivot-anchors-and-adjust-mode
  title: Pivot, ancrages et mode dajustement
- anchor: draw-order
  title: Ordre de dessin
- anchor: parent-child-hierarchies
  title: Hiérarchies parent-enfant
- anchor: layers-and-draw-calls
  title: Couches et appels de dessin
---
...
![Nouveau fichier GUI](/manuals/images/gui/new_gui_file.png)

Defold ouvre alors automatiquement le fichier dans l'éditeur de scène d'interface graphique.

![Nouvelle interface graphique](/manuals/images/gui/new_gui.png)
...
La zone d'édition centrale affiche l'interface graphique. La barre d'outils située dans le coin supérieur droit de cette zone contient les outils *Move*, *Rotate* et *Scale*, ainsi qu'un sélecteur de [mise en page](/fr/manuals/gui-layouts).

![Barre d'outils](/manuals/images/gui/toolbar.png)
...
![Obtention et définition d'une police](/manuals/images/gui/get_set_font.png)
...
![Obtention et définition d'un matériau](/manuals/images/gui/get_set_material.png)
...
![Obtention et définition d'une texture](/manuals/images/gui/get_set_texture.png)
...
![Dépendances](/manuals/images/gui/dependencies.png)
...
Nœud Box
: ![Nœud Box](/manuals/images/icons/gui-box-node.png)
  Nœud rectangulaire affichant une couleur unie, une texture ou une animation image par image. Consultez la [documentation du nœud Box](/fr/manuals/gui-box) pour plus de détails.

<div style="clear: both;"></div>

Nœud Text
: ![Nœud Text](/manuals/images/icons/gui-text-node.png)
  Affiche du texte. Consultez la [documentation du nœud Text](/fr/manuals/gui-text) pour plus de détails.

<div style="clear: both;"></div>

Nœud Pie
: ![Nœud Pie](/manuals/images/icons/gui-pie-node.png)
  Nœud circulaire ou elliptique qui peut être partiellement rempli ou inversé. Consultez la [documentation du nœud Pie](/fr/manuals/gui-pie) pour plus de détails.

<div style="clear: both;"></div>

Nœud Template
: ![Nœud Template](/manuals/images/icons/gui.png)
  Les modèles permettent de créer des instances à partir d'autres fichiers de scène d'interface graphique. Consultez la [documentation du nœud Template](/fr/manuals/gui-template) pour plus de détails.

<div style="clear: both;"></div>

Nœud ParticleFX
: ![Nœud ParticleFX](/manuals/images/icons/particlefx.png)
  Joue un effet de particules. Consultez la [documentation du nœud ParticleFX](/fr/manuals/gui-particlefx) pour plus de détails.
...
![Ajout de nœuds](/manuals/images/gui/add_node.png)
...
: Déterminent l'emplacement, l'orientation et l'étirement du nœud. Vous pouvez utiliser les outils *Move*, *Rotate* et *Scale* pour modifier ces valeurs. Vous pouvez animer ces valeurs par script ([en savoir plus](/fr/manuals/property-animation)).

Size (nœuds Box, Text et Pie)
: La taille du nœud est automatique par défaut, mais vous pouvez modifier sa valeur en réglant *Size Mode* sur `Manual`. La taille définit les limites du nœud et sert à détecter les entrées qui le ciblent. Vous pouvez animer cette valeur par script ([en savoir plus](/fr/manuals/property-animation)).
...
Slice 9 (nœuds Box)
: Définissez cette propriété pour préserver la taille en pixels des bords de la texture du nœud lors de son redimensionnement. Consultez la [documentation du nœud Box](/fr/manuals/gui-box) pour plus de détails.

Inner Radius (nœuds Pie)
: Le rayon intérieur du nœud, exprimé le long de l'axe X. Consultez la [documentation du nœud Pie](/fr/manuals/gui-pie) pour plus de détails.

Outer Bounds (nœuds Pie)
: Détermine le comportement des limites extérieures. Consultez la [documentation du nœud Pie](/fr/manuals/gui-pie) pour plus de détails.

Perimeter Vertices (nœuds Pie)
: Le nombre de segments utilisés pour construire la forme. Consultez la [documentation du nœud Pie](/fr/manuals/gui-pie) pour plus de détails.

Pie Fill Angle (nœuds Pie)
: La portion du secteur à remplir. Consultez la [documentation du nœud Pie](/fr/manuals/gui-pie) pour plus de détails.

Template (nœuds Template)
: Le fichier de scène d'interface graphique à utiliser comme modèle pour le nœud. Consultez la [documentation du nœud Template](/fr/manuals/gui-template) pour plus de détails.

ParticleFX (nœuds ParticleFX)
: L'effet de particules à utiliser sur ce nœud. Consultez la [documentation du nœud ParticleFX](/fr/manuals/gui-particlefx) pour plus de détails.

Color
: La couleur du nœud. Si le nœud possède une texture, cette couleur teinte la texture. Vous pouvez animer la couleur par script ([en savoir plus](/fr/manuals/property-animation)).

Alpha
: La translucidité du nœud. Vous pouvez animer la valeur alpha par script ([en savoir plus](/fr/manuals/property-animation)).
...
: Définit le point de pivot du nœud. Vous pouvez le considérer comme le « point central » du nœud. Toute rotation, mise à l'échelle ou modification de taille s'effectue autour de ce point.
  ...
  ![Point de pivot](/manuals/images/gui/pivot.png)
...
: L'ancrage détermine comment la position verticale et horizontale du nœud est modifiée lorsque les limites de la scène ou du nœud parent sont étirées pour s'adapter à la taille physique de l'écran.
  ...
  ![Ancrage sans ajustement](/manuals/images/gui/anchoring_unadjusted.png)
  ...
  ![Ancrage](/manuals/images/gui/anchoring.png)
...
: Définit le mode d'ajustement du nœud. Ce réglage détermine ce qui arrive au nœud lorsque les limites de la scène ou du nœud parent sont ajustées pour s'adapter à la taille physique de l'écran.
  ...
  ![Sans ajustement](/manuals/images/gui/unadjusted.png)
  ...
  ![Modes d'ajustement](/manuals/images/gui/adjusted.png)
...
: Définit le mode de découpage du nœud :
  ...
  Consultez le [manuel du découpage de l'interface graphique](/fr/manuals/gui-clipping) pour plus de détails.

Clipping Visible (nœuds Box et Pie)
: Activez cette option pour rendre le contenu du nœud dans la zone du stencil. Consultez le [manuel du découpage de l'interface graphique](/fr/manuals/gui-clipping) pour plus de détails.

Clipping Inverted (nœuds Box et Pie)
: Inverse le masque de stencil. Consultez le [manuel du découpage de l'interface graphique](/fr/manuals/gui-clipping) pour plus de détails.
...
![Ordre de dessin](/manuals/images/gui/draw_order.png)
...
![Parent et enfant](/manuals/images/gui/parent_child.png)
...
![Hiérarchie interrompant le rendu par lots](/manuals/images/gui/break_batch.png)
...
![Couches](/manuals/images/gui/layers.png)

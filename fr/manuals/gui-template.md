...
- anchor: gui-template-nodes
  title: Nœuds de modèle dinterface graphique
- anchor: creating-a-template
  title: Création dun modèle
- anchor: creating-instances-from-a-template
  title: Création dinstances à partir dun modèle
- anchor: modifying-templates-in-runtime
  title: Modification des modèles à lexécution
---
...
![Création d'un modèle](/manuals/images/gui-templates/create.png)
...
![Création d'une instance](/manuals/images/gui-templates/create_instance.png)
...
![Propriétés](/manuals/images/gui-templates/properties.png)

Tout nœud dont certaines propriétés ont été remplacées apparaît également en bleu dans la vue *Outline* :

![Vue d'ensemble](/manuals/images/gui-templates/outline.png)

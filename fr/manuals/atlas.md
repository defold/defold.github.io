...
- anchor: creating-an-atlas
  title: Création dun atlas
- anchor: atlas-properties
  title: Propriétés de latlas
- anchor: image-properties
  title: Propriétés des images
- anchor: animation-properties
  title: Propriétés des animations
- anchor: runtime-texture-and-atlas-creation
  title: Création de textures et datlas à lexécution
- anchor: creating-a-texture-resource-at-runtime
  title: Création dune ressource texture à lexécution
- anchor: creating-an-atlas-at-runtime
  title: Création dun atlas à lexécution
---
...
: Glissez-déposez des images du panneau *Asset* vers la vue de l'éditeur.
  ...
  ![Création d'un atlas, ajout d'images](/manuals/images/atlas/add.png)
  ...
  ![Images ajoutées](/manuals/images/atlas/single_images.png)
...
: Faites un <kbd>clic droit</kbd> sur l'entrée racine Atlas dans le panneau *Outline*.
  ...
  ![Création d'un atlas, ajout d'images](/manuals/images/atlas/add_animation.png)
  ...
  ![Groupe d'animation](/manuals/images/atlas/animation_group.png)
...
![Atlas à plusieurs pages](/manuals/images/atlas/multipage_atlas.png)
...
![Propriétés de l'atlas](/manuals/images/atlas/atlas_properties.png)
...
![Propriétés des images](/manuals/images/atlas/image_properties.png)
...
La texture peut être utilisée directement sur un [composant modèle](/fr/manuals/model/) à l'aide de `go.set()` :
...
Si la texture doit être utilisée sur un [composant sprite](/fr/manuals/sprite/), elle doit d'abord être utilisée par un atlas. Utilisez [`resource.create_atlas(path, params)`](https://defold.com/ref/stable/resource/#resource.create_atlas:path-table) pour créer un atlas :

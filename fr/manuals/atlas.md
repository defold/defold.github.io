...
Si la texture doit être utilisée sur un [composant sprite](/fr/manuals/sprite/), elle doit d'abord être utilisée par un atlas. Utilisez [`resource.create_atlas(path, params)`](https://defold.com/ref/resource/#resource.create_atlas:path-table) pour créer un atlas :

...
Defold utilise Lua 5.1 et LuaJIT (selon la plateforme cible), et vous devez respecter les spécifications du langage pour ces versions précises de Lua lorsque vous écrivez la logique de votre jeu. Pour plus de détails sur l'utilisation de Lua dans Defold, consultez notre [manuel Lua dans Defold](/fr/manuals/lua).

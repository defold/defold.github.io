...
- anchor: render-pipeline-what-when-and-where
  title: 'Pipeline de rendu : quoi, quand et où ?'
- anchor: the-default-render
  title: Le rendu par défaut
- anchor: render-predicates
  title: Prédicats de rendu
- anchor: default-view-projection
  title: Projection de vue par défaut
- anchor: stretch-projection
  title: Projection étirée
- anchor: fixed-fit-projection
  title: Projection à ajustement fixe
- anchor: fixed-projection
  title: Projection fixe
- anchor: camera-projection
  title: Projection de caméra
- anchor: frustum-culling
  title: Élimination hors du volume de visibilité
- anchor: coordinate-systems
  title: Systèmes de coordonnées
- anchor: the-render-script
  title: Le script de rendu
- anchor: render-resources
  title: Ressources de rendu
- anchor: multisampled-render-targets
  title: Cibles de rendu multi-échantillonnées
- anchor: texture-handles
  title: Identifiants de texture
- anchor: supported-graphics-apis
  title: API graphiques prises en charge
- anchor: system-messages
  title: Messages système
- anchor: draw-calls-and-batching
  title: Appels de dessin et regroupement par lots
- anchor: batch-rules-for-non-gui-components
  title: Règles de regroupement pour les composants autres que GUI
- anchor: batch-rules-for-gui-components
  title: Règles de regroupement pour les composants GUI
---
...
![Rendu intégré](/manuals/images/render/builtin.png)
...
Vous trouverez une description détaillée du fonctionnement des matériaux dans la [documentation sur les matériaux](/fr/manuals/material).
...
![Projection étirée](/manuals/images/render/stretch_projection.png)

*Projection étirée avec la taille de fenêtre d'origine*

![Projection étirée après redimensionnement](/manuals/images/render/stretch_projection_resized.png)
...
![Projection à ajustement fixe](/manuals/images/render/fixed_fit_projection.png)

*Projection à ajustement fixe avec la taille de fenêtre d'origine*

![Projection à ajustement fixe après redimensionnement](/manuals/images/render/fixed_fit_projection_resized.png)

*Projection à ajustement fixe avec la fenêtre étirée horizontalement*

![Projection à ajustement fixe après réduction](/manuals/images/render/fixed_fit_projection_resized_smaller.png)
...
![Projection fixe](/manuals/images/render/fixed_projection_zoom_2_0.png)

*Projection fixe avec un zoom réglé sur 2*

![Projection fixe](/manuals/images/render/fixed_projection_zoom_0_5.png)

*Projection fixe avec un zoom réglé sur 0.5*

![Projection fixe](/manuals/images/render/fixed_projection_zoom_2_0_resized.png)
...
Lorsque vous utilisez le script de rendu par défaut et que des [composants caméra](/fr/manuals/camera) sont activés dans le projet, ils ont priorité sur toute autre vue ou projection définie dans le script de rendu. Pour en savoir plus sur l'utilisation des composants caméra dans les scripts de rendu, consultez la [documentation sur les caméras](/fr/manuals/camera).
...
1 = La boîte englobante du composant Mesh doit être définie par le développeur. [En savoir plus](/fr/manuals/mesh/#frustum-culling).
...
![Ressources de rendu](/manuals/images/render/render_resources.png)
...
Les cibles de rendu prennent en charge l'anticrénelage multi-échantillons (MSAA). Il lisse les bords de la géométrie lors d'une passe de rendu hors écran. Le nombre d'échantillons de la cible est indépendant de [Display ▸ Samples](/fr/manuals/project-settings/#samples), qui contrôle l'anticrénelage de la fenêtre.

...
- anchor: game-object-paths
  title: Chemins des objets de jeu
- anchor: absolute-addressing
  title: Adressage absolu
- anchor: hashed-identifiers
  title: Identifiants hachés
- anchor: urls
  title: URL
- anchor: constructing-url-objects
  title: Construction dobjets URL
---
...
![Objet bean dans l'éditeur](/manuals/images/addressing/bean_editor.png)
...
![Objet bean](/manuals/images/addressing/bean.png)
...
![Objet bean](/manuals/images/addressing/bean_shield_editor.png)
...
![Objet bean](/manuals/images/addressing/bean_shield.png)
...
![Objet bean](/manuals/images/addressing/name_collision.png)
</div>
...
![Objet bean](/manuals/images/addressing/bean_buddy.png)
...
![Objet bean](/manuals/images/addressing/team_editor.png)
...
![Objet bean](/manuals/images/addressing/collection_team.png)
...
![Objet bean](/manuals/images/addressing/teams_editor.png)
...
![Identifiant relatif](/manuals/images/addressing/relative_same.png)
...
![Objet gestionnaire](/manuals/images/addressing/manager_editor.png)
...
![Équipes et gestionnaire](/manuals/images/addressing/teams_manager.png)

![Adressage absolu](/manuals/images/addressing/absolute.png)
...
socket
: Identifie le monde de jeu de la cible. Cela est important lorsque vous travaillez avec des [proxys de collection (collection proxies)](/fr/manuals/collection-proxy) et sert alors à identifier la _collection chargée dynamiquement_.

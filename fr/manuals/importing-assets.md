...
toc:
- anchor: importing-and-editing-assets
  title: Importation et modification des ressources
- anchor: importing-assets
  title: Importation des ressources
- anchor: using-assets
  title: Utilisation des ressources
- anchor: editing-external-assets
  title: Modification des ressources externes
- anchor: editing-defold-assets
  title: Modification des ressources Defold
---
...
* Les images peuvent servir à créer de nombreux types de composants visuels fréquemment utilisés dans les jeux 2D. Pour en savoir plus, consultez [les instructions d'importation et d'utilisation des éléments graphiques 2D](/fr/manuals/importing-graphics).
* Les sons peuvent être utilisés par le [composant Sound](/fr/manuals/sound) pour lire des sons.
* Les polices sont utilisées par le [composant Label](/fr/manuals/label) et par les [nœuds de texte](/fr/manuals/gui-text) dans une interface graphique.
* Les modèles glTF (*.gltf* et *.glb*) peuvent être utilisés par le [composant Model](/fr/manuals/model) pour afficher des modèles 3D avec des animations. Importez toutes les images de texture utilisées par le modèle en tant que ressources distinctes et affectez-les aux propriétés de texture du matériau du composant Model. Pour en savoir plus, consultez [les instructions d'importation et d'utilisation des modèles 3D](/fr/manuals/importing-models).

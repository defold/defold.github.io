...
- anchor: lua-in-defold
  title: Lua dans Defold
- anchor: lua-versions
  title: Versions de Lua
- anchor: standard-libraries-and-extensions
  title: Bibliothèques standard et extensions
- anchor: lua-books-and-resources
  title: Livres et ressources sur Lua
...
![Contextes](/manuals/images/lua/lua_contexts.png)
...
: Tout comme vous pouvez regrouper du code de script dans un module Lua, vous pouvez le regrouper dans un objet de jeu doté d'un composant script. La différence est que, si vous le placez dans un objet de jeu, vous pouvez communiquer avec lui uniquement par échange de messages.
  ...
  ![Objet auxiliaire](/manuals/images/lua/lua_helper.png)

...
- anchor: gui-text-nodes
  title: Nœuds de texte dinterface graphique
- anchor: adding-text-nodes
  title: Ajout de nœuds de texte
- anchor: alignment
  title: Alignement
- anchor: modifying-text-nodes-in-runtime
  title: Modification des nœuds de texte à lexécution
---
...
![Polices](/manuals/images/gui-text/fonts.png)
...
![Alignement du texte](/manuals/images/gui-text/align.png)

...
- anchor: editor-preferences
  title: Préférences de léditeur
- anchor: general
  title: Général
- anchor: code
  title: Code
- anchor: open-script-files-in-visual-studio-code
  title: Ouvrir les fichiers de script dans Visual Studio Code
- anchor: extensions
  title: Extensions
- anchor: tools
  title: Outils
...
: Active la [compression des textures](/fr/manuals/texture-profiles) pour tous les builds créés depuis l'éditeur.
...
Lint Code on Build
: Active l'[analyse statique du code](/fr/manuals/writing-code/#linting-configuration) lors du build du projet. Cette option est activée par défaut, mais vous pouvez la désactiver si l'analyse d'un projet volumineux prend trop de temps.
...
Format on save
: Exécute l'outil de formatage du serveur de langage sur les fichiers de code ouverts modifiés lors de l'enregistrement. Désactivé par défaut. Le serveur de langage doit prendre en charge le formatage ; consultez [Formatage du code](/fr/manuals/writing-code/#formatting-code) pour formater manuellement un document ou une sélection.

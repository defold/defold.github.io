...
- anchor: sound
  title: Le son
- anchor: creating-a-sound-component
  title: Création dun composant audio
- anchor: playing-the-sound
  title: Lecture du son
- anchor: stopping-the-sound
  title: Arrêt du son
- anchor: gain
  title: Gain
- anchor: sound-groups
  title: Groupes de sons
- anchor: gating-sounds
  title: Filtrage des déclenchements sonores
- anchor: runtime-manipulation
  title: Manipulation à lexécution
- anchor: project-configuration
  title: Configuration du projet
- anchor: sound-streaming
  title: Lecture des sons en streaming
---
...
![Sélection du composant](/manuals/images/sound/sound_add_component.jpg)

Le composant créé possède un ensemble de propriétés à configurer :

![Sélection du composant](/manuals/images/sound/sound_properties.png)

*Sound*
: Doit désigner un fichier audio de votre projet. Le fichier doit être au format _Wave_, _Ogg Vorbis_ ou _Ogg Opus_. Defold prend en charge les fichiers Wave PCM 8 bits et 16 bits. La lecture Ogg Opus est facultative et nécessite **Include Sound Decoder: Opus** dans le [manifeste de l'application](/fr/manuals/app-manifest/#sound) ; le décodeur Opus n'est pas inclus par défaut.
...
Lorsque **Use Linear Gain** est activé dans les [paramètres audio du projet](/fr/manuals/project-settings/#sound) (par défaut), le gain de sortie est le produit de ces quatre gains. Un gain de `1.0` est un gain unitaire (0 dB). Lorsque le gain linéaire est désactivé, Defold applique une courbe non linéaire lors du mixage ; la multiplication directe des quatre gains et la conversion en décibels ci-dessous ne décrivent donc pas le niveau de sortie obtenu.
...
![Table de mixage des groupes de sons](/manuals/images/sound/sound_mixer.png)
...
![Déphasage](/manuals/images/sound/sound_phase_shift.png)
...
Le fichier *game.project* comporte quelques [paramètres du projet](/fr/manuals/project-settings#sound) relatifs aux composants audio.

## Lecture des sons en streaming {#sound-streaming}

Il est également possible de prendre en charge la [lecture des sons en streaming](/fr/manuals/sound-streaming)
...
toc:
- anchor: key-triggers
  title: Déclencheurs de touches
- anchor: text-triggers
  title: Déclencheurs de texte
- anchor: text
  title: Texte
- anchor: marked-text
  title: Texte marqué
...
Il est recommandé de vous familiariser avec le fonctionnement général des entrées dans Defold, la manière de les recevoir et l'ordre dans lequel vos fichiers script les reçoivent. Pour en savoir plus sur le système d'entrée, consultez le [manuel de présentation des entrées](/fr/manuals/input).
</div>
...
![Saisie de texte marqué](/manuals/images/input/marked_text.png)

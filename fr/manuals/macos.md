...
La configuration de l'application propre à macOS s'effectue dans la [section macOS](/fr/manuals/project-settings/#macos) du fichier de paramètres *game.project*.

...
- anchor: preinitialization
  title: Préinitialisation
- anchor: collection-init
  title: Initialisation de la collection
- anchor: post-update-in-initialization
  title: Après la mise à jour durant l’initialisation
- anchor: update-loop
  title: Boucle de mise à jour
- anchor: input-phase
  title: Phase des entrées
- anchor: update-phase
  title: Phase de mise à jour
- anchor: render-update-phase
  title: Phase de mise à jour du rendu
- anchor: post-update-phase
  title: Phase après la mise à jour
- anchor: render-phase
  title: Phase de rendu
- anchor: finalization
  title: Finalisation
- anchor: dispatching-messages
  title: Distribution des messages
---
...
![Vue d’ensemble du cycle de vie](/manuals/images/application_lifecycle/application_lifecycle.png)
...
![Initialisation](/manuals/images/application_lifecycle/initialization.png)
...
![Préinitialisation](/manuals/images/application_lifecycle/pre_init.png)
...
![Initialisation de la collection](/manuals/images/application_lifecycle/collection_init.png)
...
![Après la mise à jour](/manuals/images/application_lifecycle/post_init.png)
...
![Boucle de mise à jour](/manuals/images/application_lifecycle/update_loop.png)
...
![Phase de mise à jour](/manuals/images/application_lifecycle/update_phase.png)
...
Si un [pas de temps fixe](/fr/manuals/physics/#physics-updates) est utilisé pour la simulation physique, la fonction `fixed_update()` peut également être appelée dans tous les composants script. Cette fonction est utile dans les jeux fondés sur la physique lorsque vous souhaitez manipuler les objets physiques à intervalles réguliers pour obtenir une simulation physique stable.
...
![Phase de mise à jour du rendu](/manuals/images/application_lifecycle/render_update_phase.png)
...
![Phase après la mise à jour](/manuals/images/application_lifecycle/post_update_phase.png)
...
![Phase de rendu](/manuals/images/application_lifecycle/render_phase.png)

Les éléments graphiques sont ensuite rendus, ainsi que le profileur visuel le cas échéant (voir la [documentation sur le débogage](/fr/manuals/debugging)). Après le rendu graphique, une capture vidéo est effectuée.
...
(Consultez le [manuel des proxies de collection](/fr/manuals/collection-proxy) et [`set_time_step`](/ref/collectionproxy#set-time-step) pour plus de détails)
...
![Finalisation](/manuals/images/application_lifecycle/finalization.png)
...
![Distribution des messages](/manuals/images/application_lifecycle/dispatch_messages.png)
...
Comme le code `on_message()` de tout composant destinataire peut envoyer des messages supplémentaires, le répartiteur de messages continue à distribuer récursivement les messages envoyés jusqu’à ce que la file d’attente soit vide. Le nombre de parcours de la file d’attente effectués par le répartiteur est toutefois limité. Consultez les [chaînes de messages](/fr/manuals/message-passing) pour plus de détails.
...
- anchor: script-properties
  title: Propriétés de script
- anchor: defining-a-script-property
  title: Définir une propriété de script
- anchor: text-properties
  title: Propriétés textuelles
- anchor: accessing-script-properties
  title: Accéder aux propriétés de script
- anchor: factory-created-objects
  title: Objets créés par une factory
- anchor: resource-properties
  title: Propriétés de ressources
---
...
![Composant avec des propriétés](/manuals/images/script-properties/component.png)
...
![Propriétés](/manuals/images/script-properties/properties.png)
...
![Propriétés de ressources](/manuals/images/script-properties/resource-properties.png)

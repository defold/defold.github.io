...
![Nouveau projet](/tutorials/images/new_empty.png)
...
Commencez par créer un [nouveau projet](/fr/manuals/project-setup/) et ouvrez-le dans l'éditeur. Double-cliquez sur le fichier *main/main.collection* pour l'ouvrir :
...
![Compilation](/tutorials/images/car/start_build_and_launch.png)
...
![Fichier avec des modifications non enregistrées](/tutorials/images/car/file_changed.png)
</div>
...
![Nouveau fichier de collection](/tutorials/images/car/start_new_collection.png)
...
![Ajouter l'objet de jeu de la voiture](/tutorials/images/car/start_add_car_gameobject.png)
...
![Ajouter un composant à la voiture](/tutorials/images/car/start_add_car_component.png)
...
![Image de la voiture](/tutorials/images/car/start_car.png)
![Image du pneu](/tutorials/images/car/start_tire.png)

Ajoutez ces images à l'atlas :

![Atlas des sprites](/tutorials/images/car/start_sprites_atlas.png)

![Propriétés du sprite](/tutorials/images/car/start_sprite_properties.png)
...
![Collection de la voiture terminée](/tutorials/images/car/start_car_collection_complete.png)
...
<div class='sidenote' markdown='1'>
Defold fournit plusieurs fonctions de cycle de vie pour programmer la logique du jeu. Vous trouverez plus d'informations à leur sujet dans le [manuel des scripts](/fr/manuals/script).
</div>
...
![Liaisons d'entrée](/tutorials/images/car/start_input_bindings.png)
...
![Ajouter la collection de la voiture](/tutorials/images/car/start_adding_car_collection.png)
...
3. Ajoutez des sons à votre voiture et faites-la vrombir ! ([Indice](/fr/manuals/sound/))

...
![Intégration approchée de la vitesse](/tutorials/images/platformer/integration.png)
...
![Équation de la vitesse](/tutorials/images/platformer/equationofvelocity.png)
...
![Équation du déplacement](/tutorials/images/platformer/equationoftranslation.png)
...
Si vous ne savez pas bien comment gérer les entrées dans Defold, vous trouverez un guide à ce sujet [ici](/fr/manuals/input).
...
![Normales de contact agissant sur le personnage du joueur](/tutorials/images/platformer/collision.png)
...
![L'éditeur Defold avec la géométrie du niveau et le personnage placés dans le monde](/tutorials/images/platformer/editor.png)
...
![Plusieurs polygones de tuiles assemblés en un seul](/tutorials/images/platformer/stitching.png)
...
Consultez nos guides sur la [physique](/fr/manuals/physics) et les [tuiles](/fr/manuals/2dgraphics) pour en savoir plus.

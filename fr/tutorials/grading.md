...
Nous supposons que vous savez utiliser l'éditeur Defold et que vous avez une compréhension de base des shaders GL et du pipeline de rendu de Defold. Si vous avez besoin d'approfondir ces sujets, consultez [notre manuel sur les shaders](/fr/manuals/shader/) et le [manuel sur le rendu](/fr/manuals/render/).
...
Vous pouvez remplacer le programme de shader d'un composant par un autre qui modifie les données des pixels ou crée des couleurs de pixels entièrement nouvelles par programmation. Le [tutoriel Shadertoy](/fr/tutorials/shadertoy) vous apprend à le faire.
...
![Cible de rendu](/tutorials/images/grading/render_target.png)
...
7. Ouvrez *`main.collection`*, sélectionnez le composant modèle de l'objet de jeu « `grade` » et définissez sa propriété *Material* sur « `/main/grade.material` ».
   ...
   ![Propriétés du modèle](/tutorials/images/grading/model_properties.png)
...
![Jeu désaturé](/tutorials/images/grading/desaturated_game.png)
...
![Cube de couleurs](/tutorials/images/grading/color_cube.png)
...
![Étalonnage de la cible de rendu](/tutorials/images/grading/render_target_grading.png)
...
![Texture de correspondance](/tutorials/images/grading/lut.png)
...
![Table de correspondance](/tutorials/images/grading/lut_lookup.png)
...
![Filtrage de la table de correspondance](/tutorials/images/grading/lut_filtering.png)
...
3. Définissez la propriété *`Filter min`* sur `FILTER_MODE_MIN_LINEAR` et la propriété *`Filter mag`* sur `FILTER_MODE_MAG_LINEAR`.
    ...
    ![Échantillonneur de la table de correspondance](/tutorials/images/grading/material_lut_sampler.png)

4. Téléchargez la texture de table de correspondance suivante (*`lut16.png`*) et ajoutez-la à votre projet.

    ![Table de correspondance de 16 couleurs](/tutorials/images/grading/lut16.png)

5. Ouvrez *`main.collection`* et définissez la propriété de texture *`lut`* sur la texture de correspondance téléchargée.

    ![Table de correspondance du modèle de quadrilatère](/tutorials/images/grading/quad_lut.png)
...
![Aspect d'origine du monde](/tutorials/images/grading/world_original.png)
...
![Bandes dans le dégradé bleu](/tutorials/images/grading/blue_banding.png)
...
![Dégradé bleu sans bandes](/tutorials/images/grading/blue_no_banding.png)
...
![Monde dans Affinity](/tutorials/images/grading/world_graded_affinity.png)
...
![Monde étalonné](/tutorials/images/grading/world_graded.png)

...
Dans cet exemple de projet, que vous pouvez [ouvrir depuis l'éditeur](/fr/manuals/project-setup/) ou [télécharger depuis GitHub](https://github.com/defold/sample-rpgmap), nous présentons une méthode pour créer de très grandes cartes de RPG dans Defold. La conception repose sur les hypothèses suivantes :
...
![](/tutorials/images/rpgmap/main_collection.png)
...
![](/tutorials/images/rpgmap/change_screen.png)
...
![](/tutorials/images/rpgmap/screens.png)
...
![](/tutorials/images/rpgmap/screen_collection.png)
...
![](/tutorials/images/rpgmap/bees.png)
...
![](/tutorials/images/rpgmap/test_layout.png)
...
![](/tutorials/images/rpgmap/side_by_side.png)

...
![Miniature](/tutorials/images/snake/thumbnail.png)
...
Ce tutoriel s'adresse aux débutants, mais si vous découvrez à la fois Defold et le développement de jeux, nous vous recommandons de commencer par quelques manuels d'introduction, notamment ceux consacrés aux [éléments fondamentaux de Defold](/fr/manuals/building-blocks/) et au [glossaire](/fr/manuals/glossary/). Si vous n'avez pas encore téléchargé Defold, consultez le [manuel d'installation](/fr/manuals/install/). Nous vous recommandons également de consulter la [présentation de l'éditeur](/fr/manuals/editor/) pour prendre rapidement en main l'éditeur lui-même, mais nous fournissons aussi ici des captures d'écran pour chaque étape.
...
![Démarrage](/tutorials/images/snake/1.png)
...
![Nouveau dossier](/tutorials/images/snake/3.png)
...
![Sprites de Snake](/tutorials/images/snake/snake.png)
...
![Nouveau dossier](/tutorials/images/snake/4.png)

Vous pouvez également en savoir plus sur [l'importation de ressources ici](/fr/manuals/importing-graphics/).

<input type="checkbox"/> Terminé !

## Ajout d'une source de tuiles {#adding-a-tile-source}

Defold fournit un composant (component) [tilemap](/fr/manuals/tilemap/) intégré que vous utiliserez pour créer le terrain de jeu, constitué de *tuiles* alignées sur une grille. Une tilemap permet de définir et de lire chaque tuile individuellement, ce qui convient parfaitement à ce jeu. Comme les tilemaps tirent leurs graphismes d'une [source de tuiles](/fr/manuals/tilesource/), vous devez en créer une :
...
![Nouvelle source de tuiles](/tutorials/images/snake/5.png)
...
![Source de tuiles](/tutorials/images/snake/6.png)
...
![Propriétés de la source de tuiles](/tutorials/images/snake/7.png)
...
![Ajout d'une tilemap](/tutorials/images/snake/8.png)
...
![Définition de la source de tuiles](/tutorials/images/snake/9.png)
...
![Tilemap terminée](/tutorials/images/snake/11.png)
...
![Ajout d'un objet de jeu](/tutorials/images/snake/12.png)
...
![Ajout d'un composant](/tutorials/images/snake/13.png)
...
![Exécution du jeu](/tutorials/images/snake/14.png)
...
![Ajout d'un script](/tutorials/images/snake/15.png)
...
![Collection principale](/tutorials/images/snake/16.png)
...
![Algorithme](/tutorials/images/snake/17.png)
...
![Exécution du jeu](/tutorials/images/snake/snake_run_1.png)
...
![Entrées](/tutorials/images/snake/18.png)

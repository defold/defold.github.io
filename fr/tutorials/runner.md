...
Si vous avez besoin d'une introduction à la programmation Lua, consultez notre [manuel sur Lua dans Defold](/fr/manuals/lua).
...
{% include shared/fr/install.md %}

Une fois l'éditeur installé et lancé, il est temps de créer un projet et de le préparer. Créez un [nouveau projet](/fr/manuals/project-setup/#creating-a-new-project) à partir du modèle "Empty Project".
...
![Vue d'ensemble de l'éditeur](/tutorials/images/runner/1/editor2_overview.png)
...
![Compilation](/tutorials/images/runner/1/build_and_launch.png)
...
![Fichier contenant des modifications non enregistrées](/tutorials/images/runner/1/file_changed.png)
</div>
...
![Clic droit et copie du lien vers la version](/tutorials/images/runner/extension-spine-releases.png)

Ajoutez le lien vers cette version à votre liste de [dépendances de game.project](/fr/manuals/libraries/#setting-up-library-dependencies). Une fois l'extension Spine ajoutée, vous devez également redémarrer l'éditeur pour activer l'intégration à l'éditeur incluse dans l'extension Spine.
...
2. Créez un fichier *Atlas* pour contenir les textures du sol (faites un clic droit sur un dossier adapté, par exemple le dossier *main*, dans le panneau *Assets pane* et sélectionnez <kbd>New ▸ Atlas File</kbd>). Nommez le fichier d'atlas *level.atlas*.
  ...
  <div class='sidenote' markdown='1'>
  Un *atlas* est un fichier qui réunit plusieurs images distinctes dans un seul fichier image plus grand. Cela permet d'économiser de l'espace et d'améliorer les performances. Pour en savoir plus sur les atlas et les autres fonctionnalités graphiques 2D, consultez la [documentation sur les graphismes 2D](/fr/manuals/2dgraphics).
  </div>
...
3. Ajoutez les images du sol au nouvel atlas en faisant un clic droit sur sa racine dans *Outline*, puis en sélectionnant <kbd>Add Images</kbd>. Sélectionnez les images importées et cliquez sur *OK*. Chaque image de l'atlas est désormais accessible sous forme d'animation à une seule image (image fixe), utilisable dans les sprites, les effets de particules et d'autres éléments visuels. Enregistrez le fichier.
  ...
  ![Création d'un atlas](/tutorials/images/runner/1/new_atlas.png)

  ![Ajout d'images à l'atlas](/tutorials/images/runner/1/add_images_to_atlas.png)
...
5. Dans chaque objet, ajoutez un composant sprite (faites un clic droit sur l'objet de jeu dans la vue *Outline* et sélectionnez <kbd>Add Component</kbd>, puis sélectionnez *Sprite* et cliquez sur *OK*), définissez la propriété *Image* du composant sprite sur l'atlas que vous venez de créer et choisissez l'une des deux images du sol comme animation par défaut du sprite. Définissez la position X du _composant sprite_ (et non de l'objet de jeu) sur 190 et sa position Y sur 40. Comme l'image mesure 380 pixels de large et que nous la décalons horizontalement de la moitié de cette distance, le pivot de l'objet de jeu se trouve sur le bord gauche de l'image du sprite.
  ...
  ![Création de la collection du sol](/tutorials/images/runner/1/ground_collection.png)
...
6. Les graphismes que nous utilisons sont un peu trop grands : réduisez donc chaque objet de jeu à 60 % (échelle de 0.6 en X et en Y, ce qui donne des portions de sol de 228 pixels de large).
  ...
  ![Mise à l'échelle du sol](/tutorials/images/runner/1/scale_ground.png)
...
9. Lancez le jeu (<kbd>Project ▸ Build</kbd>) pour vérifier que tout est en place.
  ...
  ![Sol immobile](/tutorials/images/runner/1/still_ground.png)
...
Pour le moment, ces descriptions devraient suffire. Vous trouverez toutefois une présentation bien plus complète dans le [manuel des éléments de base](/fr/manuals/building-blocks). Il est conseillé de consulter ce manuel plus tard pour mieux comprendre le fonctionnement de Defold.
...
Defold ajoute un ensemble d'API à Lua, ainsi qu'un système d'_échange de messages_ qui vous permet de programmer les communications entre objets de jeu. Consultez le [manuel sur l'échange de messages](/fr/manuals/message-passing) pour en savoir plus sur son fonctionnement.
</div>
...
![Contrôleur du sol](/tutorials/images/runner/1/ground_controller.png)
...
![Atlas du héros](/tutorials/images/runner/2/hero_atlas.png)
...
![Scène Spine du héros](/tutorials/images/runner/2/hero_spinescene.png)

<div class='sidenote' markdown='1'>
Le fichier *hero.spinejson* a été exporté au format Spine JSON. Vous aurez besoin du logiciel d'animation Spine pour créer de tels fichiers. Si vous souhaitez utiliser un autre logiciel d'animation, vous pouvez exporter vos animations sous forme de feuilles de sprites et les utiliser comme animations image par image à partir de ressources *Tile Source* ou *Atlas*. Consultez le manuel sur l'[animation](/fr/manuals/animation) pour en savoir plus.
</div>
...
![Propriétés du modèle Spine](/tutorials/images/runner/2/spinemodel_properties.png)
...
![Objet de jeu du héros](/tutorials/images/runner/2/hero_game_object.png)
...
Cela nécessite toutefois un peu de calcul vectoriel pour gérer correctement les collisions. Vous trouverez une explication détaillée de la résolution des collisions cinématiques dans la [documentation sur la physique](/fr/manuals/physics-resolving-collisions/).
</div>
...
![Liaisons d'entrée](/tutorials/images/runner/2/input_bindings.png)
...
![Propriété de script](/tutorials/images/runner/2/script_property.png)
...
![Ajout du code du sol](/tutorials/images/runner/insert_ground_code.png)
...
![Collision du sol](/tutorials/images/runner/2/ground_collision.png)
...
![Plateforme](/tutorials/images/runner/2/platform_long.png)
...
![Exécution du jeu](/tutorials/images/runner/2/run_game.png)
...
![Insertion du code du héros](/tutorials/images/runner/insert_hero_code.png)
...
8. Enregistrez le fichier.
    ...
    ![Pointes de la plateforme](/tutorials/images/runner/3/danger_edges.png)
...
9. Ouvrez *hero.go*, sélectionnez le *Collision Object* et ajoutez le nom "danger" à la propriété *Mask*. Enregistrez ensuite le fichier.
    ...
    ![Collision du héros](/tutorials/images/runner/3/hero_collision.png)
...
3. Ouvrez *platform.script* et modifiez-le pour qu'au lieu de simplement supprimer une plateforme qui a atteint le bord gauche, il envoie un message au contrôleur du niveau lui demandant de retirer la plateforme :
    ...
    ![Insertion du code de la plateforme](/tutorials/images/runner/insert_platform_code.png)
...
![Insertion du code du héros](/tutorials/images/runner/insert_hero_code_2.png)
...
10. Ajoutez le fichier de script à l'objet de la pièce en tant que composant *Script* (faites un clic droit sur la racine dans *Outline* et sélectionnez <kbd>Add Component from File</kbd>).
    ...
    ![Objet de jeu de la pièce](/tutorials/images/runner/3/coin.png)
...
![Factory des pièces](/tutorials/images/runner/3/coin_factory.png)
...
![Insertion du code du contrôleur](/tutorials/images/runner/insert_controller_code.png)
...
> Téléchargez la version terminée du projet [ici](/tutorials/images/runner/sample-runner.zip).

...
* Créez un [nouveau projet](/fr/manuals/project-setup/#creating-a-new-project) à partir du modèle "Empty Project"
...
![Schéma des règles du jeu](/tutorials/images/magic-link/linker_rules.png)
...
![Structure des dossiers](/tutorials/images/magic-link/linker_folders.png)
...
![Paramètres du projet](/tutorials/images/magic-link/linker_project_settings.png)
...
![Disposition du jeu à l'échelle](/tutorials/images/magic-link/linker_layout.png)
...
![Nombre maximal de sprites](/tutorials/images/magic-link/linker_sprite_max_count.png)
...
![Ajout des images](/tutorials/images/magic-link/linker_add_images.png)
...
![Ajout des images à l'atlas](/tutorials/images/magic-link/linker_add_to_atlas.png)
...
![Collection du plateau](/tutorials/images/magic-link/linker_board_collection.png)

![Collection du plateau au démarrage](/tutorials/images/magic-link/linker_bootstrap_board.png)
...
![Objet de jeu du bloc](/tutorials/images/magic-link/linker_block.png)
...
![Factory des blocs](/tutorials/images/magic-link/linker_blockfactory.png)

Vous devriez maintenant pouvoir lancer le jeu et voir le plateau rempli de blocs aux couleurs aléatoires :

![Première capture d'écran](/tutorials/images/magic-link/linker_first_screenshot.png)
...
![Associations d'entrées](/tutorials/images/magic-link/linker_input_bindings.png)
...
![Objet de jeu du connecteur](/tutorials/images/magic-link/linker_connector.png)

![Factory des connecteurs](/tutorials/images/magic-link/linker_connector_factory.png)
...
![Connecteurs dans le jeu](/tutorials/images/magic-link/linker_connector_screen.png)
...
![Descente des blocs](/tutorials/images/magic-link/linker_blocks_slide.png)
...
![Sprite de l'enveloppe](/tutorials/images/magic-link/linker_cover.png)
...
![Bloc magique sans et avec éclairage](/tutorials/images/magic-link/linker_magic_blocks.png)
...
![Marquage des régions](/tutorials/images/magic-link/linker_regions.png)
...
![Première victoire](/tutorials/images/magic-link/linker_first_win.png)
...
![Lâcher de blocs](/tutorials/images/magic-link/linker_drop.png)
...
![Interface graphique du menu principal](/tutorials/images/magic-link/linker_main_menu.png)
...
![Collection principale](/tutorials/images/magic-link/linker_main_collection.png)

Nous devons maintenant ouvrir *game.project* et définir la collection bootstrap *main_collection* sur `/main/main.collectionc`.

![Collection principale au démarrage](/tutorials/images/magic-link/linker_bootstrap_main.png)
...
![Interface graphique du plateau](/tutorials/images/magic-link/linker_board_gui.png)
...
![Interface graphique de redémarrage](/tutorials/images/magic-link/linker_restart_gui.png)
...
![Boîte de dialogue de fin de niveau](/tutorials/images/magic-link/linker_level_complete_gui.png)
...
![Interface graphique de présentation du niveau](/tutorials/images/magic-link/linker_present_level_gui.png)
...
![Interface graphique indiquant le manque de place pour un lâcher](/tutorials/images/magic-link/linker_no_drop_room_gui.png)
...
![Collection finale du plateau](/tutorials/images/magic-link/linker_board_collection_final.png)
...
![Jeu terminé](/tutorials/images/magic-link/linker_game_finished.png)

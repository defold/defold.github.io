...
Dans ce projet d'exemple, que vous pouvez [ouvrir depuis l'éditeur](/fr/manuals/project-setup/) ou [télécharger depuis GitHub](https://github.com/defold/sample-main-menu-animation), nous vous présentons des effets permettant d'afficher un menu principal. Le menu contient un arrière-plan et deux éléments de menu.

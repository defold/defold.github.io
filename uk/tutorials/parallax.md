...
У цьому прикладі проєкту, який можна [відкрити з редактора](/uk/manuals/project-setup/) або [завантажити з GitHub](https://github.com/defold/sample-parallax), ми показуємо, як використовувати ефект паралаксу для імітації глибини в ігровому світі.

...
![Новий проєкт](/tutorials/images/new_empty.png)
...
Почніть зі створення [нового проєкту](/uk/manuals/project-setup/) і відкрийте його в редакторі. Двічі клацніть файл *main/main.collection*, щоб відкрити його:
...
![Збирання](/tutorials/images/car/start_build_and_launch.png)
...
![Файл із незбереженими змінами](/tutorials/images/car/file_changed.png)
</div>
...
![Новий файл колекції](/tutorials/images/car/start_new_collection.png)
...
![Додавання ігрового об’єкта автомобіля](/tutorials/images/car/start_add_car_gameobject.png)
...
![Додавання компонента автомобіля](/tutorials/images/car/start_add_car_component.png)
...
![Зображення автомобіля](/tutorials/images/car/start_car.png)
![Зображення шини](/tutorials/images/car/start_tire.png)

Додайте ці зображення до атласу:

![Атлас спрайтів](/tutorials/images/car/start_sprites_atlas.png)

![Властивості спрайта](/tutorials/images/car/start_sprite_properties.png)
...
![Готова колекція автомобіля](/tutorials/images/car/start_car_collection_complete.png)
...
<div class='sidenote' markdown='1'>
Defold надає кілька функцій життєвого циклу для написання ігрової логіки. Докладніше про них читайте в [посібнику зі скриптів](/uk/manuals/script).
</div>
...
![Прив’язки введення](/tutorials/images/car/start_input_bindings.png)
...
![Додавання колекції автомобіля](/tutorials/images/car/start_adding_car_collection.png)
...
3. Додайте автомобілю звуки, щоб він заревів! ([Підказка](/uk/manuals/sound/))

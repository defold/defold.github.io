...
* Створіть [новий проєкт](/uk/manuals/project-setup/#creating-a-new-project) із шаблону «Empty Project»
...
![Схема правил гри](/tutorials/images/magic-link/linker_rules.png)
...
![Структура папок](/tutorials/images/magic-link/linker_folders.png)
...
![Налаштування проєкту](/tutorials/images/magic-link/linker_project_settings.png)
...
![Схема розмірів гри](/tutorials/images/magic-link/linker_layout.png)
...
![Максимальна кількість спрайтів](/tutorials/images/magic-link/linker_sprite_max_count.png)
...
![Додавання зображень](/tutorials/images/magic-link/linker_add_images.png)
...
![Додавання зображень до атласу](/tutorials/images/magic-link/linker_add_to_atlas.png)
...
![Колекція поля](/tutorials/images/magic-link/linker_board_collection.png)

![Колекція поля як стартова](/tutorials/images/magic-link/linker_bootstrap_board.png)
...
![Ігровий об’єкт блока](/tutorials/images/magic-link/linker_block.png)
...
![Фабрика блоків](/tutorials/images/magic-link/linker_blockfactory.png)

Тепер ви можете запустити гру й побачити поле, заповнене блоками випадкових кольорів:

![Перший знімок екрана](/tutorials/images/magic-link/linker_first_screenshot.png)
...
![Прив’язки введення](/tutorials/images/magic-link/linker_input_bindings.png)
...
![Ігровий об’єкт з’єднувача](/tutorials/images/magic-link/linker_connector.png)

![Фабрика з’єднувачів](/tutorials/images/magic-link/linker_connector_factory.png)
...
![З’єднувачі в грі](/tutorials/images/magic-link/linker_connector_screen.png)
...
![Зсування блоків униз](/tutorials/images/magic-link/linker_blocks_slide.png)
...
![Спрайт оболонки](/tutorials/images/magic-link/linker_cover.png)
...
![Магічний блок без підсвічування та з ним](/tutorials/images/magic-link/linker_magic_blocks.png)
...
![Позначення областей](/tutorials/images/magic-link/linker_regions.png)
...
![Перша перемога](/tutorials/images/magic-link/linker_first_win.png)
...
![Скидання блоків](/tutorials/images/magic-link/linker_drop.png)
...
![GUI головного меню](/tutorials/images/magic-link/linker_main_menu.png)
...
![GUI поля](/tutorials/images/magic-link/linker_board_gui.png)
...
![GUI перезапуску](/tutorials/images/magic-link/linker_restart_gui.png)
...
![Діалогове вікно завершення рівня](/tutorials/images/magic-link/linker_level_complete_gui.png)
...
![GUI представлення рівня](/tutorials/images/magic-link/linker_present_level_gui.png)
...
![GUI браку місця для скидання](/tutorials/images/magic-link/linker_no_drop_room_gui.png)
...
![Остаточна колекція поля](/tutorials/images/magic-link/linker_board_collection_final.png)
...
![Завершена гра](/tutorials/images/magic-link/linker_game_finished.png)

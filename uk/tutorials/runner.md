...
Якщо вам потрібне знайомство з програмуванням мовою Lua, перегляньте наш [посібник «Lua в Defold»](/uk/manuals/lua).
...
{% include shared/uk/install.md %}

Коли редактор встановлено й запущено, час створити новий проєкт і підготувати його до роботи. Створіть [новий проєкт](/uk/manuals/project-setup/#creating-a-new-project) із шаблону "Empty Project".
...
![Огляд редактора](/tutorials/images/runner/1/editor2_overview.png)
...
![Збирання](/tutorials/images/runner/1/build_and_launch.png)
...
![Файл із незбереженими змінами](/tutorials/images/runner/1/file_changed.png)
</div>
...
![Клацніть правою кнопкою миші й скопіюйте посилання на випуск](/tutorials/images/runner/extension-spine-releases.png)

Додайте посилання на випуск до списку [залежностей game.project](/uk/manuals/libraries/#setting-up-library-dependencies). Після додавання розширення Spine потрібно також перезапустити редактор, щоб активувати інтеграцію з редактором, яка входить до розширення Spine.
...
2. Створіть новий файл *Atlas* для текстур землі (клацніть правою кнопкою миші відповідну теку, наприклад *main*, на панелі *Assets pane* і виберіть <kbd>New ▸ Atlas File</kbd>). Назвіть файл атласу *level.atlas*.
  ...
  <div class='sidenote' markdown='1'>
  *Atlas* — це файл, який об’єднує набір окремих зображень в одне більше зображення. Це робиться для економії місця й підвищення продуктивності. Докладніше про атласи та інші можливості 2D-графіки читайте в [документації з 2D-графіки](/uk/manuals/2dgraphics).
  </div>
...
3. Додайте зображення землі до нового атласу: клацніть правою кнопкою миші кореневий вузол атласу на панелі *Outline* і виберіть <kbd>Add Images</kbd>. Виберіть імпортовані зображення та натисніть *OK*. Кожне зображення в атласі тепер доступне як однокадрова анімація (нерухоме зображення) для використання у спрайтах, ефектах частинок та інших візуальних елементах. Збережіть файл.
  ...
  ![Створення нового атласу](/tutorials/images/runner/1/new_atlas.png)

  ![Додавання зображень до атласу](/tutorials/images/runner/1/add_images_to_atlas.png)
...
5. До кожного об’єкта додайте компонент (component) спрайта: клацніть правою кнопкою миші ігровий об’єкт на панелі *Outline* і виберіть <kbd>Add Component</kbd>, потім виберіть *Sprite* та натисніть *OK*. Установіть для властивості *Image* компонента спрайта щойно створений атлас, а як стандартну анімацію спрайта виберіть одне з двох зображень землі. Установіть позицію X _компонента спрайта_ (а не ігрового об’єкта) в 190, а позицію Y — у 40. Оскільки ширина зображення становить 380 пікселів і ми зміщуємо його вбік на половину цієї відстані, опорна точка ігрового об’єкта опиниться на лівому краї зображення спрайта.
  ...
  ![Створення колекції землі](/tutorials/images/runner/1/ground_collection.png)
...
6. Використана графіка дещо завелика, тож зменште кожен ігровий об’єкт до 60% (масштаб 0.6 за X та Y дає ділянки землі завширшки 228 пікселів).
  ...
  ![Масштабування землі](/tutorials/images/runner/1/scale_ground.png)
...
9. Запустіть гру (<kbd>Project ▸ Build</kbd>), щоб переконатися, що все на своїх місцях.
  ...
  ![Нерухома земля](/tutorials/images/runner/1/still_ground.png)
...
Наразі цих пояснень, імовірно, достатньо. Значно докладніше ці поняття розглянуто в [посібнику «Будівельні блоки»](/uk/manuals/building-blocks). Радимо повернутися до нього згодом, щоб глибше зрозуміти, як усе працює в Defold.
...
Defold доповнює Lua набором API та системою _передавання повідомлень_, за допомогою якої можна програмувати взаємодію між ігровими об’єктами. Докладніше про її роботу читайте в [посібнику з передавання повідомлень](/uk/manuals/message-passing).
</div>
...
![Контролер землі](/tutorials/images/runner/1/ground_controller.png)
...
![Атлас героя](/tutorials/images/runner/2/hero_atlas.png)
...
![Сцена Spine героя](/tutorials/images/runner/2/hero_spinescene.png)

<div class='sidenote' markdown='1'>
Файл *hero.spinejson* експортовано у форматі Spine JSON. Для створення таких файлів потрібна програма анімації Spine. Якщо ви хочете використовувати іншу програму анімації, можна експортувати анімації як аркуші спрайтів і використовувати їх як покадрові анімації з ресурсів *Tile Source* або *Atlas*. Докладніше читайте в [посібнику з анімації](/uk/manuals/animation).
</div>
...
![Властивості моделі Spine](/tutorials/images/runner/2/spinemodel_properties.png)
...
<div class='sidenote' markdown='1'>
Тип колізії "Kinematic" означає, що ми хочемо реєструвати колізії, але фізичний рушій не розв’язуватиме їх автоматично й не симулюватиме об’єкти. Фізичний рушій підтримує кілька різних типів об’єктів колізій. Докладніше про них читайте в [документації з фізики](/uk/manuals/physics).
</div>
...
![Ігровий об’єкт героя](/tutorials/images/runner/2/hero_game_object.png)
...
Для цього й належної обробки колізій потрібні певні знання векторної математики. Докладне пояснення розв’язання кінематичних колізій наведено в [документації з фізики](/uk/manuals/physics-resolving-collisions/).
</div>
...
![Прив’язки введення](/tutorials/images/runner/2/input_bindings.png)
...
![Властивість скрипту](/tutorials/images/runner/2/script_property.png)
...
![Додавання коду землі](/tutorials/images/runner/insert_ground_code.png)
...
![Колізії землі](/tutorials/images/runner/2/ground_collision.png)
...
![Платформа](/tutorials/images/runner/2/platform_long.png)
...
![Запуск гри](/tutorials/images/runner/2/run_game.png)
...
![Вставлення коду героя](/tutorials/images/runner/insert_hero_code.png)
...
8. Збережіть файл.
    ...
    ![Шипи платформи](/tutorials/images/runner/3/danger_edges.png)

9. Відкрийте *hero.go*, виберіть *Collision Object* і додайте назву "danger" до властивості *Mask*. Потім збережіть файл.

    ![Колізії героя](/tutorials/images/runner/3/hero_collision.png)
...
3. Відкрийте *platform.script* і змініть його так, щоб замість безпосереднього видалення платформи, яка досягла крайнього лівого краю, він надсилав контролеру рівня повідомлення із запитом на її видалення:
    ...
    ![Вставлення коду платформи](/tutorials/images/runner/insert_platform_code.png)
...
![Вставлення коду героя](/tutorials/images/runner/insert_hero_code_2.png)
...
10. Додайте файл скрипту як компонент *Script* до об’єкта монети: клацніть правою кнопкою миші кореневий вузол на панелі *Outline* і виберіть <kbd>Add Component from File</kbd>.
    ...
    ![Ігровий об’єкт монети](/tutorials/images/runner/3/coin.png)
...
![Фабрика монет](/tutorials/images/runner/3/coin_factory.png)
...
![Вставлення коду контролера](/tutorials/images/runner/insert_controller_code.png)
...
> Завантажте готову версію проєкту [тут](/tutorials/images/runner/sample-runner.zip)

...
У цьому прикладі проєкту, який можна [відкрити в редакторі](/uk/manuals/project-setup/) або [завантажити з GitHub](https://github.com/defold/sample-main-menu-animation), ми демонструємо ефекти появи головного меню. Меню містить тло та два пункти меню.

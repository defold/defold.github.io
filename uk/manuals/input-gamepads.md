...
- anchor: digital-buttons
  title: Цифрові кнопки
- anchor: analog-sticks
  title: Аналогові стіки
- anchor: multiple-gamepads
  title: Кілька геймпадів
- anchor: connect-and-disconnect
  title: Підключення й відключення
- anchor: raw-gamepads
  title: Необроблені дані геймпадів
- anchor: gamepads-settings-file
  title: Файл налаштувань геймпадів
- anchor: unidentified-gamepads
  title: Нерозпізнані геймпади
- anchor: gamepads-in-html5
  title: Геймпади в HTML5
- anchor: standard-gamepad
  title: Стандартний геймпад
- anchor: gamepads-on-windows
  title: Геймпади у Windows
- anchor: gamepads-on-android
  title: Геймпади в Android
---

<div class='sidenote' markdown='1'>
Рекомендуємо ознайомитися із загальними принципами роботи введення в Defold, способами його отримання та порядком, у якому його отримують ваші файли скриптів. Докладніше про систему введення читайте в [оглядовому посібнику з введення](/uk/manuals/input).
</div>
...
![Налаштування геймпадів](/manuals/images/input/gamepads.png)
...
![Налаштування геймпадів](/manuals/images/input/gamepad_setting.png)

...
- anchor: adding-a-script-to-a-gui
  title: Додавання скрипта до GUI
- anchor: the-gui-namespace
  title: Простір імен «gui»
...
- anchor: dynamically-created-nodes
  title: Динамічно створені вузли
- anchor: dynamic-node-ids
  title: Ідентифікатори динамічних вузлів
---
...
![Скрипт](/manuals/images/gui-script/set_script.png)
...
![Передавання повідомлень](/manuals/images/gui-script/message_passing.png)
...
![Передавання повідомлень](/manuals/images/gui-script/node_id.png)
...
![Динамічний вузол](/manuals/images/gui-script/dynamic_nodes.png)

...
- anchor: optimizing-runtime-speed
  title: Оптимізація швидкодії під час виконання
- anchor: reduce-script-execution-time
  title: Скорочення часу виконання скриптів
- anchor: use-reactive-code-patterns
  title: Використовуйте реактивні підходи до написання коду
- anchor: reduce-garbage-collection
  title: Зменшення потреби у збиранні сміття
- anchor: prehash-message-and-action-ids
  title: Заздалегідь хешуйте ідентифікатори повідомлень і дій
- anchor: prefer-and-cache-urls
  title: Віддавайте перевагу URL і кешуйте їх
- anchor: reduce-time-it-takes-to-render-a-frame
  title: Скорочення часу рендерингу кадру
- anchor: reduce-scene-graph-complexity
  title: Зменшення складності графа сцени
- anchor: frustum-culling
  title: Відсікання за пірамідою видимості
...
Скрипт рендерингу може автоматично пропускати рендеринг компонентів ігрових об’єктів, які перебувають за межами визначеного обмежувального паралелепіпеда (піраміди видимості). Докладніше про відсікання за пірамідою видимості (frustum culling) читайте в [посібнику з конвеєра рендерингу](/uk/manuals/render/#frustum-culling).

...
toc:
- anchor: collision-messages
  title: Повідомлення про колізії
- anchor: event-filtering
  title: Фільтрування подій
- anchor: collision-response
  title: Реакція на колізію
- anchor: contact-point-response
  title: Реакція в точці контакту
- anchor: trigger-response
  title: Реакція тригера
---
...
Для гри чи застосунку, де потрібно повністю розділити об’єкти, повідомлення `"contact_point_response"` надає всю необхідну інформацію. Однак зауважте, що для кожної пари об’єктів, що стикаються, за кадр може надходити кілька повідомлень `"contact_point_response"` залежно від характеру колізії. Докладніше див. у [посібнику з розв’язання колізій](/uk/manuals/physics-resolving-collisions).

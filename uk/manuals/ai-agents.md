...
* [HTTP API редактора](/uk/manuals/editor-http-api) надає команди редактора, результати збирання, виведення консолі, пошук посилань, попередні перегляди, налаштування й маршрути скриптів редактора.

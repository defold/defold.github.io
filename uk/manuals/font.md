...
Про оформлення окремих фрагментів тексту й роботу з посиланнями та вбудованими спрайтами читайте в [посібнику з розмітки форматованого тексту](/uk/manuals/font-richtext).

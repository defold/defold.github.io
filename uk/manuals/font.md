...
- anchor: offline-or-runtime-fonts
  title: Шрифти з попереднім генеруванням або генеруванням під час виконання
- anchor: text-layout-support-eg-right-to-left
  title: Підтримка компонування тексту (наприклад, справа наліво)
- anchor: font-collection
  title: Колекція шрифтів
- anchor: creating-a-font
  title: Створення шрифту
- anchor: properties
  title: Властивості
- anchor: distance-field-fonts
  title: Шрифти на основі поля відстаней
- anchor: bitmap-bmfonts
  title: Растрові шрифти BMFont
- anchor: artifacts-and-best-practices
  title: Артефакти й рекомендовані підходи
- anchor: font-cache
  title: Кеш шрифту
- anchor: enabling-runtime-fonts
  title: Увімкнення генерування шрифтів під час виконання
- anchor: font-scripting
  title: Робота зі шрифтами зі скриптів
- anchor: addingremoving-fonts-to-a-font-collection
  title: Додавання шрифтів до колекції шрифтів і їх видалення
- anchor: prewarming-glyphs
  title: Попередня підготовка гліфів
---
...
Див. [Увімкнення генерування шрифтів під час виконання](/uk/manuals/font#enabling-runtime-fonts)
...
Якщо ви використовуєте генерування шрифтів під час виконання, з колекцією шрифтів можна пов’язати кілька файлів шрифтів (`.ttf`).
...
![Назва нового шрифту](/manuals/images/font/new_font_name.png)

Дайте новому файлу шрифту назву й натисніть <kbd>Ok</kbd>. Новий файл шрифту відкриється в редакторі.

![Новий шрифт](/manuals/images/font/new_font.png)
...
![Шрифт на основі поля відстаней](/manuals/images/font/df_font.png)
...
![Збільшені шрифти](/manuals/images/font/scale_up.png)
...
![Зменшені шрифти](/manuals/images/font/scale_down.png)
...
![Артефакти поля відстаней](/manuals/images/font/df_artifacts.png)
...
Докладніше про uniform-змінні шейдерів див. у [посібнику із шейдерів](/uk/manuals/shader).

## Увімкнення генерування шрифтів під час виконання {#enabling-runtime-fonts}

Для шрифтів типу SDF можна використовувати генерування під час виконання, якщо це шрифти TrueType (`.ttf`).
...
* Додайте [маніфест застосунку](/uk/manuals/app-manifest) і ввімкніть параметр `Use full text layout system`.

...
- anchor: html5-development
  title: Розробка для HTML5
- anchor: heap-size
  title: Розмір купи пам’яті
- anchor: testing-html5-build
  title: Тестування збірки HTML5
- anchor: creating-html5-bundle
  title: Створення пакета HTML5
- anchor: webgl-context-version
  title: Версія контексту WebGL
- anchor: download-verification
  title: Перевірка завантажень
- anchor: known-issues-and-limitations
  title: Відомі проблеми й обмеження
- anchor: customizing-html5-bundle
  title: Налаштування пакета HTML5
- anchor: downscale-fit-and-fit
  title: Downscale Fit і Fit
- anchor: stretch
  title: Stretch
- anchor: no-scale
  title: No Scale
...
- anchor: file-operations-in-html5
  title: Файлові операції в HTML5
- anchor: passing-arguments-to-an-html5-game
  title: Передавання аргументів у гру HTML5
- anchor: engine-arguments
  title: Аргументи рушія
- anchor: query-arguments-in-the-url
  title: Аргументи запиту в URL
...
![Налаштування проєкту](/manuals/images/html5/html5_project_settings.png)
...
![Збирання HTML5](/manuals/images/html5/html5_build_launch.png)
...
![Створення пакета HTML5](/manuals/images/html5/html5_bundle.png)
...
Можна включити будь-яку з цих архітектур або обидві. Якщо включено обидві, завантажувач вибирає `wasm_pthread-web`, коли браузер і середовище розміщення підтримують її, а в іншому разі використовує `wasm-web`. Канонічні назви цільових платформ наведено в [посібнику з Bob](/uk/manuals/bob/#usage).
...
Виберіть запитуваний графічний контекст за допомогою [`graphics.webgl_version_hint`](/uk/manuals/project-settings/#webgl-version-hint). За замовчуванням використовується WebGL 2; запросіть WebGL 1, щоб перевірити цей контекст або використовувати його у браузерах, які підтримують обидві версії.
...
Вимкнення **Verify Downloaded File Size** залишає ввімкненою будь-яку перевірку SHA-1, включену до пакета. Див. [налаштування проєкту для HTML5](/uk/manuals/project-settings/#verify-downloaded-file-size).
...
* Підтримка геймпадів — [зверніться до документації про геймпади](/uk/manuals/input-gamepads/#gamepads-in-html5), щоб дізнатися про особливості й кроки, які можуть знадобитися для HTML5.
...
![Розділ HTML5](/manuals/images/html5/html5_section.png)

Докладнішу інформацію про кожен параметр наведено в [посібнику з налаштувань проєкту](/uk/manuals/project-settings/#html5).
...
![Розділ Display](/manuals/images/html5/html5_display.png)

Відкрийте *game.project* як текст і перевірте `[section_name]` та назву поля, яке хочете використати. Потім його можна використати як токен: `{% raw %}{{section_name.field}}{% endraw %}` або `{% raw %}{{{section_name.field}}}{% endraw %}`.

![Розділ Display](/manuals/images/html5/html5_game_project.png)
...
<div class='important' markdown='1'>
Цей вбудований блок має з’являтися до завантаження основного скрипту застосунку. Оскільки він містить теги HTML, цей макрос слід брати в потрійні дужки `{% raw %}{{{TOKEN}}}{% endraw %}`, щоб запобігти екрануванню послідовностей символів.
</div>
...
* [Використання пам’яті](/uk/manuals/optimization-memory)
* [Розмір рушія](/uk/manuals/optimization-size)
* [Розмір гри](/uk/manuals/optimization-size)

## Поширені запитання {#faq}
{% include shared/uk/html5-faq.md %}
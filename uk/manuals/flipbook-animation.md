...
- anchor: flip-book-animation
  title: Покадрова анімація
- anchor: playing-flip-book-animations
  title: Відтворення покадрових анімацій
- anchor: sprite-example
  title: Приклад зі спрайтом
- anchor: gui-box-node-example
  title: Приклад із вузлом GUI типу Box

...
- anchor: creating-a-gui-component
  title: Створення компонента GUI
- anchor: gui-properties
  title: Властивості GUI
...
- anchor: node-properties
  title: Властивості вузлів
- anchor: pivot-anchors-and-adjust-mode
  title: Опорна точка, прив’язки та режим коригування
- anchor: draw-order
  title: Порядок малювання
- anchor: parent-child-hierarchies
  title: Батьківсько-дочірні ієрархії
- anchor: layers-and-draw-calls
  title: Шари та виклики малювання
---
...
![Новий файл GUI](/manuals/images/gui/new_gui_file.png)

Defold автоматично відкриє файл у редакторі сцен GUI.

![Новий GUI](/manuals/images/gui/new_gui.png)

У панелі *Outline* перелічено весь вміст GUI: список вузлів і всі залежності (див. нижче).

У центральній області редагування показано GUI. Панель інструментів у правому верхньому куті області редагування містить інструменти *Move*, *Rotate* і *Scale*, а також засіб вибору [компонування](/uk/manuals/gui-layouts).

![Панель інструментів](/manuals/images/gui/toolbar.png)
...
: Максимальна кількість динамічних текстур, які відстежує цей компонент GUI; за замовчуванням — `128`. До них належать текстури, створені за допомогою [`gui.new_texture()`](/ref/gui/#gui.new_texture:texture_id-width-height-type-buffer-flip), і зовнішні текстури, призначені GUI за допомогою `go.set(..., "textures", ...)` або `gui.set(msg.url(), "textures", ...)`. У проєктах, які замінюють багато зовнішніх текстур, може знадобитися збільшити це обмеження.
...
![Отримання та встановлення шрифту](/manuals/images/gui/get_set_font.png)
...
![Отримання та встановлення матеріалу](/manuals/images/gui/get_set_material.png)
...
![Отримання та встановлення текстури](/manuals/images/gui/get_set_texture.png)
...
![Залежності](/manuals/images/gui/dependencies.png)
...
Вузол Box
: ![Вузол Box](/manuals/images/icons/gui-box-node.png)
  Прямокутний вузол з одним кольором, текстурою або покадровою анімацією. Докладніше див. у [документації вузла Box](/uk/manuals/gui-box).

<div style="clear: both;"></div>

Вузол Text
: ![Вузол Text](/manuals/images/icons/gui-text-node.png)
  Відображає текст. Докладніше див. у [документації вузла Text](/uk/manuals/gui-text).

<div style="clear: both;"></div>

Вузол Pie
: ![Вузол Pie](/manuals/images/icons/gui-pie-node.png)
  Круглий або еліптичний вузол, який можна частково заповнити або інвертувати. Докладніше див. у [документації вузла Pie](/uk/manuals/gui-pie).

<div style="clear: both;"></div>

Вузол Template
: ![Вузол Template](/manuals/images/icons/gui.png)
  Шаблони використовуються для створення екземплярів (instances) на основі інших файлів сцен GUI. Докладніше див. у [документації вузла Template](/uk/manuals/gui-template).

<div style="clear: both;"></div>

Вузол ParticleFX
: ![Вузол ParticleFX](/manuals/images/icons/particlefx.png)
  Відтворює ефект частинок. Докладніше див. у [документації вузла ParticleFX](/uk/manuals/gui-particlefx).
...
![Додавання вузлів](/manuals/images/gui/add_node.png)
...
: Визначають розташування, орієнтацію та розтягування вузла. Ви можете змінювати ці значення за допомогою інструментів *Move*, *Rotate* і *Scale*. Значення можна анімувати зі скрипту ([докладніше](/uk/manuals/property-animation)).

Size (вузли Box, Text і Pie)
: За замовчуванням розмір вузла визначається автоматично, але якщо встановити *Size Mode* у `Manual`, ви зможете змінювати це значення. Розмір визначає межі вузла та використовується під час вибору вузла за координатами введення. Це значення можна анімувати зі скрипту ([докладніше](/uk/manuals/property-animation)).
...
Slice 9 (вузли Box)
: Увімкніть, щоб зберігати розмір текстури вузла в пікселях уздовж країв під час змінення розміру вузла. Докладніше див. у [документації вузла Box](/uk/manuals/gui-box).

Inner Radius (вузли Pie)
: Внутрішній радіус вузла, заданий уздовж осі X. Докладніше див. у [документації вузла Pie](/uk/manuals/gui-pie).

Outer Bounds (вузли Pie)
: Керує поведінкою зовнішніх меж. Докладніше див. у [документації вузла Pie](/uk/manuals/gui-pie).

Perimeter Vertices (вузли Pie)
: Кількість сегментів, які використовуватимуться для побудови форми. Докладніше див. у [документації вузла Pie](/uk/manuals/gui-pie).

Pie Fill Angle (вузли Pie)
: Визначає, яку частину вузла Pie слід заповнити. Докладніше див. у [документації вузла Pie](/uk/manuals/gui-pie).

Template (вузли Template)
: Файл сцени GUI, який використовується як шаблон для вузла. Докладніше див. у [документації вузла Template](/uk/manuals/gui-template).

ParticleFX (вузли ParticleFX)
: Ефект частинок, який використовується в цьому вузлі. Докладніше див. у [документації вузла ParticleFX](/uk/manuals/gui-particlefx).

Color
: Колір вузла. Якщо вузол має текстуру, колір забарвлює її. Колір можна анімувати зі скрипту ([докладніше](/uk/manuals/property-animation)).

Alpha
: Прозорість вузла. Значення альфа можна анімувати зі скрипту ([докладніше](/uk/manuals/property-animation)).
...
: Задає опорну точку вузла. Її можна вважати «центральною точкою» вузла. Будь-який поворот, масштабування або змінення розміру відбуватимуться відносно цієї точки.
  ...
  ![Опорна точка](/manuals/images/gui/pivot.png)
...
: Прив’язка визначає, як змінюється вертикальна й горизонтальна позиція вузла, коли межі сцени або батьківського вузла розтягуються відповідно до фізичного розміру екрана.
  ...
  ![Прив’язка без коригування](/manuals/images/gui/anchoring_unadjusted.png)
  ...
  ![Прив’язка](/manuals/images/gui/anchoring.png)
...
: Задає режим коригування вузла. Це налаштування визначає, що відбувається з вузлом, коли межі сцени або батьківського вузла коригуються відповідно до фізичного розміру екрана.
  ...
  ![Без коригування](/manuals/images/gui/unadjusted.png)
  ...
  ![Режими коригування](/manuals/images/gui/adjusted.png)
...
: Задає режим обрізання вузла:
  ...
  Докладніше див. у [посібнику з обрізання GUI](/uk/manuals/gui-clipping).

Clipping Visible (вузли Box і Pie)
: Увімкніть, щоб відображати вміст вузла в області трафарету. Докладніше див. у [посібнику з обрізання GUI](/uk/manuals/gui-clipping).

Clipping Inverted (вузли Box і Pie)
: Інвертує трафаретну маску. Докладніше див. у [посібнику з обрізання GUI](/uk/manuals/gui-clipping).
...
![Порядок малювання](/manuals/images/gui/draw_order.png)
...
![Батьківський і дочірній вузли](/manuals/images/gui/parent_child.png)
...
![Ієрархія, що розриває пакети](/manuals/images/gui/break_batch.png)
...
![Шари](/manuals/images/gui/layers.png)

...
- anchor: launch-the-debugger
  title: Запуск налагоджувача
- anchor: debug-symbols
  title: Налагоджувальні символи
- anchor: path-mappings
  title: Зіставлення шляхів
- anchor: breakpoints
  title: Точки зупину
- anchor: notes
  title: Примітки
- anchor: check-uuid-of-binary
  title: Перевірка UUID двійкового файлу
---
...
* Створіть пакет застосунку за допомогою bob з параметром `--with-symbols` ([докладніше](/uk/manuals/debugging-native-code/#symbolicate-a-callstack)):
...
* Отримайте папку `.dSYM` (тобто налагоджувальні символи)
	...
	* Якщо ви використовуєте нативне розширення, папка `.dSYM` створюється під час збирання за допомогою [bob.jar](https://www.defold.com/uk/manuals/bob/). Потрібне лише збирання (без архівування чи пакування):
...
* Створіть новий проєкт Xcode і виберіть шаблон `Game`
	...
	![Шаблон проєкту](/manuals/images/extensions/debugging/ios/project_template.png)
...
* Додайте свій код до застосунку
	...
	![Додавання файлів](/manuals/images/extensions/debugging/ios/add_files.png)

* Переконайтеся, що прапорець «Copy items if needed» знято.

	![Додавання вихідного коду](/manuals/images/extensions/debugging/ios/add_source.png)

* Ось кінцевий результат

	![Доданий вихідний код](/manuals/images/extensions/debugging/ios/added_source.png)


* Вимкніть крок `Build`

	![Редагування схеми](/manuals/images/extensions/debugging/ios/edit_scheme.png)

	![Вимкнення збирання](/manuals/images/extensions/debugging/ios/disable_build.png)

* Установіть версію `Deployment target` так, щоб вона тепер була вищою за версію iOS на вашому пристрої

	![Версія розгортання](/manuals/images/extensions/debugging/ios/deployment_version.png)

* Виберіть цільовий пристрій

	![Вибір пристрою](/manuals/images/extensions/debugging/ios/select_device.png)
...
2. Або виберіть `Attach to process by PID or Process name`
	...
	![Вибір пристрою](/manuals/images/extensions/debugging/ios/attach_to_process_name.png)
...
![Додавання налагоджувальних символів](/manuals/images/extensions/debugging/ios/add_dsym.png)
...
* Відкрийте файл у поданні проєкту та встановіть точку зупину
	...
	![Точка зупину](/manuals/images/extensions/debugging/ios/breakpoint.png)

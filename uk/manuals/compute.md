...
- anchor: compute-programs
  title: Обчислювальні програми
- anchor: what-can-i-do-with-compute-shaders
  title: Що можна робити за допомогою обчислювальних шейдерів?
- anchor: how-does-compute-shaders-work
  title: Як працюють обчислювальні шейдери?
- anchor: creating-a-compute-program
  title: Створення обчислювальної програми
- anchor: using-the-compute-program-in-defold
  title: Використання обчислювальної програми в Defold
- anchor: writing-data-from-compute-programs
  title: Запис даних з обчислювальних програм
- anchor: putting-it-all-together
  title: Поєднання всіх частин
- anchor: shader-program
  title: Шейдерна програма
- anchor: script-component
  title: Компонент-скрипт
...
* Докладніше про конвеєр рендерингу див. у [документації з рендерингу](/uk/manuals/render).
* Докладне пояснення шейдерних програм див. у [документації з шейдерів](/uk/manuals/shader).
...
![Файл обчислювальної програми](/manuals/images/compute/compute_file.png)

Нова обчислювальна програма відкриється в редакторі *Compute Editor*.

![Редактор обчислювальних програм](/manuals/images/compute/compute.png)
...
![Файл рендерингу з обчислювальною програмою](/manuals/images/compute/compute_render_file.png)
...
До масиву входять лише підтримувані можливості; це не таблиця, ключами якої є константи можливостей. Завжди виконуйте цю перевірку перед використанням обчислювальних шейдерів, якщо гра може працювати з різними графічними адаптерами або на пристроях з різним рівнем підтримки драйверів. Підтримка в OpenGL і OpenGL ES залежить від версії API та драйвера. Vulkan і Metal через MoltenVK підтримують обчислювальні шейдери починаючи з версії 1.0. Використовуйте [маніфест застосунку](/uk/manuals/app-manifest), щоб вибрати Vulkan на платформах, де він ще не є типовою графічною підсистемою.
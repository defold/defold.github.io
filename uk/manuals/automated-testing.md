...
| Метод | Призначення |
| --- | --- |
| [Попередній перегляд редактора](/uk/manuals/editor-http-api/#rendering-scene-previews) | Компонування завантаженого ресурсу, наприклад рівня або GUI, композиція атласу, інспектування тайлової мапи, статична композиція сцени, правильність рендерингу редактора й шейдерів або створення мініатюр для документації |

...
- anchor: creating-display-profiles
  title: Створення профілів дисплея
- anchor: auto-layout-selection-display-profiles
  title: Автоматичний вибір макета (Display Profiles)
- anchor: gui-layouts
  title: Макети GUI
- anchor: dynamic-profile-selection
  title: Динамічний вибір профілю
- anchor: layout-change-messages
  title: Повідомлення про зміну макета
- anchor: manual-layout-selection-lua
  title: Вибір макета вручну (Lua)
...
![Нові профілі дисплея](/manuals/images/gui-layouts/new_profiles.png)
...
![Налаштування](/manuals/images/gui-layouts/settings.png)
...
![Додавання макета до сцени](/manuals/images/gui-layouts/add_layout.png)
...
![Панель інструментів макетів](/manuals/images/gui-layouts/toolbar.png)

![Редагування портретного макета](/manuals/images/gui-layouts/portrait.png)
...
![Редагування альбомного макета](/manuals/images/gui-layouts/landscape.png)

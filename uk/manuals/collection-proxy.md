...
- anchor: creating-a-collection-proxy-component
  title: Створення компонента проксі колекції
- anchor: bootstrap
  title: Початкове завантаження
- anchor: loading-a-collection
  title: Завантаження колекції
- anchor: changing-an-excluded-proxys-collection
  title: Зміна колекції виключеного проксі
- anchor: addressing-into-the-new-world
  title: Адресація в новому світі
- anchor: unloading-a-world
  title: Вивантаження світу
- anchor: time-step
  title: Крок часу
...
Проксі колекцій відрізняються від [компонентів фабрики колекцій (collection factory)](/uk/manuals/collection-factory/). Фабрика колекцій створює екземпляри (instance) вмісту колекції в поточному ігровому світі. Проксі колекцій створюють новий ігровий світ під час виконання, тому мають інші сфери застосування.
...
![додавання компонента проксі](/manuals/images/collection-proxy/create_proxy.png)

(Ви можете виключити вміст зі збірки й натомість завантажити його за допомогою коду, встановивши прапорець *Exclude* та скориставшись [функцією Live Update](/uk/manuals/live-update/).)

## Початкове завантаження {#bootstrap}

Під час запуску рушій Defold завантажує та створює в середовищі виконання екземпляри всіх ігрових об’єктів зі *стартової колекції (bootstrap collection)*. Потім він ініціалізує й вмикає ігрові об’єкти та їхні компоненти. Стартова колекція, яку має використовувати рушій, задається в [налаштуваннях проєкту](/uk/manuals/project-settings/#main-collection). За усталеною домовленістю цей файл колекції зазвичай має назву `main.collection`.

![початкове завантаження](/manuals/images/collection-proxy/bootstrap.png)
...
![початкове завантаження](/manuals/images/collection-proxy/collection_id.png)
...
![завантаження](/manuals/images/collection-proxy/proxy_load.png)
...
Щоб відновити колекцію, призначену в редакторі, викличте `collectionproxy.set_collection("#level_proxy", nil)`, коли проксі не завантажений і не перебуває в процесі завантаження. Про завантаження й монтування вмісту дивіться [посібник зі скриптів Live Update](/uk/manuals/live-update-scripting/), а про коди помилок `collectionproxy.RESULT_*` — довідник API.
...
![завантаження](/manuals/images/collection-proxy/message_passing.png)

А якщо вам потрібно взаємодіяти із завантажувача з ігровим об’єктом у завантаженій колекції, надішліть повідомлення за [повним URL об’єкта](/uk/manuals/addressing/#urls):
...
* [Анімації властивостей ігрових об’єктів і GUI](https://defold.com/uk/manuals/animation/#property-animation-1)
* [Покадрові анімації](https://defold.com/uk/manuals/animation/#flip-book-animation)
* [Симуляції ефектів частинок](https://defold.com/uk/manuals/particlefx/)
* Швидкість таймерів

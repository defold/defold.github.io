...
- anchor: 3d-model-animation
  title: Анімація 3D-моделей
- anchor: playing-animations
  title: Відтворення анімацій
- anchor: morph-targets
  title: Цілі морфінгу
- anchor: shader-support
  title: Підтримка в шейдерах
- anchor: the-bone-hierarchy
  title: Ієрархія кісток
- anchor: cursor-animation
  title: Анімація курсора
- anchor: completion-callbacks
  title: Зворотні виклики завершення
- anchor: playback-modes
  title: Режими відтворення
---
...
Докладніше про імпортування 3D-даних у Model для анімації дивіться в [документації Model](/uk/manuals/model).

  ![Анімація в Blender](/manuals/images/animation/blender_animation.png)
  ![Циклічне погойдування](/manuals/images/animation/suzanne.gif)
...
Окрім використання `model.play_anim()` для просування анімації моделі, компоненти *Model* надають властивість `cursor`, якою можна керувати за допомогою `go.animate()` (докладніше про [анімації властивостей](/uk/manuals/property-animation)):

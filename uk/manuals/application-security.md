...
- anchor: application-security
  title: Безпека застосунків
- anchor: securing-your-intellectual-property-from-theft
  title: Захист вашої інтелектуальної власності від крадіжки
- anchor: source-code-obfuscation
  title: Обфускація вихідного коду
- anchor: resource-encryption
  title: Шифрування ресурсів
- anchor: encoding-project-configuration-values
  title: Кодування значень конфігурації проєкту
- anchor: securing-your-game-against-cheaters
  title: Захист вашої гри від читерів
- anchor: securing-your-network-communication
  title: Захист вашого мережевого обміну даними
- anchor: ssl-certificate-validation
  title: Перевірка сертифіката SSL
- anchor: securing-your-use-of-third-party-software
  title: Безпечне використання стороннього програмного забезпечення
- anchor: securing-your-use-of-cloud-build-servers
  title: Безпечне використання хмарних серверів збирання
- anchor: securing-your-downloadable-content
  title: Захист вашого завантажуваного вмісту
---
...
Докладніше про цей процес читайте в [посібнику з Live Update](https://defold.com/uk/manuals/live-update/#content-verification).
...
- anchor: script-properties
  title: Властивості скриптів
- anchor: defining-a-script-property
  title: Визначення властивості скрипту
- anchor: accessing-script-properties
  title: Доступ до властивостей скриптів
- anchor: factory-created-objects
  title: Об’єкти, створені фабрикою
- anchor: resource-properties
  title: Властивості ресурсів
---
...
Властивості скриптів додають до компонента-скрипту (script component), визначаючи їх за допомогою спеціальної функції `go.property()`. Цю функцію потрібно використовувати на верхньому рівні — поза будь-якими функціями життєвого циклу, як-от `init()` і `update()`. Задане для властивості типове значення визначає її тип: `number`, `boolean`, `hash`, `msg.url`, `vmath.vector3`, `vmath.vector4`, `vmath.quaternion` і `resource` (див. нижче).
...
![Компонент із властивостями](/manuals/images/script-properties/component.png)

 Виберіть компонент-скрипт у панелі *Outline* редактора, і властивості з’являться в панелі *Properties*, де їх можна редагувати:

![Властивості](/manuals/images/script-properties/properties.png)
...
До визначених користувачем властивостей скрипту також можна звертатися через функції `get`, `set` і `animate`, як і до будь-якої іншої властивості:
...
![Властивості ресурсів](/manuals/images/script-properties/resource-properties.png)

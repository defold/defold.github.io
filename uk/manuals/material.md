...
- anchor: default-attribute-semantics
  title: Типова семантика атрибутів
- anchor: setting-custom-vertex-attribute-data
  title: Задання даних власних атрибутів вершин
- anchor: examples-of-using-custom-vertex-attributes
  title: Приклади використання власних атрибутів вершин
- anchor: instancing
  title: Інстансинг
- anchor: vertex-and-fragment-constants
  title: Вершинні та фрагментні константи
- anchor: gui-node-material-constants
  title: Константи матеріалу вузла GUI
- anchor: samplers
  title: Семплери
- anchor: sampler-settings
  title: Налаштування семплера
- anchor: constants-buffers
  title: Буфери констант
---
...
![Файл матеріалу](/manuals/images/materials/material_file.png)

Новий матеріал відкриється в редакторі *Material Editor*.

![Редактор матеріалів](/manuals/images/materials/material.png)
...
![Власний атрибут матеріалу](/manuals/images/materials/set_custom_attribute.png)
...
![Налаштування інстансингу](/manuals/images/materials/instancing-setup.png)

Матеріал налаштовано так, що він містить один власний атрибут вершини, який повторюється для кожного екземпляра:

![Матеріал для інстансингу](/manuals/images/materials/instancing-material.png)
...
![Виклики малювання з інстансингом](/manuals/images/materials/instancing-draw-calls.png)
...
`CONSTANT_TYPE_USER`
: Константа vector4, яку можна використовувати для будь-яких власних даних, що потрібно передати до шейдерних програм. Початкове значення константи можна задати в її визначенні, а надалі змінювати за допомогою функцій [go.set()](/ref/go/#go.set) / [go.animate()](/ref/go/#go.animate). Отримати значення можна за допомогою [go.get()](/ref/go/#go.get). Змінення константи матеріалу окремого екземпляра компонента [порушує пакетування рендерингу й призводить до додаткових викликів малювання](/uk/manuals/render/#draw-calls-and-batching).
...
![Семплер спрайта](/manuals/images/materials/sprite_sampler.png)
...
![Налаштування семплера](/manuals/images/materials/my_sampler.png)
...
![Семплери моделі](/manuals/images/materials/model_samplers.png)
...
![Модель](/manuals/images/materials/model.png)

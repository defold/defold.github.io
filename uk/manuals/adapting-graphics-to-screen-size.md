...
- anchor: how-to-change-how-your-content-is-rendered
  title: Як змінити спосіб рендерингу вмісту
- anchor: retro8-bit-graphics
  title: Ретро- та 8-бітна графіка
- anchor: high-resolution-graphics
  title: Графіка з високою роздільною здатністю
- anchor: high-dpi-setting-and-retina-screens
  title: Налаштування High DPI та екрани Retina
- anchor: creating-an-adaptive-gui
  title: Створення адаптивного GUI
- anchor: node-properties
  title: Властивості *вузла*
- anchor: layouts
  title: Компонування
- anchor: testing-different-screen-sizes
  title: Тестування різних розмірів екрана
---
...
Того самого результату можна досягти, додавши [компонент камери](/uk/manuals/camera/) до ігрового об’єкта (game object), увімкнувши *Orthographic Projection* та задавши для *Orthographic Zoom* значення 4.0:

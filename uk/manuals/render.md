...
- anchor: render-pipeline-what-when-and-where
  title: Конвеєр рендерингу — що, коли й де?
- anchor: the-default-render
  title: Стандартний рендеринг
- anchor: render-predicates
  title: Предикати рендерингу
- anchor: default-view-projection
  title: Стандартний вид і проєкція
- anchor: stretch-projection
  title: Проєкція з розтягуванням
- anchor: fixed-fit-projection
  title: Проєкція з вписуванням
- anchor: fixed-projection
  title: Фіксована проєкція
- anchor: camera-projection
  title: Проєкція камери
- anchor: frustum-culling
  title: Відсікання за об’ємом видимості
- anchor: coordinate-systems
  title: Системи координат
- anchor: the-render-script
  title: Скрипт рендерингу
- anchor: render-resources
  title: Ресурси рендерингу
- anchor: multisampled-render-targets
  title: Цілі рендерингу з мультисемплінгом
- anchor: texture-handles
  title: Дескриптори текстур
- anchor: supported-graphics-apis
  title: Підтримувані графічні API
- anchor: system-messages
  title: Системні повідомлення
- anchor: draw-calls-and-batching
  title: Виклики малювання та пакетування
- anchor: batch-rules-for-non-gui-components
  title: Правила пакетування для компонентів поза GUI
- anchor: batch-rules-for-gui-components
  title: Правила пакетування для компонентів GUI
---
...
![Вбудований рендеринг](/manuals/images/render/builtin.png)
...
Докладний опис роботи матеріалів наведено в [документації про матеріали](/uk/manuals/material).
...
![Проєкція з розтягуванням](/manuals/images/render/stretch_projection.png)

*Проєкція з розтягуванням за початкового розміру вікна*

![Проєкція з розтягуванням після змінення розміру](/manuals/images/render/stretch_projection_resized.png)
...
![Проєкція з вписуванням](/manuals/images/render/fixed_fit_projection.png)

*Проєкція з вписуванням за початкового розміру вікна*

![Проєкція з вписуванням після змінення розміру](/manuals/images/render/fixed_fit_projection_resized.png)

*Проєкція з вписуванням із розтягнутим по горизонталі вікном*

![Проєкція з вписуванням після зменшення](/manuals/images/render/fixed_fit_projection_resized_smaller.png)
...
![Фіксована проєкція](/manuals/images/render/fixed_projection_zoom_2_0.png)

*Фіксована проєкція з рівнем наближення 2*

![Фіксована проєкція](/manuals/images/render/fixed_projection_zoom_0_5.png)

*Фіксована проєкція з рівнем наближення 0.5*

![Фіксована проєкція](/manuals/images/render/fixed_projection_zoom_2_0_resized.png)
...
Якщо ви використовуєте стандартний скрипт рендерингу й у проєкті є ввімкнені [компоненти камери](/uk/manuals/camera), вони матимуть пріоритет над усіма іншими видами та проєкціями, заданими у скрипті рендерингу. Докладніше про роботу з компонентами камери у скриптах рендерингу читайте в [документації про камеру](/uk/manuals/camera).
...
1 = Обмежувальний паралелепіпед меша має задати розробник. [Докладніше](/uk/manuals/mesh/#frustum-culling).
...
![Ресурси рендерингу](/manuals/images/render/render_resources.png)
...
Цілі рендерингу підтримують мультисемплінгове згладжування (MSAA). Воно згладжує краї геометрії під час позаекранного проходу рендерингу. Кількість вибірок цілі не залежить від [Display ▸ Samples](/uk/manuals/project-settings/#samples), що керує згладжуванням для вікна.
...
{% include shared/uk/graphics-api.md %}
...
Виклик малювання (draw call) — це термін, що описує процес налаштування GPU для малювання об’єкта на екрані з використанням текстури й матеріалу та, за потреби, додаткових налаштувань. Цей процес зазвичай потребує значних ресурсів, тому рекомендовано зводити кількість викликів малювання до мінімуму. Ви можете вимірювати кількість викликів малювання та час їх виконання за допомогою [вбудованого профайлера](/uk/manuals/profiling/).

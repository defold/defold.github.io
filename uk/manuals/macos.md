...
Параметри застосунку, специфічні для macOS, задають у [розділі macOS](/uk/manuals/project-settings/#macos) файлу налаштувань *game.project*.

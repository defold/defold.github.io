...
toc:
- anchor: available-docker-images
  title: Доступні образи Docker
- anchor: how-to-use-old-docker-images
  title: Як використовувати старі образи Docker
---
...
3. Запустіть локальний Extender, як описано в розділі [Як запустити локальний Extender із попередньо налаштованими артефактами](/uk/manuals/extender-local-setup#how-to-run-local-extender-with-preconfigured-artifacts).
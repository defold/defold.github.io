...
- anchor: native-extension-job-folder
  title: Папка завдання нативного розширення
---
...
* Створіть пакет застосунку в режимі налагодження у вибраній папці.
	...
	![Пакування для Android](/manuals/images/extensions/debugging/android/bundle_android.png)

* Запустіть [Android Studio](https://developer.android.com/studio/)

* Виберіть `Profile or debug APK`

	![Налагодження APK](/manuals/images/extensions/debugging/android/android_profile_or_debug.png)

* Виберіть щойно створений пакет apk

	![Вибір apk](/manuals/images/extensions/debugging/android/android_select_apk.png)

* Виберіть основний файл `.so` і переконайтеся, що він містить налагоджувальні символи

	![Вибір файлу .so](/manuals/images/extensions/debugging/android/android_missing_symbols.png)
...
* Виберіть файл .so, а потім додайте зіставлення з папкою на локальному диску
	...
	![Зіставлення шляхів 1](/manuals/images/extensions/debugging/android/path_mappings_android.png)

	![Зіставлення шляхів 2](/manuals/images/extensions/debugging/android/path_mappings_android2.png)
...
* Тепер у вашому проєкті має з’явитися зіставлений вихідний код
	...
	![Зіставлений вихідний код](/manuals/images/extensions/debugging/android/source_mappings_android.png)

* Додайте точку зупинки

	![Точка зупинки](/manuals/images/extensions/debugging/android/breakpoint_android.png)

* Натисніть `Run` -> `Debug "Appname"` і викличте код, у якому хочете зупинити виконання

	![Точка зупинки](/manuals/images/extensions/debugging/android/callstack_variables_android.png)

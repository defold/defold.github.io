...
- anchor: extension-application-and-engine-manifest-files
  title: Файли маніфестів розширення, застосунку та рушія
- anchor: app-manifest
  title: Маніфест застосунку
- anchor: engine-manifest
  title: Маніфест рушія
- anchor: extension-manifest
  title: Маніфест розширення
- anchor: the-extmanifest-file
  title: Файл ext.manifest
---

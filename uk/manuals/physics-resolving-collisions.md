...
- anchor: resolving-kinematic-collisions
  title: Розв’язання кінематичних колізій
---
...
![Фізична колізія](/manuals/images/physics/collision_multi.png)
...
![Найпростіше фізичне розділення](/manuals/images/physics/separation_naive.png)
...
![Фізичне розділення, крок 1](/manuals/images/physics/separation_step1.png)
...
![Проєкція](/manuals/images/physics/projection.png)

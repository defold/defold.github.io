...
![Компонент-фабрика](/manuals/images/factory/factory_collection.png)

![Компонент-фабрика](/manuals/images/factory/factory_component.png)
...
![Створений ігровий об’єкт](/manuals/images/factory/factory_spawned.png)
...
`[properties]`
: (необов’язковий) Таблиця Lua зі значеннями властивостей скрипту, якими потрібно ініціалізувати ігровий об’єкт. Інформацію про властивості скрипту див. у [посібнику з властивостей скрипту](/uk/manuals/script-properties).
...
![Створений ігровий об’єкт із властивістю та масштабуванням](/manuals/images/factory/factory_spawned2.png)
...
Механізм адресації Defold дає змогу звертатися до кожного об’єкта й компонента в запущеній грі. У [посібнику з адресації](/uk/manuals/addressing/) докладно описано, як працює ця система. Той самий механізм адресації можна використовувати для створених ігрових об’єктів та їхніх компонентів. Часто достатньо використати ідентифікатор створеного об’єкта, наприклад, для надсилання повідомлення:
...
![Динамічне завантаження](/manuals/images/factory/load_dynamically.png)
...
![Динамічний прототип](/manuals/images/factory/dynamic_prototype.png)
...
![Максимальна кількість екземплярів](/manuals/images/factory/factory_max_instances.png)

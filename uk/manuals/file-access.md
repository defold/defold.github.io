...
- anchor: functions-for-file-and-folder-access
  title: Функції для доступу до файлів і папок
- anchor: file-and-folder-locations
  title: Розташування файлів і папок
- anchor: how-to-save-and-load-application-specific-files
  title: Як зберігати й завантажувати файли застосунку
- anchor: how-to-access-files-bundled-with-the-application
  title: Як отримати доступ до файлів, що входять до пакета застосунку
- anchor: system-file-access
  title: Доступ до системних файлів
- anchor: extensions
  title: Розширення
---
...
Розширення також можуть надавати ці файли через `ext.properties`. Їхні шляхи об’єднуються з користувацькими ресурсами проєкту як у збірках редактора, так і в архівах Bob. Див. [користувацькі ресурси розширень](/uk/manuals/extensions/#custom-resources).

...
![проєкції](/manuals/images/camera/projections.png)
...
![створення компонента камери](/manuals/images/camera/create.png)

Компонент камери має наведені нижче властивості, які визначають її *зрізану піраміду видимості*:

![налаштування камери](/manuals/images/camera/settings.png)
...
![слідування за ігровим об’єктом](/manuals/images/camera/follow.png)
...
<div class='sidenote' markdown='1'>
[Сторонні рішення для камер, згадані в цьому посібнику](/uk/manuals/camera/#third-party-camera-solutions), надають функції перетворення в екранні координати й навпаки.
</div>

...
toc:
- anchor: game-and-system-log
  title: Журнали гри й системи
- anchor: reading-the-game-log-from-the-editor
  title: Читання журналу гри в редакторі
- anchor: reading-the-game-log-from-the-terminal
  title: Читання журналу гри в терміналі
- anchor: reading-game-and-system-logs-using-platform-specific-tools
  title: Читання журналів гри й системи за допомогою інструментів для конкретної платформи
- anchor: html5
  title: HTML5
- anchor: android
  title: Android
- anchor: ios
  title: iOS
- anchor: reading-the-game-log-from-the-log-file
  title: Читання журналу гри з файлу журналу
---

# Журнали гри й системи {#game-and-system-log}

У журналі гри відображається все виведення рушія, нативних розширень і вашої ігрової логіки. Команди [print()](/ref/base/#print:...) і [pprint()](/ref/builtins/?q=pprint#pprint:v) можна використовувати у скриптах і модулях Lua, щоб виводити інформацію в журнал гри. Для запису в журнал гри з нативних розширень можна використовувати функції з [простору імен `dmLog`](/ref/dmLog/). Журнал гри можна читати в редакторі, у вікні термінала, за допомогою інструментів для конкретної платформи або з файлу журналу.
...
Коли ви запускаєте гру локально з редактора або підключаєтеся до [мобільного застосунку для розробки](/uk/manuals/dev-app), усе виведення відображається на панелі консолі редактора:

![Редактор 2](/manuals/images/editor/editor2_overview.png)
...
: Підключіть пристрій до комп’ютера з установленими macOS і Xcode.
  ...
  ![Завантаження контейнера](/manuals/images/debugging/download_container.png)

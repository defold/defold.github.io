...
Передавання повідомлень — це механізм у Defold, який дає ігровим об’єктам змогу спілкуватися один з одним. Цей посібник передбачає, що ви знайомі з [адресацією](/uk/manuals/addressing) у Defold та [базовими будівельними блоками](/uk/manuals/building-blocks).

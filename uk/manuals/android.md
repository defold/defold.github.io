...
- anchor: shrinking-java-code-with-r8
  title: Зменшення коду Java за допомогою R8
- anchor: enabling-r8
  title: Увімкнення R8
- anchor: adding-rules-to-an-extension
  title: Додавання правил до розширення
- anchor: keeping-the-obfuscation-mapping
  title: Збереження таблиці відповідностей обфускації
- anchor: permissions
  title: Дозволи
...
Правила збереження для розширення мають розташовуватися в його каталозі `manifests/android`, поряд із `build.gradle`. Про додавання файлу та збереження класів Java розширення читайте в розділі [Правила збереження R8 для розширень Android](/uk/manuals/extensions/#r8-keep-rules-for-android).

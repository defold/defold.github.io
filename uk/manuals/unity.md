...
| [Напис](/uk/manuals/label/) | Text / TextMeshPro | Defold має [розширення RichText](https://defold.com/assets/richtext/) для розширеного форматування (подібно до TextMeshPro). |

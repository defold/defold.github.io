...
- anchor: defold-editor-overview
  title: Огляд редактора Defold
- anchor: editors-comparison
  title: Порівняння редакторів
- anchor: defold-panes-overview
  title: Огляд панелей Defold
- anchor: key-concepts
  title: Ключові поняття
- anchor: building-blocks
  title: Будівельні блоки
- anchor: game-objects
  title: Ігрові об’єкти
- anchor: components
  title: Компоненти
- anchor: resources
  title: Ресурси
- anchor: collection-vs-scene
  title: Колекція та сцена
- anchor: project-resources-and-assets
  title: Ресурси та вміст проєкту
- anchor: assets
  title: Ресурси проєкту
- anchor: resource-formats
  title: Формати ресурсів
- anchor: library-cache
  title: Кеш бібліотеки
- anchor: code-writing
...
- anchor: cc-native-extensions
  title: Нативні розширення на C++/C
- anchor: from-monobehaviours-to-lua-modules
  title: Від MonoBehaviour до модулів Lua
- anchor: built-in-code-editor
  title: Вбудований редактор коду
- anchor: vs-code-and-other-editors
  title: VS Code та інші редактори
- anchor: shaders-glsl
  title: Шейдери — GLSL
...
- anchor: messaging-to-gui-and-render
  title: Надсилання повідомлень до GUI та рендерингу
- anchor: prefabs-and-instances
  title: Префаби та екземпляри
- anchor: factory
  title: Фабрика
- anchor: collection-factory
  title: Фабрика колекції
- anchor: collection-proxy
  title: Проксі колекції
- anchor: application-lifecycle
  title: Життєвий цикл застосунку
- anchor: initialization
  title: Ініціалізація
- anchor: when-messages-are-handled
  title: Коли обробляються повідомлення?
- anchor: update-loop
  title: Цикл оновлення
- anchor: finalization
  title: Завершення
- anchor: rendering
  title: Рендеринг
...
Якщо потрібні докладніші відомості, прочитайте цей короткий [посібник зі встановлення](/uk/manuals/install/).
...
![Порівняння екранів привітання](/manuals/images/unity/unity_defold_start.png)
...
![Порівняння шаблонів на екрані привітання](/manuals/images/unity/unity_defold_templates.png)
...
![Привіт, світе: крок 1](/manuals/images/unity/helloworld_1.png)
...
![Привіт, світе: крок 2](/manuals/images/unity/helloworld_2.png)
4. Клацніть правою кнопкою миші створений ігровий об’єкт (game object) `go` і виберіть `Add Component`, а потім `Label`.
![Привіт, світе: крок 3](/manuals/images/unity/helloworld_3.png)
...
![Привіт, світе: крок 4](/manuals/images/unity/helloworld_4.png)
...
![Привіт, світе: крок 5](/manuals/images/unity/helloworld_5.png)
...
Тут ми розглянемо редактор Defold з погляду того, що користувач Unity, імовірно, захоче дізнатися насамперед, але радимо потім ознайомитися з повним [посібником з огляду редактора](/uk/manuals/editor).
...
![Порівняння редакторів](/manuals/images/unity/defold_unity_editor.png)
...
![Панель інструментів Defold](/manuals/images/unity/defold_2d.png)

Також можна змінити `Grid Settings` на панелі інструментів, щоб використовувати площину `Y`, як у Unity:

![Налаштування 3D у Defold](/manuals/images/unity/defold_3d.png)
...
| [Налагоджувач](/uk/manuals/debugging/) | Visual Studio Debugger | Налагоджувач повністю інтегровано в Defold відразу після встановлення. Є додаткова вкладка для відстеження, увімкнення та вимкнення точок зупину. |
...
![Будівельні блоки](/manuals/images/unity/blocks.png)

Докладніше читайте в повному посібнику про [будівельні блоки Defold](/uk/manuals/building-blocks/).
...
Докладніше читайте [про компоненти Defold тут](/uk/manuals/components/).
...
| Defold | Unity | Відмінності |
|---|---|---|
| [Спрайт](/uk/manuals/sprite/) | Sprite Renderer | У Defold відтінок (властивість кольору) можна змінювати лише через код. |
| [Карта плиток](/uk/manuals/tilemap/) | Tilemap / Grid | Defold має вбудований редактор карт плиток, який підтримує квадратні сітки (але є розширення, наприклад, для [шестикутників](https://github.com/selimanac/defold-hexagon/)), і не має вбудованих правил автоматичного розміщення плиток. Інструменти на кшталт [Tiled](https://defold.com/assets/tiled/), [TileSetter](https://defold.com/assets/tilesetter/) чи [Sprite Fusion](https://defold.com/assets/spritefusion/) підтримують експорт у Defold. |
| [Напис](/uk/manuals/label/) | Text / TextMeshPro | Починаючи з Defold 1.13.2, компоненти Label і текстові вузли GUI підтримують вбудовану [розмітку форматованого тексту](/uk/manuals/font-richtext/) для кольорів, градієнтів, обведень і анімованих ефектів. Також доступне окреме [розширення RichText](https://defold.com/assets/richtext/). |
| [Звук](/uk/manuals/sound/) | AudioSource | У Defold є лише глобальне джерело звуку (не просторове). Для Defold є офіційне [розширення FMOD](https://github.com/defold/extension-fmod). |
| [Фабрика](/uk/manuals/factory/) | Prefab Instantiate() | У Defold фабрика (factory) — це компонент із певним прототипом (префабом). |
| [Фабрика колекції](/uk/manuals/collection-factory/) | - (Немає прямого відповідника компонента) | Компонент-фабрика колекції в Defold може одночасно створювати кілька ігрових об’єктів із батьківсько-дочірніми зв’язками. |
| [Об’єкт колізій](/uk/manuals/physics-objects) | Rigidbody + Collider | У Defold фізичні об’єкти та форми колізій поєднано в одному компоненті. |
| [Форми колізій](/uk/manuals/physics-shapes/)  | BoxCollider / SphereCollider / CapsuleCollider | У Defold форми (паралелепіпед, сфера, капсула) налаштовують усередині компонента Collision Object. Обидва рушії підтримують форми колізій із карт плиток і даних опуклих оболонок. |
| [Камера](/uk/manuals/camera/) | Camera | У Unity камера має дещо більше вбудованих налаштувань рендерингу й постобробки, тоді як Defold передає це користувачеві для власного керування через скрипт рендерингу. |
| [GUI](/uk/manuals/gui/) | UI Toolkit / Unity UI / uGUI Canvas | GUI у Defold — потужний компонент для створення повноцінних інтерфейсів і шаблонів. Unity не має подібного єдиного компонента інтерфейсу, натомість пропонує кілька фреймворків для інтерфейсів. Defold також має розширення для [розширення](https://github.com/britzl/extension-imgui). |
| [Скрипт GUI](/uk/manuals/gui-script/) | Скрипти Unity UI / uGUI | GUI у Defold можна керувати через скрипти GUI за допомогою спеціалізованого API `gui`. |
| [Модель](/uk/manuals/model/) | MeshRenderer + Material | У Defold компонент Model поєднує файл 3D-моделі, текстури та матеріал із шейдерами. |
| [Меш](/uk/manuals/mesh/) | MeshRenderer / MeshFilter / Процедурний меш | У Defold Mesh — це компонент для керування набором вершин через код. Він подібний до Model у Defold, але ще більш низькорівневий. |
| [Ефект частинок](/uk/manuals/particlefx/) | Particle System | Редактор частинок Defold підтримує 2D/3D-ефекти частинок із багатьма властивостями й дає змогу анімувати їх у часі за допомогою кривих у Curve Editor. Він не підтримує сліди чи колізії. |
| [Скрипт](/uk/manuals/script/) | Script | Відмінності в програмуванні докладніше пояснено нижче. |
...
| Defold | Unity | Відмінності |
|---|---|---|
| [Атлас](/uk/manuals/atlas/) | Sprite Atlas / Texture2D | Defold також має [розширення для Texture Packer](https://defold.com/extension-texturepacker/). |
| [Джерело плиток](/uk/manuals/tilesource/) | Tile Palette + Ресурс | У Defold джерело плиток можна використовувати як текстуру для карт плиток, а також для спрайтів чи частинок. |
| [Шрифт](/uk/manuals/font/) | Font | Використовується компонентом Label у Defold або текстовими вузлами GUI, подібно до Text/TextMeshPro у Unity. |
| [Матеріал](/uk/manuals/material/) | Material | У Defold шейдери називаються вершинною програмою та фрагментною програмою. |
...
Докладніше про колекції читайте в [посібнику про будівельні блоки](/uk/manuals/building-blocks/#collections).
...
Докладніше про розширення читайте в [посібнику з нативних розширень Defold](/uk/manuals/extensions/).
...
- [Посібник зі скриптів](/uk/manuals/script/)
- [Написання коду](/uk/manuals/writing-code/)
- [Налагодження](/uk/manuals/debugging/)
...
Ви також можете змінити налаштування редактора Defold, щоб текстові файли за замовчуванням відкривалися у VS Code (або будь-якому іншому зовнішньому редакторі). Подробиці дивіться в [налаштуваннях редактора](/uk/manuals/editor-preferences/).
...
Докладніше про шейдери читайте в [посібнику з шейдерів](/uk/manuals/shader).
...
Докладніше про матеріали читайте в [посібнику з матеріалів](/uk/manuals/material).
...
Докладніше читайте в [посібнику з передавання повідомлень](/uk/manuals/message-passing/).
...
Докладніше читайте в [посібнику з адресації](/uk/manuals/addressing/).
...
Докладніше читайте в [посібнику з фабрик](/uk/manuals/factory/). 
...
Докладніше читайте в [посібнику з фабрик колекцій](/uk/manuals/collection-factory/).
...
Докладніше читайте в [посібнику з керування ресурсами](/uk/manuals/resource/). 
...
Докладніше читайте в [посібнику з проксі колекції](/uk/manuals/collection-proxy/).
...
| `on_input` | Методи введення | Defold отримує введення, коли [скрипт отримав фокус введення](/uk/manuals/input/#input-focus). Обробляється першим у циклі оновлення. |
| `fixed_update()` | `FixedUpdate()` | Викликається з фіксованим кроком часу. Щоб увімкнути його в Defold, потрібно встановити `Use Fixed Timestep` — [подробиці](https://defold.com/uk/manuals/project-settings/#use-fixed-timestep). Починаючи з версії 1.12.0, виконується перед `update()`. |
...
Докладніше читайте в [посібнику з життєвого циклу застосунку](/uk/manuals/application-lifecycle/).
...
Докладніше читайте в [посібнику з GUI](/uk/manuals/gui/).

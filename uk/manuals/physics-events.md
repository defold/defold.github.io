...
- anchor: defold-physics-event-handling
  title: Обробка подій фізики в Defold
- anchor: setting-the-physics-world-listener
  title: Встановлення слухача фізичного світу
- anchor: event-data-structure
  title: Структура даних подій
...
Якщо слухач встановлено, [повідомлення фізики](/uk/manuals/physics-messages) більше не надсилатимуться для фізичного світу, у якому його встановлено.
</div>

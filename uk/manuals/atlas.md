...
Якщо текстуру потрібно використовувати в [компоненті спрайта](/uk/manuals/sprite/), її спочатку потрібно додати до атласу. Використовуйте [`resource.create_atlas(path, params)`](https://defold.com/ref/resource/#resource.create_atlas:path-table), щоб створити атлас:

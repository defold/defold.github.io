...
: Перетягніть зображення з панелі *Asset* в область редактора.
  ...
  ![Створення атласу, додавання зображень](/manuals/images/atlas/add.png)
  ...
  ![Додані зображення](/manuals/images/atlas/single_images.png)
...
: <kbd>Клацніть правою кнопкою миші</kbd> кореневий елемент Atlas на панелі *Outline*.
  ...
  ![Створення атласу, додавання зображень](/manuals/images/atlas/add_animation.png)
  ...
  ![Група анімації](/manuals/images/atlas/animation_group.png)
...
![Багатосторінковий атлас](/manuals/images/atlas/multipage_atlas.png)
...
![Властивості атласу](/manuals/images/atlas/atlas_properties.png)
...
![Властивості зображення](/manuals/images/atlas/image_properties.png)
...
Текстуру можна використовувати безпосередньо в [компоненті моделі](/uk/manuals/model/) за допомогою `go.set()`:
...
Якщо текстуру потрібно використовувати в [компоненті спрайта](/uk/manuals/sprite/), її спочатку потрібно додати до атласу. Використовуйте [`resource.create_atlas(path, params)`](https://defold.com/ref/stable/resource/#resource.create_atlas:path-table), щоб створити атлас:

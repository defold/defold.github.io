...
toc:
- anchor: lua-in-defold
  title: Lua у Defold
- anchor: lua-versions
  title: Версії Lua
- anchor: standard-libraries-and-extensions
  title: Стандартні бібліотеки й розширення
- anchor: lua-books-and-resources
  title: Книжки та ресурси з Lua
...
- anchor: operators
  title: Оператори
- anchor: flow-control
  title: Керування потоком виконання
- anchor: locals-globals-and-lexical-scoping
  title: Локальні й глобальні змінні та лексична область видимості
- anchor: variable-shadowing
  title: Затінення змінних
- anchor: coroutines
  title: Співпрограми
- anchor: lua-contexts-in-defold
  title: Контексти Lua у Defold
- anchor: performance-considerations
  title: Міркування щодо продуктивності
- anchor: memory-and-garbage-collection
  title: Пам’ять і збирання сміття
...
![Контексти](/manuals/images/lua/lua_contexts.png)
...
: Як і в модулі Lua, код скрипту можна розмістити в ігровому об’єкті з компонентом-скриптом. Різниця в тому, що з кодом в ігровому об’єкті можна взаємодіяти виключно через передавання повідомлень.
  ...
  ![Допоміжний об’єкт](/manuals/images/lua/lua_helper.png)
...
: За такого підходу можна створити ігровий об’єкт поведінки, який автоматично впливає на інший цільовий ігровий об’єкт: за заздалегідь визначеним іменем (користувач має відповідно перейменувати цільовий ігровий об’єкт) або через URL у `go.property()`, що вказує на цільовий ігровий об’єкт.
  ...
  ![Колекція](/manuals/images/lua/lua_collection.png)

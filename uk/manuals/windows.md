...
- anchor: creating-ico-file-locally-using-imagemagick-software-suite
  title: Локальне створення файлу .ico за допомогою пакета програм ImageMagick.
- anchor: faq
...
Специфічні для Windows налаштування застосунку задаються в [розділі Windows](/uk/manuals/project-settings/#windows) файлу налаштувань *game.project*.
...
{% include shared/uk/windows-faq.md %}
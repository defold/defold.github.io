...
- anchor: rich-text-markup
  title: Розмітка форматованого тексту
...
- anchor: interaction-messages
  title: Повідомлення взаємодії
- anchor: named-styles
  title: Іменовані стилі
- anchor: layout-object-api
  title: API об’єктів компонування
- label.get_layout_objects()
- gui.get_layout_objects()
- anchor: returned-object-fields
  title: Поля поверненого об’єкта
- anchor: lua-example
  title: Приклад Lua
- anchor: useful-combinations
  title: Корисні поєднання
- anchor: colored-outline-with-a-horizontal-gradient
  title: Кольорове обведення з горизонтальним градієнтом
- anchor: shake-a-sentence-gradient-one-word
  title: Тремтіння речення й градієнт одного слова
- anchor: override-one-property-without-losing-the-others
  title: Перевизначення однієї властивості зі збереженням інших
---
...
![Текст прикладу, відображений непрозорим зеленим](/manuals/images/richtext/color_green.webp)
...
![Текст прикладу, відображений напівпрозорим зеленим](/manuals/images/richtext/color_green_alpha.webp)
...
![Текст прикладу, відображений розміром 24 пікселі](/manuals/images/richtext/size_24.webp)
...
![Текст прикладу, відображений розміром 120 відсотків від 32 пікселів](/manuals/images/richtext/size_120.webp)
...
![Текст прикладу, відображений удвічі більшим за базовий розмір 32 пікселі](/manuals/images/richtext/size_2em.webp)
...
![Текст прикладу з горизонтальним градієнтом від пурпурового до білого](/manuals/images/richtext/gradient_horizontal.webp)
...
![Текст прикладу з вертикальним синім градієнтом](/manuals/images/richtext/gradient_vertical.webp)
...
![Текст прикладу з градієнтом за чотирма кутами, застосованим до кожного гліфа](/manuals/images/richtext/gradient_four_glyph.webp)
...
![Текст прикладу з градієнтом за чотирма кутами, застосованим до фрагмента](/manuals/images/richtext/gradient_four_text.webp)
...
![Анімований градієнт із перетіканням, застосований до кожного гліфа](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![Анімований градієнт із перетіканням, застосований до фрагмента](/manuals/images/richtext/gradient_flow_span.webp)
...
![Текст прикладу із суцільним підкресленням](/manuals/images/richtext/underline_solid.webp)
...
![Текст прикладу зі штриховим підкресленням](/manuals/images/richtext/underline_dashed.webp)
...
![Текст прикладу з градієнтним підкресленням](/manuals/images/richtext/underline_gradient.webp)
...
![Текст прикладу із суцільним закресленням](/manuals/images/richtext/strike_solid.webp)
...
![Текст прикладу зі штриховим закресленням](/manuals/images/richtext/strike_dashed.webp)
...
![Текст прикладу із зовнішнім чорним обведенням](/manuals/images/richtext/outline.webp)
...
![Текст прикладу зі зміщеною тінню](/manuals/images/richtext/shadow.webp)
...
![Текст прикладу з анімованим тремтінням окремих гліфів](/manuals/images/richtext/shake_glyph.webp)
...
![Текст прикладу з анімованим тремтінням усього фрагмента](/manuals/images/richtext/shake_span.webp)
...
![Текст прикладу з анімованим хвильовим рухом окремих гліфів](/manuals/images/richtext/wave_glyph.webp)
...
![Текст прикладу, що рухається як один анімований фрагмент](/manuals/images/richtext/wave_span.webp)
...
![Логотип Defold, відображений у рядку тексту](/manuals/images/richtext/sprite.webp)
...
![www.defold.com зі стандартним стилем посилання й підкресленням](/manuals/images/richtext/link.webp)
...
Докладні відомості про налаштування наведено в розділах [Фокус введення](/uk/manuals/input/#input-focus) і [Введення мишею й дотиком](/uk/manuals/input-mouse-and-touch).

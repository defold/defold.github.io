...
- anchor: setting-up-amazon-web-service
  title: Налаштування Amazon Web Service
---
...
1. Створіть бакет (bucket) для ресурсів Live update
    ...
    ![Створення бакета](/manuals/images/live-update/01-create-bucket.png)
...
2. Додайте політику бакета
    ...
    ![Політика бакета](/manuals/images/live-update/02-bucket-policy.png)
...
3. Додайте конфігурацію CORS до бакета (необов’язково)
    ...
    ![Конфігурація CORS](/manuals/images/live-update/03-cors-configuration.png)
...
4. Створіть політику IAM
    ...
    ![Політика IAM](/manuals/images/live-update/04-create-policy.png)
...
6. Створіть файл профілю облікових даних
    ...
    ![Налаштування Live update](/manuals/images/live-update/05-liveupdate-settings.png)
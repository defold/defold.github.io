...
- anchor: physically-based-rendering-pbr
  title: Фізично обґрунтований рендеринг (PBR)
- anchor: material-properties-overview
  title: Огляд властивостей матеріалів
- anchor: shader-integration
  title: Інтеграція з шейдерами
- anchor: example-shader
  title: Приклад шейдера
- anchor: constants
  title: Константи
- anchor: next-steps
...
![Константи матеріалу](/manuals/images/physically-based-rendering/material-constants.png)
...
* [Посібник із шейдерів](/uk/manuals/shader)
* [Посібник із рендерингу](/uk/manuals/render)

...
- anchor: editor-script-runtime
  title: Середовище виконання скриптів редактора
- anchor: anatomy-of-editor_script
  title: Будова .editor_script
- anchor: editor-api
  title: API редактора
- anchor: commands
  title: Команди
- anchor: use-commands-to-change-the-in-memory-editor-state
  title: Змінення стану редактора в пам’яті за допомогою команд
- anchor: use-commands-with-the-active-editor-view
  title: Використання команд з активною областю редактора
- anchor: use-shell-commands
  title: Використання команд оболонки
- anchor: lifecycle-hooks
  title: Обробники життєвого циклу
- anchor: language-servers
  title: Мовні сервери
- anchor: http-server
  title: HTTP-сервер
- anchor: editor-scripts-in-libraries
  title: Скрипти редактора в бібліотеках
- anchor: preferences
  title: Налаштування редактора
- anchor: execution-modes
  title: Режими виконання
- anchor: actions
  title: Дії
- anchor: undoable-actions
  title: Дії, які можна скасувати
- anchor: non-undoable-actions
  title: Дії, які не можна скасувати
- anchor: mixing-actions-and-side-effects
  title: Поєднання дій і побічних ефектів
---
...
- `editor.ui.*` — різні функції для роботи з інтерфейсом користувача, див. [посібник з інтерфейсів скриптів редактора](/uk/manuals/editor-scripts-ui).
...
- `on_bundle_started(opts)` — виконується, коли ви створюєте пакет або збираєте HTML5-версію гри. Як і з `on_build_started`, зміни, спричинені цим обробником, з’являться в пакеті, а помилки перервуть пакування. `opts` матиме такі ключі:
  ...
  - `platform` — платформа, для якої пакується гра. Перелік можливих значень платформи див. у [посібнику з Bob](/uk/manuals/bob).
...
Редактор підтримує частину можливостей [Language Server Protocol](https://microsoft.github.io/language-server-protocol/): діагностику (перевірки коду), автодоповнення, інформацію при наведенні, символи документа на панелі Structure, перехід до визначення, пошук посилань і перейменування символів. Наведіть вказівник на символ, щоб побачити інформацію від мовного сервера. Розташувавши курсор на символі, натисніть <kbd>F2</kbd>, щоб перейменувати його, <kbd>F12</kbd>, щоб перейти до його визначення, або <kbd>Shift+F12</kbd>, щоб знайти посилання. Ці дії також доступні в меню <kbd>Edit</kbd>.

Щоб визначити мовний сервер, відредагуйте функцію `get_language_servers` свого скрипту редактора так:
...
- `languages` (обов’язкове) — список мов, з якими працює сервер, визначених [тут](https://code.visualstudio.com/docs/languages/identifiers#known-language-identifiers) (розширення файлів також підходять);
...
- вкладеність: кожен ключ налаштування — це рядок із частинами, розділеними крапками, де перший сегмент шляху визначає скрипт редактора, а решта 

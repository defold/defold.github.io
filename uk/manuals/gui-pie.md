...
- anchor: gui-pie-nodes
  title: Вузли Pie у GUI
- anchor: creating-a-pie-node
  title: Створення вузла Pie
- anchor: modify-pie-nodes-at-runtime
  title: Змінення вузлів Pie під час виконання
---
...
![Створення вузла Pie](/manuals/images/gui-pie/create.png)
...
![Властивості](/manuals/images/gui-pie/properties.png)

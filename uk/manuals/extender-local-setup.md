...
- anchor: build-server-local-setup
  title: Локальне налаштування сервера збирання
- anchor: how-to-run-local-extender-with-preconfigured-artifacts
  title: Як запустити локальний Extender із попередньо налаштованими артефактами
- anchor: what-about-macos-and-ios
  title: А як щодо macOS та iOS?
- anchor: how-to-run-local-extender-with-locally-built-artifacts
  title: Як запустити локальний Extender із локально зібраними артефактами
---

...
- anchor: components
  title: Компоненти
- anchor: props
  title: Властивості props
- anchor: alignment
  title: Вирівнювання
- anchor: built-in-components
  title: Вбудовані компоненти
- anchor: layout-components
  title: Компоненти компонування
- anchor: data-presentation-components
  title: Компоненти подання даних
- anchor: input-components
  title: Компоненти введення
- anchor: dialog-related-components
  title: Компоненти діалогових вікон
- anchor: utility-components
  title: Допоміжні компоненти
- anchor: reactivity
  title: Реактивність
- anchor: rules-of-reactivity
  title: Правила реактивності
- anchor: hooks
  title: Хуки
- '**use_state**'
- '**use_memo**'
...
Цей посібник пояснює, як створювати інтерактивні елементи інтерфейсу користувача (UI) в редакторі за допомогою скриптів редактора, написаних мовою Lua. Щоб почати працювати зі скриптами редактора, перегляньте [посібник зі скриптів редактора](/uk/manuals/editor-scripts). Повний довідник API редактора можна знайти [тут](/ref/stable/editor-lua/). Наразі можна створювати лише інтерактивні діалогові вікна, але в майбутньому ми хочемо розширити підтримку скриптів UI на решту редактора.
...
![Діалогове вікно «Привіт, світе»](/manuals/images/editor_scripts/perform_action_dialog.png)
...
![Вирівнювання](/manuals/images/editor_scripts/alignment.png)
...
![Внутрішні відступи та проміжки](/manuals/images/editor_scripts/padding_and_spacing.png)
...
![Діалогове вікно створення рівня](/manuals/images/editor_scripts/new_level_dialog.png)
...
![Компоненти введення](/manuals/images/editor_scripts/inputs_demo.png)
...
![Діалогове вікно створення файлу](/manuals/images/editor_scripts/reactive_new_file_dialog.png)

...
A: Die folgenden Plattformen werden unterstützt:

  **Editor und Werkzeuge**

  | System             | Version            | Architekturen      |
  | ------------------ | ------------------ | ------------------ |
...
A: Mit einem Klick kannst du für PS4™, PS5™, Nintendo Switch, iOS (64-Bit), Android (32-Bit und 64-Bit) und HTML5 sowie macOS (x86-64 und arm64), Windows (64-Bit) und Linux (x86-64 und arm64) veröffentlichen. Es ist tatsächlich eine einzige Codebasis mit Unterstützung für mehrere Plattformen.


#### Q: Auf welcher Rendering-API basiert Defold? {#q-what-rendering-api-does-defold-rely-on}

A: Bei der Entwicklung musst du dich nur mit einer einzigen Render-API befassen, die eine [vollständig skriptgesteuerte Rendering-Pipeline](/de/manuals/render/) verwendet. Die Render-Skript-API von Defold übersetzt Renderoperationen in die folgenden Grafik-APIs:

{% include shared/de/graphics-api.md %}
...
{% include shared/de/linux-faq.md %}


## Fragen zu Android {#android-questions}
{% include shared/de/android-faq.md %}


## Fragen zu HTML5 {#html5-questions}
{% include shared/de/html5-faq.md %}


## Fragen zu iOS {#ios-questions}
{% include shared/de/ios-faq.md %}


## Fragen zu Windows {#windows-questions}
{% include shared/de/windows-faq.md %}


## Fragen zu Konsolen {#console-questions}
{% include shared/de/consoles-faq.md %}
...
A: Im Allgemeinen werden alle Ressourcen statisch deklariert. Das hat den Vorteil, dass du die Ressourcenverwaltung ohne weiteren Aufwand erhältst. Mit [Ressourceneigenschaften](/de/manuals/script-properties/#resource-properties) kannst du ändern, welche Ressource einer Komponente zugewiesen ist.
...
A: Ja, setze das Flag *physics.debug* in *game.project*. (Siehe die offizielle [Dokumentation der Projekteinstellungen](/de/manuals/project-settings/#debug))
...
A: Defold führt im Hintergrund eine angepasste Version von Box2D aus, und der Leistungsaufwand sollte sehr ähnlich sein. Du kannst jederzeit sehen, wie viel Zeit die Engine für die Physik benötigt, indem du den [Profiler](/de/manuals/debugging) öffnest. Du solltest auch berücksichtigen, welche Arten von Kollisionsobjekten du verwendest. Statische Objekte benötigen beispielsweise weniger Rechenleistung. Weitere Einzelheiten findest du in der offiziellen [Physik-Dokumentation](/de/manuals/physics) von Defold.

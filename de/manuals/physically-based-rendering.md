...
- anchor: physically-based-rendering-pbr
  title: Physikalisch basiertes Rendering (PBR)
- anchor: material-properties-overview
  title: Übersicht der Materialeigenschaften
- Shader-Integration
- anchor: example-shader
  title: Beispiel-Shader
- anchor: constants
  title: Konstanten
- anchor: next-steps
...
![Materialkonstanten](/manuals/images/physically-based-rendering/material-constants.png)

...
- anchor: creating-ico-file-locally-using-imagemagick-software-suite
  title: Eine .ico-Datei lokal mit der Softwaresammlung ImageMagick erstellen.
- FAQ
---
...
Die Windows-spezifische Konfiguration der Anwendung erfolgt im [Windows-Abschnitt](/de/manuals/project-settings/#windows) der Einstellungsdatei *game.project*.

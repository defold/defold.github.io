...
- anchor: ios-development
  title: Entwicklung für iOS
- anchor: apples-code-signing-process
  title: Apples Verfahren zur Codesignierung
- anchor: developing-using-a-free-apple-developer-account
  title: Mit einem kostenlosen Apple-Entwicklerkonto entwickeln
- anchor: creating-an-ios-application-bundle
  title: Ein iOS-Anwendungsbundle erstellen
- anchor: custom-infoplist-and-local-target-discovery
  title: Benutzerdefinierte Info.plist und Erkennung lokaler Ziele
- anchor: installing-and-launching-bundle-on-a-connected-iphone
  title: Ein Bundle auf einem verbundenen iPhone installieren und starten
- anchor: creating-a-storyboard
  title: Ein Storyboard erstellen
- anchor: creating-an-icon-asset-catalog
  title: Einen Asset-Katalog für Symbole erstellen
- anchor: installing-an-ios-application-bundle
  title: Ein iOS-Anwendungsbundle installieren
- anchor: export-compliance-information
  title: Angaben zur Einhaltung von Exportvorschriften
- FAQ
---
...
iOS verlangt, dass _jede_ App, die du erstellst und auf deinem Telefon oder Tablet ausführen möchtest, mit einem von Apple ausgestellten Zertifikat und Bereitstellungsprofil (provisioning profile) signiert werden _muss_. Dieses Handbuch erläutert die Schritte zur Erstellung eines Bundles deines Spiels für iOS. Während der Entwicklung ist es oft vorzuziehen, dein Spiel über die [Entwicklungs-App](/de/manuals/dev-app) auszuführen, da du damit Inhalte und Code per Hot Reload direkt auf dein Gerät laden kannst.
...
: Die UDID eines iOS-Geräts findest du, indem du das Gerät per WLAN oder Kabel mit einem Computer verbindest. Öffne Xcode und wähle <kbd>Window ▸ Devices and Simulators</kbd>. Wenn du dein Gerät auswählst, werden die Seriennummer und die Kennung angezeigt.
  ...
  ![Geräte in Xcode](/manuals/images/ios/xcode_devices.png)
  ...
  ![Geräte in iTunes](/manuals/images/ios/itunes_devices.png)
...
![iOS-Bundle signieren](/manuals/images/ios/sign_bundle.png)
...
![iOS-Anwendungsbundle im IPA-Format](/manuals/images/ios/ipa_file.png)

Das Symbol für die App, das Storyboard für den Startbildschirm und weitere Angaben legst du in der Projekteinstellungsdatei *game.project* im [Abschnitt iOS](/de/manuals/project-settings/#ios) fest.
...
{% include shared/de/build-variants.md %}
...
![iOS-Bundle installieren und starten](/manuals/images/ios/install_and_launch.png)
...
Wenn der Editor den Installationsort des Werkzeugs ios-deploy nicht erkennen kann, musst du ihn in den [Editoreinstellungen](/de/manuals/editor-preferences/#tools) angeben. 
...
![Projekt erstellen](/manuals/images/ios/xcode_create_project.png)

Klicke auf Next und fahre mit der Konfiguration deines Projekts fort. Gib einen Product Name ein:

![Projekteinstellungen](/manuals/images/ios/xcode_storyboard_create_project_settings.png)
...
![Die Projektansicht](/manuals/images/ios/xcode_storyboard_project_view.png)
...
![Bild hinzufügen](/manuals/images/ios/xcode_storyboard_add_image.png)
...
![Bildansicht hinzufügen](/manuals/images/ios/xcode_storyboard_add_imageview.png)

Ziehe die Komponente Image View auf das Storyboard:

![Zum Storyboard hinzufügen](/manuals/images/ios/xcode_storyboard_add_imageview_to_storyboard.png)
...
![Projekteinstellungen](/manuals/images/ios/xcode_icons_create_project_settings.png)
...
![Die Projektansicht](/manuals/images/ios/xcode_icons_project_view.png)

Ziehe Bilder in die leeren Felder für die verschiedenen unterstützten Symbolgrößen und lege sie dort ab:

![Symbole hinzufügen](/manuals/images/ios/xcode_icons_add_icons.png)
...
![Projekt erstellen](/manuals/images/ios/xcode_icons_build.png)
...
![Symbol und Asset-Katalog zu game.project hinzufügen](/manuals/images/ios/defold_icons_game_project.png)
...
{% include shared/de/apple-privacy-manifest.md %}

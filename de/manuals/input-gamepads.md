...
- anchor: digital-buttons
  title: Digitale Tasten
- anchor: analog-sticks
  title: Analogsticks
- anchor: multiple-gamepads
  title: Mehrere Gamepads
- anchor: connect-and-disconnect
  title: Verbinden und Trennen
- anchor: raw-gamepads
  title: Gamepad-Rohdaten
- anchor: gamepads-settings-file
  title: Gamepad-Einstellungsdatei
- anchor: unidentified-gamepads
  title: Nicht identifizierte Gamepads
- Gamepads in HTML5
- Standard-Gamepad
- anchor: gamepads-on-windows
  title: Gamepads unter Windows
- anchor: gamepads-on-android
  title: Gamepads unter Android
---

<div class='sidenote' markdown='1'>
Es wird empfohlen, dass du dich damit vertraut machst, wie Eingaben in Defold grundsätzlich funktionieren, wie du sie empfängst und in welcher Reihenfolge deine Skriptdateien sie erhalten. Mehr über das Eingabesystem erfährst du im [Handbuch zur Eingabeübersicht](/de/manuals/input).
</div>
...
![Gamepad-Einstellungen](/manuals/images/input/gamepads.png)
...
![Gamepad-Einstellungen](/manuals/images/input/gamepad_setting.png)

...
- anchor: creating-a-gui-component
  title: Eine GUI-Komponente erstellen
- anchor: gui-properties
  title: GUI-Eigenschaften
...
- anchor: node-properties
  title: Knoteneigenschaften
- anchor: pivot-anchors-and-adjust-mode
  title: Bezugspunkt, Verankerungen und Anpassungsmodus
- anchor: draw-order
  title: Zeichenreihenfolge
- anchor: parent-child-hierarchies
  title: Eltern-Kind-Hierarchien
- anchor: layers-and-draw-calls
  title: Ebenen und Zeichenaufrufe
---
...
![Neue GUI-Datei](/manuals/images/gui/new_gui_file.png)

Defold öffnet die Datei nun automatisch im GUI-Szeneneditor.

![Neue GUI](/manuals/images/gui/new_gui.png)
...
Der zentrale Bearbeitungsbereich zeigt die GUI. Die Werkzeugleiste oben rechts im Bearbeitungsbereich enthält die Werkzeuge *Move*, *Rotate* und *Scale* sowie eine Auswahl für das [Layout](/de/manuals/gui-layouts).

![Werkzeugleiste](/manuals/images/gui/toolbar.png)
...
![Schriftart abrufen und festlegen](/manuals/images/gui/get_set_font.png)
...
![Material abrufen und festlegen](/manuals/images/gui/get_set_material.png)
...
![Textur abrufen und festlegen](/manuals/images/gui/get_set_texture.png)
...
![Abhängigkeiten](/manuals/images/gui/dependencies.png)
...
Box-Knoten
: ![Box-Knoten](/manuals/images/icons/gui-box-node.png)
  Rechteckiger Knoten mit einer einzelnen Farbe, einer Textur oder einer Flipbook-Animation. Einzelheiten findest du in der [Dokumentation zu Box-Knoten](/de/manuals/gui-box).

<div style="clear: both;"></div>

Textknoten
: ![Textknoten](/manuals/images/icons/gui-text-node.png)
  Zeigt Text an. Einzelheiten findest du in der [Dokumentation zu Textknoten](/de/manuals/gui-text).

<div style="clear: both;"></div>

Kreissektor-Knoten
: ![Kreissektor-Knoten](/manuals/images/icons/gui-pie-node.png)
  Ein kreisförmiger oder elliptischer Knoten, der teilweise gefüllt oder invertiert werden kann. Einzelheiten findest du in der [Dokumentation zu Kreissektor-Knoten](/de/manuals/gui-pie).

<div style="clear: both;"></div>

Vorlagenknoten
: ![Vorlagenknoten](/manuals/images/icons/gui.png)
  Vorlagen werden verwendet, um Instanzen auf Basis anderer GUI-Szenendateien zu erstellen. Einzelheiten findest du in der [Dokumentation zu Vorlagenknoten](/de/manuals/gui-template).

<div style="clear: both;"></div>

Partikeleffektknoten
: ![Partikeleffektknoten](/manuals/images/icons/particlefx.png)
  Spielt einen Partikeleffekt ab. Einzelheiten findest du in der [Dokumentation zu Partikeleffektknoten](/de/manuals/gui-particlefx).
...
![Knoten hinzufügen](/manuals/images/gui/add_node.png)
...
: Steuern die Position, Ausrichtung und Streckung des Knotens. Du kannst die Werkzeuge *Move*, *Rotate* und *Scale* verwenden, um diese Werte zu ändern. Die Werte lassen sich per Skript animieren ([mehr erfahren](/de/manuals/property-animation)).

Size (Box-Knoten, Textknoten und Kreissektor-Knoten)
: Die Größe des Knotens wird standardmäßig automatisch festgelegt. Wenn du *Size Mode* auf `Manual` setzt, kannst du den Wert jedoch ändern. Die Größe legt die Grenzen des Knotens fest und wird verwendet, um Knoten bei Eingaben zu ermitteln. Dieser Wert lässt sich per Skript animieren ([mehr erfahren](/de/manuals/property-animation)).
...
Slice 9 (Box-Knoten)
: Aktivieren, um die Pixelgröße der Knotentextur an den Rändern beizubehalten, wenn die Größe des Knotens geändert wird. Einzelheiten findest du in der [Dokumentation zu Box-Knoten](/de/manuals/gui-box).

Inner Radius (Kreissektor-Knoten)
: Der innere Radius des Knotens, angegeben entlang der X-Achse. Einzelheiten findest du in der [Dokumentation zu Kreissektor-Knoten](/de/manuals/gui-pie).

Outer Bounds (Kreissektor-Knoten)
: Steuert das Verhalten der äußeren Grenzen. Einzelheiten findest du in der [Dokumentation zu Kreissektor-Knoten](/de/manuals/gui-pie).

Perimeter Vertices (Kreissektor-Knoten)
: Die Anzahl der Segmente, aus denen die Form aufgebaut wird. Einzelheiten findest du in der [Dokumentation zu Kreissektor-Knoten](/de/manuals/gui-pie).

Pie Fill Angle (Kreissektor-Knoten)
: Wie viel des Kreissektors gefüllt werden soll. Einzelheiten findest du in der [Dokumentation zu Kreissektor-Knoten](/de/manuals/gui-pie).

Template (Vorlagenknoten)
: Die GUI-Szenendatei, die als Vorlage für den Knoten verwendet werden soll. Einzelheiten findest du in der [Dokumentation zu Vorlagenknoten](/de/manuals/gui-template).

ParticleFX (Partikeleffektknoten)
: Der Partikeleffekt, der auf diesem Knoten verwendet werden soll. Einzelheiten findest du in der [Dokumentation zu Partikeleffektknoten](/de/manuals/gui-particlefx).

Color
: Die Farbe des Knotens. Wenn der Knoten eine Textur hat, färbt die Farbe diese Textur ein. Die Farbe lässt sich per Skript animieren ([mehr erfahren](/de/manuals/property-animation)).

Alpha
: Die Transparenz des Knotens. Der Alphawert lässt sich per Skript animieren ([mehr erfahren](/de/manuals/property-animation)).
...
: Legt den Bezugspunkt (pivot) für den Knoten fest. Dieser kann als „Mittelpunkt“ des Knotens betrachtet werden. Jede Drehung, Skalierung oder Größenänderung erfolgt um diesen Punkt.
  ...
  ![Bezugspunkt](/manuals/images/gui/pivot.png)
...
: Die Verankerung steuert, wie die vertikale und horizontale Position des Knotens geändert wird, wenn die Grenzen der Szene oder des übergeordneten Knotens gestreckt werden, um sie an die physische Bildschirmgröße anzupassen.
  ...
  ![Verankerung ohne Anpassung](/manuals/images/gui/anchoring_unadjusted.png)
  ...
  ![Verankerung](/manuals/images/gui/anchoring.png)
...
: Legt den Anpassungsmodus für den Knoten fest. Diese Einstellung steuert, was mit einem Knoten geschieht, wenn die Grenzen der Szene oder des übergeordneten Knotens an die physische Bildschirmgröße angepasst werden.
  ...
  ![Ohne Anpassung](/manuals/images/gui/unadjusted.png)
  ...
  ![Anpassungsmodi](/manuals/images/gui/adjusted.png)
...
: Legt den Modus zum Beschneiden (Clipping) des Knotens fest:
  ...
  Einzelheiten findest du im [Handbuch zum Beschneiden von GUIs](/de/manuals/gui-clipping).

Clipping Visible (Box- und Kreissektor-Knoten)
: Aktivieren, um den Inhalt des Knotens im Stencil-Bereich zu rendern. Einzelheiten findest du im [Handbuch zum Beschneiden von GUIs](/de/manuals/gui-clipping).

Clipping Inverted (Box- und Kreissektor-Knoten)
: Invertiert die Stencil-Maske. Einzelheiten findest du im [Handbuch zum Beschneiden von GUIs](/de/manuals/gui-clipping).
...
![Zeichenreihenfolge](/manuals/images/gui/draw_order.png)
...
![Über- und untergeordnete Knoten](/manuals/images/gui/parent_child.png)
...
![Hierarchie unterbricht die Bündelung](/manuals/images/gui/break_batch.png)
...
![Ebenen](/manuals/images/gui/layers.png)

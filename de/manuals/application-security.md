...
- anchor: securing-your-intellectual-property-from-theft
  title: Dein geistiges Eigentum vor Diebstahl schützen
- anchor: source-code-obfuscation
  title: Quellcode-Verschleierung
- anchor: resource-encryption
  title: Ressourcenverschlüsselung
- anchor: encoding-project-configuration-values
  title: Projektkonfigurationswerte kodieren
- anchor: securing-your-game-against-cheaters
  title: Dein Spiel vor Cheatern schützen
- anchor: securing-your-network-communication
  title: Deine Netzwerkkommunikation absichern
- anchor: ssl-certificate-validation
  title: Validierung von SSL-Zertifikaten
- anchor: securing-your-use-of-third-party-software
  title: Drittanbietersoftware sicher verwenden
- anchor: securing-your-use-of-cloud-build-servers
  title: Cloud-Build-Server sicher nutzen
- anchor: securing-your-downloadable-content
  title: Deine herunterladbaren Inhalte absichern
---
...
Weitere Informationen zu diesem Vorgang findest du im [Handbuch zu Live Update](https://defold.com/de/manuals/live-update/#content-verification).
...
![bean im Editor](/manuals/images/addressing/bean_editor.png)
...
![Relativer Bezeichner](/manuals/images/addressing/relative_same.png)
...
{% include shared/de/url-shorthands.md %}
...
![Manager-Objekt](/manuals/images/addressing/manager_editor.png)
...
![Teams und Manager](/manuals/images/addressing/teams_manager.png)

![Absolute Adressierung](/manuals/images/addressing/absolute.png)
...
socket
: Bezeichnet die Spielwelt des Ziels. Das ist bei der Arbeit mit [Sammlungs-Proxys (collection proxies)](/de/manuals/collection-proxy) wichtig. Der Socket wird dann verwendet, um die _dynamisch geladene Sammlung_ zu bezeichnen.

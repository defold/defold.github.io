...
![Die Startseite des lokalen Editorservers](/manuals/images/automation/editor_server.png)
...
Informationen zur Abgrenzung von Testergebnissen und zur Klassifizierung von Fehlern findest du unter [Automatisiertes Testen und Überprüfen](/de/manuals/automated-testing/#structured-test-results).
...
![Eine vom Editor gerenderte Vorschau der Hauptsammlung](/manuals/images/automation/main-preview.png)
...
![Eine vom Editor gerenderte Vorschau des Würfelmodells](/manuals/images/automation/cube-preview.png)
...
Editor-Skripte können mit [`get_http_server_routes()`](/de/manuals/editor-scripts/#http-server) zusätzliche Routen definieren. Eine optionale OpenAPI-Operationstabelle macht eine Route über dasselbe Dokument `/openapi.json` wie die integrierten Operationen zugänglich.
...
Der Editorserver gehört zum Editorprozess. Ein laufendes Spiel hat einen anderen Port und andere Aufgaben, die im [Handbuch zum Engine-Dienst und zur Laufzeit-HTTP-API](/de/manuals/engine-service) beschrieben werden.
...
- anchor: functions-for-file-and-folder-access
  title: Funktionen für den Zugriff auf Dateien und Ordner
- anchor: file-and-folder-locations
  title: Speicherorte von Dateien und Ordnern
- anchor: how-to-save-and-load-application-specific-files
  title: Anwendungsspezifische Dateien speichern und laden
- anchor: how-to-access-files-bundled-with-the-application
  title: Auf Dateien zugreifen, die mit der Anwendung gebündelt sind
- anchor: system-file-access
  title: Zugriff auf Systemdateien
- anchor: extensions
  title: Erweiterungen
---
...
Erweiterungen können diese Dateien auch über `ext.properties` bereitstellen. Ihre Pfade werden sowohl bei Editor-Builds als auch bei Bob-Archiven mit den benutzerdefinierten Ressourcen des Projekts zusammengeführt. Siehe [benutzerdefinierte Ressourcen von Erweiterungen](/de/manuals/extensions/#custom-resources).

...
toc:
- anchor: ray-casts
  title: Strahlabfragen
---

## Strahlabfragen {#ray-casts}

Mit Strahlabfragen (raycast) liest du die Physikwelt (physics world) entlang eines geraden Strahls aus. Um einen Strahl in die Physikwelt zu senden, gibst du eine Start- und eine Endposition sowie [eine Menge von Kollisionsgruppen (collision groups)](/de/manuals/physics-groups) an, gegen die geprüft werden soll.

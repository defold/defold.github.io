...
- anchor: editor-language
  title: Sprache des Editors
- anchor: the-editor-views
  title: Die Bereiche des Editors
- anchor: 1-assets-pane
  title: 1. Bereich Assets
- anchor: the-scene-editor
  title: 2. Bereich Scene Editor
- anchor: 3-outline-pane
  title: 3. Bereich Outline
- anchor: 4-properties-pane
  title: 4. Bereich Properties
- anchor: 5-tools-pane
  title: 5. Bereich Tools
- anchor: 6-changed-files-pane
  title: 6. Bereich Changed Files
- anchor: menu-bar
  title: Menüleiste
- anchor: status-bar
  title: Statusleiste
- anchor: panes-size-and-visibility
  title: Größe und Sichtbarkeit der Bereiche
- anchor: tabs
  title: Registerkarten
- anchor: side-by-side-editing
  title: Nebeneinander bearbeiten
- anchor: creating-new-project-files
  title: Neue Projektdateien erstellen
- anchor: templates
  title: Vorlagen
- anchor: importing-files-to-your-project
  title: Dateien in dein Projekt importieren
- anchor: updating-the-editor
  title: Den Editor aktualisieren
- anchor: preferences
  title: Editoreinstellungen
- anchor: editor-logs
  title: Editorprotokolle
- anchor: editor-server
  title: Editorserver
- anchor: editor-installation-metadata
  title: Metadaten zur Editorinstallation
...
: Hier findest du deine zuletzt geöffneten Projekte, damit du schnell auf sie zugreifen kannst. Dies ist die Standardansicht des Startbildschirms.
  ...
  ![Meine Projekte](/manuals/images/editor/start_no_projects.png)


  Wenn du bereits Projekte geöffnet hast, erscheint eine Liste deiner Projekte, wie in der folgenden Abbildung:

  ![Meine Projekte](/manuals/images/editor/start_my_projects.png)
...
: Enthält Projekte, die bestimmte Anwendungsfälle veranschaulichen.
  ...
  ![Neues Projekt](/manuals/images/editor/start_templates.png)
...
Mehr über die verschiedenen Möglichkeiten erfährst du im [Handbuch zur Projekteinrichtung](https://www.defold.com/de/manuals/project-setup/).
...
![Sprachen](/manuals/images/editor/languages.png)
...
![Scene Editor](/manuals/images/editor/2d_scene.png)

Zu den zentralen Funktionen des Szeneneditors gehören:

- [Navigation in 2D- und 3D-Szenen](/de/manuals/scene-editing/#2d-and-3d-scene-orientation) mit orthografischen und perspektivischen Kameramodi
- [Transformationswerkzeuge](/de/manuals/scene-editing/#manipulating-objects) zum Verschieben, Drehen und Skalieren von Objekten
- [Freier Kameramodus (Free Camera Mode)](/de/manuals/scene-editing/#free-camera-mode) für die 3D-Navigation aus der Ich-Perspektive
- [Rastereinstellungen](/de/manuals/scene-editing/#grid-settings) mit konfigurierbarer Größe, Ebene und Darstellung
- [Sichtbarkeitsfilter](/de/manuals/scene-editing/#visibility-filters) zum Ein- und Ausblenden von Komponententypen und Hilfslinien

Mehr dazu erfährst du im [Handbuch zum Szeneneditor](/de/manuals/scene-editing/).
...
![Outline](/manuals/images/editor/outline.png)
...
![Properties](/manuals/images/editor/properties.png)
...
![Sichtbarkeit der Bereiche](/manuals/images/editor/editor_panes.png)
...
- `➝| Open As` auswählen, um einen anderen Editor als den Standardeditor oder das zugeordnete externe Werkzeug zu verwenden, das unter `File ▸ Preferences ▸ Code ▸ Custom Editor` festgelegt ist. Mehr dazu erfährst du im [Handbuch zu den Editoreinstellungen](/de/manuals/editor-preferences).

![Registerkarten](/manuals/images/editor/tabs_custom.png)
...
![2 Bereiche](/manuals/images/editor/2-panes.png)
...
![Datei erstellen](/manuals/images/editor/create_file.png)
...
![Dateinamen festlegen](/manuals/images/editor/create_file_name.png)

## Vorlagen {#templates}

Du kannst für jedes Projekt eigene Vorlagen festlegen. Erstelle dazu einen neuen Ordner namens `templates` im Stammverzeichnis des Projekts und füge neue Dateien namens `default.*` mit den gewünschten Erweiterungen hinzu, beispielsweise `/templates/default.gui` oder `/templates/default.script`. Wenn in diesen Dateien das Token `{% raw %}{{NAME}}{% endraw %}` verwendet wird, wird es außerdem durch den im Fenster zur Dateierstellung angegebenen Dateinamen ersetzt.
...
![Update über die Projektauswahl](/manuals/images/editor/update_start.png)
![Update über den Editor](/manuals/images/editor/update_available.png)
...
![Popup zum Aktualisieren des Editors](/manuals/images/editor/update.png)

Den Downloadfortschritt siehst du in der unteren Statusleiste:

![Downloadfortschritt](/manuals/images/editor/download_status.png)
...
![Zum Aktualisieren neu starten](/manuals/images/editor/restart_to_update.png)
...
Weitere Einzelheiten findest du im [Handbuch zu den Editoreinstellungen](/de/manuals/editor-preferences)

![Editoreinstellungen](/manuals/images/editor/preferences.png)
...
Mehr dazu erfährst du im [Handbuch zur Hilfesuche](/de/manuals/getting-help/#getting-help).

![Protokolle anzeigen](/manuals/images/editor/show_logs.png)
...
Du kannst das Aussehen des Editors durch eigene Stile anpassen. Mehr dazu erfährst du im [Handbuch zur Gestaltung des Editors](/de/manuals/editor-styling).

## FAQ
{% include shared/de/editor-faq.md %}
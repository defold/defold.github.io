...
- anchor: texture-filtering-and-sampling
  title: Texturfilterung und Abtastung
---
...
Die Einstellung für die verwendete Filterung wird in der Datei mit den [Projekteinstellungen](/de/manuals/project-settings/#graphics) gespeichert. Es gibt zwei Einstellungen:
...
Beachte, dass die Einstellung in *game.project* von den Standard-Samplern verwendet wird. Wenn du Sampler in einem benutzerdefinierten Material angibst, kannst du die Filtermethode für jeden Sampler gesondert festlegen. Einzelheiten findest du im [Handbuch zu Materialien](/de/manuals/material/).
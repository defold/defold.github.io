...
- anchor: gui-text-nodes
  title: GUI-Textknoten
- anchor: adding-text-nodes
  title: Textknoten hinzufügen
- anchor: alignment
  title: Ausrichtung
- anchor: modifying-text-nodes-in-runtime
  title: Textknoten zur Laufzeit ändern
---
...
![Schriftarten](/manuals/images/gui-text/fonts.png)
...
![Textausrichtung](/manuals/images/gui-text/align.png)

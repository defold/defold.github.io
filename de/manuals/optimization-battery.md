...
- anchor: optimize-battery-usage
  title: Den Akkuverbrauch optimieren
- anchor: disable-accelerometer
  title: Den Beschleunigungssensor deaktivieren
...
In den Handbüchern dazu, wie du die [Leistung eines Spiels zur Laufzeit optimierst](/de/manuals/optimization-speed), erfährst du, wie du die CPU- und GPU-Auslastung reduzierst.

## Den Beschleunigungssensor deaktivieren {#disable-accelerometer}
Wenn du ein mobiles Spiel entwickelst, das den Beschleunigungssensor des Geräts nicht verwendet, solltest du [ihn in *game.project* deaktivieren](/de/manuals/project-settings/#use-accelerometer), um die Anzahl der erzeugten Eingabeereignisse zu reduzieren.

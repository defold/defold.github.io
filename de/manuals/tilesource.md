...
- anchor: creating-a-tile-source
  title: Eine Kachelquelle erstellen
- anchor: tile-source-flip-book-animations
  title: Flipbook-Animationen einer Kachelquelle
- anchor: tile-source-collision-shapes
  title: Kollisionsformen einer Kachelquelle
---

# Kachelquelle {#tile-source}

Eine *Kachelquelle* (tile source) kann von einer [Kachelkartenkomponente (tile map component)](/de/manuals/tilemap) verwendet werden, um Kacheln auf eine Rasterfläche zu zeichnen, oder als Grafikquelle für ein [Sprite](/de/manuals/sprite) oder eine [Partikeleffektkomponente (particle effect component)](/de/manuals/particlefx) dienen. Du kannst auch die *Kollisionsformen* (collision shapes) der Kachelquelle in einer Kachelkarte für die [Kollisionserkennung und Physiksimulation](/de/manuals/physics) verwenden ([Beispiel](/examples/tilemap/collisions/)).
...
![Kachelbild](/manuals/images/tilemap/small_map.png)
...
![Eine Kachelquelle erstellen](/manuals/images/tilemap/tilesource.png)
...
![Animation einer Kachelquelle](/manuals/images/tilemap/animation.png)
...
![Kollisionsformen](/manuals/images/tilemap/collision.png)

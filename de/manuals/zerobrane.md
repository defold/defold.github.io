...
- anchor: debugging-lua-scripts-with-zerobrane-studio
  title: Lua-Skripte mit ZeroBrane Studio debuggen
- anchor: zerobrane-configuration
  title: ZeroBrane konfigurieren
- anchor: to-set-up-zerobrane
  title: ZeroBrane einrichten
- anchor: starting-the-debugging-server
  title: Den Debugging-Server starten
- anchor: connecting-your-application-to-the-debugger
  title: Deine Anwendung mit dem Debugger verbinden
- Remote-Debugging
- anchor: other-recommended-zerobrane-setting
  title: Weitere empfohlene ZeroBrane-Einstellung
---
...
![Debugger starten](/manuals/images/zerobrane/startdebug.png)
...
![Weitere empfohlene Einstellungen](/manuals/images/zerobrane/otherrecommended.png)
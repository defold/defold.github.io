...
- anchor: opening-the-scene-editor
  title: Den Szeneneditor öffnen
- anchor: remembered-scene-views
  title: Gespeicherte Szenenansichten
- anchor: scene-view-navigation-camera-controls
  title: Navigation in der Szenenansicht (Kamerasteuerung)
- anchor: standard-navigation-all-visual-editors
  title: Normale Navigation (alle visuellen Editoren)
- anchor: 2d-and-3d-scene-orientation
  title: Szenenausrichtung in 2D und 3D
- anchor: toolbar-overview
  title: Übersicht der Werkzeugleiste
- anchor: manipulating-objects
  title: Objekte auswählen und verändern
- anchor: selecting-objects
  title: Objekte auswählen
- anchor: visibility-filters
  title: Sichtbarkeitsfilter
- anchor: grid-settings
  title: Rastereinstellungen
- anchor: camera-type-perspective-vs-orthographic
  title: 'Kameratyp: perspektivisch und orthografisch'
- anchor: free-camera-mode
  title: Freier Kameramodus
- anchor: activating-free-camera-mode
  title: Den freien Kameramodus aktivieren
- anchor: exiting-free-camera-mode
  title: Den freien Kameramodus beenden
- anchor: looking-around-mouse-look
  title: Umschauen (Blicksteuerung mit der Maus)
- anchor: moving
  title: Bewegen
- anchor: walking-mode-optional
  title: Gehmodus (optional)
- anchor: camera-settings-popup
  title: Popup mit Kameraeinstellungen
---
...
![Szeneneditor in 3D](/manuals/images/editor/3d_scene.png)
...
![Werkzeugleiste](/manuals/images/editor/toolbar.png)
...
![Verschiebewerkzeug](/manuals/images/editor/icon_move.png)
...
![Objekt verschieben](/manuals/images/editor/move.png)![Objekt in 3D verschieben](/manuals/images/editor/move_3d.png)
...
![Drehwerkzeug](/manuals/images/editor/icon_rotate.png)

Verwende das *Rotate Tool*, um Objekte zu drehen. Wähle es in der Werkzeugleiste aus oder drücke die Taste <kbd>E</kbd>.

![Objekt drehen](/manuals/images/editor/rotate.png)![Objekt in 3D drehen](/manuals/images/editor/rotate_3d.png)
...
![Skalierungswerkzeug](/manuals/images/editor/icon_scale.png)

Verwende das *Scale Tool*, um Objekte zu skalieren. Wähle es in der Werkzeugleiste aus oder drücke die Taste <kbd>R</kbd>.

![Objekt skalieren](/manuals/images/editor/scale.png)![Objekt in 3D skalieren](/manuals/images/editor/scale_3d.png)
...
![Sichtbarkeitsfilter](/manuals/images/editor/visibilityfilters.png)
...
![Rastereinstellungen](/manuals/images/editor/grid_popup.png)
...
![Einstellungen der perspektivischen Kamera](/manuals/images/editor/camera_popup.png)

...
- anchor: components
  title: Komponenten
- anchor: objects-added-in-place-or-by-reference
  title: Objekte direkt oder als Referenz hinzufügen
- anchor: childing-game-objects
  title: Spielobjekte einem übergeordneten Spielobjekt zuordnen
---

#  Bausteine {#building-blocks}

Der Aufbau von Defold beruht auf einigen Konzepten, die du gut verstehen solltest. Dieses Handbuch erklärt, woraus die Bausteine von Defold bestehen. Lies anschließend das [Handbuch zur Adressierung](/de/manuals/addressing) und das [Handbuch zur Nachrichtenübermittlung](/de/manuals/message-passing). Außerdem stehen dir direkt im Editor eine Reihe von [Tutorials](/tutorials/getting-started) zur Verfügung, die dir einen schnellen Einstieg ermöglichen.

![Bausteine](/manuals/images/building_blocks/building_blocks.png)
...
![Sammlung](/manuals/images/building_blocks/collection.png)
...
Eine Liste aller verfügbaren Komponententypen findest du in der [Komponentenübersicht](/de/manuals/components/).
...
![Instanz](/manuals/images/building_blocks/instance.png)
...
![Spielobjektinstanzen](/manuals/images/building_blocks/go_instance.png)

Wenn du die Prototypdatei änderst, wird jede Instanz, die diese Datei verwendet, sofort aktualisiert.

![Prototyp eines Spielobjekts ändern](/manuals/images/building_blocks/go_change_blueprint.png)
...
![Aktualisierte Spielobjektinstanzen](/manuals/images/building_blocks/go_instance2.png)
...
![Spielobjekte einem übergeordneten Spielobjekt zuordnen](/manuals/images/building_blocks/childing.png)
...
![Transformation eines untergeordneten Objekts](/manuals/images/building_blocks/child_transform.png)

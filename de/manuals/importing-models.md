...
- anchor: importing-3d-models
  title: 3D-Modelle importieren
- anchor: importing-to-defold
  title: In Defold importieren
- anchor: using-a-model
  title: Ein Modell verwenden
- anchor: exporting-to-gltf
  title: Nach glTF exportieren
- anchor: requirements
  title: Anforderungen
- anchor: exporting-a-texture
  title: Eine Textur exportieren
- anchor: exporting-using-blender
  title: Mit Blender exportieren
---
...
![Modell in Blender](/manuals/images/model/blender_gltf.png)
...
![Importierte Modell-Assets](/manuals/images/model/assets_gltf.png)
...
Nachdem du das Modell importiert hast, verwende es in einer [Modellkomponente](/de/manuals/model):
...
![Alle auswählen](/manuals/images/model/blender_select_all_vertices.png)

Wenn alle Vertices ausgewählt sind, wickle das Mesh ab, um das UV-Layout zu erhalten:

![Mesh abwickeln](/manuals/images/model/blender_unwrap_mesh.png)

Anschließend kannst du das UV-Layout als Bild exportieren, das als Textur verwendet werden kann:

![UV-Layout exportieren](/manuals/images/model/blender_export_uv_layout.png)

![Ergebnis des UV-Layout-Exports](/manuals/images/model/blender_export_uv_layout_result.png)
...
![Mit Blender exportieren](/manuals/images/model/export_gltf.png)
...
![Mit Blender exportieren](/manuals/images/model/export_settings.png)
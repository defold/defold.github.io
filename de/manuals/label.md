...
- anchor: creating-a-label
  title: Eine Beschriftung erstellen
- anchor: label-properties
  title: Eigenschaften der Beschriftung
- anchor: blend-modes
  title: Mischmodi
- anchor: pivot-and-alignment
  title: Bezugspunkt und Ausrichtung
...
![Beschriftung hinzufügen](/manuals/images/label/add_label.png)
...
![Neue Beschriftung](/manuals/images/label/label.png)
...
![Schriftart und Material](/manuals/images/label/font_material.png)
...
![Textausrichtung](/manuals/images/label/align.png)
...
Die Datei *game.project* enthält einige [Projekteinstellungen](/de/manuals/project-settings#label) für Beschriftungen.
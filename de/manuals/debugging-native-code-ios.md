...
- anchor: launch-the-debugger
  title: Den Debugger starten
- anchor: debug-symbols
  title: Debug-Symbole
- anchor: path-mappings
  title: Pfadzuordnungen
- anchor: breakpoints
  title: Haltepunkte
- anchor: notes
  title: Hinweise
- anchor: check-uuid-of-binary
  title: UUID der Binärdatei prüfen
---
...
* Erstelle mit bob und der Option `--with-symbols` ein Bundle der App ([weitere Informationen](/de/manuals/debugging-native-code/#symbolicate-a-callstack)):
...
* Besorge dir den Ordner `.dSYM` (also die Debug-Symbole)
	...
	* Wenn du eine native Erweiterung verwendest, wird der Ordner `.dSYM` beim Erstellen eines Builds mit [bob.jar](https://www.defold.com/de/manuals/bob/) erzeugt. Dafür ist nur ein Build erforderlich (keine Archivierung oder Bundle-Erstellung):
...
* Erstelle ein neues Xcode-Projekt und wähle die Vorlage `Game`
	...
	![Projektvorlage](/manuals/images/extensions/debugging/ios/project_template.png)
...
* Füge deinen Code zur App hinzu
	...
	![Dateien hinzufügen](/manuals/images/extensions/debugging/ios/add_files.png)

* Stelle sicher, dass „Copy items if needed“ deaktiviert ist.

	![Quellcode hinzufügen](/manuals/images/extensions/debugging/ios/add_source.png)

* So sieht das Endergebnis aus

	![Hinzugefügter Quellcode](/manuals/images/extensions/debugging/ios/added_source.png)


* Deaktiviere den Schritt `Build`

	![Schema bearbeiten](/manuals/images/extensions/debugging/ios/edit_scheme.png)

	![Build-Schritt deaktivieren](/manuals/images/extensions/debugging/ios/disable_build.png)

* Stelle die Version von `Deployment target` so ein, dass sie nun höher als die iOS-Version deines Geräts ist

	![Bereitstellungsversion](/manuals/images/extensions/debugging/ios/deployment_version.png)

* Wähle das Zielgerät

	![Gerät auswählen](/manuals/images/extensions/debugging/ios/select_device.png)
...
2. Oder wähle `Attach to process by PID or Process name`
	...
	![Gerät auswählen](/manuals/images/extensions/debugging/ios/attach_to_process_name.png)
...
```
	...
	![Debug-Symbole hinzufügen](/manuals/images/extensions/debugging/ios/add_dsym.png)
...
* Öffne eine Datei in der Projektansicht und setze einen Haltepunkt
	...
	![Haltepunkt](/manuals/images/extensions/debugging/ios/breakpoint.png)

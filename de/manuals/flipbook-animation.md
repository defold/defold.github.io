...
- anchor: playing-flip-book-animations
  title: Flipbook-Animationen abspielen
- anchor: sprite-example
  title: Sprite-Beispiel
- anchor: gui-box-node-example
  title: Beispiel für einen GUI-Box-Knoten

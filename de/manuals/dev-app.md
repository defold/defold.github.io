...
- anchor: the-mobile-development-app
  title: Die mobile Entwicklungs-App
- anchor: installing-a-development-app
  title: Eine Entwicklungs-App installieren
- anchor: installing-on-ios
  title: Unter iOS installieren
- anchor: installing-on-android
  title: Unter Android installieren
- anchor: launching-your-game
  title: Dein Spiel starten
- anchor: connecting-to-an-ios-device-using-usb-on-windows
  title: Unter Windows über USB mit einem iOS-Gerät verbinden
- anchor: connecting-to-an-ios-device-using-usb-on-linux
  title: Unter Linux über USB mit einem iOS-Gerät verbinden
- anchor: connecting-to-an-ios-device-using-usb-on-macos
  title: Unter macOS über USB mit einem iOS-Gerät verbinden
- anchor: connecting-to-an-android-device-using-usb-on-macos
  title: Unter macOS über USB mit einem Android-Gerät verbinden
- anchor: connecting-to-an-android-device-using-usb-on-windows-or-linux
  title: Unter Windows oder Linux über USB mit einem Android-Gerät verbinden
...
![Bundle ohne Inhalte](/manuals/images/dev-app/contentless-bundle.png)

### Unter iOS installieren {#installing-on-ios}

Folge den [Anweisungen im iOS-Handbuch](/de/manuals/ios/#creating-an-ios-application-bundle), um ein Bundle für iOS zu erstellen. Achte darauf, Debug als Variante auszuwählen!

### Unter Android installieren {#installing-on-android}

Folge den [Anweisungen im Android-Handbuch](https://defold.com/de/manuals/android/#creating-an-android-application-bundle), um ein Bundle für Android zu erstellen.
...
5. Während das Spiel läuft, kannst du wie gewohnt [Hot Reload](/de/manuals/hot-reload/) verwenden.

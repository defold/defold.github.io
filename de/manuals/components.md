...
- anchor: enabling-and-disabling-components
  title: Komponenten aktivieren und deaktivieren
- anchor: component-properties
  title: Komponenteneigenschaften
- anchor: component-position-rotation-and-scale
  title: Position, Drehung und Skalierung von Komponenten
- anchor: component-draw-order
  title: Zeichenreihenfolge von Komponenten
- anchor: render-script-predicates
  title: Prädikate im Render-Skript
- anchor: component-z-value
  title: Z-Wert von Komponenten
---

#  Komponenten {#components}

{% include shared/de/components.md %}

## Komponententypen {#component-types}

Defold unterstützt die folgenden Komponententypen:

* [Sammlungsfabrik (collection factory)](/de/manuals/collection-factory) - Sammlungen (collections) dynamisch erzeugen
* [Sammlungs-Proxy (collection proxy)](/de/manuals/collection-proxy) - Sammlungen laden und entladen
* [Kollisionsobjekt (collision object)](/de/manuals/physics) - 2D- und 3D-Physik
* [Kamera (camera)](/de/manuals/camera) - Den Ansichtsbereich (viewport) und die Projektion der Spielwelt ändern
* [Fabrik (factory)](/de/manuals/factory) - Spielobjekte dynamisch erzeugen
* [GUI](/de/manuals/gui) - Eine grafische Benutzeroberfläche rendern
* [Beschriftung (label)](/de/manuals/label) - Einen Text rendern
* [Licht (light)](/de/manuals/light) - Lichtdaten für Shader hinzufügen
* [Mesh](/de/manuals/mesh) Ein 3D-Mesh anzeigen (mit Erstellung und Bearbeitung zur Laufzeit)
* [Modell (model)](/de/manuals/model) Ein 3D-Modell anzeigen (mit optionalen Animationen)
* [Partikeleffekt (Particle FX)](/de/manuals/particlefx) -  Partikel dynamisch erzeugen
* [Skript (script)](/de/manuals/script) - Spiellogik hinzufügen
* [Audiokomponente (sound)](/de/manuals/sound) - Audio oder Musik abspielen
* [Sprite](/de/manuals/sprite) - Ein 2D-Bild anzeigen (mit optionaler Flipbook-Animation)
* [Kachelkarte (tile map)](/de/manuals/tilemap) - Ein Raster aus Kacheln anzeigen
...
Die Komponententypen von Defold haben jeweils unterschiedliche Eigenschaften. Der Bereich [Properties](/de/manuals/editor/#the-editor-views) im Editor zeigt die Eigenschaften der Komponente an, die gerade im Bereich [Outline](/de/manuals/editor/#the-editor-views) ausgewählt ist. In den Handbüchern zu den einzelnen Komponententypen erfährst du mehr über die verfügbaren Komponenteneigenschaften.

...
toc:
- Atlas
- anchor: creating-an-atlas
  title: Einen Atlas erstellen
- anchor: atlas-properties
  title: Atlas-Eigenschaften
- anchor: image-properties
  title: Bildeigenschaften
- anchor: animation-properties
  title: Animationseigenschaften
- anchor: runtime-texture-and-atlas-creation
  title: Texturen und Atlanten zur Laufzeit erstellen
- anchor: creating-a-texture-resource-at-runtime
  title: Eine Texturressource zur Laufzeit erstellen
- anchor: creating-an-atlas-at-runtime
  title: Einen Atlas zur Laufzeit erstellen
---
...
: Ziehe Bilder aus dem Bereich *Asset* in die Editoransicht und lege sie dort ab.
  ...
  ![Einen Atlas erstellen und Bilder hinzufügen](/manuals/images/atlas/add.png)
  ...
  ![Hinzugefügte Bilder](/manuals/images/atlas/single_images.png)
...
: Führe einen <kbd>Rechtsklick</kbd> auf den obersten Atlas-Eintrag im Bereich *Outline* aus.
  ...
  ![Einen Atlas erstellen und Bilder hinzufügen](/manuals/images/atlas/add_animation.png)
  ...
  ![Animationsgruppe](/manuals/images/atlas/animation_group.png)
...
![Mehrseitiger Atlas](/manuals/images/atlas/multipage_atlas.png)
...
![Atlas-Eigenschaften](/manuals/images/atlas/atlas_properties.png)
...
![Bildeigenschaften](/manuals/images/atlas/image_properties.png)
...
Verwende [`resource.create_texture(path, params)`](https://defold.com/ref/resource/#resource.create_texture:path-table), um eine neue Texturressource zu erstellen:
...
Nachdem die Textur erstellt wurde, kannst du [`resource.set_texture(path, params, buffer)`](https://defold.com/ref/resource/#resource.set_texture:path-table-buffer) verwenden, um die Pixel der Textur festzulegen:
...
Die Textur kann mit `go.set()` direkt auf einer [Modellkomponente](/de/manuals/model/) verwendet werden:
...
Wenn die Textur auf einer [Sprite-Komponente](/de/manuals/sprite/) verwendet werden soll, muss sie zunächst von einem Atlas verwendet werden. Verwende [`resource.create_atlas(path, params)`](https://defold.com/ref/resource/#resource.create_atlas:path-table), um einen Atlas zu erstellen:

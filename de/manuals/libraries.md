...
- anchor: setting-up-library-sharing
  title: Die Freigabe einer Bibliothek einrichten
- anchor: library-url
  title: Bibliotheks-URL
- anchor: basic-access-authentication
  title: Basisauthentifizierung
- anchor: advanced-access-authentication
  title: Erweiterte Zugriffsauthentifizierung
- anchor: setting-up-library-dependencies
  title: Abhängigkeiten von Bibliotheken einrichten
- anchor: editing-files-in-library-dependencies
  title: Dateien in eingebundenen Bibliotheken bearbeiten
- anchor: broken-references
  title: Ungültige Referenzen
...
Angenommen, du möchtest eine Bibliothek mit gemeinsam genutzten Sprites und Kachelquellen (tile sources) aufbauen. Beginne damit, [ein neues Projekt einzurichten](/de/manuals/project-setup/). Entscheide, welche Ordner des Projekts du freigeben möchtest, und trage ihre Namen in der Eigenschaft *`include_dirs`* in den Projekteinstellungen ein. Wenn du mehrere Ordner auflisten möchtest, trenne ihre Namen durch Leerzeichen:

![Einzubeziehende Verzeichnisse](/manuals/images/libraries/libraries_include_dirs.png)
...
![Bibliotheks-URL auf GitHub](/manuals/images/libraries/libraries_library_url_github.png)
...
<div class='important' markdown='1'>
Es wird empfohlen, Bibliotheken von Drittanbietern vor der Verwendung immer zu prüfen. Weitere Informationen findest du unter [Drittanbietersoftware sicher verwenden](https://defold.com/de/manuals/application-security/#securing-your-use-of-third-party-software).
</div>
...
![Abhängigkeiten](/manuals/images/libraries/libraries_dependencies.png)
...
![Einrichtung der Bibliothek abgeschlossen](/manuals/images/libraries/libraries_done.png)
...
Wenn du ein Material kopierst und einfügst und es für alle Komponenten (components) eines bestimmten Typs verwenden möchtest, können [projektspezifische Vorlagen](/de/manuals/editor/#creating-new-project-files) hilfreich sein.

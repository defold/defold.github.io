...
- anchor: gui-template-nodes
  title: GUI-Vorlagenknoten
- anchor: creating-a-template
  title: Eine Vorlage erstellen
- anchor: creating-instances-from-a-template
  title: Instanzen aus einer Vorlage erstellen
- anchor: modifying-templates-in-runtime
  title: Vorlagen zur Laufzeit ändern
---
...
![Vorlage erstellen](/manuals/images/gui-templates/create.png)
...
![Instanz erstellen](/manuals/images/gui-templates/create_instance.png)
...
![Instanzen](/manuals/images/gui-templates/instances.png)
...
![Eigenschaften](/manuals/images/gui-templates/properties.png)

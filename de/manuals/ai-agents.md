...
- anchor: when-an-ai-agent-is-useful
  title: Wann ein KI-Agent nützlich ist
- anchor: model-neutral-defold-interfaces
  title: Modellunabhängige Defold-Schnittstellen
- anchor: integration-layers
  title: Integrationsschichten
- Model Context Protocol
- anchor: community-mcp-integrations
  title: MCP-Integrationen der Community
...
- anchor: bounded-change-and-verification-loops
  title: Begrenzte Änderungs- und Überprüfungsschleifen
- anchor: multimodal-evaluation
  title: Multimodale Bewertung
- anchor: security-isolation-and-good-practices
  title: Sicherheit, Isolation und bewährte Vorgehensweisen
---
...
* [Editor-Skripte](/de/manuals/editor-scripts) können projektspezifische Ressourcenoperationen und Werkzeuge bereitstellen.
* Die [HTTP-API des Editors](/de/manuals/editor-http-api) stellt Editorbefehle, Build-Ergebnisse, Konsolenausgaben, Referenzsuche, Vorschauen, Editoreinstellungen und Routen von Editor-Skripten bereit.
* Die [APIs für den Engine-Dienst und die Laufzeitautomatisierung](/de/manuals/engine-service) stellen den aktuellen Zustand der Debug-Engine, Eingaben, Bildschirmaufnahmen und von Erweiterungen definierte Operationen bereit.
* [Bob](/de/manuals/bob) ermöglicht Builds über die Kommandozeile sowie Berichte, Archive und Bundles.
...
Agenten sollten dieselbe [Schleife aus Untersuchen, Ändern, Überprüfen und Bewerten](/de/manuals/automation/#the-automation-loop) befolgen wie jede andere Automatisierung.
...
Bewährte Vorgehensweisen für automatisiertes Testen und Überprüfen werden in [diesem Handbuch](/de/manuals/automated-testing) beschrieben.

## Multimodale Bewertung {#multimodal-evaluation}

Ein Agent mit Bildeingabe kann [Editorvorschauen](/de/manuals/editor-http-api/#rendering-scene-previews), Bildschirmaufnahmen zur Laufzeit, visuelle Unterschiede und Browseraufnahmen untersuchen.
...
Weitere Informationen zu Editorvorschauen, Bildschirmaufnahmen zur Laufzeit und visueller Prüfung findest du in [diesem Handbuch](/de/manuals/automated-testing).

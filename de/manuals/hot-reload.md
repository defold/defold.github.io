...
- anchor: hot-reloading-resources
  title: Ressourcen per Hot Reload neu laden
- anchor: how-to-hot-reload
  title: Hot Reload verwenden
- anchor: hot-reloading-on-device
  title: Hot Reload auf Geräten
- anchor: reloading-scripts
  title: Skripte neu laden
- anchor: reloading-lua-modules
  title: Lua-Module neu laden
- anchor: the-on_reload-function
  title: Die Funktion on_reload()
- anchor: reloading-shader-code
  title: Shader-Code neu laden
---
...
![Ressourcen neu laden](/manuals/images/hot-reload/menu.png)

## Hot Reload auf Geräten {#hot-reloading-on-device}

Hot Reload funktioniert sowohl auf Geräten als auch auf Desktop-Computern. Um es auf einem Gerät zu verwenden, starte einen Debug-Build deines Spiels oder die [Entwicklungs-App](/de/manuals/dev-app) auf deinem Mobilgerät und wähle es anschließend im Editor als Ziel aus:

![Zielgerät](/manuals/images/hot-reload/target.png)
...
![GUI neu laden](/manuals/images/hot-reload/gui.png)
...
![Neu geladene GUI](/manuals/images/hot-reload/gui-reloaded.png)
...
Das Ändern und erneute Laden von `my_module.lua` verändert das Verhalten von `user.script` _nicht_. Im [Handbuch zu Modulen](/de/manuals/modules) erfährst du mehr darüber, warum das so ist und wie du diese Falle vermeidest.

...
- anchor: store-materials
  title: Materialien für den Store
- anchor: app-icon
  title: App-Symbol
- anchor: store-banners-and-images
  title: Banner und Bilder für den Store
- anchor: save-games
  title: Spielstände
- anchor: save-games-on-desktop-mobile-and-web
  title: Spielstände auf Desktop- und Mobilgeräten sowie im Web
- anchor: save-games-on-console
  title: Spielstände auf Konsolen
- anchor: build-artifacts
  title: Build-Artefakte
- anchor: application-optimizations
  title: Optimierung der Anwendung
- anchor: performance
  title: Leistung
- anchor: screen-resolution-and-refresh-rate
  title: Bildschirmauflösung und Bildwiederholfrequenz
- anchor: mobile-phones-and-notch-and-hole-punch-cameras
  title: Mobiltelefone mit Notch oder Hole-Punch-Kamera
- anchor: platform-specific-guidelines
  title: Plattformspezifische Richtlinien
- Android
- anchor: consoles
  title: Konsolen
- Nintendo Switch
...
Nur iOS - Stelle sicher, dass du [Localizations](/de/manuals/project-settings/#localizations) in `game.project` angibst, da `sys.get_info()` niemals eine Sprache zurückgibt, die nicht in dieser Liste enthalten ist.
</div>
...
Stelle sicher, dass du für jede veröffentlichte Version [Debugsymbole erzeugst](/de/manuals/debugging-native-code/#symbolicate-a-callstack), damit du Abstürze debuggen kannst. Bewahre diese zusammen mit dem Anwendungs-Bundle auf.

## Optimierung der Anwendung {#application-optimizations}

Im [Handbuch zur Optimierung](/de/manuals/optimization) erfährst du, wie du deine Anwendung hinsichtlich Leistung, Größe, Speicherverbrauch und Akkuverbrauch optimieren kannst.



## Leistung {#performance}
Teste immer auf der Zielhardware! Prüfe die Leistung des Spiels und optimiere sie bei Bedarf. Verwende den [Profiler](/de/manuals/profiling), um Engpässe im Code zu finden.


## Bildschirmauflösung und Bildwiederholfrequenz {#screen-resolution-and-refresh-rate}
Für Plattformen mit fester Ausrichtung und Bildschirmauflösung: Prüfe, ob das Spiel mit der Bildschirmauflösung und dem Seitenverhältnis der Zielplattform funktioniert. Für Plattformen mit variabler Bildschirmauflösung und variablem Seitenverhältnis: Prüfe, ob das Spiel mit verschiedenen Bildschirmauflösungen und Seitenverhältnissen funktioniert. Berücksichtige dabei, welche Art von [Ansichtsprojektion](/de/manuals/render/#default-view-projection) im Render-Skript und in der Kamera verwendet wird.
...
### Android
Bewahre deinen [Schlüsselspeicher](/de/manuals/android/#creating-a-keystore) an einem sicheren Ort auf, damit du dein Spiel aktualisieren kannst.

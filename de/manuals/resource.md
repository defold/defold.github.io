...
- anchor: the-static-resource-tree
  title: Der statische Ressourcenbaum
- anchor: dynamically-loading-factory-resources
  title: Fabrikressourcen dynamisch laden
- anchor: unloading-dynamically-loaded-resources
  title: Dynamisch geladene Ressourcen entladen
- anchor: excluding-resources-from-bundle
  title: Ressourcen vom Bundle ausschließen
---
...
- [Benutzerdefinierte Ressourcen](/de/manuals/project-settings/#custom-resources), die in *game.project* deklariert sind.

![Ressourcenbaum](/manuals/images/resource/resource_tree.png)

<div class='sidenote' markdown='1'>
Defold kennt außerdem [Bundle-Ressourcen](/de/manuals/project-settings/#bundle-resources). Bundle-Ressourcen sind im Anwendungs-Bundle enthalten, gehören aber nicht zum Ressourcenbaum. Dabei kann es sich um beliebige Dateien handeln, von plattformspezifischen Hilfsdateien bis hin zu externen Dateien, die [aus dem Dateisystem geladen](/de/manuals/file-access/#how-to-access-files-bundled-with-the-application) und von deinem Spiel verwendet werden (zum Beispiel FMOD-Soundbanken).
</div>
...
- Spielweltsammlungen, auf die Sammlungs-Proxys verweisen. Spielwelten sind relativ groß, deshalb musst du ihr Laden und Entladen manuell im Code auslösen. Einzelheiten findest du im [Handbuch zu Sammlungs-Proxys](/de/manuals/collection-proxy).
...
![Laden von Ressourcen](/manuals/images/resource/loading.png)
...
![Dynamisch laden](/manuals/images/resource/load_dynamically.png)
...
Lies das [Handbuch zu Fabriken](/de/manuals/factory) und das [Handbuch zu Sammlungsfabriken (collection factories)](/de/manuals/collection-factory), um Einzelheiten zur Funktionsweise zu erfahren.

...
- anchor: editor-scripts-and-ui
  title: Editor-Skripte und Benutzeroberflächen
- anchor: hello-world
  title: Hallo Welt
- anchor: opening-resources
  title: Ressourcen öffnen
...
- anchor: built-in-components
  title: Integrierte Komponenten
- anchor: layout-components
  title: Layoutkomponenten
- anchor: data-presentation-components
  title: Komponenten zur Datendarstellung
- anchor: input-components
  title: Eingabekomponenten
- anchor: dialog-related-components
  title: Komponenten für Dialogfelder
- anchor: utility-components
  title: Hilfskomponenten
- anchor: reactivity
  title: Reaktivität
- anchor: rules-of-reactivity
  title: Regeln für Reaktivität
- Hooks
- '**use_state**'
- '**use_memo**'
---
...
![Hallo-Welt-Dialogfeld](/manuals/images/editor_scripts/perform_action_dialog.png)
...
![Ausrichtung](/manuals/images/editor_scripts/alignment.png)
...
![Innenabstand und Abstand zwischen Komponenten](/manuals/images/editor_scripts/padding_and_spacing.png)
...
![Dialogfeld für ein neues Level](/manuals/images/editor_scripts/new_level_dialog.png)
...
![Eingaben](/manuals/images/editor_scripts/inputs_demo.png)
...
![Dialogfeld für eine neue Datei](/manuals/images/editor_scripts/reactive_new_file_dialog.png)

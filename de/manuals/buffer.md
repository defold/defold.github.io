...
Du kannst eine Pufferressource als Eingabe für eine [Mesh-Komponente (mesh component)](/de/manuals/mesh) verwenden. Pufferressourcen können auch zur Laufzeit mit `buffer.create()` und [verwandten API-Funktionen](/ref/buffer/#buffer.create:element_count-declaration) erstellt werden.
...
- anchor: clipping
  title: Beschneiden
- anchor: creating-a-clipping-node
  title: Einen Knoten zum Beschneiden erstellen
- anchor: stencil-mask
  title: Stencil-Maske
- anchor: stencil-limitations
  title: Einschränkungen von Stencil-Masken
- anchor: layers
  title: Ebenen
---
...
![Beschneiden einrichten](/manuals/images/gui-clipping/create.png)
...
![Hierarchie beim Beschneiden](/manuals/images/gui-clipping/setup.png)
...
![Stencil-Masken](/manuals/images/gui-clipping/modes.png)
...
![Ebenen und Beschneiden](/manuals/images/gui-clipping/layers.png)

...
toc:
- anchor: factory-components
  title: Fabrikkomponenten
- anchor: addressing-of-factory-created-objects
  title: Adressierung von Objekten, die eine Fabrik erzeugt hat
- anchor: tracking-spawned-and-parent-objects
  title: Erzeugte und übergeordnete Objekte nachverfolgen
- anchor: dynamic-loading-of-factory-resources
  title: Dynamisches Laden von Fabrikressourcen
- anchor: dynamic-prototype
  title: Dynamischer Prototyp
- anchor: instance-limits
  title: Instanzgrenzen
- anchor: pooling-of-game-objects
  title: Spielobjekte in Pools verwalten
---
...
![Fabrikkomponente](/manuals/images/factory/factory_collection.png)

![Fabrikkomponente](/manuals/images/factory/factory_component.png)
...
![Dynamisch erzeugtes Spielobjekt](/manuals/images/factory/factory_spawned.png)
...
`[properties]`
: (optional) Eine Lua-Tabelle mit beliebigen Werten für Skripteigenschaften, mit denen das Spielobjekt initialisiert werden soll. Informationen zu Skripteigenschaften findest du im [Handbuch zu Skripteigenschaften](/de/manuals/script-properties).
...
![Dynamisch erzeugtes Spielobjekt mit Eigenschaft und Skalierung](/manuals/images/factory/factory_spawned2.png)
...
Mit dem Adressierungsmechanismus von Defold kannst du auf jedes Objekt und jede Komponente in einem laufenden Spiel zugreifen. Das [Handbuch zur Adressierung](/de/manuals/addressing/) erklärt ausführlich, wie das System funktioniert. Du kannst denselben Adressierungsmechanismus auch für dynamisch erzeugte Spielobjekte und deren Komponenten verwenden. Oft genügt die ID des erzeugten Objekts, zum Beispiel beim Senden einer Nachricht:
...
![Dynamisch laden](/manuals/images/factory/load_dynamically.png)
...
![Dynamischer Prototyp](/manuals/images/factory/dynamic_prototype.png)
...
![Maximale Anzahl der Instanzen](/manuals/images/factory/factory_max_instances.png)
...
Richte *Max Instances* nach der größten Anzahl von Spielobjekten aus, die in einer dynamischen Welt gleichzeitig existieren können. Unter [Optimierung der maximalen Komponentenanzahl](/de/manuals/project-settings/#component-max-count-optimizations) erfährst du, wie die übrigen Komponentengrenzen berechnet werden.

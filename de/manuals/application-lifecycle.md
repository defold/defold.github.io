...
- anchor: preinitialization
  title: Vorinitialisierung
- anchor: collection-init
  title: Initialisierung der Sammlung
- anchor: post-update-in-initialization
  title: Phase nach der Aktualisierung während der Initialisierung
- anchor: update-loop
  title: Aktualisierungsschleife
- anchor: input-phase
  title: Eingabephase
- anchor: update-phase
  title: Aktualisierungsphase
- anchor: render-update-phase
  title: Aktualisierungsphase des Renderings
- anchor: post-update-phase
  title: Phase nach der Aktualisierung
- anchor: render-phase
  title: Renderphase
- anchor: finalization
  title: Finalisierung
- anchor: dispatching-messages
  title: Nachrichten zustellen
---
...
![Übersicht des Lebenszyklus](/manuals/images/application_lifecycle/application_lifecycle.png)
...
![Initialisierung](/manuals/images/application_lifecycle/initialization.png)
...
![Vorinitialisierung](/manuals/images/application_lifecycle/pre_init.png)
...
![Initialisierung der Sammlung](/manuals/images/application_lifecycle/collection_init.png)
...
![Phase nach der Aktualisierung](/manuals/images/application_lifecycle/post_init.png)
...
![Aktualisierungsschleife](/manuals/images/application_lifecycle/update_loop.png)
...
![Aktualisierungsphase](/manuals/images/application_lifecycle/update_phase.png)
...
![Aktualisierungsphase des Renderings](/manuals/images/application_lifecycle/render_update_phase.png)
...
![Phase nach der Aktualisierung](/manuals/images/application_lifecycle/post_update_phase.png)
...
![Renderphase](/manuals/images/application_lifecycle/render_phase.png)

Danach werden die Grafiken sowie gegebenenfalls die Darstellung des visuellen Profilers gerendert (siehe die [Debugging-Dokumentation](/de/manuals/debugging)). Nach dem Rendern der Grafiken erfolgt die Videoaufnahme.
...
(Weitere Informationen findest du im [Handbuch zu Sammlungs-Proxys](/de/manuals/collection-proxy) und unter [`set_time_step`](/ref/collectionproxy#set-time-step))
...
![Finalisierung](/manuals/images/application_lifecycle/finalization.png)
...
![Nachrichten zustellen](/manuals/images/application_lifecycle/dispatch_messages.png)

...
- anchor: preparing-content-for-live-update
  title: Inhalte für Live Update vorbereiten
- anchor: live-update-settings
  title: Einstellungen für Live Update
- anchor: bundling-with-live-update
  title: Bundles mit Live Update erstellen
- anchor: the-zip-archives
  title: Die .zip-Archive
- anchor: splitting-zip-archives
  title: .zip-Archive aufteilen
- anchor: live-update-on-android
  title: Live Update auf Android
- anchor: content-verification
  title: Inhaltsprüfung
- anchor: mounts
  title: Einbindungen
- anchor: scripting-with-live-update
  title: Skripting mit Live Update
- anchor: development-caveats
  title: Hinweise für die Entwicklung
---
...
![Mona-Lisa-Sammlung](/manuals/images/live-update/mona-lisa.png)
...
![Ausgeschlossener Sammlungs-Proxy](/manuals/images/live-update/proxy-excluded.png)
...
![Einstellungen für Live Update](/manuals/images/live-update/05-liveupdate-settings-zip.png)
...
![Anwendungs-Bundle mit Live Update erstellen](/manuals/images/live-update/bundle-app.png)
...
Mehr zum [Skripting mit Live Update erfährst du hier](/de/manuals/live-update-scripting).
...
: Wenn du eine als Bundle erstellte Version deines Spiels ausführst, hast du keinen direkten Zugriff auf eine Konsole. Das erschwert die Fehlersuche. Du kannst die Anwendung jedoch über die Befehlszeile oder durch einen direkten Doppelklick auf die ausführbare Datei im Bundle starten:
  ...
  ![Eine Anwendung aus einem Bundle ausführen](/manuals/images/live-update/run-bundle.png)

  Das Spiel startet nun mit einem Shell-Fenster, das die Ausgabe aller `print()`-Anweisungen anzeigt:

  ![Konsolenausgabe](/manuals/images/live-update/run-bundle-console.png)
...
: Als Entwickler kannst du die Inhalte in eine beliebige Datei oder einen beliebigen Ordner herunterladen. Häufig befinden sie sich jedoch unter dem Anwendungspfad. Der Speicherort des Ordners für Anwendungsdaten hängt vom Betriebssystem ab. Du kannst ihn mit `print(sys.get_save_file("", ""))` ermitteln. Um einen Download zu erzwingen, entferne das heruntergeladene Paket und den zugehörigen Eintrag aus allen von der Anwendung verwalteten Zustandsdaten. Es gibt keine von der Engine verwaltete Liste von Einbindungen, die gelöscht werden müsste; Einbindungen bleiben über Neustarts hinweg nicht erhalten.
  ...
  ![Lokaler Speicher](/manuals/images/live-update/local-storage.png)
...
- anchor: compression-times
  title: Komprimierungsdauer
- anchor: signal-loss
  title: Signalverlust
- anchor: compression-file-sizes
  title: Dateigrößen nach der Komprimierung
...
![Neue Profildatei](/manuals/images/texture_profiles/texture_profiles_new_file.png)

![Texturprofil festlegen](/manuals/images/texture_profiles/texture_profiles_game_project.png)
...
![Einstellungen für Texturprofile](/manuals/images/texture_profiles/texture_profiles_preferences.png)
...
![Pfade](/manuals/images/texture_profiles/texture_profiles_paths.png)
...
![Neue Profildatei](/manuals/images/texture_profiles/kodim03_pow2.png)
...
`LOW`
![Komprimierungsvoreinstellung LOW](/manuals/images/texture_profiles/kodim03_pow2.fast.png)

`MEDIUM`
![Komprimierungsvoreinstellung MEDIUM](/manuals/images/texture_profiles/kodim03_pow2.normal.png)

`HIGH`
![Komprimierungsvoreinstellung HIGH](/manuals/images/texture_profiles/kodim03_pow2.high.png)

`HIGHEST`
![Beste Komprimierungsvoreinstellung](/manuals/images/texture_profiles/kodim03_pow2.best.png)
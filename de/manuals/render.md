...
- anchor: render-pipeline-what-when-and-where
  title: Rendering-Pipeline - Was, wann und wo?
- anchor: the-default-render
  title: Das Standard-Rendering
- anchor: render-predicates
  title: Render-Prädikate
- anchor: default-view-projection
  title: Standardansicht und -projektion
- anchor: stretch-projection
  title: Gestreckte Projektion
- anchor: fixed-fit-projection
  title: Fest eingepasste Projektion
- anchor: fixed-projection
  title: Feste Projektion
- anchor: camera-projection
  title: Kameraprojektion
- anchor: frustum-culling
  title: Geometrie außerhalb des Sichtvolumens aussondern
- anchor: coordinate-systems
  title: Koordinatensysteme
- anchor: the-render-script
  title: Das Render-Skript
- anchor: render-resources
  title: Render-Ressourcen
- anchor: multisampled-render-targets
  title: Renderziele mit Multisampling
- anchor: texture-handles
  title: Textur-Handles
- anchor: supported-graphics-apis
  title: Unterstützte Grafik-APIs
- anchor: system-messages
  title: Systemnachrichten
- anchor: draw-calls-and-batching
  title: Zeichenaufrufe und Bündelung von Zeichenoperationen
- anchor: batch-rules-for-non-gui-components
  title: Bündelungsregeln für Komponenten außerhalb der GUI
- anchor: batch-rules-for-gui-components
  title: Bündelungsregeln für GUI-Komponenten
---
...
Das Herzstück der Rendering-Pipeline ist das _Render-Skript_. Es ist ein Lua-Skript mit den Funktionen `init()`, `update()` und `on_message()` und dient hauptsächlich dazu, mit der zugrunde liegenden Grafik-API zu interagieren. Das Render-Skript nimmt im Lebenszyklus deines Spiels einen besonderen Platz ein. Einzelheiten findest du in der [Dokumentation zum Anwendungslebenszyklus](/de/manuals/application-lifecycle).
...
![Integriertes Rendering](/manuals/images/render/builtin.png)
...
Eine ausführliche Beschreibung der Funktionsweise von Materialien findest du in der [Materialdokumentation](/de/manuals/material).
...
![Gestreckte Projektion](/manuals/images/render/stretch_projection.png)

*Gestreckte Projektion mit ursprünglicher Fenstergröße*

![Gestreckte Projektion nach Größenänderung](/manuals/images/render/stretch_projection_resized.png)
...
![Fest eingepasste Projektion](/manuals/images/render/fixed_fit_projection.png)

*Fest eingepasste Projektion mit ursprünglicher Fenstergröße*

![Fest eingepasste Projektion nach Größenänderung](/manuals/images/render/fixed_fit_projection_resized.png)

*Fest eingepasste Projektion mit horizontal gestrecktem Fenster*

![Fest eingepasste Projektion bei kleinerem Fenster](/manuals/images/render/fixed_fit_projection_resized_smaller.png)
...
![Feste Projektion](/manuals/images/render/fixed_projection_zoom_2_0.png)

*Feste Projektion mit Zoomstufe 2*

![Feste Projektion](/manuals/images/render/fixed_projection_zoom_0_5.png)

*Feste Projektion mit Zoomstufe 0,5*

![Feste Projektion](/manuals/images/render/fixed_projection_zoom_2_0_resized.png)
...
1 = Der Begrenzungsquader des Meshes muss von dir festgelegt werden. [Mehr erfahren](/de/manuals/mesh/#frustum-culling).
...
![Render-Ressourcen](/manuals/images/render/render_resources.png)
...
Ein Zeichenaufruf bezeichnet den Vorgang, die GPU so einzurichten, dass sie ein Objekt mit einer Textur und einem Material sowie optionalen zusätzlichen Einstellungen auf den Bildschirm zeichnet. Dieser Vorgang ist normalerweise ressourcenintensiv, daher wird empfohlen, die Anzahl der Zeichenaufrufe möglichst gering zu halten. Mit dem [integrierten Profiler](/de/manuals/profiling/) kannst du die Anzahl der Zeichenaufrufe und die zum Rendern benötigte Zeit messen.

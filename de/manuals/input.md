...
- anchor: setting-up-input-bindings
  title: Eingabebindungen einrichten
- anchor: trigger-types
  title: Auslösertypen
- anchor: accelerometer-input
  title: Eingabe des Beschleunigungssensors
- anchor: input-focus
  title: Eingabefokus
- anchor: input-dispatch-and-on_input
  title: Weiterleitung von Eingaben und on_input()
- anchor: input-focus-and-collection-proxy-components
  title: Eingabefokus und Sammlungs-Proxy-Komponenten
- anchor: releasing-input
  title: Eingabefokus freigeben
- anchor: consuming-input
  title: Eingaben abfangen
---
...
![Eingabebindungen](/manuals/images/input/overview.png)
...
: Eingabegeräte, die Teil deines Computers oder Mobilgeräts oder daran angeschlossen sind, liefern unverarbeitete Eingaben auf Systemebene an die Defold-Laufzeitumgebung. Die folgenden Gerätetypen werden unterstützt:
  ...
  4. Gamepads (soweit sie vom Betriebssystem unterstützt und in der Datei [gamepads](/de/manuals/input-gamepads/#gamepads-settings-file) zugeordnet werden)
...
![Einstellung für Eingabebindungen](/manuals/images/input/setting.png)
...
![Eingabebindungen festlegen](/manuals/images/input/input_binding.png)
...
Key Triggers
: Eingabe einzelner Tastaturtasten. Jede Taste wird separat einer entsprechenden Aktion zugeordnet. Weitere Informationen findest du im [Handbuch zur Tasten- und Texteingabe](/de/manuals/input-key-and-text).

Text Triggers
: Textauslöser werden verwendet, um beliebige Texteingaben zu lesen. Weitere Informationen findest du im [Handbuch zur Tasten- und Texteingabe](/de/manuals/input-key-and-text)

Mouse Triggers
: Eingaben von Maustasten und Mausrädern. Weitere Informationen findest du im [Handbuch zur Maus- und Berührungseingabe](/de/manuals/input-mouse-and-touch).

Touch Triggers
: Auslöser für Berührungseingaben mit einer oder mehreren Berührungen sind auf iOS- und Android-Geräten in nativen Anwendungen und in HTML5-Bundles verfügbar. Weitere Informationen findest du im [Handbuch zur Maus- und Berührungseingabe](/de/manuals/input-mouse-and-touch).

Gamepad Triggers
: Gamepad-Auslöser ermöglichen es dir, Standard-Gamepad-Eingaben an Spielfunktionen zu binden. Weitere Informationen findest du im [Gamepad-Handbuch](/de/manuals/input-gamepads).
...
![Eingabestapel](/manuals/images/input/input_stack.png)
...
![Weiterleitung von Aktionen](/manuals/images/input/actions.png)
...
![Weiterleitung von Aktionen an Proxys](/manuals/images/input/proxy.png)
...
![Eingaben abfangen](/manuals/images/input/consuming.png)
...
![Eingaben abfangen](/manuals/images/input/game.png)
...
![Pausenmenü](/manuals/images/input/game_paused.png)

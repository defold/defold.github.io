...
- anchor: open-script-files-in-visual-studio-code
  title: Skriptdateien in Visual Studio Code öffnen
- Extensions
- Tools
- Keymap
---
...
: Aktiviert die [Texturkomprimierung](/de/manuals/texture-profiles) für alle Builds, die im Editor erstellt werden.
...
Lint Code on Build
: Aktiviert die [statische Codeprüfung](/de/manuals/writing-code/#linting-configuration) beim Erstellen eines Builds des Projekts. Diese Option ist standardmäßig aktiviert, kann aber deaktiviert werden, wenn die statische Codeprüfung in einem großen Projekt zu viel Zeit beansprucht.

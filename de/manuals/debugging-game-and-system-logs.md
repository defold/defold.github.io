...
- anchor: game-and-system-log
  title: Spiel- und Systemprotokoll
- anchor: reading-the-game-log-from-the-editor
  title: Das Spielprotokoll im Editor lesen
- anchor: reading-the-game-log-from-the-terminal
  title: Das Spielprotokoll im Terminal lesen
- anchor: reading-game-and-system-logs-using-platform-specific-tools
  title: Spiel- und Systemprotokolle mit plattformspezifischen Werkzeugen lesen
- HTML5
- Android
- iOS
- anchor: reading-the-game-log-from-the-log-file
  title: Das Spielprotokoll aus der Protokolldatei lesen
---
...
Wenn du dein Spiel lokal aus dem Editor oder über eine Verbindung zur [mobilen Entwicklungs-App](/de/manuals/dev-app) ausführst, werden alle Ausgaben im Konsolenbereich des Editors angezeigt:
...
: Verbinde dein Gerät mit einem Computer, auf dem macOS und Xcode installiert sind.
  ...
  ![Container herunterladen](/manuals/images/debugging/download_container.png)

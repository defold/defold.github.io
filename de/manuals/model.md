...
![Modell in einem Spielobjekt](/manuals/images/model/model_gltf.png)
...
![Wiggler im Spiel](/manuals/images/model/runtime.png)

### Animation zur Laufzeit {#runtime-animation}

Defold bietet umfangreiche Unterstützung für die Steuerung von Animationen zur Laufzeit. Mehr dazu findest du im [Handbuch zu Modellanimationen](/de/manuals/model-animation):
...
Einzelheiten zur Funktionsweise von Render-Skripten findest du in der [Render-Dokumentation](/de/manuals/render).
...
toc:
- anchor: font-files
  title: Schriftdateien
- anchor: offline-or-runtime-fonts
  title: Offline- oder Laufzeitschriftarten
- anchor: text-layout-support-eg-right-to-left
  title: Unterstützung für Textlayout (z. B. von rechts nach links)
- anchor: font-collection
  title: Schriftsammlung
- anchor: creating-a-font
  title: Eine Schriftressource erstellen
- anchor: properties
  title: Eigenschaften
- anchor: distance-field-fonts
  title: Distanzfeldschriften
- anchor: bitmap-bmfonts
  title: Bitmap-Schriften im BMFont-Format
- anchor: artifacts-and-best-practices
  title: Artefakte und bewährte Vorgehensweisen
- anchor: font-cache
  title: Schrift-Cache
- anchor: enabling-runtime-fonts
  title: Laufzeitschriftarten aktivieren
- anchor: font-scripting
  title: Schriftarten per Skript steuern
- anchor: addingremoving-fonts-to-a-font-collection
  title: Schriftarten zu einer Schriftsammlung hinzufügen oder daraus entfernen
- anchor: prewarming-glyphs
  title: Glyphen vorab erzeugen
---
...
Informationen zum Gestalten einzelner Textabschnitte und zum Arbeiten mit Links und eingebetteten Sprites findest du im [Handbuch zur Rich-Text-Auszeichnung](/de/manuals/font-richtext).
...
Siehe [Laufzeitschriftarten aktivieren](/de/manuals/font#enabling-runtime-fonts)
...
![Name der neuen Schriftressource](/manuals/images/font/new_font_name.png)
...
![Neue Schriftressource](/manuals/images/font/new_font.png)
...
![Distanzfeldschrift](/manuals/images/font/df_font.png)
...
![Vergrößerte Schriftarten](/manuals/images/font/scale_up.png)
...
![Verkleinerte Schriftarten](/manuals/images/font/scale_down.png)
...
![Artefakte bei Distanzfeldschriften](/manuals/images/font/df_artifacts.png)
...
Weitere Informationen zu Shader-Uniforms findest du im [Shader-Handbuch](/de/manuals/shader).
...
* Füge ein [Anwendungsmanifest](/de/manuals/app-manifest) hinzu und aktiviere die Option `Use full text layout system`.

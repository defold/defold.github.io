...
- anchor: native-extension-job-folder
  title: Auftragsordner für native Erweiterungen
---
...
* Erstelle im Debug-Modus ein Bundle der App in einem Ordner deiner Wahl.
	...
	![Android-Bundle erstellen](/manuals/images/extensions/debugging/android/bundle_android.png)

* Starte [Android Studio](https://developer.android.com/studio/)

* Wähle `Profile or debug APK`

	![APK debuggen](/manuals/images/extensions/debugging/android/android_profile_or_debug.png)

* Wähle das APK-Bundle, das du gerade erstellt hast

	![APK auswählen](/manuals/images/extensions/debugging/android/android_select_apk.png)

* Wähle die Hauptdatei mit der Erweiterung `.so` und stelle sicher, dass sie Debug-Symbole enthält

	![SO-Datei auswählen](/manuals/images/extensions/debugging/android/android_missing_symbols.png)
...
* Wähle die .so-Datei und füge dann eine Zuordnung zu deinem lokalen Laufwerk hinzu
	...
	![Pfadzuordnung 1](/manuals/images/extensions/debugging/android/path_mappings_android.png)

	![Pfadzuordnung 2](/manuals/images/extensions/debugging/android/path_mappings_android2.png)
...
* Du solltest den zugeordneten Quellcode jetzt in deinem Projekt sehen
	...
	![Quellcode](/manuals/images/extensions/debugging/android/source_mappings_android.png)

* Füge einen Haltepunkt hinzu

	![Haltepunkt](/manuals/images/extensions/debugging/android/breakpoint_android.png)

* Wähle `Run` -> `Debug "Appname"` und rufe den Code auf, in dem du die Ausführung anhalten möchtest

	![Haltepunkt](/manuals/images/extensions/debugging/android/callstack_variables_android.png)

...
- anchor: minimum-browser-versions
  title: Mindestens unterstützte Browserversionen
- anchor: initial-memory-html5
  title: Anfänglicher Speicher (HTML5)
- anchor: stack-size-html5
  title: Stack-Größe (HTML5)
---
...
Die Einstellungen des Box2D-Solvers sind versionsabhängig. Einzelheiten findest du in den [Box2D-Projekteinstellungen](/de/manuals/project-settings/#box2d).
...
Steuere die Funktionalität von Rigs und Modellen (models), oder wähle None aus, um Modelle und Rigs vollständig auszuschließen. (Siehe die Dokumentation zu [`Model`](https://defold.com/de/manuals/model/#model-component)).
...
Die Einstellung im Anwendungsmanifest steuert, ob der Profiler-Code in einen Build eingebunden wird. Die Einstellungen unter `profiler` in *game.project* steuern das Verhalten des Profilers zur Laufzeit. Wie du die verfügbaren Funktionen verwendest, erfährst du im [Profiling-Handbuch](/de/manuals/profiling/).
...
Bindet die Unterstützung für Ogg-Opus-Audioressourcen ein. Der Opus-Decoder ist standardmäßig ausgeschlossen. Du musst diese Option daher aktivieren, bevor `.opus`-Ressourcen wiedergegeben werden können. Die unterstützten Formate findest du im [Audiohandbuch](/de/manuals/sound/).
...
Schließt die [Live-Update-Funktionalität](/de/manuals/live-update) aus der Engine aus.
...
Schließt die [Bibliothek zur Texturkomprimierung](/de/manuals/texture-profiles) Basis Universal aus der Engine aus.


## Use Android Support Lib

Verwendet die veraltete und zur Ablösung vorgesehene Android Support Library anstelle von Android X. [Weitere Informationen](https://defold.com/de/manuals/android/#using-androidx).
...
Diese Option legt den Standardwert zur Kompilierungszeit fest. Der Wert von [`html5.heap_size`](/de/manuals/html5/#heap-size) in *game.project* überschreibt ihn zur Laufzeit.

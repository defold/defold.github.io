...
- anchor: gui-box-nodes
  title: GUI-Box-Knoten
- anchor: adding-box-nodes
  title: Box-Knoten hinzufügen
...
![Texturen](/manuals/images/gui-box/create.png)
...
![Eingefärbte Textur](/manuals/images/gui-box/tinted.png)
...
Box-Knoten können Animationen aus Atlanten oder Kachelquellen abspielen. Weitere Informationen findest du im [Handbuch zur Flipbook-Animation](/de/manuals/flipbook-animation).

...
- anchor: creating-a-sound-component
  title: Eine Audiokomponente erstellen
- anchor: playing-the-sound
  title: Den Ton wiedergeben
- anchor: stopping-the-sound
  title: Den Ton stoppen
- anchor: gain
  title: Verstärkungsfaktor
- anchor: sound-groups
  title: Audiogruppen
- anchor: gating-sounds
  title: Die Wiedergabe von Tönen begrenzen
...
![Verstärkungsfaktor](/manuals/images/sound/sound_gain.png)
...
![Mischpult für Audiogruppen](/manuals/images/sound/sound_mixer.png)
...
![Phasenverschiebung](/manuals/images/sound/sound_phase_shift.png)
...
Die Datei *game.project* enthält einige [Projekteinstellungen](/de/manuals/project-settings#sound) für Audiokomponenten.

## Audiostreaming {#sound-streaming}

Du kannst auch [Töne streamen](/de/manuals/sound-streaming)
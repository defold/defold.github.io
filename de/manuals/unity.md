...
- anchor: defold-editor-overview
  title: Überblick über den Defold-Editor
- anchor: editors-comparison
  title: Vergleich der Editoren
- anchor: defold-panes-overview
  title: Überblick über die Bereiche in Defold
- anchor: key-concepts
...
- anchor: messaging-to-gui-and-render
  title: Nachrichten an GUI und Rendering
- anchor: prefabs-and-instances
  title: Prefabs und Instanzen
- anchor: factory
  title: Fabrik
...
- anchor: when-messages-are-handled
  title: Wann werden Nachrichten verarbeitet?
- anchor: update-loop
  title: Aktualisierungsschleife
- anchor: finalization
  title: Finalisierung
- Rendering
- GUI
...
- anchor: where-are-sorting-layers
  title: Wo sind die Sorting Layers?
...
Defold ist viel kleiner als Unity. Die Größe der Engine mit einem leeren Projekt liegt auf allen Plattformen zwischen 1 und 3 MB. Du kannst weitere Teile der Engine entfernen und einige Spielinhalte in [Live Update](/de/manuals/live-update) auslagern, um sie später separat herunterzuladen. Einen Größenvergleich und weitere Gründe für Defold findest du auf der [Webseite „Warum Defold?“](https://defold.com/why/).
...
Weitere Informationen findest du in diesem kurzen [Installationshandbuch](/de/manuals/install/).
...
![Vergleich der Willkommensbildschirme](/manuals/images/unity/unity_defold_start.png)
...
![Vergleich der Vorlagen auf dem Willkommensbildschirm](/manuals/images/unity/unity_defold_templates.png)
...
![Hallo Welt, Schritt 1](/manuals/images/unity/helloworld_1.png)
...
![Hallo Welt, Schritt 4](/manuals/images/unity/helloworld_4.png)
...
![Hallo Welt, Schritt 5](/manuals/images/unity/helloworld_5.png)
...
Wir stellen den Defold-Editor hier aus der Perspektive dessen vor, was Unity-Nutzer anfangs wissen möchten. Wir empfehlen dir aber, anschließend das vollständige [Handbuch zum Editor](/de/manuals/editor) zu lesen.
...
![Vergleich der Editoren](/manuals/images/unity/defold_unity_editor.png)
...
![Defold-Werkzeugleiste](/manuals/images/unity/defold_2d.png)

Du kannst auch die `Grid Settings` in der Werkzeugleiste anpassen, um wie in Unity die `Y`-Ebene zu verwenden:

![Defold-3D-Einstellungen](/manuals/images/unity/defold_3d.png)
...
| [Debugger](/de/manuals/debugging/) | Visual Studio Debugger | Der Debugger ist ohne weitere Einrichtung vollständig in Defold integriert. Es gibt eine zusätzliche Registerkarte, um Haltepunkte zu verfolgen, zu aktivieren und zu deaktivieren. |
...
![Bausteine](/manuals/images/unity/blocks.png)

Weitere Informationen findest du im vollständigen Handbuch zu den [Defold-Bausteinen](/de/manuals/building-blocks/).
...
Lies [hier mehr über Defold-Komponenten](/de/manuals/components/).
...
| Defold | Unity | Unterschiede |
|---|---|---|
| [Sprite](/de/manuals/sprite/) | Sprite Renderer | In Defold kannst du die Einfärbung (Farbeigenschaft) nur über Code ändern. |
| [Kachelkarte (tile map)](/de/manuals/tilemap/) | Tilemap / Grid | Defold hat einen integrierten Kachelkarten-Editor, der quadratische Raster unterstützt (es gibt aber eine Erweiterung z. B. für [Hexagon](https://github.com/selimanac/defold-hexagon/)) und keine integrierten Regeln zum automatischen Anordnen von Kacheln bietet. Werkzeuge wie [Tiled](https://defold.com/assets/tiled/), [TileSetter](https://defold.com/assets/tilesetter/) oder [Sprite Fusion](https://defold.com/assets/spritefusion/) bieten Exportmöglichkeiten für Defold. |
| [Beschriftung](/de/manuals/label/) | Text / TextMeshPro | Seit Defold 1.13.2 unterstützen Beschriftungskomponenten und GUI-Textknoten integriertes [Rich-Text-Markup](/de/manuals/font-richtext/) für Farben, Farbverläufe, Konturen und animierte Effekte. Eine separate [RichText-Erweiterung](https://defold.com/assets/richtext/) ist ebenfalls verfügbar. |
| [Audio](/de/manuals/sound/) | AudioSource | Defold hat nur eine globale Audioquelle (keine räumliche). Es gibt eine offizielle [FMOD-Erweiterung](https://github.com/defold/extension-fmod) für Defold. |
| [Fabrik](/de/manuals/factory/) | Prefab Instantiate() | In Defold ist eine Fabrik (factory) eine Komponente mit einem bestimmten Prototyp (Prefab). |
| [Sammlungsfabrik](/de/manuals/collection-factory/) | - (Keine direkt entsprechende Komponente) | Eine Sammlungsfabrik (collection factory) in Defold kann mehrere Spielobjekte mit Eltern-Kind-Beziehungen gleichzeitig erzeugen. |
| [Kollisionsobjekt](/de/manuals/physics-objects) | Rigidbody + Collider | In Defold sind Physikobjekte und Kollisionsformen in einer einzigen Komponente zusammengefasst. |
| [Kollisionsformen](/de/manuals/physics-shapes/)  | BoxCollider / SphereCollider / CapsuleCollider | In Defold werden Formen (Quader, Kugel, Kapsel) innerhalb der Kollisionsobjekt-Komponente konfiguriert. Beide unterstützen Kollisionsformen aus Kachelkarten und Daten für konvexe Hüllen. |
| [Kamera](/de/manuals/camera/) | Camera | In Unity hat die Kamera einige zusätzliche integrierte Einstellungen für Rendering und Nachbearbeitung, während Defold die benutzerdefinierte Steuerung über das Render-Skript dem Nutzer überlässt. |
| [GUI](/de/manuals/gui/) | UI Toolkit / Unity UI / uGUI Canvas | Defolds GUI ist eine leistungsfähige Komponente zum Erstellen vollständiger Benutzeroberflächen und Vorlagen. Unity hat keine entsprechende einzelne UI-Komponente, sondern mehrere UI-Frameworks. Defold hat auch eine Erweiterung für [Erweiterung](https://github.com/britzl/extension-imgui). |
| [GUI-Skript](/de/manuals/gui-script/) | Unity UI / uGUI-Skripte | Defolds GUI lässt sich über GUI-Skripte mit der dafür vorgesehenen `gui`-API steuern. |
| [Modell](/de/manuals/model/) | MeshRenderer + Material | In Defold bündelt eine Modellkomponente eine 3D-Modelldatei, Texturen und ein Material mit Shadern. |
| [Mesh](/de/manuals/mesh/) | MeshRenderer / MeshFilter / Procedural Mesh | In Defold ist Mesh eine Komponente zur Verwaltung einer Menge von Vertices über Code. Sie ähnelt einem Defold-Modell, arbeitet aber auf einer noch niedrigeren Ebene. |
| [ParticleFX](/de/manuals/particlefx/) | Particle System | Defolds Partikeleditor unterstützt 2D-/3D-Partikeleffekte mit vielen Eigenschaften und ermöglicht es dir, sie mit Kurven im Curve Editor über die Zeit zu animieren. Er bietet weder Spuren noch Kollisionen. |
| [Skript](/de/manuals/script/) | Script | Weitere Informationen zu Unterschieden bei der Programmierung findest du unten. |
...
| Defold | Unity | Unterschiede |
|---|---|---|
| [Atlas](/de/manuals/atlas/) | Sprite Atlas / Texture2D | Defold hat auch eine [Erweiterung für Texture Packer](https://defold.com/extension-texturepacker/). |
| [Kachelquelle](/de/manuals/tilesource/) | Tile Palette + Asset | In Defold lässt sich eine Kachelquelle als Textur für Kachelkarten, aber auch für Sprites oder Partikel verwenden. |
| [Schriftart](/de/manuals/font/) | Font | Wird von der Beschriftungskomponente oder von Textknoten in Defolds GUI verwendet, ähnlich wie Text/TextMeshPro in Unity. |
| [Material](/de/manuals/material/) | Material | In Defold heißen Shader Vertex-Programm und Fragment-Programm. |
...
Lies mehr über Sammlungen im [Handbuch zu den Bausteinen](/de/manuals/building-blocks/#collections).
...
Lies mehr über Erweiterungen im [Defold-Handbuch zu nativen Erweiterungen](/de/manuals/extensions/).
...
- [Skripthandbuch](/de/manuals/script/)
- [Code schreiben](/de/manuals/writing-code/)
- [Debugging](/de/manuals/debugging/)
...
Du kannst die Einstellungen des Defold-Editors auch so konfigurieren, dass Textdateien standardmäßig in VS Code (oder einem anderen externen Editor) geöffnet werden. Weitere Informationen findest du unter [Editoreinstellungen](/de/manuals/editor-preferences/).
...
Lies mehr über Shader im [Shader-Handbuch](/de/manuals/shader).
...
Lies mehr über Materialien im [Materialhandbuch](/de/manuals/material).
...
Weitere Informationen findest du im [Handbuch zur Nachrichtenübermittlung](/de/manuals/message-passing/).
...
Weitere Informationen findest du im [Handbuch zur Adressierung](/de/manuals/addressing/).
...
Weitere Informationen findest du im [Handbuch zu Fabriken](/de/manuals/factory/). 
...
Weitere Informationen findest du im [Handbuch zu Sammlungsfabriken](/de/manuals/collection-factory/).
...
Weitere Informationen findest du im [Handbuch zur Ressourcenverwaltung](/de/manuals/resource/). 
...
Weitere Informationen findest du im [Handbuch zu Sammlungs-Proxys](/de/manuals/collection-proxy/).
...
| `on_input` | Eingabemethoden | Defold empfängt Eingaben, wenn [der Eingabefokus für das Skript gesetzt ist](/de/manuals/input/#input-focus). Wird in der Aktualisierungsschleife zuerst verarbeitet. |
| `fixed_update()` | `FixedUpdate()` | Wird mit festem Zeitschritt aufgerufen. Um dies in Defold zu aktivieren, musst du `Use Fixed Timestep` einschalten; siehe [Details](https://defold.com/de/manuals/project-settings/#use-fixed-timestep). Seit 1.12.0 wird es vor `update()` ausgeführt. |
...
Weitere Informationen findest du im [Handbuch zum Anwendungslebenszyklus](/de/manuals/application-lifecycle/).
...
Weitere Informationen findest du im [GUI-Handbuch](/de/manuals/gui/).

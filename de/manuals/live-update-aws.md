...
- anchor: setting-up-amazon-web-service
  title: Amazon Web Services einrichten
---
...
1. Einen Bucket für Ressourcen für Live Update erstellen
    ...
    ![Einen Bucket erstellen](/manuals/images/live-update/01-create-bucket.png)
...
2. Deinem Bucket eine Bucket-Richtlinie hinzufügen
    ...
    ![Bucket-Richtlinie](/manuals/images/live-update/02-bucket-policy.png)
...
3. Deinem Bucket eine CORS-Konfiguration hinzufügen (optional)
    ...
    ![CORS-Konfiguration](/manuals/images/live-update/03-cors-configuration.png)
...
4. Eine IAM-Richtlinie erstellen
    ...
    ![IAM-Richtlinie](/manuals/images/live-update/04-create-policy.png)
...
6. Eine Profildatei mit Zugangsdaten erstellen
    ...
    ![Einstellungen für Live Update](/manuals/images/live-update/05-liveupdate-settings.png)
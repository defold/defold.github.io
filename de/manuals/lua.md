...
- anchor: standard-libraries-and-extensions
  title: Standardbibliotheken und Erweiterungen
- anchor: lua-books-and-resources
  title: Bücher und Ressourcen zu Lua
...
- anchor: locals-globals-and-lexical-scoping
  title: Lokale und globale Variablen sowie lexikalische Gültigkeitsbereiche
- anchor: variable-shadowing
  title: Überschattung von Variablen
- anchor: coroutines
  title: Koroutinen
- anchor: lua-contexts-in-defold
  title: Lua-Kontexte in Defold
- anchor: performance-considerations
  title: Überlegungen zur Leistung
- anchor: memory-and-garbage-collection
  title: Speicher und automatische Speicherbereinigung
...
![Kontexte](/manuals/images/lua/lua_contexts.png)
...
: So wie du Skriptcode in einem Lua-Modul kapseln kannst, kannst du ihn auch in einem Spielobjekt mit einer Skriptkomponente kapseln. Der Unterschied besteht darin, dass du bei der Kapselung in einem Spielobjekt ausschließlich über Nachrichten mit ihm kommunizieren kannst.
  ...
  ![Hilfsspielobjekt](/manuals/images/lua/lua_helper.png)
...
: Bei diesem Entwurf kannst du ein Spielobjekt für eine Verhaltensweise erstellen, das automatisch auf ein anderes Zielspielobjekt einwirkt. Dies geschieht entweder über einen vordefinierten Namen, an den der Name des Zielspielobjekts angepasst werden muss, oder über eine URL in `go.property()`, die auf das Zielspielobjekt verweist.
  ...
  ![Sammlung](/manuals/images/lua/lua_collection.png)

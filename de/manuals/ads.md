...
- anchor: interstitial-ads
  title: Interstitial-Anzeigen
- anchor: rewarded-ads
  title: Werbung gegen Belohnung
- anchor: ad-networks
  title: Werbenetzwerke
- anchor: how-to-integrate-ads-in-your-game
  title: Werbung in dein Spiel integrieren
- anchor: combining-ads-and-in-app-purchases
  title: Werbung und In-App-Käufe kombinieren
- anchor: learn-more
  title: Mehr erfahren
---
...
Wenn du dich für ein Werbenetzwerk entschieden hast, das du in dein Spiel integrieren möchtest, musst du die Installations- und Nutzungsanweisungen des jeweiligen *Assets* befolgen. Üblicherweise fügst du die Erweiterung zunächst als [Projektabhängigkeit](/de/manuals/libraries/#setting-up-library-dependencies) hinzu. Sobald du das Asset zu deinem Projekt hinzugefügt hast, kannst du mit der Integration fortfahren und die Funktionen des jeweiligen Assets aufrufen, um Werbung zu laden und anzuzeigen.


# Werbung und In-App-Käufe kombinieren {#combining-ads-and-in-app-purchases}

In Mobilspielen ist es recht üblich, einen [In-App-Kauf](/de/manuals/iap) anzubieten, mit dem sich Werbung dauerhaft entfernen lässt.

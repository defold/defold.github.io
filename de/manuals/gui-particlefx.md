...
- anchor: gui-particlefx-nodes
  title: GUI-Partikeleffektknoten
- anchor: adding-particle-fx-nodes
  title: Partikeleffektknoten hinzufügen
- anchor: controlling-the-effect
  title: Den Effekt steuern
---
...
![Partikeleffekt](/manuals/images/gui-particlefx/create.png)
...
Weitere Informationen zur Funktionsweise von Partikeleffekten findest du im [Handbuch zu Partikeleffekten](/de/manuals/particlefx).
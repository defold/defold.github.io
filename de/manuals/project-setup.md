...
- anchor: creating-a-new-project
  title: Ein neues lokales Projekt erstellen
- anchor: adding-the-project-to-github
  title: Das Projekt zu GitHub hinzufügen
- anchor: open-an-existing-project
  title: Ein vorhandenes Projekt öffnen
- anchor: open-a-recent-project
  title: Ein zuletzt verwendetes Projekt öffnen
---
...
![Projekt öffnen](/manuals/images/workflow/open_project.png)

Oder aus einem Tutorial mit einer Schritt-für-Schritt-Anleitung:

![Projekt aus einem Tutorial erstellen](/manuals/images/workflow/create_from_tutorial.png)

Oder aus einem fertigen Beispielspiel:

![Projekt aus einem Beispiel erstellen](/manuals/images/workflow/create_from_sample.png)
...
![Projekt importieren](/manuals/images/workflow/open_from_disk.png)

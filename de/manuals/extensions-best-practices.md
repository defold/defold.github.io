...
- C++-Version
- anchor: no-c-exceptions
  title: Keine C++-Ausnahmen
- anchor: standard-template-libraries-stl
  title: Standard-Template-Bibliotheken - STL
- anchor: make-functions-hidden
  title: Funktionen verbergen
- anchor: 3rd-party-libraries
  title: Bibliotheken von Drittanbietern
- anchor: open-source-dependencies
  title: Open-Source-Abhängigkeiten
---
...
```
    /root
        ...
        /bundleres                       -- Resources that should be bundles for (see game.project and the [bundle_resources setting]([physics scale setting](/de/manuals/project-settings/#project))
            /<platform>
        game.project

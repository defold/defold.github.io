...
- anchor: availability-and-port-discovery
  title: Verfügbarkeit und Ermitteln des Ports
- anchor: built-in-endpoints
  title: Integrierte Endpunkte
- anchor: extension-defined-runtime-routes
  title: Von Erweiterungen definierte Laufzeitrouten
- anchor: automation-bridge-extension
  title: Die Erweiterung Automation Bridge
- anchor: editor-and-runtime-clients
  title: Editor- und Laufzeitclients
- anchor: limitations-and-security
  title: Einschränkungen und Sicherheit
---
...
Er ist vom [Editorserver](/de/manuals/editor-http-api) getrennt, der zum Defold-Editor gehört und das geöffnete Projekt steuert.
...
![Portinformationen des Engine-Dienstes in einem Defold-Debug-Build](/manuals/images/automation/engine-service.png)
...
![Zugriff auf den Engine-Server](/manuals/images/automation/engine-server.png)
...
Laufzeitskripte, Physik, Eingaben, dynamisch erstellte Objekte und plattformspezifisches Rendering benötigen eine laufende Engine und sollten durch [automatisiertes Testen zur Laufzeit](/de/manuals/automated-testing) überprüft werden.

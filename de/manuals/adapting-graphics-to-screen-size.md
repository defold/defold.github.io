...
- anchor: how-to-change-how-your-content-is-rendered
  title: Ändern, wie deine Inhalte gerendert werden
- anchor: retro8-bit-graphics
  title: Retro-/8-Bit-Grafik
- anchor: high-resolution-graphics
  title: Hochauflösende Grafik
- anchor: high-dpi-setting-and-retina-screens
  title: Einstellung für hohe Pixeldichte und Retina-Bildschirme
- anchor: creating-an-adaptive-gui
  title: Eine anpassungsfähige GUI erstellen
- anchor: node-properties
  title: Eigenschaften von *Knoten*
- Layouts
- anchor: testing-different-screen-sizes
  title: Unterschiedliche Bildschirmgrößen testen
---
...
Du kannst dasselbe Ergebnis erzielen, indem du einem Spielobjekt (game object) eine [Kamerakomponente (camera component)](/de/manuals/camera/) hinzufügst, *Orthographic Projection* aktivierst und *Orthographic Zoom* auf 4.0 setzt:
...
Mehr über diese Eigenschaften erfährst du [im GUI-Handbuch](/de/manuals/gui/#node-properties).

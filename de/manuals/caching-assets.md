...
Du kannst den Projekt-Cache manuell löschen, indem du die Dateien in `build/default` löschst oder den Befehl `clean` mit dem [Kommandozeilen-Build-Werkzeug Bob](/de/manuals/bob) ausführst.

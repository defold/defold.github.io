...
- anchor: creating-a-material
  title: Ein Material erstellen
- anchor: attributes
  title: Attribute
- anchor: default-attribute-semantics
  title: Standardsemantik von Attributen
- anchor: setting-custom-vertex-attribute-data
  title: Daten benutzerdefinierter Vertex-Attribute setzen
- anchor: examples-of-using-custom-vertex-attributes
  title: Beispiele für benutzerdefinierte Vertex-Attribute
- Instancing
- anchor: vertex-and-fragment-constants
  title: Vertex- und Fragment-Konstanten
- anchor: gui-node-material-constants
  title: Materialkonstanten von GUI-Knoten
- anchor: samplers
  title: Sampler
- anchor: sampler-settings
  title: Sampler-Einstellungen
- anchor: constants-buffers
  title: Konstantenpuffer
---
...
* Weitere Informationen zur Rendering-Pipeline findest du in der [Rendering-Dokumentation](/de/manuals/render).
* Eine ausführliche Erklärung von Shader-Programmen findest du in der [Shader-Dokumentation](/de/manuals/shader).
...
![Materialdatei](/manuals/images/materials/material_file.png)

Das neue Material wird im *Material Editor* geöffnet.

![Materialeditor](/manuals/images/materials/material.png)
...
![Benutzerdefiniertes Materialattribut](/manuals/images/materials/set_custom_attribute.png)
...
![Einrichtung von Instancing](/manuals/images/materials/instancing-setup.png)
...
![Material für Instancing](/manuals/images/materials/instancing-material.png)
...
![Zeichenaufrufe beim Instancing](/manuals/images/materials/instancing-draw-calls.png)
...
![Sampler-Einstellungen](/manuals/images/materials/my_sampler.png)
...
![Modell-Sampler](/manuals/images/materials/model_samplers.png)
...
![Modell](/manuals/images/materials/model.png)

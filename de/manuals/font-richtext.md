...
- anchor: interaction-messages
  title: Interaktionsnachrichten
- anchor: named-styles
  title: Benannte Stile
- anchor: layout-object-api
  title: API für Layout-Objekte
- label.get_layout_objects()
- gui.get_layout_objects()
- anchor: returned-object-fields
  title: Zurückgegebene Objektfelder
- anchor: lua-example
  title: Lua-Beispiel
- anchor: useful-combinations
  title: Nützliche Kombinationen
- anchor: colored-outline-with-a-horizontal-gradient
  title: Farbige Kontur mit horizontalem Farbverlauf
- anchor: shake-a-sentence-gradient-one-word
  title: Einen Satz zittern lassen und ein Wort mit einem Farbverlauf versehen
- anchor: override-one-property-without-losing-the-others
  title: Eine Eigenschaft überschreiben, ohne die anderen zu verlieren
---
...
![Beispieltext in deckendem Grün](/manuals/images/richtext/color_green.webp)
...
![Beispieltext in Grün mit halbem Alphawert](/manuals/images/richtext/color_green_alpha.webp)
...
![Beispieltext mit einer Größe von 24 Pixeln](/manuals/images/richtext/size_24.webp)
...
![Beispieltext mit 120 Prozent von 32 Pixeln](/manuals/images/richtext/size_120.webp)
...
![Beispieltext mit dem Doppelten der Basisgröße von 32 Pixeln](/manuals/images/richtext/size_2em.webp)
...
![Beispieltext mit einem horizontalen Farbverlauf von Magenta zu Weiß](/manuals/images/richtext/gradient_horizontal.webp)
...
![Beispieltext mit einem vertikalen blauen Farbverlauf](/manuals/images/richtext/gradient_vertical.webp)
...
![Beispieltext mit einem an jede Glyphe angepassten Farbverlauf zwischen vier Ecken](/manuals/images/richtext/gradient_four_glyph.webp)
...
![Beispieltext mit einem an den Textbereich angepassten Farbverlauf zwischen vier Ecken](/manuals/images/richtext/gradient_four_text.webp)
...
![Animierter fließender Farbverlauf, an jede Glyphe angepasst](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![Animierter fließender Farbverlauf, an den Textbereich angepasst](/manuals/images/richtext/gradient_flow_span.webp)
...
![Beispieltext mit einer durchgezogenen Unterstreichung](/manuals/images/richtext/underline_solid.webp)
...
![Beispieltext mit einer gestrichelten Unterstreichung](/manuals/images/richtext/underline_dashed.webp)
...
![Beispieltext mit einer Unterstreichung mit Farbverlauf](/manuals/images/richtext/underline_gradient.webp)
...
![Beispieltext mit einer durchgezogenen Durchstreichung](/manuals/images/richtext/strike_solid.webp)
...
![Beispieltext mit einer gestrichelten Durchstreichung](/manuals/images/richtext/strike_dashed.webp)
...
![Beispieltext mit einer äußeren schwarzen Kontur](/manuals/images/richtext/outline.webp)
...
![Beispieltext mit einem versetzten Schatten](/manuals/images/richtext/shadow.webp)
...
![Beispieltext mit einem animierten Zittern jeder Glyphe](/manuals/images/richtext/shake_glyph.webp)
...
![Beispieltext mit einem animierten Zittern des gesamten Textbereichs](/manuals/images/richtext/shake_span.webp)
...
![Beispieltext mit einer animierten Wellenbewegung jeder Glyphe](/manuals/images/richtext/wave_glyph.webp)
...
![Beispieltext, der sich als ein animierter Textbereich bewegt](/manuals/images/richtext/wave_span.webp)
...
![Ein im Textfluss gerendertes Defold-Logo](/manuals/images/richtext/sprite.webp)
...
![www.defold.com mit dem Standard-Linkstil und einer Unterstreichung gerendert](/manuals/images/richtext/link.webp)
...
Einzelheiten zur Einrichtung findest du unter [Eingabefokus](/de/manuals/input/#input-focus) und [Maus- und Touch-Eingaben](/de/manuals/input-mouse-and-touch).

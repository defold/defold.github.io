...
- anchor: defold-physics-event-handling
  title: Verarbeitung von Physikereignissen in Defold
- anchor: setting-the-physics-world-listener
  title: Den Listener für die Physikwelt festlegen
- anchor: event-data-structure
  title: Datenstruktur der Ereignisse
...
Wenn ein Listener festgelegt ist, werden für die Physikwelt, in der dieser Listener festgelegt ist, keine [Physiknachrichten](/de/manuals/physics-messages) mehr gesendet.
</div>

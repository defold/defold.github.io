...
- anchor: multi-textured-sprites
  title: Sprites mit mehreren Texturen
- anchor: animations
  title: Animationen
- anchor: uvs
  title: UV-Koordinaten
---
...
Die Sprite-Komponente kann für ihre Grafik entweder einen [Atlas](/de/manuals/atlas) oder eine [Kachelquelle (tile source)](/de/manuals/tilesource) verwenden.
...
{% include shared/de/slice-9-texturing.md %}
...
{% include shared/de/material-constants.md component='sprite' variable='tint' %}
...
Ein Sprite kann Vertex-Attribute des aktuell zugewiesenen Materials überschreiben. Die Komponente übergibt diese Attribute an den Vertex-Shader (weitere Informationen findest du im [Handbuch zu Materialien](/de/manuals/material/#attributes)).
...
![Sprite-Attribute](/manuals/images/graphics/sprite-attributes.png)

## Projektkonfiguration {#project-configuration}

Die Datei *game.project* enthält einige [Projekteinstellungen](/de/manuals/project-settings#sprite) für Sprites.
...
Deshalb verwenden wir `Rename patterns` im [Atlas](/de/manuals/material/), um sie umzubenennen.

...
![Struktur der Nachrichtenübermittlung](/manuals/images/message_passing/message_passing_structure.png)
...
![Nachrichtenübermittlung](/manuals/images/message_passing/message_passing.png)
...
![Name der Sammlung](/manuals/images/message_passing/collection_name.png)
...
```
Eine ausführlichere Beschreibung der Funktionsweise von Proxys findest du in der Dokumentation zu [Sammlungs-Proxys](/de/manuals/collection-proxy).

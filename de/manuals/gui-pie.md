...
- anchor: gui-pie-nodes
  title: GUI-Kreissektor-Knoten
- anchor: creating-a-pie-node
  title: Einen Kreissektor-Knoten erstellen
- anchor: modify-pie-nodes-at-runtime
  title: Kreissektor-Knoten zur Laufzeit ändern
---
...
![Kreissektor-Knoten erstellen](/manuals/images/gui-pie/create.png)
...
![Eigenschaften](/manuals/images/gui-pie/properties.png)

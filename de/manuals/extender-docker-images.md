...
- anchor: how-to-use-old-docker-images
  title: Alte Docker-Images verwenden
---
...
3. Starte den lokalen Extender wie unter [Einen lokalen Extender mit vorkonfigurierten Artefakten ausführen](/de/manuals/extender-local-setup#how-to-run-local-extender-with-preconfigured-artifacts) beschrieben.
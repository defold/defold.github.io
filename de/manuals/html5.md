...
- anchor: html5-development
  title: HTML5-Entwicklung
- anchor: heap-size
  title: Heap-Größe
- anchor: testing-html5-build
  title: Einen HTML5-Build testen
- anchor: creating-html5-bundle
  title: Ein HTML5-Bundle erstellen
- anchor: webgl-context-version
  title: WebGL-Kontextversion
...
- anchor: customizing-html5-bundle
  title: Ein HTML5-Bundle anpassen
- anchor: downscale-fit-and-fit
  title: Downscale Fit und Fit
- Stretch
- No Scale
- Tokens
...
- anchor: file-operations-in-html5
  title: Dateioperationen in HTML5
- anchor: passing-arguments-to-an-html5-game
  title: Argumente an ein HTML5-Spiel übergeben
- anchor: engine-arguments
  title: Engine-Argumente
- anchor: query-arguments-in-the-url
  title: Abfrageargumente in der URL
...
![Projekteinstellungen](/manuals/images/html5/html5_project_settings.png)
...
![Ein HTML5-Bundle erstellen](/manuals/images/html5/html5_bundle.png)
...
Du kannst eine der beiden Architekturen oder beide einbinden. Wenn beide enthalten sind, wählt der Loader `wasm_pthread-web`, sofern der Browser und die Hosting-Umgebung dies unterstützen, und greift andernfalls auf `wasm-web` zurück. Die kanonischen Zielnamen findest du im [Bob-Handbuch](/de/manuals/bob/#usage).
...
Wähle den angeforderten Grafikkontext über [`graphics.webgl_version_hint`](/de/manuals/project-settings/#webgl-version-hint). Der Standardwert ist WebGL 2. Fordere WebGL 1 an, um diesen Kontext in Browsern, die beide Versionen unterstützen, zu testen oder als Ziel zu verwenden.
...
Wenn du **Verify Downloaded File Size** deaktivierst, bleibt eine im Bundle enthaltene SHA-1-Überprüfung weiterhin aktiviert. Siehe die [HTML5-Projekteinstellungen](/de/manuals/project-settings/#verify-downloaded-file-size).
...
* Gamepad-Unterstützung - [Die Gamepad-Dokumentation](/de/manuals/input-gamepads/#gamepads-in-html5) beschreibt Besonderheiten und Schritte, die du bei HTML5 möglicherweise beachten oder durchführen musst.
...
![HTML5-Abschnitt](/manuals/images/html5/html5_section.png)

Weitere Informationen zu jeder Option findest du im [Handbuch zu den Projekteinstellungen](/de/manuals/project-settings/#html5).
...
![HTML5-Abschnitt](/manuals/images/html5/html5_fit.png)
...
![HTML5-Abschnitt](/manuals/images/html5/html5_stretch.png)
...
![Abschnitt Display](/manuals/images/html5/html5_display.png)

Öffne *game.project* als Text und prüfe `[section_name]` sowie den Namen des Felds, das du verwenden möchtest. Anschließend kannst du es als Token verwenden: `{% raw %}{{section_name.field}}{% endraw %}` oder `{% raw %}{{{section_name.field}}}{% endraw %}`.

![Abschnitt Display](/manuals/images/html5/html5_game_project.png)
...
<div class='important' markdown='1'>
Dieser direkt eingefügte Block muss vor dem Laden des Hauptskripts der Anwendung stehen. Da er HTML-Tags enthält, sollte dieses Makro in dreifachen geschweiften Klammern `{% raw %}{{{TOKEN}}}{% endraw %}` stehen, damit Zeichenfolgen nicht maskiert werden.
</div>
...
* [Speicherverbrauch](/de/manuals/optimization-memory)
* [Engine-Größe](/de/manuals/optimization-size)
* [Spielgröße](/de/manuals/optimization-size)

...
Wenn du eine Einführung in die Lua-Programmierung brauchst, lies unser [Handbuch zu Lua in Defold](/de/manuals/lua).
...
{% include shared/de/install.md %}

Nachdem der Editor installiert und gestartet ist, kannst du ein neues Projekt erstellen und vorbereiten. Erstelle ein [neues Projekt](/de/manuals/project-setup/#creating-a-new-project) mit der Vorlage "Empty Project".
...
![Übersicht des Editors](/tutorials/images/runner/1/editor2_overview.png)
...
![Build erstellen](/tutorials/images/runner/1/build_and_launch.png)
...
![Datei mit ungespeicherten Änderungen](/tutorials/images/runner/1/file_changed.png)
</div>
...
![Mit der rechten Maustaste klicken und den Link zur Version kopieren](/tutorials/images/runner/extension-spine-releases.png)

Füge den Link zur Version zu deiner Liste der [Abhängigkeiten in game.project](/de/manuals/libraries/#setting-up-library-dependencies) hinzu. Nachdem du die Spine-Erweiterung hinzugefügt hast, musst du den Editor neu starten, um die mitgelieferte Editorintegration zu aktivieren.
...
2. Erstelle eine neue *Atlas*-Datei für die Bodentexturen. Klicke dazu im Bereich *Assets pane* mit der rechten Maustaste auf einen geeigneten Ordner, beispielsweise den Ordner *main*, und wähle <kbd>New ▸ Atlas File</kbd>. Nenne die Atlasdatei *level.atlas*.
  ...
  <div class='sidenote' markdown='1'>
  Ein *Atlas* ist eine Datei, die mehrere einzelne Bilder in einer größeren Bilddatei zusammenfasst. Das spart Speicherplatz und verbessert die Leistung. Mehr über Atlanten und andere Funktionen für 2D-Grafik erfährst du in der [Dokumentation zur 2D-Grafik](/de/manuals/2dgraphics).
  </div>
...
3. Füge die Bodenbilder zum neuen Atlas hinzu, indem du in der Ansicht *Outline* mit der rechten Maustaste auf den obersten Knoten des Atlas klickst und <kbd>Add Images</kbd> wählst. Wähle die importierten Bilder aus und klicke auf *OK*. Jedes Bild im Atlas steht jetzt als Animation mit einem Einzelbild (Standbild) für Sprites, Partikeleffekte und andere visuelle Elemente zur Verfügung. Speichere die Datei.
  ...
  ![Einen neuen Atlas erstellen](/tutorials/images/runner/1/new_atlas.png)

  ![Bilder zum Atlas hinzufügen](/tutorials/images/runner/1/add_images_to_atlas.png)
...
5. Füge jedem Objekt eine Sprite-Komponente hinzu. Klicke dazu in der Ansicht *Outline* mit der rechten Maustaste auf das Spielobjekt und wähle <kbd>Add Component</kbd>, dann *Sprite* und schließlich *OK*. Setze die Eigenschaft *Image* der Sprite-Komponente auf den gerade erstellten Atlas und die Standardanimation des Sprites auf eines der beiden Bodenbilder. Setze die X-Position der _Sprite-Komponente_ (nicht des Spielobjekts) auf 190 und die Y-Position auf 40. Das Bild ist 380 Pixel breit und wir verschieben es um die Hälfte dieser Pixelzahl zur Seite. Dadurch liegt der Bezugspunkt (pivot) des Spielobjekts am linken Rand des Sprite-Bildes.
  ...
  ![Die Bodensammlung erstellen](/tutorials/images/runner/1/ground_collection.png)
...
6. Die verwendete Grafik ist etwas zu groß. Skaliere deshalb jedes Spielobjekt auf 60 % (Skalierung von 0.6 in X und Y, wodurch 228 Pixel breite Bodenstücke entstehen).
  ...
  ![Den Boden skalieren](/tutorials/images/runner/1/scale_ground.png)
...
9. Starte das Spiel (<kbd>Project ▸ Build</kbd>), um zu sehen, ob alles an seinem Platz ist.
  ...
  ![Unbewegter Boden](/tutorials/images/runner/1/still_ground.png)
...
Für den Moment reichen diese Beschreibungen wahrscheinlich aus. Eine wesentlich ausführlichere Erklärung findest du jedoch im [Handbuch zu Bausteinen](/de/manuals/building-blocks). Es ist sinnvoll, dieses Handbuch später zu lesen, um genauer zu verstehen, wie Defold funktioniert.
...
Defold ergänzt Lua um mehrere APIs sowie ein System zur _Nachrichtenübermittlung_, mit dem du die Kommunikation zwischen Spielobjekten programmieren kannst. Wie das funktioniert, erfährst du im [Handbuch zur Nachrichtenübermittlung](/de/manuals/message-passing).
</div>
...
![Bodensteuerung](/tutorials/images/runner/1/ground_controller.png)
...
![Atlas der Heldenfigur](/tutorials/images/runner/2/hero_atlas.png)
...
![Eigenschaften des Spine-Modells](/tutorials/images/runner/2/spinemodel_properties.png)
...
<div class='sidenote' markdown='1'>
Bei Kollisionen vom Typ "Kinematic" werden Kollisionen erkannt, aber die Physik-Engine löst sie nicht automatisch auf und simuliert die Objekte nicht. Die Physik-Engine unterstützt verschiedene Typen von Kollisionsobjekten. Mehr darüber erfährst du in der [Physikdokumentation](/de/manuals/physics).
</div>
...
![Spielobjekt der Heldenfigur](/tutorials/images/runner/2/hero_game_object.png)
...
Dafür und für eine korrekte Behandlung der Kollisionen brauchen wir ein wenig Vektorrechnung. Eine ausführliche Erklärung zur Auflösung kinematischer Kollisionen findest du in der [Physikdokumentation](/de/manuals/physics-resolving-collisions/).
</div>
...
![Eingabebindungen](/tutorials/images/runner/2/input_bindings.png)
...
![Skripteigenschaft](/tutorials/images/runner/2/script_property.png)
...
![Code für den Boden hinzufügen](/tutorials/images/runner/insert_ground_code.png)
...
![Bodenkollision](/tutorials/images/runner/2/ground_collision.png)
...
![Plattform](/tutorials/images/runner/2/platform_long.png)
...
![Das Spiel ausführen](/tutorials/images/runner/2/run_game.png)
...
![Code für die Heldenfigur einfügen](/tutorials/images/runner/insert_hero_code.png)
...
8. Speichere die Datei.
    ...
    ![Stacheln an der Plattform](/tutorials/images/runner/3/danger_edges.png)
...
9. Öffne *hero.go*, markiere das *Collision Object* und füge den Namen "danger" zur Eigenschaft *Mask* hinzu. Speichere anschließend die Datei.
    ...
    ![Kollision der Heldenfigur](/tutorials/images/runner/3/hero_collision.png)
...
3. Öffne *platform.script* und ändere es so, dass es eine Plattform, die den linken Rand erreicht hat, nicht einfach löscht. Stattdessen soll es eine Nachricht an die Levelsteuerung senden und sie auffordern, die Plattform zu entfernen:
    ...
    ![Code für die Plattform einfügen](/tutorials/images/runner/insert_platform_code.png)
...
![Code für die Heldenfigur einfügen](/tutorials/images/runner/insert_hero_code_2.png)
...
10. Füge dem Münzobjekt die Skriptdatei als *Script*-Komponente hinzu (Rechtsklick auf den obersten Knoten in *Outline* und <kbd>Add Component from File</kbd>).
    ...
    ![Spielobjekt der Münze](/tutorials/images/runner/3/coin.png)
...
![Münzfabrik](/tutorials/images/runner/3/coin_factory.png)
...
![Code für die Steuerung einfügen](/tutorials/images/runner/insert_controller_code.png)
...
> Lade die fertige Version des Projekts [hier](/tutorials/images/runner/sample-runner.zip) herunter.

...
In diesem Beispielprojekt, das du [im Editor öffnen](/de/manuals/project-setup/) oder [von GitHub herunterladen](https://github.com/defold/sample-parallax) kannst, zeigen wir, wie du mit einem Parallaxeneffekt Tiefe in der Spielwelt simulierst.

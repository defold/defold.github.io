...
![Vorschaubild](/tutorials/images/snake/thumbnail.png)
...
Dieses Tutorial richtet sich an Einsteiger. Wenn du aber mit Defold und der Spieleentwicklung noch gar nicht vertraut bist, empfehlen wir dir, zuerst einige einführende Handbücher zu lesen, insbesondere über [Defolds Bausteine](/de/manuals/building-blocks/) und das [Glossar](/de/manuals/glossary/). Falls du Defold noch nicht heruntergeladen hast, sieh dir das [Installationshandbuch](/de/manuals/install/) an. Empfehlenswert ist auch die [Übersicht des Editors](/de/manuals/editor/), um dich schnell im Editor zurechtzufinden. Hier zeigen wir aber ebenfalls Bildschirmaufnahmen zu jedem Schritt.
...
![Projekt erstellen](/tutorials/images/snake/1.png)
...
![Neuer Ordner](/tutorials/images/snake/3.png)
...
![Snake-Sprites](/tutorials/images/snake/snake.png)
...
![Neuer Ordner](/tutorials/images/snake/4.png)

Weitere Einzelheiten zum [Importieren von Assets findest du hier](/de/manuals/importing-graphics/).

<input type="checkbox"/> Erledigt!

## Eine Kachelquelle hinzufügen {#adding-a-tile-source}

Defold bietet eine integrierte Komponente (component) für [Kachelkarten](/de/manuals/tilemap/), mit der du das Spielfeld aus *Kacheln* erstellst, die in einem Raster angeordnet sind. Eine Kachelkarte ermöglicht es dir, einzelne Kacheln zu setzen und auszulesen, was perfekt zu diesem Spiel passt. Da Kachelkarten ihre Grafiken aus einer [Kachelquelle](/de/manuals/tilesource/) (tile source) beziehen, musst du eine erstellen:
...
![Neue Kachelquelle](/tutorials/images/snake/5.png)
...
![Kachelquelle](/tutorials/images/snake/6.png)
...
![Eigenschaften der Kachelquelle](/tutorials/images/snake/7.png)
...
![Kachelkarte hinzufügen](/tutorials/images/snake/8.png)
...
![Kachelquelle festlegen](/tutorials/images/snake/9.png)
...
![Kachelkarte](/tutorials/images/snake/10.png)

3. Zeichne einen Rand entlang des Bildschirmrands und einige Hindernisse.
![Fertige Kachelkarte](/tutorials/images/snake/11.png)
...
![Spielobjekt hinzufügen](/tutorials/images/snake/12.png)
...
![Komponente hinzufügen](/tutorials/images/snake/13.png)
...
![Spiel starten](/tutorials/images/snake/14.png)
...
![Skript hinzufügen](/tutorials/images/snake/15.png)
...
![Hauptsammlung](/tutorials/images/snake/16.png)
...
![Algorithmus](/tutorials/images/snake/17.png)
...
![Spiel starten](/tutorials/images/snake/snake_run_1.png)
...
![Eingabe](/tutorials/images/snake/18.png)

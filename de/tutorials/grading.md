...
Wir gehen davon aus, dass du dich im Defold-Editor zurechtfindest und grundlegende Kenntnisse über GL-Shader und die Rendering-Pipeline von Defold hast. Wenn du dich in diese Themen einlesen möchtest, sieh dir [unser Shader-Handbuch](/de/manuals/shader/) und das [Render-Handbuch](/de/manuals/render/) an.
...
Du kannst das Shader-Programm einer Komponente durch eines ersetzen, das die Pixeldaten verändert oder völlig neue Pixelfarben programmgesteuert erzeugt. Im [Shadertoy-Tutorial](/de/tutorials/shadertoy) erfährst du, wie das geht.
...
![Renderziel](/tutorials/images/grading/render_target.png)
...
7. Öffne *`main.collection`*, wähle die Modellkomponente im Spielobjekt „`grade`“ aus und setze ihre Eigenschaft *Material* auf „`/main/grade.material`“.
   ...
   ![Modelleigenschaften](/tutorials/images/grading/model_properties.png)
...
![Entsättigtes Spiel](/tutorials/images/grading/desaturated_game.png)
...
![Farbwürfel](/tutorials/images/grading/color_cube.png)
...
![Farbkorrektur mit Renderziel](/tutorials/images/grading/render_target_grading.png)
...
![Nachschlagetextur](/tutorials/images/grading/lut.png)
...
![Nachschlagetabelle](/tutorials/images/grading/lut_lookup.png)
...
![Filterung der Nachschlagetabelle](/tutorials/images/grading/lut_filtering.png)
...
3. Setze die Eigenschaft *`Filter min`* auf `FILTER_MODE_MIN_LINEAR` und die Eigenschaft *`Filter mag`* auf `FILTER_MODE_MAG_LINEAR`.
    ...
    ![Sampler der Nachschlagetabelle](/tutorials/images/grading/material_lut_sampler.png)

4. Lade die folgende Textur der Nachschlagetabelle (*`lut16.png`*) herunter und füge sie deinem Projekt hinzu.

    ![Nachschlagetabelle mit 16 Farben](/tutorials/images/grading/lut16.png)

5. Öffne *`main.collection`* und setze die Textureigenschaft *`lut`* auf die heruntergeladene Nachschlagetextur.

    ![Nachschlagetabelle des Quad-Modells](/tutorials/images/grading/quad_lut.png)
...
![Spielwelt mit ursprünglicher Farbgebung](/tutorials/images/grading/world_original.png)
...
![Streifenbildung im Blauverlauf](/tutorials/images/grading/blue_banding.png)
...
![Blauverlauf ohne Streifenbildung](/tutorials/images/grading/blue_no_banding.png)
...
![Spielwelt in Affinity](/tutorials/images/grading/world_graded_affinity.png)
...
![Farbkorrigierte Spielwelt](/tutorials/images/grading/world_graded.png)

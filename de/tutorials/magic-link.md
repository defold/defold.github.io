...
* Erstelle ein [neues Projekt](/de/manuals/project-setup/#creating-a-new-project) aus der Vorlage „Empty Project“
...
![Schematische Darstellung der Spielregeln](/tutorials/images/magic-link/linker_rules.png)
...
![Ordnerstruktur](/tutorials/images/magic-link/linker_folders.png)
...
![Projekteinstellungen](/tutorials/images/magic-link/linker_project_settings.png)
...
![Aufteilung und Größenverhältnisse des Spielfelds](/tutorials/images/magic-link/linker_layout.png)
...
![Maximale Sprite-Anzahl](/tutorials/images/magic-link/linker_sprite_max_count.png)
...
![Bilder hinzufügen](/tutorials/images/magic-link/linker_add_images.png)
...
![Bilder zum Atlas hinzufügen](/tutorials/images/magic-link/linker_add_to_atlas.png)
...
![Sammlung für das Spielfeld](/tutorials/images/magic-link/linker_board_collection.png)

![Spielfeldsammlung als Startsammlung](/tutorials/images/magic-link/linker_bootstrap_board.png)
...
![Spielobjekt für einen Block](/tutorials/images/magic-link/linker_block.png)
...
![Fabrik für Blöcke](/tutorials/images/magic-link/linker_blockfactory.png)

Jetzt solltest du das Spiel starten können und ein Spielfeld sehen, das mit zufällig gefärbten Blöcken gefüllt ist:

![Erste Bildschirmaufnahme](/tutorials/images/magic-link/linker_first_screenshot.png)
...
![Eingabebindungen](/tutorials/images/magic-link/linker_input_bindings.png)
...
![Spielobjekt für eine Verbindung](/tutorials/images/magic-link/linker_connector.png)

![Fabrik für Verbindungen](/tutorials/images/magic-link/linker_connector_factory.png)
...
![Verbindungen im Spiel](/tutorials/images/magic-link/linker_connector_screen.png)
...
![Blöcke nach unten gleiten lassen](/tutorials/images/magic-link/linker_blocks_slide.png)
...
![Sprite für die Abdeckung](/tutorials/images/magic-link/linker_cover.png)
...
![Magischer Block ohne und mit Licht](/tutorials/images/magic-link/linker_magic_blocks.png)
...
![Regionen markieren](/tutorials/images/magic-link/linker_regions.png)
...
![Erster Sieg](/tutorials/images/magic-link/linker_first_win.png)
...
![Abwurf](/tutorials/images/magic-link/linker_drop.png)
...
![GUI des Hauptmenüs](/tutorials/images/magic-link/linker_main_menu.png)
...
![Hauptsammlung](/tutorials/images/magic-link/linker_main_collection.png)

Öffne nun *game.project* und ändere die Startsammlung (bootstrap collection) *main_collection* auf `/main/main.collectionc`.

![Hauptsammlung als Startsammlung](/tutorials/images/magic-link/linker_bootstrap_main.png)
...
![GUI des Spielfelds](/tutorials/images/magic-link/linker_board_gui.png)
...
![GUI für den Neustart](/tutorials/images/magic-link/linker_restart_gui.png)
...
![Dialog für den Levelabschluss](/tutorials/images/magic-link/linker_level_complete_gui.png)
...
![GUI zur Vorstellung des Levels](/tutorials/images/magic-link/linker_present_level_gui.png)
...
![GUI bei fehlendem Platz für einen Abwurf](/tutorials/images/magic-link/linker_no_drop_room_gui.png)
...
![Fertige Spielfeldsammlung](/tutorials/images/magic-link/linker_board_collection_final.png)
...
![Fertiges Spiel](/tutorials/images/magic-link/linker_game_finished.png)

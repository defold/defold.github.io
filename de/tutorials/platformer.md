...
![Näherungsweise Integration der Geschwindigkeit](/tutorials/images/platformer/integration.png)
...
![Gleichung der Geschwindigkeit](/tutorials/images/platformer/equationofvelocity.png)
...
![Gleichung der Verschiebung](/tutorials/images/platformer/equationoftranslation.png)
...
Wenn du dir nicht sicher bist, wie du Eingaben in Defold verarbeitest, findest du [hier](/de/manuals/input) eine Anleitung dazu.
...
![Kontaktnormalen, die auf die Spielfigur wirken](/tutorials/images/platformer/collision.png)
...
![Der Defold-Editor mit der Levelgeometrie und der in der Welt platzierten Spielfigur](/tutorials/images/platformer/editor.png)
...
![Mehrere kachelbasierte Polygone zu einem einzigen verbunden](/tutorials/images/platformer/stitching.png)
...
Weitere Informationen findest du in unseren Anleitungen zu [Physik](/de/manuals/physics) und [Kacheln](/de/manuals/2dgraphics).

...
![Neues Projekt](/tutorials/images/new_empty.png)
...
Erstelle zunächst ein [neues Projekt](/de/manuals/project-setup/) und öffne es im Editor. Wenn du auf die Datei *main/main.collection* doppelklickst, wird sie geöffnet:
...
![Build erstellen](/tutorials/images/car/start_build_and_launch.png)
...
![Datei mit ungespeicherten Änderungen](/tutorials/images/car/file_changed.png)
</div>
...
![Neue Sammlungsdatei](/tutorials/images/car/start_new_collection.png)
...
![Auto-Spielobjekt hinzufügen](/tutorials/images/car/start_add_car_gameobject.png)
...
![Komponente zum Auto hinzufügen](/tutorials/images/car/start_add_car_component.png)
...
![Autobild](/tutorials/images/car/start_car.png)
![Reifenbild](/tutorials/images/car/start_tire.png)

Füge diese Bilder zum Atlas hinzu:

![Sprite-Atlas](/tutorials/images/car/start_sprites_atlas.png)

![Sprite-Eigenschaften](/tutorials/images/car/start_sprite_properties.png)
...
![Fertige Autosammlung](/tutorials/images/car/start_car_collection_complete.png)
...
<div class='sidenote' markdown='1'>
Defold stellt mehrere Lebenszyklusfunktionen bereit, mit denen du Spiellogik programmieren kannst. Mehr darüber erfährst du im [Skript-Handbuch](/de/manuals/script).
</div>
...
![Eingabebindungen](/tutorials/images/car/start_input_bindings.png)
...
![Die Autosammlung hinzufügen](/tutorials/images/car/start_adding_car_collection.png)
...
3. Füge deinem Auto Sounds hinzu und lass es brummen! ([Tipp](/de/manuals/sound/))

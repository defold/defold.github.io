...
In diesem Beispielprojekt, das du [im Editor öffnen](/de/manuals/project-setup/) oder [von GitHub herunterladen](https://github.com/defold/sample-rpgmap) kannst, zeigen wir eine Methode zum Erstellen sehr großer RPG-Karten in Defold. Der Entwurf beruht auf den folgenden Annahmen:

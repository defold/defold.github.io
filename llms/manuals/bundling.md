...
To learn more about build reports please refer to the [Profiling manual](https://defold.com/llms/manuals/profiling.md).

### Android

Creating an Android application bundle (.apk file) is documented in the [Android manual](https://defold.com/llms/manuals/android.md).

### iOS

Creating an iOS application bundle (.ipa file) is documented in the [iOS manual](https://defold.com/llms/manuals/ios.md).

### macOS

Creating a macOS application bundle (.app file) is documented in the [macOS manual](https://defold.com/llms/manuals/macos.md).

### Linux

Creating a Linux application bundle requires no specific setup and no optional platform specific configuration in the *game.project* [project settings file](https://defold.com/llms/manuals/project-settings.md).

### Windows

Creating a Windows application bundle (.exe file) is documented in the [Windows manual](https://defold.com/llms/manuals/windows.md).

### HTML5

Creating an HTML5 application bundle as well as optional setup is documented in the [HTML5 manual](https://defold.com/llms/manuals/html5.md).

#### Facebook Instant Games

It is possible to create a special version of an HTML5 application bundle specifically for Facebook Instant Games. This process is documented in the [Facebook Instant Games manual](https://defold.com/llms/manuals/instant-games.md).

## Bundling from the command line

The editor uses our command line tool [Bob](https://defold.com/llms/manuals/bob.md) to bundle the application.

While doing day to day development of your application it is likely that you build and bundle from within the Defold editor. In other circumstances you may wish to automatically generate application bundles, for instance batch building for all targets when releasing a new version or when creating nightly builds of the latest version of the game, perhaps in a CI environment. Building and bundling of an application can be done outside the normal editor workflow using the [Bob command line tool](https://defold.com/llms/manuals/bob.md).
...
Using the [bundle_resources](https://defold.com/llms/manuals/project-settings.md) setting, you can configure assets that should be placed within the bundle as-is.
...
Using the [custom_resources](https://defold.com/llms/manuals/project-settings.md) setting, you can configure assets that should be placed (with compression) within the `game.arcd`.
...
* Release builds do not include the [screen recorder](https://defold.com/ref/sys/#start_record)
...
* Release builds do not support targeting from the editor for [hot-reload](https://defold.com/llms/manuals/hot-reload.md) and similar functionality
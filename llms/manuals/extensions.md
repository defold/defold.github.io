...
Supported `arc-platform` pairs are `arm64-ios`, `arm64_sim-ios`, `armv7-android`, `arm64-android`, `x86_64-android`, `arm64-osx`, `x86_64-osx`, `x86-win32`, `x86_64-win32`, `arm64-linux`, `x86_64-linux`, `wasm-web` and `wasm_pthread-web`.
...
See [file access](https://defold.com/llms/manuals/file-access.md) for how custom resources differ from bundle resources.

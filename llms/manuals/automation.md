# Automation in Defold {#manuals:automation}
...
| Layer | Purpose |
| --- | --- |
| [Editor Scripts](https://defold.com/llms/manuals/editor-scripts.md) | Custom commands and Editor workflows or integrations to speed up testing and development, e.g. creation of levels, assets |
| [Editor UI scripts](https://defold.com/llms/manuals/editor-scripts-ui.md) | Custom visual tools, popups, configurators, or user interfaces utilizing Editor Scripts |
| [Editor HTTP API](https://defold.com/llms/manuals/editor-http-api.md) | Control the open game project in the Defold Editor via OpenAPI operations, project resources, builds, editor commands, previews, preferences, console output, or editor scripts for custom operations, external tools, IDE integrations, and test controllers |
| [Bob CLI](https://defold.com/llms/manuals/bob.md) | Building a project, creating data archives or standalone bundles from the command line, reports, CI |
| [Lifecycle hooks](https://defold.com/llms/manuals/editor-http-api#lifecycle-hooks.md) | Validation or generation before and after editor builds or bundling |
| [Engine HTTP service](https://defold.com/llms/manuals/engine-service.md) | Running Defold game engine (`dmengine`) inspection, development services, profiling, runtime messages, or extension-defined runtime automation APIs, external tools querying, sending commands to a running debug build |
...
| [Automated tests](https://defold.com/llms/manuals/automated-testing.md) | Testing game logic, messages, components, input, physics, and engine behavior, scene inspection, visual feedback e.g. via [editor preview](https://defold.com/llms/manuals/editor-http-api.md), injected input, live application state, [running test collections](https://defold.com/llms/manuals/automated-testing.md) |
...
* [Automating the Defold editor tasks with HTTP API](https://defold.com/llms/manuals/editor-http-api.md)
* [The engine service and runtime HTTP API](https://defold.com/llms/manuals/engine-service.md)
* [Automated testing and verification](https://defold.com/llms/manuals/automated-testing.md)
* [Using AI coding agents with Defold](https://defold.com/llms/manuals/ai-agents.md)
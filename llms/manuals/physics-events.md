...
If a listener is set, [physics messages](https://defold.com/llms/manuals/physics-messages.md) will no longer be sent for the physics world where this listener is set.

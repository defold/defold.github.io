...
A Buffer resource can be used as input to a [Mesh component](https://defold.com/llms/manuals/mesh.md). Buffer resources can also be created at runtime using the `buffer.create()` and [related API functions](https://defold.com/ref/buffer/#buffer.create:element_count-declaration).
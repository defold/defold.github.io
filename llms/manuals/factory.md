...
Plan *Max Instances* around the greatest number of game objects that may be alive at once in a dynamic world. See [Component max count optimizations](https://defold.com/llms/manuals/project-settings.md) for how the other component limits are calculated.

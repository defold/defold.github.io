...
* `If-None-Match: ` will be set with the ETag of any previously cached response.
...
* `Range: bytes=-` will be set if requesting a partial response, for instance when [streaming sounds](/sound-streaming#sound-streaming).

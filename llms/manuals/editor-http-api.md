...
A completed build does not mean that the game has finished loading in the browser. Wait for the canvas and application readiness before sending input or checking gameplay. See [Browser tests for HTML5](https://defold.com/llms/manuals/automated-testing.md) for more details.

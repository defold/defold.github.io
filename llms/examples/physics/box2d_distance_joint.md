...
Compare a rigid distance joint with the same joint configured as a damped spring.

[Project files](https://github.com/defold/examples/tree/master/physics/box2d_distance_joint)

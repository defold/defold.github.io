...
已更改文件
: 包含与当前 Git 提交相比在本地添加、修改、重命名或删除的文件。您可以在此查看文本差异并还原本地更改。请使用外部 Git 客户端或命令行与远程仓库同步。
...
![构建](/tutorials/images/car/start_build_and_launch.png)
...
![包含未保存更改的文件](/tutorials/images/car/file_changed.png)
</div>
...
![新建集合文件](/tutorials/images/car/start_new_collection.png)
...
![添加汽车游戏对象](/tutorials/images/car/start_add_car_gameobject.png)
...
![添加汽车组件](/tutorials/images/car/start_add_car_component.png)
...
![汽车图像](/tutorials/images/car/start_car.png)
![轮胎图像](/tutorials/images/car/start_tire.png)

将这些图像添加到图集：

![精灵图集](/tutorials/images/car/start_sprites_atlas.png)

![精灵属性](/tutorials/images/car/start_sprite_properties.png)
...
![汽车集合完成](/tutorials/images/car/start_car_collection_complete.png)
...
<div class='sidenote' markdown='1'>
Defold 提供了几个生命周期函数来编写游戏逻辑。在[脚本手册](/zh/manuals/script)中阅读更多关于它们的信息。
</div>
...
![输入绑定](/tutorials/images/car/start_input_bindings.png)
...
![添加汽车集合](/tutorials/images/car/start_adding_car_collection.png)
...
3. 为您的汽车添加声音，使其发出嗡嗡声！（[提示](/zh/manuals/sound/)）

...
![文件夹结构](/tutorials/images/magic-link/linker_folders.png)
...
![项目设置](/tutorials/images/magic-link/linker_project_settings.png)

我们还需要增加渲染的最大精灵数量。如果您愿意，可以跳到下一节，当您在控制台收到通知说您已达到精灵限制时再回到这里。

![游戏比例布局](/tutorials/images/magic-link/linker_layout.png)
...
![最大精灵数量](/tutorials/images/magic-link/linker_sprite_max_count.png)
...
![游戏板集合](/tutorials/images/magic-link/linker_board_collection.png)

![游戏板集合引导](/tutorials/images/magic-link/linker_bootstrap_board.png)
...
![Block 游戏对象](/tutorials/images/magic-link/linker_block.png)
...
![Connector 游戏对象](/tutorials/images/magic-link/linker_connector.png)
...
![游戏中的连接器](/tutorials/images/magic-link/linker_connector_screen.png)
...
![向下滑动方块](/tutorials/images/magic-link/linker_blocks_slide.png)
...
![没有光和有光的魔法方块](/tutorials/images/magic-link/linker_magic_blocks.png)
...
![标记区域](/tutorials/images/magic-link/linker_regions.png)
...
![首次获胜](/tutorials/images/magic-link/linker_first_win.png)
...
![掉落](/tutorials/images/magic-link/linker_drop.png)
...
![主菜单 GUI](/tutorials/images/magic-link/linker_main_menu.png)
...
集合代理允许我们动态地将集合加载和卸载到运行的游戏中。它代表指定的集合文件，我们通过向代理发送消息来加载、初始化、启用、禁用和卸载动态集合。有关如何使用它们的完整描述，请参阅 [Collection Proxy 文档](/zh/manuals/collection-proxy)。
...
![引导主集合](/tutorials/images/magic-link/linker_bootstrap_main.png)
...
![游戏板 GUI](/tutorials/images/magic-link/linker_board_gui.png)
...
![重启 GUI](/tutorials/images/magic-link/linker_restart_gui.png)
...
![关卡完成对话框](/tutorials/images/magic-link/linker_level_complete_gui.png)
...
![呈现关卡 GUI](/tutorials/images/magic-link/linker_present_level_gui.png)
...
![无掉落空间 GUI](/tutorials/images/magic-link/linker_no_drop_room_gui.png)
...
![最终游戏板集合](/tutorials/images/magic-link/linker_board_collection_final.png)
...
![游戏完成](/tutorials/images/magic-link/linker_game_finished.png)

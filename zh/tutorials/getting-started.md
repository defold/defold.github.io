...
![创建项目](/tutorials/images/getting-started/new-project.png)

编辑器现在会自动下载教程项目，在编辑器中打开它，并打开教程文本（项目根目录中的"README"文件）。

![教程文本](/tutorials/images/getting-started/tutorial-text.png)
...
![并排查看](/tutorials/images/getting-started/side-by-side.png)

如果您是 Defold 的新手，您可能还想查看[编辑器介绍](/zh/manuals/editor)。

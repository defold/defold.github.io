...
在本示例项目中，您可以[从编辑器打开](/zh/manuals/project-setup/)或[从GitHub下载](https://github.com/defold/sample-levelcomplete)，我们演示了显示关卡完成时可能出现的分数计数效果。总分数会逐渐累加，当达到不同分数等级时会出现三颗星星。该示例还使用了重新加载功能，以便在调整值时快速周转。

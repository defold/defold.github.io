...
[Shadertoy.com](https://www.shadertoy.com/)是一个汇集用户贡献的GLSL着色器的网站。它是寻找着色器代码和灵感的绝佳资源。在本教程中，我们将从Shadertoy获取一个着色器，并使其在Defold中运行。本教程假设您对着色器有基本了解。如果您需要阅读相关内容，[着色器手册](/zh/manuals/shader/)是一个很好的起点。
...
![Blender中的四边形](/tutorials/images/shadertoy/quad_blender.png)
...
![Defold中的四边形](/tutorials/images/shadertoy/quad_no_material.png)
...
6. 在*标签*中添加一个"tile"标签。这样四边形将在绘制精灵和瓦片时包含在渲染通道中。
    ...
    ![材质](/tutorials/images/shadertoy/material.png)
...
![Defold中的四边形](/tutorials/images/shadertoy/quad_material.png)

## 星巢着色器

现在一切准备就绪，可以开始处理实际的着色器代码了。让我们先看一下原始代码。它由几个部分组成：

![Star Nest着色器代码](/tutorials/images/shadertoy/starnest_code.png)
...
![带有starnest的四边形](/tutorials/images/shadertoy/quad_starnest.png)
...
![时间常量](/tutorials/images/shadertoy/time_constant.png)
...
4. 最后，将*star-nest.script*作为脚本组件添加到"star-nest"游戏对象：
    ...
    ![脚本组件](/tutorials/images/shadertoy/script_component.png)

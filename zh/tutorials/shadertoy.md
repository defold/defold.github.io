...
[Shadertoy.com](https://www.shadertoy.com/) 是一个汇集用户贡献 GL 着色器的网站。它是寻找着色器代码和灵感的绝佳资源。在本教程中，我们将从 Shadertoy 取一个着色器并让它在 Defold 中运行。本教程假设您对着色器有基本了解。如果需要补充知识，[着色器手册](/zh/manuals/shader/)是很好的起点。

...
![GUI 缩放](/manuals/images/gui-box/scaling.png)

九宫格方块节点包含4个像素数值分别代表左, 上, 右, 下有多少边缘不参与缩放:

![九宫格属性](/manuals/images/gui-box/slice9_properties.png)

从左边开始, 顺时针设置:

![九宫格设置](/manuals/images/gui-box/slice9.png)
...
![九宫格 mipmapping](/manuals/images/gui-box/mipmap.png)

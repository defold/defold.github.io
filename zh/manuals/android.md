...
Defold 在 Android 签名流程中使用密钥库。[更多信息请参阅此论坛帖子](https://forum.defold.com/t/upcoming-change-to-the-android-build-pipeline/66084)。
</div>
...
扩展的保留规则应放在其 `manifests/android` 目录中，与 `build.gradle` 位于同一位置。有关如何添加文件并保留扩展的 Java 类，请参阅 [Android 扩展的 R8 保留规则](/zh/manuals/extensions/#r8-keep-rules-for-android)。
...
允许应用程序打开*网络套接字*并访问网络信息。这些权限是访问互联网所必需的。（[Android 官方文档](https://developer.android.com/reference/android/Manifest.permission#INTERNET)）和（[Android 官方文档](https://developer.android.com/reference/android/Manifest.permission#ACCESS_NETWORK_STATE)）。

...
: ![spine node](/manuals/images/icons/spine-model.png)
  显示spine模型和动画. 详情请见 [Spine 节点教程](/zh/manuals/gui-spine).
...
: 节点上显示的spine scene. 详情请见 [Spine 节点教程](/zh/manuals/gui-spine)

Default Animation (spine 节点)
: 节点上自动播放的spine动画. 详情请见 [Spine 节点教程](/zh/manuals/gui-spine)

Skin (spine 节点)
: 节点上使用的spine皮肤. 详情请见 [Spine 节点教程](/zh/manuals/gui-spine)

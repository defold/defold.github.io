...
如果纹理应该在[精灵组件](/zh/manuals/sprite/)上使用，它首先需要被图集使用。使用 [`resource.create_atlas(path, params)`](https://defold.com/ref/resource/#resource.create_atlas:path-table) 创建图集：

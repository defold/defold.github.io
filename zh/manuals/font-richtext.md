...
![渲染为不透明绿色的示例文本](/manuals/images/richtext/color_green.webp)
...
![渲染为半透明绿色的示例文本](/manuals/images/richtext/color_green_alpha.webp)
...
![以 24 像素渲染的示例文本](/manuals/images/richtext/size_24.webp)
...
![以 32 像素的 120% 渲染的示例文本](/manuals/images/richtext/size_120.webp)
...
![以 32 像素基础大小的两倍渲染的示例文本](/manuals/images/richtext/size_2em.webp)
...
![具有从品红到白色的水平渐变的示例文本](/manuals/images/richtext/gradient_horizontal.webp)
...
![具有蓝色垂直渐变的示例文本](/manuals/images/richtext/gradient_vertical.webp)
...
![四角渐变适配到每个字形的示例文本](/manuals/images/richtext/gradient_four_glyph.webp)
...
![四角渐变适配到整段文本的示例文本](/manuals/images/richtext/gradient_four_text.webp)
...
![适配到每个字形的动态流动渐变](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![适配到整段文本的动态流动渐变](/manuals/images/richtext/gradient_flow_span.webp)
...
![带实线下划线的示例文本](/manuals/images/richtext/underline_solid.webp)
...
![带虚线下划线的示例文本](/manuals/images/richtext/underline_dashed.webp)
...
![带渐变下划线的示例文本](/manuals/images/richtext/underline_gradient.webp)
...
![带实线删除线的示例文本](/manuals/images/richtext/strike_solid.webp)
...
![带虚线删除线的示例文本](/manuals/images/richtext/strike_dashed.webp)
...
![带黑色外轮廓的示例文本](/manuals/images/richtext/outline.webp)
...
![带偏移阴影的示例文本](/manuals/images/richtext/shadow.webp)
...
![逐字形动态抖动的示例文本](/manuals/images/richtext/shake_glyph.webp)
...
![整段动态抖动的示例文本](/manuals/images/richtext/shake_span.webp)
...
![逐字形动态波动的示例文本](/manuals/images/richtext/wave_glyph.webp)
...
![整段一同运动的示例文本](/manuals/images/richtext/wave_span.webp)
...
![与文本同行渲染的 Defold 标志](/manuals/images/richtext/sprite.webp)
...
![使用默认链接样式和下划线渲染的 www.defold.com](/manuals/images/richtext/link.webp)
...
有关设置的详细信息，请参阅[输入焦点](/zh/manuals/input/#input-focus)和[鼠标与触摸输入](/zh/manuals/input-mouse-and-touch)。

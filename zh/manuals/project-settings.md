...
toc: ["项目配置","各类设置","Project","Title","Version","Write Log","Compress Archive","Dependencies","Custom Resources","Bundle Resources","Bundle Exclude Resources","Bootstrap","Main Collection","Render","Library","Include Dirs","Script","Shared State","Engine","Run While Iconified","Fixed Update Frequency","Display","Width","Height","High Dpi","Samples","Fullscreen","Update Frequency","Swap interval","Display Profiles","Dynamic Orientation","Render","Clear Color Red","Clear Color Green","Clear Color Blue","Clear Color Alpha","Physics","Type","Gravity Y","Debug","Debug Alpha","World Count","Gravity X","Gravity Z","Scale","Allow Dynamic Transforms","Use Fixed Timestep","Debug Scale","Max Collisions","Max Contacts","Contact Impulse Limit","Ray Cast Limit 2d","Ray Cast Limit 3d","Trigger Overlap Capacity","Graphics","Default Texture Min Filter","Default Texture Mag Filter","Max Draw Calls","Max Characters:","Max Debug Vertices","Texture Profiles","Verify Graphics Calls","Shader","Output SPIR-V","Input","Repeat Delay","Repeat Interval","Gamepads","Game Binding","Use Accelerometer","Resource","Http Cache","Uri","Max Resources","Network","Http Timeout","Http Thread Count","Http Cache Enabled","SSL Certificates","Collection","Max Instances","Max Input Stack Entries","Sound","Gain","Max Sound Data","Max Sound Buffers","Max Sound Sources","Max Sound Instances","Use Thread","Sprite","Max Count","Subpixels","Tilemap","Max Count","Max Tile Count","Spine","Max Count","Mesh","Max Count","Model","Max Count","GUI","Max Count","Max Particlefx Count","Max Particle Count","Max Animation Count","Label","Max Count","Subpixels","Particle FX","Max Count","Max Particle Count","Collection proxy","Max Count","Collection factory","Max Count","Factory","Max Count","iOS","App Icon 57x57--180x180","Launch Screen","Pre Rendered Icons","Bundle Identifier","Bundle Name","Bundle Version","Info.plist","Privacy Manifest","Custom Entitlements","Override Entitlements","Default Language","Localizations","Android","App Icon 36x36--192x192","Push Icon Small--LargeXxxhdpi","Push Field Title","Push Field Text","Version Code","Package","Gcm Sender Id","Manifest","Iap Provider","Input Method","Immersive Mode","Debuggable","Extract Native Libs","macOS","App Icon","Info.plist","Privacy Manifest","Bundle Identifier","Default Language","Localizations","Windows","App Icon","Iap Provider","HTML5","Heap Size",".html Shell","Custom .css","Splash Image","Archive Location Prefix","Archive Location Suffix","Engine Arguments","Show Fullscreen Button","Show Made With Defold","Scale Mode","IAP","Auto Finish Transactions","Live update","Private Key","Public Key","Native extension","_App Manifest_","Profiler","Track Cpu","File format","在引擎启动时设定配置值","Specify a bootstap collection","Set two custom config values","自定义项目配置文件"]
title: Defold 项目配置
...
#### Custom Resources
`custom_resources`
项目中包含的以逗号分隔的资源列表. 如指定的是目录, 则目录下所有文件及其子目录都会包含进去. 这些资源可以通过 [`sys.load_resource()`](/ref/sys/#sys.load_resource) 载入. 自定义资源的加载详情请见 [文件存取教程](/zh/manuals/file-access/#how-to-access-files-bundled-with-the-application).
...
(举例: 在安卓平台上要这么写 "file:///android_asset/"). 文件的加载详情请见 [文件存取教程](/zh/manuals/file-access/#how-to-access-files-bundled-with-the-application).
...
#### _App Manifest_
如果设置了, 则在自定义引擎编译时使用指定的 manifest. 此设置可以让你移除引擎不必要的部分来减小包体. 关于如何去除引擎功能参见 [应用清单教程](/zh/manuals/app-manifest).

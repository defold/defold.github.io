...
When you run your game locally from the editor or connected to the [mobile dev app](/zh/manuals/dev-app) all of the output will be shown in the console pane of the editor:

...
* Crea un [nuovo progetto](/it/manuals/project-setup/#creating-a-new-project) dal modello "Empty Project"
...
![Schema delle regole del gioco](/tutorials/images/magic-link/linker_rules.png)
...
![Struttura delle cartelle](/tutorials/images/magic-link/linker_folders.png)
...
![Impostazioni del progetto](/tutorials/images/magic-link/linker_project_settings.png)
...
![Layout delle dimensioni del gioco](/tutorials/images/magic-link/linker_layout.png)
...
![Numero massimo di sprite](/tutorials/images/magic-link/linker_sprite_max_count.png)
...
![Aggiunta delle immagini](/tutorials/images/magic-link/linker_add_images.png)
...
![Aggiunta delle immagini all'atlas](/tutorials/images/magic-link/linker_add_to_atlas.png)
...
![Collezione del tabellone](/tutorials/images/magic-link/linker_board_collection.png)

![Collezione del tabellone come collezione di bootstrap](/tutorials/images/magic-link/linker_bootstrap_board.png)
...
![Oggetto di gioco del blocco](/tutorials/images/magic-link/linker_block.png)
...
![Fabbrica dei blocchi](/tutorials/images/magic-link/linker_blockfactory.png)

Ora dovresti poter eseguire il gioco e vedere il tabellone riempito con blocchi di colori casuali:

![Prima schermata](/tutorials/images/magic-link/linker_first_screenshot.png)
...
![Binding di input](/tutorials/images/magic-link/linker_input_bindings.png)
...
![Oggetto di gioco del connettore](/tutorials/images/magic-link/linker_connector.png)

![Fabbrica dei connettori](/tutorials/images/magic-link/linker_connector_factory.png)
...
![Connettori nel gioco](/tutorials/images/magic-link/linker_connector_screen.png)
...
![Scorrimento dei blocchi verso il basso](/tutorials/images/magic-link/linker_blocks_slide.png)
...
![Magic_fx.go](/tutorials/images/magic-link/linker_magic_fx.png)
...
![Sprite della copertura](/tutorials/images/magic-link/linker_cover.png)
...
![Blocco magico senza e con illuminazione](/tutorials/images/magic-link/linker_magic_blocks.png)
...
![Assegnazione delle regioni](/tutorials/images/magic-link/linker_regions.png)
...
![Prima vittoria](/tutorials/images/magic-link/linker_first_win.png)
...
![Caduta di blocchi](/tutorials/images/magic-link/linker_drop.png)
...
![GUI del menu principale](/tutorials/images/magic-link/linker_main_menu.png)
...
Il proxy di collezione permette di caricare e scaricare dinamicamente collezioni nel gioco in esecuzione. Agisce per conto di uno specifico file di collezione: inviando messaggi al proxy, possiamo caricare, inizializzare, abilitare, disabilitare e scaricare la collezione dinamica. Per una descrizione completa del suo utilizzo, consulta la [documentazione sui proxy di collezione](/it/manuals/collection-proxy).
...
![Collezione principale](/tutorials/images/magic-link/linker_main_collection.png)

Ora apri *game.project* e cambia *main_collection* della sezione di bootstrap in `/main/main.collectionc`.

![Collezione principale di bootstrap](/tutorials/images/magic-link/linker_bootstrap_main.png)
...
![GUI del tabellone](/tutorials/images/magic-link/linker_board_gui.png)
...
![GUI di riavvio](/tutorials/images/magic-link/linker_restart_gui.png)
...
![Finestra di dialogo di completamento del livello](/tutorials/images/magic-link/linker_level_complete_gui.png)
...
![GUI di presentazione del livello](/tutorials/images/magic-link/linker_present_level_gui.png)
...
![GUI per lo spazio insufficiente per la caduta](/tutorials/images/magic-link/linker_no_drop_room_gui.png)
...
![Collezione definitiva del tabellone](/tutorials/images/magic-link/linker_board_collection_final.png)
...
![Gioco completato](/tutorials/images/magic-link/linker_game_finished.png)

...
![Nuovo progetto](/tutorials/images/new_empty.png)
...
Inizia creando un [nuovo progetto](/it/manuals/project-setup/) e aprendolo nell'editor. Fai doppio clic sul file *main/main.collection* per aprirlo:
...
![Creazione della build](/tutorials/images/car/start_build_and_launch.png)
...
![File con modifiche non salvate](/tutorials/images/car/file_changed.png)
</div>
...
![Nuovo file di collezione](/tutorials/images/car/start_new_collection.png)
...
![Aggiunta dell'oggetto di gioco dell'auto](/tutorials/images/car/start_add_car_gameobject.png)
...
![Aggiunta di un componente all'auto](/tutorials/images/car/start_add_car_component.png)
...
![Immagine dell'auto](/tutorials/images/car/start_car.png)
![Immagine dello pneumatico](/tutorials/images/car/start_tire.png)

Aggiungi queste immagini all'atlas:

![Atlas degli sprite](/tutorials/images/car/start_sprites_atlas.png)

![Proprietà dello sprite](/tutorials/images/car/start_sprite_properties.png)
...
![Collezione dell'auto completata](/tutorials/images/car/start_car_collection_complete.png)
...
<div class='sidenote' markdown='1'>
Defold fornisce diverse funzioni del ciclo di vita per programmare la logica di gioco. Trovi maggiori informazioni nel [manuale degli script](/it/manuals/script).
</div>
...
![Binding di input](/tutorials/images/car/start_input_bindings.png)
...
![Aggiunta della collezione dell'auto](/tutorials/images/car/start_adding_car_collection.png)
...
3. Aggiungi suoni alla tua auto e falla rombare! ([Suggerimento](/it/manuals/sound/))

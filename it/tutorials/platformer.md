...
![Integrazione approssimata della velocità](/tutorials/images/platformer/integration.png)
...
![Equazione della velocità](/tutorials/images/platformer/equationofvelocity.png)
...
![Equazione dello spostamento](/tutorials/images/platformer/equationoftranslation.png)
...
Se non sai bene come gestire l'input in Defold, trovi una guida sull'argomento [qui](/it/manuals/input).
...
![Normali di contatto che agiscono sul personaggio](/tutorials/images/platformer/collision.png)
...
![L'editor Defold con la geometria del livello e il personaggio posizionati nel mondo](/tutorials/images/platformer/editor.png)
...
![Più poligoni basati su tile uniti in un'unica forma](/tutorials/images/platformer/stitching.png)
...
Per maggiori informazioni, consulta le nostre guide sulla [fisica](/it/manuals/physics) e sui [tile](/it/manuals/2dgraphics).

...
Se ti serve un'introduzione alla programmazione in Lua, consulta il nostro [manuale di Lua in Defold](/it/manuals/lua).
...
Una volta installato e avviato l'editor, è il momento di creare un nuovo progetto e prepararlo. Crea un [nuovo progetto](/it/manuals/project-setup/#creating-a-new-project) dal modello "Empty Project".
...
![Panoramica dell'editor](/tutorials/images/runner/1/editor2_overview.png)
...
![Creazione della build](/tutorials/images/runner/1/build_and_launch.png)
...
![File con modifiche non salvate](/tutorials/images/runner/1/file_changed.png)
</div>
...
![Clic con il pulsante destro e copia del link alla release](/tutorials/images/runner/extension-spine-releases.png)

Aggiungi il link alla release all'elenco delle [dipendenze di game.project](/it/manuals/libraries/#setting-up-library-dependencies). Dopo aver aggiunto l'estensione Spine, devi anche riavviare l'editor per attivare l'integrazione con l'editor inclusa nell'estensione.
...
2. Crea un nuovo file *Atlas* che contenga le texture del terreno (fai clic con il pulsante destro su una cartella adatta, per esempio *main*, nel *pannello Assets* e seleziona <kbd>New ▸ Atlas File</kbd>). Assegna al file atlas il nome *level.atlas*.
  ...
  <div class='sidenote' markdown='1'>
  Un *atlas* è un file che combina un insieme di immagini separate in un unico file immagine più grande. Questo permette di risparmiare spazio e migliorare le prestazioni. Puoi approfondire gli atlas e le altre funzionalità grafiche 2D nella [documentazione della grafica 2D](/it/manuals/2dgraphics).
  </div>
...
3. Aggiungi le immagini del terreno al nuovo atlas facendo clic con il pulsante destro sulla radice dell'atlas in *Outline* e selezionando <kbd>Add Images</kbd>. Seleziona le immagini importate e fai clic su *OK*. Ogni immagine nell'atlas è ora accessibile come animazione di un singolo fotogramma (immagine fissa), da utilizzare in sprite, effetti particellari e altri elementi visivi. Salva il file.
  ...
  ![Creare un nuovo atlas](/tutorials/images/runner/1/new_atlas.png)

  ![Aggiungere immagini all'atlas](/tutorials/images/runner/1/add_images_to_atlas.png)
...
5. Aggiungi un componente sprite a ciascun oggetto (fai clic con il pulsante destro sull'oggetto di gioco nella vista *Outline* e seleziona <kbd>Add Component</kbd>, poi seleziona *Sprite* e fai clic su *OK*), imposta la proprietà *Image* del componente sprite sull'atlas appena creato e imposta l'animazione predefinita dello sprite su una delle due immagini del terreno. Imposta la posizione X del _componente sprite_ (non dell'oggetto di gioco) su 190 e la posizione Y su 40. Poiché l'immagine è larga 380 pixel e la spostiamo lateralmente della metà di tale valore, il punto di pivot dell'oggetto di gioco si troverà sul bordo sinistro dell'immagine dello sprite.
  ...
  ![Creare la collezione del terreno](/tutorials/images/runner/1/ground_collection.png)
...
6. La grafica che utilizziamo è un po' troppo grande, quindi ridimensiona ogni oggetto di gioco al 60% (scala di 0.6 su X e Y, ottenendo tratti di terreno larghi 228 pixel).
  ...
  ![Ridimensionare il terreno](/tutorials/images/runner/1/scale_ground.png)
...
9. Avvia il gioco (<kbd>Project ▸ Build</kbd>) per verificare che tutto sia al suo posto.
  ...
  ![Terreno fermo](/tutorials/images/runner/1/still_ground.png)
...
Per il momento queste descrizioni dovrebbero bastare. Puoi però trovare una spiegazione molto più approfondita nel [manuale degli elementi fondamentali](/it/manuals/building-blocks). Ti consigliamo di consultarlo in seguito per comprendere meglio come funziona Defold.
...
Defold aggiunge a Lua una serie di API e un sistema di _scambio di messaggi_ che permette di programmare la comunicazione tra gli oggetti di gioco. Consulta il [manuale dello scambio di messaggi](/it/manuals/message-passing) per i dettagli sul suo funzionamento.
</div>
...
![Controller del terreno](/tutorials/images/runner/1/ground_controller.png)
...
![Atlas dell'eroe](/tutorials/images/runner/2/hero_atlas.png)
...
![Proprietà del modello Spine](/tutorials/images/runner/2/spinemodel_properties.png)
...
<div class='sidenote' markdown='1'>
Le collisioni di tipo "Kinematic" vengono rilevate, ma il motore fisico non le risolve automaticamente e non simula gli oggetti. Il motore fisico supporta diversi tipi di oggetti di collisione. Puoi approfondirli nella [documentazione della fisica](/it/manuals/physics).
</div>
...
![Oggetto di gioco dell'eroe](/tutorials/images/runner/2/hero_game_object.png)
...
Per farlo e gestire correttamente le collisioni serve un po' di matematica vettoriale. Trovi una spiegazione approfondita su come risolvere le collisioni cinematiche nella [documentazione della fisica](/it/manuals/physics-resolving-collisions/).
</div>
...
![Binding di input](/tutorials/images/runner/2/input_bindings.png)
...
![Proprietà dello script](/tutorials/images/runner/2/script_property.png)
...
![Aggiungere il codice del terreno](/tutorials/images/runner/insert_ground_code.png)
...
![Collisione del terreno](/tutorials/images/runner/2/ground_collision.png)
...
![Piattaforma](/tutorials/images/runner/2/platform_long.png)
...
![Eseguire il gioco](/tutorials/images/runner/2/run_game.png)
...
![Inserire il codice dell'eroe](/tutorials/images/runner/insert_hero_code.png)
...
8. Salva il file.
    ...
    ![Spuntoni della piattaforma](/tutorials/images/runner/3/danger_edges.png)

9. Apri *hero.go*, seleziona il *Collision Object* e aggiungi il nome "danger" alla proprietà *Mask*. Poi salva il file.

    ![Collisione dell'eroe](/tutorials/images/runner/3/hero_collision.png)
...
3. Apri *platform.script* e modificalo in modo che, invece di eliminare semplicemente una piattaforma che ha raggiunto l'estremità sinistra, invii un messaggio al controller del livello chiedendo di rimuoverla:
    ...
    ![Inserire il codice della piattaforma](/tutorials/images/runner/insert_platform_code.png)
...
![Inserire il codice dell'eroe](/tutorials/images/runner/insert_hero_code_2.png)
...
10. Aggiungi il file di script come componente *Script* all'oggetto della moneta (fai clic con il pulsante destro sulla radice in *Outline* e seleziona <kbd>Add Component from File</kbd>).
    ...
    ![Oggetto di gioco della moneta](/tutorials/images/runner/3/coin.png)
...
![Fabbrica delle monete](/tutorials/images/runner/3/coin_factory.png)
...
![Inserire il codice del controller](/tutorials/images/runner/insert_controller_code.png)
...
> Scarica la versione completa del progetto [qui](/tutorials/images/runner/sample-runner.zip).

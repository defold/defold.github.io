...
![Avvio](/tutorials/images/shadertoy/empty_project.png)
...
![Quadrilatero in Blender](/tutorials/images/shadertoy/quad_blender.png)
...
![Quadrilatero in Defold](/tutorials/images/shadertoy/quad_default_material.png)
...
1. Crea un nuovo file di materiale *`star-nest.material`* facendo clic con il <kbd>tasto destro del mouse</kbd> sulla cartella `main` nel pannello `Assets`, selezionando <kbd>New</kbd>-><kbd>Material</kbd> e assegnandogli il nome `star-nest`.
 ...
 ![Materiale](/tutorials/images/shadertoy/new_material.png)
...
8. Aggiungi un tag "tile" a *Tags*. In questo modo il quadrilatero viene incluso nel passaggio di rendering in cui vengono disegnati sprite e tile.
 ...
 ![Materiale](/tutorials/images/shadertoy/material.png)
...
![Quadrilatero in Defold](/tutorials/images/shadertoy/quad_material.png)
...
![Telecamera](/tutorials/images/shadertoy/camera.png)
...
![Codice dello shader Star Nest](/tutorials/images/shadertoy/starnest_code.png)
...
![Quadrilatero con Star Nest](/tutorials/images/shadertoy/quad_starnest.png)
...
![Costante del tempo](/tutorials/images/shadertoy/time_constant.png)

...
![anteprima](/tutorials/images/snake/thumbnail.png)
...
Questo tutorial è pensato per i principianti, ma se non hai mai usato Defold e non hai esperienza nello sviluppo di giochi, ti consigliamo di leggere prima alcuni manuali introduttivi, in particolare quelli sugli [elementi fondamentali di Defold](/it/manuals/building-blocks/) e il [glossario](/it/manuals/glossary/). Se non hai ancora scaricato Defold, consulta il [manuale di installazione](/it/manuals/install/). Ti consigliamo anche di consultare la [panoramica dell'editor](/it/manuals/editor/) per familiarizzare rapidamente con l'editor stesso; qui, comunque, trovi schermate per ogni passaggio.
...
![avvio](/tutorials/images/snake/1.png)
...
![schermo](/tutorials/images/snake/2.png)

Questo passaggio serve perché il gioco verrà disegnato su una griglia in cui ogni segmento misura 16x16 pixel: in questo modo, i bordi dello schermo di gioco non taglieranno alcun segmento. Il file `game.project` contiene tutte le impostazioni importanti del progetto; puoi scoprirle nel [manuale delle impostazioni del progetto](/it/manuals/project-settings/).
...
![nuova cartella](/tutorials/images/snake/3.png)
...
![sprite del serpente](/tutorials/images/snake/snake.png)
...
![nuova cartella](/tutorials/images/snake/4.png)

Puoi anche trovare maggiori dettagli sull'[importazione degli asset qui](/it/manuals/importing-graphics/).

<input type="checkbox"/> Fatto!

## Aggiungere una sorgente di tile {#adding-a-tile-source}

Defold offre un componente [mappa di tile (Tile Map)](/it/manuals/tilemap/) integrato, che userai per creare il campo di gioco composto da *tile* allineati su una griglia. Una mappa di tile consente di impostare e leggere singoli tile, ed è quindi perfetta per questo gioco. Poiché le mappe di tile ricavano la propria grafica da una [sorgente di tile (Tile Source)](/it/manuals/tilesource/), devi crearne una:
...
![nuova sorgente di tile](/tutorials/images/snake/5.png)
...
![sorgente di tile](/tutorials/images/snake/6.png)
...
![proprietà della sorgente di tile](/tutorials/images/snake/7.png)
...
![aggiungere una mappa di tile](/tutorials/images/snake/8.png)
...
![impostare la sorgente di tile](/tutorials/images/snake/9.png)
...
![mappa di tile](/tutorials/images/snake/10.png)

3. Disegna una cornice lungo il bordo dello schermo e alcuni ostacoli.
![mappa di tile completata](/tutorials/images/snake/11.png)
...
![aggiungere un oggetto di gioco](/tutorials/images/snake/12.png)
...
![aggiungere un componente](/tutorials/images/snake/13.png)
...
![avviare il gioco](/tutorials/images/snake/14.png)
...
![aggiungere uno script](/tutorials/images/snake/15.png)
...
![collezione principale](/tutorials/images/snake/16.png)
...
![algoritmo](/tutorials/images/snake/17.png)
...
![avviare il gioco](/tutorials/images/snake/snake_run_1.png)
...
![associazioni di input](/tutorials/images/snake/18.png)

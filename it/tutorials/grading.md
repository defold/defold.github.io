...
Si presuppone che tu sappia orientarti nell'editor Defold e che abbia una conoscenza di base degli shader GL e della pipeline di rendering di Defold. Se hai bisogno di approfondire questi argomenti, consulta [il nostro manuale sugli shader](/it/manuals/shader/) e il [manuale sul rendering](/it/manuals/render/).
...
Puoi sostituire il programma shader di un componente con uno che modifichi i dati dei pixel o crei colori dei pixel completamente nuovi tramite codice. Il [tutorial su Shadertoy](/it/tutorials/shadertoy) ti insegna come fare.
...
![Destinazione di rendering](/tutorials/images/grading/render_target.png)
...
7. Apri *`main.collection`*, seleziona il componente modello nell'oggetto di gioco "`grade`" e imposta la sua proprietà *Material* su "`/main/grade.material`".
   ...
   ![Proprietà del modello](/tutorials/images/grading/model_properties.png)
...
![Gioco desaturato](/tutorials/images/grading/desaturated_game.png)
...
![Cubo dei colori](/tutorials/images/grading/color_cube.png)
...
![Correzione cromatica della destinazione di rendering](/tutorials/images/grading/render_target_grading.png)
...
![Texture di ricerca](/tutorials/images/grading/lut.png)
...
![Tabella di ricerca](/tutorials/images/grading/lut_lookup.png)
...
![Filtraggio della tabella di ricerca](/tutorials/images/grading/lut_filtering.png)
...
3. Imposta la proprietà *`Filter min`* su `FILTER_MODE_MIN_LINEAR` e la proprietà *`Filter mag`* su `FILTER_MODE_MAG_LINEAR`.
    ...
    ![Sampler della tabella di ricerca](/tutorials/images/grading/material_lut_sampler.png)

4. Scarica la seguente texture della tabella di ricerca (*`lut16.png`*) e aggiungila al tuo progetto.

    ![Tabella di ricerca a 16 colori](/tutorials/images/grading/lut16.png)

5. Apri *`main.collection`* e imposta la proprietà della texture *`lut`* sulla texture di ricerca scaricata.

    ![Tabella di ricerca del modello del quadrilatero](/tutorials/images/grading/quad_lut.png)
...
![Aspetto originale del mondo](/tutorials/images/grading/world_original.png)
...
![Bande nel blu](/tutorials/images/grading/blue_banding.png)
...
![Blu senza bande](/tutorials/images/grading/blue_no_banding.png)
...
![Mondo in Affinity](/tutorials/images/grading/world_graded_affinity.png)
...
![Mondo con correzione cromatica](/tutorials/images/grading/world_graded.png)

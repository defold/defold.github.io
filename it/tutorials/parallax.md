...
In questo progetto di esempio, che puoi [aprire dall'editor](/it/manuals/project-setup/) o [scaricare da GitHub](https://github.com/defold/sample-parallax), mostriamo come usare un effetto di parallasse per simulare la profondità nel mondo di gioco.

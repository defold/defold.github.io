...
In questo progetto di esempio, che puoi [aprire dall'editor](/it/manuals/project-setup/) o [scaricare da GitHub](https://github.com/defold/sample-main-menu-animation), mostriamo alcuni effetti per presentare un menu principale. Il menu contiene uno sfondo e due voci.

...
In questo progetto di esempio, che puoi [aprire dall'editor](/it/manuals/project-setup/) o [scaricare da GitHub](https://github.com/defold/sample-rpgmap), mostriamo un metodo per creare mappe RPG molto grandi in Defold. La progettazione si basa sui seguenti presupposti:

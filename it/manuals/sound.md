...
- anchor: creating-a-sound-component
  title: Creare un componente audio
- anchor: playing-the-sound
  title: Riprodurre il suono
- anchor: stopping-the-sound
  title: Interrompere il suono
- anchor: gain
  title: Guadagno
- anchor: sound-groups
  title: Gruppi di suoni
- anchor: gating-sounds
  title: Limitare le ripetizioni dei suoni
...
![Selezionare un componente](/manuals/images/sound/sound_add_component.jpg)

Il componente creato ha una serie di proprietà da impostare:

![Selezionare un componente](/manuals/images/sound/sound_properties.png)

*Sound*
: Deve indicare un file audio del progetto. Il file deve essere in formato _Wave_, _Ogg Vorbis_ o _Ogg Opus_. Defold supporta i file Wave PCM a 8 e 16 bit. La riproduzione Ogg Opus è facoltativa e richiede **Include Sound Decoder: Opus** nel [manifest dell'applicazione](/it/manuals/app-manifest/#sound); il decoder Opus non è incluso per impostazione predefinita.
...
![Guadagno](/manuals/images/sound/sound_gain.png)
...
![Mixer dei gruppi di suoni](/manuals/images/sound/sound_mixer.png)
...
![Sfasamento](/manuals/images/sound/sound_phase_shift.png)
...
Il file *game.project* contiene alcune [impostazioni del progetto](/it/manuals/project-settings#sound) relative ai componenti audio.

## Streaming audio {#sound-streaming}

È anche possibile supportare la [riproduzione di suoni in streaming](/it/manuals/sound-streaming)
...
- anchor: materials
  title: Materiali
- anchor: creating-a-material
  title: Creare un materiale
- anchor: attributes
  title: Attributi
- anchor: default-attribute-semantics
  title: Semantica predefinita degli attributi
- anchor: setting-custom-vertex-attribute-data
  title: Impostare i dati degli attributi dei vertici personalizzati
- anchor: examples-of-using-custom-vertex-attributes
  title: Esempi di utilizzo degli attributi dei vertici personalizzati
- Instancing
- anchor: vertex-and-fragment-constants
  title: Costanti dei vertex shader e dei fragment shader
- anchor: gui-node-material-constants
  title: Costanti del materiale dei nodi GUI
- anchor: samplers
  title: Campionatori
- anchor: sampler-settings
  title: Impostazioni dei campionatori
- anchor: constants-buffers
  title: Buffer delle costanti
---
...
* Per ulteriori informazioni sulla pipeline di rendering, consulta la [documentazione sul rendering](/it/manuals/render).
* Per una spiegazione approfondita dei programmi shader, consulta la [documentazione sugli shader](/it/manuals/shader).
...
![File del materiale](/manuals/images/materials/material_file.png)

Il nuovo materiale si aprirà nel *Material Editor*.

![Editor dei materiali](/manuals/images/materials/material.png)
...
Tags
: I tag associati al materiale. I tag sono rappresentati nel motore come una _maschera di bit_, usata da [`render.predicate()`](/ref/render#render.predicate) per raggruppare i componenti da disegnare insieme. Per sapere come fare, consulta la [documentazione sul rendering](/it/manuals/render). Il numero massimo di tag utilizzabili in un progetto è 32.
...
![Attributo personalizzato del materiale](/manuals/images/materials/set_custom_attribute.png)
...
![Configurazione dell'instancing](/manuals/images/materials/instancing-setup.png)

Il materiale è configurato come mostrato, con un solo attributo dei vertici personalizzato che viene ripetuto per istanza:

![Materiale per l'instancing](/manuals/images/materials/instancing-material.png)
...
![Chiamate di disegno con instancing](/manuals/images/materials/instancing-draw-calls.png)
...
`CONSTANT_TYPE_USER`
: Una costante vector4 che puoi usare per qualsiasi dato personalizzato da passare ai programmi shader. Puoi impostare il valore iniziale della costante nella sua definizione e modificarlo tramite le funzioni [go.set()](/ref/go/#go.set) / [go.animate()](/ref/go/#go.animate). Puoi anche recuperare il valore con [go.get()](/ref/go/#go.get). Modificare una costante del materiale di una singola istanza di componente [interrompe il raggruppamento del rendering e genera chiamate di disegno aggiuntive](/it/manuals/render/#draw-calls-and-batching).
...
![Campionatore dello sprite](/manuals/images/materials/sprite_sampler.png)
...
![Impostazioni del campionatore](/manuals/images/materials/my_sampler.png)
...
![Campionatori del modello](/manuals/images/materials/model_samplers.png)
...
![Modello](/manuals/images/materials/model.png)

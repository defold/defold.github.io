...
Prima di creare una mappa di tasselli devi creare una sorgente di tasselli. Consulta il [manuale delle sorgenti di tasselli](/it/manuals/tilesource) per sapere come crearne una.
...
- La nuova mappa di tasselli si apre automaticamente nell'editor delle mappe di tasselli.
  ...
  ![Nuova mappa di tasselli](/manuals/images/tilemap/tilemap.png)
...
2. Seleziona un tassello da usare come pennello (premi <kbd>Space</kbd> per mostrare la tavolozza dei tasselli), oppure seleziona più tasselli facendo clic e trascinando nella tavolozza per creare un pennello rettangolare composto da più tasselli.
   ...
   ![Tavolozza](/manuals/images/tilemap/palette.png)
...
3. Dipingi con il pennello selezionato. Per cancellare un tassello, scegli un tassello vuoto e usalo come pennello, oppure seleziona la gomma (<kbd>Edit ▸ Select Eraser</kbd>).
   ...
   ![Dipingere tasselli](/manuals/images/tilemap/paint_tiles.png)
...
![Prelevare tasselli](/manuals/images/tilemap/pick_tiles.png)
...
![Usare una mappa di tasselli](/manuals/images/tilemap/use_tilemap.png)
...
{% include shared/it/material-constants.md component='tilemap' variable='tint' %}
...
Il file *game.project* contiene alcune [impostazioni del progetto](/it/manuals/project-settings#tilemap) relative alle mappe di tasselli.

...
- anchor: collision-messages
  title: Messaggi di collisione
- anchor: event-filtering
  title: Filtraggio degli eventi
- anchor: collision-response
  title: Risposta alla collisione
- anchor: contact-point-response
  title: Risposta del punto di contatto
- anchor: trigger-response
  title: Risposta del trigger
---

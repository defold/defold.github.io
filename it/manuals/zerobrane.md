...
- anchor: debugging-lua-scripts-with-zerobrane-studio
  title: Debug degli script Lua con ZeroBrane Studio
- anchor: zerobrane-configuration
  title: Configurazione di ZeroBrane
- anchor: to-set-up-zerobrane
  title: Configurare ZeroBrane
- anchor: starting-the-debugging-server
  title: Avvio del server di debug
- anchor: connecting-your-application-to-the-debugger
  title: Connessione dellapplicazione al debugger
- anchor: remote-debugging
  title: Debug remoto
- anchor: other-recommended-zerobrane-setting
  title: Altra impostazione consigliata per ZeroBrane
---
...
![Visualizzazione nel Finder](/manuals/images/zerobrane/show_in_desktop.png)

## Configurare ZeroBrane {#to-set-up-zerobrane}

Per configurare ZeroBrane, seleziona <kbd>Project ▸ Project Directory ▸ Choose...</kbd>:

![Configurazione](/manuals/images/zerobrane/setup.png)
...
![Avvio del debugger](/manuals/images/zerobrane/startdebug.png)
...
![Altre impostazioni consigliate](/manuals/images/zerobrane/otherrecommended.png)
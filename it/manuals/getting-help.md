...
- anchor: report-a-problem-on-the-forum
  title: Segnalare un problema sul forum
- anchor: required-information
  title: Informazioni necessarie
- anchor: sharing-code
  title: Condividere il codice
- anchor: report-a-problem-from-the-editor
  title: Segnalare un problema dalleditor
- anchor: discuss-a-problem-on-discord
  title: Discutere di un problema su Discord
- anchor: log-files
  title: File di log
---
...
* [Log del motore](/it/manuals/debugging-game-and-system-logs)
* [Log dell'editor](/it/manuals/editor#editor-logs)
* [Log del server di build](/it/manuals/extensions#build-server-logs)
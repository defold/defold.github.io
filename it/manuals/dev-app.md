...
- anchor: the-mobile-development-app
  title: Lapp di sviluppo per dispositivi mobili
- anchor: installing-a-development-app
  title: Installare unapp di sviluppo
- anchor: installing-on-ios
  title: Installare su iOS
...
- anchor: connecting-to-an-ios-device-using-usb-on-windows
  title: Connettersi a un dispositivo iOS tramite USB su Windows
- anchor: connecting-to-an-ios-device-using-usb-on-linux
  title: Connettersi a un dispositivo iOS tramite USB su Linux
- anchor: connecting-to-an-ios-device-using-usb-on-macos
  title: Connettersi a un dispositivo iOS tramite USB su macOS
- anchor: connecting-to-an-android-device-using-usb-on-macos
  title: Connettersi a un dispositivo Android tramite USB su macOS
- anchor: connecting-to-an-android-device-using-usb-on-windows-or-linux
  title: Connettersi a un dispositivo Android tramite USB su Windows o Linux
...
![Bundle senza contenuti](/manuals/images/dev-app/contentless-bundle.png)

### Installare su iOS {#installing-on-ios}

Segui le [istruzioni nel manuale di iOS](/it/manuals/ios/#creating-an-ios-application-bundle) per creare un bundle per iOS. Assicurati di selezionare Debug come variante!

### Installare su Android {#installing-on-android}

Segui le [istruzioni nel manuale di Android](https://defold.com/it/manuals/android/#creating-an-android-application-bundle) per creare un bundle per Android.
...
5. Mentre il gioco è in esecuzione, puoi usare l'[hot reload](/it/manuals/hot-reload/) come al solito.

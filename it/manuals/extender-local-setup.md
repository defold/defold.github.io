...
- anchor: build-server-local-setup
  title: Configurazione locale del server di build
- anchor: how-to-run-local-extender-with-preconfigured-artifacts
  title: Come eseguire Extender in locale con artefatti preconfigurati
- anchor: what-about-macos-and-ios
  title: E per macOS e iOS?
- anchor: how-to-run-local-extender-with-locally-built-artifacts
  title: Come eseguire Extender in locale con artefatti compilati localmente
---

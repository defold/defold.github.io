...
- anchor: editor-preferences
  title: Preferenze delleditor
- anchor: general
  title: Impostazioni generali
- anchor: code
  title: Codice
- anchor: open-script-files-in-visual-studio-code
  title: Aprire i file di script in Visual Studio Code
- anchor: extensions
  title: Estensioni
- anchor: tools
  title: Strumenti
- anchor: keymap
  title: Mappatura dei comandi
---
...
: Attiva la [compressione delle texture](/it/manuals/texture-profiles) per tutte le build create dall'editor.
...
Lint Code on Build
: Attiva l'[analisi statica del codice](/it/manuals/writing-code/#linting-configuration) durante la build del progetto. Questa opzione è attiva per impostazione predefinita, ma può essere disattivata se l'analisi statica richiede troppo tempo in un progetto di grandi dimensioni.
...
Format on save
: Esegue il formatter del server di linguaggio sui file di codice aperti e modificati al momento del salvataggio. Disabilitata per impostazione predefinita. Il server di linguaggio deve supportare la formattazione; consulta [Formattare il codice](/it/manuals/writing-code/#formatting-code) per formattare manualmente un documento o una selezione.

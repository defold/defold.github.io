...
- anchor: adding-a-script-to-a-gui
  title: Aggiungere uno script a una GUI
- anchor: the-gui-namespace
  title: Lo spazio dei nomi gui
- anchor: message-passing
  title: Scambio di messaggi
- anchor: addressing-nodes
  title: Indirizzamento dei nodi
- anchor: dynamically-created-nodes
  title: Nodi creati dinamicamente
- anchor: dynamic-node-ids
  title: ID dei nodi dinamici
---
...
![Scambio di messaggi](/manuals/images/gui-script/message_passing.png)
...
![Scambio di messaggi](/manuals/images/gui-script/node_id.png)
...
![Nodo dinamico](/manuals/images/gui-script/dynamic_nodes.png)

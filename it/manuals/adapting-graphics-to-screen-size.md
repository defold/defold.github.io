...
- anchor: how-to-change-how-your-content-is-rendered
  title: Modificare il modo in cui viene visualizzato il contenuto
- anchor: retro8-bit-graphics
  title: Grafica rétro/a 8 bit
- anchor: high-resolution-graphics
  title: Grafica ad alta risoluzione
- anchor: high-dpi-setting-and-retina-screens
  title: Impostazione per DPI elevati e schermi Retina
- anchor: creating-an-adaptive-gui
  title: Creare una GUI adattiva
- anchor: node-properties
  title: Proprietà dei *nodi*
- anchor: layouts
  title: Layout
- anchor: testing-different-screen-sizes
  title: Provare schermi di dimensioni diverse
---
...
Puoi ottenere lo stesso risultato aggiungendo un [componente telecamera](/it/manuals/camera/) a un oggetto di gioco, selezionando *Orthographic Projection* e impostando *Orthographic Zoom* su 4.0:

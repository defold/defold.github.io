...
- anchor: securing-your-intellectual-property-from-theft
  title: Proteggere la tua proprietà intellettuale dal furto
- anchor: source-code-obfuscation
  title: Offuscamento del codice sorgente
- anchor: resource-encryption
  title: Crittografia delle risorse
- anchor: encoding-project-configuration-values
  title: Codificare i valori di configurazione del progetto
- anchor: securing-your-game-against-cheaters
  title: Proteggere il tuo gioco da chi bara
- anchor: securing-your-network-communication
  title: Proteggere le tue comunicazioni di rete
- anchor: ssl-certificate-validation
  title: Validazione dei certificati SSL
- anchor: securing-your-use-of-third-party-software
  title: Usare software di terze parti in modo sicuro
- anchor: securing-your-use-of-cloud-build-servers
  title: Usare i server di build nel cloud in modo sicuro
- anchor: securing-your-downloadable-content
  title: Proteggere i tuoi contenuti scaricabili
---
...
Puoi leggere ulteriori dettagli su questo processo nel [manuale di Live Update](https://defold.com/it/manuals/live-update/#content-verification).
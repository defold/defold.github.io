...
- anchor: creating-a-collection-proxy-component
  title: Creare un componente proxy di collezione
- Bootstrap
- anchor: loading-a-collection
  title: Caricare una collezione
- anchor: changing-an-excluded-proxys-collection
  title: Cambiare la collezione di un proxy escluso
- anchor: addressing-into-the-new-world
  title: Indirizzare oggetti nel nuovo mondo
- anchor: unloading-a-world
  title: Scaricare un mondo
- anchor: time-step
  title: Passo temporale
- anchor: caveats-and-common-issues
  title: Limitazioni e problemi comuni
---
...
![aggiunta di un componente proxy](/manuals/images/collection-proxy/create_proxy.png)

(Puoi escludere il contenuto dalla build e scaricarlo tramite codice selezionando la casella *Exclude* e usando la [funzionalità Live Update](/it/manuals/live-update/).)

## Bootstrap

All'avvio, il motore Defold carica e istanzia nel runtime tutti gli oggetti di gioco di una *collezione di bootstrap*. Poi inizializza e abilita gli oggetti di gioco e i loro componenti. La collezione di bootstrap da utilizzare viene specificata nelle [impostazioni del progetto](/it/manuals/project-settings/#main-collection). Per convenzione, questo file di collezione è solitamente denominato `main.collection`.
...
![caricamento](/manuals/images/collection-proxy/proxy_load.png)
...
![caricamento](/manuals/images/collection-proxy/message_passing.png)

Se invece devi comunicare dall'oggetto di caricamento con un oggetto di gioco nella collezione caricata, puoi inviare un messaggio usando l'[URL completo dell'oggetto](/it/manuals/addressing/#urls):
...
* [Animazioni delle proprietà degli oggetti di gioco e della GUI](https://defold.com/it/manuals/animation/#property-animation-1)
* [Animazioni flipbook](https://defold.com/it/manuals/animation/#flip-book-animation)
* [Simulazioni degli effetti particellari](https://defold.com/it/manuals/particlefx/)
* Velocità dei timer

...
- anchor: creating-a-clipping-node
  title: Creare un nodo di ritaglio
- anchor: stencil-mask
  title: Maschera stencil
- anchor: stencil-limitations
  title: Limitazioni degli stencil
- anchor: layers
  title: Livelli
---
...
![Creare un ritaglio](/manuals/images/gui-clipping/create.png)
...
![Gerarchia di ritaglio](/manuals/images/gui-clipping/setup.png)
...
![Maschere stencil](/manuals/images/gui-clipping/modes.png)
...
![Livelli e ritaglio](/manuals/images/gui-clipping/layers.png)

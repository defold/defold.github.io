...
toc:
- anchor: physically-based-rendering-pbr
  title: Rendering basato sulla fisica (PBR)
- anchor: material-properties-overview
  title: Panoramica delle proprietà dei materiali
- anchor: shader-integration
  title: Integrazione negli shader
- anchor: example-shader
  title: Shader di esempio
- anchor: constants
  title: Costanti
- anchor: next-steps
...
![Costanti del materiale](/manuals/images/physically-based-rendering/material-constants.png)

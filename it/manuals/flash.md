...
- anchor: movie-clips-and-game-objects
  title: Clip filmato e oggetti di gioco
- anchor: flashmanually-creating-movie-clips
  title: Flash—creazione manuale di clip filmato
- anchor: defoldmanually-creating-game-objects
  title: Defold—creazione manuale di oggetti di gioco
- anchor: flashreferencing-manually-created-movie-clips
  title: Flash—riferimenti ai clip filmato creati manualmente
- anchor: defoldgame-object-id
  title: Defold—ID delloggetto di gioco
- anchor: flashdynamically-creating-movie-clips
  title: Flash—creazione dinamica di clip filmato
- anchor: defoldcreating-game-objects-using-factories
  title: Defold—creazione di oggetti di gioco tramite fabbriche
- Flash—Stage
- anchor: defoldcollections
  title: Defold—collezioni
- anchor: flashtimeline
  title: Flash—linea temporale
- anchor: defoldproperty-animation
  title: Defold—animazione delle proprietà
- anchor: flashdepth-index
  title: Flash—indice di profondità
- anchor: defoldz-position
  title: Defold—posizione z
- anchor: flash-hittestobject-and-hittestpoint-collision-detection
  title: Rilevamento delle collisioni in Flash con hitTestObject e hitTestPoint
- anchor: defoldcollision-objects
  title: Defold—oggetti di collisione
- anchor: flashevent-handling
  title: Flash—gestione degli eventi
- anchor: defoldcall-back-functions-and-messaging
  title: Defold—funzioni di callback e messaggi
- anchor: flashbutton-symbols
  title: Flash—simboli pulsante
- anchor: defoldgui-scenes-and-scripts
  title: Defold—scene GUI e script
- anchor: debugging
  title: Debug
...
![clip filmato creati manualmente](/manuals/images/flash/manual_movie_clips.png)

## Defold—creazione manuale di oggetti di gioco {#defoldmanually-creating-game-objects}

Come già accennato, Defold non prevede il concetto di linea temporale. Gli oggetti di gioco sono invece organizzati in collezioni. Le collezioni sono contenitori (o prefab) che racchiudono oggetti di gioco e altre collezioni. Nel caso più semplice, un gioco può essere costituito da una sola collezione. Più spesso, i giochi Defold usano più collezioni, aggiunte manualmente alla collezione di bootstrap `main` oppure caricate dinamicamente tramite [proxy di collezione](/it/manuals/collection-proxy). Questo concetto di caricamento di "livelli" o "schermate" non ha un equivalente diretto in Flash.
...
![oggetti di gioco creati manualmente](/manuals/images/flash/manual_game_objects.png)
...
![nome di istanza in Flash](/manuals/images/flash/flash_instance_name.png)
...
![ID dell'oggetto di gioco](/manuals/images/flash/game_object_id.png)
...
Il modello di indirizzamento e lo scambio di messaggi sono concetti fondamentali nello sviluppo di giochi con Defold. Il [manuale sull'indirizzamento](/it/manuals/addressing) e il [manuale sullo scambio di messaggi](/it/manuals/message-passing) li spiegano in modo approfondito.
...
![collegamento ActionScript](/manuals/images/flash/actionscript_linkage.png)
...
![Fabbrica del logo](/manuals/images/flash/logo_factory.png)
...
![componente fabbrica](/manuals/images/flash/factory_component.png)
...
Le collezioni sono contenitori usati nell'editor per organizzare oggetti di gioco e altre collezioni. Il contenuto di una collezione può anche essere generato durante l'esecuzione tramite script, usando una [fabbrica di collezioni](/it/manuals/collection-factory/#spawning-a-collection), che funziona come una normale fabbrica di oggetti di gioco. È utile, per esempio, per generare gruppi di nemici o una disposizione di monete da raccogliere. Nella schermata seguente abbiamo posizionato manualmente due istanze della collezione `logos` nella collezione `main`.

![collezione](/manuals/images/flash/collection.png)

In alcuni casi vuoi caricare un mondo di gioco completamente nuovo. Il componente [proxy di collezione](/it/manuals/collection-proxy/) permette di creare un nuovo mondo di gioco sulla base del contenuto di un file di collezione. È utile in situazioni come il caricamento di nuovi livelli di gioco, minigiochi o sequenze narrative.
...
![linea temporale](/manuals/images/flash/timeline.png)
...
![animazione flipbook](/manuals/images/flash/flipbook.png)
...
![indice di profondità](/manuals/images/flash/depth_index.png)
...
![indice di profondità](/manuals/images/flash/depth_index_2.png)

## Defold—posizione z {#defoldz-position}

Le posizioni degli oggetti di gioco in Defold sono rappresentate da vettori composti da tre variabili: x, y e z. La posizione z determina la profondità di un oggetto di gioco. Nello [script di rendering](/it/manuals/render) predefinito, le posizioni z disponibili vanno da -1 a 1.
...
![ordine z](/manuals/images/flash/z_order.png)
...
![ordine z](/manuals/images/flash/z_order_outline.png)
...
![test di collisione](/manuals/images/flash/hittest.png)
...
![test di collisione con rettangoli di delimitazione](/manuals/images/flash/hitboundingbox.png)
...
![collisione](/manuals/images/flash/collision.png)

Infine, consulta la [documentazione del profilatore](/ref/profiler/) per sapere come monitorare l'uso della CPU e della memoria. Per ulteriori informazioni sulle tecniche di debug avanzate, consulta la [sezione sul debug](/it/manuals/debugging) del manuale di Defold.

...
- anchor: setting-up-amazon-web-service
  title: Configurazione di Amazon Web Service
---
...
1. Crea un bucket per le risorse Live update
    ...
    ![Creazione di un bucket](/manuals/images/live-update/01-create-bucket.png)
...
2. Aggiungi una policy al bucket
    ...
    ![Policy del bucket](/manuals/images/live-update/02-bucket-policy.png)
...
3. Aggiungi una configurazione CORS al bucket (facoltativo)
    ...
    ![Configurazione CORS](/manuals/images/live-update/03-cors-configuration.png)
...
4. Crea una policy IAM
    ...
    ![Policy IAM](/manuals/images/live-update/04-create-policy.png)
...
6. Crea un file di profilo delle credenziali
    ...
    ![Impostazioni Live update](/manuals/images/live-update/05-liveupdate-settings.png)
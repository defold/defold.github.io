...
![Collezione](/manuals/images/building_blocks/collection.png)
...
Consulta la [panoramica dei componenti](/it/manuals/components/) per un elenco di tutti i tipi di componenti disponibili.
...
![Istanza](/manuals/images/building_blocks/instance.png)
...
![Istanze di oggetti di gioco](/manuals/images/building_blocks/go_instance.png)

Modificando il file di prototipo, tutte le istanze che usano quel file vengono aggiornate immediatamente.

![Modifica del prototipo di un oggetto di gioco](/manuals/images/building_blocks/go_change_blueprint.png)
...
![Istanze di oggetti di gioco aggiornate](/manuals/images/building_blocks/go_instance2.png)
...
![Gerarchie genitore-figlio tra oggetti di gioco](/manuals/images/building_blocks/childing.png)
...
![Trasformazione di un figlio](/manuals/images/building_blocks/child_transform.png)

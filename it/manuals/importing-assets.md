...
- anchor: importing-assets
  title: Importazione degli asset
- anchor: using-assets
  title: Uso degli asset
- anchor: editing-external-assets
  title: Modifica degli asset esterni
- anchor: editing-defold-assets
  title: Modifica degli asset Defold
---
...
* Le immagini possono essere usate per creare molti tipi di componenti visivi di uso comune nei giochi 2D. Per saperne di più, consulta [come importare e usare la grafica 2D](/it/manuals/importing-graphics).
* I suoni possono essere usati dal [componente Sound](/it/manuals/sound) per riprodurre audio.
* I font vengono usati dal [componente Label](/it/manuals/label) e dai [nodi di testo](/it/manuals/gui-text) in una GUI.
* I modelli glTF (*.gltf* e *.glb*) possono essere usati dal [componente Model](/it/manuals/model) per mostrare modelli 3D con animazioni. Importa tutte le immagini delle texture usate dal modello come asset separati e assegnale nelle proprietà delle texture del materiale del componente Model. Per saperne di più, consulta [come importare e usare i modelli 3D](/it/manuals/importing-models).

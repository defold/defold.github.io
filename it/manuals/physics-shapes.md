...
- anchor: primitive-shapes
  title: Forme primitive
- anchor: box-shape
  title: Forma a parallelepipedo
- anchor: sphere-shape
  title: Forma sferica
- anchor: capsule-shape
  title: Forma a capsula
- anchor: complex-shapes
  title: Forme complesse
- anchor: hull-and-mesh-shapes-in-3d
  title: Forme Hull e Mesh in 3D
- anchor: tilemap-collision-shape
  title: Forma di collisione di una mappa di tile
- anchor: convex-hull-shape
  title: Forma a inviluppo convesso
- anchor: file-format
  title: Formato del file
- anchor: external-tools
  title: Strumenti esterni
- anchor: scaling-collision-shapes
  title: Modifica della scala delle forme di collisione
- anchor: resizing-collision-shapes
  title: Ridimensionamento delle forme di collisione
- anchor: rotating-collision-shapes
  title: Rotazione delle forme di collisione
- anchor: rotating-collision-shapes-in-3d-physics
  title: Rotazione delle forme di collisione nella fisica 3D
- anchor: rotating-collision-shapes-in-2d-physics
  title: Rotazione delle forme di collisione nella fisica 2D
- anchor: debugging
  title: Debug
---
...
![Aggiunta di una forma primitiva](/manuals/images/physics/add_shape.png)
...
Defold include una funzionalità che consente di generare facilmente forme fisiche per la sorgente di tile usata da una mappa di tile. Il [manuale delle sorgenti di tile](/it/manuals/tilesource/#tile-source-collision-shapes) spiega come aggiungere gruppi di collisione a una sorgente di tile e assegnare i tile ai gruppi di collisione ([esempio](/examples/tilemap/collisions/)).
...
![Collisione della sorgente di tile](/manuals/images/physics/collision_tilemap.png)
...
Le forme di collisione nella fisica 2D possono essere ruotate solo attorno all'asse z. La rotazione attorno all'asse x o y produce risultati errati e va evitata, anche quando si ruota di 180 gradi per ribaltare di fatto la forma lungo l'asse x o y. Per ribaltare una forma fisica, si consiglia di usare [`physics.set_hlip(url, flip)`](/ref/physics/?#physics.set_hflip:url-flip) e [`physics.set_vlip(url, flip)`](/ref/physics/?#physics.set_vflip:url-flip).


# Debug {#debugging}
Puoi [attivare il debug della fisica](/it/manuals/debugging-game-logic/#debugging-problems-with-physics) per visualizzare le forme di collisione durante l'esecuzione.
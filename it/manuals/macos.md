...
toc:
- anchor: macos-development
  title: Sviluppo per macOS
- anchor: project-settings
  title: Impostazioni del progetto
- anchor: application-icon
  title: Icona dellapplicazione
- anchor: publishing-your-application
  title: Pubblicazione dellapplicazione
- anchor: publishing-outside-the-mac-app-store
  title: Pubblicazione al di fuori del Mac App Store
- anchor: publishing-to-the-mac-app-store
  title: Pubblicazione sul Mac App Store
---
...
La configurazione dell'applicazione specifica per macOS si effettua nella [sezione macOS](/it/manuals/project-settings/#macos) del file delle impostazioni *game.project*.

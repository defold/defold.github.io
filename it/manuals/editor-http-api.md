...
Attendi che l'URL sia disponibile prima di avviare i test nel browser. Per ulteriori dettagli, consulta [Test nel browser per HTML5](/it/manuals/automated-testing/#browser-tests-for-html5).
...
![Anteprima della collection principale renderizzata dall'editor](/manuals/images/automation/main-preview.png)

...
- anchor: cameras
  title: Telecamere
- anchor: creating-a-camera
  title: Creare una telecamera
- anchor: using-the-camera
  title: Usare la telecamera
- anchor: render-script
  title: Script di rendering
- anchor: panning-the-camera
  title: Spostare la telecamera
- anchor: zooming-the-camera
  title: Regolare lo zoom della telecamera
- anchor: adaptive-zoom
  title: Zoom adattivo
- anchor: following-a-game-object
  title: Seguire un oggetto di gioco
- anchor: converting-mouse-to-world-coordinates
  title: Convertire tra coordinate dello schermo e del mondo
- anchor: runtime-manipulation
  title: Modifiche durante lesecuzione
- anchor: third-party-camera-solutions
  title: Soluzioni per telecamere di terze parti
---
...
![proiezioni](/manuals/images/camera/projections.png)
...
![creazione del componente telecamera](/manuals/images/camera/create.png)

Il componente telecamera ha le seguenti proprietà che definiscono il *frustum* della telecamera:

![impostazioni della telecamera](/manuals/images/camera/settings.png)
...
![inseguimento di un oggetto di gioco](/manuals/images/camera/follow.png)
...
<div class='sidenote' markdown='1'>
Le [soluzioni per telecamere di terze parti menzionate in questo manuale](/it/manuals/camera/#third-party-camera-solutions) forniscono funzioni per convertire da e verso le coordinate dello schermo.
</div>

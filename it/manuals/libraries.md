...
- anchor: setting-up-library-sharing
  title: Configurare la condivisione di una libreria
- anchor: library-url
  title: URL della libreria
- anchor: basic-access-authentication
  title: Autenticazione di accesso di base
- anchor: advanced-access-authentication
  title: Autenticazione di accesso avanzata
- anchor: setting-up-library-dependencies
  title: Configurare le dipendenze da librerie
- anchor: editing-files-in-library-dependencies
  title: Modificare i file nelle librerie usate come dipendenze
- anchor: broken-references
  title: Riferimenti non validi
- anchor: name-collisions
  title: Conflitti di nomi
---
...
Supponiamo che tu voglia creare una libreria contenente sprite e sorgenti di tile (tile source) condivisi. Inizia [configurando un nuovo progetto](/it/manuals/project-setup/). Decidi quali cartelle del progetto vuoi condividere e aggiungi i loro nomi alla proprietà *`include_dirs`* nelle impostazioni del progetto. Se vuoi elencare più cartelle, separa i nomi con spazi:

![Directory da includere](/manuals/images/libraries/libraries_include_dirs.png)
...
![URL della libreria su GitHub](/manuals/images/libraries/libraries_library_url_github.png)
...
<div class='important' markdown='1'>
È consigliabile esaminare sempre le librerie di terze parti prima di usarle. Per saperne di più, consulta [come rendere sicuro l'uso di software di terze parti](https://defold.com/it/manuals/application-security/#securing-your-use-of-third-party-software).
</div>
...
![Dipendenze](/manuals/images/libraries/libraries_dependencies.png)
...
![Recupero delle librerie](/manuals/images/libraries/libraries_fetch_libraries.png)
...
![Configurazione della libreria completata](/manuals/images/libraries/libraries_done.png)
...
Se copi e incolli un materiale e vuoi usarlo in tutti i componenti di un certo tipo, può essere utile usare [modelli specifici del progetto](/it/manuals/editor/#creating-new-project-files).

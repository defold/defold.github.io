...
- anchor: editor-scripts-and-ui
  title: Script delleditor e interfaccia utente
- anchor: hello-world
  title: Ciao mondo
- anchor: opening-resources
  title: Aprire le risorse
...
- anchor: layout-components
  title: Componenti di layout
- anchor: data-presentation-components
  title: Componenti di presentazione dei dati
- anchor: input-components
  title: Componenti di input
- anchor: dialog-related-components
  title: Componenti per le finestre di dialogo
- anchor: utility-components
  title: Componenti di utilità
- anchor: reactivity
  title: Reattività
- anchor: rules-of-reactivity
  title: Regole della reattività
- anchor: hooks
  title: Hook
- '**use_state**'
- '**use_memo**'
...
![Finestra di dialogo Ciao mondo](/manuals/images/editor_scripts/perform_action_dialog.png)
...
![Allineamento](/manuals/images/editor_scripts/alignment.png)
...
![Spaziatura interna e tra i figli](/manuals/images/editor_scripts/padding_and_spacing.png)
...
![Finestra di dialogo per un nuovo livello](/manuals/images/editor_scripts/new_level_dialog.png)
...
![Campi di input](/manuals/images/editor_scripts/inputs_demo.png)
...
![Finestra di dialogo per un nuovo file](/manuals/images/editor_scripts/reactive_new_file_dialog.png)

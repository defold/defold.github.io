...
- anchor: mouse-triggers
  title: Trigger del mouse
- anchor: mouse-buttons
  title: Pulsanti del mouse
- anchor: mouse-wheel
  title: Rotella del mouse
- anchor: mouse-movement
  title: Movimento del mouse
- anchor: touch-triggers
  title: Trigger tattili
- anchor: single-touch
  title: Tocco singolo
- anchor: multi-touch
  title: Tocchi multipli
- anchor: detecting-click-or-tap-on-objects
  title: Rilevare clic o tocchi sugli oggetti
- anchor: detecting-interaction-with-gui-nodes
  title: Rilevare linterazione con i nodi GUI
- anchor: detecting-interaction-with-game-objects
  title: Rilevare linterazione con gli oggetti di gioco
---

<div class='sidenote' markdown='1'>
Ti consigliamo di familiarizzare con il funzionamento generale dell'input in Defold, con le modalità di ricezione dell'input e con l'ordine in cui viene ricevuto nei file di script. Per saperne di più sul sistema di input, consulta il [manuale introduttivo sull'input](/it/manuals/input).
</div>
...
In entrambi i casi è necessario convertire le coordinate dell'evento del mouse o del tocco nello spazio dello schermo in coordinate nello spazio del mondo degli oggetti di gioco. Puoi farlo in diversi modi:
  ...
  * Tenere traccia manualmente della vista e della proiezione utilizzate dallo script di rendering e usarle per convertire le coordinate da e verso lo spazio del mondo. Consulta il [manuale della camera per un esempio](/it/manuals/camera/#converting-mouse-to-world-coordinates).
  * Usare una [soluzione di terze parti per la camera](/it/manuals/camera/#third-party-camera-solutions) e le funzioni di conversione dallo spazio dello schermo allo spazio del mondo che mette a disposizione.
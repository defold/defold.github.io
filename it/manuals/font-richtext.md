...
toc:
- anchor: rich-text-markup
  title: Markup del testo formattato
- anchor: tag-reference
  title: Riferimento dei tag
- anchor: syntax
  title: Sintassi
- anchor: attributes
  title: Attributi
...
- sprite
- link
- anchor: interaction-messages
  title: Messaggi di interazione
- anchor: named-styles
  title: Stili con nome
- anchor: layout-object-api
  title: API degli oggetti di layout
- label.get_layout_objects()
- gui.get_layout_objects()
- anchor: returned-object-fields
  title: Campi degli oggetti restituiti
- anchor: lua-example
  title: Esempio Lua
- anchor: useful-combinations
  title: Combinazioni utili
- anchor: colored-outline-with-a-horizontal-gradient
  title: Contorno colorato con un gradiente orizzontale
- anchor: shake-a-sentence-gradient-one-word
  title: Far tremare una frase e applicare un gradiente a una parola
- anchor: override-one-property-without-losing-the-others
  title: Sovrascrivere una proprietà senza perdere le altre
---
...
![Testo di esempio renderizzato in verde opaco](/manuals/images/richtext/color_green.webp)
...
![Testo di esempio renderizzato in verde con alfa dimezzato](/manuals/images/richtext/color_green_alpha.webp)
...
![Testo di esempio renderizzato a 24 pixel](/manuals/images/richtext/size_24.webp)
...
![Testo di esempio renderizzato al 120 percento di 32 pixel](/manuals/images/richtext/size_120.webp)
...
![Testo di esempio renderizzato al doppio della dimensione di base di 32 pixel](/manuals/images/richtext/size_2em.webp)
...
![Testo di esempio con un gradiente orizzontale dal magenta al bianco](/manuals/images/richtext/gradient_horizontal.webp)
...
![Testo di esempio con un gradiente blu verticale](/manuals/images/richtext/gradient_vertical.webp)
...
![Testo di esempio con un gradiente a quattro angoli adattato a ogni glifo](/manuals/images/richtext/gradient_four_glyph.webp)
...
![Testo di esempio con un gradiente a quattro angoli adattato alla porzione di testo](/manuals/images/richtext/gradient_four_text.webp)
...
![Gradiente animato a scorrimento adattato a ogni glifo](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![Gradiente animato a scorrimento adattato alla porzione di testo](/manuals/images/richtext/gradient_flow_span.webp)
...
![Testo di esempio con sottolineatura continua](/manuals/images/richtext/underline_solid.webp)
...
![Testo di esempio con sottolineatura tratteggiata](/manuals/images/richtext/underline_dashed.webp)
...
![Testo di esempio con sottolineatura a gradiente](/manuals/images/richtext/underline_gradient.webp)
...
![Testo di esempio barrato con linea continua](/manuals/images/richtext/strike_solid.webp)
...
![Testo di esempio barrato con linea tratteggiata](/manuals/images/richtext/strike_dashed.webp)
...
![Testo di esempio con un contorno nero esterno](/manuals/images/richtext/outline.webp)
...
![Testo di esempio con un'ombra spostata](/manuals/images/richtext/shadow.webp)
...
![Testo di esempio con un tremolio animato per ogni glifo](/manuals/images/richtext/shake_glyph.webp)
...
![Testo di esempio con un tremolio animato dell'intera porzione di testo](/manuals/images/richtext/shake_span.webp)
...
![Testo di esempio con un'onda animata per ogni glifo](/manuals/images/richtext/wave_glyph.webp)
...
![Testo di esempio che si muove come un'unica porzione animata](/manuals/images/richtext/wave_span.webp)
...
![Un logo Defold renderizzato in linea con il testo](/manuals/images/richtext/sprite.webp)
...
![www.defold.com renderizzato con lo stile predefinito dei link e una sottolineatura](/manuals/images/richtext/link.webp)
...
Consulta [Focus dell'input](/it/manuals/input/#input-focus) e [Input da mouse e tocco](/it/manuals/input-mouse-and-touch) per i dettagli della configurazione.

...
- anchor: creating-a-tile-source
  title: Creare una sorgente di tasselli
- anchor: tile-source-flip-book-animations
  title: Animazioni a fotogrammi delle sorgenti di tasselli
- anchor: tile-source-collision-shapes
  title: Forme di collisione delle sorgenti di tasselli
---

# Sorgente di tasselli {#tile-source}

Una *sorgente di tasselli (tile source)* può essere utilizzata da un [componente mappa di tasselli (tile map)](/it/manuals/tilemap) per disegnare tasselli su una griglia, oppure come sorgente grafica per uno [sprite](/it/manuals/sprite) o un [componente effetto particellare](/it/manuals/particlefx). Puoi anche utilizzare le *forme di collisione* della sorgente di tasselli in una mappa di tasselli per il [rilevamento delle collisioni e la simulazione fisica](/it/manuals/physics) ([esempio](/examples/tilemap/collisions/)).
...
![Immagine dei tasselli](/manuals/images/tilemap/small_map.png)
...
![Creazione di una sorgente di tasselli](/manuals/images/tilemap/tilesource.png)
...
![Animazione della sorgente di tasselli](/manuals/images/tilemap/animation.png)
...
![Forme di collisione](/manuals/images/tilemap/collision.png)

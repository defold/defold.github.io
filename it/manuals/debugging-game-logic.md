...
- anchor: debugging-game-logic
  title: Debug della logica di gioco
- anchor: print-and-visual-debugging
  title: Debug con stampe e visualizzazioni
- anchor: running-the-debugger
  title: Avvio del debugger
- anchor: breakpoints-tab
  title: Scheda Breakpoints
- anchor: lua-debug-library
  title: Libreria di debug di Lua
- anchor: debugging-checklist
  title: Lista di controllo per il debug
- anchor: debugging-problems-with-physics
  title: Debug dei problemi con la fisica
---

# Debug della logica di gioco {#debugging-game-logic}

Defold include un debugger Lua integrato con funzioni di ispezione. Insieme agli [strumenti di profilazione](/it/manuals/profiling) integrati, è uno strumento potente che può aiutarti a trovare la causa dei bug nella logica di gioco o ad analizzare problemi di prestazioni.
...
![panoramica](/manuals/images/debugging/overview.png)
...
: <img src='/manuals/images/debugging/play.svg' width='60px'/>
  ...
  ![interruzione](/manuals/images/debugging/break.png)
...
: <img src='/manuals/images/debugging/step_over.svg' width='60px'/>
  ...
  ![passo](/manuals/images/debugging/step.png)
...
: <img src='/manuals/images/debugging/step_in.svg' width='60px'/>
  ...
  ![ingresso nella funzione](/manuals/images/debugging/step_into.png)
...
: Puoi impostare un numero arbitrario di punti di interruzione nel codice Lua. Quando il gioco viene eseguito con il debugger collegato, l'esecuzione si fermerà al prossimo punto di interruzione che incontra e attenderà un tuo ulteriore intervento.
  ...
  ![aggiunta di un punto di interruzione](/manuals/images/debugging/add_breakpoint.png)
...
: Puoi disattivare temporaneamente i punti di interruzione senza rimuoverli. Quando sono disattivati, vengono ignorati durante l'esecuzione, ma puoi riattivarli in qualsiasi momento. Fai clic con il pulsante destro del mouse sul punto di interruzione nel margine dell'editor di codice, quindi seleziona o deseleziona la casella `Enabled`. I punti di interruzione disattivati appaiono vuoti all'interno per indicare che sono inattivi.
  ...
  ![disattivazione di un punto di interruzione](/manuals/images/debugging/disable_breakpoint.png)
...
: Puoi configurare un punto di interruzione in modo che contenga una condizione che deve risultare vera affinché il punto di interruzione si attivi. La condizione può accedere alle variabili locali disponibili in quella riga durante l'esecuzione del codice.
  ...
  ![modifica di un punto di interruzione](/manuals/images/debugging/edit_breakpoint.png)
...
## Scheda Breakpoints {#breakpoints-tab}
  ...
  ![scheda Breakpoints](/manuals/images/debugging/breakpoints_tab.png)
...
![impostazione di debug della fisica](/manuals/images/debugging/physics_debug_setting.png)

Quando questa casella è selezionata, Defold disegna tutte le forme di collisione e i punti di contatto delle collisioni:

![visualizzazione di debug della fisica](/manuals/images/debugging/physics_debug_visualisation.png)
...
- anchor: extension-application-and-engine-manifest-files
  title: File manifest dellestensione, dellapplicazione e del motore
- anchor: app-manifest
  title: Manifest dellapplicazione
- anchor: engine-manifest
  title: Manifest del motore
- anchor: extension-manifest
  title: Manifest dellestensione
- anchor: the-extmanifest-file
  title: Il file ext.manifest
---

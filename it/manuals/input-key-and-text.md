...
toc:
- anchor: key-triggers
  title: Trigger dei tasti
- anchor: text-triggers
  title: Trigger di testo
- anchor: text
  title: Testo
- anchor: marked-text
  title: Testo in composizione
---

<div class='sidenote' markdown='1'>
Ti consigliamo di familiarizzare con il funzionamento generale dell'input in Defold, con il modo in cui riceverlo e con l'ordine in cui viene ricevuto nei file di script. Per saperne di più sul sistema di input, consulta il [manuale di panoramica sull'input](/it/manuals/input).
</div>
...
![Input di testo in composizione](/manuals/images/input/marked_text.png)

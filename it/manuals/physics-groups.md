...
- anchor: group-and-mask
  title: Gruppo e maschera
- anchor: detecting-collisions
  title: Rilevamento delle collisioni
---
...
![Gruppo di collisione fisica](/manuals/images/physics/collision_group.png)
...
Quando due oggetti di collisione con gruppi e maschere compatibili entrano in collisione, il motore fisico genera [messaggi di collisione](/it/manuals/physics-messages) che puoi usare nei giochi per reagire alle collisioni.
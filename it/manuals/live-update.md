...
- anchor: preparing-content-for-live-update
  title: Preparare i contenuti per Live Update
- anchor: live-update-settings
  title: Impostazioni di Live Update
- anchor: bundling-with-live-update
  title: Creare un bundle con Live Update
- anchor: the-zip-archives
  title: Gli archivi .zip
- anchor: splitting-zip-archives
  title: Suddividere gli archivi .zip
- anchor: live-update-on-android
  title: Live Update su Android
- anchor: content-verification
  title: Verifica dei contenuti
- anchor: mounts
  title: Punti di montaggio
- anchor: scripting-with-live-update
  title: Usare Live Update negli script
- anchor: development-caveats
  title: Accorgimenti durante lo sviluppo
---
...
![Collezione della Gioconda](/manuals/images/live-update/mona-lisa.png)
...
![Proxy di collezione escluso](/manuals/images/live-update/proxy-excluded.png)
...
![Impostazioni di Live Update](/manuals/images/live-update/05-liveupdate-settings-zip.png)
...
![Creazione del bundle di un'applicazione con Live Update](/manuals/images/live-update/bundle-app.png)
...
Per approfondire, consulta la guida su come [usare Live Update negli script](/it/manuals/live-update-scripting).
...
: Quando esegui una versione del gioco distribuita come bundle, non hai accesso diretto a una console. Questo crea problemi per il debug. Puoi però eseguire l'applicazione dalla riga di comando o facendo doppio clic direttamente sull'eseguibile nel bundle:
  ...
  ![Esecuzione di un'applicazione da un bundle](/manuals/images/live-update/run-bundle.png)

  Ora il gioco si avvia con una finestra della shell che mostra l'output di tutte le istruzioni `print()`:

  ![Output della console](/manuals/images/live-update/run-bundle-console.png)
...
: Lo sviluppatore può scaricare i contenuti in qualsiasi file o cartella desideri, ma spesso si trovano all'interno del percorso dell'applicazione. La posizione della cartella di supporto dell'applicazione dipende dal sistema operativo. Puoi trovarla con `print(sys.get_save_file("", ""))`. Per forzare un download, rimuovi il pacchetto scaricato e la voce corrispondente da qualsiasi stato gestito dall'applicazione. Non esiste un elenco dei punti di montaggio gestito dal motore da eliminare; i punti di montaggio non persistono dopo un riavvio.
  ...
  ![Archiviazione locale](/manuals/images/live-update/local-storage.png)
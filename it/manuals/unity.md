...
- anchor: defold-editor-overview
  title: Panoramica delleditor Defold
- anchor: editors-comparison
  title: Confronto degli editor
- anchor: defold-panes-overview
  title: Panoramica dei pannelli di Defold
- anchor: key-concepts
  title: Concetti fondamentali
- anchor: building-blocks
  title: Elementi costitutivi
- anchor: game-objects
  title: Oggetti di gioco
- anchor: components
  title: Componenti
- anchor: resources
  title: Risorse
- anchor: collection-vs-scene
  title: Collezione e scena a confronto
- anchor: project-resources-and-assets
  title: Risorse e asset del progetto
- anchor: assets
  title: Asset
- anchor: resource-formats
  title: Formati delle risorse
- anchor: library-cache
  title: Cache delle librerie
- anchor: code-writing
  title: Scrittura del codice
- Lua
- Teal
- anchor: cc-native-extensions
  title: Estensioni native C++/C
- anchor: from-monobehaviours-to-lua-modules
  title: Dai MonoBehaviour ai moduli Lua
- anchor: built-in-code-editor
  title: Editor di codice integrato
- anchor: vs-code-and-other-editors
  title: VS Code e altri editor
- anchor: shaders-glsl
  title: Shader - GLSL
- anchor: messaging-system
  title: Sistema di messaggistica
- anchor: sending-a-message
  title: Invio di un messaggio
- anchor: addressing
  title: Indirizzamento
- anchor: messaging-to-gui-and-render
  title: Messaggi alla GUI e al rendering
- anchor: prefabs-and-instances
  title: Prefab e istanze
- anchor: factory
  title: Fabbrica
...
- anchor: application-lifecycle
  title: Ciclo di vita dellapplicazione
- anchor: initialization
  title: Inizializzazione
- anchor: when-messages-are-handled
  title: Quando vengono gestiti i messaggi?
- anchor: update-loop
...
- anchor: gui-rendering
  title: Rendering della GUI
- anchor: where-are-sorting-layers
  title: Dove sono i Sorting Layers?
- anchor: where-to-go-from-here
  title: Come proseguire?
---
...
Se ti servono altri dettagli, leggi questo breve [manuale di installazione](/it/manuals/install/).
...
![Confronto delle schermate iniziali](/manuals/images/unity/unity_defold_start.png)
...
![Confronto dei modelli nella schermata iniziale](/manuals/images/unity/unity_defold_templates.png)
...
![Ciao mondo, passaggio 1](/manuals/images/unity/helloworld_1.png)
...
![Ciao mondo, passaggio 2](/manuals/images/unity/helloworld_2.png)
4. Fai clic con il pulsante destro sull'oggetto di gioco `go` appena creato e seleziona `Add Component`, poi `Label`.
![Ciao mondo, passaggio 3](/manuals/images/unity/helloworld_3.png)
...
![Ciao mondo, passaggio 4](/manuals/images/unity/helloworld_4.png)
...
![Ciao mondo, passaggio 5](/manuals/images/unity/helloworld_5.png)
...
Qui presentiamo l'editor Defold dal punto di vista di ciò che potrebbe interessare subito a chi usa Unity, ma ti invitiamo a consultare in seguito il [manuale completo sulla panoramica dell'editor](/it/manuals/editor).
...
![Confronto degli editor](/manuals/images/unity/defold_unity_editor.png)
...
![Barra degli strumenti di Defold](/manuals/images/unity/defold_2d.png)

Puoi anche regolare le `Grid Settings` nella barra degli strumenti per usare il piano `Y`, come in Unity:

![Impostazioni 3D di Defold](/manuals/images/unity/defold_3d.png)
...
| [Debugger](/it/manuals/debugging/) | Visual Studio Debugger | Il debugger è completamente integrato in Defold fin dall'installazione. Una scheda aggiuntiva permette di tenere traccia dei punti di interruzione e di attivarli e disattivarli. |
...
![Elementi costitutivi](/manuals/images/unity/blocks.png)

Per maggiori dettagli, consulta il manuale completo sugli [elementi costitutivi di Defold](/it/manuals/building-blocks/).
...
Leggi altri dettagli sui [componenti di Defold](/it/manuals/components/).
...
| Defold | Unity | Differenze |
|---|---|---|
| [Sprite](/it/manuals/sprite/) | Sprite Renderer | In Defold puoi cambiare la tinta (proprietà del colore) soltanto tramite codice. |
| [Tilemap](/it/manuals/tilemap/) | Tilemap / Grid | Defold dispone di un editor di tilemap integrato che supporta griglie quadrate (ma esistono estensioni, per esempio per [Hexagon](https://github.com/selimanac/defold-hexagon/)) e non ha regole integrate per il posizionamento automatico dei tile. Strumenti come [Tiled](https://defold.com/assets/tiled/), [TileSetter](https://defold.com/assets/tilesetter/) o [Sprite Fusion](https://defold.com/assets/spritefusion/) offrono opzioni di esportazione per Defold. |
| [Label](/it/manuals/label/) | Text / TextMeshPro | Da Defold 1.13.2, i componenti Label e i nodi di testo GUI supportano il [markup del testo formattato](/it/manuals/font-richtext/) integrato per colori, gradienti, contorni ed effetti animati. È disponibile anche un'[estensione RichText](https://defold.com/assets/richtext/) separata. |
| [Sound](/it/manuals/sound/) | AudioSource | Defold dispone soltanto di una sorgente sonora globale (non spaziale). È disponibile un'[estensione FMOD](https://github.com/defold/extension-fmod) ufficiale per Defold. |
| [Fabbrica](/it/manuals/factory/) | Prefab Instantiate() | In Defold una fabbrica (factory) è un componente con un prototipo specifico (prefab). |
| [Fabbrica di collezioni](/it/manuals/collection-factory/) | - (Nessun componente direttamente equivalente) | Un componente fabbrica di collezioni (collection factory) in Defold può generare contemporaneamente più oggetti di gioco con relazioni genitore-figlio. |
| [Oggetto di collisione](/it/manuals/physics-objects) | Rigidbody + Collider | In Defold gli oggetti fisici e le forme di collisione sono riuniti in un unico componente. |
| [Forme di collisione](/it/manuals/physics-shapes/)  | BoxCollider / SphereCollider / CapsuleCollider | In Defold le forme (parallelepipedo, sfera, capsula) si configurano all'interno del componente oggetto di collisione. Entrambi supportano forme di collisione ricavate da tilemap e dati di inviluppi convessi. |
| [Camera](/it/manuals/camera/) | Camera | In Unity la camera ha più impostazioni integrate per il rendering e la post-elaborazione, mentre Defold affida la loro personalizzazione all'utente tramite lo script di rendering. |
| [GUI](/it/manuals/gui/) | UI Toolkit / Unity UI / uGUI Canvas | La GUI di Defold è un componente potente per creare interfacce e modelli completi. Unity non ha un singolo componente UI equivalente, ma diversi framework per le interfacce. Defold dispone anche di un'[estensione](https://github.com/britzl/extension-imgui). |
| [Script GUI](/it/manuals/gui-script/) | Script Unity UI / uGUI | La GUI di Defold può essere controllata tramite script GUI usando l'API dedicata `gui`. |
| [Modello](/it/manuals/model/) | MeshRenderer + Material | In Defold un componente modello riunisce un file di modello 3D, le texture e un materiale con shader. |
| [Mesh](/it/manuals/mesh/) | MeshRenderer / MeshFilter / Mesh procedurale | In Defold Mesh è un componente per gestire un insieme di vertici tramite codice. È simile a un modello Defold, ma opera a un livello ancora più basso. |
| [ParticleFX](/it/manuals/particlefx/) | Particle System | L'editor di particelle di Defold supporta effetti particellari 2D/3D con molte proprietà e permette di animarle nel tempo mediante curve nel Curve Editor. Non dispone di scie o collisioni. |
| [Script](/it/manuals/script/) | Script | Le differenze di programmazione sono spiegate più in dettaglio di seguito. |
...
| Defold | Unity | Differenze |
|---|---|---|
| [Atlas](/it/manuals/atlas/) | Sprite Atlas / Texture2D | Defold dispone anche di un'[estensione per Texture Packer](https://defold.com/extension-texturepacker/). |
| [Sorgente di tile](/it/manuals/tilesource/) | Tile Palette + Asset | In Defold una sorgente di tile può essere usata come texture per le tilemap, ma anche per sprite o particelle. |
| [Font](/it/manuals/font/) | Font | Usato dal componente Label di Defold o dai nodi di testo della GUI, in modo simile a Text/TextMeshPro in Unity. |
| [Materiale](/it/manuals/material/) | Material | In Defold gli shader prendono il nome di vertex program e fragment program. |
...
Leggi altri dettagli sulle collezioni nel [manuale degli elementi costitutivi](/it/manuals/building-blocks/#collections).
...
Leggi altri dettagli sulle estensioni nel [manuale delle estensioni native di Defold](/it/manuals/extensions/).
...
- [Manuale degli script](/it/manuals/script/)
- [Scrittura del codice](/it/manuals/writing-code/)
- [Debug](/it/manuals/debugging/)
...
Puoi anche configurare le preferenze dell'editor Defold per aprire i file di testo in VS Code (o in qualsiasi altro editor esterno) per impostazione predefinita. Consulta le [preferenze dell'editor](/it/manuals/editor-preferences/) per i dettagli.
...
Leggi altri dettagli sugli shader nel [manuale degli shader](/it/manuals/shader).
...
Leggi altri dettagli sui materiali nel [manuale dei materiali](/it/manuals/material).
...
Puoi leggere altri dettagli nel [manuale dello scambio di messaggi](/it/manuals/message-passing/).
...
Trovi altri dettagli nel [manuale dell'indirizzamento](/it/manuals/addressing/).
...
Consulta altri dettagli nel [manuale delle fabbriche](/it/manuals/factory/). 
...
Consulta altri dettagli nel [manuale delle fabbriche di collezioni](/it/manuals/collection-factory/).
...
Consulta altri dettagli nel [manuale della gestione delle risorse](/it/manuals/resource/). 
...
Consulta altri dettagli nel [manuale dei proxy di collezione](/it/manuals/collection-proxy/).
...
| `on_input` | Metodi di input | Defold riceve gli input quando [lo script ha acquisito il focus dell'input](/it/manuals/input/#input-focus). Vengono elaborati per primi nel ciclo di aggiornamento. |
| `fixed_update()` | `FixedUpdate()` | Chiamata a intervalli di tempo fissi. Per abilitarla in Defold devi impostare `Use Fixed Timestep` - [dettagli](https://defold.com/it/manuals/project-settings/#use-fixed-timestep). Dalla versione 1.12.0 viene eseguita prima di `update()`. |
...
Per altri dettagli, leggi il [manuale del ciclo di vita dell'applicazione](/it/manuals/application-lifecycle/).
...
Per altri dettagli, leggi il [manuale della GUI](/it/manuals/gui/).

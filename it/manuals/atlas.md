...
- anchor: creating-an-atlas
  title: Creazione di un atlas
- anchor: atlas-properties
  title: Proprietà dellatlas
- anchor: image-properties
  title: Proprietà delle immagini
- anchor: animation-properties
  title: Proprietà delle animazioni
- anchor: runtime-texture-and-atlas-creation
  title: Creazione di texture e atlas a runtime
- anchor: creating-a-texture-resource-at-runtime
  title: Creazione di una risorsa texture a runtime
- anchor: creating-an-atlas-at-runtime
  title: Creazione di un atlas a runtime
---
...
: Trascina e rilascia le immagini dal pannello *Asset* nella vista dell'editor.
  ...
  ![Creazione di un atlas, aggiunta di immagini](/manuals/images/atlas/add.png)
  ...
  ![Immagini aggiunte](/manuals/images/atlas/single_images.png)
...
: <kbd>Fai clic con il pulsante destro</kbd> sulla voce radice Atlas nel pannello *Outline*.
  ...
  ![Creazione di un atlas, aggiunta di immagini](/manuals/images/atlas/add_animation.png)
  ...
  ![Gruppo di animazione](/manuals/images/atlas/animation_group.png)
...
![Atlas a più pagine](/manuals/images/atlas/multipage_atlas.png)
...
![Proprietà dell'atlas](/manuals/images/atlas/atlas_properties.png)
...
![Proprietà delle immagini](/manuals/images/atlas/image_properties.png)
...
Usa [`resource.create_texture(path, params)`](https://defold.com/ref/resource/#resource.create_texture:path-table) per creare una nuova risorsa texture:
...
Una volta creata la texture, puoi usare [`resource.set_texture(path, params, buffer)`](https://defold.com/ref/resource/#resource.set_texture:path-table-buffer) per impostarne i pixel:
...
La texture può essere usata direttamente su un [componente modello](/it/manuals/model/) tramite `go.set()`:
...
Per usare la texture su un [componente sprite](/it/manuals/sprite/), devi prima usarla in un atlas. Usa [`resource.create_atlas(path, params)`](https://defold.com/ref/resource/#resource.create_atlas:path-table) per creare un atlas:

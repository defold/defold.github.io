...
toc:
- anchor: gui-template-nodes
  title: Nodi modello GUI
- anchor: creating-a-template
  title: Creazione di un modello
- anchor: creating-instances-from-a-template
  title: Creazione di istanze da un modello
- anchor: modifying-templates-in-runtime
  title: Modifica dei modelli a runtime
---
...
![Creazione di un modello](/manuals/images/gui-templates/create.png)
...
![Creazione di un'istanza](/manuals/images/gui-templates/create_instance.png)
...
![Istanze](/manuals/images/gui-templates/instances.png)
...
![Proprietà](/manuals/images/gui-templates/properties.png)

Anche tutti i nodi con proprietà sovrascritte sono evidenziati in blu nella vista *Outline*:

![Vista della struttura](/manuals/images/gui-templates/outline.png)

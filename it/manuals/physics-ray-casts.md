...
toc:
- anchor: ray-casts
  title: Proiezione di raggi
---

## Proiezione di raggi {#ray-casts}

La proiezione di raggi (ray cast) permette di esaminare il mondo fisico lungo un raggio rettilineo. Per proiettare un raggio nel mondo fisico, specifica una posizione iniziale e una finale, oltre a [un insieme di gruppi di collisione](/it/manuals/physics-groups) con cui verificare le intersezioni.

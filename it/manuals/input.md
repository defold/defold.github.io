...
- anchor: setting-up-input-bindings
  title: Configurazione dei binding di input
- anchor: trigger-types
  title: Tipi di trigger
- anchor: accelerometer-input
  title: Input dallaccelerometro
- anchor: input-focus
  title: Focus dellinput
- anchor: input-dispatch-and-on_input
  title: Distribuzione dellinput e on_input()
- anchor: input-focus-and-collection-proxy-components
  title: Focus dellinput e componenti proxy di collezione
- anchor: releasing-input
  title: Rilascio dellinput
- anchor: consuming-input
  title: Consumo dellinput
---
...
![Binding di input](/manuals/images/input/overview.png)
...
: I dispositivi di input integrati nel computer o nel dispositivo mobile, oppure collegati a essi, forniscono al runtime di Defold l'input grezzo a livello di sistema. Sono supportati i seguenti tipi di dispositivi:
  ...
  4. Gamepad (secondo il supporto del sistema operativo e la mappatura nel file [gamepads](/it/manuals/input-gamepads/#gamepads-settings-file))
...
![Impostazione del binding di input](/manuals/images/input/setting.png)
...
![Configurazione dei binding di input](/manuals/images/input/input_binding.png)
...
Key Triggers
: Input da singoli tasti della tastiera. Ogni tasto viene associato separatamente a un'azione corrispondente. Per saperne di più, consulta il [manuale sull'input da tastiera e sull'immissione di testo](/it/manuals/input-key-and-text).

Text Triggers
: I trigger di testo servono a leggere testo arbitrario immesso dall'utente. Per saperne di più, consulta il [manuale sull'input da tastiera e sull'immissione di testo](/it/manuals/input-key-and-text)

Mouse Triggers
: Input dai pulsanti e dalle rotelline del mouse. Per saperne di più, consulta il [manuale sull'input da mouse e tattile](/it/manuals/input-mouse-and-touch).

Touch Triggers
: I trigger di tipo Single-touch e Multi-touch sono disponibili sui dispositivi iOS e Android nelle applicazioni native e nei bundle HTML5. Per saperne di più, consulta il [manuale sul mouse e sul tocco](/it/manuals/input-mouse-and-touch).

Gamepad Triggers
: I trigger del gamepad consentono di associare gli input standard del gamepad alle funzioni del gioco. Per saperne di più, consulta il [manuale sui gamepad](/it/manuals/input-gamepads).
...
![Stack di input](/manuals/images/input/input_stack.png)
...
![Distribuzione delle azioni](/manuals/images/input/actions.png)
...
![Distribuzione delle azioni ai proxy](/manuals/images/input/proxy.png)
...
![Consumo dell'input](/manuals/images/input/consuming.png)
...
![Consumo dell'input](/manuals/images/input/game.png)
...
![Menu di pausa](/manuals/images/input/game_paused.png)

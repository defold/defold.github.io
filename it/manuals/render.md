...
- anchor: render-pipeline-what-when-and-where
  title: Pipeline di rendering - Cosa, quando e dove?
- anchor: the-default-render
  title: Il rendering predefinito
- anchor: render-predicates
  title: Predicati di rendering
- anchor: default-view-projection
  title: Proiezione della vista predefinita
- anchor: stretch-projection
  title: Proiezione Stretch
- anchor: fixed-fit-projection
  title: Proiezione Fixed Fit
- anchor: fixed-projection
  title: Proiezione Fixed
- anchor: camera-projection
  title: Proiezione della camera
- Frustum culling
- anchor: coordinate-systems
  title: Sistemi di coordinate
- anchor: the-render-script
  title: Lo script di rendering
- anchor: render-resources
  title: Risorse di rendering
- anchor: multisampled-render-targets
  title: Render target multicampionati
- anchor: texture-handles
  title: Handle delle texture
- anchor: supported-graphics-apis
  title: API grafiche supportate
- anchor: system-messages
  title: Messaggi di sistema
- anchor: draw-calls-and-batching
  title: Chiamate di disegno e raggruppamento
- anchor: batch-rules-for-non-gui-components
  title: Regole di raggruppamento per i componenti non GUI
- anchor: batch-rules-for-gui-components
  title: Regole di raggruppamento per i componenti GUI
---
...
![Rendering integrato](/manuals/images/render/builtin.png)
...
Una descrizione dettagliata del funzionamento dei materiali è disponibile nella [documentazione sui materiali](/it/manuals/material).
...
![Proiezione Stretch](/manuals/images/render/stretch_projection.png)

*Proiezione Stretch con le dimensioni originali della finestra*

![Proiezione Stretch dopo il ridimensionamento](/manuals/images/render/stretch_projection_resized.png)
...
![Proiezione Fixed Fit](/manuals/images/render/fixed_fit_projection.png)

*Proiezione Fixed Fit con le dimensioni originali della finestra*

![Proiezione Fixed Fit dopo il ridimensionamento](/manuals/images/render/fixed_fit_projection_resized.png)

*Proiezione Fixed Fit con la finestra allargata orizzontalmente*

![Proiezione Fixed Fit con dimensioni ridotte](/manuals/images/render/fixed_fit_projection_resized_smaller.png)
...
![Proiezione Fixed](/manuals/images/render/fixed_projection_zoom_2_0.png)

*Proiezione Fixed con zoom impostato a 2*

![Proiezione Fixed](/manuals/images/render/fixed_projection_zoom_0_5.png)

*Proiezione Fixed con zoom impostato a 0.5*

![Proiezione Fixed](/manuals/images/render/fixed_projection_zoom_2_0_resized.png)
...
Quando usi lo script di rendering predefinito e nel progetto sono disponibili [componenti camera](/it/manuals/camera) abilitati, questi hanno la precedenza su qualsiasi altra vista o proiezione impostata nello script di rendering. Per saperne di più sull'uso dei componenti camera negli script di rendering, consulta la [documentazione sulla camera](/it/manuals/camera).
...
1 = Il volume delimitatore della mesh deve essere impostato dallo sviluppatore. [Ulteriori informazioni](/it/manuals/mesh/#frustum-culling).
...
![Risorse di rendering](/manuals/images/render/render_resources.png)
...
I render target supportano l'antialiasing multicampione (MSAA), che smussa i bordi della geometria in un passaggio di rendering fuori schermo. Il numero di campioni del target è indipendente da [Display ▸ Samples](/it/manuals/project-settings/#samples), che controlla l'antialiasing della finestra.

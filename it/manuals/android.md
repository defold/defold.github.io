...
- anchor: android-development
  title: Sviluppo per Android
- anchor: android-and-google-play-signing-process
  title: Processo di firma per Android e Google Play
- anchor: creating-a-keystore
  title: Creazione di un keystore
- anchor: creating-an-android-application-bundle
  title: Creazione di un bundle di unapplicazione Android
- anchor: installing-an-android-application-bundle
  title: Installazione di un bundle di unapplicazione Android
- anchor: shrinking-java-code-with-r8
  title: Ridurre il codice Java con R8
- anchor: enabling-r8
  title: Abilitare R8
- anchor: adding-rules-to-an-extension
  title: Aggiungere regole a unestensione
- anchor: keeping-the-obfuscation-mapping
  title: Conservare la mappatura delloffuscamento
- anchor: permissions
  title: Autorizzazioni
- anchor: androidpermissioninternet-and-androidpermissionaccess_network_state-protection-level-normal
  title: 'android.permission.INTERNET e android.permission.ACCESS_NETWORK_STATE (Livello di protezione: normal)'
- anchor: androidpermissionwake_lock-protection-level-normal
  title: 'android.permission.WAKE_LOCK (Livello di protezione: normal)'
- anchor: using-androidx
  title: Utilizzo di AndroidX
- FAQ
---

# Sviluppo per Android {#android-development}

I dispositivi Android consentono di eseguire liberamente le proprie applicazioni. È molto semplice creare una build del gioco e copiarla su un dispositivo Android. Questo manuale illustra i passaggi necessari per creare un bundle del gioco per Android. Durante lo sviluppo, spesso è preferibile eseguire il gioco tramite l'[applicazione di sviluppo](/it/manuals/dev-app), poiché consente di ricaricare a caldo contenuti e codice direttamente sul dispositivo.
...
Quando crei un bundle di un'applicazione Android dall'editor Defold o dallo [strumento a riga di comando](/it/manuals/bob), puoi fornire un keystore (contenente il certificato e la chiave) e la relativa password, che verranno utilizzati per firmare l'applicazione. Se non li fornisci, Defold genera un keystore di debug e lo utilizza per firmare il bundle dell'applicazione.
...
L'editor consente di creare facilmente un bundle autonomo del gioco. Prima di creare il bundle, puoi specificare le icone da utilizzare per l'applicazione, impostare il codice di versione e altri parametri nel [file delle impostazioni del progetto](/it/manuals/project-settings/#android) *game.project*.
...
![Firma del bundle Android](/manuals/images/android/sign_bundle.png)
...
![Firma del bundle Android](/manuals/images/android/sign_bundle2.png)
...
![File del pacchetto dell'applicazione Android](/manuals/images/android/apk_file.png)
...
{% include shared/it/android-adb.md %}
...
![Installazione e avvio dell'APK](/manuals/images/android/install_and_launch.png)

Per utilizzare questa funzionalità, devi avere *ADB* installato e *USB debugging* abilitato sul dispositivo collegato. Se l'editor non riesce a rilevare il percorso di installazione dello strumento a riga di comando ADB, devi specificarlo in [Preferences](/it/manuals/editor-preferences/#tools).
...
Le regole di conservazione di un'estensione vanno nella sua directory `manifests/android`, accanto a `build.gradle`. Consulta [Regole di conservazione R8 per le estensioni Android](/it/manuals/extensions/#r8-keep-rules-for-android) per sapere come aggiungere un file e conservare le classi Java dell'estensione.
...
Il motore Defold richiede diverse autorizzazioni affinché tutte le sue funzionalità possano operare. Le autorizzazioni sono definite in `AndroidManifest.xml`, specificato nel [file delle impostazioni del progetto](/it/manuals/project-settings/#android) *game.project*. Puoi approfondire le autorizzazioni Android nella [documentazione ufficiale](https://developer.android.com/guide/topics/permissions/overview). Il manifest predefinito richiede le seguenti autorizzazioni:
...
AndroidX rappresenta un importante miglioramento rispetto alla libreria Android Support Library originale, che non è più mantenuta. I pacchetti AndroidX sostituiscono completamente la Support Library, offrendo le stesse funzionalità e nuove librerie. La maggior parte delle estensioni Android nell'[Asset Portal](/assets) supporta AndroidX. Se non vuoi utilizzare AndroidX, puoi disabilitarlo esplicitamente a favore della vecchia Android Support Library selezionando `Use Android Support Lib` nel [manifest dell'applicazione](https://defold.com/it/manuals/app-manifest/).

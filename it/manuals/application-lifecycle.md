...
- anchor: preinitialization
  title: Preinizializzazione
- anchor: collection-init
  title: Inizializzazione della collezione
- anchor: post-update-in-initialization
  title: Aggiornamento finale durante linizializzazione
- anchor: update-loop
...
- anchor: render-update-phase
  title: Fase di aggiornamento del rendering
- anchor: post-update-phase
  title: Fase di aggiornamento finale
- anchor: render-phase
  title: Fase di rendering
- anchor: finalization
...
![Panoramica del ciclo di vita](/manuals/images/application_lifecycle/application_lifecycle.png)
...
![Inizializzazione](/manuals/images/application_lifecycle/initialization.png)
...
![Preinizializzazione](/manuals/images/application_lifecycle/pre_init.png)
...
![Inizializzazione della collezione](/manuals/images/application_lifecycle/collection_init.png)
...
![Aggiornamento finale](/manuals/images/application_lifecycle/post_init.png)
...
![Ciclo di aggiornamento](/manuals/images/application_lifecycle/update_loop.png)
...
![Fase di aggiornamento](/manuals/images/application_lifecycle/update_phase.png)
...
![Fase di aggiornamento del rendering](/manuals/images/application_lifecycle/render_update_phase.png)
...
![Fase di aggiornamento finale](/manuals/images/application_lifecycle/post_update_phase.png)
...
![Fase di rendering](/manuals/images/application_lifecycle/render_phase.png)

Viene quindi eseguito il rendering della grafica, incluso quello dell'eventuale profilatore visivo (consulta la [documentazione sul debug](/it/manuals/debugging)). Dopo il rendering della grafica viene effettuata l'acquisizione video.
...
(Consulta il [manuale dei proxy di collezione](/it/manuals/collection-proxy) e [`set_time_step`](/ref/collectionproxy#set-time-step) per maggiori dettagli)
...
![Finalizzazione](/manuals/images/application_lifecycle/finalization.png)
...
![Consegna dei messaggi](/manuals/images/application_lifecycle/dispatch_messages.png)
...
Poiché il codice di `on_message()` di qualsiasi componente destinatario può inviare ulteriori messaggi, il sistema di consegna dei messaggi continua a consegnare ricorsivamente i messaggi inviati finché la coda non è vuota. Esiste però un limite al numero di passaggi che il sistema di consegna esegue sulla coda dei messaggi. Consulta [Catene di messaggi](/it/manuals/message-passing) per maggiori dettagli.
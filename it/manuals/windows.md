...
- anchor: creating-ico-file-locally-using-imagemagick-software-suite
  title: Creazione di un file .ico in locale con la suite software ImageMagick.
- FAQ
---
...
La configurazione dell'applicazione specifica per Windows si effettua nella [sezione Windows](/it/manuals/project-settings/#windows) del file delle impostazioni *game.project*.

...
- anchor: gui-particlefx-nodes
  title: Nodi ParticleFX della GUI
- anchor: adding-particle-fx-nodes
  title: Aggiunta di nodi Particle FX
- anchor: controlling-the-effect
  title: Controllo delleffetto
---
...
![Effetti particellari](/manuals/images/gui-particlefx/create.png)
...
Consulta il [manuale degli effetti particellari](/it/manuals/particlefx) per informazioni dettagliate sul funzionamento degli effetti particellari.
...
- anchor: optimize-battery-usage
  title: Ottimizzare il consumo della batteria
- anchor: disable-accelerometer
  title: Disattivare laccelerometro
...
Consulta i manuali su come [ottimizzare le prestazioni durante l'esecuzione](/it/manuals/optimization-speed) di un gioco per scoprire come ridurre l'utilizzo della CPU e della GPU.

## Disattivare l'accelerometro {#disable-accelerometer}
Se stai creando un gioco per dispositivi mobili che non utilizza l'accelerometro del dispositivo, ti consigliamo di [disattivarlo in *game.project*](/it/manuals/project-settings/#use-accelerometer) per ridurre il numero di eventi di input generati.

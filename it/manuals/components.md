...
- anchor: enabling-and-disabling-components
  title: Abilitazione e disabilitazione dei componenti
- anchor: component-properties
  title: Proprietà dei componenti
- anchor: component-position-rotation-and-scale
  title: Posizione, rotazione e scala dei componenti
- anchor: component-draw-order
  title: Ordine di disegno dei componenti
- anchor: render-script-predicates
  title: Predicati dello script di rendering
- anchor: component-z-value
  title: Valore Z dei componenti
---

#  Componenti {#components}

{% include shared/it/components.md %}

## Tipi di componenti {#component-types}

Defold supporta i seguenti tipi di componenti:

* [Fabbrica di collezioni (collection factory)](/it/manuals/collection-factory) - Genera collezioni
* [Proxy di collezione (collection proxy)](/it/manuals/collection-proxy) - Carica e scarica collezioni
* [Oggetto di collisione](/it/manuals/physics) - Fisica 2D e 3D
* [Telecamera](/it/manuals/camera) - Modifica il viewport e la proiezione del mondo di gioco
* [Fabbrica (factory)](/it/manuals/factory) - Genera oggetti di gioco
* [GUI](/it/manuals/gui) - Esegue il rendering di un'interfaccia utente grafica
* [Etichetta](/it/manuals/label) - Esegue il rendering di un testo
* [Luce](/it/manuals/light) - Aggiunge dati di illuminazione per gli shader
* [Mesh](/it/manuals/mesh) Mostra una mesh 3D (con creazione e modifica a runtime)
* [Modello](/it/manuals/model) Mostra un modello 3D (con animazioni facoltative)
* [Effetti particellari (Particle FX)](/it/manuals/particlefx) -  Genera particelle
* [Script](/it/manuals/script) - Aggiunge la logica di gioco
* [Suono](/it/manuals/sound) - Riproduce suoni o musica
* [Sprite](/it/manuals/sprite) - Mostra un'immagine 2D (con animazione flipbook facoltativa)
* [Mappa di tessere (tilemap)](/it/manuals/tilemap) - Mostra una griglia di tessere
...
Ogni tipo di componente di Defold ha proprietà diverse. Il [pannello Properties](/it/manuals/editor/#the-editor-views) dell'editor mostra le proprietà del componente attualmente selezionato nel [pannello Outline](/it/manuals/editor/#the-editor-views). Consulta i manuali dei diversi tipi di componenti per maggiori informazioni sulle proprietà disponibili.

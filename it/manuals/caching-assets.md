...
Puoi svuotare manualmente la cache del progetto eliminando i file in `build/default` oppure eseguendo il comando `clean` dello [strumento di build a riga di comando Bob](/it/manuals/bob).

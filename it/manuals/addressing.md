...
- anchor: collections
  title: Collezioni
- anchor: relative-addressing
  title: Indirizzamento relativo
- anchor: shorthands
  title: Forme abbreviate
- anchor: game-object-paths
  title: Percorsi degli oggetti di gioco
- anchor: absolute-addressing
  title: Indirizzamento assoluto
- anchor: hashed-identifiers
  title: Identificatori hash
- anchor: urls
  title: URL
- anchor: constructing-url-objects
  title: Costruire oggetti URL
---
...
![bean nell'editor](/manuals/images/addressing/bean_editor.png)
...
![Personaggio bean](/manuals/images/addressing/bean.png)
...
![Personaggio bean](/manuals/images/addressing/bean_shield_editor.png)
...
![Personaggio bean](/manuals/images/addressing/bean_shield.png)
...
![Personaggio bean](/manuals/images/addressing/name_collision.png)
</div>
...
![Personaggio bean](/manuals/images/addressing/bean_buddy.png)
...
![Personaggio bean](/manuals/images/addressing/team_editor.png)
...
![Personaggio bean](/manuals/images/addressing/collection_team.png)
...
![Personaggio bean](/manuals/images/addressing/teams_editor.png)
...
![ID relativo](/manuals/images/addressing/relative_same.png)
...
{% include shared/it/url-shorthands.md %}
...
![Oggetto gestore](/manuals/images/addressing/manager_editor.png)
...
![Squadre e gestore](/manuals/images/addressing/teams_manager.png)

![Indirizzamento assoluto](/manuals/images/addressing/absolute.png)
...
socket
: Identifica il mondo di gioco della destinazione. È importante quando lavori con i [proxy di collezione](/it/manuals/collection-proxy) e in quel caso viene usato per identificare la _collezione caricata dinamicamente_.

...
- anchor: application-manifests
  title: Manifest delle applicazioni
- anchor: naming-and-structure
  title: Nomi e struttura
- Android
- anchor: example
  title: Esempio
- iOS / macOS
...
Consigliamo di utilizzare: `<uses-sdk android:targetSdkVersion="{% raw %}{{android.target_sdk_version}}{% endraw %}" />`
</div>
### Esempio {#example}

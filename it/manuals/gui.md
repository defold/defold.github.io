...
- anchor: creating-a-gui-component
  title: Creazione di un componente GUI
- anchor: gui-properties
  title: Proprietà della GUI
- anchor: runtime-manipulation
  title: Modifiche durante lesecuzione
- anchor: dependencies
  title: Dipendenze
- anchor: node-types
  title: Tipi di nodi
- anchor: node-properties
  title: Proprietà dei nodi
- anchor: pivot-anchors-and-adjust-mode
  title: Perno, ancoraggi e modalità di adattamento
- anchor: draw-order
  title: Ordine di disegno
- anchor: parent-child-hierarchies
  title: Gerarchie genitore-figlio
- anchor: layers-and-draw-calls
  title: Livelli e chiamate di disegno
---
...
![Nuovo file GUI](/manuals/images/gui/new_gui_file.png)

Defold apre automaticamente il file nell'editor di scene GUI.

![Nuova GUI](/manuals/images/gui/new_gui.png)

La vista *Outline* elenca tutti i contenuti della GUI: l'elenco dei nodi e le eventuali dipendenze (vedi sotto).

L'area di modifica centrale mostra la GUI. La barra degli strumenti nell'angolo superiore destro dell'area di modifica contiene gli strumenti *Move*, *Rotate* e *Scale*, oltre a un selettore di [layout](/it/manuals/gui-layouts).

![Barra degli strumenti](/manuals/images/gui/toolbar.png)
...
![Recupero e impostazione di un carattere](/manuals/images/gui/get_set_font.png)
...
![Recupero e impostazione di un materiale](/manuals/images/gui/get_set_material.png)
...
![Recupero e impostazione di una texture](/manuals/images/gui/get_set_texture.png)
...
![Dipendenze](/manuals/images/gui/dependencies.png)
...
Nodo Box
: ![Nodo Box](/manuals/images/icons/gui-box-node.png)
  Nodo rettangolare con un colore uniforme, una texture o un'animazione flipbook. Per i dettagli, consulta la [documentazione del nodo Box](/it/manuals/gui-box).

<div style="clear: both;"></div>

Nodo Text
: ![Nodo Text](/manuals/images/icons/gui-text-node.png)
  Visualizza del testo. Per i dettagli, consulta la [documentazione del nodo Text](/it/manuals/gui-text).

<div style="clear: both;"></div>

Nodo Pie
: ![Nodo Pie](/manuals/images/icons/gui-pie-node.png)
  Un nodo circolare o ellittico che può essere parzialmente riempito o invertito. Per i dettagli, consulta la [documentazione del nodo Pie](/it/manuals/gui-pie).

<div style="clear: both;"></div>

Nodo Template
: ![Nodo Template](/manuals/images/icons/gui.png)
  I modelli vengono utilizzati per creare istanze basate su altri file di scena GUI. Per i dettagli, consulta la [documentazione del nodo Template](/it/manuals/gui-template).

<div style="clear: both;"></div>

Nodo ParticleFX
: ![Nodo ParticleFX](/manuals/images/icons/particlefx.png)
  Riproduce un effetto particellare. Per i dettagli, consulta la [documentazione del nodo ParticleFX](/it/manuals/gui-particlefx).
...
![Aggiunta di nodi](/manuals/images/gui/add_node.png)
...
: Controllano la posizione, l'orientamento e la deformazione del nodo. Puoi usare gli strumenti *Move*, *Rotate* e *Scale* per modificare questi valori. I valori possono essere animati tramite script ([approfondisci](/it/manuals/property-animation)).

Size (nodi Box, Text e Pie)
: Le dimensioni del nodo sono automatiche per impostazione predefinita, ma puoi modificarne il valore impostando *Size Mode* su `Manual`. Le dimensioni definiscono i limiti del nodo e vengono usate per individuare il nodo interessato dall'input. Questo valore può essere animato tramite script ([approfondisci](/it/manuals/property-animation)).
...
Slice 9 (nodi Box)
: Impostala per mantenere le dimensioni in pixel della texture lungo i bordi quando il nodo viene ridimensionato. Per i dettagli, consulta la [documentazione del nodo Box](/it/manuals/gui-box).

Inner Radius (nodi Pie)
: Il raggio interno del nodo, espresso lungo l'asse X. Per i dettagli, consulta la [documentazione del nodo Pie](/it/manuals/gui-pie).

Outer Bounds (nodi Pie)
: Controlla il comportamento dei limiti esterni. Per i dettagli, consulta la [documentazione del nodo Pie](/it/manuals/gui-pie).

Perimeter Vertices (nodi Pie)
: Il numero di segmenti che verranno utilizzati per costruire la forma. Per i dettagli, consulta la [documentazione del nodo Pie](/it/manuals/gui-pie).

Pie Fill Angle (nodi Pie)
: La porzione del nodo Pie da riempire. Per i dettagli, consulta la [documentazione del nodo Pie](/it/manuals/gui-pie).

Template (nodi Template)
: Il file di scena GUI da utilizzare come modello per il nodo. Per i dettagli, consulta la [documentazione del nodo Template](/it/manuals/gui-template).

ParticleFX (nodi ParticleFX)
: L'effetto particellare da utilizzare su questo nodo. Per i dettagli, consulta la [documentazione del nodo ParticleFX](/it/manuals/gui-particlefx).

Color
: Il colore del nodo. Se il nodo ha una texture, il colore ne modifica la tinta. Il colore può essere animato tramite script ([approfondisci](/it/manuals/property-animation)).

Alpha
: La traslucenza del nodo. Il valore alfa può essere animato tramite script ([approfondisci](/it/manuals/property-animation)).
...
: Imposta il punto di perno del nodo. Puoi considerarlo il "punto centrale" del nodo. Ogni rotazione, ridimensionamento o modifica delle dimensioni avviene attorno a questo punto.
  ...
  ![Punto di perno](/manuals/images/gui/pivot.png)
...
: L'ancoraggio controlla come cambia la posizione verticale e orizzontale del nodo quando i limiti della scena, o quelli del nodo genitore, vengono estesi per adattarsi alle dimensioni fisiche dello schermo.
  ...
  ![Ancoraggio senza adattamento](/manuals/images/gui/anchoring_unadjusted.png)
  ...
  ![Ancoraggio](/manuals/images/gui/anchoring.png)
...
: Imposta la modalità di adattamento del nodo. Questa impostazione controlla cosa succede al nodo quando i limiti della scena, o quelli del nodo genitore, vengono adattati alle dimensioni fisiche dello schermo.
  ...
  ![Senza adattamento](/manuals/images/gui/unadjusted.png)
  ...
  ![Modalità di adattamento](/manuals/images/gui/adjusted.png)
...
: Imposta la modalità di ritaglio del nodo:
  ...
  Per i dettagli, consulta il [manuale sul ritaglio delle GUI](/it/manuals/gui-clipping).

Clipping Visible (nodi Box e Pie)
: Attivala per visualizzare il contenuto del nodo nell'area dello stencil. Per i dettagli, consulta il [manuale sul ritaglio delle GUI](/it/manuals/gui-clipping).

Clipping Inverted (nodi Box e Pie)
: Inverte la maschera stencil. Per i dettagli, consulta il [manuale sul ritaglio delle GUI](/it/manuals/gui-clipping).
...
![Ordine di disegno](/manuals/images/gui/draw_order.png)
...
![Genitore e figlio](/manuals/images/gui/parent_child.png)
...
![Gerarchia che interrompe il batch](/manuals/images/gui/break_batch.png)
...
![Livelli](/manuals/images/gui/layers.png)

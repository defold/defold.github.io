...
Un componente di collisione può usare più forme primitive oppure una singola forma complessa. Per saperne di più sulle varie forme e su come aggiungerle a un componente di collisione, consulta il [manuale delle forme di collisione](/it/manuals/physics-shapes).
...
Collision Shape
: Questa proprietà viene usata per la geometria delle mappe di tile o per le forme convesse che non usano forme primitive. Per ulteriori informazioni, consulta il [manuale delle forme di collisione](/it/manuals/physics-shapes).

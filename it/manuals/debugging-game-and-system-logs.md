...
- anchor: game-and-system-log
  title: Log di gioco e di sistema
- anchor: reading-the-game-log-from-the-editor
  title: Leggere il log di gioco dalleditor
- anchor: reading-the-game-log-from-the-terminal
  title: Leggere il log di gioco dal terminale
- anchor: reading-game-and-system-logs-using-platform-specific-tools
  title: Leggere i log di gioco e di sistema con strumenti specifici della piattaforma
- HTML5
- Android
- iOS
- anchor: reading-the-game-log-from-the-log-file
  title: Leggere il log di gioco dal file di log
---
...
Quando esegui il gioco localmente dall'editor o tramite una connessione all'[app di sviluppo per dispositivi mobili](/it/manuals/dev-app), tutto l'output viene mostrato nel pannello della console dell'editor:
...
: Collega il dispositivo a un computer con macOS e Xcode installati.
  ...
  ![Scaricare il container](/manuals/images/debugging/download_container.png)

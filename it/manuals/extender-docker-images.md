...
- anchor: how-to-use-old-docker-images
  title: Come utilizzare le immagini Docker precedenti
---
...
3. Esegui Extender in locale come descritto in [Come eseguire Extender in locale con artefatti preconfigurati](/it/manuals/extender-local-setup#how-to-run-local-extender-with-preconfigured-artifacts).
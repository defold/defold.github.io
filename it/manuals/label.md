...
- anchor: creating-a-label
  title: Creare unetichetta
- anchor: label-properties
  title: Proprietà delle etichette
- anchor: blend-modes
  title: Modalità di fusione
- anchor: pivot-and-alignment
  title: Punto di ancoraggio e allineamento
...
![Aggiungere un'etichetta](/manuals/images/label/add_label.png)
...
![Nuova etichetta](/manuals/images/label/label.png)
...
![Font e materiale](/manuals/images/label/font_material.png)
...
![Allineamento del testo](/manuals/images/label/align.png)
...
Il file *game.project* contiene alcune [impostazioni del progetto](/it/manuals/project-settings#label) relative alle etichette.
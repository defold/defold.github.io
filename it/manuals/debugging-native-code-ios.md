...
toc:
- anchor: debugging-on-iosmacos
  title: Debug su iOS/macOS
- Xcode
- anchor: create-project
  title: Creare il progetto
- anchor: launch-the-debugger
  title: Avviare il debugger
- anchor: debug-symbols
  title: Simboli di debug
- anchor: path-mappings
  title: Mappatura dei percorsi
- anchor: breakpoints
  title: Punti di interruzione
- anchor: notes
  title: Note
- anchor: check-uuid-of-binary
  title: Verificare lUUID del file binario
---
...
* Crea il bundle dell'app con Bob, usando l'opzione `--with-symbols` ([maggiori informazioni](/it/manuals/debugging-native-code/#symbolicate-a-callstack)):
...
* Procurati la cartella `.dSYM` (cioè i simboli di debug)
	...
	* Se usi un'estensione nativa, la cartella `.dSYM` viene generata quando crei una build con [bob.jar](https://www.defold.com/it/manuals/bob/). È sufficiente creare la build (senza archiviarla né creare un bundle):
...
* Crea un nuovo progetto Xcode e scegli il modello `Game`
	...
	![Modello del progetto](/manuals/images/extensions/debugging/ios/project_template.png)
...
* Aggiungi il tuo codice all'app
	...
	![Aggiunta di file](/manuals/images/extensions/debugging/ios/add_files.png)

* Assicurati che "Copy items if needed" sia deselezionato.

	![Aggiunta del codice sorgente](/manuals/images/extensions/debugging/ios/add_source.png)

* Questo è il risultato finale

	![Codice sorgente aggiunto](/manuals/images/extensions/debugging/ios/added_source.png)


* Disabilita il passaggio `Build`

	![Modifica dello schema](/manuals/images/extensions/debugging/ios/edit_scheme.png)

	![Disabilitazione della build](/manuals/images/extensions/debugging/ios/disable_build.png)

* Imposta la versione di `Deployment target` in modo che sia superiore alla versione di iOS del tuo dispositivo

	![Versione di distribuzione](/manuals/images/extensions/debugging/ios/deployment_version.png)

* Seleziona il dispositivo di destinazione

	![Selezione del dispositivo](/manuals/images/extensions/debugging/ios/select_device.png)
...
2. Oppure scegliere `Attach to process by PID or Process name`
	...
	![Selezione del dispositivo](/manuals/images/extensions/debugging/ios/attach_to_process_name.png)
...
```
	...
	![Aggiunta di dSYM](/manuals/images/extensions/debugging/ios/add_dsym.png)
...
* Apri un file nella vista del progetto e imposta un punto di interruzione
	...
	![Punto di interruzione](/manuals/images/extensions/debugging/ios/breakpoint.png)

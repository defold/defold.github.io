...
- anchor: receiving-messages
  title: Ricezione di messaggi
- anchor: messaging-between-game-worlds
  title: Scambio di messaggi tra mondi di gioco
- anchor: message-chains
  title: Catene di messaggi
---

# Scambio di messaggi {#message-passing}

Lo scambio di messaggi è un meccanismo che consente agli oggetti di gioco (game object) di Defold di comunicare tra loro. Questo manuale presuppone una conoscenza di base del [meccanismo di indirizzamento](/it/manuals/addressing) e degli [elementi fondamentali](/it/manuals/building-blocks) di Defold.
...
![Struttura dello scambio di messaggi](/manuals/images/message_passing/message_passing_structure.png)
...
![Scambio di messaggi](/manuals/images/message_passing/message_passing.png)
...
![Nome della collezione](/manuals/images/message_passing/collection_name.png)
...
```
Una descrizione più approfondita del funzionamento dei proxy si trova nella documentazione dei [proxy di collezione](/it/manuals/collection-proxy).

...
- anchor: optimizing-memory-usage
  title: Ottimizzare luso della memoria
- anchor: texture-compression
  title: Compressione delle texture
- anchor: dynamic-loading
  title: Caricamento dinamico
- anchor: optimize-component-counters
  title: Ottimizzare i contatori dei componenti
- anchor: optimize-gui-node-count
  title: Ottimizzare il numero di nodi GUI
---
...
* [Proxy di collezione](/it/manuals/collection-proxy/)
* [Fabbriche di collezioni dinamiche (collection factory)](/it/manuals/collection-factory/#dynamic-loading-of-factory-resources)
* [Fabbriche dinamiche (factory)](/it/manuals/factory/#dynamic-loading-of-factory-resources)
* [Live Update](/it/manuals/live-update/)

## Ottimizzare i contatori dei componenti {#optimize-component-counters}
Per ridurre la frammentazione della memoria, Defold alloca una sola volta la memoria per componenti e risorse quando viene creata una collezione. La quantità di memoria allocata dipende dalla configurazione dei vari contatori dei componenti in *game.project*. Usa il [profilatore](/it/manuals/profiling/) per misurare con precisione l'uso di componenti e risorse e configura il gioco con valori massimi più vicini al numero effettivo di componenti e risorse. In questo modo ridurrai la quantità di memoria usata dal gioco (consulta le informazioni sull'[ottimizzazione del numero massimo di componenti](/it/manuals/project-settings/#component-max-count-optimizations)).

## Ottimizzare il numero di nodi GUI {#optimize-gui-node-count}
Ottimizza il numero di nodi GUI impostando nel file GUI un numero massimo di nodi limitato a quelli necessari. Il campo `Current Nodes` nelle [proprietà del componente GUI](https://defold.com/it/manuals/gui/#gui-properties) mostra il numero di nodi usati dal componente GUI.

{% include shared/it/optimization-memory-html5.md %}
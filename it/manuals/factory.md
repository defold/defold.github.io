...
- anchor: factory-components
  title: Componenti fabbrica
- anchor: addressing-of-factory-created-objects
  title: Indirizzamento degli oggetti creati da una fabbrica
- anchor: tracking-spawned-and-parent-objects
  title: Tenere traccia degli oggetti generati e dei loro genitori
- anchor: dynamic-loading-of-factory-resources
  title: Caricamento dinamico delle risorse della fabbrica
- anchor: dynamic-prototype
  title: Prototipo dinamico
- anchor: instance-limits
  title: Limiti delle istanze
- anchor: pooling-of-game-objects
  title: Riutilizzo degli oggetti di gioco tramite pool
---
...
![Componente fabbrica](/manuals/images/factory/factory_collection.png)

![Componente fabbrica](/manuals/images/factory/factory_component.png)
...
![Oggetto di gioco generato](/manuals/images/factory/factory_spawned.png)
...
`[properties]`
: (facoltativo) Una tabella Lua con gli eventuali valori delle proprietà dello script con cui inizializzare l'oggetto di gioco. Consulta il [manuale delle proprietà degli script](/it/manuals/script-properties) per informazioni sulle proprietà degli script.
...
![Oggetto di gioco generato con proprietà e ridimensionamento](/manuals/images/factory/factory_spawned2.png)
...
![Caricamento dinamico](/manuals/images/factory/load_dynamically.png)
...
![Prototipo dinamico](/manuals/images/factory/dynamic_prototype.png)
...
![Numero massimo di istanze](/manuals/images/factory/factory_max_instances.png)

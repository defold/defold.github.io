...
- anchor: sprites
  title: Sprite
- anchor: sprite-properties
  title: Proprietà dello sprite
- anchor: blend-modes
...
Il componente sprite può usare un [atlas](/it/manuals/atlas) o una [sorgente di tile (Tile Source)](/it/manuals/tilesource) per la propria grafica.
...
{% include shared/it/material-constants.md component='sprite' variable='tint' %}
...
Uno sprite può sovrascrivere gli attributi dei vertici del materiale attualmente assegnato, che il componente passa al vertex shader (consulta il [manuale sui materiali per maggiori dettagli](/it/manuals/material/#attributes)).
...
![Attributi dello sprite](/manuals/images/graphics/sprite-attributes.png)

## Configurazione del progetto {#project-configuration}

Il file *game.project* contiene alcune [impostazioni del progetto](/it/manuals/project-settings#sprite) relative agli sprite.
...
Per rinominarli usiamo quindi `Rename patterns` nell'[atlas](/it/manuals/material/).

...
![Modello in Blender](/manuals/images/model/blender_gltf.png)
...
![Asset del modello importati](/manuals/images/model/assets_gltf.png)
...
Dopo aver importato il modello, usalo in un [componente modello](/it/manuals/model):
...
2. Imposta la proprietà *Mesh* sul file *.gltf* o *.glb* importato che contiene la mesh.
3. Per un modello animato, imposta la proprietà *Skeleton* sul file *.gltf* o *.glb* che contiene lo scheletro. Spesso è lo stesso file usato per *Mesh* quando mesh, scheletro e animazioni vengono esportati insieme.
...
![Selezione di tutti i vertici](/manuals/images/model/blender_select_all_vertices.png)

Quando tutti i vertici sono selezionati, distendi la mesh per ottenere il layout UV:

![Distensione della mesh](/manuals/images/model/blender_unwrap_mesh.png)

Puoi quindi esportare il layout UV in un'immagine da usare come texture:

![Esportazione del layout UV](/manuals/images/model/blender_export_uv_layout.png)

![Risultato dell'esportazione del layout UV](/manuals/images/model/blender_export_uv_layout_result.png)
...
![Esportazione con Blender](/manuals/images/model/export_gltf.png)
...
![Esportazione con Blender](/manuals/images/model/export_settings.png)
...
- anchor: hot-reloading-resources
  title: Hot reload delle risorse
- anchor: how-to-hot-reload
  title: Come eseguire lhot reload
- anchor: hot-reloading-on-device
  title: Hot reload su dispositivo
- anchor: reloading-scripts
  title: Ricaricamento degli script
- anchor: reloading-lua-modules
  title: Ricaricamento dei moduli Lua
- anchor: the-on_reload-function
  title: La funzione on_reload()
- anchor: reloading-shader-code
  title: Ricaricamento del codice degli shader
---
...
![Ricaricamento delle risorse](/manuals/images/hot-reload/menu.png)

## Hot reload su dispositivo {#hot-reloading-on-device}

L'hot reload funziona sia sui dispositivi mobili sia su desktop. Per usarlo su un dispositivo mobile, esegui una build di debug del gioco o l'[app di sviluppo](/it/manuals/dev-app) sul dispositivo, quindi selezionalo come destinazione nell'editor:

![Dispositivo di destinazione](/manuals/images/hot-reload/target.png)
...
![Ricaricamento della GUI](/manuals/images/hot-reload/gui.png)
...
![GUI ricaricata](/manuals/images/hot-reload/gui-reloaded.png)
...
Modificare e ricaricare `my_module.lua` _non_ cambia il comportamento di `user.script`. Consulta [il manuale sui moduli](/it/manuals/modules) per scoprire il motivo e come evitare questo problema.

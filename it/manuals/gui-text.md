...
toc:
- anchor: gui-text-nodes
  title: Nodi di testo GUI
- anchor: adding-text-nodes
  title: Aggiungere nodi di testo
- anchor: alignment
  title: Allineamento
- anchor: modifying-text-nodes-in-runtime
  title: Modificare i nodi di testo a runtime
---
...
L'anteprima dell'editor supporta la composizione dei glifi e il layout da destra a sinistra usando il renderer dei font del motore. Consulta [Supporto per il layout del testo](/it/manuals/font/#text-layout-support-eg-right-to-left) per le impostazioni richieste dei font e dell'App Manifest.
...
![Font](/manuals/images/gui-text/fonts.png)
...
![Allineamento del testo](/manuals/images/gui-text/align.png)

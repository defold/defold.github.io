...
- anchor: texture-filtering-and-sampling
  title: Filtraggio e campionamento delle texture
---
...
Il filtraggio da utilizzare è specificato nel file delle [impostazioni del progetto](/it/manuals/project-settings/#graphics). Sono presenti due impostazioni:
...
L'impostazione in *game.project* viene utilizzata dai campionatori predefiniti. Se specifichi dei campionatori in un materiale personalizzato, puoi impostare il metodo di filtraggio per ciascun campionatore. Consulta il [manuale dei materiali](/it/manuals/material/) per maggiori dettagli.
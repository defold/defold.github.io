...
- anchor: ios-development
  title: Sviluppo per iOS
- anchor: apples-code-signing-process
  title: Il processo di firma del codice di Apple
- anchor: developing-using-a-free-apple-developer-account
  title: Sviluppare con un account sviluppatore Apple gratuito
- anchor: creating-an-ios-application-bundle
  title: Creare un bundle di applicazione iOS
- anchor: custom-infoplist-and-local-target-discovery
  title: Info.plist personalizzato e rilevamento delle destinazioni locali
- anchor: installing-and-launching-bundle-on-a-connected-iphone
  title: Installare e avviare un bundle su un iPhone collegato
- anchor: creating-a-storyboard
  title: Creare uno storyboard
- anchor: creating-an-icon-asset-catalog
  title: Creare un catalogo di asset per le icone
- anchor: installing-an-ios-application-bundle
  title: Installare un bundle di applicazione iOS
- anchor: export-compliance-information
  title: Informazioni sulla conformità alle norme di esportazione
- FAQ
---
...
iOS richiede che _qualsiasi_ applicazione di cui crei una build e che vuoi eseguire sul tuo telefono o tablet _debba_ essere firmata con un certificato e un profilo di provisioning rilasciati da Apple. Questo manuale spiega i passaggi necessari per creare un bundle del tuo gioco per iOS. Durante lo sviluppo, spesso è preferibile eseguire il gioco tramite l'[applicazione di sviluppo](/it/manuals/dev-app), perché consente di ricaricare a caldo contenuti e codice direttamente sul dispositivo.
...
: Puoi trovare l'UDID di un dispositivo iOS collegandolo a un computer tramite Wi-Fi o cavo. Apri Xcode e seleziona <kbd>Window ▸ Devices and Simulators</kbd>. Quando selezioni il dispositivo, vengono visualizzati il numero di serie e l'identificatore.
  ...
  ![Dispositivi in Xcode](/manuals/images/ios/xcode_devices.png)
  ...
  ![Dispositivi in iTunes](/manuals/images/ios/itunes_devices.png)
...
![Firma del bundle iOS](/manuals/images/ios/sign_bundle.png)
...
![Bundle di applicazione iOS ipa](/manuals/images/ios/ipa_file.png)

Specifica l'icona da usare per l'applicazione, lo storyboard della schermata di avvio e altre opzioni nel file delle impostazioni del progetto *game.project*, nella [sezione iOS](/it/manuals/project-settings/#ios).
...
{% include shared/it/build-variants.md %}
...
![Installazione e avvio del bundle iOS](/manuals/images/ios/install_and_launch.png)
...
Se l'editor non riesce a rilevare il percorso di installazione dello strumento ios-deploy, dovrai specificarlo in [Preferences](/it/manuals/editor-preferences/#tools). 
...
![Creazione del progetto](/manuals/images/ios/xcode_create_project.png)

Fai clic su Next e procedi alla configurazione del progetto. Inserisci un Product Name:

![Impostazioni del progetto](/manuals/images/ios/xcode_storyboard_create_project_settings.png)
...
![Vista del progetto](/manuals/images/ios/xcode_storyboard_project_view.png)
...
![Aggiunta di un'immagine](/manuals/images/ios/xcode_storyboard_add_image.png)
...
![Aggiunta di una vista immagine](/manuals/images/ios/xcode_storyboard_add_imageview.png)

Trascina il componente Image View sullo storyboard:

![Aggiunta allo storyboard](/manuals/images/ios/xcode_storyboard_add_imageview_to_storyboard.png)
...
![Impostazioni del progetto](/manuals/images/ios/xcode_icons_create_project_settings.png)
...
![Vista del progetto](/manuals/images/ios/xcode_icons_project_view.png)

Trascina e rilascia le immagini nei riquadri vuoti che rappresentano le diverse dimensioni di icona supportate:

![Aggiunta delle icone](/manuals/images/ios/xcode_icons_add_icons.png)
...
![Build del progetto](/manuals/images/ios/xcode_icons_build.png)
...
![Aggiunta dell'icona e del catalogo di asset a game.project](/manuals/images/ios/defold_icons_game_project.png)
...
{% include shared/it/apple-privacy-manifest.md %}
...
Se ritieni che il tuo progetto sia esente, imposta la chiave [`ITSAppUsesNonExemptEncryption`](https://developer.apple.com/documentation/bundleresources/information-property-list/itsappusesnonexemptencryption) su `False` nel file `Info.plist` del progetto; consulta [Manifesti delle applicazioni](/it/manuals/extensions-manifest-merge-tool) per ulteriori dettagli.

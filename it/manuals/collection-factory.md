...
- anchor: collection-factories
  title: Fabbriche di collezioni
- anchor: spawning-a-collection
  title: Generare una collezione
- anchor: properties
  title: Proprietà
...
Le collezioni offrono un potente meccanismo per creare modelli riutilizzabili, o "prefab", in Defold. Per una panoramica delle collezioni, consulta la [documentazione sugli elementi costitutivi](/it/manuals/building-blocks#collections). Le collezioni possono essere posizionate nell'editor oppure inserite dinamicamente nel gioco.
...
![Fabbrica di collezioni](/manuals/images/collection_factory/factory.png)
...
Questo presuppone che l'oggetto di gioco `bean` in `bean.collection` definisca la proprietà `shield`. [Il manuale delle proprietà degli script](/it/manuals/script-properties) contiene informazioni sulle proprietà degli script.
...
![Caricamento dinamico](/manuals/images/collection_factory/load_dynamically.png)
...
![Prototipo dinamico](/manuals/images/collection_factory/dynamic_prototype.png)

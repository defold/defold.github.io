...
- anchor: functions-for-file-and-folder-access
  title: Funzioni per laccesso a file e cartelle
- anchor: file-and-folder-locations
  title: Posizioni di file e cartelle
- anchor: how-to-save-and-load-application-specific-files
  title: Come salvare e caricare file specifici dellapplicazione
- anchor: how-to-access-files-bundled-with-the-application
  title: Come accedere ai file inclusi nel bundle dellapplicazione
- anchor: system-file-access
  title: Accesso ai file di sistema
- anchor: extensions
  title: Estensioni
---
...
Anche le estensioni possono fornire questi file tramite `ext.properties`. I loro percorsi vengono combinati con le risorse personalizzate del progetto sia nelle build dell'editor sia negli archivi di Bob. Consulta [Risorse personalizzate delle estensioni](/it/manuals/extensions/#custom-resources).

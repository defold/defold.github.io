...
- anchor: offline-or-runtime-fonts
  title: Font offline o a runtime
- anchor: text-layout-support-eg-right-to-left
  title: Supporto per il layout del testo (ad esempio da destra a sinistra)
- anchor: font-collection
  title: Collezione di font
- anchor: creating-a-font
  title: Creare un font
- anchor: properties
  title: Proprietà
- anchor: distance-field-fonts
  title: Font a campo di distanza
- anchor: bitmap-bmfonts
  title: Font bitmap BMFont
- anchor: artifacts-and-best-practices
  title: Artefatti e buone pratiche
- anchor: font-cache
  title: Cache del font
- anchor: enabling-runtime-fonts
  title: Abilitare i font a runtime
- anchor: font-scripting
  title: Usare i font negli script
- anchor: addingremoving-fonts-to-a-font-collection
  title: Aggiungere e rimuovere font da una collezione di font
- anchor: prewarming-glyphs
  title: Precaricare i glifi
---
...
Per informazioni su come applicare stili a singole porzioni di testo e usare link e sprite in linea, consulta il [manuale del markup del testo formattato](/it/manuals/font-richtext).
...
Consulta [Abilitare i font a runtime](/it/manuals/font#enabling-runtime-fonts)
...
![Font a campo di distanza](/manuals/images/font/df_font.png)
...
![Font ingranditi](/manuals/images/font/scale_up.png)
...
![Font ridotti](/manuals/images/font/scale_down.png)
...
![Artefatti del campo di distanza](/manuals/images/font/df_artifacts.png)
...
Per ulteriori informazioni sulle variabili uniform degli shader, consulta il [manuale degli shader](/it/manuals/shader).
...
* Aggiungi un [manifesto dell'applicazione](/it/manuals/app-manifest) e abilita l'opzione `Use full text layout system`.

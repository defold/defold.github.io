...
- anchor: creating-display-profiles
  title: Creazione dei profili di visualizzazione
- anchor: auto-layout-selection-display-profiles
  title: Selezione automatica del layout (Display Profiles)
- anchor: gui-layouts
  title: Layout GUI
- anchor: dynamic-profile-selection
  title: Selezione dinamica del profilo
- anchor: layout-change-messages
  title: Messaggi di cambio del layout
- anchor: manual-layout-selection-lua
  title: Selezione manuale del layout (Lua)
...
![Nuovi profili di visualizzazione](/manuals/images/gui-layouts/new_profiles.png)
...
![Impostazioni](/manuals/images/gui-layouts/settings.png)
...
![Aggiunta di un layout alla scena](/manuals/images/gui-layouts/add_layout.png)
...
![Barra degli strumenti dei layout](/manuals/images/gui-layouts/toolbar.png)

![Modifica del layout verticale](/manuals/images/gui-layouts/portrait.png)
...
![Modifica del layout orizzontale](/manuals/images/gui-layouts/landscape.png)

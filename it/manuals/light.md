...
toc:
- anchor: light-component
  title: Componente luce
- anchor: light-properties
  title: Proprietà delle luci
- anchor: ambient-light
  title: Luce ambientale
- anchor: directional-light
  title: Luce direzionale
- anchor: point-light
  title: Luce puntiforme
- anchor: spot-light
  title: Luce a faretto
- anchor: validation
  title: Validazione
- anchor: project-limit
  title: Limite del progetto
- anchor: light-buffer-in-shaders
  title: Buffer delle luci negli shader
- anchor: built-in-lighting-helper
  title: Funzioni di illuminazione integrate
- anchor: see-also
  title: Vedi anche
---
...
![Scena senza luci](/manuals/images/light/no_light.png)
...
![Luce ambientale con intensità inferiore](/manuals/images/light/ambient_light_less_intensity.png)
...
![Luce ambientale con intensità superiore](/manuals/images/light/ambient_light_full_intensity.png)
...
![Luce direzionale](/manuals/images/light/directional_light.png)
...
![Luce direzionale e ambientale](/manuals/images/light/directional_and_ambient_light.png)
...
![Luce puntiforme](/manuals/images/light/point_light.png)
...
![Portata della luce puntiforme](/manuals/images/light/point_light_range.png)
...
![Portata della luce puntiforme di colore verde](/manuals/images/light/point_ight_range_green_color.png)
...
![Luce a faretto](/manuals/images/light/spot_light.png)
...
![Indicatori della luce a faretto](/manuals/images/light/spot_light_gizmos.png)
...
![Shader con buffer delle luci](/manuals/images/light/light-buffer-shader.png)
...
- [Manuale degli shader](/it/manuals/shader)
- [Manuale dei materiali](/it/manuals/material)
- [Manuale del rendering](/it/manuals/render)
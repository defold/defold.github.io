...
toc:
- anchor: particle-fx
  title: Effetti particellari
- anchor: creating-an-effect
  title: Creare un effetto
- anchor: previewing-an-effect
  title: Visualizzare lanteprima di un effetto
- anchor: emitter-properties
  title: Proprietà dellemettitore
- anchor: blend-modes
  title: Modalità di fusione
- anchor: keyable-emitter-properties
  title: Proprietà dellemettitore animabili tramite curve
- anchor: modifiers
  title: Modificatori
- anchor: modifier-properties
  title: Proprietà dei modificatori
- anchor: controlling-a-particle-effect
  title: Controllare un effetto particellare
- anchor: material-constants
  title: Costanti del materiale
...
![Editor degli effetti particellari](/manuals/images/particlefx/editor.png)
...
Seleziona <kbd>New... ▸ Particle FX</kbd> dal menu contestuale nel pannello *Assets*. Assegna un nome al nuovo file dell'effetto particellare. L'editor aprirà il file nell'[editor di scena](/it/manuals/editor/#the-scene-editor).
...
![Particelle predefinite](/manuals/images/particlefx/default.png)
...
![Aggiungere un modificatore](/manuals/images/particlefx/add_modifier.png)

![Selezionare il modificatore da aggiungere](/manuals/images/particlefx/add_modifier_select.png)
...
![Modificare le particelle](/manuals/images/particlefx/rotate.gif)
...
: La forma dell'emettitore
  ...
  ![Tipi di emettitore](/manuals/images/particlefx/emitter_types.png)
...
{% include shared/it/blend-modes.md %}
...
![Proprietà](/manuals/images/particlefx/property.png)
...
![Proprietà controllata da una curva](/manuals/images/particlefx/key.png)
...
![Editor delle curve degli effetti particellari](/manuals/images/particlefx/curve_editor.png)
...
: Fa muovere le particelle in direzione circolare o a spirale attorno alla propria posizione.
  ...
  ![Modificatori](/manuals/images/particlefx/modifiers.png)
...
Per avviare e arrestare un effetto particellare da uno script GUI, consulta il [manuale degli effetti particellari nella GUI](/it/manuals/gui-particlefx#controlling-the-effect) per maggiori informazioni.
...
Il materiale predefinito degli effetti particellari dispone delle seguenti costanti, che possono essere modificate con `particlefx.set_constant()` e ripristinate con `particlefx.reset_constant()` (consulta il [manuale dei materiali per maggiori dettagli](/it/manuals/material/#vertex-and-fragment-constants)):
...
Il file *game.project* contiene alcune [impostazioni del progetto](/it/manuals/project-settings#particle-fx) relative alle particelle.
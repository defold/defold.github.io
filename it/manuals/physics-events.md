...
- anchor: defold-physics-event-handling
  title: Gestione degli eventi fisici in Defold
- anchor: setting-the-physics-world-listener
  title: Impostazione della funzione di ascolto del mondo fisico
- anchor: event-data-structure
  title: Struttura dei dati degli eventi
...
Se imposti una funzione di ascolto, i [messaggi fisici](/it/manuals/physics-messages) non verranno più inviati per il mondo fisico in cui è impostata.
</div>

...
- anchor: texture-profiles
  title: Profili delle texture
- Basis Universal
- ASTC
- anchor: texture-profiles
  title: Profili delle texture
- anchor: path-settings
  title: Impostazioni dei percorsi
- anchor: profiles
  title: Profili
- anchor: texture-formats
  title: Formati delle texture
- anchor: compressors
  title: Compressori
- anchor: example-image
  title: Immagine di esempio
- anchor: compression-times
  title: Tempi di compressione
- anchor: signal-loss
  title: Perdita di segnale
- anchor: compression-file-sizes
  title: Dimensioni dei file compressi
...
![Nuovo file di profili](/manuals/images/texture_profiles/texture_profiles_new_file.png)

![Impostazione del profilo delle texture](/manuals/images/texture_profiles/texture_profiles_game_project.png)
...
![Preferenze dei profili delle texture](/manuals/images/texture_profiles/texture_profiles_preferences.png)
...
![Percorsi](/manuals/images/texture_profiles/texture_profiles_paths.png)
...
![Profili](/manuals/images/texture_profiles/texture_profiles_profiles.png)
...
![Nuovo file di profili](/manuals/images/texture_profiles/kodim03_pow2.png)
...
`LOW`
![preimpostazione di compressione bassa](/manuals/images/texture_profiles/kodim03_pow2.fast.png)

`MEDIUM`
![preimpostazione di compressione media](/manuals/images/texture_profiles/kodim03_pow2.normal.png)

`HIGH`
![preimpostazione di compressione alta](/manuals/images/texture_profiles/kodim03_pow2.high.png)

`HIGHEST`
![preimpostazione di compressione migliore](/manuals/images/texture_profiles/kodim03_pow2.best.png)
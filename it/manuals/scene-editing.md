...
- anchor: the-defold-scene-editor
  title: Leditor di scena di Defold
- anchor: opening-the-scene-editor
  title: Aprire leditor di scena
- anchor: remembered-scene-views
  title: Viste delle scene memorizzate
- anchor: scene-view-navigation-camera-controls
  title: Navigazione nella vista della scena (controlli della telecamera)
- anchor: standard-navigation-all-visual-editors
  title: Navigazione standard (tutti gli editor visivi)
- anchor: 2d-and-3d-scene-orientation
  title: Orientamento della scena in 2D e 3D
- anchor: toolbar-overview
  title: Panoramica della barra degli strumenti
- anchor: manipulating-objects
  title: Selezionare e manipolare gli oggetti
- anchor: selecting-objects
  title: Selezionare gli oggetti
- anchor: visibility-filters
  title: Filtri di visibilità
- anchor: grid-settings
  title: Impostazioni della griglia
- anchor: camera-type-perspective-vs-orthographic
  title: 'Tipo di telecamera: prospettica e ortografica'
- anchor: free-camera-mode
  title: Modalità telecamera libera
- anchor: activating-free-camera-mode
  title: Attivare la modalità telecamera libera
- anchor: exiting-free-camera-mode
  title: Uscire dalla modalità telecamera libera
- anchor: looking-around-mouse-look
  title: Guardarsi intorno (visuale con il mouse)
- anchor: moving
  title: Spostarsi
- anchor: walking-mode-optional
  title: Modalità camminata (facoltativa)
- anchor: camera-settings-popup
  title: Popup delle impostazioni della telecamera
---
...
![Editor di scena in 3D](/manuals/images/editor/3d_scene.png)
...
![Barra degli strumenti](/manuals/images/editor/toolbar.png)
...
![Strumento di spostamento](/manuals/images/editor/icon_move.png)
...
![Spostamento di un oggetto](/manuals/images/editor/move.png)![Spostamento di un oggetto in 3D](/manuals/images/editor/move_3d.png)
...
![Strumento di rotazione](/manuals/images/editor/icon_rotate.png)
...
![Rotazione di un oggetto](/manuals/images/editor/rotate.png)![Rotazione di un oggetto in 3D](/manuals/images/editor/rotate_3d.png)
...
![Strumento di ridimensionamento](/manuals/images/editor/icon_scale.png)
...
![Ridimensionamento di un oggetto](/manuals/images/editor/scale.png)![Ridimensionamento di un oggetto in 3D](/manuals/images/editor/scale_3d.png)
...
![Filtri di visibilità](/manuals/images/editor/visibilityfilters.png)
...
![Impostazioni della griglia](/manuals/images/editor/grid_popup.png)
...
![Impostazioni della telecamera prospettica](/manuals/images/editor/camera_popup.png)

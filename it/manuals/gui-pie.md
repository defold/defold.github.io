...
toc:
- anchor: gui-pie-nodes
  title: Nodi GUI a settore circolare
- anchor: creating-a-pie-node
  title: Creazione di un nodo a settore circolare
- anchor: modify-pie-nodes-at-runtime
  title: Modifica dei nodi a settore circolare durante lesecuzione
---
...
![Creazione di un nodo a settore circolare](/manuals/images/gui-pie/create.png)
...
![Proprietà](/manuals/images/gui-pie/properties.png)

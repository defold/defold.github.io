...
- anchor: editor-overview
  title: Panoramica delleditor
- anchor: starting-the-editor
  title: Avvio delleditor
- anchor: editor-language
  title: Lingua delleditor
- anchor: the-editor-views
  title: I pannelli delleditor
- anchor: 1-assets-pane
  title: 1. Pannello Assets
- anchor: the-scene-editor
  title: 2. Pannello Scene Editor
- anchor: 3-outline-pane
  title: 3. Pannello Outline
- anchor: 4-properties-pane
  title: 4. Pannello Properties
- anchor: 5-tools-pane
  title: 5. Pannello Tools
- anchor: 6-changed-files-pane
  title: 6. Pannello Changed Files
- anchor: menu-bar
  title: Barra dei menu
- anchor: status-bar
  title: Barra di stato
- anchor: panes-size-and-visibility
  title: Dimensioni e visibilità dei pannelli
- anchor: tabs
  title: Schede
- anchor: side-by-side-editing
  title: Modifica in viste affiancate
- anchor: creating-new-project-files
  title: Creazione di nuovi file di progetto
- anchor: templates
  title: Modelli
- anchor: importing-files-to-your-project
  title: Importazione di file nel progetto
- anchor: updating-the-editor
  title: Aggiornamento delleditor
- anchor: preferences
  title: Preferenze
- anchor: editor-logs
  title: Log delleditor
- anchor: editor-server
  title: Server delleditor
- anchor: editor-installation-metadata
  title: Metadati di installazione delleditor
- anchor: editor-styling
  title: Personalizzazione dellaspetto delleditor
- FAQ
---
...
: Qui trovi i progetti aperti di recente, per potervi accedere rapidamente. È la vista predefinita della schermata iniziale.
  ...
  ![I miei progetti](/manuals/images/editor/start_no_projects.png)


  Se hai già aperto dei progetti, viene mostrato il relativo elenco, come nell'immagine seguente:

  ![I miei progetti](/manuals/images/editor/start_my_projects.png)
...
: Contiene progetti preparati per illustrare casi d'uso specifici.
  ...
  ![Nuovo progetto](/manuals/images/editor/start_templates.png)
...
Puoi approfondire le diverse opzioni nel [manuale sulla configurazione del progetto](https://www.defold.com/it/manuals/project-setup/).
...
![Lingue](/manuals/images/editor/languages.png)
...
![Editor della scena](/manuals/images/editor/2d_scene.png)

Alcune delle funzionalità principali dell'editor della scena:

- [Navigazione nelle scene 2D e 3D](/it/manuals/scene-editing/#2d-and-3d-scene-orientation) con modalità della camera ortografica e prospettica
- [Strumenti di trasformazione](/it/manuals/scene-editing/#manipulating-objects) per spostare, ruotare e ridimensionare gli oggetti
- [Modalità camera libera](/it/manuals/scene-editing/#free-camera-mode) per la navigazione 3D in prima persona
- [Impostazioni della griglia](/it/manuals/scene-editing/#grid-settings) con dimensioni, piano e aspetto configurabili
- [Filtri di visibilità](/it/manuals/scene-editing/#visibility-filters) per mostrare o nascondere tipi di componenti e guide

Per saperne di più, consulta il [manuale dell'editor della scena](/it/manuals/scene-editing/).
...
![Struttura degli elementi](/manuals/images/editor/outline.png)
...
![Proprietà](/manuals/images/editor/properties.png)
...
*Curve Editor* : viene usato per modificare le curve nell'[editor delle particelle](/it/manuals/particlefx/).

Il pannello Tools viene usato anche per interagire con il debugger integrato. Per saperne di più, consulta il [manuale sul debug](/it/manuals/debugging/).

### 6. Pannello Changed Files {#6-changed-files-pane}

Se il progetto usa Git, questa vista elenca i file modificati, aggiunti, rinominati o eliminati localmente rispetto al commit corrente (`HEAD`). Usa un client Git esterno o la riga di comando per sincronizzarti con un repository remoto. Puoi saperne di più nel [manuale sul controllo di versione](/it/manuals/version-control/). In questa vista puoi eseguire alcune operazioni sui file:
...
![Visibilità dei pannelli](/manuals/images/editor/editor_panes.png)
...
- Selezionare `➝| Open As` - per usare un editor diverso da quello predefinito o lo strumento esterno associato impostato in `File ▸ Preferences ▸ Code ▸ Custom Editor`. Per saperne di più, consulta il [manuale delle preferenze](/it/manuals/editor-preferences).

![Schede](/manuals/images/editor/tabs_custom.png)
...
![2 pannelli](/manuals/images/editor/2-panes.png)
...
![Creazione di un file](/manuals/images/editor/create_file.png)
...
![Aggiornamento dalla selezione del progetto](/manuals/images/editor/update_start.png)
![Aggiornamento dall'editor](/manuals/images/editor/update_available.png)
...
![Finestra di aggiornamento dell'editor](/manuals/images/editor/update.png)

L'avanzamento del download viene mostrato nella barra di stato inferiore:

![Avanzamento del download](/manuals/images/editor/download_status.png)
...
![Riavvio per aggiornare](/manuals/images/editor/restart_to_update.png)
...
Per maggiori dettagli, consulta il [manuale delle preferenze](/it/manuals/editor-preferences)

![Preferenze](/manuals/images/editor/preferences.png)
...
Per saperne di più, consulta il [manuale su come ottenere aiuto](/it/manuals/getting-help/#getting-help).

![Visualizzazione dei log](/manuals/images/editor/show_logs.png)
...
Puoi modificare l'aspetto dell'editor usando stili personalizzati. Per saperne di più, consulta il [manuale sulla personalizzazione dell'aspetto dell'editor](/it/manuals/editor-styling).

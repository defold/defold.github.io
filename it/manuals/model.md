...
toc:
- anchor: model-component
  title: Componente modello
- anchor: creating-a-model-component
  title: Creazione di un componente modello
- anchor: model-properties
  title: Proprietà del modello
- anchor: editor-manipulation
  title: Modifiche nelleditor
- anchor: runtime-manipulation
  title: Modifiche a runtime
- anchor: runtime-animation
  title: Animazione a runtime
...
![Modello in un oggetto di gioco](/manuals/images/model/model_gltf.png)
...
![Wiggler nel gioco](/manuals/images/model/runtime.png)

### Animazione a runtime {#runtime-animation}

Defold offre un potente supporto per il controllo delle animazioni durante l'esecuzione. Trovi maggiori informazioni nel [manuale delle animazioni dei modelli](/it/manuals/model-animation):
...
Consulta la [documentazione sul rendering](/it/manuals/render) per i dettagli sul funzionamento degli script di rendering.
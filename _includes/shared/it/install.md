...
![Download dell'editor](/shared/images/editor_download.png)
...
: Il file scaricato è un archivio ZIP che deve essere estratto:
  ...
  1. Trova il file di archivio `Defold-x86_64-win32.zip`, <kbd>premi e tieni premuto</kbd> (o <kbd>clicca con il tasto destro</kbd>) sul file, seleziona <kbd>Estrai tutto</kbd>, quindi segui le istruzioni per estrarre l'archivio in una cartella denominata `Defold`.
...
C'è un comando per installare un'icona sul desktop nel menu <kbd>Help ▸ Create Desktop Entry</kbd>.

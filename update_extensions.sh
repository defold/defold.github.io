...
./update.py --extension=extension-adpf ${DOWNLOAD} extensions
./update.py --extension=extension-applovin ${DOWNLOAD} extensions
./update.py --extension=extension-camera ${DOWNLOAD} extensions
./update.py --extension=extension-crazygames ${DOWNLOAD} extensions
...
./update.py --extension=extension-fontgen ${DOWNLOAD} extensions
...
./update.py --extension=extension-levelplay ${DOWNLOAD} extensions
...
./update.py --extension=extension-texturepacker ${DOWNLOAD} extensions
...
./update.py --extension=extension-xsolla ${DOWNLOAD} extensions
./update.py --extension=extension-zendesk ${DOWNLOAD} extensions

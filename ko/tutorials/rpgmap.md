...
에디터에서 [열거나](/ko/manuals/project-setup/) [GitHub에서 다운로드](https://github.com/defold/sample-rpgmap)할 수 있는 이 샘플 프로젝트에서는 Defold에서 매우 큰 RPG 맵을 만드는 한 가지 방법을 보여줍니다. 이 설계는 다음 가정을 기반으로 합니다.

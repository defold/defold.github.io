...
* "Empty Project" 템플릿으로 [새 프로젝트](/ko/manuals/project-setup/#creating-a-new-project)를 만듭니다.
...
![게임 규칙 도식](/tutorials/images/magic-link/linker_rules.png)
...
![폴더 구조](/tutorials/images/magic-link/linker_folders.png)
...
![프로젝트 설정](/tutorials/images/magic-link/linker_project_settings.png)

또한 렌더링되는 스프라이트의 최대 개수를 늘려야 합니다. 원한다면 다음 섹션으로 건너뛰었다가 콘솔에서 스프라이트 한도에 도달했다는 알림을 받은 뒤 여기로 돌아와도 됩니다.

![게임 스케일 레이아웃](/tutorials/images/magic-link/linker_layout.png)
...
![최대 스프라이트 수](/tutorials/images/magic-link/linker_sprite_max_count.png)
...
![이미지 추가](/tutorials/images/magic-link/linker_add_images.png)
...
![Atlas에 이미지 추가](/tutorials/images/magic-link/linker_add_to_atlas.png)
...
![보드 컬렉션](/tutorials/images/magic-link/linker_board_collection.png)

![보드 컬렉션 부트스트랩](/tutorials/images/magic-link/linker_bootstrap_board.png)
...
![블록 게임 오브젝트](/tutorials/images/magic-link/linker_block.png)
...
![블록 팩토리](/tutorials/images/magic-link/linker_blockfactory.png)

이제 게임을 실행하면 보드가 무작위 색 블록으로 채워진 것을 볼 수 있습니다.

![첫 스크린샷](/tutorials/images/magic-link/linker_first_screenshot.png)
...
![입력 바인딩](/tutorials/images/magic-link/linker_input_bindings.png)
...
![Connector 게임 오브젝트](/tutorials/images/magic-link/linker_connector.png)

![Connector 팩토리](/tutorials/images/magic-link/linker_connector_factory.png)
...
![게임 안의 connector](/tutorials/images/magic-link/linker_connector_screen.png)
...
![블록을 아래로 미끄러뜨리기](/tutorials/images/magic-link/linker_blocks_slide.png)
...
![Cover 스프라이트](/tutorials/images/magic-link/linker_cover.png)
...
![빛이 꺼진 매직 블록과 켜진 매직 블록](/tutorials/images/magic-link/linker_magic_blocks.png)
...
![영역 표시](/tutorials/images/magic-link/linker_regions.png)
...
![첫 승리](/tutorials/images/magic-link/linker_first_win.png)
...
![메인 메뉴 GUI](/tutorials/images/magic-link/linker_main_menu.png)
...
컬렉션 프록시는 실행 중인 게임에 컬렉션을 동적으로 로드하고 언로드할 수 있게 해 줍니다. 지정된 컬렉션 파일을 대신해서 동작하며, 프록시에 메세지를 보내 동적 컬렉션을 로드, 초기화, 활성화, 비활성화, 언로드합니다. 사용 방법에 대한 완전한 설명은 [Collection Proxy 문서](/ko/manuals/collection-proxy)를 참고하세요.

이 경우에는 collection proxy 컴포넌트의 *Collection* 프로퍼티를 "level"을 담고 있는 *board.collection* 으로 설정합니다.

![main 컬렉션](/tutorials/images/magic-link/linker_main_collection.png)

이제 *game.project* 를 열고 bootstrap *main_collection* 을 `/main/main.collectionc`로 변경해야 합니다.

![bootstrap main 컬렉션](/tutorials/images/magic-link/linker_bootstrap_main.png)
...
![level complete 다이얼로그](/tutorials/images/magic-link/linker_level_complete_gui.png)
...
![최종 보드 컬렉션](/tutorials/images/magic-link/linker_board_collection_final.png)
...
![완성된 게임](/tutorials/images/magic-link/linker_game_finished.png)

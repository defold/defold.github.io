...
[새 프로젝트](/ko/manuals/project-setup/)를 만들고 에디터에서 여는 것으로 시작합니다. *main/main.collection* 파일을 더블 클릭하면 파일이 열립니다.
...
Changed Files
: 현재 Git 커밋과 비교하여 로컬에서 추가, 수정, 이름 변경 또는 삭제된 파일을 포함합니다. 여기에서 텍스트 diff를 확인하고 로컬 변경 사항을 되돌릴 수 있습니다. 원격 저장소와 동기화하려면 외부 Git 클라이언트나 명령줄을 사용하세요.
...
<div class='sidenote' markdown='1'>
Defold는 게임 로직을 코딩하기 위한 여러 라이프사이클 함수를 제공합니다. 자세한 내용은 [스크립트 매뉴얼](/ko/manuals/script)을 읽어 보세요.
</div>
...
3. 자동차에 사운드를 추가하고 부릉거리게 만들어 보세요! ([힌트](/ko/manuals/sound/))

...
![썸네일](/tutorials/images/snake/thumbnail.png)
...
이 튜토리얼은 초보자를 위해 설계되었지만, Defold와 게임 개발이 완전히 처음이라면 먼저 몇 가지 입문 매뉴얼, 특히 [Defold의 빌딩 블록](/ko/manuals/building-blocks/)과 [용어집](/ko/manuals/glossary/)을 읽는 것을 권장합니다. 아직 Defold를 다운로드하지 않았다면 [설치 매뉴얼](/ko/manuals/install/)을 확인하세요. 에디터 자체를 빠르게 파악할 수 있도록 [에디터 개요](/ko/manuals/editor/)도 확인하는 것이 좋습니다. 다만 여기에서도 각 단계마다 스크린샷을 제공합니다.
...
![시작](/tutorials/images/snake/1.png)
...
![디스플레이](/tutorials/images/snake/2.png)

이렇게 하는 이유는 게임이 각 세그먼트가 16x16 픽셀인 그리드에 그려지기 때문입니다. 이렇게 하면 게임 화면이 세그먼트 일부를 잘라내지 않습니다. `game.project` 파일에는 프로젝트의 모든 중요한 설정이 들어 있습니다. 자세한 내용은 [프로젝트 설정 매뉴얼](/ko/manuals/project-settings/)에서 읽을 수 있습니다.
...
![새 폴더](/tutorials/images/snake/3.png)
...
![새 폴더](/tutorials/images/snake/4.png)

[에셋 임포트에 대한 자세한 내용](/ko/manuals/importing-graphics/)도 읽어 볼 수 있습니다.

<input type="checkbox"/> 완료!

## 타일 소스(Tile Source) 추가하기

Defold는 그리드에 정렬된 *타일*로 구성된 플레이필드를 만드는 데 사용할 수 있는 내장 [타일 맵](/ko/manuals/tilemap/) 컴포넌트를 제공합니다. 타일 맵을 사용하면 개별 타일을 설정하고 읽을 수 있으므로 이 게임에 매우 잘 맞습니다. 타일 맵은 [타일 소스(Tile Source)](/ko/manuals/tilesource/)에서 그래픽을 가져오므로 먼저 하나 만들어야 합니다:
...
![새 tilesource](/tutorials/images/snake/5.png)
...
![tilesource 프로퍼티](/tutorials/images/snake/7.png)
...
![타일맵](/tutorials/images/snake/10.png)

3. 화면 가장자리에 테두리를 칠하고 장애물도 몇 개 칠합니다.
![최종 타일맵](/tutorials/images/snake/11.png)
...
![게임 실행](/tutorials/images/snake/14.png)
...
![알고리즘](/tutorials/images/snake/17.png)
...
![게임 실행](/tutorials/images/snake/snake_run_1.png)
...
![입력](/tutorials/images/snake/18.png)

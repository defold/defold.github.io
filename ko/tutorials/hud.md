...
[에디터에서 열거나](/ko/manuals/project-setup/) [GitHub에서 다운로드](https://github.com/defold/sample-hud)할 수 있는 이 샘플 프로젝트에서는 점수 카운팅 효과를 보여줍니다. 점수는 화면 곳곳에 무작위로 나타나며, 플레이어가 여러 위치에서 점수를 얻는 게임을 시뮬레이션합니다.

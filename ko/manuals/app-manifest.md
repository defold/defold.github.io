...
엔진에서 프로파일러를 제외합니다. 프로파일러는 성능 및 사용량 카운터를 수집하는 데 사용됩니다. [프로파일링 매뉴얼](/ko/manuals/profiling/)에서 프로파일러 사용법을 알아보세요.
...
이 옵션은 *game.project*의 `html5.heap_size` [link](https://defold.com/ko/manuals/html5/#heap-size)와 관련이 있습니다. 어플리케이션 메니페스트로 구성한 옵션은 컴파일 중 설정되며 `INITIAL_MEMORY` 옵션의 기본값으로 사용됩니다. *game.project*의 값은 어플리케이션 메니페스트의 값을 덮어쓰며 런타임에 사용됩니다.

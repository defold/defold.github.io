...
활성화하면(`true`) 프로젝트에서 True Type Fonts(`.ttf`)를 사용할 때 SDF 타입 폰트의 런타임 생성을 사용할 수 있습니다. [Font Manual](https://defold.com/ko/manuals/font/#enabling-runtime-fonts)에서 자세한 내용을 확인하세요.

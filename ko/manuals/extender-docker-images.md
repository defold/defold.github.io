...
3. [사전 구성된 아티팩트로 로컬 Extender를 실행하는 방법](/ko/manuals/extender-local-setup#how-to-run-local-extender-with-preconfigured-artifacts)에 설명된 대로 로컬 Extender를 실행합니다.
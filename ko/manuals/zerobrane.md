...
![Finder에서 보기](/manuals/images/zerobrane/show_in_desktop.png)

## ZeroBrane 설정하기

ZeroBrane을 설정하려면 <kbd>Project ▸ Project Directory ▸ Choose...</kbd>를 선택합니다:

![설정](/manuals/images/zerobrane/setup.png)
...
![디버거 시작](/manuals/images/zerobrane/startdebug.png)
...
![단계 실행](/manuals/images/zerobrane/code.png)
...
![기타 권장 설정](/manuals/images/zerobrane/otherrecommended.png)
...
![불투명한 초록색으로 렌더링한 예제 텍스트](/manuals/images/richtext/color_green.webp)
...
![알파값이 절반인 초록색으로 렌더링한 예제 텍스트](/manuals/images/richtext/color_green_alpha.webp)
...
![24픽셀 크기로 렌더링한 예제 텍스트](/manuals/images/richtext/size_24.webp)
...
![32픽셀의 120퍼센트 크기로 렌더링한 예제 텍스트](/manuals/images/richtext/size_120.webp)
...
![32픽셀 기본 크기의 두 배로 렌더링한 예제 텍스트](/manuals/images/richtext/size_2em.webp)
...
![수평으로 마젠타에서 흰색으로 변하는 그라디언트가 적용된 예제 텍스트](/manuals/images/richtext/gradient_horizontal.webp)
...
![수직 파란색 그라디언트가 적용된 예제 텍스트](/manuals/images/richtext/gradient_vertical.webp)
...
![각 글리프에 맞춘 네 모서리 그라디언트가 적용된 예제 텍스트](/manuals/images/richtext/gradient_four_glyph.webp)
...
![텍스트 구간에 맞춘 네 모서리 그라디언트가 적용된 예제 텍스트](/manuals/images/richtext/gradient_four_text.webp)
...
![각 글리프에 맞춰 흐르는 애니메이션 그라디언트](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![텍스트 구간에 맞춰 흐르는 애니메이션 그라디언트](/manuals/images/richtext/gradient_flow_span.webp)
...
![실선 밑줄이 있는 예제 텍스트](/manuals/images/richtext/underline_solid.webp)
...
![파선 밑줄이 있는 예제 텍스트](/manuals/images/richtext/underline_dashed.webp)
...
![그라디언트 밑줄이 있는 예제 텍스트](/manuals/images/richtext/underline_gradient.webp)
...
![실선 취소선이 있는 예제 텍스트](/manuals/images/richtext/strike_solid.webp)
...
![파선 취소선이 있는 예제 텍스트](/manuals/images/richtext/strike_dashed.webp)
...
![바깥쪽에 검은색 외곽선이 있는 예제 텍스트](/manuals/images/richtext/outline.webp)
...
![오프셋이 적용된 그림자가 있는 예제 텍스트](/manuals/images/richtext/shadow.webp)
...
![글리프별 흔들림 애니메이션이 적용된 예제 텍스트](/manuals/images/richtext/shake_glyph.webp)
...
![텍스트 구간 전체의 흔들림 애니메이션이 적용된 예제 텍스트](/manuals/images/richtext/shake_span.webp)
...
![글리프별 파동 애니메이션이 적용된 예제 텍스트](/manuals/images/richtext/wave_glyph.webp)
...
![하나의 텍스트 구간으로 함께 움직이는 예제 텍스트](/manuals/images/richtext/wave_span.webp)
...
![텍스트와 같은 줄에 렌더링한 Defold 로고](/manuals/images/richtext/sprite.webp)
...
![기본 링크 스타일과 밑줄로 렌더링한 www.defold.com](/manuals/images/richtext/link.webp)
...
자세한 설정 방법은 [입력 포커스](/ko/manuals/input/#input-focus)와 [마우스 및 터치 입력](/ko/manuals/input-mouse-and-touch)을 참고하세요.

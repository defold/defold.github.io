...
![ParticleFX 에디터](/manuals/images/particlefx/editor.png)
...
*Assets* 브라우저의 컨텍스트 메뉴에서 <kbd>New... ▸ Particle FX</kbd>를 선택합니다. 새 파티클 효과 파일의 이름을 지정합니다. 이제 에디터가 [Scene Editor](/ko/manuals/editor/#the-scene-editor)를 사용해 파일을 엽니다.

*Outline* 창에는 기본 emitter가 표시됩니다. Emitter를 선택하면 아래 *Properties* 창에 해당 프로퍼티가 나타납니다.

![기본 파티클](/manuals/images/particlefx/default.png)
...
![modifier 추가](/manuals/images/particlefx/add_modifier.png)

![modifier 선택 추가](/manuals/images/particlefx/add_modifier_select.png)
...
![파티클 편집](/manuals/images/particlefx/rotate.gif)
...
: Emitter의 모양입니다.
  ...
  ![emitter 타입](/manuals/images/particlefx/emitter_types.png)
...
### 블렌드 모드
{% include shared/ko/blend-modes.md %}
...
![프로퍼티](/manuals/images/particlefx/property.png)

키 버튼을 체크하면 프로퍼티 값이 emitter의 duration 동안 곡선으로 제어됩니다. 키가 지정된 프로퍼티를 초기화하려면 키 버튼의 체크를 해제합니다.

![키가 지정된 프로퍼티](/manuals/images/particlefx/key.png)
...
: 해당 위치 주위에서 원형 또는 나선형 방향으로 파티클에 영향을 줍니다.
  ...
  ![modifier](/manuals/images/particlefx/modifiers.png)
...
GUI 스크립트에서 파티클 효과를 시작하고 중지하는 방법은 [GUI Particle FX 매뉴얼](/ko/manuals/gui-particlefx#controlling-the-effect)에서 자세히 확인할 수 있습니다.
...
기본 파티클 효과 메터리얼에는 `particlefx.set_constant()`로 변경하고 `particlefx.reset_constant()`로 초기화할 수 있는 다음 상수가 있습니다([자세한 내용은 메터리얼 매뉴얼 참고](/ko/manuals/material/#vertex-and-fragment-constants)).
...
*game.project* 파일에는 파티클과 관련된 몇 가지 [프로젝트 설정](/ko/manuals/project-settings#particle-fx)이 있습니다.
...
사용할 필터링 설정은 [프로젝트 설정](/ko/manuals/project-settings/#graphics) 파일에 저장됩니다. 설정값은 두 가지입니다.
...
*game.project*의 설정은 기본 샘플러에서 사용됩니다. 커스텀 메터리얼에서 샘플러를 지정하면 각 샘플러마다 필터 방식을 따로 설정할 수 있습니다. 자세한 내용은 [메터리얼 매뉴얼](/ko/manuals/material/)을 참고하세요.
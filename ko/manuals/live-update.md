...
`Amazon`
: 이 옵션은 Defold가 제외된 리소스를 아마존 웹 서비스(AWS) S3 버켓에 자동으로 업로드하도록 지시합니다. AWS *Credential profile* 이름을 입력하고, 적절한 *Bucket*을 선택한 뒤 *Prefix* 이름을 제공합니다. AWS 계정 설정 방법은 이 [aws guide](/ko/manuals/live-update-aws)에서 더 읽을 수 있습니다.
...
[live update 스크립팅 방법](/ko/manuals/live-update-scripting)에서 더 읽어보세요.

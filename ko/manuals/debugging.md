...
toc: ["Debugging","Debugging Lua scripts with ZeroBrane","ZeroBrane configuration","To set up ZeroBrane","Starting the debugging server","Connecting your application to the debugger","Other recommended ZeroBrane setting","Hot reloading","Web profiler","Frames overview","Frame data","Frames plot","Frame time chart"]
title: Defold manual
---

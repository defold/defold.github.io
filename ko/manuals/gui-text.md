...
텍스트 노드에는 특별한 속성들이 있습니다:

*Font*
: 생성하는 모든 텍스트 노드는 *Font* 속성이 설정되어 있어야 합니다.

*Text*
: 이 속성은 표시되는 텍스트를 포함합니다.

*Line Break*
: 텍스트 정렬은 피벗 설정을 따르며, 이 속성을 설정하면 텍스트가 여러 줄로 흐를 수 있습니다. 노드의 너비가 텍스트가 줄바꿈되는 위치를 결정합니다.
...
텍스트 노드는 크기, 피벗, 색상 등을 설정하는 모든 일반 노드 조작 함수에 응답합니다. 텍스트 노드 전용 함수도 몇 가지 있습니다:

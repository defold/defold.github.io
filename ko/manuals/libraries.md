...
공유 스프라이트와 타일 소스를 포함하는 라이브러리를 만들고 싶다고 가정해 보겠습니다. 먼저 [새 프로젝트를 설정](/ko/manuals/project-setup/)합니다. 프로젝트에서 공유할 폴더를 정하고 해당 폴더 이름을 Project settings의 *`include_dirs`* 프로퍼티에 추가합니다. 폴더를 둘 이상 나열하려면 이름을 공백으로 구분합니다.

![포함 디렉토리](/manuals/images/libraries/libraries_include_dirs.png)
...
<div class='important' markdown='1'>
서드파티 라이브러리는 사용하기 전에 항상 검토하는 것을 권장합니다. [서드파티 소프트웨어 사용 보안](https://defold.com/ko/manuals/application-security/#securing-your-use-of-third-party-software)에 대해 자세히 알아보세요.
</div>
...
![종속성](/manuals/images/libraries/libraries_dependencies.png)
...
![라이브러리 설정 완료](/manuals/images/libraries/libraries_done.png)
...
메터리얼을 복사 붙여넣기한 뒤 특정 타입의 모든 컴포넌트에서 사용하고 싶다면 [프로젝트별 템플릿](/ko/manuals/editor/#creating-new-project-files)을 사용하는 것이 유용할 수 있습니다.

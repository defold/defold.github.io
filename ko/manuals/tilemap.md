...
타일 맵을 만들기 전에 먼저 타일 소스를 만들어야 합니다. 타일 소스를 만드는 방법은 [타일 소스 매뉴얼](/ko/manuals/tilesource)을 참고하세요.
...
- 새 타일 맵이 타일 맵 에디터에서 자동으로 열립니다.
  ...
  ![새 타일맵](/manuals/images/tilemap/tilemap.png)
...
![타일 가져오기](/manuals/images/tilemap/pick_tiles.png)
...
![타일 맵 사용](/manuals/images/tilemap/use_tilemap.png)
...
{% include shared/ko/material-constants.md component='tilemap' variable='tint' %}
...
*game.project* 파일에는 타일맵과 관련된 몇 가지 [프로젝트 설정](/ko/manuals/project-settings#tilemap)이 있습니다.

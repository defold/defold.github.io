...
![컴퓨트 파일](/manuals/images/compute/compute_file.png)

새 컴퓨트 파일이 *Compute Editor*에서 열립니다.

![컴퓨트 에디터](/manuals/images/compute/compute.png)
...
![컴퓨트 렌더 파일](/manuals/images/compute/compute_render_file.png)
...
<div class='sidenote' markdown='1'>
현재 실행 중인 클라이언트가 컴퓨트 쉐이더를 지원하는지 확인할 방법은 없습니다.
즉 그래픽 어댑터가 OpenGL 또는 OpenGL ES 기반인 경우, 클라이언트가 컴퓨트 쉐이더 실행을 지원한다고 보장할 수 없습니다.
Vulkan과 Metal은 버전 1.0부터 컴퓨트 쉐이더를 지원합니다. Vulkan을 사용하려면 커스텀 메니페스트를 만들고 Vulkan을 백엔드로 선택해야 합니다.
</div>
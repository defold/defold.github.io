...
Buffer 리소스는 [Mesh 컴포넌트](/ko/manuals/mesh)의 입력으로 사용할 수 있습니다. Buffer 리소스는 런타임에 `buffer.create()`와 [관련 API 함수](/ref/buffer/#buffer.create:element_count-declaration)를 사용해 생성할 수도 있습니다.
...
텍스쳐를 [스프라이트 컴포넌트](/ko/manuals/sprite/)에서 사용하려면 먼저 아틀라스에서 사용해야 합니다. Atlas를 생성하려면 [`resource.create_atlas(path, params)`](https://defold.com/ref/resource/#resource.create_atlas:path-table)를 사용합니다:

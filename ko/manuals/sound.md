...
*Sound*
: 프로젝트의 사운드 파일로 설정해야 합니다. 파일은 _Wave_, _Ogg Vorbis_ 또는 _Ogg Opus_ 포멧이어야 합니다. Defold는 16bit 비트 깊이로 저장된 사운드 파일을 지원합니다.
...
- "master" 그룹에 설정된 게인. `sound.set_group_gain(hash("master"))`로 변경할 수 있습니다.

출력 게인은 이 4개의 게인을 곱한 결과입니다. 기본 게인은 모든 위치에서 1.0(0 dB)입니다.
...
모든 값은 0과 1.0(0 dB) 사이의 선형 값입니다. 데시벨로 변환하려면 표준 공식을 사용하면 됩니다:

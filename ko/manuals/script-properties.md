...
![프로퍼티가 있는 컴포넌트](/manuals/images/script-properties/component.png)

에디터의 *Outline* 뷰에서 스크립트 컴포넌트를 선택하면 *Properties* 뷰에 프로퍼티가 나타나고, 여기에서 값을 편집할 수 있습니다:

![프로퍼티](/manuals/images/script-properties/properties.png)
...
![리소스 프로퍼티](/manuals/images/script-properties/resource-properties.png)

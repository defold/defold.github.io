...
에디터는 그래픽 데스크톱 어플리케이션입니다. 디스플레이에 액세스할 수 있는 대화형 사용자 세션에서 시작하세요. headless CI처럼 그래픽 세션을 사용할 수 없거나 컴파일 전용 자동화와 standalone 번들 생성이 필요한 경우 [Bob](/ko/manuals/bob)을 사용하세요.
...
브라우저 테스트를 시작하기 전에 URL을 사용할 수 있을 때까지 기다리세요. 자세한 내용은 [HTML5 브라우저 테스트](/ko/manuals/automated-testing/#browser-tests-for-html5)를 참고하세요.

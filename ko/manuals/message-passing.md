...
메세지 전달은 Defold 게임 오브젝트(game object)가 서로 통신하는 메커니즘입니다. 이 매뉴얼은 Defold의 [주소 지정 메커니즘](/ko/manuals/addressing)과 [기본 빌딩 블록](/ko/manuals/building-blocks)을 기본적으로 이해하고 있다고 가정합니다.
...
![메세지 전달 구조](/manuals/images/message_passing/message_passing_structure.png)
...
![메세지 전달](/manuals/images/message_passing/message_passing.png)
...
![컬렉션 이름](/manuals/images/message_passing/collection_name.png)
...
```
프록시가 동작하는 방식에 대한 더 자세한 설명은 [컬렉션 프록시](/ko/manuals/collection-proxy) 문서에서 찾을 수 있습니다.

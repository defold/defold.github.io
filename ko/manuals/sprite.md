...
스프라이트 컴포넌트는 그래픽에 [아틀라스](/ko/manuals/atlas) 또는 [타일 소스](/ko/manuals/tilesource)를 사용할 수 있습니다.
...
{% include shared/ko/slice-9-texturing.md %}
...
{% include shared/ko/material-constants.md component='sprite' variable='tint' %}
...
스프라이트는 현재 할당된 메터리얼의 버텍스 attribute를 오버라이드할 수 있으며, 이 attribute들은 컴포넌트에서 버텍스 쉐이더로 전달됩니다(자세한 내용은 [메터리얼 매뉴얼](/ko/manuals/material/#attributes)을 참조하세요).
...
그래서 [아틀라스](/ko/manuals/material/)의 `Rename patterns`를 사용해 이름을 변경합니다.

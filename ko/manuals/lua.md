...
toc: ["Lua in Defold","Lua versions","Lua books and resources","Syntax","Flow control (흐름제어)","Defold scripts","Script execution and callbacks","Reactive logic(반응형 로직)","Lua contexts in Defold","Memory and garbage collection(메모리와 가비지 컬렉션)"]
title: Defold manual
---

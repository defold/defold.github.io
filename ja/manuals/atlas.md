...
テクスチャを [スプライトコンポーネント](/ja/manuals/sprite/) で使用するには、先にアトラスでそのテクスチャを使う必要があります。[`resource.create_atlas(path, params)`](https://defold.com/ref/resource/#resource.create_atlas:path-table) を使ってアトラスを作成します。

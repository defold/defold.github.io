...
* レンダリングパイプラインの詳細については、[レンダリングのドキュメント](/ja/manuals/render)を参照してください。
* シェーダープログラム（shader program）の詳しい説明については、[シェーダーのドキュメント](/ja/manuals/shader)を参照してください。
...
![コンピュートファイル](/manuals/images/compute/compute_file.png)

新しいコンピュートファイルが *Compute Editor* で開きます。

![コンピュートエディター](/manuals/images/compute/compute.png)
...
![コンピュートプログラムを追加したレンダーファイル](/manuals/images/compute/compute_render_file.png)

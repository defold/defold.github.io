...
エディターのプレビューは、エンジンのフォントレンダラーを使って、テキストの字形形成と右から左へのレイアウトをサポートします。必要なフォントと App Manifest の設定については、[テキストレイアウトのサポート](/ja/manuals/font/#text-layout-support-eg-right-to-left)を参照してください。
...
![フォント](/manuals/images/gui-text/fonts.png)
...
![テキストの揃え方](/manuals/images/gui-text/align.png)

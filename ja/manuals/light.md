...
- anchor: light-buffer-in-shaders
  title: シェーダー内のライトバッファー
- anchor: built-in-lighting-helper
  title: 組み込みのライティングヘルパー
- anchor: see-also
  title: 関連項目
---
...
![ライトのないシーン](/manuals/images/light/no_light.png)
...
![強度の低いアンビエントライト](/manuals/images/light/ambient_light_less_intensity.png)
...
![強度の高いアンビエントライト](/manuals/images/light/ambient_light_full_intensity.png)
...
![ディレクショナルライト](/manuals/images/light/directional_light.png)
...
![ディレクショナルライトとアンビエントライト](/manuals/images/light/directional_and_ambient_light.png)
...
![ポイントライト](/manuals/images/light/point_light.png)
...
![ポイントライトの範囲](/manuals/images/light/point_light_range.png)

ライトの色を変更するとポイントライトが与える光の色が変わり、範囲を変更すると光源から光が届く距離が変わります。

![緑色のポイントライトの範囲](/manuals/images/light/point_ight_range_green_color.png)
...
![スポットライト](/manuals/images/light/spot_light.png)
...
![スポットライトのギズモ](/manuals/images/light/spot_light_gizmos.png)
...
![ライトバッファーを使用するシェーダー](/manuals/images/light/light-buffer-shader.png)
...
- [シェーダーマニュアル](/ja/manuals/shader)
- [マテリアルマニュアル](/ja/manuals/material)
- [レンダリングマニュアル](/ja/manuals/render)
...
- anchor: accessing-script-properties
  title: スクリプトプロパティへのアクセス
- anchor: factory-created-objects
  title: ファクトリーで作成したオブジェクト
...
![プロパティを持つコンポーネント](/manuals/images/script-properties/component.png)

 エディターの *Outline* ビューでスクリプトコンポーネントを選択すると、*Properties* ビューにプロパティが表示され、編集できるようになります。

![プロパティ](/manuals/images/script-properties/properties.png)
...
![リソースプロパティ](/manuals/images/script-properties/resource-properties.png)

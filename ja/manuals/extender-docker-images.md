...
3. [設定済みのアーティファクトを使ってローカルの Extender を実行する方法](/ja/manuals/extender-local-setup#how-to-run-local-extender-with-preconfigured-artifacts)の説明に従って、ローカルの Extender を実行します。
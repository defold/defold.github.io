...
- anchor: dialog-related-components
  title: ダイアログ関連のコンポーネント
- anchor: utility-components
  title: ユーティリティコンポーネント
- anchor: reactivity
  title: リアクティビティ
...
このマニュアルでは、Lua で記述したエディタースクリプト（editor script）を使用して、エディターに操作可能な UI 要素を作成する方法を説明します。エディタースクリプトを使い始めるには、[エディタースクリプトのマニュアル](/ja/manuals/editor-scripts)を参照してください。エディター API の完全なリファレンスは[こちら](/ref/stable/editor-lua/)にあります。現在作成できるのは操作可能なダイアログだけですが、今後は UI スクリプトのサポートをエディターのほかの部分にも広げたいと考えています。
...
![最初の例のダイアログ](/manuals/images/editor_scripts/perform_action_dialog.png)
...
![配置](/manuals/images/editor_scripts/alignment.png)
...
![パディングと間隔](/manuals/images/editor_scripts/padding_and_spacing.png)
...
![新しいレベルのダイアログ](/manuals/images/editor_scripts/new_level_dialog.png)
...
![入力コンポーネント](/manuals/images/editor_scripts/inputs_demo.png)
...
![新規ファイル作成ダイアログ](/manuals/images/editor_scripts/reactive_new_file_dialog.png)

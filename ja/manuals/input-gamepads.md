...
- anchor: gamepads-on-windows
  title: Windows のゲームパッド
- anchor: gamepads-on-android
  title: Android のゲームパッド
---

<div class='sidenote' markdown='1'>
Defold で入力が動作する基本的な仕組み、入力の受信方法、スクリプトファイルで入力を受信する順序を理解しておくことをお勧めします。入力システムについて詳しくは、[入力の概要マニュアル](/ja/manuals/input)をご覧ください。
</div>
...
![ゲームパッドの設定](/manuals/images/input/gamepads.png)
...
![ゲームパッドの設定](/manuals/images/input/gamepad_setting.png)

...
![不透明な緑で描画したサンプルテキスト](/manuals/images/richtext/color_green.webp)
...
![アルファ値が半分の緑で描画したサンプルテキスト](/manuals/images/richtext/color_green_alpha.webp)
...
![24 ピクセルで描画したサンプルテキスト](/manuals/images/richtext/size_24.webp)
...
![32 ピクセルの 120% で描画したサンプルテキスト](/manuals/images/richtext/size_120.webp)
...
![基本サイズ 32 ピクセルの2倍で描画したサンプルテキスト](/manuals/images/richtext/size_2em.webp)
...
![マゼンタから白への水平方向のグラデーションを適用したサンプルテキスト](/manuals/images/richtext/gradient_horizontal.webp)
...
![青の垂直方向のグラデーションを適用したサンプルテキスト](/manuals/images/richtext/gradient_vertical.webp)
...
![各グリフに合わせて四隅のグラデーションを適用したサンプルテキスト](/manuals/images/richtext/gradient_four_glyph.webp)
...
![スパンに合わせて四隅のグラデーションを適用したサンプルテキスト](/manuals/images/richtext/gradient_four_text.webp)
...
![各グリフに合わせて流れるグラデーションのアニメーション](/manuals/images/richtext/gradient_flow_glyph.webp)
...
![スパンに合わせて流れるグラデーションのアニメーション](/manuals/images/richtext/gradient_flow_span.webp)
...
![実線の下線付きのサンプルテキスト](/manuals/images/richtext/underline_solid.webp)
...
![破線の下線付きのサンプルテキスト](/manuals/images/richtext/underline_dashed.webp)
...
![グラデーションの下線付きのサンプルテキスト](/manuals/images/richtext/underline_gradient.webp)
...
![実線の取り消し線付きのサンプルテキスト](/manuals/images/richtext/strike_solid.webp)
...
![破線の取り消し線付きのサンプルテキスト](/manuals/images/richtext/strike_dashed.webp)
...
![外側に黒い輪郭を付けたサンプルテキスト](/manuals/images/richtext/outline.webp)
...
![位置をずらした影付きのサンプルテキスト](/manuals/images/richtext/shadow.webp)
...
![グリフごとに震えるアニメーションを適用したサンプルテキスト](/manuals/images/richtext/shake_glyph.webp)
...
![スパン全体が震えるアニメーションを適用したサンプルテキスト](/manuals/images/richtext/shake_span.webp)
...
![グリフごとに波打つアニメーションを適用したサンプルテキスト](/manuals/images/richtext/wave_glyph.webp)
...
![1つのスパンとして動くアニメーションを適用したサンプルテキスト](/manuals/images/richtext/wave_span.webp)
...
![テキスト内にインラインで描画した Defold ロゴ](/manuals/images/richtext/sprite.webp)
...
![既定のリンクスタイルと下線で描画した www.defold.com](/manuals/images/richtext/link.webp)
...
設定の詳細は、[入力フォーカス](/ja/manuals/input/#input-focus)と[マウスとタッチ入力](/ja/manuals/input-mouse-and-touch)を参照してください。

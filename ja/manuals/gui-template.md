...
![テンプレートの作成](/manuals/images/gui-templates/create.png)
...
![インスタンスの作成](/manuals/images/gui-templates/create_instance.png)
...
![インスタンス](/manuals/images/gui-templates/instances.png)

変更したプロパティは、エディターで青色で表示されます。プロパティの横にあるリセットボタンを押すと、テンプレートの値に戻ります。

![プロパティ](/manuals/images/gui-templates/properties.png)

プロパティが上書きされたノードも、*Outline* で青色で表示されます。

![Outline ビュー](/manuals/images/gui-templates/outline.png)

...
![投影方式](/manuals/images/camera/projections.png)
...
![カメラコンポーネントの作成](/manuals/images/camera/create.png)

カメラコンポーネントには、カメラの *視錐台* を定義する次のプロパティ（property）があります。

![カメラの設定](/manuals/images/camera/settings.png)
...
![ゲームオブジェクトの追従](/manuals/images/camera/follow.png)
...
<div class='sidenote' markdown='1'>
[このマニュアルで紹介しているサードパーティー製のカメラソリューション](/ja/manuals/camera/#third-party-camera-solutions) には、スクリーン座標との相互変換を行う関数があります。
</div>

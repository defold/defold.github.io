...
![スクリプト](/manuals/images/gui-script/set_script.png)
...
![メッセージパッシング](/manuals/images/gui-script/message_passing.png)

## ノードのアドレス指定 {#addressing-nodes}

GUI ノードは、そのコンポーネントに関連付けられた GUI スクリプトから操作できます。各ノードには、エディターで設定する一意の *Id* が必要です。

![メッセージパッシング](/manuals/images/gui-script/node_id.png)
...
![動的なノード](/manuals/images/gui-script/dynamic_nodes.png)

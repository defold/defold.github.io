...
![ラベルの追加](/manuals/images/label/add_label.png)
...
![新しいラベル](/manuals/images/label/label.png)

*Font* プロパティに使用するフォントを設定し、*Material* プロパティには、必ずフォントの種類に合ったマテリアル（material）を設定します。

![フォントとマテリアル](/manuals/images/label/font_material.png)
...
![テキストの揃え方](/manuals/images/label/align.png)
...
*game.project* ファイルには、ラベルに関するいくつかの [プロジェクト設定](/ja/manuals/project-settings#label) があります。
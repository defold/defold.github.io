...
![新しいディスプレイプロファイル](/manuals/images/gui-layouts/new_profiles.png)

エンジンで新しいプロファイルを使うように指定する必要もあります。*game.project* を開き、*display* の *Display Profiles* 設定でディスプレイプロファイルファイルを選択します。

![設定](/manuals/images/gui-layouts/settings.png)
...
![シーンへのレイアウトの追加](/manuals/images/gui-layouts/add_layout.png)
...
![レイアウトのツールバー](/manuals/images/gui-layouts/toolbar.png)

![縦向きのレイアウトの編集](/manuals/images/gui-layouts/portrait.png)
...
![横向きのレイアウトの編集](/manuals/images/gui-layouts/landscape.png)

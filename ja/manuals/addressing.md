...
![エディターの bean](/manuals/images/addressing/bean_editor.png)
...
![bean の構成](/manuals/images/addressing/bean.png)
...
![bean の構成](/manuals/images/addressing/bean_shield_editor.png)
...
![bean の構成](/manuals/images/addressing/bean_shield.png)

<div class='sidenote' markdown='1'>
同じ識別子を複数回使おうとすると、エディターがエラーを表示するため、実際にこれが問題になることはありません。

![bean の構成](/manuals/images/addressing/name_collision.png)
</div>
...
![bean の構成](/manuals/images/addressing/bean_buddy.png)
...
![bean の構成](/manuals/images/addressing/team_editor.png)

この構造でも、"bean" ゲームオブジェクトは引き続き `"buddy#controller"` というアドレスで、"buddy" 内の "controller" コンポーネントを参照できます。

![bean の構成](/manuals/images/addressing/collection_team.png)
...
![bean の構成](/manuals/images/addressing/teams_editor.png)
...
![相対識別子](/manuals/images/addressing/relative_same.png)
...
{% include shared/ja/url-shorthands.md %}
...
![マネージャーオブジェクト](/manuals/images/addressing/manager_editor.png)
...
![チームとマネージャー](/manuals/images/addressing/teams_manager.png)

![絶対アドレス指定](/manuals/images/addressing/absolute.png)
...
socket
: 対象のゲームワールドを識別します。これは [コレクションプロキシ（collection proxy）](/ja/manuals/collection-proxy) を扱う場合に重要で、その場合は _動的に読み込まれるコレクション_ を識別するために使います。

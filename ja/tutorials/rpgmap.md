...
[エディターから開く](/ja/manuals/project-setup/)か、[GitHub からダウンロード](https://github.com/defold/sample-rpgmap)できるこのサンプルプロジェクトでは、Defold で非常に大きな RPG マップを作成する方法の1つを紹介します。この設計は、次の前提に基づいています。

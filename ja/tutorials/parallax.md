...
[エディターから開く](/ja/manuals/project-setup/)、または [GitHub からダウンロードする](https://github.com/defold/sample-parallax)ことができるこのサンプルプロジェクトでは、パララックス（parallax）効果を使ってゲームワールド（game world）に奥行きを表現する方法を紹介します。

...
[エディターから開く](/ja/manuals/project-setup/)か、[GitHub からダウンロードする](https://github.com/defold/sample-main-menu-animation)ことができるこのサンプルプロジェクトでは、メインメニューを表示するための演出を紹介します。メニューは背景と2つのメニュー項目で構成されています。

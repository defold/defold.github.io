...
![新しいプロジェクト](/tutorials/images/new_empty.png)
...
まず、[新しいプロジェクト](/ja/manuals/project-setup/)を作成して、エディターで開きます。*main/main.collection* ファイルをダブルクリックすると、次のようにファイルが開きます。
...
![ビルド](/tutorials/images/car/start_build_and_launch.png)
...
![未保存の変更があるファイル](/tutorials/images/car/file_changed.png)
</div>
...
![新しいコレクションファイル](/tutorials/images/car/start_new_collection.png)
...
![車のゲームオブジェクトを追加する](/tutorials/images/car/start_add_car_gameobject.png)
...
![車のコンポーネントを追加する](/tutorials/images/car/start_add_car_component.png)
...
![車の画像](/tutorials/images/car/start_car.png)
![タイヤの画像](/tutorials/images/car/start_tire.png)

これらの画像をアトラスに追加します。

![スプライトのアトラス](/tutorials/images/car/start_sprites_atlas.png)

![スプライトのプロパティ](/tutorials/images/car/start_sprite_properties.png)
...
![完成した車のコレクション](/tutorials/images/car/start_car_collection_complete.png)
...
<div class='sidenote' markdown='1'>
Defold には、ゲームロジックを記述するためのライフサイクル関数がいくつか用意されています。詳しくは[スクリプトマニュアル](/ja/manuals/script)を参照してください。
</div>
...
![入力バインディング](/tutorials/images/car/start_input_bindings.png)
...
![車のコレクションを追加する](/tutorials/images/car/start_adding_car_collection.png)
...
3. 車にサウンドを追加して、エンジン音を響かせましょう！（[ヒント](/ja/manuals/sound/)）
